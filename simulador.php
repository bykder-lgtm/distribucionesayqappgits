...
<?php $nombre_tipo_origen_simulacion     = "SIMULACION_VALOR_LIBRE"; ?>
</head>
...
<?php //include_once("admin/05_modulo_algunas_categorias.php"); ?>
    ...
    <div class="cart-box-main">
        ...
        <form name="formulario_de_actualizacion" method="POST" autocomplete="off" action="app/admin/simulador_libre_visitante_extnosesion_resultado.php">
