...
$buscar_usuario = "SELECT cod_administrador, cuenta, contrasena, cod_seguridad, cod_tipo_historia_clinica, nombres, apellidos, nombre_sexo, cod_tipo_aplicacion 
...
$cod_tipo_aplicacion                = $datax['cod_tipo_aplicacion'];
$cod_base_caja                      = '1';

if ($cod_tipo_aplicacion == '0') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_tipo_aplicacion == '1') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_tipo_aplicacion == '2') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_tipo_aplicacion == '3') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos_version_tactil.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_tipo_aplicacion == '4') { $pag_redirec_sesion_descryp = "lista_caja_virtual_cocina.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
/*
if ($cod_tipo_aplicacion == '5') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_tipo_aplicacion == '6') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '7') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '8') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '9') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '10') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '11') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '12') { $pag_redirec_sesion_descryp = "lista_caja_virtual_cocina.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '13') { $pag_redirec_sesion_descryp = "facturacion_venta_temporal_producto_manual_caja_registradora_pos.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
*/
//---------------------------------------------------------------------------------------------------------------------------------//
...
$_SESSION['pagina_salir_visitante']           = '';
