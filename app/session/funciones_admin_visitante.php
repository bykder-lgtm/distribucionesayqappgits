...
if ($cod_seguridad_sec == '1') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '2') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '3') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '4') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '5') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '6') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '7') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '8') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '9') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '10') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '11') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
if ($cod_seguridad_sec == '12') { $pag_redirec_sesion_descryp = "ver_producto_visitante.php";
$pag_redirec_sesion_cryp = DAXCRYPTOR::encriptardax($pag_redirec_sesion_descryp);
}
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
