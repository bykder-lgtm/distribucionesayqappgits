                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="nav-item"><a class="nav-link" href="../admin/lista_info_factura_venta_abierta_siscredito_visitante_intern_aliado_estrategico.php">Transacciones Abiertas</a></li>
                            <li class="nav-item"><a class="nav-link" href="../admin/lista_info_factura_venta_cerrada_siscredito_visitante_intern_aliado_estrategico.php">Transacciones Cerradas</a></li>
                            <!--<li class="nav-item"><a class="nav-link" href="../admin/lista_cliente_siscredito_visitante_intern.php">Clientes</a></li>-->
                            <li class="nav-item"><a class="nav-link" href="../admin/ver_producto_visitante_intern_simulador_credito_interes_max_entidad_crediticia.php">Tienda Virtual</a></li>
                            <!--
                            ...
                            -->
                            <li class="nav-item"><a class="nav-link" href="../admin/simulador_credito_visitante_intern_interes_max_entidad_crediticia_libre.php">Simulador de Credito</a></li>
