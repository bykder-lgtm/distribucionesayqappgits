        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../admin/ver_producto_visitante_ext.php"><img src="../imagenes/logo.png" class="logo" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="nav-item"><a class="nav-link" href="../admin/ver_producto_visitante_ext.php">Tienda Virtual</a></li>
                            <li class="nav-item"><a class="nav-link" href="../admin/carrito_compra_temporal_visitante_ext.php">Carrito</a></li>
...
<?php } ?>
                        <li class="total">
                            <a href="../admin/carrito_compra_temporal_visitante_ext.php" class="btn btn-default hvr-hover btn-cart">VER CARRITO</a>
