        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <?php if ($tipo_dispositivo_encontrado == 'PC') { ?>
                    <a class="navbar-brand" href="../admin/facturacion_venta_temporal_producto_manual_pos_tactil.php"><img src="../imagenes/logo.png" class="logo" alt=""></a>
                <?php } ?>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="nav-item"><a class="nav-link" href="../admin/facturacion_venta_temporal_producto_manual_pos_version_tactil.php">Tienda Virtual</a></li>
                            <li class="nav-item"><a class="nav-link" href="../admin/carrito_compra_temporal_version_tactil.php">Pedidos</a></li>
                            <li class="nav-item"><a class="nav-link" href="../session/salir_visitante_ext.php?token=<?php echo $token ?>&pagina_salir=<?php echo $pagina_salir_visitante ?>">Salir</a></li>
                        </ul>
                </div>
<?php
$conteo = 0;
$sql_producto_total = "SELECT SUM(und_venta * precio_venta_producto) as total_venta FROM tbl15_venta_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
?>
                ...
                <div class="attr-nav">
                    <ul>
                        <li class="side-menu"><a href="#"><i class="fa fa-shopping-bag"></i>-<span class="badge" id="total_reg_carrito"><div id="salida_info_actualizada_carrito_compra_menu_total_venta_reg_ajax">$ <?php echo number_format($total_venta_tactil, 0, ",", ".") ?></div></span></a></li>
                    </ul>
                </div>
...
<?php } ?>
                        <li class="total">
                            <a href="../admin/carrito_compra_temporal_version_tactil.php" class="btn btn-default hvr-hover btn-cart">VER CARRITO</a>
