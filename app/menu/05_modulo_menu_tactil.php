                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="nav-item"><a class="nav-link" href="../admin/facturacion_venta_temporal_producto_manual_pos_tactil.php">Tienda Virtual</a></li>
                            <li class="nav-item"><a class="nav-link" href="../admin/carrito_compra_temporal_tactil.php">Pedidos</a></li>
...
$sql_venta_producto_temporal = "SELECT * FROM tbl15_carrito_compra_temporal WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<?php } ?>
                        <li class="total">
                            <a href="../admin/carrito_compra_temporal_tactil.php" class="btn btn-default hvr-hover btn-cart">VER CARRITO</a>
