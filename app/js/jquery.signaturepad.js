...
$.fn.signaturePad.defaults = {
  ...
  , errorMessage : 'Por favor, escriba su nombre' // The error message displayed on invalid submission
  , errorMessageDraw : 'Por favor firme el documento' // The error message displayed when drawOnly and no signature is drawn
