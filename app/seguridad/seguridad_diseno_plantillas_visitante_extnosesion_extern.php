...
if (($inicio_sesion == 'SI') && ($cod_seguridad == '1') && (isset($_SESSION['cuenta_actual']))) { 
	include_once('app/menu/05_modulo_menu_visitante_extnosesion_extern.php');
}
elseif (($inicio_sesion == 'SI') && ($cod_seguridad == '2') && (isset($_SESSION['cuenta_actual']))) { 
	include_once('app/menu/05_modulo_menu_visitante_extnosesion_extern.php'); 
}
elseif (($inicio_sesion == 'SI') && ($cod_seguridad == '3') && (isset($_SESSION['cuenta_actual']))) { 
	include_once('app/menu/05_modulo_menu_visitante_extnosesion_extern.php'); 
}
elseif (($inicio_sesion == 'NO')) { 
	...
	//header("Location:acceso_denegado_visitante_extnosesion.php"); 
	?>
	<META HTTP-EQUIV="REFRESH" CONTENT="0; <?php echo ($nombre_carpeta_pagina) ?>/admin/acceso_denegado_siscredit_visitante_extnosesion.php"> 
<?php
}
?>