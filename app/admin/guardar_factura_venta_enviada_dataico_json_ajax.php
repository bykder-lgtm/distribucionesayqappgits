...
$nombre_tipo_cobro                  = date("Y-m-d H:i:s").'|'.$cuenta;
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_info_factura_venta') && ($tipo_ajax=='tbl15_info_factura_venta')) {
	...
	tiempo_ejecucion_dian_dataico = '$tiempo_ejecucion_dian_dataico', nombre_tipo_cobro = '$nombre_tipo_cobro' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
