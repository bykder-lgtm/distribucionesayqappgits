...
<head>
    ...
    <style>
        /* ============================================ */
        /* CAMBIAR PASSWORD vendedor - TEMA VERDE ESMERALDA */
        /* ============================================ */
...
<main class="page-container">
    ...
    <div class="page-header animate-in">
        <h1>
            <button class="back-btn" onclick="window.location.href='perfil_vendedor_movil.php'">
...
<script>
    ...
    $(document).ready(function() {
        $('#formPassword').on('submit', function(e) {
            ...
            $.ajax({
                url: 'cambiar_contrasena_vendedor_ajax.php',
                type: 'POST',
                data: $(this).serialize(),
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = 'perfil_vendedor_movil.php';
                        });
