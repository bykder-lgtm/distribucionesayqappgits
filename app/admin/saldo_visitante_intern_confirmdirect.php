                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">Saldo Actual (Monedero)</th>
                                    <?php if ($cod_estado_puntos_redimibles_campanya_recarga_global == '1') { ?><th style="text-align:center;">Saldo Actual (Puntos Redimibles)</th><?php } ?>
                                    <th style="text-align:center;">ID</th>
                                </tr>
                            </thead>
                          <tbody>
<?php
$sql_total_tipo_factura = "SELECT cod_administrador, cuenta, nombre1_tercero, apellido1_tercero, correo, identificacion_tercero, total_saldo_recarga, total_puntos_redimibles_campanya_tercero 
...
$correo_vendedor_tercero                            = $datos_total_tipo_factura['correo'];
...
$total_puntos_redimibles_campanya_tercero           = $datos_total_tipo_factura['total_puntos_redimibles_campanya_tercero'];
...
?>
                                <tr>
                                    ...
                                    <?php if ($cod_estado_puntos_redimibles_campanya_recarga_global == '1') { ?><td style="text-align:center;"><?php echo number_format($total_puntos_redimibles_campanya_tercero, 0, ",", ".") ?></td><?php } ?>
