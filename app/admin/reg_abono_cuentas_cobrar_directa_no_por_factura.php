...
if (isset($_GET['pagina'])) { $pagina = addslashes($_GET['pagina']); } else { $pagina = "../admin/cuentas_cobrar_detalle_factura_directa_no_por_factura.php"; }
...
$nombre_modulo_puc                                 = 'ABONOS CUENTAS POR COBRAR';
$cod_sino                                          = 2;
?>
...
<tr>
<td style="text-align:center"><strong><a href="../admin/cuentas_cobrar_detalle_factura_directa_no_por_factura.php?cod_tercero=<?php echo $cod_tercero;?>&cliente=<?php echo $cliente;?>"><font size="5px">REGRESAR</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
...
<td><font size="6"><?php echo number_format($total_monto_deuda_cuenta_cobrar, 0, ",", "."); ?></font></td>
</tr>
<tr valign="baseline">
<td nowrap align="left"><font size="6">TOTAL PENDIENTE:</font></td>
<td><font size="6"><?php echo number_format($total_subtotal_cuenta_cobrar, 0, ",", "."); ?></font></td>
</tr>
</table>

<br>

<form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/reg_abono_cuentas_cobrar_directa_no_por_factura_reg.php">
<table class="table table-striped">
    <tr>
    ...
    <tr>
        <td style="text-align:center"><input style="font-size:24px; width: 150px;" type="number" name="abonado" value="" max="<?php echo $total_subtotal_cuenta_cobrar; ?>" required></td>
    ...
    <?php if ($cod_estado_movimiento_contable_cuenta_personal_global == '1') { ?>
        <td style="text-align:center">
            <select name="cod_movimiento_contable_cuenta_personal" id="cod_movimiento_contable_cuenta_personal" class="cod_movimiento_contable_cuenta_personal" data-show-subtext="true" data-live-search="true" style="width: 170px;" tabindex="1" required>
...
<?php if ($cod_estado_modulo_puc_global == '1') { ?>
    ...
    $(document).ready(function(){
        $("#cod_tipo_forma_pago").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: "../admin/parametrizacion_puc_movimiento_contable_cuenta_cobrar_ajax.php",
                data: datos_url_ajax,
                //dataType: 'json',
