...
if (isset($_GET['fecha_pago_reg_ini'])) { 
	...
	$fecha                         = date("Y_m_d");
	$hora                          = date("H_i_s");
	$nombre_archivo                = "REPORTE_GENERAL_TOTAL_EGRESOS_".$fecha.'__'.$fecha;
	$cabecera_emp                  = "REPORTE_GENERAL_TOTAL_EGRESOS";
...
//-----------------------------------------------------------------------------------------------------//
// Headers
	$writer->addRow(array('TOTAL EGRESO INMOBILIARIA (EGRESO_P)', 'TOTAL EGRESO JURIDICA (EGRESO_P)', 'TOTAL EGRESO ABOGADO YAMID (EGRESO_P)', 'TOTAL EGRESO ABOGADO TRILLO (EGRESO_P)', 'TOTAL EGRESOS'));
// Then a foreach
/*
...
*/
		$writer->addRow(array($total_otros_egresos_inmobil, $total_otros_egresos_juridica, $total_otros_egresos_abogado_yamid, $total_otros_egresos_abogado_trillo, $total_otros_egresos));
	//}
	$writer->close();
}