...
<td align="Left"><a href="../admin/reg_factura_compra_temporal_producto_reg.php?cod_producto_barra=<?php echo $cod_producto_barra?>&nombre_tipo_cargue_factura=<?php echo $nombre_tipo_cargue_factura?>&nombre_tipo_moneda=<?php echo $nombre_tipo_moneda?>&nombre_tipo_factura=<?php echo $nombre_tipo_factura?>&foco=<?php echo $foco?>&cod_estado_vacuna=<?php echo $cod_estado_vacuna?>&pagina=<?php echo $pagina?>" tabindex=3><?php echo $nombre_producto ?></a></td>
