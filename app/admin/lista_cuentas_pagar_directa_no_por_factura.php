...
<a href="../admin/lista_cuentas_pagar_archivado.php"><h4>Lista Cuentas por Pagar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<?php if ($cod_estado_cuenta_pagar_registrar == '1') { ?>
<a href="../admin/reg_cuentas_pagar_manual_directa_no_por_factura.php">Crear nueva cuenta por pagar</h4></a>
<?php } ?>
</div>
...
$sql_total_cuenta_pagar = "SELECT SUM(total_monto_deuda_cuenta_pagar) AS total_monto_deuda_cuenta_pagar_sum, SUM(total_abonado_cuenta_pagar) AS total_abonado_cuenta_pagar_sum, 
SUM(total_subtotal_cuenta_pagar) AS total_subtotal_cuenta_pagar_sum FROM tbl15_tercero";
...
$total_monto_deuda_cuenta_pagar_sum            = $datos_total_cuenta_pagar['total_monto_deuda_cuenta_pagar_sum'];
$total_abonado_cuenta_pagar_sum                = $datos_total_cuenta_pagar['total_abonado_cuenta_pagar_sum'];
$total_subtotal_cuenta_pagar_sum               = $datos_total_cuenta_pagar['total_subtotal_cuenta_pagar_sum'];
...
<td align="center"><strong><font size='4'><?php echo number_format($total_subtotal_cuenta_pagar_sum, 0, ",", ".") ?></font></strong></td>
...
if (isset($_POST['palabra'])) { 
	...
	$calcular_datos_cuenta_pagar = "SELECT cod_tercero, nombre1_tercero, nombre2_tercero, apellido1_tercero, apellido2_tercero, total_monto_deuda_cuenta_pagar, total_subtotal_cuenta_pagar, total_abonado_cuenta_pagar, direccion_tercero, 
...
while ($datos_cuenta_pagar = mysqli_fetch_assoc($consulta_datos_cuenta_pagar)) {
	...
	$cliente                                           = $datos_cuenta_pagar['nombre1_tercero']." ".$datos_cuenta_pagar['nombre2_tercero']." ".$datos_cuenta_pagar['apellido1_tercero']." ".$datos_cuenta_pagar['apellido2_tercero'];
...
?>
		<tr>
			...
			<?php } ?>
			<td><font size='4'><a href="../admin/cuentas_pagar_detalle_factura_directa_no_por_factura.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $identificacion_tercero;?></a></font></td>
			<td><font size='4'><a href="../admin/cuentas_pagar_detalle_factura_directa_no_por_factura.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $cliente;?></a></font></td>
			...
			<td style="text-align: center;"><font size='4'><a href="../admin/cuentas_pagar_cliente_actualizar_directa_no_por_factura.php?cod_tercero=<?php echo $cod_tercero; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/correcto.png"></a></font></td>
		</tr>
<?php } ?>
	</tbody>
</table>
