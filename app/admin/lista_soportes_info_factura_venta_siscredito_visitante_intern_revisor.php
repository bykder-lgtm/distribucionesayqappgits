                        ...
                        <div class="row p-3 mb-2 bg-primary text-white">
                            <div class="col-md-12">
                                <div style="text-align:center;" class="">
                                    <a href="../admin/lista_info_factura_venta_siscredito_visitante_intern.php"><?php echo $nombre_cliente ?> | <?php echo $nombre_entidad_crediticia ?> | <?php echo $nombre_producto ?> | <?php echo number_format($monto_deuda, 0, ",", ".") ?></a>
                                    ...
                                    <?php if ($nombre_estado_factura == 'CERRADA') { ?>
                                        <br><br>
                                        <a href="../admin/venta_productos_opcion_imprimir_siscredito_visitante_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&modo_venta_por_defecto=<?php echo $modo_venta_por_defecto ?>&pagina=<?php echo $pagina ?>">Ver Factura</a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
...
<input type='hidden' value='<?php echo $nombre_nota_observacion;?>' id='nombre_nota_observacion<?php echo $cod_nota_observacion;?>'>
                            ...
                            <?php if ($codigo_estado_revision == '0') { // 0 POR CARGAR ?>
                                <div class="col-md-6">
                                    <div style="text-align:center;" class=""><?php echo $url_estado_soporte.$previsualizar_soporte ?>
                                        <a class="btn btn-primary btn-lg btn-block" href="../admin/soporte_cargar_por_camara_info_factura_venta_cliente_siscredito_visitante_intern.php?cod_nota_observacion=<?php echo $cod_nota_observacion?>&cod_info_factura_venta=<?php echo $cod_info_factura_venta?>&cod_tercero=<?php echo $cod_tercero?>&codigo_tipo_cague_documento_camara=1&pagina=<?php echo $pagina?>"><span class="fas fa-camera"></span> Camara</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div style="text-align:center;" class=""><?php echo $url_estado_soporte.$previsualizar_soporte ?>
                                        <a class="btn btn-success btn-lg btn-block" href="../admin/soporte_cargar_por_documento_info_factura_venta_cliente_siscredito_visitante_intern.php?cod_nota_observacion=<?php echo $cod_nota_observacion?>&cod_info_factura_venta=<?php echo $cod_info_factura_venta?>&cod_tercero=<?php echo $cod_tercero?>&codigo_tipo_cague_documento_camara=0&pagina=<?php echo $pagina?>"><span class="fas fa-file"></span> Documento</a>
                                    </div>
                                </div>
                            <?php } else { ?>
                                <div class="col-md-12">
                                    <div style="text-align:center;" class="">ESTADO: 
                                        ...
                                        <?php echo $previsualizar_soporte ?>
