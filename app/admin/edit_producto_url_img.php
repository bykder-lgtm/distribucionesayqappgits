...
<table border="1" class="table table-responsive">
	<thead>
		<tr>
		  <th style="text-align:center"><img src="<?php echo $url_img_orig_producto ?>" width="50%" class="img-rounded" /></th>
		</tr>
	</thead>
</table>
<!-- ***************************************************************************************************************************** -->
...
<!-- ***************************************************************************************************************************** -->
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/edit_producto_url_img_reg.php">
<fieldset>
<table border="1" class="table table-responsive">
	<thead>
		<tr>
...
<input type="hidden" name="cod_producto_imagen" value="<?php echo $cod_producto_imagen ?>">
