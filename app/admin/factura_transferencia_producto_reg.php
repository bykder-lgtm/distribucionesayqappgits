...
SUM(und_compra * precio_venta_producto) AS total_precio_venta FROM tbl15_transferencia_producto_temporal WHERE (cod_info_factura_transferencia = '$cod_info_factura_transferencia')";
...
if (isset($_POST['cod_info_factura_transferencia'])) {
...
$agregar_reg_compra_producto = "INSERT INTO tbl15_factura_transferencia_producto (cod_info_factura_transferencia, cod_tercero, cod_doc_soporte, cod_caja_virtual, 
...
VALUES ('$cod_info_factura_transferencia', '$cod_tercero', '$cod_doc_soporte', '$cod_caja_virtual', 
...
fecha_ult_compra = '$fecha_ult_compra', tope_min = '$tope_min', cod_info_factura_transferencia = '$cod_info_factura_transferencia', 
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$agregar_regis = sprintf("UPDATE tbl15_info_factura_transferencia SET total = '$total', subtotal_total_precio_compra = '$subtotal_total_precio_compra', 
...
vendedor, cuenta, fecha_pago, fecha, fecha_invert, fecha_seg, cod_info_factura_transferencia)
VALUES ('$cod_factura', '$cod_tercero', '$monto_deuda', '$subtotal', 
'$vendedor', '$cuenta', '$fecha_pago', '$fecha', '$fecha_invert', '$fecha_seg', '$cod_info_factura_transferencia')";
$resultado_compra_producto = mysqli_query($conectar, $agregar_reg_compra_producto) or die(mysqli_error($conectar));
}
$url_redir = "../admin/factura_transferencia_productos_opcion_imprimir.php?cod_info_factura_transferencia=".$cod_info_factura_transferencia."&cod_tipo_pago=".$cod_tipo_pago."&pagina=".$pagina;
