...
$pagina                               = '../admin/lista_cierre_caja.php?cod_cierre_cajas='.$cod_cierre_cajas;
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>CIERRE:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo $cod_cierre_caja; ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>VENDEDOR:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo $cuenta; ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>BASE:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo number_format($total_base_cierre_caja, 0, ",", "."); ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>TOTAL FISICO:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo number_format($total_fisico_cierre_caja, 0, ",", "."); ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>BASE + FISICO:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo number_format($total_base_cierre_caja + $total_fisico_cierre_caja, 0, ",", "."); ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>TOTAL SISTEMA:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo number_format($total_sistema_cierre_caja, 0, ",", "."); ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>TOTAL SISTEMA EN EFECTIVO:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo number_format($total_sistema_contado_efectivo_cierre_caja, 0, ",", "."); ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>FECHA DE CIERRE:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo $fecha_anyo; ?></strong></font></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 50%; font-family: Courier; font-size:8pt;"><font><strong>HORA DE CIERRE:</strong></font></td>
    <td style="text-align: right; width: 50%; font-family: Courier; font-size:8pt;"><font><strong><?php echo $hora_cierre_caja; ?></strong></font></td>
  </tr>
</table>
