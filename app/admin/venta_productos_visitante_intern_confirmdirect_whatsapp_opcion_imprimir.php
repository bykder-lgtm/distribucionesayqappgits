                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="text-align:center;"><a href="../admin/contactar_por_whatapp_telefono_intern_confirmdirect.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&accion_codifcryp=<?php echo $accion_whatapp_codifcryp ?>&tipo_codifcryp=<?php echo $tipo_codifcryp ?>&origen_codifcryp=<?php echo $origen_codifcryp ?>" target="_blank"><img src="../imagenes/btn_tel_whatapp_solo.png" /><br>Enviar</a></th>
                                </tr>
                            </thead>
                        </table>
...
?>
                        ...
                        <div class="col-xl-12 col-lg-5 col-md-6">
                            <div class="single-product-details">
                            <h2><div style="text-align:center;" id="texto_resaltado">Detalles de facturación</div></h2>
                            </div>
                        </div>

                        <div class="col-xl-12 col-lg-5 col-md-6">
                            <div class="single-product-details">
                            <h2><div style="text-align:center;" id="texto_resaltado">URBAN STREAMING</div></h2>
                            <h2><div style="text-align:center;" id="texto_resaltado"><?php echo $correo ?></div></h2>
                            </div>
                        </div>
