...
if (isset($_GET['fecha_ymd_venta_producto_ini'])) {
  ...
  $nombre_tipo_asunto                         = 'Resoluciones a Vencer';
  ...
  * { line-height: inherit; }
  ...
  <thead>
    <tr>
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>ID</span></th>
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>TIPO DE FACTURACION</span></th>
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>NUMERO DE RESOLUCION</span></th>
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>FECHA DE RESOLUCION</span></th>
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>VIGENCIA RESOLUCION (MESES)</span></th>
      ...
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>ESTADO</span></th>
    </tr>
  </thead>
  <tbody>
  ";
  ...
  $mostrar_datos_sql = "SELECT * FROM tbl15_resolucion_facturacion WHERE (fecha_vencimiento_resolucion_facturacion BETWEEN '$fecha_hoy' AND '$fecha_vencimiento_ref') AND (nombre_tipo_estado = 'ACTIVO')";
  ...
  $mensaje .= "
    <tr>
      <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$cod_resolucion_facturacion."</span></td>
      <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$nombre_tipo_resolucion_facturacion."</span></td>
      <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$numero_resolucion_facturacion."</span></td>
      <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$fecha_resolucion_facturacion."</span></td>
      <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$vigencia_meses_resolucion_facturacion."</span></td>
      <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$fecha_vencimiento_resolucion_facturacion.''.$titulo_alerta."</span></td>
      <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$nombre_tipo_estado."</span></td>
    </tr>
  ";
  }
  $mensaje .= "
  ...
  if ($total_reg <> '0') {
    ...
    $cod_tipo_modulo_envio_correo         = "5";
    $nombre_tipo_modulo_envio_correo      = "RESOLUCION DE FACTURACION A VENCER - EDITAXE POS";
    $id_origen_correo                     = "";
    ...
    $nombre_origen_correo                 = "Recordatorio resolucion facturacion a vencer";
