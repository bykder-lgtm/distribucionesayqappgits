...
//---------------------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------------------//
    if ($btn_enviar == 'btn_Eliminar_Ocupado') {
        $cod_estado_habitacion_hotel = 0;

        $sql_venta_producto_temporal = "SELECT * FROM tbl15_venta_producto_temporal WHERE (cod_venta_producto_temporal = '$cod_venta_producto_temporal')";
        ...
        $cod_caja_virtual                            = $datos_venta_producto_temporal['cod_caja_virtual'];
        ...
        $total_compra_producto                       = $datos_venta_producto_temporal['total_compra_producto'];
        ...
        $fecha_ymd_venta_producto                    = $datos_venta_producto_temporal['fecha_ymd_venta_producto'];
        $fecha_mes_venta_producto                    = $datos_venta_producto_temporal['fecha_mes_venta_producto'];
        $fecha_anyo_venta_producto                   = $datos_venta_producto_temporal['fecha_anyo_venta_producto'];
        ...
        $iva_ptj                                     = $datos_venta_producto_temporal['iva_ptj'];
        ...
        $cod_estado_habitacion_hotel                 = $datos_venta_producto_temporal['cod_estado_habitacion_hotel'];
        $cod_tipo_habitacion_hotel                   = $datos_venta_producto_temporal['cod_tipo_habitacion_hotel'];
        $total_horas                                 = $datos_venta_producto_temporal['total_horas'];

        $sql_data = "INSERT INTO tbl15_venta_producto_temporal_copia (cod_venta_producto_temporal, cod_info_factura_venta, cod_caja_virtual, cod_producto, cod_producto_barra, nombre_producto, 
        und_venta, precio_compra_producto, total_compra_producto, precio_costo_producto, total_costo_producto, precio_venta_producto, 
        total_venta_producto, precio_venta_producto_orig, nombre_tipo_producto, nombre_tipo_unidad_medida, cod_tercero, 
        fecha_ymd_venta_producto, fecha_mes_venta_producto, fecha_anyo_venta_producto, fecha_seg_venta_producto, cuenta, 
        cod_administrador, cod_base_caja, cod_tipo_cobrar, iva_ptj, nombre_tipo_precio_venta, fecha_ymd_parqueo_ini, 
        fecha_hora_parqueo_ini, fecha_ymd_parqueo_fin, fecha_hora_parqueo_fin, cod_check_imp, cod_estado_componente_und_venta, 
        cod_estado_habitacion_hotel, cod_tipo_habitacion_hotel, total_horas) 
        VALUES ('$cod_venta_producto_temporal', '$cod_info_factura_venta', '$cod_caja_virtual', '$cod_producto', '$cod_producto_barra', '$nombre_producto', 
        '$und_venta', '$precio_compra_producto', '$total_compra_producto', '$precio_costo_producto', '$total_costo_producto', '$precio_venta_producto', 
        '$total_venta_producto', '$precio_venta_producto_orig', '$nombre_tipo_producto', '$nombre_tipo_unidad_medida', '$cod_tercero', 
        '$fecha_ymd_venta_producto', '$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', '$fecha_seg_venta_producto', '$cuenta', 
        '$cod_administrador', '$cod_base_caja', '$cod_tipo_cobrar', '$iva_ptj', '$nombre_tipo_precio_venta', '$fecha_ymd_parqueo_ini', 
        ...
        $sql_data = sprintf("UPDATE tbl15_info_factura_venta SET fecha_ymd_parqueo_ini = '', fecha_hora_parqueo_ini = '', fecha_ymd_parqueo_fin = '', fecha_hora_parqueo_fin = '', 
        cod_estado_habitacion_hotel = '', cod_tipo_habitacion_hotel = '', total_horas = '' WHERE (cod_info_factura_venta = '$cod_info_factura_venta')");
        $exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
        ...
        $datos_info_factura_cero = "SELECT cod_venta_producto_temporal FROM tbl15_venta_producto_temporal WHERE (cod_info_factura_venta = '$cod_info_factura_venta')";
    ...
    } elseif ($btn_enviar == 'btn_Facturar_Alquiler_Ocupado') {
        $pagina_redirect = "../admin/venta_producto_hotel.php?cod_info_factura_venta=".$cod_info_factura_venta."&cuenta=".$cuenta."&cod_caja_virtual=".$cod_caja_virtual;
    ?>
<?php
