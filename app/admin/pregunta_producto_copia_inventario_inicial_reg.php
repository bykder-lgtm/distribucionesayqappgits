...
$nombre_tipo_inventario             = "COMPLETO";
...
$total_precio_compra_producto_inv_nuevo         = $datos_conteo_atendido_mujer['total_precio_compra_producto_inv_viejo'];
$total_precio_costo_producto_inv_nuevo          = $datos_conteo_atendido_mujer['total_precio_costo_producto_inv_viejo'];
$total_precio_venta_producto_inv_nuevo          = $datos_conteo_atendido_mujer['total_precio_venta_producto_inv_viejo'];
...
total_precio_compra_producto_inv_nuevo, total_precio_costo_producto_inv_nuevo, total_precio_venta_producto_inv_nuevo, cod_estado) 
...
cod_info_producto_copia_inventario, cod_producto, cod_estado_subproducto, cod_producto_barra, nombre_producto, und_producto_viejo, und_producto_nuevo, und_producto_bodega, precio_compra_producto, 
...
url_img_producto_min, url_img_producto_orig, nombre_promocion, nombre_promocion_ing, nombre_tipo_inventario, nombre_letra_alfabeto, fecha_actualizacion
) 
SELECT 
'$cod_info_producto_copia_inventario', cod_producto, cod_estado_subproducto, cod_producto_barra, nombre_producto, und_producto, und_producto, und_producto_bodega, precio_compra_producto, 
precio_costo_producto, precio_venta_producto, precio_venta_producto2, precio_venta_producto3, precio_venta_producto4, precio_venta_producto5, 
total_precio_venta_producto, total_precio_costo_producto, nombre_tipo_unidad_medida, posologia_cantidad, posologia_peso, iva_ptj, nombre_tipo_producto, 
nombre_tipo_presentacion, nombre_via_administracion, nombre_frec_duracion, cod_marca, cod_proveedor, cod_tercero, cod_estado, cod_dependencia, 
fecha_ult_compra, fecha_ult_venta, fecha_vencimiento1, vencimiento_lote1, fecha_vencimiento2, vencimiento_lote2, tope_min, '$fecha_creacion', fecha_modificacion, 
