...
<!-- Start Cart  -->
<form name="formulario_de_actualizacion" method="POST" enctype="multipart/form-data" action="../admin/simulador_credito_producto_visitante_intern_interes_funcionamiento_resultado_get.php">
