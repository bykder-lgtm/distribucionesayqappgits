...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    '$telefono', '$correo', '$nombre_tipo_cliente', '$nombre_tipo_regimen', '$nombre_tipo_impuesto', '$cod_administrador_actual', '$cod_coordinador', '$cod_asesor_id', '$cod_estado_activacion_usuario', '1', 
