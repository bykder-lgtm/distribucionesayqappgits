...
tbl15_cliente.fecha_nac_time, tbl15_cliente.nombre_grupo_rh, tbl15_cliente.tel_cliente, tbl15_cliente.tel_contacto1, tbl15_historia_clinica.fecha_ymd, tbl15_historia_clinica.hora
FROM tbl15_historia_clinica RIGHT JOIN tbl15_cliente ON tbl15_historia_clinica.cod_cliente = tbl15_cliente.cod_cliente WHERE tbl15_historia_clinica.cod_administrador = '$cod_administrador'
