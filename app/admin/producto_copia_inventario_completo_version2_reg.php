...
if (isset($_POST["cod_info_producto_copia_inventario"])) {
    ...
    $sql_productos_sin_contar = "SELECT * FROM tbl15_producto_copia_inventario WHERE (cod_info_producto_copia_inventario = '$cod_info_producto_copia_inventario') AND (cod_estado = '0')";
    $resultado_productos_sin_contar = mysqli_query($conectar, $sql_productos_sin_contar) or die(mysqli_error($conectar));
    $total_productos_sin_contar = mysqli_num_rows($resultado_productos_sin_contar);

    if ($total_productos_sin_contar > 0) {
    	$pagina_redirect = "../admin/alerta_productos_sin_contar_inventario_completo_version2.php?cod_info_producto_copia_inventario=".$cod_info_producto_copia_inventario."&total_productos_sin_contar=".$total_productos_sin_contar;
    } else {
	    ...
	    while ($info_producto_con_existencia_no_cargado = mysqli_fetch_assoc($resultado_producto_con_existencia_no_cargado)) {
			...
			$sql_data = sprintf("UPDATE tbl15_producto_copia_inventario SET cod_estado = '$cod_estado', fecha_creacion = '$fecha_creacion', fecha_actualizacion = '$fecha_actualizacion' 
    	...
    	$pagina_redirect = "../admin/lista_info_producto_copia_inventario.php?cod_info_producto_copia_inventario=".$cod_info_producto_copia_inventario."&total_productos_sin_contar=".$total_productos_sin_contar;
    }
?>
