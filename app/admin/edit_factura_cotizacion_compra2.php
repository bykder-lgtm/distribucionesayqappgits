...
$sql_profesional = "SELECT cod_factura FROM tbl15_info_cotizacion_factura_compra WHERE cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra'";
...
$incre                                  = 0;
$tab                                    = 'tbl15_info_cotizacion_factura_compra';
$campo                                  = 'cod_info_cotizacion_factura_compra';
$tipo                                   = 'eliminar';
...
var cod_info_cotizacion_factura_compra=document.getElementById('cod_info_cotizacion_factura_compra').value;
...
xmlhttp.send("buscar="+valor_buscar+"&cod_info_cotizacion_factura_compra="+cod_info_cotizacion_factura_compra+"&pagina="+pagina);
}
</script>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr><td bgcolor="#fff" align="center"><strong><a href="../admin/lista_info_factura_cotizacion_compra.php">LISTA DE COTIZACIONES</a></strong></td></tr></tbody>
</table>

<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr><td bgcolor="#fff" align="center"><strong>EDICION COTIZACION DE COMPRA</strong></td></tr></tbody>
</table>
...
$suma_temporal = "SELECT  Sum(total_compra_producto) As total_compra, Sum(total_costo_producto) As total_compra FROM tbl15_cotizacion_compra_producto WHERE (cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra')";
...
$cod_info_cotizacion_factura_compra      = $data_info_factura['cod_info_cotizacion_factura_compra'];
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            var tipo_ajax = "tbl15_info_cotizacion_factura_compra";
            $.post("guardar_info_factura_y_cotizacion_compra_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_cotizacion_factura_compra; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_cotizacion_compra_producto";
            var id = $(this).attr("class");
            //let id = this.id;
            $.post("guardar_info_factura_y_cotizacion_compra_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
-->
  ...
  <tr>
   <td style="text-align:center;"></td>
   <td style="text-align:center;"><a href="../admin/eliminar_cotizacion_compra.php?llave=<?php echo $cod_info_cotizacion_factura_compra?>&tab=<?php echo $tab?>&campo=<?php echo $campo?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/eliminar_grand.png" class="img-polaroid" alt=""></a></td>
   <td style="text-align:center;"><?php echo $cod_info_cotizacion_factura_compra ?></td>
...
-->
    ...
    <td style="text-align:center;"><a href="../admin/enviar_cotizacion_compra_a_venta_producto_temporal.php?cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra?>&tab=<?php echo $tab?>&campo=<?php echo $campo?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/agregar.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"></td>
  </tr>
</table>
<!-- ***************************************************************************************************************************** -->
...
<td style="text-align:center;"></td>
<td  style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_cotizacion_compra_producto?>&cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>&tab=<?php echo $tab ?>&tipo=<?php echo $tipo ?>&campo=<?php echo $campo ?>&pagina=<?php echo $pagina_local ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>
<!--<td style="text-align:center"><input name="cod_tipo_cobrar" class="cod_tipo_cobrar__<?php echo $cod_cotizacion_compra_producto;?>" id="cod_tipo_cobrar_<?php echo $cod_cotizacion_compra_producto;?>" type="checkbox" value="1" <?php if($cod_tipo_cobrar=='1'){ echo "checked"; } ?>></td>-->
<!--<td style="text-align:center;" id="cod_cotizacion_compra_producto_<?php echo $cod_cotizacion_compra_producto ?>" class="service_list" data="<?php echo $cod_cotizacion_compra_producto ?>"><a class="eliminar" id="cod_cotizacion_compra_producto<?php echo $cod_cotizacion_compra_producto ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>-->
...
<td style="text-align:right;" id="und_compra_<?php echo $incre;?>"><input name="und_compra" type="number" id="und_compra-<?php echo $incre;?>" class="<?php echo $cod_cotizacion_compra_producto;?>" onChange="calc_total_venta();" value="<?php echo $und_compra;?>" style="width: 70px;" /></td>
<td style="text-align:center;" id="nombre_tipo_unidad_medida_<?php echo $incre;?>"><?php echo $nombre_tipo_unidad_medida;?></td>
<td style="text-align:right;" id="precio_venta_producto_<?php echo $incre;?>"><input name="precio_compra_producto" type="number" id="precio_compra_producto-<?php echo $incre;?>" class="<?php echo $cod_cotizacion_compra_producto;?>" onChange="calc_total_venta();" value="<?php echo $precio_compra_producto;?>" style="width: 100px;" /></td>
<td style="text-align:right;" id="mensaje_alerta_<?php echo $incre;?>"></td>
<td style="text-align:right;" id="total_compra_producto_<?php echo $incre;?>"><?php echo number_format($total_compra_producto, 0, ",", ".");?></td>
<td style="text-align:center;"></td>
...
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  <tr>
<!--
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=EXCEL&cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/excel.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=FACTURA&cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/imprimir_peq.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=LISTA&cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></td>
-->
    <td style="text-align:center;"><a href="../admin/cotizacion_compra_productos_opcion_imprimir.php?cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos.png" class="img-polaroid" alt=""></a></td>
  </tr>
</table>
</div>
<!-- ***************************************************************************************************************************** -->
...
total_venta_producto = (und_compra * precio_venta_producto);
...
$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
        ...
        var cod_cotizacion_compra_producto = $(this).parent().attr('data');
        var dataString = 'llave='+cod_cotizacion_compra_producto+'&'+'tab='+'<?php echo $tab ?>'+'&'+'campo='+'<?php echo $campo ?>'+'&'+'tipo='+'<?php echo $tipo ?>';
        ...
        $.ajax({
            ...
            success: function() {           
                $('#eliminar-ok').empty();
                $('#eliminar-ok').append('<div align="center" class="correcto">Se ha eliminado correctamente el codigo = '+cod_cotizacion_compra_producto+'.</div>').fadeIn("slow");
                $('#'+parent).fadeOut("slow");
                $('#cod_producto_barra_'+cod_cotizacion_compra_producto).fadeOut("slow");
                $('#nombre_cliente_'+cod_cotizacion_compra_producto).fadeOut("slow");
                $('#nombre_producto_'+cod_cotizacion_compra_producto).fadeOut("slow");
                $('#und_compra_'+cod_cotizacion_compra_producto).fadeOut("slow");
                $('#precio_venta_producto_'+cod_cotizacion_compra_producto).fadeOut("slow");
                $('#total_venta_producto_'+cod_cotizacion_compra_producto).fadeOut("slow");
                $('#tr'+cod_cotizacion_compra_producto).fadeOut("slow");
            }
        });
