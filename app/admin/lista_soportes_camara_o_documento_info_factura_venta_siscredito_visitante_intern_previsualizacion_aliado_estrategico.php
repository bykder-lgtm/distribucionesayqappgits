                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="contact-form-right">
                        <div class="row p-3 mb-2 bg-primary text-white">
                            <div class="col-md-1" style="text-align:center;"><a href="<?php echo $pagina_redirect_regresar ?>"><img style="width:50px;" class="w-1000 mb-4" src="../imagenes/regresar.png"></a></div>
                            <div class="col-md-11">
                                <div style="text-align:center;" class="">
                                    ...
                                    <?php if ($nombre_estado_factura == 'CERRADA') { ?>
                                        <br><br>
                                        <a href="<?php echo $pagina_redirect_imprimir_factura ?>">Ver Factura <img src="../imagenes/imprimir_.png" class="img-polaroid"></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
...
?>
                            <div class="row">
                                <?php if ($codigo_estado_revision == '0') { // 0 POR CARGAR ?>
                                    ...
                                    <?php } else { ?>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div style="text-align:center; <?php echo $color_fondo_celda_estado ?>; <?php echo $color_letra_celda_estado ?>" id="estado_revision_por_cargar<?php echo $cod_nota_observacion ?>" class=""><?php echo $nombre_nota_observacion ?> <br> ESTADO: <?php echo $nombre_estado_revision ?><br>
