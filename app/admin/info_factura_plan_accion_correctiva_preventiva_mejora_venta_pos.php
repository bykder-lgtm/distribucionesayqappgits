...
<?php
$suma_temporal = "SELECT Sum(total_venta_producto) As total_venta, Sum(total_costo_producto) As total_compra FROM tbl15_plan_accion_correctiva_preventiva_mejora 
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_y_plan_accion_correctiva_preventiva_mejora_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            //let id = this.id;
            $.post("guardar_info_factura_y_plan_accion_correctiva_preventiva_mejora_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
-->
   ...
   <td style="text-align:center;"><input name="vlr_cancelado" id="vlr_cancelado" type="number" value="<?php echo $vlr_cancelado ?>" style="width: 100px;" required/></td>
    ...
    <td style="text-align:center;"><a href="../admin/plan_accion_correctiva_preventiva_mejoras_opcion_imprimir.php?cod_info_plan_accion_correctiva_preventiva_mejora=<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora?>&pagina=<?php echo $pagina_local ?>"><img src="../imagenes/guardar.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"></td>

<?php 
$sql_temporal = "SELECT cod_plan_accion_correctiva_preventiva_mejora FROM tbl15_plan_accion_correctiva_preventiva_mejora 
WHERE (cod_info_plan_accion_correctiva_preventiva_mejora = '$cod_info_plan_accion_correctiva_preventiva_mejora')";
...
<input type="hidden" name="cod_plan_accion_correctiva_preventiva_mejora[]" value="<?php echo $datos_temporal['cod_plan_accion_correctiva_preventiva_mejora']; ?>" size="4">
<?php } ?>  
<?php $pagina ='facturacion_plan_accion_correctiva_preventiva_mejora_manual_pos.php'; ?>
