...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_cuentas_cobrar_version_independiente.php"><font size='+2'>REGRESAR</font></a></th>
    </tr>
</table>

<div class="table-responsive">
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/reg_cuentas_cobrar_manual_caja_registradora_reg.php">
<table class="table table-striped">
<thead>
<tr>
