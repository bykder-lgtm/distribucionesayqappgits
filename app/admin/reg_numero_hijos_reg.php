...
if (isset($_POST['nombre_numero_hijos']) <> '') { $nombre_numero_hijos = mysqli_real_escape_string($conectar, ($_POST['nombre_numero_hijos'])); } else { $nombre_numero_hijos = ''; }

$obtener_numero_hijos = "SELECT nombre_numero_hijos FROM tbl15_numero_hijos WHERE nombre_numero_hijos = '".($nombre_numero_hijos)."'";
...
<?php } else {
$sql_data = "INSERT INTO tbl15_numero_hijos (nombre_numero_hijos) VALUES ('$nombre_numero_hijos')";
