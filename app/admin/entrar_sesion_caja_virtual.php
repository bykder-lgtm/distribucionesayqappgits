...
if (isset($_GET["cod_caja_virtual"])) {
	...
	$pagina_redirect                  = $pagina.'?cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&cod_info_factura_venta='.$cod_info_factura_venta.'&modo_venta_por_defecto='.$modo_venta_por_defecto;
?>
