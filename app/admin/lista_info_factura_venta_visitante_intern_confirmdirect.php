...
while ($datos_total_tipo_factura = mysqli_fetch_assoc($consulta_total_tipo_factura)) {
    ...
    if ($nombre_estado_factura == 'CERRADA') { $nombre_estado_confirmacion = 'CONFIRMADA'; $url_estado_confirmacion = '../admin/ver_factura_venta_visitante_intern_confirmdirect_confirmada.php'; } else { $nombre_estado_confirmacion = 'EN ESPERA'; $url_estado_confirmacion = '../admin/ver_factura_venta_visitante_intern_confirmdirect_no_confirmada.php'; }
...
?>
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="../admin/lista_soporte_archivo_adjunto_info_factura_venta_visitante_intern_confirmdirect.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>"><img src="../imagenes/expediente.png" class="img-polaroid" alt=""></a></td>
