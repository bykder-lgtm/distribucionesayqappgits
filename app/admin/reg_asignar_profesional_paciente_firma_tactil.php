...
<tbody><tr>
<td style="text-align:center">
<select name="cod_grupo_area_cargo" id="cod_grupo_area_cargo" class="chosen-select" data-show-subtext="true" data-live-search="true">
...
<table border="1" class="table table-responsive">
    <thead><tr><th style="text-align:center; width:50%" bgcolor="#FAC090">VISTA PREVIA</th><th style="text-align:center; width:50%" bgcolor="#FAC090">IMAGEN TOMADA</th></tr></thead>
    <tbody>
        <tr>
            <td style="text-align:center; width:50%"><div align="center" id="vista_previa_camara"></div>
            <form><input type="button" value="Tomar Foto" onClick="tomar_foto(<?php echo $cod_cliente ?>, <?php echo $cedula ?>)"></form>
        </td>
