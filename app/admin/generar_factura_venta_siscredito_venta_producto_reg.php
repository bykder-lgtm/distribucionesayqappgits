...
if (isset($_GET['cod_info_factura_venta'])) {
    ...
    $modo_venta_por_defecto                                         = intval($_GET['modo_venta_por_defecto']);
    ...
    //---------------------------------------------------------------------------------------------------------------------------------//
    $pagina_redirect = "../admin/venta_productos_opcion_imprimir_siscredito_visitante_intern.php";
	//---------------------------------------------------------------------------------------------------------------------------------//
	$url_redir = $pagina_redirect."?cod_info_factura_venta=".$cod_info_factura_venta."&pagina=".$pagina;
