...
<a class="btn btn-success" href="../admin/lista_producto_imagen.php?cod_producto=<?php echo $cod_producto ?>&pagina=<?php echo $pagina ?>">Regresar</a>
<a class="btn btn-primary" href="../admin/lista_producto.php">Lista de Productos</a>
</div>
