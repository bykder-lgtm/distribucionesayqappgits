...
?>
<form action="../admin/venta_producto_carrito_compra_intern_reg.php" method="post">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        <div class="title-left">
                            ...
                            <div class="mb-3">
                                <label for="address"><a class="btn hvr-hover" href="../admin/cargar_soporte_archivo_adjunto_info_factura_venta_nota_observacion_intern.php?cuenta=<?php echo $cuenta_actual?>&cod_caja_virtual=<?php echo $cod_caja_virtual?>&nombre_estado_factura=<?php echo $nombre_estado_factura?>">Adjuntar Soporte</a></label>
                                <br>
                                <?php 
