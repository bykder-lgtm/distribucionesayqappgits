                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="text-align:center;"><a href="../admin/venta_productos_visitante_intern_confirmdirect_opcion_imprimir.php?cod_info_factura_venta_carrito_compra=<?php echo $cod_info_factura_venta_carrito_compra ?>&cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>">Ver credenciales</a></th>
                                </tr>
                            </thead>
                        </table>
