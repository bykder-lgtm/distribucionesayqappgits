...
$sql_producto = "SELECT p.cod_producto, p.cod_producto_barra, p.nombre_producto, p.und_producto, p.precio_venta_producto, p.descripcion_producto, 
    ...
    p.cod_categoria, p.cod_estado, p.cod_tienda FROM tbl15_producto p 
    INNER JOIN tbl15_tienda t ON p.cod_tienda = t.cod_tienda
    WHERE (p.nombre_estado = 'HABILITADO') AND (p.cod_tienda = '$cod_tienda') AND (p.cod_estado != '0') AND (t.cod_estado != '0')";
...
$sql_producto .= " ORDER BY p.nombre_producto DESC";
