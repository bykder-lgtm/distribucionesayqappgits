...
xmlhttp.open("POST","../admin/busqueda_inmediata_alquiler_temporal_manual_inquilino_php.php",true);
...
xmlhttp.open("POST","../admin/busqueda_inmediata_alquiler_temporal_manual_producto_inmueble_php.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
...
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/facturacion_alquiler_temporal_manual_reg.php">
    <fieldset>
    ...
    <table border="1" class="table table-responsive">
        <thead>
            <tr>
                ...
                <th style="text-align:center">SOPORTE CONTRATO</th>
            </tr>
            <tr>
