...
if ((isset($_POST["insersion"])) && ($_POST["insersion"] == "formulario_de_insersion")) {
	...
	$agreg = "INSERT INTO tbl15_tipo_unidad_medida (nombre_tipo_unidad_medida, cod_estado) VALUES ('$nombre_tipo_unidad_medida', '$cod_estado')";
	$resultado_sql1 = mysqli_query($conectar, $agreg) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_asignacion_tipo_unidad_medida_segun_tipo_precio_venta.php">
<?php } ?>
<!-- ***************************************************************************************************************************** -->
