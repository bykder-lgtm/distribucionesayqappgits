...
<a class="btn btn-primary" href="#"><h6>Lista de Paciente Atendidos Por Empresa Mes</h6></a>
</div>
<div class="row-fluid">
...
<td><a href="#">MES:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<select name="fecha_mes" class="selectpicker" data-show-subtext="true" data-live-search="true" required>
<?php if (isset($fecha_mes)) { echo "<option value='' >Selecione</option>";
} else { echo  "<option value='' selected >Selecione</option>"; }
$sql_consulta = ("SELECT fecha_mes FROM tbl15_historia_clinica GROUP BY fecha_mes ORDER BY fecha_ymd DESC");
$resultado = mysqli_query($conectar, $sql_consulta);
while ($contenedor = mysqli_fetch_assoc($resultado)) {
if(isset($fecha_mes) and $fecha_mes == $contenedor['fecha_mes']) {
$seleccionado = "selected"; } else { $seleccionado = ""; }
$codigo = $contenedor['fecha_mes'];
$nombre = $contenedor['fecha_mes'];
echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?></select>
</td>
...
tbl15_historia_clinica.cod_administrador, tbl15_historia_clinica.cod_cliente, tbl15_historia_clinica.fecha_mes, tbl15_historia_clinica.cod_factura, tbl15_historia_clinica.costo_motivo_consulta,
...
WHERE ((tbl15_historia_clinica.nombre_empresa)='$nombre_empresa') AND ((tbl15_historia_clinica.cod_estado_facturacion)=1) AND ((tbl15_historia_clinica.fecha_mes)='$fecha_mes') ORDER BY tbl15_historia_clinica.fecha_time DESC";
...
FROM tbl15_empresa RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_historia_clinica ON tbl15_administrador.cod_administrador = tbl15_historia_clinica.cod_administrador) 
ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente) ON tbl15_empresa.nombre_empresa = tbl15_historia_clinica.nombre_empresa
WHERE ((tbl15_historia_clinica.nombre_empresa)='$nombre_empresa') AND ((tbl15_historia_clinica.fecha_mes)='$fecha_mes')";
...
FROM tbl15_empresa RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_historia_clinica ON tbl15_administrador.cod_administrador = tbl15_historia_clinica.cod_administrador) 
ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente) ON tbl15_empresa.nombre_empresa = tbl15_historia_clinica.nombre_empresa
WHERE ((tbl15_historia_clinica.nombre_empresa)='$nombre_empresa') AND ((tbl15_historia_clinica.cod_estado_facturacion)=1) AND ((tbl15_historia_clinica.fecha_mes)='$fecha_mes')";
...
FROM tbl15_empresa RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_historia_clinica ON tbl15_administrador.cod_administrador = tbl15_historia_clinica.cod_administrador) 
ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente) ON tbl15_empresa.nombre_empresa = tbl15_historia_clinica.nombre_empresa
WHERE ((tbl15_historia_clinica.nombre_empresa)='$nombre_empresa') AND ((tbl15_historia_clinica.cod_estado_facturacion)=0) AND ((tbl15_historia_clinica.fecha_mes)='$fecha_mes')";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_hombre = "SELECT Count(tbl15_cliente.nombre_sexo) AS conteo_hombre, tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_mes
...
GROUP BY tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_mes
HAVING (((tbl15_historia_clinica.nombre_empresa)='$nombre_empresa') AND ((tbl15_historia_clinica.cod_estado_facturacion)=1) AND ((tbl15_cliente.nombre_sexo)='M') AND ((tbl15_historia_clinica.fecha_mes)='$fecha_mes'))";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_mujer = "SELECT Count(tbl15_cliente.nombre_sexo) AS conteo_mujer, tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_mes
FROM tbl15_empresa RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_historia_clinica ON tbl15_administrador.cod_administrador = tbl15_historia_clinica.cod_administrador) ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente) ON tbl15_empresa.nombre_empresa = tbl15_historia_clinica.nombre_empresa
GROUP BY tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_mes
HAVING (((tbl15_historia_clinica.nombre_empresa)='$nombre_empresa') AND ((tbl15_historia_clinica.cod_estado_facturacion)=1) AND ((tbl15_cliente.nombre_sexo)='F') AND ((tbl15_historia_clinica.fecha_mes)='$fecha_mes'))";
...
<td align="center">EMPRESA: <?php echo $nombre_empresa ?><br>MES: <?php echo $fecha_mes ?></td>
</form> 
<br>
<div class="table-responsive">
<table class="table table-striped">
<tr>
<th style="text-align:center"><a href="../admin/informe_diagnostico_condiciones_salud_fecha_empresa.php?fecha=<?php echo $fecha_mes ?>&tipo_fecha=fecha_mes&nombre_empresa=<?php echo $nombre_empresa ?>" target="_blank"><img src="../imagenes/ver_informe.png"></a></th>
</tr>
</table>
</div>
