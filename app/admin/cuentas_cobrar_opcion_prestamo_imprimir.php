...
<table class="table table-striped">
  <tr>
    <td style="text-align: center;"><strong>NIT TERCERO: <?php echo $identificacion_tercero; ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: center;"><strong>NOMBRE TERCERO: <?php echo $nombre_cliente; ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: center;"><strong>FACTURA: <?php echo $cod_factura; ?></strong></td>
  </tr>
</table>

<table class="table table-striped">
<tr>
<th style="text-align: center;"><strong>ABONO</strong></th>
<th style="text-align: center;"><strong>FECHA</strong></th>
<th style="text-align: center;"><strong># CUOTA</strong></th>
<?php
$sql = "SELECT * FROM tbl15_cuentas_cobrar_abonos WHERE cod_cuentas_cobrar_abonos = '$cod_cuentas_cobrar_abonos' ORDER BY fecha_invert DESC";
