...
if ((isset($_POST["insersion"])) && ($_POST["insersion"] == "formulario_de_insersion")) {
	...
	<?php } else {
		...
		cod_estado_dto_tercero, dto1_con_iva_tercero, dto2_con_iva_tercero, dto1_sin_iva_tercero, dto2_sin_iva_tercero, dto1_excento_iva_tercero, dto2_excento_iva_tercero, total_puntos_redimibles_campanya_tercero, 
		retefuente_ptj, reteica_ptj, reteiva_ptj) 
		VALUES ('$nombre_tipo_tercero', '$nombre_tipo_identificacion', '$identificacion_tercero', '$digito_tercero', UPPER('$nombre1_tercero'), 
		UPPER('$nombre2_tercero'), UPPER('$apellido1_tercero'), UPPER('$apellido2_tercero'), '$direccion_tercero', '$telefono1_tercero', 
		'$telefono2_tercero', '$correo_tercero', '$cod_pais', '$cod_departamento', '$cod_municipio', '$nombre_pais', '$nombre_departamento', '$nombre_ciudad', 
		'$nombre_tipo_regimen', '$nombre_tipo_impuesto', '$contacto_tercero', '$fax_tercero', '$nombre_tipo_cliente', '$fecha_nac_tercero', '$cod_administrador', 
		'$cod_estado_dto_tercero', '$dto1_con_iva_tercero', '$dto2_con_iva_tercero', '$dto1_sin_iva_tercero', '$dto2_sin_iva_tercero', '$dto1_excento_iva_tercero', '$dto2_excento_iva_tercero', '$total_puntos_redimibles_campanya_tercero', 
		'$retefuente_ptj', '$reteica_ptj', '$reteiva_ptj')";
	...
	?>
	<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_tercero.php">
	<?php } ?>
<?php } ?>
<!-- ***************************************************************************************************************************** -->
