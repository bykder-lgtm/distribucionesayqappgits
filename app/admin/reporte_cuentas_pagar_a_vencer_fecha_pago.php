...
<a href="#"><h4>Reporte Cuentas por Pagar a Vencer Fecha de Pago</h4></a>
</div>
<hr>
<div class="row-fluid">
...
FROM tbl15_cuentas_pagar WHERE ((tbl15_cuentas_pagar.cod_estado_pago = '0') OR (tbl15_cuentas_pagar.subtotal <> '0')) ORDER BY tbl15_cuentas_pagar.cod_cuentas_pagar DESC";
...
while ($datos_cuenta_pagar = mysqli_fetch_assoc($consulta_datos_cuenta_pagar)) {
	...
	if ($cod_estado_pago == '0') { 
		...
		$url_actualizar_estado_pago  = '../admin/actualizar_estado_pago_cuenta_pagar_reg.php?cod_cuentas_pagar='.$cod_cuentas_pagar.'&cod_estado_pago='.$cod_estado_pago_invert.'&cod_factura='.$cod_factura.'&cod_info_factura_compra='.$cod_info_factura_compra.'&cod_tercero='.$cod_tercero.'&pagina='.$pagina;
