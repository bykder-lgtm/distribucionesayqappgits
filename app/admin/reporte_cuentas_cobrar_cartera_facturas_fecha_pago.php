...
if ($cod_tercero==0) {
    ...
    $filtro_consulta_tercero_productos_rel = "AND (tbl15_cuentas_cobrar.cod_tercero = '$cod_tercero')";
}
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
?>
...
<table class="table table-striped">
	<tr>
		<th style="text-align: center;"><h4>Listado Cartera Por Facturas</h4></th>
	</tr>
</table>
...
<?php if (isset($_GET['fecha_ymd_venta_producto_ini'])) { ?>
	...
	WHERE (tbl15_cuentas_cobrar.fecha BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') $filtro_consulta_tercero_rel ORDER BY tbl15_cuentas_cobrar.cod_cuentas_cobrar DESC";
