...
<div class="breadcrumbs"><a href="<?php echo $pagina ?>"><h4>Enviar Ayudas Diagnósticas a Correo Electrónico</h4></a></div>
<div class="row-fluid">
...
$sql_historia_clinica = "SELECT * FROM tbl15_historia_clinica WHERE cod_historia_clinica = '$cod_historia_clinica'";
...
$sql_cliente = "SELECT cedula, nombres, apellido1, apellido2, correo FROM tbl15_cliente WHERE cod_cliente = '$cod_cliente'";
...
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/enviar_ayudas_diagnosticas_correo_reg.php">
<fieldset>
