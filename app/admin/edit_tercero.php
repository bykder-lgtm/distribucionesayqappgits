...
$reteica_ptj                                              = $info_cliente['reteica_ptj'];
$reteiva_ptj                                              = $info_cliente['reteiva_ptj'];
$total_puntos_redimibles_campanya_tercero                 = $info_cliente['total_puntos_redimibles_campanya_tercero'];
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/edit_tercero_reg.php">
<fieldset>
    	...
    	<tr>
			<td>
				<select id="select_nombre_tipo_tercero" name="nombre_tipo_tercero" class="input-block-level"  style="font-size:15px">
			        ...
			        $consulta2_sql = "SELECT * FROM tbl15_tipo_tercero WHERE (cod_estado = '1')";
...
<table border="1" class="table table-responsive">
	<thead>
		<tr>
			<th style="text-align:center">ACTIVAR PRONTO PAGO</th>
	...
	<tbody>
		<tr>
			<td>
				<select id="cod_estado_dto_tercero" name="cod_estado_dto_tercero" class="input-block-level"  style="font-size:15px">
			        <?php if (isset($cod_estado_dto_tercero)) { echo ""; } else { echo  ""; }
			        $consulta2_sql = "SELECT * FROM tbl15_sino ORDER BY cod_sino DESC";
			        $consulta2 = mysqli_query($conectar, $consulta2_sql) or die(mysql_error());
			        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
			        if(isset($cod_estado_dto_tercero) and $cod_estado_dto_tercero == $datos2['cod_sino']) {
			        $seleccionado = "selected"; } else { $seleccionado = ""; }
			...
			<td><input class="input-block-level" name="dto1_con_iva_tercero" type="text" value="<?php echo $dto1_con_iva_tercero ?>"/></td>
			<td><input class="input-block-level" name="dto2_con_iva_tercero" type="text" value="<?php echo $dto2_con_iva_tercero ?>"/></td>
			<td><input class="input-block-level" name="dto1_sin_iva_tercero" type="text" value="<?php echo $dto1_sin_iva_tercero ?>"/></td>
			<td><input class="input-block-level" name="dto2_sin_iva_tercero" type="text" value="<?php echo $dto2_sin_iva_tercero ?>"/></td>
			<td><input class="input-block-level" name="dto1_excento_iva_tercero" type="text" value="<?php echo $dto1_excento_iva_tercero ?>"/></td>
			<td><input class="input-block-level" name="dto2_excento_iva_tercero" type="text" value="<?php echo $dto2_excento_iva_tercero ?>"/></td>
	</tbody>
</table>
