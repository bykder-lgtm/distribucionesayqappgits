...
$pagina                       = addslashes($_GET['pagina'])."?&foco=".$foco."&buscar_por=".$buscar_por."&pagina=plan_accion_correctiva_preventiva_mejora_temporal_producto_manual_pos.php";
...
precio_venta_producto_orig, und_producto) 
