...
<table align="center" border="0" width="25%" cellspacing="0" style="font-family: Mono; font-size: <?php echo $tamano_font_emp ?>pt;">
  <tr>
    <td><strong><em>PACIENTE: </em></strong></td>
    <td>
...
WHERE (fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') AND (cod_cliente = '$cod_cliente')";
...
<td align="center">Paciente: <?php echo $nombres ?><br>FECHA INI: <?php echo $fecha_ymd_venta_producto_ini ?><br>FECHA FIN: <?php echo $fecha_ymd_venta_producto_fin ?></td>
</form> 
...
WHERE (tbl15_venta_producto.fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') AND (tbl15_venta_producto.cod_cliente = '$cod_cliente')
