...
if ($cod_tercero==0) {
    ...
    $filtro_consulta_tercero_rel = "AND (tbl15_cuentas_pagar.cod_tercero = '$cod_tercero')";
    $filtro_consulta_tercero_productos_rel = "AND (tbl15_cuentas_pagar.cod_tercero = '$cod_tercero')";
}
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
?>
...
<?php if (isset($_GET['fecha_ymd_venta_producto_ini'])) { ?>
	...
	FROM tbl15_cuentas_pagar 
	WHERE (tbl15_cuentas_pagar.fecha BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') $filtro_consulta_tercero_rel ORDER BY tbl15_cuentas_pagar.cod_cuentas_pagar DESC";
