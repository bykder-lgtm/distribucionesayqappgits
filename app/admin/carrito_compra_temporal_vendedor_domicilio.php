...
?>
<!-- **************************************************** MODULO DE SESION ******************************************** -->
<?php include_once("../admin/01_modulo_diseno_superior_vendedor_domicilio.php"); ?>
<!-- **************************************************** MODULO DE SESION ******************************************** -->
<?php include_once("../admin/01_info_empresa_vendedor_domicilio.php"); ?>
...
<?php include_once("../admin/03_modulo_css_vendedor_domicilio.php"); ?>
...
FROM tbl15_carrito_compra_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual') ORDER BY cod_carrito_compra_temporal DESC";
...
?>
                                <tr id="tr-<?php echo $cod_carrito_compra_temporal;?>">
                                    ...
                                    <td id="und_venta-<?php echo $cod_carrito_compra_temporal;?>" class="quantity-box"><input type="number" name="<?php echo $campo_codifcryp;?>" id="und_venta<?php echo $incre;?>" min="1" max="5" data_codifcryp="<?php echo $cod_carrito_compra_temporal;?>" size="4" min="0" step="1" class="c-input-text qty text" value="<?php echo $und_venta;?>">
...
-->
                ...
                <?php if ($total_reg <> '0') { ?>
                <div class="col-12 d-flex shopping-box"><a href="../admin/checkout_visitante_ext.php" class="ml-auto btn hvr-hover">Revisar Compra</a> </div>
                <?php } ?>
            </div>
...
<?php include_once("../admin/09_modulo_footer_vendedor_domicilio.php"); ?>

<?php include_once("../admin/10_modulo_js_vendedor_domicilio.php"); ?>
...
<script type="text/javascript">
    $("input").change(function(){  
        ...
        var vendedor_codifcryp = '<?php echo $cuenta_actual ?>';
        //let id = this.id;
        console.log("input");
