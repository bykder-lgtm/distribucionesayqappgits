...
if (isset($_POST['fecha_anyo'])) { $fecha_anyo  = addslashes($_POST['fecha_anyo']); } else { $fecha_anyo = ""; }
...
if (isset($_POST['total_datos'])) { $total_datos  = intval($_POST['total_datos']); } else { $total_datos = ""; }
if (isset($_POST['vlr_cancelado'])) { $vlr_cancelado  = addslashes($_POST['vlr_cancelado']); } else { $vlr_cancelado = ""; }
if (isset($_POST['cod_tipo_mantenimiento'])) { $cod_tipo_mantenimiento  = intval($_POST['cod_tipo_mantenimiento']); } else { $cod_tipo_mantenimiento = ""; }
if (isset($_POST['fecha_mantenimiento'])) { $fecha_mantenimiento  = addslashes($_POST['fecha_mantenimiento']); } else { $fecha_mantenimiento = ""; }
...
$cod_info_factura_compra       = $cod_info_factura_venta;
...
$sql_maxima_factura = "SELECT Max(cod_factura) AS cod_factura FROM tbl15_info_factura_mantenimiento 
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_info_imp_factura = "SELECT * FROM tbl15_info_factura_mantenimiento WHERE cod_info_factura_venta = '$cod_info_factura_venta'";
...
FROM tbl15_mantenimiento_producto_temporal WHERE (cod_info_factura_venta = '$cod_info_factura_venta')";
...
$sql_mconsulta = "SELECT * FROM tbl15_mantenimiento_producto_temporal WHERE (cod_venta_producto_temporal = '$cod_venta_producto_temporal')";
...
$agregar_reg_venta_producto = "INSERT INTO tbl15_mantenimiento_producto (cod_info_factura_venta, cod_factura, cod_producto, cod_producto_barra, 
...
//----------------------------------------------------------------------- ---------------------------------------------------------//
//----------------------------------------------------------------------- ---------------------------------------------------------//
$borrar_sql = sprintf("DELETE FROM tbl15_mantenimiento_producto_temporal WHERE (cod_info_factura_venta = '$cod_info_factura_venta')");
$Result1 = mysqli_query($conectar, $borrar_sql) or die(mysqli_error($conectar));
//----------------------------------------------------------------------- ---------------------------------------------------------//
//----------------------------------------------------------------------- ---------------------------------------------------------//   
$agregar_regis = sprintf("UPDATE tbl15_info_factura_mantenimiento SET cod_estado_factura = '$cod_estado_factura', cod_factura = '$cod_factura', fecha_anyo = '$fecha_anyo', 
...
cod_tipo_mantenimiento = '$cod_tipo_mantenimiento', fecha_mantenimiento = '$fecha_mantenimiento'
...
$sql_reg = "INSERT INTO tbl15_historial_fecha_mantenimiento (cod_info_factura_compra, cod_factura, cod_producto_barra, fecha_mantenimiento, fecha_compra)
VALUES ('$cod_info_factura_compra', '$cod_factura', '$cod_producto_barra', '$fecha_mantenimiento', '$fecha_compra')";
$resultado_venta_producto = mysqli_query($conectar, $sql_reg) or die(mysqli_error($conectar));
}

$url_redir = "../admin/mantenimiento_productos_opcion_imprimir.php?cod_info_factura_venta=".$cod_info_factura_venta."&cod_tipo_pago=".$cod_tipo_pago."&pagina=".$pagina;
...
$url_redir = "../admin/venta_productos_valor_cancelado_menor_venta_total.php?cod_info_factura_venta=".$cod_info_factura_venta."&cod_tipo_pago=".$cod_tipo_pago."&total_precio_venta=".$total_precio_venta."&vlr_cancelado=".$vlr_cancelado."&pagina=".$pagina;
header("Location: $url_redir");
}
elseif ($vlr_cancelado > 99999999) { 
$url_redir = "../admin/venta_productos_valor_cancelado_demasiado_grande.php?cod_info_factura_venta=".$cod_info_factura_venta."&cod_tipo_pago=".$cod_tipo_pago."&total_precio_venta=".$total_precio_venta."&vlr_cancelado=".$vlr_cancelado."&pagina=".$pagina;
header("Location: $url_redir");
}
elseif (($vlr_cancelado <> '0') && ($cod_tipo_pago == '2')) {
$url_redir = "../admin/venta_productos_credito_valor_no_cero.php?cod_info_factura_venta=".$cod_info_factura_venta."&cod_tipo_pago=".$cod_tipo_pago."&total_precio_venta=".$total_precio_venta."&vlr_cancelado=".$vlr_cancelado."&pagina=".$pagina;
header("Location: $url_redir");
}
else { 
//$url_redir = "../admin/venta_productos_valor_cancelado_demasiado_grande.php?cod_info_factura_venta=".$cod_info_factura_venta."&cod_tipo_pago=".$cod_tipo_pago."&total_precio_venta=".$total_precio_venta."&vlr_cancelado=".$vlr_cancelado."&pagina=".$pagina;
