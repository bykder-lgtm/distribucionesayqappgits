                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th style="text-align:center; font-size: 18px" class="hvr-hover">Pagarás <?php echo $numero_cuotas ?> cuotas por un valor aproximado de: $ <?php echo number_format($cuota_credito, 0, ",", ".") ?><br><?php echo $nombre_tipo_cobro ?></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table class="table">
                        <thead>
                            <tr>
                                <th style="text-align:center; font-size: 18px" class="hvr-hover"><a href="../admin/simulador_credito_visitante_intern.php?valor_credito=<?php echo $valor_credito ?>&cod_entidad_crediticia=<?php echo $cod_entidad_crediticia ?>&cod_tipo_cobro=<?php echo $cod_tipo_cobro ?>&cod_meses_credito=<?php echo $cod_meses_credito ?>">Regresar Al Simulador</a></th>
                            </tr>
                        </thead>
                    </table>
                </div>
