...
<div class="breadcrumbs"><a href="<?php echo $pagina; ?>"><h4>Editar Sub Dependencia</h4></a></div>
<div class="row-fluid">
...
<!-- ***************************************************************************************************************************** -->
<?php
$cod_dependencia_sub             = intval($_GET['cod_dependencia_sub']);

$mostrar_datos_sql = "SELECT * FROM tbl15_dependencia_sub WHERE cod_dependencia_sub = '$cod_dependencia_sub'";
...
?>
<form name="formulario_edicion" accept-charset="utf-8" method="post" action="../admin/edit_dependencia_sub_reg.php">
<fieldset>
...
<td><input type="text" name="nombre_dependencia_sub" value="<?php echo ($nombre_dependencia_sub) ?>"  class="input-block-level" required/></td>
<td>        
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<hr>
<input type="hidden" name="cod_dependencia_sub" value="<?php echo $cod_dependencia_sub ?>"/>
