...
if ($cod_tienda > 0) {
    ...
    if ($res_tienda && mysqli_num_rows($res_tienda) > 0) {
        ...
        $consulta_sql = "SELECT cod_administrador, nombres_apellidos_tercero, identificacion_tercero, telefono1_tercero, correo_tercero FROM tbl15_administrador 
        WHERE cod_seguridad = '2' AND cod_aliado_estrategico = '$cod_aliado_estrategico' AND cod_estado_activacion_usuario = '1' ORDER BY nombres_apellidos_tercero ASC";
