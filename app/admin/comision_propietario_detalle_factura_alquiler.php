...
<legend>HISTORIAL DE PAGO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="../admin/comision_propietario_detalle_factura_alquiler_excluido.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar ?>&cod_tercero=<?php echo $cod_tercero ?>&cod_factura=<?php echo $cod_factura ?>&pagina=<?php echo $pagina ?>&palabra=<?php echo $palabra ?>">EXCLUIDOS</a>
</legend>
...
<?php
$calcular_datos_cuenta_cobrar = "SELECT * FROM tbl15_cuentas_cobrar_alerta WHERE (cod_factura = '$cod_factura') AND (cod_estado_archivado = '0') AND (cod_excluir_pago_propietario = '0') ORDER BY fecha_pago ASC";
...
$sql_cuentas_cobrar_factura_comision_propietario = "SELECT total_recibido, fecha_pago_reg, url_img_orig_producto FROM tbl15_cuentas_cobrar_factura_comision_propietario WHERE cod_cuentas_cobrar_alerta = '$cod_cuentas_cobrar_alerta' ORDER BY cod_cuentas_cobrar_factura_comision_propietario DESC";
