...
if($action == 'ajax') {
    ...
    $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_asesor = '$cod_administrador') AND (tbl15_info_factura_venta.nombre_estado_factura = 'CERRADA')";
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_asesor = '$cod_administrador') AND (tbl15_info_factura_venta.nombre_estado_factura = 'CERRADA') AND ( ";
