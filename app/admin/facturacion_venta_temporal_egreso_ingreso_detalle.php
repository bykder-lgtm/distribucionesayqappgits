...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_egreso_ingreso_detalle_temporal_virtual.php?pagina=<?php echo $pagina ?>">LISTA DE GASTOS ABIERTOS | </a></strong></td>
        <?php if ($cod_seguridad==1) { ?>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/reporte_egreso_ingreso_venta_relacionado_deducido.php">LISTA DE GASTOS DEDUCIDOS</a></strong></td>
        <?php } else { ?>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/reporte_egreso_ingreso_venta_relacionado_deducido.php">LISTA DE GASTOS DEDUCIDOS</a></strong></td>
        <?php } ?>
    </tr></tbody>
...
<?php } ?>
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_factura_venta_egreso_ingreso_detalle.php'); ?>
<!-- ***************************************************************************************************************************** -->
...
<thead>
	<tr>
		...
		<th style="text-align:center;">ADMINISTRACION DE REPARACION</th>
