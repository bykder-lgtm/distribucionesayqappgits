...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_factura') && ($tipo_ajax=='tbl15_info_plan_accion_correctiva_preventiva_mejora')) {
$cod_factura           = addslashes($_POST['valor']);
$cod_info_plan_accion_correctiva_preventiva_mejora             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_plan_accion_correctiva_preventiva_mejora SET cod_factura = '$cod_factura' WHERE cod_info_plan_accion_correctiva_preventiva_mejora = '$cod_info_plan_accion_correctiva_preventiva_mejora'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET cod_tercero = '$cod_tercero' WHERE cod_info_plan_accion_correctiva_preventiva_mejora = '$cod_info_plan_accion_correctiva_preventiva_mejora'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_producto_barra') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$cod_producto_barra           = addslashes($_POST['valor']);
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET cod_producto_barra = '$cod_producto_barra' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_producto') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_producto              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_producto = '$nombre_producto' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_accion') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_tipo_accion              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_tipo_accion = '$nombre_tipo_accion' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_fuente') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_tipo_fuente              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_tipo_fuente = '$nombre_tipo_fuente' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_actividad') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_tipo_actividad              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_tipo_actividad = '$nombre_tipo_actividad' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='descripcion_hallazgo') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$descripcion_hallazgo              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET descripcion_hallazgo = '$descripcion_hallazgo' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_accion_tomada') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_tipo_accion_tomada              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_tipo_accion_tomada = '$nombre_tipo_accion_tomada' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='recurso_humano') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$recurso_humano              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET recurso_humano = '$recurso_humano' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='recurso_financiero') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$recurso_financiero              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET recurso_financiero = '$recurso_financiero' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='recurso_tecnologico') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$recurso_tecnologico              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET recurso_tecnologico = '$recurso_tecnologico' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_responsable_implantar_accion') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_responsable_implantar_accion              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_responsable_implantar_accion = '$nombre_responsable_implantar_accion' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_prevista') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$fecha_prevista              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET fecha_prevista = '$fecha_prevista' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='seguimiento_cumplimiento') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$seguimiento_cumplimiento              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET seguimiento_cumplimiento = '$seguimiento_cumplimiento' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='seguimiento_eficacia') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$seguimiento_eficacia              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET seguimiento_eficacia = '$seguimiento_eficacia' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='seguimiento_soporte') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$seguimiento_soporte              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET seguimiento_soporte = '$seguimiento_soporte' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_frec_duracion') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_frec_duracion         = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_frec_duracion = '$nombre_frec_duracion' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_venta') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$und_venta                    = intval($_POST['valor']);
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$datos_info_temporal = "SELECT precio_costo_producto, precio_venta_producto FROM tbl15_plan_accion_correctiva_preventiva_mejora_temporal WHERE (cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal')";
...
$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET und_venta = '$und_venta', total_costo_producto = '$total_costo_producto', total_venta_producto = '$total_venta_producto', 
cod_estado_permitir_venta = '$cod_estado_permitir_venta' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$precio_venta_producto        = intval($_POST['valor']);
$cod_plan_accion_correctiva_preventiva_mejora_temporal  = intval($_POST['id']);

$datos_info_temporal = "SELECT und_venta, precio_costo_producto FROM tbl15_plan_accion_correctiva_preventiva_mejora_temporal WHERE (cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET precio_venta_producto = '$precio_venta_producto', total_venta_producto = '$total_venta_producto',
cod_estado_permitir_venta = '$cod_estado_permitir_venta' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_cliente') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$nombre_cliente              = addslashes(strtoupper($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_cliente = '$nombre_cliente' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_cobrar') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$cod_tipo_cobrar             = addslashes(($_POST['valor']));
$id                          = addslashes($_POST['id']);
$frag                        = explode("__", $id);
$cod_plan_accion_correctiva_preventiva_mejora_temporal = $frag[1];

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET cod_tipo_cobrar = '$cod_tipo_cobrar' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_alerta') && ($tipo_ajax=='tbl15_plan_accion_correctiva_preventiva_mejora_temporal')) {
$fecha_alerta                = addslashes(($_POST['valor']));
$cod_plan_accion_correctiva_preventiva_mejora_temporal = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET fecha_alerta = '$fecha_alerta' WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
