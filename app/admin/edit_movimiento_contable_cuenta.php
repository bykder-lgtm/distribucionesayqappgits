...
$tab                                      = 'tbl15_movimiento_contable_concepto';
$tipo                                     = 'eliminar';
$campo                                    = 'cod_movimiento_contable_concepto';
?>
...
<table class="table table-striped">
  <tr>
    ...
    <td ><input type="text" name="doc_modifica" id="<?php echo $cod_movimiento_contable ?>" value="<?php echo $doc_modifica ?>" size="10"></td>
  </tr>
  <tr>
...
<a href="#" id="modal_abrir"><img src="../imagenes/boton_mas_blanco.png"></a>
  ...
  <tr>
    <td style="text-align:left">DESCRIPCION DEL MOVIMIENTO: <input type="text" name="descripcion_movimiento" id="<?php echo $cod_movimiento_contable ?>" value="<?php echo $descripcion_movimiento ?>" size="50"></td>
...
?>
<table border="1" style="text-align:center; font-family:mono; font-size:12pt; width:99%"><tr><td style="text-align:center">CUENTA<a href="../admin/reg_movimiento_contable_concepto_cuenta_reg.php?cod_movimiento_contable=<?php echo $cod_movimiento_contable?>&nombre_tipo_documento=<?php echo $nombre_tipo_documento?>&nombre_tipo_movimiento=DEBITOS"><img src=../imagenes/mas.png alt="mas"></a></td></tr></table>
...
?>
    <tr id="tr<?php echo $cod_movimiento_contable_concepto;?>">
      <td style="text-align:center"><a href="../admin/eliminar.php?llave=<?php echo $cod_movimiento_contable_concepto ?>&cod_movimiento_contable=<?php echo $cod_movimiento_contable ?>&tab=<?php echo $tab ?>&tipo=<?php echo $tipo ?>&campo=<?php echo $campo ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>
      <!--<td style="text-align:center" class="service_list" id="cod_movimiento_contable_concepto<?php echo $cod_movimiento_contable_concepto ?>" data="<?php echo $cod_movimiento_contable_concepto ?>"><a class="eliminar_movimiento_contable_temporal_concepto" id="cod_movimiento_contable_concepto<?php echo $cod_movimiento_contable_concepto ?>"><img src="../imagenes/eliminar.png"></a></td>-->
      <td style="text-align:center"><input type="text" name="codigo_puc[]" class="codigo_puc" id="<?php echo $cod_movimiento_contable_concepto ?>" value="<?php echo $codigo_puc ?>" size="8"></td>
      <td style="text-align:left"><input type="text" name="nombre_puc[]" class="nombre_puc_<?php echo $cod_movimiento_contable_concepto ?>" id="<?php echo $cod_movimiento_contable_concepto ?>" value="<?php echo $nombre_puc ?>" size="25"></td>
      <td style="text-align:center"><input type="text" name="costo_movimiento_contable[]" class="costo_movimiento_contable_debitos<?php echo $incre ?>" data="DEBITOS" id="<?php echo $cod_movimiento_contable_concepto ?>" value="<?php echo $costo_movimiento_contable ?>" size="8"></td>
 ...
 $(document).ready(function(){  
         ...
         $('input[name="doc_modifica"]').change(function(){  
           ...
           $.ajax({  
                url:"guardar_movimiento_contable_ajax.php",  
                method:"POST",  
                data:{valor:nombre_empresa_movimiento_contable, campo:"doc_modifica", id:id},  
                success:function(data){  
                     $('#result').html(data);  
                }  
           });  
