...
<select name="motivo" id="<?php echo $cod_historia_clinica ?>">
...
<td style="text-align:center"><input style="text-align:center" class="input-block-level" name="costo_motivo_consulta" id="<?php echo $cod_historia_clinica ?>" type="number" value="<?php echo $costo_motivo_consulta ?>" /></td>
</tr>
...
<table align="center" class="table table-responsive" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <thead><tr>
    	...
    	<div id="fecha_ymd_hora" class="input-append date"><input id="<?php echo $cod_historia_clinica ?>" type="text" name="fecha_ymd_hora" value="<?php echo $fecha_y_hora_registro ?>" required></input><span class="add-on"><i data-time-icon="icon-time" data-date-icon="icon-calendar"></i></span></div></th>
...
<td style="text-align:center"><select name="nombre_empresa_contratante" id="<?php echo $cod_historia_clinica ?>" required>
...
<td style="text-align:center"><select name="nombre_empresa" id="nombre_empresa" onChange="conocer_empresa_laborar();" required>
...
<td style="text-align:center"><select name="nombre_actividad_ecoemp" id="<?php echo $cod_historia_clinica ?>">
...
<td><input style="text-align:center" class="input-block-level" name="ciudad_empresa" id="<?php echo $cod_historia_clinica ?>" type="text" value="<?php echo $ciudad_empresa ?>"/></td>
</tr></tbody>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<br>
...
$nombre = $datos2['nombre_empresa'];
echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?></select></td>
<!--<td><input style="text-align:center" class="input-block-level" name="dat_ocupa_emp1" id="<?php echo $cod_historia_clinica ?>" type="text" value="<?php echo $nombre_empresa ?>"/></td>-->
...
<td style="text-align:center"><input name="dat_ocupa_visu1" class="dat_ocupa_visu1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_visu1=='S'){ echo "checked"; } ?>></td>
<td style="text-align:center"><input name="dat_ocupa_audi1" class="dat_ocupa_audi1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_audi1=='S'){ echo "checked"; } ?>></td>
<td style="text-align:center"><input name="dat_ocupa_altu1" class="dat_ocupa_altu1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_altu1=='S'){ echo "checked"; } ?>></td>
<td style="text-align:center"><input name="dat_ocupa_resp1" class="dat_ocupa_resp1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_resp1=='S'){ echo "checked"; } ?>></td>
<td style="text-align:center"><input name="dat_ocupa_cabeza1" class="dat_ocupa_cabeza1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_cabeza1=='S'){ echo "checked"; } ?>></td>
<td style="text-align:center"><input name="dat_ocupa_manos1" class="dat_ocupa_manos1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_manos1=='S'){ echo "checked"; } ?>></td>
<td style="text-align:center"><input name="dat_ocupa_tronco1" class="dat_ocupa_tronco1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_tronco1=='S'){ echo "checked"; } ?>></td>
<td style="text-align:center"><input name="dat_ocupa_pies1" class="dat_ocupa_pies1" id="<?php echo $cod_historia_clinica ?>" type="checkbox" value="S" <? if($dat_ocupa_pies1=='S'){ echo "checked"; } ?>></td>
...
SI<input type="radio" name="ant_impor_accilab" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_impor_accilab=='SI')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;
...
SI<input type="radio" name="enf_lab" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($enf_lab=='SI')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_neuro" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_neuro=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_resp" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_resp=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_derma" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_derma=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_psiq" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_psiq=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_alerg" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_alerg=='SI')?'checked':'' ?> ></td>
<td style="text-align:center">NO<input type="radio" name="ant_pato_alerg" id="<?php echo $cod_historia_clinica ?>" value="NO" <?php echo ($ant_pato_alerg=='NO')?'checked':'' ?> ></td>	
        ...
        <tr>
<td><strong>Osteomusculares</strong></td>
<td style="text-align:center">SI<input type="radio" name="ant_pato_osteomusc" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_osteomusc=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_gastrointes" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_gastrointes=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_hematolog" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_hematolog=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_org_sentid" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_org_sentid=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_onco" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_onco=='SI')?'checked':'' ?> ></td>
<td style="text-align:center">NO<input type="radio" name="ant_pato_onco" id="<?php echo $cod_historia_clinica ?>" value="NO" <?php echo ($ant_pato_onco=='NO')?'checked':'' ?> ></td>	
        ...
        <tr>
            <td><strong>Hipertensión</strong></td>
<td style="text-align:center">SI<input type="radio" name="ant_pato_hiperten" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_hiperten=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_genurinario" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_genurinario=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_infesios" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_infesios=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_congenit" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_congenit=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_farmacolog" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_farmacolog=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_transfus" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_transfus=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_endocrino" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_endocrino=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_vascular" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_vascular=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_pato_auntoinmun" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_pato_auntoinmun=='SI')?'checked':'' ?> ></td>
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody>
        <tr><td bgcolor="#B6DDE8"><strong>Presenta Antecedentes para Alturas&nbsp;&nbsp;&nbsp;NO<input type="radio" name="ant_altu_no" id="<?php echo $cod_historia_clinica ?>" value="NO" <?php echo ($ant_altu_no=='NO')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;NA<input type="radio" name="ant_altu_no" id="<?php echo $cod_historia_clinica ?>" value="NA" <?php echo ($ant_altu_no=='NA')?'checked':'' ?> ></strong></td></tr>
    </tbody>
</table>
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_epilep" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_epilep=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_otitmed" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_otitmed=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_enfmanier" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_enfmanier=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_traumcran" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_traumcran=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_tumcereb" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_tumcereb=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_malfocereb" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_malfocereb=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_trombo" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_trombo=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_hipoac" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_hipoac=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_arritcardi" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_arritcardi=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_hipogli" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_hipogli=='SI')?'checked':'' ?> ></td>
...
<td style="text-align:center">SI<input type="radio" name="ant_altu_fobia" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_altu_fobia=='SI')?'checked':'' ?> ></td>
...
SI<input type="radio" name="ant_trau" value="SI" <?php echo ($ant_trau=='SI')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;
...
SI<input type="radio" name="ant_quirur" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_quirur=='SI')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;
...
<!-- /////////////////////////////////////////////////// -->
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody><tr><td bgcolor="#FAC090"><strong>3.6 Antecedentes - Inmunizaciones (Presenta Vacunas:&nbsp;&nbsp;&nbsp; SI<input type="radio" name="ant_inmuni" id="<?php echo $cod_historia_clinica ?>" value="SI" >&nbsp;&nbsp;&nbsp;NO<input type="radio" name="ant_inmuni" id="<?php echo $cod_historia_clinica ?>" value="NO">)</strong></td></tr></tbody>
</table>
<table align="center" border="1" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_tetano" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_tetano=='SI')?'checked':'' ?> /></td>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_fiebtifo" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_fiebtifo=='SI')?'checked':'' ?> /></td>
        ...
        <tr>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_hepatita" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_hepatita=='SI')?'checked':'' ?> /></td>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_influenza" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_influenza=='SI')?'checked':'' ?> /></td>
        ...
        <tr>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_hepatitb" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_hepatitb=='SI')?'checked':'' ?> /></td>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_saramp" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_saramp=='SI')?'checked':'' ?> /></td>
        ...
        <tr>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_fiebamarill" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_fiebamarill=='SI')?'checked':'' ?> /></td>
            ...
            <td style="text-align:center">SI<input type="radio" name="ant_inmuni_otra" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($ant_inmuni_otra=='SI')?'checked':'' ?> /></td>
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody><tr><td><strong>Observaciones: </strong><input class="input-block-level" name="ant_inmuni_observacion" id="<?php echo $cod_historia_clinica ?>" type="text" value=""/></td></tr></tbody>
</table>
<!-- /////////////////////////////////////////////////// -->
<br>
<!-- /////////////////////////////////////////////////// -->
...
Tabaquismo:&nbsp;Fuma<input type="radio" name="habit_tox_fum_nofum_exfum" id="<?php echo $cod_historia_clinica ?>" value="Fuma" <?php echo ($habit_tox_fum_nofum_exfum=='Fuma')?'checked':'' ?> >
...
<tr>
<td style="text-align:center" colspan="8"><strong>
Consumo de Alcohol:&nbsp;SI<input type="radio" name="habit_tox_consum_alcoh" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($habit_tox_consum_alcoh=='SI')?'checked':'' ?> >
...
<tr>
<td style="text-align:center" colspan="8"><strong>
Actividad física:&nbsp;Sedentario<input type="radio" name="habit_tox_activfis" id="<?php echo $cod_historia_clinica ?>" value="Sedentario" <?php echo ($habit_tox_activfis=='Sedentario')?'checked':'' ?> >
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_orgsentido" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_orgsentido=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_neurolog" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_neurolog=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_resp" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_resp=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_gastrointes" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_gastrointes=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_geniuri" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_geniuri=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_osteomus" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_osteomus=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_dermato" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_dermato=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_cardiovas" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_cardiovas=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_constitu" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_constitu=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center">
	SI<input type="radio" name="rev_sist_metabolendocri" id="<?php echo $cod_historia_clinica ?>" value="SI" <?php echo ($rev_sist_metabolendocri=='SI')?'checked':'' ?> />&nbsp;&nbsp;&nbsp;
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody>
        <tr>
            <td><strong>CONCEPTO:&nbsp;&nbsp;&nbsp;
            	NORMAL<input type="radio" name="eval_estment_concept" id="<?php echo $cod_historia_clinica ?>" value="NORMAL" <?php echo ($eval_estment_concept=='NORMAL')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;
...
<tbody>
<tr>
<td style="text-align:center"><strong>&nbsp;Talla: (Mts)<input style="text-align:center" name="exa_fis_talla" class="exa_fis_talla" id="exa_fis_talla" type="text" value="<?php echo $exa_fis_talla ?>" onChange="calc_imc();" /></strong></td>
<td style="text-align:center"><strong>PESO: (Kg)<input style="text-align:center" name="exa_fis_peso" class="exa_fis_peso" id="exa_fis_peso" type="text" value="<?php echo $exa_fis_peso ?>" onChange="calc_imc();" /></strong></td>
...
<td style="text-align:center"><strong>F. Resp: (/Min)<input style="text-align:center" name="exa_fis_fresp" class="exa_fis_fresp" id="<?php echo $cod_historia_clinica ?>" type="text" value="<?php echo $exa_fis_fresp ?>"/></strong></td>
</tr>
<tr>
...
<td style="text-align:center"><strong>FC: (/Min)<input style="text-align:center" name="exa_fis_fc" class="exa_fis_fc" id="<?php echo $cod_historia_clinica ?>" type="text" value="<?php echo $exa_fis_fc ?>"/></strong></td>
<td style="text-align:center"><strong>
Lateralidad&nbsp;&nbsp;&nbsp;&nbsp;
D<input type="radio" name="exa_fis_lateral" id="<?php echo $cod_historia_clinica ?>" value="D" <?php echo ($exa_fis_lateral=='D')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center"><strong>Perímetro Abdominal: (Cm)<input style="text-align:center" name="exa_fis_periabdom" class="exa_fis_periabdom" id="<?php echo $cod_historia_clinica ?>" type="number" value="<?php echo $exa_fis_periabdom ?>"/>
<td style="text-align:center"><strong>
Temperatura:&nbsp;&nbsp;&nbsp;&nbsp;
Febril<input type="radio" name="exa_fis_temperat" id="<?php echo $cod_historia_clinica ?>" value="Febril" <?php echo ($exa_fis_temperat=='Febril')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;
...
<!-- /////////////////////////////////////////////////// -->
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody><tr><td bgcolor="#FAC090"><strong>EXAMEN FÍSICO <input type="radio" name="exa_fis" value="N" /> N(Normal) &ndash; 
...
<!-- /////////////////////////////////////////////////// -->
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
<tbody><tr><td bgcolor="#FAC090"><strong><span style="color:#FF0000">
7. EXAMEN OSTEOMUSCULAR
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Normal<input type="radio" name="exaosteo_norm_anorm" id="<?php echo $cod_historia_clinica ?>" class="exaosteo_norm_anorm" value="Normal" <?php echo ($exaosteo_norm_anorm=='Normal')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
Anormal<input type="radio" name="exaosteo_norm_anorm" id="<?php echo $cod_historia_clinica ?>" class="exaosteo_norm_anorm" value="Anormal" <?php echo ($exaosteo_norm_anorm=='Anormal')?'checked':'' ?> ></strong></td>
...
<?php $consulta2_sql = "SELECT cod_cie10, codigo_cie10, descripcion_cie10 FROM tbl15_cie10 WHERE cod_estado_cie10 = '1' ORDER BY codigo_cie10 ASC";
$consulta2 = mysqli_query($conectar, $consulta2_sql);
while ($datos2 = mysqli_fetch_assoc($consulta2)) {
