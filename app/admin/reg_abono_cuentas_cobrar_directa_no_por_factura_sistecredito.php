...
<tr>
<td style="text-align:center"><strong><a href="../admin/cuentas_cobrar_detalle_factura_directa_no_por_factura_sistecredito.php?cod_tercero=<?php echo $cod_tercero;?>&cliente=<?php echo $cliente;?>"><font size="5px">REGRESAR</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
...
<form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/reg_abono_cuentas_cobrar_directa_no_por_factura_sistecredito_reg.php">
<table class="table table-striped">
    <tr>
    ...
    <?php if ($cod_estado_movimiento_contable_cuenta_personal_global == '1') { ?>
        <td style="text-align:center">
            <select name="cod_movimiento_contable_cuenta_personal" id="cod_movimiento_contable_cuenta_personal" class="cod_movimiento_contable_cuenta_personal" data-show-subtext="true" data-live-search="true" style="width: 170px;" tabindex="1">
                ...
                $consulta2_sql = "SELECT cod_movimiento_contable_cuenta_personal, codigo_puc, nombre_puc, tipo_puc FROM tbl15_movimiento_contable_cuenta_personal WHERE (cod_tipo_forma_pago = '$cod_tipo_forma_pago') ORDER BY nombre_puc ASC";
                $consulta2 = mysqli_query($conectar, $consulta2_sql);
                while ($datos2 = mysqli_fetch_assoc($consulta2)) {
