...
$pagina_facturacion       = $concatenador."facturacion_venta_temporal_producto_manual_pos.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    // escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sTable = "tbl15_tipo_historia_clinica RIGHT JOIN (tbl15_empresa RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_historia_clinica ON tbl15_administrador.cod_administrador = tbl15_historia_clinica.cod_administrador) ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente) ON tbl15_empresa.cod_empresa = tbl15_historia_clinica.cod_empresa) ON tbl15_tipo_historia_clinica.cod_tipo_historia_clinica = tbl15_historia_clinica.cod_tipo_historia_clinica";
     ...
     elseif ($buscar_por=='nombre_empresa') { $columnas_busqueda = array('tbl15_empresa.nombre_empresa'); }
...
<th style="text-align:center" class="column-title">Profesional</th>
...
<th style="text-align:center" class="column-title">Fact</th>
<th style="text-align:center" class="column-title">HCorreo</th>
...
$sql_consulta = "SELECT tbl15_historia_clinica.cod_historia_clinica, tbl15_historia_clinica.cod_cliente, tbl15_historia_clinica.cod_empresa, 
tbl15_historia_clinica.cod_administrador, tbl15_cliente.nombre_especie, tbl15_cliente.nombre_raza,
tbl15_historia_clinica.cod_tipo_historia_clinica, tbl15_historia_clinica.cod_estado_facturacion, 
tbl15_historia_clinica.motivo, tbl15_historia_clinica.fecha_time, tbl15_cliente.cedula, tbl15_cliente.nombres, tbl15_cliente.apellido1, 
...
tbl15_tipo_historia_clinica.nombre_tipo_historia_clinica, tbl15_cliente.url_img_firma, tbl15_cliente.url_img_foto, tbl15_historia_clinica.url_img_firma_orig, 
tbl15_historia_clinica.url_img_foto_orig, tbl15_empresa.nombre_empresa 
...
$cod_tipo_historia_clinica          = $datos_consulta['cod_tipo_historia_clinica'];
...
$cod_estado_facturacion             = $datos_consulta['cod_estado_facturacion'];
?>
...
<td><?php echo $hora?></td>
<!--
<?php if ($url_img_foto <> '') { ?><td align="center"><a href="../admin/edit_cargar_foto.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/existe_archivo.png" class="img-polaroid" alt=""></a></td>
<?php } else { ?><td align="center"><a href="../admin/edit_cargar_foto.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/no_existe_archivo.png" class="img-polaroid" alt=""></a></td><?php } ?>
-->
<td style="text-align:center"><a href="../admin/ver_historial_clinico_version_pdf_mejorada.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>" target="_blank"><img src="../imagenes/imprimir_peq.png" class="img-polaroid" alt=""></a></td>
<!--
<td style="text-align:center"><a href="../admin/ver_facturacion_por_historia_clinica_pdf.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>" target="_blank"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></td>
...
-->
<td style="text-align:center"><a href="../admin/reg_venta_temporal_producto_reg.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_producto=0&foco=0&pagina=<?php echo $pagina_facturacion?>"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></td>
<td style="text-align:center"><a href="../admin/enviar_historia_clinica_correo.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina_facturacion?>" target="_blank"><img src="../imagenes/enviar_historia_clinica_correo.png" class="img-polaroid" alt=""></a></td>
<td style="text-align:center"><a href="../admin/adjuntar_archivo_historia_clinica.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina_facturacion?>"><img src="../imagenes/adjuntar_archivo.png" class="img-polaroid" alt=""></a></td>
<td style="text-align:center"><a href="../admin/reg_historia_clinica_mejorada.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
</tr>
<?php } //end while ?>
<tr>
