...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$cod_info_cotizacion_factura_compra      = intval($_POST['cod_info_cotizacion_factura_compra']);
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_info_imp_factura = "SELECT * FROM tbl15_info_cotizacion_factura_compra WHERE cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra'";
...
if (isset($_POST['cod_info_cotizacion_factura_compra'])) {

	for ($i=0; $i < $total_datos; $i++) {

		$cod_cotizacion_compra_producto_temporal       = $_POST['cod_cotizacion_compra_producto_temporal'][$i];

		$sql_mconsulta = "SELECT * FROM tbl15_cotizacion_compra_producto_temporal WHERE (cod_cotizacion_compra_producto_temporal = '$cod_cotizacion_compra_producto_temporal')";
		...
		$sqlr_consulta = "SELECT und_producto, comision_ptj, precio_compra_producto, precio_costo_producto FROM tbl15_producto WHERE cod_producto_barra = '$cod_producto_barra'";
		...
		$agregar_reg_compra_producto = "INSERT INTO tbl15_cotizacion_compra_producto (cod_info_cotizacion_factura_compra, cod_tercero, cod_doc_soporte, cod_caja_virtual, 
		cod_producto, cod_producto_barra, nombre_producto, und_venta, und_producto, und_compra, und_unidades, und_caja, unidades_total, precio_compra_producto, 
		...
		VALUES ('$cod_info_cotizacion_factura_compra', '$cod_tercero', '$cod_doc_soporte', '$cod_caja_virtual', 
		'$cod_producto', '$cod_producto_barra', '$nombre_producto', '$und_venta', '$und_producto', '$und_compra', '$und_unidades', '$und_caja', '$unidades_total', '$precio_compra_producto', 
		'$total_compra_producto', '$precio_costo_producto', '$total_costo_producto', '$precio_venta_producto', '$precio_venta_producto2', '$precio_venta_producto3', 
		'$precio_venta_producto4', '$precio_venta_producto5', '$total_venta_producto', '$nombre_tipo_producto', '$nombre_tipo_unidad_medida', 
		'$nombre_tipo_presentacion', '$fecha_ymd_venta_producto', '$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', '$fecha_seg_venta_producto', 
...
//----------------------------------------------------------------------- ---------------------------------------------------------//
//----------------------------------------------------------------------- ---------------------------------------------------------//
	$borrar_sql = sprintf("DELETE FROM tbl15_cotizacion_compra_producto_temporal WHERE (cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra')");
...
//----------------------------------------------------------------------- ---------------------------------------------------------//   
	...
	$agregar_regis = sprintf("UPDATE tbl15_info_cotizacion_factura_compra SET cod_estado_factura = '$cod_estado_factura', cod_factura = '$cod_factura', fecha_anyo = '$fecha_anyo', 
	...
	subtotal = '$subtotal', valor_iva = '$valor_iva', total_descuento = '$total_descuento', total_precio_ipc = '$total_precio_ipc', 
	...
	cod_resolucion_facturacion = '$cod_resolucion_facturacion' 
	...
	$url_redir = "../admin/cotizacion_compra_productos_opcion_imprimir.php?cod_info_cotizacion_factura_compra=".$cod_info_cotizacion_factura_compra."&cod_tipo_pago=".$cod_tipo_pago."&pagina=".$pagina;
