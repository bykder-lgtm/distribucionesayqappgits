...
monto_deuda, monto_deuda_sin_interes, subtotal_sin_interes, monto_cuota, monto_cuota_sin_interes) 
...
if ($subtotal <= '0' ) { $cod_estado_contrato = 1; } else { $cod_estado_contrato = 0; } 
//-------------------------------------- -----------------------------------------------------------------//
...
nombre_tipo_calificacion = '$nombre_tipo_calificacion', cod_estado_contrato = '$cod_estado_contrato' WHERE (cod_cuentas_cobrar = '$cod_cuentas_cobrar')";
...
monto_deuda = '$monto_deuda', monto_deuda_sin_interes = '$monto_deuda_sin_interes', subtotal_sin_interes = '$subtotal_sin_interes', 
monto_cuota = '$monto_cuota', monto_cuota_sin_interes = '$monto_cuota_sin_interes', 
WHERE (cod_cuentas_cobrar_alerta = '$cod_cuentas_cobrar_alerta')";
$resultado_actualizacion1 = mysqli_query($conectar, $actualizar_sql1) or die(mysqli_error($conectar));
//-------------------------------------- -----------------------------------------------------------------//
$resultado_abono = $total_pagar - $abonado;
if ($resultado_abono <> '0') {
...
$cod_producto_barra              = $datos_cuentas_cobrar_alerta['cod_producto_barra'];
$nombre_producto                 = $datos_cuentas_cobrar_alerta['nombre_producto'];
$monto_deuda                     = $resultado_abono;
$monto_deuda_sin_interes         = $resultado_abono;
$subtotal                        = $resultado_abono;
$subtotal_sin_interes            = $resultado_abono;
$numero_cuota                    = $datos_cuentas_cobrar_alerta['numero_cuota'];
$monto_cuota                     = $resultado_abono;
$monto_cuota_sin_interes         = $resultado_abono;
...
$agregar_reg_cuentas_cobrar_abonos = "INSERT INTO tbl15_cuentas_cobrar_alerta (cod_cuentas_cobrar, cod_cuentas_cobrar_abonos, numero_alerta, cod_factura, cod_tercero, 
cod_producto, cod_producto_barra, nombre_producto, monto_deuda, monto_deuda_sin_interes, 
subtotal, subtotal_sin_interes, numero_cuota, monto_cuota, monto_cuota_sin_interes, nombre_tipo_cobro, 
vendedor, cuenta, fecha_pago, fecha, fecha_mes, anyo, fecha_invert, fecha_seg, cod_administrador, cod_estado, cod_tipo_moneda) 
VALUES ('$cod_cuentas_cobrar', '$cod_cuentas_cobrar_abonos', '$numero_alerta', '$cod_factura', '$cod_tercero', 
'$cod_producto', '$cod_producto_barra', '$nombre_producto', '$monto_deuda', '$monto_deuda_sin_interes', 
'$subtotal', '$subtotal_sin_interes', '$numero_cuota', '$monto_cuota', '$monto_cuota_sin_interes', '$nombre_tipo_cobro', 
'$vendedor', '$cuenta', '$fecha_pago', '$fecha', '$fecha_mes', '$anyo', '$fecha_invert', '$fecha_seg', '$cod_administrador', '$cod_estado', '$cod_tipo_moneda')";
$resultado_cuentas_cobrar_abonos = mysqli_query($conectar, $agregar_reg_cuentas_cobrar_abonos) or die(mysqli_error($conectar));
