...
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
$sql_motivo = "SELECT * FROM tbl15_historia_clinica WHERE (cod_historia_clinica='$cod_historia_clinica') AND (cod_estado_facturacion=1)";
$resultado_motivo = mysqli_query($conectar, $sql_motivo);
$info_motivo = mysqli_fetch_assoc($resultado_motivo); 

$nombre_empresa                 = $info_motivo['nombre_empresa'];
$cod_cliente                    = $info_motivo['cod_cliente'];
$nombre_contacto1               = $info_motivo['nombre_contacto1'];
$identificacion_contacto1       = $info_motivo['identificacion_contacto1'];
$direccion_contacto1            = $info_motivo['direccion_contacto1'];
$tel_contacto1                  = $info_motivo['tel_contacto1'];
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
  <tr>
    <td width="87" valign="top">Señor (es): '.$nombre_contacto1.'</td>
    <td width="40" valign="top">Nit: '.$identificacion_contacto1.'</td>
  </tr>
  <tr>
    <td width="87" valign="top">Dirección: '.$direccion_contacto1.'</td>
    <td width="40" valign="top">Tel: '.$tel_contacto1.'</td>
  </tr>
</table>
<!-- /////////////////////////////////////////////////// -->
<br>
...
$sql_motivo_conteo = "SELECT costo_motivo_consulta, fecha_ymd, cod_estado_facturacion, nombre_empresa, motivo 
FROM tbl15_historia_clinica WHERE (cod_historia_clinica='$cod_historia_clinica') AND (cod_estado_facturacion=1)";
...
$sum_costo_motivo_consulta      = $info_motivo_conteo['costo_motivo_consulta'];
