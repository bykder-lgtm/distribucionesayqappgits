...
if ($cod_tienda > 0) {
    ...
    $consulta_sql = "SELECT i.cod_info_factura_venta, i.cod_factura, i.total_precio_venta, i.fecha_anyo, i.fecha_hora,
    t.nombre1_tercero, t.nombre2_tercero, t.apellido1_tercero, t.apellido2_tercero, t.identificacion_tercero
    FROM tbl15_info_factura_venta i 
    LEFT JOIN tbl15_tercero t ON i.cod_tercero = t.cod_tercero
    WHERE i.cod_tienda = '$cod_tienda' AND i.nombre_estado_factura = 'ABIERTA' 
    ORDER BY i.fecha_anyo DESC, i.fecha_hora DESC";
