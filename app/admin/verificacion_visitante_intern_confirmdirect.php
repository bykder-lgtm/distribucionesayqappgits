...
if (conexiones($usuario, $clave)) {
	...
	$pag_redirec_sesion_ini      = "ver_producto_visitante_intern_confirmdirect.php";
...
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0.1; ../admin/entrar_visitante_intern_confirmdirect.php?error=<?php echo $error ?>">
<?php
}
?>
<!-- ***************************************************************************************************************************** -->
