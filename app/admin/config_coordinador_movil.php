...
<style>
/* ============================================ */
/* CONFIG COORDINADOR - TEMA AZUL INDIGO        */
/* ============================================ */
...
.menu-item-icon.green { background: rgba(99, 102, 241, 0.15); color: #6366f1; }
...
<main class="page-container">
    ...
    <div class="profile-card animate-in delay-1">
        ...
        <div class="profile-role">Coordinador</div>
    ...
    <div class="menu-section animate-in delay-2">
        ...
        <div class="menu-list">
            <a href="dashboard_coordinador_movil.php" class="menu-item">
            ...
            <a href="lista_tarea_coordinador_movil.php" class="menu-item">
            ...
            <a href="lista_tienda_coordinador_movil.php" class="menu-item">
            ...
            <a href="lista_notificacion_alerta_renovacion_coordinador_movil.php" class="menu-item">
    ...
    <div class="menu-section animate-in delay-3">
        ...
        <div class="menu-list">
            <a href="edit_perfil_coordinador.php" class="menu-item">
                <div class="menu-item-icon purple">
            ...
            <a href="cambiar_contrasena_coordinador_movil.php" class="menu-item">
                <div class="menu-item-icon blue">
    ...
    <div class="menu-section animate-in delay-3">
        ...
        <div class="menu-list">
            <a href="lista_tienda_coordinador_diseno_vertical.php" class="menu-item">
                <div class="menu-item-icon green">
...
function marcarTodasLeidasMovil() {
    Swal.fire({
        title: '¿Marcar todas como leídas?', text: 'Se marcarán todas las notificaciones pendientes como leídas', icon: 'question', showCancelButton: true, confirmButtonColor: '#6366f1',
