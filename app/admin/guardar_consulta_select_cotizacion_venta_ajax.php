...
$sql_data = "UPDATE tbl15_info_cotizacion_factura_venta SET cod_tercero = '$cod_tercero' WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta')";
