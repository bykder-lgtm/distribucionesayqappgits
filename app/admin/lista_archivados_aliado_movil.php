...
<style>
/* ============================================ */
/* LISTA ARCHIVADOS ALIADO - BLUE/DARK THEME   */
/* ============================================ */
...
.page-header {
    background: linear-gradient(135deg, #4169e1 0%, #2b4acb 100%);
    border-radius: 20px;
    padding: 1.5rem;
...
.tab-btn.active { background: #4169e1; color: white; box-shadow: 0 4px 15px rgba(65, 105, 225, 0.3); }
...
.archived-card:hover { opacity: 1; transform: translateY(-2px); background: rgba(255, 255, 255, 0.05); border-color: rgba(65, 105, 225, 0.3); }
...
.pagination-btn.active { background: #4169e1; }
...
function filtrar(val) {
    if (val.length > 2 || val.length == 0) {
        window.location.href = 'lista_archivados_aliado_movil.php?tab=<?php echo $tab; ?>&busqueda=' + val;
    }
}
