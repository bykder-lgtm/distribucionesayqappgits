...
$fecha_pago_reg_dmy             = date("d-m-Y", strtotime($fecha_pago_reg));
...
<td style="text-align: center;"><a href="../admin/reg_cuentas_cobrar_agrupado_detalle_factura_alquiler.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar;?>&cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta;?>&cod_factura=<?php echo $cod_factura;?>&numero_alerta=<?php echo $numero_alerta;?>&cod_tercero=<?php echo $cod_tercero;?>&cliente=<?php echo $cliente_inquilino;?>&pagina=<?php echo $pagina_local;?>"><img src=../imagenes/<?php echo $btn_imagen;?> alt="Abonar"></a></td>
<?php } else { ?>
