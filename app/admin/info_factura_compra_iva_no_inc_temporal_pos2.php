<?php if ($total_datos <> 0) { ?>
    ...
    $(document).ready(function(){
        $("#fecha_anyo").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: "../admin/guardar_info_factura_y_compra_producto_temporal_iva_no_inc_json_ajax.php",
                data: datos_url_ajax,
                //dataType: 'json',
    ...
    <table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
      ...
      <tr>
       ...
       <td style="text-align:center;"><input name="total_factura_compra_retefuente" id="total_factura_compra_retefuente" type="number" value="<?php echo $total_factura_compra_retefuente ?>" style="width: 110px;" step="any" min="1" required/></td>
