                                                ...
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        -->
                                                            ...
                                                            <a href="../admin/simulador_credito_producto_por_cuotas_visitante_intern.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>" class="cart_modif">Cotizar Credito</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <a href="../admin/simulador_credito_producto_visitante_intern.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>" class="cart_modif">Cotizar Credito</a>
