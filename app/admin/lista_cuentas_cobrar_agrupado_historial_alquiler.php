...
<h4><a href="#">Historial de alquiler inquilino</a></h4>
</div>
<hr>
<div class="row-fluid">
...
if (isset($_REQUEST['palabra'])) { $palabra = addslashes($_REQUEST['palabra']); } else { $palabra = ''; }
//-----------------------------------------------------------------------------------------------------------------//
...
$palabra = addslashes($_REQUEST['palabra']);

$calcular_datos_cuenta_cobrar = "SELECT MIN(tbl15_cuentas_cobrar.cod_estado_contrato) AS cod_estado_contrato, tbl15_cuentas_cobrar.cod_cuentas_cobrar, tbl15_cuentas_cobrar.cod_factura, 
tbl15_tercero.nombre1_tercero, tbl15_tercero.apellido1_tercero, tbl15_cuentas_cobrar.cod_tercero, tbl15_cuentas_cobrar.cod_administrador, tbl15_cuentas_cobrar.mensaje, 
...
tbl15_cuentas_cobrar.cod_producto, tbl15_cuentas_cobrar.nombre_producto, tbl15_cuentas_cobrar.nombre_tipo_cobro, 
...
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar.cod_tercero
WHERE ((tbl15_tercero.nombre1_tercero LIKE '%$palabra%') OR (tbl15_cuentas_cobrar.cod_factura LIKE '$palabra')) AND (tbl15_cuentas_cobrar.cod_estado_archivado = '0') 
GROUP BY tbl15_cuentas_cobrar.cod_factura DESC";
...
tbl15_tercero.nombre_departamento, tbl15_tercero.nombre_ciudad, tbl15_tercero.telefono1_tercero, tbl15_tercero.identificacion_tercero
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar.cod_tercero
WHERE (tbl15_cuentas_cobrar.cod_estado_archivado = '0')
GROUP BY tbl15_cuentas_cobrar.cod_factura DESC";
$consulta_datos_cuenta_cobrar = mysqli_query($conectar, $calcular_datos_cuenta_cobrar);
} 
...
<td style="text-align: center;"><font size='3'><a href="../admin/cuentas_cobrar_agrupado_detalle_factura_alquiler.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar; ?>&cod_tercero=<?php echo $cod_tercero; ?>&cod_factura=<?php echo $cod_factura; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/ver.png" class="img-polaroid" alt=""></a></font></td>
