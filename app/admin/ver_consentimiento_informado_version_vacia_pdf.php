...
$palabras_claves_doc_pdf             = "CONSENTIMIENTO INFORMADO";
...
<table align="center" border="1" cellspacing="0" cellpadding="0" style="font-family:mono;  font-size:'.$tamano_font_manaliment_emp.'pt; width:100%">
  <tr>
    ...
    <td width="50%" rowspan="3" align="center">AUTOREPORTE DE CONDICIONES DE SALUD Y ANTECEDENTES MÉDICOS</td>
    <td width="25%" align="center"><barcode code="'.$cod_consentimiento_informado_strpad.'" type="C128A" size="0.5" height="1" /></td>
  </tr>
  <tr >
    <td align="center">CCI: '.$cod_consentimiento_informado_strpad.'</td>
  </tr>
  <tr>
...
<table align="center" border="1" cellspacing="0" width="100%" style="font-family: Mono; font-size: 9pt;">
  <tr>
    <td colspan="4">VIII. HA TENIDO ALGUNOS DE ESTOS SIGNOS O SINTOMAS EN LOS ULTIMOS DIAS:</td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>FIEBRE</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>ESCALOFRIOS</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>CANSANCIO</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>MALESTAR GENERAL</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>FATIGA</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>TOS SECA</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>CEFALEAS</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>CONGESTION NASAL</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>SECRECIONES NASALES</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>DOLOR DE GARGANTA</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>DIARREA</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>DIFICULTAD RESPIRATORIA</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>INAPETENCIA</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>PERDIDA DEL OLFATO</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>PERDIDA EL GUSTO</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>DEDOS DE COVID(MORETONES EN CUALQUIER SITIO DEL CUERPO</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>DOLOR TORÁCICO</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>CONFUSION</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>COLORACION AZULADA EN LABIOS O EL ROSTRO</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
  <tr>
    <td style="text-align:left" width="50%"><ul><li>HABER ESTADO CERCA DE UNA PERSONA CON ESTOS SINTOMAS, O QUE HALLA SIDO DIÁGNOSTICADO CON COVID-19</li></ul></td>
    <td style="text-align:center" width="5%">SI</td>
    <td style="text-align:center" width="5%">NO</td>
    <td style="text-align:center"></td>
  </tr>
...
<table align="center" border="1" cellspacing="0" width="100%" style="font-family: Mono; font-size: 9pt;">
  <tr>
    <td>IX. POLITICA DE PROTECCION DE DATOS.</td>
  </tr>
  <tr>
...
<table align="center" border="1" cellspacing="0" width="100%" style="font-family: Mono; font-size: 9pt;">
  <tr>
    <td>X. CONSENTIMIENTO INFORMADO.</td>
  </tr>
  <tr>
    <td><br>Yo ___________________________ con documento de identificación No ______________________ en 
...
<table align="center" border="0" cellspacing="0" width="100%" style="font-family: Mono; font-size: 9pt;">
  ...
  <tr>
    <td style="text-align:left; height:60px" width="70%">_______________________________________________________</td>
    <td style="text-align:left; border:1; height:60px"></td>
...
$ruta = '../pdfs/';
$nombre_archivo = 'CONSENTIMIENTO_INFORMADO.pdf';
