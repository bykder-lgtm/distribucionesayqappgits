...
$datos_factura = "SELECT cod_factura_compra_producto FROM tbl15_factura_compra_producto WHERE (cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra')";
...
xmlhttp.open("POST","../admin/busqueda_inmediata_factura_compra_producto_php.php",true);
...
<tbody>
<?php
$sql_factura_compra_producto = "SELECT * FROM tbl15_factura_compra_producto WHERE (cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra') ORDER BY cod_factura_compra_producto DESC";
...
$cod_info_cotizacion_factura_compra            = $datos_factura_compra_producto['cod_info_cotizacion_factura_compra'];
