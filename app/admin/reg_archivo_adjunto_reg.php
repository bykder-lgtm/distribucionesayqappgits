...
if ((isset($_POST["insersion"])) && ($_POST["insersion"] == "formulario_de_insersion")) {
	...
	if (isset($_POST['cod_archivador']) <> '') { $cod_archivador = addslashes($_POST['cod_archivador']); } else { $cod_archivador = ''; }
...
/* ----------------------------------------------------------------------------------------------------------/ */
	if (move_uploaded_file($_FILES['url_img1']['tmp_name'], $url_img_orig_producto)) {
 	...
 	$pagina_redirect                                    = '../admin/ver_historial_archivo_adjunto.php'.'?cod_archivador='.$cod_archivador.'&cod_archivo_adjunto='.$cod_archivo_adjunto.'&resultado_subir_archivo='.$resultado_subir_archivo;
/* ----------------------------------------------------------------------------------------------------------/ */
?>
