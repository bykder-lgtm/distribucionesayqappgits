	...
	if ($url_img1 <> '') { 
		...
		if ($imagen_foto_miniatura->uploaded) {
			...
			if ($url_img_orig_producto_db == '') {
				$actualiza_producto = sprintf("UPDATE tbl15_producto SET url_img_orig_producto = '$url_img_orig_producto', url_img_min_producto = '$url_img_min_producto', url_img_producto_orig = '$url_img_producto_orig', url_img_producto_min = '$url_img_producto_min' 
