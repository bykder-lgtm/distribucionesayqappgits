...
$sql_info_factura = "SELECT * FROM tbl15_info_cita_factura_venta WHERE cod_info_cita_factura_venta = '$cod_info_cita_factura_venta'";
...
$sql_motivo_conteo = "SELECT * FROM tbl15_cita_venta_producto WHERE (cod_factura = '$cod_factura') ORDER BY cod_cita_venta_producto DESC";
