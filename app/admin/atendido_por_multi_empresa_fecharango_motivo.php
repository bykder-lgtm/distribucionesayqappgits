...
<table cellspacing="0" cellpadding="0">
  <tr>
    <td><a>EMPRESA:</a></td>
    <td>
<select name="nombre_empresa[]" data-placeholder="Empresa" class="chosen-select" multiple tabindex="4" required>
<?php $consulta2_sql = "SELECT cod_empresa, nombre_empresa FROM tbl15_empresa ORDER BY nombre_empresa ASC";
$consulta2 = mysqli_query($conectar, $consulta2_sql);
while ($datos2 = mysqli_fetch_assoc($consulta2)) {
$cod_empresa = $datos2['cod_empresa'];
$nombre_empresa = $datos2['nombre_empresa'];
?><option value="<?php echo $nombre_empresa ?>"><?php echo $nombre_empresa ?></option><?php } ?></select>
    </td>
  </tr>
  <tr>
    <td><a>MOTIVO:</a></td>
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_hombre = "SELECT Count(tbl15_cliente.nombre_sexo) AS conteo_hombre, tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_ymd, tbl15_historia_clinica.motivo
...
GROUP BY tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_ymd
HAVING (tbl15_historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (tbl15_historia_clinica.nombre_empresa='$nombre_empresa') 
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_mujer = "SELECT Count(tbl15_cliente.nombre_sexo) AS conteo_mujer, tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_ymd, tbl15_historia_clinica.motivo
FROM tbl15_empresa RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_historia_clinica ON tbl15_administrador.cod_administrador = tbl15_historia_clinica.cod_administrador) ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente) ON tbl15_empresa.nombre_empresa = tbl15_historia_clinica.nombre_empresa
GROUP BY tbl15_historia_clinica.nombre_empresa, tbl15_historia_clinica.cod_estado_facturacion, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.fecha_ymd
HAVING (tbl15_historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (tbl15_historia_clinica.nombre_empresa='$nombre_empresa') 
...
<th style="text-align:center"><a href="../admin/ver_lista_por_empresa_fecharango_motivo_version_xlsx.php?fecha=<?php echo $fecha ?>&fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=1&motivo=<?php echo $motivo ?>&cuenta=<?php echo $cuenta_actual ?>" target="_blank"><img src="../imagenes/ver_lista_excel_grande.png"></a></th>
...
<th style="text-align:center"><a href="../admin/ver_lista_por_empresa_fecharango_motivo_version_xlsx.php?fecha=<?php echo $fecha ?>&fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=2&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>&cuenta=<?php echo $cuenta_actual ?>" target="_blank"><img src="../imagenes/ver_lista_excel_grande.png"></a></th>
...
<th style="text-align:center"><a href="../admin/ver_lista_por_empresa_fecharango_motivo_version_xlsx.php?fecha=<?php echo $fecha ?>&fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=4&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>&motivo3=<?php echo $motivo3 ?>&motivo4=<?php echo $motivo4 ?>&cuenta=<?php echo $cuenta_actual ?>" target="_blank"><img src="../imagenes/ver_lista_excel_grande.png"></a></th>
...
<th style="text-align:center"><a href="../admin/ver_lista_por_empresa_fecharango_motivo_version_xlsx.php?fecha=<?php echo $fecha ?>&fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=5&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>&motivo3=<?php echo $motivo3 ?>&motivo4=<?php echo $motivo4 ?>&motivo5=<?php echo $motivo5 ?>&cuenta=<?php echo $cuenta_actual ?>" target="_blank"><img src="../imagenes/ver_lista_excel_grande.png"></a></th>
...
<th style="text-align:center"><a href="../admin/ver_lista_por_empresa_fecharango_motivo_version_xlsx.php?fecha=<?php echo $fecha ?>&fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=6&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>&motivo3=<?php echo $motivo3 ?>&motivo4=<?php echo $motivo4 ?>&motivo5=<?php echo $motivo5 ?>&motivo6=<?php echo $motivo6 ?>&cuenta=<?php echo $cuenta_actual ?>" target="_blank"><img src="../imagenes/ver_lista_excel_grande.png"></a></th>
...
<th style="text-align:center"><a href="../admin/ver_lista_por_empresa_fecharango_motivo_version_xlsx.php?fecha=<?php echo $fecha ?>&fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=7&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>&motivo3=<?php echo $motivo3 ?>&motivo4=<?php echo $motivo4 ?>&motivo5=<?php echo $motivo5 ?>&motivo6=<?php echo $motivo6 ?>&motivo7=<?php echo $motivo7 ?>&cuenta=<?php echo $cuenta_actual ?>" target="_blank"><img src="../imagenes/ver_lista_excel_grande.png"></a></th>
...
<th style="text-align:center"><a href="../admin/ver_lista_por_empresa_fecharango_motivo_version_xlsx.php?fecha=<?php echo $fecha ?>&fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=8&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>&motivo3=<?php echo $motivo3 ?>&motivo4=<?php echo $motivo4 ?>&motivo5=<?php echo $motivo5 ?>&motivo6=<?php echo $motivo6 ?>&motivo7=<?php echo $motivo7 ?>&motivo8=<?php echo $motivo8 ?>&cuenta=<?php echo $cuenta_actual ?>" target="_blank"><img src="../imagenes/ver_lista_excel_grande.png"></a></th>
