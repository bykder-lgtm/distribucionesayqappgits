...
if ((isset($_POST["insersion"])) && ($_POST["insersion"] == "formulario_de_insersion")) {
	...
	if (isset($_POST['deduccion_comision_ptj']) <> '') { $deduccion_comision_ptj = intval($_POST['deduccion_comision_ptj']); } else { $deduccion_comision_ptj = '0'; }
	if (isset($_POST['deduccion_retefuente']) <> '') { $deduccion_retefuente = intval($_POST['deduccion_retefuente']); } else { $deduccion_retefuente = '0'; }
	if (isset($_POST['deduccion_otro_concepto']) <> '') { $deduccion_otro_concepto = intval($_POST['deduccion_otro_concepto']); } else { $deduccion_otro_concepto = '0'; }
...
/* ----------------------------------------------------------------------------------------------------------/ */
	...
	$total_ingreso                  = $monto_deuda_sin_interes_libre;
	/* ----------------------------------------------------------------------------------------------------------/ */
...
/* ----------------------------------------------------------------------------------------------------------/ */
	...
	cod_tercero_propietario, deduccion_comision_ptj) 
...
/* ----------------------------------------------------------------------------------------------------------/ */
	for ($contador=0; $contador < $numero_cuota ; $contador++) { 
		...
		cod_producto, cod_producto_barra, nombre_producto, cod_estado, cod_tercero_propietario, total_pagar, total_pendiente, total_ingreso, deduccion_comision_ptj, 
		deduccion_retefuente, deduccion_otro_concepto, fecha_pago_periodo_orig, fecha_alerta_pago_comision_prop) 
