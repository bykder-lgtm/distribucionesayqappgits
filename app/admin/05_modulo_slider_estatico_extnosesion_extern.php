<section id="main-slider_css_slider" class="no-margin_css_slider">
    <div class="carousel slide">
        ...
        <?php
        $aumentar = -1;
        $sql_info_portafolio = "SELECT * FROM tbl15_banner_slider WHERE (cod_estado = '1')";
        ...
        <?php
        $sql_info_portafolio = "SELECT * FROM tbl15_banner_slider WHERE (cod_banner_slider = '5') AND (cod_estado = '1')";
        $cons_info_portafolio = mysqli_query($conectar, $sql_info_portafolio) or die(mysqli_error($conectar));
        while ($datos_info_portafolio = mysqli_fetch_assoc($cons_info_portafolio)) {
            ...
            $active_banner_slider2                      = $datos_info_portafolio['active_banner_slider2'];
        ...
        ?>
        <div class="item <?php echo $active_banner_slider2 ?>" style="background-image: url(<?php echo $nombre_carpeta_pagina ?>/<?php echo $nombre_carpeta_pagina ?>/<?php echo $url_img_banner_slider_orig ?>)">
            <div class="container">
                <div class="row slide-margin">
                    <div class="col-sm-6">
                        <div class="carousel-content">
                            ...
                            <a class="btn-slide animation animated-item-3" href="<?php echo $nombre_carpeta_pagina ?>/admin/como_funciona_extnosesion.php?cod_banner_slider_codifcryp=<?php echo $cod_banner_slider_codifcryp ?>"><?php echo $texto_boton_accion_banner_slider ?></a>
                            <br>
                            <a class="btn-slide animation animated-item-4" href="#">Quiero ser Aliado / Asesor</a>
