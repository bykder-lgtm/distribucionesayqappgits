...
$pagina                             = addslashes($_GET['pagina'])."?&foco=".$foco."&buscar_por=".$buscar_por."&pagina=facturacion_auditoria_temporal_producto_manual_pos.php";
...
//$cod_info_factura_auditoria     = $datos_producto['cod_info_factura_auditoria'];
...
$datos_info = "SELECT * FROM tbl15_info_factura_auditoria WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
und_unidades, und_caja, nombre_tipo_cargue_factura, comision_ptj) 
...
$sql_info_factura = "SELECT cod_info_factura_auditoria, cod_tercero FROM tbl15_info_factura_auditoria WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_info_factura_auditoria             = $datos_info_factura['cod_info_factura_auditoria'];
