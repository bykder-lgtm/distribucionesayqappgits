...
$(document).ready(function(){
    ...
    $(document).on('click', '#info_ajax', function(e){
        ...
        var cod_tercero = frag[0];
        var nombres_apellidos = frag[1];
        var cedula = frag[2];

        SwalDelete(cod_tercero, nombres_apellidos, cedula);
        e.preventDefault();
    });
...
//------------------------------------------------------------------------------------------------------------------//
//------------------------------------------------------------------------------------------------------------------//
function SwalDelete(cod_tercero, nombres_apellidos, identificacion_tercero){
