...
$sql_info_factura = "SELECT * FROM tbl15_info_parqueo_cotizacion_factura_venta WHERE cod_info_parqueo_cotizacion_factura_venta = '$cod_info_parqueo_cotizacion_factura_venta'";
...
$nombres_completos                 = "FACTURA PARQUEO";
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:25pt; width:100%; border-collapse: collapse; border:1px solid #999999">
  ...
  <tr>
    <td style="text-align:center; font-size:12pt;">NIT: 900142732-7 </td>
  </tr>
  <tr>
...
$codigoHTML.='
  <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
    <tr>
    <td width="40" valign="top">  * SITIO DE RECIBO, KM 12 VIA PLANETA RICA, 100 METROS PASANDO EL PEAJE </td>
    </tr>
    <tr>
     <td width="40" valign="top">  HORARIO DE RECIBIDO: LUNES A VIERNES: 7:00 AM  A  11:00 AM Y  DE 1:00 PM A 3:00 PM,  SABADOS:8:00 AM A 12:00M </td>
   </tr>
</table>
';
}
...
$codigoHTML.='
  <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
    ...
    <tr>
     <td width="40" valign="top">  HORARIO DE ENTREGA: LUNES A VIERNES: 7:00 AM  A  11:00 AM Y  DE 1:00 PM A 3:00 PM,  SABADOS:8:00 AM A 12:00M </td>
   </tr>
</table>
';
}
...
$sql_motivo_conteo = "SELECT * FROM tbl15_parqueo_cotizacion_venta_producto WHERE (cod_info_parqueo_cotizacion_factura_venta = '$cod_info_parqueo_cotizacion_factura_venta') ORDER BY cod_parqueo_cotizacion_venta_producto DESC";
...
$codigoHTML.='
  <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
    <tr>
     <td width="40" valign="top">  Señor PROVEEDOR: si industrias Corfibra LTDA, recibe un producto que no cumpla las condiciones de calidad requeridas, hará devolución del producto en su totalidad, no asumiendo costo alguno por  concepto de fletes u otros relacionados. </td>
    </tr>
</table>
';
}
