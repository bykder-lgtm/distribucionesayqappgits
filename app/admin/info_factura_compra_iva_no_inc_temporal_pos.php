...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
        ...
        $("input").on('change', function () {
            ...
            $.ajax({
                ...
                success:function(respuesta){
                    ...
                    if ((campo == 'precio_costo_producto') && (afectado == 'SI')) {
                        var subtotal = respuesta.subtotal;
                        var total_precio_ipc = respuesta.total_precio_ipc;
                        var valor_iva = respuesta.valor_iva;
                        var total_rete_fuente = respuesta.total_rete_fuente;
    ...
    <?php if ($cod_estado_generar_movimiento_contable_automatico_global == '1') { ?>
        <td style="text-align:center;">
            ...
            <br>
            <?php if ($cod_estado_mov_contable_antes_de_guardar == '0') { echo '<a href="../admin/generar_mov_contable_antes_de_guardar_reg.php?cod_info_factura_compra='.$cod_info_factura_compra.'&pagina='.$pagina_local.'">Generar Mov Contable Antes de Guardar</a>'; } ?>
        </td>
    <?php } ?>
