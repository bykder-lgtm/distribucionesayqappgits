...
$pagina                                          = addslashes($_GET['pagina']).'?cod_info_cotizacion_factura_venta='.$cod_info_cotizacion_factura_venta;
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_cotizacion_factura_venta WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta')";
...
FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') AND (cod_producto_barra = '$cod_servicio_cupobrilla')";
...
$precio_venta_producto_cupobrilla         = intval($info_servicio_cupobrilla['precio_venta_producto']);
...
Sum(total_venta_producto*(descuento_ptj/100)) AS total_desc, Sum(total_venta_producto) AS total_venta_neta FROM tbl15_cotizacion_venta_producto 
...
$subtotal_base                       = ($suma['subtotal_base']) - $precio_venta_producto_cupobrilla;
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_venta_descuento_manual_como_concepto = "SELECT Sum(total_venta_producto) As total_descuento_manual_como_concepto FROM tbl15_cotizacion_venta_producto 
WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') AND (cod_producto_barra = '$cod_servicio_descuento')";
...
FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') AND (cod_producto_barra <> '$cod_servicio_descuento') AND (cod_producto_barra <> '$cod_servicio_propina') 
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_venta_descuento_puntos_redimibles_como_concepto = "SELECT Sum(total_venta_producto) As total_descuento_puntos_redimibles_como_concepto, nombre_producto FROM tbl15_cotizacion_venta_producto 
WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') AND (cod_producto_barra = '$cod_servicio_descuento_punto_redimible')";
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_venta_retefuente = "SELECT Sum(total_venta_producto) As total_descuento_retefuente, nombre_producto FROM tbl15_cotizacion_venta_producto 
WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') AND (cod_producto_barra = '$cod_servicio_retefuente')";
...
FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') AND (cod_producto_barra = '$cod_servicio_propina')";
...
FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') AND (cod_producto_barra = '$cod_servicio_domicilio')";
...
$cod_info_factura_strpad   = str_pad($cod_info_cotizacion_factura_venta, 6, "0", STR_PAD_LEFT);
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$resta                               = 1516399999;
$time_seg                            = time();
...
<table class="table table-striped">
  ...
  <tr>
    <td><font color='black' size= "+3">COTIZACION DE VENTA NO:</font></td>
  ...
  <tr>
    <td><font color='black' size= "+3">TOTAL COTIZACION DE VENTA:</font></td>
  ...
  <tr>
    ...
    <td align='center'><a href="../admin/ver_factura_cotizacion_venta_pdf.php?cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta?>" target="_blank"><img src="../imagenes/imprimir_.png"></a></td>
  </tr>
</table>
</center>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <td style="text-align: center; width: 98%; font-family: Helvetica; font-size:12pt;"><img src="../imagenes/logo_empresa_factura_pos_blanco_negro.jpg" width="100px"></td>
  </tr>
</table>
<?php } ?>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <th style="text-align: center; width: 99%; font-family: Helvetica; font-size:8pt;"><?php echo $nombre_emp; ?></th>
  </tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <th style="text-align: center; width: 99%; font-family: Helvetica; font-size:8pt;"><?php echo $localidad_emp; ?></th>
  </tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <th style="text-align: center; width: 99%; font-family: Helvetica; font-size:8pt;">NIT: <?php echo $nit_empresa_emp; ?></th>
  </tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <th style="text-align: center; width: 99%; font-family: Helvetica; font-size:8pt;">DIRECCION: <?php echo $direccion_emp; ?></th>
  </tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <th style="text-align: center; width: 99%; font-family: Helvetica; font-size:8pt;">TELEFONO: <?php echo $telefono_emp; ?></th>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">FECHA: <?php echo $fecha_anyo; ?> - <?php echo $fecha_hora; ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">COTIZACION DE VENTA: <?php echo $prefijo_resolucion_facturacion.' '.$cod_factura; ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">FORMA DE PAGO: <?php echo $nombre_tipo_forma_pago; ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">TIPO DE PAGO: <?php echo $nombre_tipo_pago; ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">NIT CLIENTE: <?php echo ($cedula_cli); ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">NOMBRE CLIENTE: <?php echo utf8_decode($nombre_cliente); ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">VENDEDOR (A): <?php echo $usario_vendedor; ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 98%; font-family: Helvetica; font-size:8pt;">CAJA: <?php echo $cod_caja; ?></th>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="2" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <th style="text-align: center; width:10%; font-family: Helvetica; font-size:8pt;">CANT</th>
    <th style="text-align: center; width:50%; font-family: Helvetica; font-size:8pt;">ARTICULO</th>
    <th style="text-align: center; width:15%; font-family: Helvetica; font-size:8pt;">P.UNIT</th>
    <th style="text-align: center; width:15%; font-family: Helvetica; font-size:8pt;">P.TOTAL</th>
    <th style="text-align: center; width:10%; font-family: Helvetica; font-size:8pt;"></th>
  </tr>
<?php
...
?>
  <tr>
    <th style="text-align: center; width:10%; font-family: Helvetica; font-size:8pt;"><?php echo $und_venta ?></th>
    <th style="text-align: left; width:50%; font-family: Helvetica; font-size:8pt;"><?php echo $nombre_producto ?></th>
    <th style="text-align: right; width:14%; font-family: Helvetica; font-size:8pt;"><?php echo number_format($precio_venta_producto, 0, ",", ".") ?></th>
    <th style="text-align: right; width:14%; font-family: Helvetica; font-size:8pt;"><?php echo number_format($total_venta_producto, 0, ",", ".") ?></th>
    <th style="text-align: left; width:10%; font-family: Helvetica; font-size:7pt;"><?php echo $nombre_tipo_iva ?></th>
  </tr>
<?php } ?>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    ...
    <th style="text-align: right; width: 20%; font-family: Helvetica; font-size:7pt;"><?php echo number_format($subtotal_base, 0, ",", ".") ?></th>
    <th style="text-align: right; width: 5%; font-family: Helvetica; font-size:7pt;"></th>
  </tr>
  <tr>
    <th style="text-align: right; width: 50%; font-family: Helvetica; font-size:7pt;">%DESC:</th>
    <th style="text-align: right; width: 20%; font-family: Helvetica; font-size:7pt;"><?php echo number_format($descuento_ptj, 0, ",", ".") ?></th>
    <th style="text-align: right; width: 5%; font-family: Helvetica; font-size:7pt;"></th>
  </tr>
  <tr>
    <th style="text-align: right; width: 50%; font-family: Helvetica; font-size:7pt;">$DESC:</th>
    <th style="text-align: right; width: 20%; font-family: Helvetica; font-size:7pt;"><?php echo number_format($total_desc, 0, ",", ".") ?></th>
    <th style="text-align: right; width: 5%; font-family: Helvetica; font-size:7pt;"></th>
  </tr>
  ...
  <tr>
    ...
    <?php } ?>
  <tr>
    <th style="text-align: center; width: 50%; font-family: Helvetica; font-size:8pt;">----------------------------------</th>
    <th style="text-align: center; width: 20%; font-family: Helvetica; font-size:8pt;">----------------------------------</th>
    <th style="text-align: center; width: 5%; font-family: Helvetica; font-size:8pt;"></th>
  </tr>
  <tr>
    <th style="text-align: right; width: 50%; font-family: Helvetica; font-size:8pt;">TOTAL:</th>
    <th style="text-align: right; width: 20%; font-family: Helvetica; font-size:8pt;"><?php echo number_format($total_venta_temp, 0, ",", ".") ?></th>
    <th style="text-align: right; width: 5%; font-family: Helvetica; font-size:8pt;"></th>
  </tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <td style="text-align: center; width: 95%; font-family: Helvetica; font-size:8pt;">****************************************</td>
  </tr>
  <tr>
    <td style="text-align: center; width: 95%; font-family: Helvetica; font-size:8pt;"><strong>Muchas gracias por su preferencia</strong></td>
  </tr>
  <tr>
    <td style="text-align: center; width: 95%; font-family: Helvetica; font-size:8pt;"><strong>Precios sujetos a cambios</strong></td>
  </tr>
  <tr>
    <td style="text-align: center; width: 95%; font-family: Helvetica; font-size:8pt;">****************************************</td>
  </tr>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:8pt;">
  <tr>
    <td style="text-align: center; width: 98%; font-family: Helvetica; font-size:8pt;"><div id="codigo_codabar_php"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Helvetica; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_factura.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_cotiz_nrm</td>
  </tr>
</table>
