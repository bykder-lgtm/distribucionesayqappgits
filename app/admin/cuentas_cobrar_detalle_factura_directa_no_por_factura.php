...
<tr>
<td style="text-align: center;"><strong><a href="../admin/lista_cuentas_cobrar_directa_no_por_factura.php"><font size="5px">REGRESAR</font></a></strong></td>
</tr>
<tr>
...
<tr>
<td style="text-align: center;"><a href="../admin/reg_abono_cuentas_cobrar_directa_no_por_factura.php?cod_tercero=<?php echo $cod_tercero?>&pagina=<?php echo $pagina?>"><font size="6px">NUEVO ABONO</font></a></td>
</tr>
<?php } ?>
</table>
</table>
...
tbl15_cuentas_cobrar.monto_deuda, tbl15_cuentas_cobrar.abonado, tbl15_cuentas_cobrar.subtotal,  tbl15_cuentas_cobrar.cod_tipo_forma_pago, tbl15_tercero.nombre1_tercero, tbl15_tercero.apellido1_tercero, 
...
while ($datos_cuenta_cobrar = mysqli_fetch_assoc($consulta_datos_cuenta_cobrar)) {
	...
	$calcular_datos_tipo_forma_pago = "SELECT * FROM tbl15_tipo_forma_pago WHERE (cod_tipo_forma_pago = '$cod_tipo_forma_pago')";
	$consulta_datos_tipo_forma_pago = mysqli_query($conectar, $calcular_datos_tipo_forma_pago);
...
?>
	<tr>
		...
		<td style="text-align: center;"><font size='3'><?php echo $nombre_tipo_forma_pago;?></font></td>
		...
		<?php if ($cod_estado_cuenta_cobrar_editar== '1') { ?>
		<td style="text-align: center;"><a href="../admin/edit_cuentas_cobrar_factura_directa_no_por_factura.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar;?>&cod_factura=<?php echo $cod_factura;?>&cod_info_factura_venta=<?php echo $cod_info_factura_venta;?>&cod_tercero=<?php echo $cod_tercero;?>&cliente=<?php echo $cliente;?>&pagina=<?php echo $pagina;?>"><img src=../imagenes/editar.png alt="Abonar"></a></td>
		<?php } ?>
		<?php if ($cod_estado_cuenta_cobrar_eliminar == '1') { ?>
		<td style="text-align:center"><a href="../admin/eliminar.php?llave=<?php echo $cod_cuentas_cobrar; ?>&cod_tercero=<?php echo $cod_tercero;?>&tab=<?php echo $tab1; ?>&campo=<?php echo $campo1; ?>&tipo=<?php echo $tipo; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>
		<?php } ?>
	</tr>
<?php } ?>
</table>
...
<?php
$sql = "SELECT * FROM tbl15_cuentas_cobrar_abonos WHERE (cod_tercero = '$cod_tercero') AND (cod_estado_archivado = '0') ORDER BY cod_cuentas_cobrar_abonos DESC";
...
?>
	...
	<tr>
      <?php if ($cod_estado_habilitar_btn_imp_venta_direct_driv_global == '0') { ?>
      <td style="text-align:center;"><button onclick="btnImprimirAbonoCuentaCobrar(<?php echo $cod_cuentas_cobrar_abonos; ?>)"><img src="../imagenes/imprimir_imgpeq.png" alt="imprimir"></button></td>
      <?php } ?>
		...
		<td style="text-align: center;">
			...
			<br>
			<a href="../admin/edit_cuentas_cobrar_directa_no_por_factura_forma_pago_movimiento_contable_cuenta_personal.php?cod_cuentas_cobrar_abonos=<?php echo $cod_cuentas_cobrar_abonos ?>&cod_movimiento_contable_cuenta_personal=<?php echo $cod_movimiento_contable_cuenta_personal ?>&cod_tercero=<?php echo $cod_tercero ?>&cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar ?>&cliente=<?php echo $cliente;?>&pagina=<?php echo $pagina;?>">(<?php echo $nombre_puc; ?>)</a>
			</font>
		</td>
		...
		<?php if ($cod_estado_cuenta_cobrar_eliminar == '1') { ?>
		<td style="text-align:center"><a href="../admin/eliminar.php?llave=<?php echo $cod_cuentas_cobrar_abonos; ?>&cod_tercero=<?php echo $cod_tercero;?>&tab=<?php echo $tab2; ?>&campo=<?php echo $campo2; ?>&tipo=<?php echo $tipo; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>
		<?php } ?>
...
<table class="table table-striped">
	<tr>
		...
		<th style="text-align: center;"><a href="../admin/cuentas_cobrar_cliente_actualizar_directa_no_por_factura.php?cod_tercero=<?php echo $cod_tercero; ?>&pagina=<?php echo $pagina; ?>">.</a></th>
	</tr>
	<tr>
...
<table border="1" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:9pt;">
	<tr>
		<th style="text-align: center; width:10%; font-family: Courier; font-size:10pt;">FACT</th>
		<th style="text-align: center; width:50%; font-family: Courier; font-size:10pt;">CREDIT</th>
		<th style="text-align: center; width:15%; font-family: Courier; font-size:10pt;">ABONAD</th>
		<th style="text-align: center; width:5%; font-family: Courier; font-size:10pt;">PENDIENTE</th>
		<th style="text-align: center; width:5%; font-family: Courier; font-size:10pt;">FECHA</th>
		<th style="text-align: center; width:5%; font-family: Courier; font-size:10pt;"></th>
	</tr>
<?php
...
?>
	<tr>
		<th style="text-align: center; width:10%; font-family: Courier; font-size:10pt;"><?php echo $cod_factura ?></th>
		<th style="text-align: right; width:50%; font-family: Courier; font-size:10pt;"><?php echo number_format($monto_deuda, 0, ",", ".") ?></th>
		<th style="text-align: right; width:50%; font-family: Courier; font-size:10pt;"><?php echo number_format($abonado, 0, ",", ".") ?></th>
		<th style="text-align: right; width:50%; font-family: Courier; font-size:10pt;"><?php echo number_format($subtotal, 0, ",", ".") ?></th>
		<th style="text-align: right; width:15%; font-family: Courier; font-size:10pt;"><?php echo $fecha_pago ?></th>
		<th style="text-align: center; width:5%; font-family: Courier; font-size:10pt;"></th>
	</tr>
<?php } ?>
</table>
...
<script>  
 $(document).ready(function(){  
  ...
  <script>  
	function btnImprimirAbonoCuentaCobrar(cod_cuentas_cobrar_abonos) {
    var origen = "0";  
