...
<tbody>
<?php
$sql_info_factura = "SELECT nombre_producto, cod_producto_barra, precio_venta_producto, total_venta_producto, fecha_mes_venta_producto, und_venta, und_producto, cod_guia, nombre_info_empresa, fecha_modificacion
FROM tbl15_producto_mas_vendido_externo GROUP BY cod_guia DESC";
...
$nombre_info_empresa                          = $info_info_factura['nombre_info_empresa'];
$cod_guia                                     = $info_info_factura['cod_guia'];
$fecha_modificacion                           = $info_info_factura['fecha_modificacion'];

?>
  <tr>
    <td style="text-align:center;"><?php echo $nombre_info_empresa ?></td>
