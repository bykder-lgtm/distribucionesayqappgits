...
$pagina                                                        = addslashes($_GET['pagina']).'?cod_info_cambio_precio_venta_predeterm_producto='.$cod_info_cambio_precio_venta_predeterm_producto;
$cod_info_cambio_precio_venta_predeterm_producto_codif         = DAXCODIFCRYPTOR::encodifdax($cod_info_cambio_precio_venta_predeterm_producto);
$cod_info_cambio_precio_venta_predeterm_producto_codif_cryp    = DAXCODIFCRYPTOR::encriptardax($cod_info_cambio_precio_venta_predeterm_producto_codif);
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_cambio_precio_venta_predeterm_producto WHERE (cod_info_cambio_precio_venta_predeterm_producto = '$cod_info_cambio_precio_venta_predeterm_producto')";
...
Sum(total_venta_producto) AS total_desc, Sum(total_venta_producto) AS total_venta_neta FROM tbl15_cambio_precio_venta_predeterm_producto 
...
$cod_info_factura_strpad   = str_pad($cod_info_cambio_precio_venta_predeterm_producto, 6, "0", STR_PAD_LEFT);
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$resta                               = 1516399999;
$time_seg                            = time();
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_info_cambio_precio_venta_predeterm_producto.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_transf</td>
  </tr>
</table>
