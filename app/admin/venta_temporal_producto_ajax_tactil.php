...
//************************************************************************************************************************************//
//************************************************************************************************************************************//
if (($tipo_accion == 'eliminar') && ($tab == 'tbl15_carrito_compra_temporal')) {
...
//------------------------------------------------------------------------------------------------------------------------------------//
//------------------------------------------------------------------------------------------------------------------------------------//
if (($tipo_accion == 'registrar') && ($tab == 'tbl15_carrito_compra_temporal')) {
...
/*  ///////////////////////////////////////////////////////CARRITO COMPRA INI//////////////////////////////////////////////////////////////// */
	...
	$salida_carrito_compra_ajax .= '								<h3><a href="#">'.$nombre_concepto_multi_virtual.' DE VENTA</a> ['.$cod_base_caja.']</h3>';
...
$codigoHTML_menu .= '            <a href="../admin/carrito_compra_temporal_tactil.php" class="btn btn-default hvr-hover btn-cart">VER CARRITO</a>';
