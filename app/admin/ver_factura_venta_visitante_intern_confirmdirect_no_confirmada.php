                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        <table class="table">
                          ...
                          <tbody>
<?php
$sql_venta_producto_temporal = "SELECT * FROM tbl15_venta_producto_temporal WHERE (cod_info_factura_venta = '$cod_info_factura_venta') ORDER BY cod_venta_producto_temporal DESC";
...
?>
                                <tr>
                                    ...
                                    <td style="text-align:center;" class="name-pr"><?php echo $cod_venta_producto_temporal ?></td>
                                </tr>
<?php } ?>
                            </tbody>
                        </table>
