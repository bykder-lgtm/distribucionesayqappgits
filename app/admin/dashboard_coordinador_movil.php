...
<style>
/* ============================================ */
/* Dashboard Coordinador - TEMA AZUL INDIGO     */
/* ============================================ */
...
.kpi-icon.success {
    background: linear-gradient(135deg, #818cf8 0%, #16a34a 100%);
    color: white;
...
.qa-tiendas i { color: #6366f1; }
.qa-productos i { color: #6366f1; }
.qa-creditos i { color: #818cf8; }
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND ifv.nombre_estado_factura = 'ABIERTA' AND t.cod_estado != '0'";
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND ifv.nombre_estado_factura = 'CERRADA' AND t.cod_estado != '0'";
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes_actual' AND t.cod_estado != '0'";
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes_anterior' AND t.cod_estado != '0'";
...
for ($i = 5; $i >= 0; $i--) {
    ...
    WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes' AND t.cod_estado != '0'";
...
$sql_ultimas_tiendas = "SELECT t.cod_tienda, t.nombre_tienda, t.fecha_creacion, t.abrev_tienda, ta.nombre_tipo_aliado, ta.color_tipo_aliado FROM tbl15_tienda t LEFT JOIN tbl15_tipo_aliado ta ON t.cod_tipo_aliado = ta.cod_tipo_aliado WHERE t.cod_administrador = '$cod_administrador' AND t.cod_estado != '0' ORDER BY t.fecha_creacion DESC LIMIT 5";
$resultado_ultimas_tiendas = mysqli_query($conectar, $sql_ultimas_tiendas);

// Estados de tiendas por tipo de aliado - Coordinador
...
// Tiendas en zona de peligro (Dormido, Inactivo) - Coordinador
...
WHERE t.cod_administrador = '$cod_administrador' AND t.cod_estado != '0' AND ta.nombre_tipo_aliado IN ('Dormido', 'Inactivo') 
...
<main class="dashboard-container">
    ...
    <div class="dashboard-header animate-in">
        <h1><i class="fa-solid fa-chart-pie"></i> Dashboard Coordinador</h1>
    ...
    <div class="quick-actions animate-in delay-1">
        <a href="lista_tienda_coordinador_movil.php" class="quick-action-btn qa-tiendas">
            <i class="fa-solid fa-store"></i>
            <span>Tiendas</span>
        </a>
        <a href="lista_producto_coordinador_movil.php" class="quick-action-btn qa-productos">
            <i class="fa-solid fa-boxes-stacked"></i>
            <span>Productos</span>
        </a>
        <a href="lista_info_factura_venta_coordinador_movil.php" class="quick-action-btn qa-creditos">
    ...
    <div class="chart-card animate-in delay-2" style="background: linear-gradient(135deg, rgba(99, 102, 241, 0.05) 0%, rgba(99, 102, 241, 0.02) 100%); border: 1px solid rgba(99, 102, 241, 0.2);">
        <div class="chart-header" style="border-bottom: 1px solid rgba(99, 102, 241, 0.1); padding-bottom: 0.75rem; margin-bottom: 1rem;">
            <div class="chart-title" style="display: flex; align-items: center; gap: 0.5rem; color: #6366f1; font-size: 0.95rem; font-weight: 700;">
    ...
    <div class="activity-card animate-in">
        ...
        if (mysqli_num_rows($resultado_ultimas_tiendas) > 0):
            while ($tienda = mysqli_fetch_assoc($resultado_ultimas_tiendas)): 
                ...
                $color_aliado = !empty($tienda['color_tipo_aliado']) ? $tienda['color_tipo_aliado'] : '#6366f1';
