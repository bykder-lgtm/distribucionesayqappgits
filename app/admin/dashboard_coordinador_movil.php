...
$sql_tiendas = "SELECT COUNT(*) as total FROM tbl15_tienda WHERE cod_administrador = '$cod_administrador'";
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND ifv.nombre_estado_factura = 'ABIERTA'";
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND ifv.nombre_estado_factura = 'CERRADA'";
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes_actual'";
...
WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes_anterior'";
...
$sql_tiendas_mes = "SELECT COUNT(*) as total FROM tbl15_tienda WHERE cod_administrador = '$cod_administrador' AND DATE_FORMAT(fecha_creacion, '%Y-%m') = '$mes_actual'";
...
for ($i = 5; $i >= 0; $i--) {
    ...
    WHERE ifv.cod_administrador_coordinador = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes'";
...
$sql_ultimas_tiendas = "SELECT cod_tienda, nombre_tienda, fecha_creacion, abrev_tienda FROM tbl15_tienda WHERE cod_administrador = '$cod_administrador' ORDER BY fecha_creacion DESC LIMIT 5";
