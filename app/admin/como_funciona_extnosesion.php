...
<?php //include_once("../admin/05_modulo_algunas_categorias.php"); ?>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-product-details"><h2>¿Cómo funciona?</h2></div>
                    <p>• Paso 1: Regístrate como asesor o aliado</p>
                    <p>• Paso 2: Accede a nuestro catálogo de productos</p>
                    <p>• Paso 3: Simula precios, cuotas y vende fácil</p>
                    <p>• Paso 4: Gana comisiones por cada venta</p>
                </div>

                <div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-thumbnail img-fluid" src="../imagenes/quienes_somos.jpg" alt="" /></div>
                </div>
            </div>
        </div>
    </div>
