...
$data_sql = ("UPDATE tbl15_trabajo_altura SET fecha_ymd = '$fecha_ymd', fecha_time = '$fecha_time', fecha_mes = '$fecha_mes', 
...
$obtener_trab_altura = "SELECT explo_fis_talla FROM tbl15_trabajo_altura WHERE cod_trabajo_altura = '".($cod_trabajo_altura)."'";
...
$data_sql = ("UPDATE tbl15_trabajo_altura SET explo_fis_peso = '$explo_fis_peso', explo_fis_imc = '$explo_fis_imc' WHERE cod_trabajo_altura = '$cod_trabajo_altura'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$obtener_trab_altura = "SELECT explo_fis_peso FROM tbl15_trabajo_altura WHERE cod_trabajo_altura = '".($cod_trabajo_altura)."'";
$consultar_trab_altura = mysqli_query($conectar, $obtener_trab_altura) or die(mysqli_error($conectar));
$info_trab_altura= mysqli_fetch_assoc($consultar_trab_altura);
...
$data_sql = ("UPDATE tbl15_trabajo_altura SET explo_fis_talla = '$explo_fis_talla', explo_fis_imc = '$explo_fis_imc' WHERE cod_trabajo_altura = '$cod_trabajo_altura'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
} 
elseif ($campo=='cod_grupo_area_cargo') {
$obtener_grupo_area_cargo = "SELECT nombre_grupo_area_cargo FROM tbl15_grupo_area_cargo WHERE cod_grupo_area_cargo = '".($valor_intro)."'";
...
$data_sql = ("UPDATE tbl15_trabajo_altura SET $campo = '$valor_intro', cargo_empresa = '$cargo_empresa' WHERE cod_trabajo_altura = '$cod_trabajo_altura'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$data_sql = ("UPDATE tbl15_trabajo_altura SET $campo = '$valor_intro' WHERE cod_trabajo_altura = '$cod_trabajo_altura'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
