...
<thead>
	<tr class="headings">
		...
		<?php if ($cod_estado_retefuente_global == '1') { ?><th style="text-align:center">Rete Fuente</th><?php } ?>
		<?php if ($cod_estado_reteica_global == '1') { ?><th style="text-align:center">Rete Ica</th><?php } ?>
		<?php if ($cod_estado_reteiva_global == '1') { ?><th style="text-align:center">Rete Iva</th><?php } ?>
		<?php if ($cod_estado_puntos_redimibles_campanya_global == '1') { ?><th style="text-align:center">Puntos</th><?php } ?>
...
while ($datos_consulta = mysqli_fetch_array($query_consulta)) {
	...
	$retefuente_ptj                                       = $datos_consulta['retefuente_ptj'];
	$reteica_ptj                                          = $datos_consulta['reteica_ptj'];
	$reteiva_ptj                                          = $datos_consulta['reteiva_ptj'];
	$total_puntos_redimibles_campanya_tercero             = $datos_consulta['total_puntos_redimibles_campanya_tercero'];
...
?>
<tr class="even pointer" id="<?php echo $cod_tercero;?>">
	...
	<td style="text-align:left"><?php echo trim($nombre1_tercero.' '.$nombre2_tercero.' '.$apellido1_tercero.' '.$apellido2_tercero) ?></td>
	...
	<?php if ($cod_estado_retefuente_global == '1') { ?><td style="text-align:center"><?php echo $retefuente_ptj?>%</td><?php } ?>
	<?php if ($cod_estado_reteica_global == '1') { ?><td style="text-align:center"><?php echo $reteica_ptj?>%</td><?php } ?>
	<?php if ($cod_estado_reteiva_global == '1') { ?><td style="text-align:center"><?php echo $reteiva_ptj?>%</td><?php } ?>
	<?php if ($cod_estado_puntos_redimibles_campanya_global == '1') { ?><td style="text-align:center"><?php echo $total_puntos_redimibles_campanya_tercero?></td><?php } ?>
