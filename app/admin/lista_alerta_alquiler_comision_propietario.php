...
<table class="table table-bordered table-hover table-sm">
    <tr>
        <th style="text-align:center; background-color:#DBE0F3; color:#000; font-size: 15px">ALERTA COMISION A PAGAR A PROPIETARIO INCLUIDOS</th>
    ...
    <tr>
        ...
        <th style="text-align:center; background-color:#DBE0F3; color:#000; font-size: 15px"><a href="../admin/lista_alerta_alquiler_comision_propietario_excluido.php">EXLUIDO PAGO PROP</a></th>
    </tr>
</table>
