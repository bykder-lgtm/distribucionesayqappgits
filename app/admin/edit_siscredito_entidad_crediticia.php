...
<div class="breadcrumbs"><a href="../admin/lista_siscredito_entidad_crediticia.php?nombre_tipo_tercero=<?php echo $nombre_tipo_tercero?>"><h4>Editar Entidad Crediticia</h4></a></div>
<div class="row-fluid">
...
$sql_cliente = "SELECT * FROM tbl15_entidad_crediticia WHERE cod_entidad_crediticia = '$cod_entidad_crediticia'";
...
$interes_ptj                                              = $info_cliente['interes_ptj'];
$aval_ptj                                                 = $info_cliente['aval_ptj'];
$lider_interes_ptj                                        = $info_cliente['lider_interes_ptj'];
$coordinador_interes_ptj                                  = $info_cliente['coordinador_interes_ptj'];
$asesor_interes_ptj                                       = $info_cliente['asesor_interes_ptj'];
$vendedor_interes_ptj                                     = $info_cliente['vendedor_interes_ptj'];
$proveedor_interes_ptj                                    = $info_cliente['proveedor_interes_ptj'];
$aliado_estrategico_interes_ptj                           = $info_cliente['aliado_estrategico_interes_ptj'];
$entidad_crediticia_interes_ptj                           = $info_cliente['entidad_crediticia_interes_ptj'];
$lider_aval_ptj                                           = $info_cliente['lider_aval_ptj'];
$coordinador_aval_ptj                                     = $info_cliente['coordinador_aval_ptj'];
$asesor_aval_ptj                                          = $info_cliente['asesor_aval_ptj'];
$vendedor_aval_ptj                                        = $info_cliente['vendedor_aval_ptj'];
$proveedor_aval_ptj                                       = $info_cliente['proveedor_aval_ptj'];
$aliado_estrategico_aval_ptj                              = $info_cliente['aliado_estrategico_aval_ptj'];
$entidad_crediticia_aval_ptj                              = $info_cliente['entidad_crediticia_aval_ptj'];
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/edit_siscredito_entidad_crediticia_reg.php">
<fieldset>
...
<table border="1" class="table table-responsive">
	<tbody>
    	...
    	<tr>
			...
			<td style="text-align:center"><input class="input-block-level" name="identificacion_tercero" type="text" value="<?php echo $identificacion_tercero ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="digito_tercero" type="number" value="<?php echo $digito_tercero ?>"/></td>
    	<tr>
    	</tr>
		<tr>
    	...
    	<tr>
			<td style="text-align:center"><input class="input-block-level" name="nombre1_tercero" type="text" value="<?php echo $nombre1_tercero ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="nombre2_tercero" type="text" value="<?php echo $nombre2_tercero ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="apellido1_tercero" type="text" value="<?php echo $apellido1_tercero ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="apellido2_tercero" type="text" value="<?php echo $apellido2_tercero ?>"/></td>
    	</tr>
		<tr>
    	...
    	<tr>
			<td style="text-align:center"><input class="input-block-level" name="direccion_tercero" type="text" value="<?php echo $direccion_tercero ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="telefono1_tercero" type="text" value="<?php echo $telefono1_tercero ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="telefono2_tercero" type="text" value="<?php echo $telefono2_tercero ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="correo_tercero" type="text" value="<?php echo $correo_tercero ?>"/></td>
    	</tr>
		<tr>
    	...
    	<tr>
			...
			<td style="text-align:left" id="cod_municipio_select">
    	...
    	<tr>
			...
			<td style="text-align:center"><input class="input-block-level" name="fecha_nac_tercero" type="date" value="<?php echo $fecha_nac_tercero ?>"/></td>
			<td style="text-align:center">
...
<table border="1" class="table table-responsive">
	<tbody>
		...
		<tr>
			<td style="text-align:center"><input class="input-block-level" name="lider_interes_ptj" type="text" value="<?php echo $lider_interes_ptj ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="coordinador_interes_ptj" type="text" value="<?php echo $coordinador_interes_ptj ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="asesor_interes_ptj" type="text" value="<?php echo $asesor_interes_ptj ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="vendedor_interes_ptj" type="text" value="<?php echo $vendedor_interes_ptj ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="proveedor_interes_ptj" type="text" value="<?php echo $proveedor_interes_ptj ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="aliado_estrategico_interes_ptj" type="text" value="<?php echo $aliado_estrategico_interes_ptj ?>"/></td>
			<td style="text-align:center"><input class="input-block-level" name="entidad_crediticia_interes_ptj" type="text" value="<?php echo $entidad_crediticia_interes_ptj ?>"/></td>
		</tr>
    </tbody>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
