...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>Lista Gastos a propietario de Inmuebles  pendientes</font></a></th>
...
$sql_total_tipo_factura = "SELECT * FROM tbl15_gasto_inmueble_detalle_venta_temporal 
...
$cod_gasto_inmueble_detalle_venta_temporal             = $datos_total_tipo_factura['cod_gasto_inmueble_detalle_venta_temporal'];
