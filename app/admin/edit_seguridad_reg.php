...
if (isset($_POST['nombre_seguridad'])) { $nombre_seguridad = addslashes($_POST['nombre_seguridad']); } else { $nombre_seguridad = ''; }
if (isset($_POST['funcion'])) { $funcion = addslashes($_POST['funcion']); } else { $funcion = ''; }
...
if (isset($_POST['cod_estado_habilitar_total_venta_caja_mesa_virtual'])) { $cod_estado_habilitar_total_venta_caja_mesa_virtual = intval($_POST['cod_estado_habilitar_total_venta_caja_mesa_virtual']); } else { $cod_estado_habilitar_total_venta_caja_mesa_virtual = '1'; }
if (isset($_POST['cod_estado_habilitar_caja_mesa_virtual_en_uso'])) { $cod_estado_habilitar_caja_mesa_virtual_en_uso = intval($_POST['cod_estado_habilitar_caja_mesa_virtual_en_uso']); } else { $cod_estado_habilitar_caja_mesa_virtual_en_uso = '1'; }
if (isset($_POST['cod_estado_habilitar_total_venta_caja_mesa_virtual_en_uso'])) { $cod_estado_habilitar_total_venta_caja_mesa_virtual_en_uso = intval($_POST['cod_estado_habilitar_total_venta_caja_mesa_virtual_en_uso']); } else { $cod_estado_habilitar_total_venta_caja_mesa_virtual_en_uso = '1'; }
...
$sql_data = sprintf("UPDATE tbl15_seguridad SET nombre_seguridad = '$nombre_seguridad', funcion = '$funcion',
...
WHERE cod_seguridad = '$cod_seguridad'");
