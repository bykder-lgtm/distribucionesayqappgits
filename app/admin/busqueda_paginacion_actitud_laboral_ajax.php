...
$pagina                   = $concatenador."lista_concepto_actitud_laboral.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    // escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sTable = "tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_actitud_laboral ON tbl15_administrador.cod_administrador = tbl15_actitud_laboral.cod_administrador) ON tbl15_cliente.cod_cliente = tbl15_actitud_laboral.cod_cliente";
     ...
     elseif ($buscar_por=='motivo') { $columnas_busqueda = array('tbl15_actitud_laboral.motivo_actilab'); }
     elseif ($buscar_por=='nombre_empresa') { $columnas_busqueda = array('tbl15_actitud_laboral.nombre_empresa'); }
     elseif ($buscar_por=='fecha_ymd') { $columnas_busqueda = array('tbl15_actitud_laboral.fecha_ymd'); }
     elseif ($buscar_por=='cod_historia_clinica') { $columnas_busqueda = array('tbl15_actitud_laboral.cod_historia_clinica'); }
     elseif ($buscar_por=='cod_actitud_laboral') { $columnas_busqueda = array('tbl15_actitud_laboral.cod_actitud_laboral'); }
     else {  }
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" ORDER BY tbl15_actitud_laboral.fecha_time DESC";
} else {
    $sWhere.=" ORDER BY tbl15_actitud_laboral.fecha_time DESC";
}
    ...
    $reload = '../admin/lista_concepto_actitud_laboral.php';
...
$sql_consulta = "SELECT tbl15_actitud_laboral.cod_actitud_laboral, tbl15_actitud_laboral.cod_historia_clinica, 
...
$cod_actitud_laboral           = $datos_consulta['cod_actitud_laboral'];
...
$motivo_actilab                = $datos_consulta['motivo_actilab'];
