...
$('#total_recibido').number( true, 0 );
$('#total_pendiente').number( true, 0 );
...
$("#total_recibido").keyup(function () {
    var total_recibido = $(this).val();
    $("#total_recibido_hidden").val(total_recibido);
});

$("#total_pendiente").keyup(function () {
    var total_pendiente = $(this).val();
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$frag_mes                                 = explode("-", $fecha_mes);
$nombre_tabla_mes                         = $frag_mes[1];
/*
...
<table border="1" class="table table-responsive">
    <thead>
        ...
        <tr>
            ...
            <?php if ($url_img_orig_producto <> '') { ?><td style="text-align:center"><a id="foco_adjunto" href="<?php echo $url_img_orig_producto ?>" target="_blank"><img src="../imagenes/adjuntar_archivo.png" class="img-polaroid" alt=""></a></td><?php } ?>          
            <td style="text-align:center"><?php echo $nombre_estado_contrato ?></td>
            <td style="text-align:center"><a href="../admin/cuentas_cobrar_detalle_factura_alquiler.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar ?>&cod_tercero=<?php echo $cod_tercero ?>&cod_factura=<?php echo $cod_factura ?>&pagina=<?php echo $pagina_local ?>">VER</a></td>
...
$nombre_tabla_mes_alert                         = date("m", strtotime($fecha_pago_concat));

$mostrar_datos_sql = "SELECT nombre_letra_tabla_mes FROM tbl15_tabla_mes WHERE nombre_tabla_mes  = '$nombre_tabla_mes_alert'";
$consulta = mysqli_query($conectar, $mostrar_datos_sql) or die(mysqli_error($conectar));
$matriz_consulta = mysqli_fetch_assoc($consulta);
...
?>
        <tr>
            ...
            <td style="text-align:center"><?php echo date("d-m-Y", strtotime($fecha_pago_concat)) ?></td>
...
<table border="1" class="table table-responsive">
    <thead>
        <tr>
            ...
            <th style="text-align:center">IMPRIMIR CUENTA COBRO</th>
            <!--<th style="text-align:center">IMPRIMIR COMROBANTE INGRESO</th>-->
            <th style="text-align:center">IMPRIMIR SALDO A FAVOR</th>
            <th style="text-align:center">IMPRIMIR CUENTAS DE ARREGLO</th>
        </tr>
        <tr>
            <td style="text-align: center;"><a href="<?php echo $pagina_redirect;?>">Regresar</a></td>
            <td style="text-align: center;"><a href="../admin/cuentas_cobrar_abonos_alquiler_comprobante_cuenta_cobro_imprimir_pdf.php?cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta;?>&fecha_mes=<?php echo $fecha_mes;?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes;?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo;?>&cod_estado_envio_correo=<?php echo $cod_estado_envio_correo;?>&cod_estado_pago=<?php echo $cod_estado_pago;?>&pagina=<?php echo $pagina_local;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>
            <!--<td style="text-align: center;"><a href="../admin/cuentas_cobrar_abonos_alquiler_comprobante_cuenta_cobro_imprimir_pdf.php?cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta;?>&fecha_mes=<?php echo $fecha_mes;?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes;?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo;?>&cod_estado_envio_correo=<?php echo $cod_estado_envio_correo;?>&cod_estado_pago=<?php echo $cod_estado_pago;?>&pagina=<?php echo $pagina_local;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>-->
            <td style="text-align: center;"><a href="../admin/saldo_favor_inquilino_imprimir_pdf.php?cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta;?>&fecha_mes=<?php echo $fecha_mes;?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes;?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo;?>&cod_estado_envio_correo=<?php echo $cod_estado_envio_correo;?>&cod_estado_pago=<?php echo $cod_estado_pago;?>&pagina=<?php echo $pagina_local;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>
...
<table border="1" class="table table-responsive">
    <thead>
        <tr>
            ...
            <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_saldo_favor" id="deduccion_saldo_favor" value="<?php echo $deduccion_saldo_favor;?>" min="0" size="5" required></td>
            <input type="hidden" name="deduccion_saldo_favor_hidden" id="deduccion_saldo_favor_hidden" value="" required>
            <th style="text-align:right">ESTADO</th>
            <td style="text-align:left">
                <select name="cod_estado" id="cod_estado" class="<?php echo $cod_cuentas_cobrar_alerta;?>" data-show-subtext="true" data-live-search="true" style="width:140px" required>
            ...
            <th style="text-align:right">ESTADO ENVIO CORREO</th>
            <td style="text-align:left">
                <select name="cod_estado_envio_correo" id="cod_estado_envio_correo" class="<?php echo $cod_cuentas_cobrar_alerta;?>" data-show-subtext="true" data-live-search="true" style="width:140px" required>
                    <?php if (isset($cod_estado_envio_correo_cuenta_cobro)) { echo ""; } else { echo  ""; }
            ...
            <th style="text-align:right">NUMERO DE PERIODO</th>
            <td style="text-align:left"><input type="number" name="numero_alerta" id="numero_alerta" value="<?php echo $numero_alerta; ?>" class="<?php echo $cod_cuentas_cobrar_alerta;?>" style="width:70px"></td>
        </tr>
...
<table border="1" class="table table-responsive">
    <thead>
        ...
        <tr>
            <th style="text-align:center;"><a href="../admin/actualizar_total_pagar_cuentas_cobro_detalle_factura_alquiler_reg.php?cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta; ?>&cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar; ?>&cod_tercero=<?php echo $cod_tercero; ?>&cod_factura=<?php echo $cod_factura; ?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes; ?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo; ?>&cod_estado_envio_correo_cuenta_cobro=<?php echo $cod_estado_envio_correo_cuenta_cobro; ?>&fecha_mes=<?php echo $fecha_mes; ?>&pagina=<?php echo $pagina_local; ?>"><img src="../imagenes/boton_actualizar.png" class="img-polaroid" alt=""></a></th> 
            <th style="text-align:center;"><a href="../admin/duplicar_cuentas_cobro_detalle_factura_alquiler_reg.php?cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta; ?>&cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar; ?>&cod_tercero=<?php echo $cod_tercero; ?>&cod_factura=<?php echo $cod_factura; ?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes; ?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo; ?>&cod_estado_envio_correo_cuenta_cobro=<?php echo $cod_estado_envio_correo_cuenta_cobro; ?>&fecha_mes=<?php echo $fecha_mes; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/duplicar_factura_venta.png" class="img-polaroid" alt=""></a></th> 
            <!--<th style="text-align:center;"><a href="../admin/actualizar_total_pagar_cuentas_cobro_detalle_factura_alquiler_reg.php?cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta; ?>&cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar; ?>&cod_tercero=<?php echo $cod_tercero; ?>&cod_factura=<?php echo $cod_factura; ?>&pagina=<?php echo $pagina_local; ?>"><img src="../imagenes/boton_actualizar.png" class="img-polaroid" alt=""></a></th>-->
        </tr>
    </thead>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<table border="1" class="table table-responsive">
    <thead>
      ...
      <tr>
        ...
        <td style="text-align:left; width:25%"><span>.</span><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_retefuente" id="deduccion_retefuente" value="<?php echo $deduccion_retefuente;?>" min="0" size="5" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left"><br><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_reparacion" id="deduccion_reparacion" value="<?php echo $deduccion_reparacion;?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left; width:25%">ATRASO <span id="dias_atraso"></span><input style="font-size:24px" class="input-block-level" type="text" name="monto_cuota_interes" id="monto_cuota_interes" value="<?php echo $monto_cuota_interes ?>" min="0" size="5" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="ingreso_gasto_juridica" id="ingreso_gasto_juridica" value="<?php echo $ingreso_gasto_juridica ?>" min="0" size="5" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="ingreso_administracion_incluida" id="ingreso_administracion_incluida" value="<?php echo $ingreso_administracion_incluida;?>" min="0" size="5" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="ingreso_deudas_anteriores" id="ingreso_deudas_anteriores" value="<?php echo $ingreso_deudas_anteriores;?>" min="0" size="5" required></td>
    ...
    <thead>
        ...
        <tr>
            ...
            <td style="text-align:center">
                <select name="nombre_tabla_mes" id="nombre_tabla_mes" class="<?php echo $cod_cuentas_cobrar_alerta;?>" data-show-subtext="true" data-live-search="true" required>
                    <?php if (isset($nombre_tabla_mes)) { echo "<option value='' >...</option>"; } else { echo "<option value='' selected ></option>"; }
                    $consulta2_sql = "SELECT * FROM tbl15_tabla_mes";
                    $consulta2 = mysqli_query($conectar, $consulta2_sql);
                    while ($datos2 = mysqli_fetch_assoc($consulta2)) {
            ...
            <td style="text-align:center">
                <select name="cod_tipo_forma_pago" id="cod_tipo_forma_pago" class="<?php echo $cod_cuentas_cobrar_alerta;?>" data-show-subtext="true" data-live-search="true" required>
            ...
            <td style="text-align:center"><textarea class="<?php echo $cod_cuentas_cobrar_alerta;?>" name="mensaje" rows="3" cols="20"><?php echo $mensaje;?></textarea></td>
            <td style="text-align:center">
                <select name="cod_administrador" id="cod_administrador" class="<?php echo $cod_cuentas_cobrar_alerta;?>" data-show-subtext="true" data-live-search="true" required>
...
<table border="1" class="table table-responsive">
    <thead>
        <tr>
            <th style="text-align:center; font-size:28px;">TOTAL A PAGAR:</th>
            <th style="text-align:center; font-size:28px;">TOTAL RECIBIDO:</th>
            <th style="text-align:center; font-size:28px;">TOTAL PENDIENTE:</th>
        </tr>
        <tr>
            <td style="text-align:center; font-size:28px;" id="total_pagar"></td>
            <input type="hidden" name="total_pagar_hidden" id="total_pagar_hidden" value="<?php echo $total_pagar;?>" required>

            <td style="text-align:center"><input style="font-size:24px" class="input-block-level" type="text" name="total_recibido" id="total_recibido" value="<?php echo $total_recibido;?>" min="0" size="5" required></td>
            <input type="hidden" name="total_recibido_hidden" id="total_recibido_hidden" value="" required>

            <td style="text-align:center"><input style="font-size:24px" class="input-block-level" type="text" name="total_pendiente" id="total_pendiente" value="<?php echo $total_pendiente;?>" min="0" size="5" required></td>
...
<input type="hidden" name="cod_cuentas_cobrar_alerta" id="cod_cuentas_cobrar_alerta" value="<?php echo $cod_cuentas_cobrar_alerta; ?>">
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#total_recibido').change(function(){
        var cod_cuentas_cobrar = ($('#cod_cuentas_cobrar').val());
        var cod_cuentas_cobrar_alerta = ($('#cod_cuentas_cobrar_alerta').val());
        var total_recibido = parseFloat($('#total_recibido').val());
        $('#total_recibido').val(total_recibido);
        $('#total_recibido_hidden').val(total_recibido);

        var tab = "tbl15_cuentas_cobrar_alerta";
        var tipo = "editar";
        var campo = "total_recibido";

        var dataString = 'cod_cuentas_cobrar='+cod_cuentas_cobrar+'&'+'cod_cuentas_cobrar_alerta='+cod_cuentas_cobrar_alerta+'&'+'total_recibido='+total_recibido+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobro_detalle_factura_alquiler_total_recibido_total_pendiente_ajax_reg.php",
            data: dataString,
            success: function() {           
                //$('#eliminar-ok').empty();
            }
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#total_pendiente').change(function(){
        var cod_cuentas_cobrar = ($('#cod_cuentas_cobrar').val());
        var cod_cuentas_cobrar_alerta = ($('#cod_cuentas_cobrar_alerta').val());
        var total_pendiente = parseFloat($('#total_pendiente').val());
        $('#total_pendiente').val(total_pendiente);
        $('#total_pendiente_hidden').val(total_pendiente);

        var tab = "tbl15_cuentas_cobrar_alerta";
        var tipo = "editar";
        var campo = "total_pendiente";
        
        var dataString = 'cod_cuentas_cobrar='+cod_cuentas_cobrar+'&'+'cod_cuentas_cobrar_alerta='+cod_cuentas_cobrar_alerta+'&'+'total_pendiente='+total_pendiente+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobro_detalle_factura_alquiler_total_recibido_total_pendiente_ajax_reg.php",
            data: dataString,
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#numero_alerta').change(function(){ 
          var numero_alerta = $(this).val();  
          var cod_cuentas_cobrar_alerta = $(this).attr('class');

          var tab = "tbl15_cuentas_cobrar_alerta";
          var tipo = "editar";
          var campo = "numero_alerta";

          let ids = this.id;
            $.ajax({ url:"edit_cuentas_cobro_estado_factura_alquiler_ajax_reg.php", method:"GET", data:{valor:numero_alerta, campo:"numero_alerta", tab:tab, tipo:tipo, campo:campo, id:cod_cuentas_cobrar_alerta }, success:function(data){ $('#result').html(data); }  
        });  
    });
 //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
<script>  
 $(document).ready(function(){  
  ...
  let ids = this.id;
    $.ajax({ url:"edit_cuentas_cobro_estado_factura_alquiler_ajax_reg.php", method:"GET", data:{valor:cod_estado, campo:"cod_estado", tab:tab, tipo:tipo, campo:campo, id:cod_cuentas_cobrar_alerta }, success:function(data){ $('#result').html(data); }  
    });  
  });
 });  
 </script>
...
<script>  
 $(document).ready(function(){  
  ...
  $('select[name="nombre_tabla_mes"]').change(function(){ 
  var nombre_tabla_mes = $(this).val();  
  var cod_cuentas_cobrar_alerta = $(this).attr('class');

  var tab = "tbl15_cuentas_cobrar_alerta";
  var tipo = "editar";
  var campo = "nombre_tabla_mes";

  let ids = this.id;
    $.ajax({ url:"edit_cuentas_cobro_estado_factura_alquiler_ajax_reg.php", method:"GET", data:{valor:nombre_tabla_mes, campo:"nombre_tabla_mes", tab:tab, tipo:tipo, campo:campo, id:cod_cuentas_cobrar_alerta }, success:function(data){ $('#result').html(data); }  
    });  
  });
 });  
 </script>
