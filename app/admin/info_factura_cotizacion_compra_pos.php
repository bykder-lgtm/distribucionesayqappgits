...
<?php
$suma_temporal = "SELECT Sum(total_compra_producto) As total_compra FROM tbl15_cotizacion_compra_producto WHERE (cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra')";
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_y_cotizacion_compra_producto_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_cotizacion_factura_compra; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            //let id = this.id;
            $.post("guardar_info_factura_y_cotizacion_compra_producto_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  <tr>
    ...
    <th style="text-align:center;">ENVIAR A FACTURA DE COMPRA</th>
    <th style="text-align:center;">GUARDAR</th>
    <th style="text-align:center;"></th>
  </tr>
  <tr>
    <th style="text-align:center;"></th>
    <!--<td style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_info_cotizacion_factura_compra?>&tab=<?php echo $tab2?>&campo=<?php echo $campo2?>&tipo=<?php echo $tipo2?>&pagina=<?php echo $pagina?>"><img src="../imagenes/eliminar_grand.png" class="img-polaroid" alt=""></a></td>-->
    <th style="text-align:center;"><?php echo $cod_info_cotizacion_factura_compra ?></th>
...
<?php } ?>
    ...
    <td style="text-align:center;"><a href="../admin/enviar_cotizacion_compra_a_facturacion_compra_iva_inc_temporal_producto_manual_pos.php?cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra?>&tab=<?php echo $tab?>&campo=<?php echo $campo?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/agregar.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"><a href="../admin/edit_factura_cotizacion_compra.php?cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>"><img src="../imagenes/guardar.png" class="img-polaroid" alt=""></a></td>
...
<input type="hidden" name="cod_info_cotizacion_factura_compra" value="<?php echo $cod_info_cotizacion_factura_compra ?>" size="10">
