    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="shop-cat-box">
                ...
                <a class="btn nav-item active" href="#" class="nav-link"><?php echo $nombre_concepto_multi_virtual; ?>S EN USO</a>
                <?php } ?>
...
$sql_datos_venta_temp = "SELECT cod_venta_producto_temporal, cod_producto_barra, und_venta, nombre_producto, cod_estado_revisado FROM tbl15_venta_producto_temporal 
WHERE (cod_info_factura_venta = '$cod_info_factura_venta') ORDER BY cod_venta_producto_temporal DESC";
...
if ($cod_estado_revisado_con == '0') { $nombre_producto_concat .= "<mark>(".intval($und_venta_con).")".$nombre_producto_con.' |*| </mark>'; } else { $nombre_producto_concat .= "(".intval($und_venta_con).")".$nombre_producto_con.' |*| '; }
} else { $nombre_producto_concat .= "(".intval($und_venta_con).")".$nombre_producto_con.' |*| '; }
...
<td style="text-align:left;"><a href="../admin/entrar_sesion_caja_virtual.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo $cuenta_usuario; ?></a></td>
<td style="text-align:left;"><a href="../admin/entrar_sesion_caja_virtual.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo $nombre_producto_concat.$observacion; ?></a></td>
...
<?php if ($cod_estado_habilitar_total_venta_caja_mesa_virtual == '0') { ?>
<td style="text-align:center;"><a href="../admin/entrar_sesion_caja_virtual.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo number_format($total_venta_producto_ciclo, 0, ",", "."); ?></a></td>
<?php } ?>

<?php if ($cod_estado_tipo_metodo_envio_global == '1') { ?>
<td style="text-align:center;"><a href="../admin/entrar_sesion_caja_virtual.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo $nombre_tipo_metodo_envio; ?></a></td>
<?php } ?>

<td style="text-align:left;"><a href="../admin/entrar_sesion_caja_virtual.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo $cliente.$nombre_cliente_visitante; ?></a></td>
<td style="text-align:center;"><a href="../admin/entrar_sesion_caja_virtual.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo $fecha_anyo.' | '.$fecha_hora; ?></a></td>
...
<?php if ($cod_estado_eliminar_caja_mesa_virtual=='1') { ?>
<td style="text-align:center;"><a href="../admin/eliminar_caja_virtual.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina_local ?>"><img src=../imagenes/eliminar.png alt="eliminar"></td>
<?php } ?>
</tr>
<?php } ?>
</table>
