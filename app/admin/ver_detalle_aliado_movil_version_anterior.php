...
$sql = "SELECT a.*, l.nombres_apellidos_tercero AS nombre_lider, c.nombres_apellidos_tercero AS nombre_coordinador FROM tbl15_administrador a 
LEFT JOIN tbl15_administrador l ON a.cod_lider = l.cod_administrador LEFT JOIN tbl15_administrador c ON a.cod_coordinador = c.cod_administrador WHERE a.cod_administrador = '$cod_aliado'";
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value"><?php echo $row['nombre_lider'] ?: '-'; ?></span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Coordinador</span>
                        <span class="detail-value"><?php echo $row['nombre_coordinador'] ?: '-'; ?></span>
                    </div>
                </div>
            </div>
            <!-- Resumen de créditos -->
...
-->
            ...
            <div class="detail-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(16, 185, 129, 0.2); padding-bottom: 0.5rem;">
                    <h3 class="section-title" style="border: none; margin: 0; padding: 0;">Información Bancaria</h3>
                    <button onclick="abrirModalBanco()" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: none; padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.75rem; font-weight: 600; cursor: pointer;">
                ...
                <div class="detail-grid" id="listaBancos">
                    <?php if ($res_banco && mysqli_num_rows($res_banco) > 0): ?>
                        ...
                        <div class="detail-item" style="position: relative;">
                            ...
                            <button onclick="editarBanco(<?php echo $banco['cod_banco_cuenta']; ?>)" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: none; padding: 0.4rem 0.6rem; border-radius: 8px; cursor: pointer; font-size: 0.7rem; margin-left: 0.5rem;" title="Editar cuenta"><i class="fa-solid fa-edit"></i></button>
                        </div>
                        <?php endwhile; ?>
                    <?php else: ?>
            ...
            <div class="detail-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(16, 185, 129, 0.2); padding-bottom: 0.5rem;">
                    <h3 class="section-title" style="border: none; margin: 0; padding: 0;">Tiendas Asociadas</h3>
                    <button onclick="abrirModalRegistroTienda()" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: none; padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.75rem; font-weight: 600; cursor: pointer;">
                        <i class="fa-solid fa-plus"></i> Agregar
                    </button>
                </div>
            ...
            <div class="detail-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(16, 185, 129, 0.2); padding-bottom: 0.5rem;">
                    <h3 class="section-title" style="border: none; margin: 0; padding: 0;"><i class="fa-solid fa-building-columns"></i> Líneas de Crédito</h3>
                    <button onclick="abrirModalEntidad()" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: none; padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.75rem; font-weight: 600; cursor: pointer;">
                        <i class="fa-solid fa-plus"></i> Agregar
                    </button>
                </div>
                ...
                <div class="entidades-grid" id="listaEntidades" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 0.75rem;">
                    <?php if ($total_entidades > 0): ?>
                        ...
                        <div class="entidad-card" id="entidad_<?php echo $cod_parametrizacion_entidad_crediticia_aliado; ?>" style="background: <?php echo $bg_color; ?>; border: 1px solid <?php echo $border_color; ?>; border-radius: 12px; padding: 0.75rem; position: relative; opacity: <?php echo $opacity; ?>;">
                            ...
                            <!-- Botones de acción -->
                            <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid rgba(255,255,255,0.05);">
                                <?php 
                                // Preparar datos para JavaScript con el nombre correcto del campo
                                $entidad_js = $entidad;
                                $entidad_js['cod_parametrizacion'] = $cod_parametrizacion_entidad_crediticia_aliado;
                                ?>
                                <button onclick='editarEntidad(<?php echo json_encode($entidad_js); ?>)' 
                                        style="flex: 1; background: rgba(59, 130, 246, 0.2); color: #3b82f6; border: none; padding: 0.4rem; border-radius: 8px; font-size: 0.7rem; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.25rem;">
                                    <i class="fa-solid fa-edit"></i> Editar
                                </button>
                                <button onclick="eliminarEntidad(<?php echo $cod_parametrizacion_entidad_crediticia_aliado; ?>, '<?php echo addslashes($nombre_entidad_crediticia); ?>')" 
                                        style="flex: 1; background: rgba(239, 68, 68, 0.2); color: #ef4444; border: none; padding: 0.4rem; border-radius: 8px; font-size: 0.7rem; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.25rem;">
