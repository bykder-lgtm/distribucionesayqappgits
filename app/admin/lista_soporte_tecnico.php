...
<table class="table table-striped">
	<thead>
		<tr>
			<th style="text-align:center"><a href="../admin/lista_tercero_cliente.php">Total Resuelto</a></th>
			<th style="text-align:center"><a href="../admin/lista_tercero_proveedor.php">Total Sin Resolver</a></th>
		</tr>
	</thead>
	<tbody>
<?php
$sql_tercero_total = "SELECT * FROM tbl15_soporte_tecnico";
$resultado_tercero_total = mysqli_query($conectar, $sql_tercero_total);
$total_reg = mysqli_num_rows($resultado_tercero_total);

$sql_tercero_cliente = "SELECT * FROM tbl15_soporte_tecnico WHERE (cod_estado = '1')";
...
$sql_tercero_proveedor = "SELECT * FROM tbl15_soporte_tecnico WHERE (cod_estado = '0')";
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <input type="hidden" class="form-control" id="buscar_por" placeholder="" onkeyup='load(1);'>
            <input type="hidden" class="form-control" id="busqueda_ajax" placeholder="" onkeyup='load(1);'>
...
-->
        <input type="hidden" id="tabla" Value="tbl15_soporte_tecnico">
</form>
<!-- end Form search -->
                        <div class="x_content">
                            <div class="table-responsive">
...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/busqueda_paginacion_soporte_tecnico_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&tabla='+tabla,
