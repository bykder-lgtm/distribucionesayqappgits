        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <img class="" src="../imagenes/patrocinador_person.png" alt="" />
                </div>
            ...
            <div class="row my-5">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <div class="single-product-details"><h2>Nuestra <span>Misión</span></h2></div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <div class="single-product-details"><h2>Nuestra <span>Visión</span></h2></div>
                        <p><?php echo (($vision_info_empresa)) ?></p>
                    </div>
                </div>
...
<?php include_once("../admin/05_modulo_algunas_categorias_cliente_visitante_extnosesion.php"); ?>
