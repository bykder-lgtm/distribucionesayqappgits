...
fecha_nac_tercero = '$fecha_nac_tercero', correo_tercero = '$correo_tercero', cod_administrador = '$cod_administrador', cod_estado = '$cod_estado', ingreso_impuesto_iva = '$ingreso_impuesto_iva' 
WHERE cod_tercero = '$cod_tercero'");
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

$pagina                       = addslashes($_POST['pagina']);
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_propietario.php">
<?php } else { ?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_propietario.php">
<?php } ?>
<!-- ***************************************************************************************************************************** -->
