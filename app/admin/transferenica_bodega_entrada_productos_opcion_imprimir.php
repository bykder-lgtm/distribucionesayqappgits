...
$pagina                                                          = addslashes($_GET['pagina']).'?cod_info_factura_transferencia_bodega_entrada='.$cod_info_factura_transferencia_bodega_entrada;
$cod_info_factura_transferencia_bodega_entrada_codif         = DAXCODIFCRYPTOR::encodifdax($cod_info_factura_transferencia_bodega_entrada);
$cod_info_factura_transferencia_bodega_entrada_codif_cryp    = DAXCODIFCRYPTOR::encriptardax($cod_info_factura_transferencia_bodega_entrada_codif);
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_factura_transferencia_bodega_entrada WHERE (cod_info_factura_transferencia_bodega_entrada = '$cod_info_factura_transferencia_bodega_entrada')";
...
Sum(total_venta_producto) AS total_desc, Sum(total_venta_producto) AS total_venta_neta FROM tbl15_transferencia_bodega_entrada_producto 
...
<table class="table table-striped">
  <tr>
    <td><font color='black' size= "+3">TRASNFERENCIA DE ENTRADA NO:</font></td>
...
<table class="table table-striped">
  <tr>
    <td style="text-align:center;"><a href="../admin/importar_archivo_csv_transferencia_bodega_entrada_xlsx_ajax.php" id="listo"><img src="../imagenes/listo.png" alt="listo"></a></td>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>TRASNFERENCIA DE ENTRADA NO: <?php echo $cod_factura; ?></strong></td>
  </tr>
  <tr>
...
FROM tbl15_transferencia_bodega_entrada_producto WHERE (cod_info_factura_transferencia_bodega_entrada = '$cod_info_factura_transferencia_bodega_entrada')";
...
?>
<tr>
<td style="text-align: right; width:10%; font-family: Courier; font-size:8pt;"><strong><?php echo $und_venta ?></strong></td>
<td style="text-align: left; width:10%; font-family: Courier; font-size:8pt;"><strong><?php echo $nombre_tipo_unidad_medida ?></strong></td>
<td style="text-align: left; width:50%; font-family: Courier; font-size:8pt;"><strong><?php echo $nombre_producto ?></strong></td>
<td style="text-align: left; width:10%; font-family: Courier; font-size:7pt;"><strong></strong></td>
</tr>
<?php } ?>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_info_factura_transferencia_bodega_entrada.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_transf</td>
  </tr>
</table>
...
<script>  
 $(document).ready(function(){  
  ...
  var cod_info_factura_transferencia_bodega_entrada = <?php echo $cod_info_factura_transferencia_bodega_entrada ?>;  
    $.ajax({ url:"imprimir_factura_venta_ticket_pos.php", method:"GET", data:{cod_info_factura_transferencia_bodega_entrada:cod_info_factura_transferencia_bodega_entrada, campo:"cod_info_factura_transferencia_bodega_entrada", id:cod_info_factura_transferencia_bodega_entrada }, 
