...
/* ----------------------------------------------------------------------------------------------------------/ */
	...
	$resultado_archivador = mysqli_query($conectar, $sql_archivador) or die(mysqli_error($conectar));
 	...
 	$pagina_redirect                                    = '../admin/ver_certificado_apoyo_emocional_extern_opcion_imprimir.php'.'?cod_certificado_apoyo_emocional_codifcryp='.$cod_certificado_apoyo_emocional_codifcryp;
/* ----------------------------------------------------------------------------------------------------------/ */
?>
