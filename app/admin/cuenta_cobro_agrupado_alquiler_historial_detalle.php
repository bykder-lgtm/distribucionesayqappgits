...
<h4>
<a class="btn btn-primary" href="../admin/lista_cuenta_cobro_alquiler_historial.php">Regresar</a>
</h4>
</div>
...
$sql_consulta_estado_envio_correo = "SELECT nombre_estado_envio_correo FROM tbl15_estado_envio_correo WHERE cod_estado_envio_correo_cuenta_cobro = '$cod_estado_envio_correo_cuenta_cobro'";
...
<td style="text-align: center;"><strong>PERIODOS TRASADOS</strong></td>
<td style="text-align: center;"><strong>VER</strong></td>
<td style="text-align: center;"><strong>ENVIAR</strong></td>
</tr>
<?php
$cuentas_cobrar_viejas_concat             = '';

$calcular_datos_cuenta_cobrar = "SELECT * FROM tbl15_cuentas_cobrar_alerta WHERE (fecha_mes = '$fecha_mes') $filtro_consulta_estado_pago $filtro_consulta_estado_envio_correo";
...
<td style="text-align: right;"><font size='3'><?php echo $cuentas_cobrar_viejas_concat;?></font></td>
