...
-->
                ...
                <?php if ($total_reg <> '0') { ?>
                <div class="col-12 d-flex shopping-box"><a href="../admin/checkout_visitante_tactil.php" class="ml-auto btn hvr-hover">Revisar Compra</a> </div>
                <?php } ?>
            </div>
...
$(document).ready(function() {
    $('.eliminar').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "../admin/eliminar_carrito_compra_temporal_tactil_ajax.php",
            data: datos_url_ajax,
            beforeSend: function(objeto){
...
<script type="text/javascript">
    $("input").change(function(){  
        ...
        $.ajax({
            type: "POST",
            url: "../admin/actualizar_und_precio_vend_carrito_compra_tactil_ajax.php",
            data: datos_url_ajax,
            //dataType: 'json',
            beforeSend: function(objeto){
