...
if (isset($_GET['cod_producto_barra'])) {
	...
	$pagina                       = addslashes($_GET['pagina'])."?&foco=".$foco."&buscar_por=".$buscar_por."&pagina=facturacion_cambio_precio_venta_predeterm_producto_temporal.php";
	...
	$datos_info = "SELECT * FROM tbl15_info_cambio_precio_venta_predeterm_producto WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
//---------------------------------------------------------------------FACTURA NUEVA INICIO----------------------------------------------------------------//
		if ($factura_abierta == '0') {
			...
			$sql_autoincremento_info_factura = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '$base_datos' AND TABLE_NAME = 'tbl15_info_cambio_precio_venta_predeterm_producto'";
			...
			$cod_info_cambio_precio_venta_predeterm_producto             = $datos_autoincremento_info_factura['AUTO_INCREMENT'];
			//---------------------------------------------------------------------------------------------------------------------------------------------//
			$sql_data = "INSERT INTO tbl15_info_cambio_precio_venta_predeterm_producto (cod_info_cambio_precio_venta_predeterm_producto, nombre_estado_factura, fecha_ymdhis, cuenta, cod_estado_factura, cod_caja_virtual, fecha_dia, fecha_mes, 
			...
			VALUES ('$cod_info_cambio_precio_venta_predeterm_producto', '$nombre_estado_factura', '$fecha_ymdhis', '$cuenta', '$cod_estado_factura', '$cod_caja_virtual', '$fecha_dia', '$fecha_mes', 
			'$fecha_anyo', '$anyo', '$fecha_hora', '$cod_tipo_pago', '$cod_administrador', '$cod_dependencia', '$cod_tipo_forma_pago', 
			'$nombre_tipo_factura', '$nombre_tipo_moneda', '$cod_tercero', '$cod_tipo_inventario', '$cod_tipo_producto_consumo')";
			$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

			$sql_data = "INSERT INTO tbl15_cambio_precio_venta_predeterm_producto_temporal (cod_info_cambio_precio_venta_predeterm_producto, cod_tercero, cod_producto, cod_producto_barra, nombre_producto, und_venta, 
			...
			VALUES ('$cod_info_cambio_precio_venta_predeterm_producto', '$cod_tercero', '$cod_producto', '$cod_producto_barra', '$nombre_producto', '$und_venta', 
			'$precio_compra_producto', '$total_compra_producto', '$precio_costo_producto', '$total_costo_producto', 
			'$precio_venta_producto', '$total_venta_producto', '$posologia_cantidad', '$posologia_peso', '$nombre_tipo_producto', '$nombre_tipo_unidad_medida', '$nombre_tipo_presentacion', 
			'$nombre_via_administracion', '$nombre_frec_duracion', '$fecha_ymd_venta_producto', '$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', '$fecha_seg_venta_producto', '$cuenta', 
			'$cod_administrador', '$cod_tipo_cobrar', '$cod_estado_vacuna', '$cod_caja_virtual', '$nombre_tipo_precio_venta', '$cod_estado_permitir_venta', '$und_producto')";
		...
		$sql_info_factura = "SELECT cod_info_cambio_precio_venta_predeterm_producto, cod_tercero FROM tbl15_info_cambio_precio_venta_predeterm_producto WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
		...
		$cod_info_cambio_precio_venta_predeterm_producto     = $datos_info_factura['cod_info_cambio_precio_venta_predeterm_producto'];
