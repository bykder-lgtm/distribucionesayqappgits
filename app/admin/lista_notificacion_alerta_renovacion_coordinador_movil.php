...
<head>
    ...
    <style>
        /* ============================================ */
        /* NOTIFICACIONES COORDINADOR - TEMA AZUL INDIGO */
        /* ============================================ */
...
<main class="page-container">
    ...
    <div class="page-header animate-in">
        <h1><button class="back-btn" onclick="window.location.href='config_coordinador_movil.php'"><i class="fa-solid fa-arrow-left"></i></button>Notificaciones</h1>
    </div>
...
function marcarLeida(id) {
    Swal.fire({
        title: '¿Marcar como leída?', text: "La notificación pasará al historial de leídas", icon: 'question', showCancelButton: true, confirmButtonColor: '#6366f1',
