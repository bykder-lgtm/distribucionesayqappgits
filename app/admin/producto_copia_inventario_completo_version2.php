...
?>
    ...
    <form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/producto_copia_inventario_completo_version2_reg.php">
        <table class="table table-striped">
            <tr>
...
<script>
    ...
    function load(page){
        ...
        var cod_producto_copia_inventario_get = "<?php echo $cod_producto_copia_inventario_get?>";
        var foco_check = "<?php echo $foco_check?>";

        $("#loader").fadeIn('slow');
        $.ajax({
            url:'../admin/producto_copia_inventario_completo_version2_busqueda_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&tabla='+tabla+'&cod_info_producto_copia_inventario='+cod_info_producto_copia_inventario+'&cod_producto_copia_inventario_get='+cod_producto_copia_inventario_get+'&foco_check='+foco_check,
