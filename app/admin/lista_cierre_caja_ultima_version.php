...
<table class="table table-striped">
    <tr>
        ...
        <?php if ($cod_estado_cierre_caja_registrar == '1') { ?>
            ...
            <?php } else { ?>
                <th style="text-align:right"><a href="../admin/reg_cierre_caja_valor_total_ultima_version.php"><font size='+2'>Cerrar Caja</font></a></th>
            <?php } ?>
        <?php } ?>
    </tr>
</table>
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <th style="text-align:center">TOTAL VENTA (EFECTIVO + TRANSFERENCIA)</th>
        <th style="text-align:center">TOTAL VENTA EN EFECTIVO</th>
        <th style="text-align:center">TOTAL ABONOS EN EFECTIVO</th>
        <th style="text-align:center">TOTAL VENTA + ABONOS EN EFECTIVO</th>
        <th style="text-align:center">TOTAL BASE</th>
        <th style="text-align:center">TOTAL VENTA EFECTIVO + BASE</th>
        <th style="text-align:center">TOTAL CONTEO CAJA EN EFECTIVO</th>
...
while ($datos_total_tipo_factura = mysqli_fetch_assoc($consulta_total_tipo_factura)) {
    ...
    $total_venta_contado_efectivo_cierre_caja          = $datos_total_tipo_factura['total_venta_contado_efectivo_cierre_caja'];
    $total_abono_efectivo_cuenta_cobrar_cierre_caja    = $datos_total_tipo_factura['total_abono_efectivo_cuenta_cobrar_cierre_caja'];
    ...
    $total_venta_efectivo_mas_base                     = $total_sistema_contado_efectivo_cierre_caja + $total_base_cierre_caja;
    $resultado                                         = $total_fisico_cierre_caja - $total_sistema_contado_efectivo_cierre_caja;
    ...
    if ($resultado > 0) { $resultado_mensaje = "SOBRAN "; } elseif ($resultado < 0) { $resultado_mensaje = "FALTAN "; } else { $resultado_mensaje = "CORRECTO "; }
?>
        <tr>
            ...
            <td style="text-align:right"><?php echo number_format($total_venta_contado_efectivo_cierre_caja, 0, ",", ".") ?></td>
            <td style="text-align:right"><?php echo number_format($total_abono_efectivo_cuenta_cobrar_cierre_caja, 0, ",", ".") ?></td>
            <td style="text-align:right; font-size: 30px;"><?php echo number_format($total_sistema_contado_efectivo_cierre_caja, 0, ",", ".") ?></td>
            <td style="text-align:right"><?php echo number_format($total_base_cierre_caja, 0, ",", ".") ?></td>
            <td style="text-align:right"><?php echo number_format($total_venta_efectivo_mas_base, 0, ",", ".") ?></td>
            <td style="text-align:right; font-size: 30px;"><?php echo number_format($total_fisico_cierre_caja, 0, ",", ".") ?></td>
            <td style="text-align:center"><?php echo $resultado_mensaje.' ('.number_format($resultado, 0, ",", ".").')' ?></td>
            ...
            <?php if ($cod_estado_cierre_caja_imprimir == '1') { ?>
            <td id="edit<?php echo $cod_cierre_caja;?>" style="text-align:center"><a href="../admin/factura_cierre_caja_opcion_imprimir_ultima_version.php?cod_cierre_cajas=<?php echo $cod_cierre_cajas ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></td>
            <?php } ?>
        </tr>
<?php } ?>
    </tbody>
