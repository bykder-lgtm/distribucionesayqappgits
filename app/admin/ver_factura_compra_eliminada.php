...
$tab                               = 'tbl15_factura_compra_producto_copia';
$campo                             = 'cod_factura_compra_producto_copia';
$tipo                              = 'eliminar';
$tab2                              = 'tbl15_venta_producto_eliminar_sin_devolucion';
$tab3                              = 'tbl15_factura_compra_producto_copia';
$campo3                            = 'cod_factura_compra_producto_copia';
...
$datos_factura = "SELECT cod_factura_compra_producto_copia FROM tbl15_factura_compra_producto_copia WHERE (cod_info_factura_compra = '$cod_info_factura_compra')";
...
-->
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_ver_factura_compra_eliminada.php'); ?>
<!-- ***************************************************************************************************************************** -->
<!-- ***************************************************************************************************************************** -->
...
<tbody>
<?php
$sql_factura_compra_producto_copia = "SELECT * FROM tbl15_factura_compra_producto_copia WHERE (cod_info_factura_compra = '$cod_info_factura_compra') 
ORDER BY cod_factura_compra_producto_copia DESC";
$consulta_factura_compra_producto_copia = mysqli_query($conectar, $sql_factura_compra_producto_copia);
while ($datos_factura_compra_producto_copia = mysqli_fetch_assoc($consulta_factura_compra_producto_copia)) {

$cod_factura_compra_producto_copia             = $datos_factura_compra_producto_copia['cod_factura_compra_producto_copia'];
$cod_producto                                  = $datos_factura_compra_producto_copia['cod_producto'];
$cod_producto_barra                            = $datos_factura_compra_producto_copia['cod_producto_barra'];
$nombre_producto                               = $datos_factura_compra_producto_copia['nombre_producto'];
$cedula                                        = $datos_factura_compra_producto_copia['cedula'];
$nombre_cliente                                = $datos_factura_compra_producto_copia['nombre_cliente'];
$und_compra                                    = $datos_factura_compra_producto_copia['und_compra'];
$und_unidades                                  = $datos_factura_compra_producto_copia['und_unidades'];
$und_caja                                      = $datos_factura_compra_producto_copia['und_caja'];
$precio_costo_producto                         = $datos_factura_compra_producto_copia['precio_costo_producto'];
$precio_compra_producto                        = $datos_factura_compra_producto_copia['precio_compra_producto'];
$total_costo_producto                          = $datos_factura_compra_producto_copia['total_costo_producto'];
$total_compra_producto                         = $datos_factura_compra_producto_copia['total_compra_producto'];
$precio_venta_producto                         = $datos_factura_compra_producto_copia['precio_venta_producto'];
$precio_venta_producto2                        = $datos_factura_compra_producto_copia['precio_venta_producto2'];
$precio_venta_producto3                        = $datos_factura_compra_producto_copia['precio_venta_producto3'];
$precio_venta_producto4                        = $datos_factura_compra_producto_copia['precio_venta_producto4'];
$precio_venta_producto5                        = $datos_factura_compra_producto_copia['precio_venta_producto5'];
$iva_ptj                                       = $datos_factura_compra_producto_copia['iva_ptj'];
$dto1                                          = $datos_factura_compra_producto_copia['dto1'];
$dto2                                          = $datos_factura_compra_producto_copia['dto2'];
$precio_ipc                                    = $datos_factura_compra_producto_copia['precio_ipc'];
$precio_venta_producto                         = $datos_factura_compra_producto_copia['precio_venta_producto'];
$total_venta_producto                          = $datos_factura_compra_producto_copia['total_venta_producto'];
$nombre_tipo_producto                          = $datos_factura_compra_producto_copia['nombre_tipo_producto'];
$nombre_tipo_unidad_medida                     = $datos_factura_compra_producto_copia['nombre_tipo_unidad_medida'];
$posologia_cantidad                            = $datos_factura_compra_producto_copia['posologia_cantidad'];
$posologia_peso                                = $datos_factura_compra_producto_copia['posologia_peso'];
$nombre_tipo_presentacion                      = $datos_factura_compra_producto_copia['nombre_tipo_presentacion'];
$nombre_via_administracion                     = $datos_factura_compra_producto_copia['nombre_via_administracion'];
$nombre_frec_duracion                          = $datos_factura_compra_producto_copia['nombre_frec_duracion'];
$cod_tipo_cobrar                               = $datos_factura_compra_producto_copia['cod_tipo_cobrar'];
$cod_info_factura_compra                       = $datos_factura_compra_producto_copia['cod_info_factura_compra'];
$nombre_tipo_precio_venta                      = $datos_factura_compra_producto_copia['nombre_tipo_precio_venta'];
$cod_estado_permitir_venta                     = $datos_factura_compra_producto_copia['cod_estado_permitir_venta'];
$und_producto                                  = $datos_factura_compra_producto_copia['und_producto'];
$cajas_sobre                                   = $datos_factura_compra_producto_copia['cajas_sobre'];
...
$incre++;
?>
<tr style="text-align:center;" id="tr<?php echo $cod_factura_compra_producto_copia;?>">
<th style="text-align:center;"></th>
...
<td style="text-align:center;"><?php echo $cod_factura_compra_producto_copia;?></td>
<td style="text-align:center;"></td>
</tr style="text-align:right;" id="tr<?php echo $cod_factura_compra_producto_copia;?>">
<?php } ?>
</tbody>
</table>
