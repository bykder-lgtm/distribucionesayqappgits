...
WHERE ((($tipo_fecha)='$fecha') AND (cod_estado_facturacion=1) AND ((ant_impor_accilab)='SI') AND ((nombre_empresa)='$nombre_empresa'))
...
FROM tbl15_historia_clinica 
WHERE ((($tipo_fecha)='$fecha') AND (cod_estado_facturacion=1) AND ((ant_impor_accilab)='NO') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY ant_impor_accilab, $tipo_fecha, cod_estado_facturacion, nombre_empresa";
