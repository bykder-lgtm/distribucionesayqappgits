    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="formRegistro">
                ...
                <label class="form-label" style="color: #8b5cf6; font-weight: 700; margin-bottom: 0.75rem; display: block;"><i class="fa-solid fa-building-columns"></i> Datos del Administrador</label>
                <div class="form-group">
...
function filtrar(busqueda) { clearTimeout(window.searchTimeout); window.searchTimeout = setTimeout(function() { window.location.href = 'lista_aliado_lider_movil.php?busqueda=' + encodeURIComponent(busqueda); }, 500); }
