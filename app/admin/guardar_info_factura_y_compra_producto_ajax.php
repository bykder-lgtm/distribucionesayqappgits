...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_pago') && ($tipo_ajax=='tbl15_info_factura_compra')) {
	$fecha_pago                          = addslashes($_POST['valor']);
	$cod_info_factura_compra             = intval($_POST['id']);

	$data_sql = "UPDATE tbl15_info_factura_compra SET fecha_pago = '$fecha_pago' WHERE cod_info_factura_compra = '$cod_info_factura_compra'";
	$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
	...
	if ($cod_tipo_pago == '2') {
		$data_sql = ("UPDATE tbl15_cuentas_pagar SET fecha_pago = '$fecha_pago' WHERE cod_info_factura_compra = '$cod_info_factura_compra'");
		$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
	}
}
// ------------------------------------------------------------------------------------------------- //
