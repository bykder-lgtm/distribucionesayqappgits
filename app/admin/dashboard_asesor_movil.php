...
WHERE ifv.cod_administrador_asesor = '$cod_administrador' AND ifv.nombre_estado_factura = 'ABIERTA'";
...
WHERE ifv.cod_administrador_asesor = '$cod_administrador' AND ifv.nombre_estado_factura = 'CERRADA'";
...
WHERE ifv.cod_administrador_asesor = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes_actual'";
...
WHERE ifv.cod_administrador_asesor = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes_anterior'";
...
for ($i = 5; $i >= 0; $i--) {
    ...
    WHERE ifv.cod_administrador_asesor = '$cod_administrador' AND DATE_FORMAT(ifv.fecha_creacion, '%Y-%m') = '$mes'";
