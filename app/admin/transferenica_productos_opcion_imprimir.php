...
$cod_info_factura_transferencia_codif         = DAXCODIFCRYPTOR::encodifdax($cod_info_factura_transferencia);
$cod_info_factura_transferencia_codif_cryp    = DAXCODIFCRYPTOR::encriptardax($cod_info_factura_transferencia_codif);
...
Sum(total_venta_producto) AS total_desc, Sum(total_venta_producto) AS total_venta_neta FROM tbl15_transferencia_producto 
...
<table class="table table-striped">
  <tr>
    <td><font color='black' size= "+3">TRASNFERENCIA NO:</font></td>
    <td style="text-align:right;" colspan="2"><font color='black' size= "+3"><?php echo $cod_factura; ?></font></td>
  </tr>
  <tr>
    <td><font color='black' size= "+3">TRASNFERENCIA A:</font></td>
    <td style="text-align:right;" colspan="2"><font color='black' size= "+3"><?php echo $nombre_tipo_inventario; ?></font></td>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>TRASNFERENCIA NO: <?php echo $cod_factura; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>TRASNFERENCIA A: <?php echo $nombre_tipo_inventario; ?></strong></td>
  </tr>
  <tr>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_info_factura_transferencia.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_transf</td>
  </tr>
</table>
...
<script>  
 $(document).ready(function(){  
  ...
  var cod_info_factura_transferencia = <?php echo $cod_info_factura_transferencia ?>;  
    $.ajax({ url:"imprimir_factura_venta_ticket_pos.php", method:"GET", data:{cod_info_factura_transferencia:cod_info_factura_transferencia, campo:"cod_info_factura_transferencia", id:cod_info_factura_transferencia }, 
