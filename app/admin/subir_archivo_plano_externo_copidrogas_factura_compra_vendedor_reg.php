...
//---------------------------------------------------------------------------------------------------------------------------------------------//
	...
	do {
		if ($datos_archivo_plano_extern[0]) {
			...
			$sql_producto = "SELECT cod_producto, cod_producto_barra, und_unidades, und_sobre, tope_min, precio_compra_producto AS precio_compra_producto_viejo, 
			...
			precio_venta_producto5, cod_dependencia, und_producto
