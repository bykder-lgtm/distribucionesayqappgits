...
$nombre_representante = isset($_POST['nombre_representante']) ? mysqli_real_escape_string($conectar, trim(addslashes($_POST['nombre_representante']))) : '';
...
$telefono1_tercero = isset($_POST['telefono1_tercero']) ? mysqli_real_escape_string($conectar, trim(addslashes($_POST['telefono1_tercero']))) : '';
...
$correo_representante = isset($_POST['correo_representante']) ? mysqli_real_escape_string($conectar, trim(addslashes($_POST['correo_representante']))) : '';
...
cod_aliado_estrategico = '$cod_aliado_estrategico', 
