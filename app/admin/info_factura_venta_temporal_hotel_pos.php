      ...
      <tr>
       ...
       <td style="text-align:center;"><input name="cod_base_caja" id="cod_base_caja" type="number" value="<?php echo $cod_base_caja ?>" style="width: 40px;" tabindex="1" required/><div id="mensaje_caja_mesa"></div></td>
        ...
        <td style="text-align:center;">
            ...
            <?php if ($cod_estado_soporte_factura_venta_global == '1') { ?><input type="file" name="url_img1" id="url_img1"><?php } ?>
        </td>
        ...
        <td style="text-align:center;">
            ...
            <?php if ($nombre_tipo_factura == 'ELECTRONICA') { echo '<br><img src="../imagenes/auxilio.gif"> Ultima Factura Electronica #'.$cod_ultima_factura_electronica.' - (Base: '.number_format($subtotal_base_iva, 0, ",", ".").')'; } ?>
        </td>
        ...
        <?php $pagina ='facturacion_venta_temporal_producto_manual_hotel_pos.php'; ?>
...
<?php if ($cod_estado_venta_bolsa == '1') { ?>
        <td style="text-align:right;"><a href="../admin/actualizar_bolsa_temporal_producto.php?cuenta=<?php echo $cuenta_actual ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&pagina=<?php echo $pagina ?>&pagina_local=<?php echo $pagina ?>" tabindex="1"><img src="../imagenes/btn_bolsa_plastica.png" alt="Listo" tabindex="1"></a></td>
<?php } ?>
