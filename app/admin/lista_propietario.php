...
<a class="btn btn-success" href="../admin/reg_propietario.php">Registrar Propietario</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="btn btn-primary" href="../admin/lista_propietario_deshabilitado.php">Propietarios Deshabilitados</a>
<?php } ?>
<br>
<!--
...
<script type="text/javascript" src="../admin/busqueda_paginacion_propietario_ajax.js"></script>
