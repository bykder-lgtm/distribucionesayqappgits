...
tbl15_cuentas_cobrar.url_img_orig_producto, tbl15_cuentas_cobrar.cod_estado_contrato, tbl15_cuentas_cobrar.cod_renovacion_contrato
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar.cod_tercero 
WHERE (tbl15_cuentas_cobrar.cod_factura='$cod_factura') ORDER BY tbl15_cuentas_cobrar.fecha_invert DESC";
...
$cod_renovacion_contrato        = $datos_total_facturas['cod_renovacion_contrato']+1;
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/renovar_contrato_agrupado_alquiler_reg.php">
    <fieldset>
    ...
    <table border="1" class="table table-responsive">
        <thead>
            ...
            <tr>
                ...
                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="cod_renovacion_contrato" type="number" value="<?php echo $cod_renovacion_contrato ?>" min="0" size="10" step="any" required></td>
                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="numero_cuota" type="number" value="<?php echo $numero_cuota ?>" min="1" max="99" size="10" step="any" required></td>
                <td style="text-align:center"><input style="font-size:24px; width: 150px;" class="input-block-level" name="monto_deuda_sin_interes" id="monto_deuda_sin_interes" type="text" value="<?php echo $precio_venta_producto ?>" min="1" size="10" required></td>
