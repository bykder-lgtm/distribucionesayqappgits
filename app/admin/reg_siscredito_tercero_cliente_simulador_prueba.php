            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form action="../admin/reg_siscredito_tercero_aliado_estrategico_reg.php" method="post" id="contactForm">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">Fecha de nacimiento
                                        <input type="date" class="form-control" id="fecha_nac_tercero" name="fecha_nac_tercero" placeholder="Fecha de nacimiento" required data-error="Por favor, ingrese su fecha de nacimiento" />
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">Celular
                                        <input type="text" class="form-control" id="telefono1_tercero" name="telefono1_tercero" placeholder="Celular" required data-error="Por favor, ingrese su celular" />
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">Correo
                                        <input type="text" class="form-control" id="correo_tercero" name="correo_tercero" placeholder="Correo" required data-error="Por favor, ingrese su Correo" />
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button class="btn hvr-hover btn-lg btn-block" id="submit" type="submit">Registrar Cliente</button>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
