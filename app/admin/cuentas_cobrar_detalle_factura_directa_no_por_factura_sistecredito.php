...
<tr>
<td style="text-align: center;"><strong><a href="../admin/lista_cuentas_cobrar_directa_no_por_factura_sistecredito.php"><font size="5px">REGRESAR</font></a></strong></td>
</tr>
<tr>
...
<tr>
<td style="text-align: center;"><a href="../admin/reg_abono_cuentas_cobrar_directa_no_por_factura_sistecredito.php?cod_tercero=<?php echo $cod_tercero?>&pagina=<?php echo $pagina?>"><font size="6px">NUEVO ABONO</font></a></td>
</tr>
<?php } ?>
</table>
</table>
...
?>
	<tr>
		...
		<?php if ($cod_estado_modulo_cuenta_cobrar_abono_editar_venta_global == '1') { ?><td style="text-align: center"><?php echo $boton_alerta_caducidad ?></td><?php } ?>
