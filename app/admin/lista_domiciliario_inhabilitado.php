...
<a href="../admin/lista_domiciliario.php"><h4>Lista de Domiciliarios Deshabilitadas&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_domiciliario.php">Regresar</h4></a>
</div>
...
<tbody>
<?php
$mostrar_datos_sql = "SELECT * FROM tbl15_domiciliario WHERE (cod_estado = '0') ORDER BY cod_domiciliario DESC";
