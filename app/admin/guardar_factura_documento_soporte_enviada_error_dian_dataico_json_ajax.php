...
if (($campo=='cod_info_factura_compra') && ($tipo_ajax=='tbl15_info_factura_compra')) {
	...
	$data_sql = ("UPDATE tbl15_info_factura_compra SET dataico_dian_error = '$dataico_dian_error', dataico_dian_path = '$dataico_dian_path' WHERE cod_info_factura_compra = '$cod_info_factura_compra'");
