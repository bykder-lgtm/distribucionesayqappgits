...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formulario_de_actualizacion")) {
	...
	$cod_gasto_inmueble_detalle_venta_temporal      = intval($_POST['cod_gasto_inmueble_detalle_venta_temporal']);
...
/* ----------------------------------------------------------------------------------------------------------/ */
	if ($url_img1 <> '') { 
		...
		$nombre_normal2                  = 'GASTO_ARRENDATARIO_'.$fecha_ymdHis.'_'.$cod_gasto_inmueble_detalle_venta_temporal.'_'.$cod_info_gasto_inmueble_detalle_venta.'.'.$formato_img2;
...
//-------------------------------------- -----------------------------------------------------------------//
//-------------------------------------- -----------------------------------------------------------------//
	$actualizar_sql1 = "UPDATE tbl15_gasto_inmueble_detalle_venta_temporal SET url_img_orig_producto = '$url_img_orig_producto', url_img_min_producto = '$url_img_min_producto' 
