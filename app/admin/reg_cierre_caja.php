...
<table border="1" class="table table-responsive">
	<thead>
		...
		<?php if ($cod_seguridad == '1') { ?>
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">TOTAL VENTA (EFECTIVO + TRANSFERENCIA SISTEMA):</th>
		...
		<?php if ($cod_seguridad == '1') { ?>
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">TOTAL VENTA EN EFECTIVO (SISTEMA):</th>
		...
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">CONTEO CAJA EN EFECTIVO + BASE:</th>
		...
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;" title="No contar la base">TOTAL CONTEO CAJA EN EFECTIVO:</th>
