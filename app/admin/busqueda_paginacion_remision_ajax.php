...
$pagina                   = $concatenador."tbl15_remision.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    // escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sTable = "(tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_remision ON tbl15_administrador.cod_administrador = tbl15_remision.cod_administrador) ON tbl15_cliente.cod_cliente = tbl15_remision.cod_cliente)";
     ...
     elseif ($buscar_por=='motivo') { $columnas_busqueda = array('tbl15_remision.motivo'); }
     elseif ($buscar_por=='nombre_empresa') { $columnas_busqueda = array('tbl15_remision.nombre_empresa'); }
     elseif ($buscar_por=='fecha_ymd') { $columnas_busqueda = array('tbl15_remision.fecha_ymd'); }
     elseif ($buscar_por=='cod_remision') { $columnas_busqueda = array('tbl15_remision.cod_remision'); }
     elseif ($buscar_por=='cod_historia_clinica') { $columnas_busqueda = array('tbl15_remision.cod_historia_clinica'); }
     else {  }
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" ORDER BY tbl15_remision.fecha_time DESC";
} else {
    $sWhere.=" ORDER BY tbl15_remision.fecha_time DESC";
}
    ...
    $reload = '../admin/tbl15_remision.php';
...
$sql_consulta = "SELECT tbl15_remision.cod_remision, tbl15_remision.cod_cliente, tbl15_remision.cod_administrador, tbl15_remision.cod_historia_clinica, 
...
<td><?php echo $estructura_remision?></td>
