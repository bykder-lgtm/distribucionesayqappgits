...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_certificado_retencion_en_la_fuente_compra.php"><font size='+1'>Registrar Certificado Retefuente Por Reporte de Compra</font></a></th>
    </tr>
</table>
<div class="row-fluid">
...
<table class="table table-striped">
    <tr>
        ...
        <th style="text-align:center;"><a href="#">GENERAR CERTIFICADO DE RETENCION PDF</a></th>
    </tr>
    <tr>
        ...
        <td style="text-align:center;"><a href="../admin/certificado_de_retencion_en_la_fuente_por_reporte_compra_reg.php?fecha_ymd_venta_producto_ini=<?php echo $fecha_ymd_venta_producto_ini?>&fecha_ymd_venta_producto_fin=<?php echo $fecha_ymd_venta_producto_fin?>&cod_tercero=<?php echo $cod_tercero?>&nombre_certificado_retefuente=<?php echo $nombre_certificado_retefuente?>&nombre_origen_modulo=<?php echo $nombre_origen_modulo?>&nombre_origen_creacion=<?php echo $nombre_origen_creacion?>" target="_blank"><img src=../imagenes/pdf.png alt="imprimir_peq"></a></td>
    </tr>
</table>
