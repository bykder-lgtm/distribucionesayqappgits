...
<?php
$suma_temporal = "SELECT Sum(total_venta_producto) As total_venta, Sum(total_costo_producto) As total_compra FROM tbl15_plan_accion_correctiva_preventiva_mejora_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_plan_accion_correctiva_preventiva_mejora WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_y_plan_accion_correctiva_preventiva_mejora_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<script language="javascript">
$(document).ready(function(){
    $("#nombre_tipo_pendiente").on('change', function () {
            var valor = $(this).val();
            var campo = "nombre_tipo_pendiente";
            var tipo_ajax = "tbl15_info_plan_accion_correctiva_preventiva_mejora";
            $.post("guardar_info_factura_y_plan_accion_correctiva_preventiva_mejora_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora; ?> }, function(data){
                $("#modelo").html(data);
        });
...
<script language="javascript">
$(document).ready(function(){
    $("#nombre_comentario").on('change', function () {
            var valor = $(this).val();
            var campo = "nombre_comentario";
            var tipo_ajax = "tbl15_info_plan_accion_correctiva_preventiva_mejora";
            $.post("guardar_info_factura_y_plan_accion_correctiva_preventiva_mejora_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora; ?> }, function(data){
                $("#modelo").html(data);
        });
...
<script language="javascript">
$(document).ready(function(){
    $("#descripcion_tipo_pendiente").on('change', function () {
            var valor = $(this).val();
            var campo = "descripcion_tipo_pendiente";
            var tipo_ajax = "tbl15_info_plan_accion_correctiva_preventiva_mejora";
            $.post("guardar_info_factura_y_plan_accion_correctiva_preventiva_mejora_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora; ?> }, function(data){
                $("#modelo").html(data);
        });
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_plan_accion_correctiva_preventiva_mejora_temporal";
            var idclass = $(this).attr("class");
            var id = $(this).attr("llave");
            //let id = this.id;
            $.post("guardar_info_factura_y_plan_accion_correctiva_preventiva_mejora_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<form method="post" name="formulario" action="../admin/plan_accion_correctiva_preventiva_mejora_venta_producto_reg.php">
...
<?php 
$sql_temporal = "SELECT cod_plan_accion_correctiva_preventiva_mejora_temporal FROM tbl15_plan_accion_correctiva_preventiva_mejora_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<input type="hidden" name="cod_plan_accion_correctiva_preventiva_mejora_temporal[]" value="<?php echo $datos_temporal['cod_plan_accion_correctiva_preventiva_mejora_temporal']; ?>" size="4">
<?php } ?>  
<?php $pagina ='facturacion_plan_accion_correctiva_preventiva_mejora_venta_temporal_producto_manual_pos.php'; ?>
<input type="hidden" name="cod_info_plan_accion_correctiva_preventiva_mejora" value="<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora ?>" size="10">
