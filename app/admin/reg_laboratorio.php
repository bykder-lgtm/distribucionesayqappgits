...
<a href="#"><h4>Registrar Laboratorio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_laboratorio.php">Lista de Laboratorios</h4></a>
</div>
<hr>
<div class="row-fluid">
...
$('#nombre_laboratorio').blur(function(){
$('#Info').html('<img src="../imagenes/loader.gif" alt="" />').fadeOut(1000);
var nombre_laboratorio = $(this).val();		
var dataString = 'nombre_laboratorio='+nombre_laboratorio;
$.ajax({ type: "GET", url: "validar_laboratorio.php", data: dataString, success: function(data) { $('#Info').fadeIn(1000).html(data); } }); }); });    
</script>
<!-- ***************************************************************************************************************************** -->
<?php
$pagina = $_SERVER['PHP_SELF'];
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/reg_laboratorio_reg.php">
<fieldset>
...
<table border="1" class="table table-responsive">
    ...
    <tbody>
    	<tr>
<td><input class="input-block-level" id="nombre_laboratorio" name="nombre_laboratorio" type="text" value="" required autofocus/></td>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
