...
<a href="#"><h4>Lista de Notas y Observaciones&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/reg_nota_observacion.php">Registrar Notas y Observaciones</h4></a>
</div>
...
if (isset($_GET['buscar_por'])) { $buscar_por = addslashes($_GET['buscar_por']); } else { $buscar_por = 'nombre_nota_observacion'; }
?>
<!-- Form search -->
...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/busqueda_paginacion_nota_observacion_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&tabla='+tabla,
