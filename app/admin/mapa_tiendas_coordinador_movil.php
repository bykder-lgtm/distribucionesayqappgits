...
<head>
    ...
    <title>Mapa de Tiendas (Coordinador) - <?php echo $nombre_empresa; ?></title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .filter-input:focus { outline: none; border-color: var(--theme-color); background: rgba(59, 130, 246, 0.1); box-shadow: 0 0 10px rgba(59, 130, 246, 0.2); }
...
<body>
    ...
    <header class="app-header">
        <a href="config_coordinador_movil.php" class="back-btn">
