...
<td style="text-align:center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../admin/cuentas_pagar_abonos.php?cod_cuentas_pagar_abonos=<?php echo $cod_cuentas_pagar_abonos ?>&cod_cuentas_pagar=<?php echo $cod_cuentas_pagar ?>&cod_factura=<?php echo $cod_factura ?>&cod_tercero=<?php echo $cod_tercero ?>&cliente=<?php echo $cliente ?>" id="listo"><img src="../imagenes/listo.png" alt="listo"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<?php
$sql = "SELECT * FROM tbl15_cuentas_pagar_abonos WHERE cod_cuentas_pagar_abonos = '$cod_cuentas_pagar_abonos' ORDER BY fecha_invert DESC";
