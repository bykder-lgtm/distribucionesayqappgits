...
$sql_producto = "SELECT * FROM tbl15_venta_producto_temporal 
                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="text-align:center;">Pedido hecho correctamente</th>
                                </tr>
                                <tr>
...
<div class="col-xl-12 col-lg-5 col-md-6">
    ...
    <h2><div id="texto_resaltado">Comunícate con nosotros al siguiente número de whatsapp para obtener mejores precios.</div></h2>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="text-align:center;"><a href="../admin/contactar_por_whatapp_telefono.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&accion_codifcryp=<?php echo $accion_whatapp_codifcryp ?>&tipo_codifcryp=<?php echo $tipo_codifcryp ?>&origen_codifcryp=<?php echo $origen_codifcryp ?>" target="_blank"><img src="../imagenes/btn_tel_whatapp_solo.png" /><br><?php echo $telefono ?></a></th>
                                    <th style="text-align:center;"><a href="tel:57<?php echo $telefono ?>" target="_blank"><img src="../imagenes/btn_tel_telefono_solo.png" /><br><?php echo $telefono ?></a></th>
<!--
                                    <th style="text-align:center;"><a href="../admin/contactar_por_whatapp_telefono.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&accion_codifcryp=<?php echo $accion_whatapp_codifcryp ?>&tipo_codifcryp=<?php echo $tipo_codifcryp ?>&origen_codifcryp=<?php echo $origen_codifcryp ?>" target="_blank"><img src="../admin/crear_escribir_sobre_imagen_whatapp_empresa.php?tel1=<?php echo $telefono ?>" /></a></th>
                                    <th style="text-align:center;"><a href="tel:57<?php echo $telefono ?>" target="_blank"><img src="../admin/crear_escribir_sobre_imagen_telefono_empresa.php?tel1=<?php echo $telefono ?>" /></a></th>
-->
                                </tr>
                            </thead>
                        </table>
