...
<?php include_once("../admin/modulo_categoria_producto_filtro_vendedor_domicilio.php"); ?>
...
if ($url_img_orig_producto=='') { $url_img_orig_producto = '../imagenes/sin_imagen.jpg'; }
...
$(document).ready(function() {
    ...
    $('.hvr-hover').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "../admin/reg_venta_temporal_producto_vendedor_domicilio_ajax_reg.php",
            data: datos_url_ajax,
...
$(document).ready(function() {
    ...
    $('.hvr-hover').click(function(){
        ...
        var datos_url_ajax = 'llave_codifcryp='+cod_producto_barra+'&'+'und_vendida='+und_vendida+'&'+'tab_codifcryp='+'<?php echo $tab_codifcryp ?>'+'&'+'campo_codifcryp='+'<?php echo $campo_codifcryp ?>'+'&'+'accion_codifcryp='+'<?php echo $accion_codifcryp ?>'+'&'+'origen_codifcryp='+'<?php echo $origen_codifcryp ?>'+'&'+'tipo_codifcryp='+'<?php echo $tipo_codifcryp ?>'+'&'+'vendedor_codifcryp='+'<?php echo $cuenta_actual ?>';
