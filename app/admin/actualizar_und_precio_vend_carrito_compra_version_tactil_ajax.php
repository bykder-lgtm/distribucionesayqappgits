...
$cod_venta_producto_temporal        = intval($_REQUEST['id']);
...
$sql_venta_producto_temporal = "SELECT precio_venta_producto FROM tbl15_venta_producto_temporal WHERE (cod_venta_producto_temporal = '$cod_venta_producto_temporal')";
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = sprintf("UPDATE tbl15_venta_producto_temporal SET und_venta = '$und_venta', total_venta_producto = '$total_venta_producto' WHERE (cod_venta_producto_temporal = '$cod_venta_producto_temporal')");
