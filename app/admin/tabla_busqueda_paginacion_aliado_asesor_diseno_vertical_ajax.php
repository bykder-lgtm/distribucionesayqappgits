...
$pagina = $concatenador."lista_aliado_asesor_diseno_vertical.php";
...
if($action == 'ajax') {
    ...
    $sWhere = " WHERE (cod_asesor = '$cod_administrador')";
    if ($busqueda_ajax != "") {
        $sWhere = " WHERE (cod_asesor = '$cod_administrador') AND ( ";
    ...
    $reload                            = '../admin/lista_aliado_asesor_diseno_vertical.php';
