...
if (mysqli_query($conectar, $sql_update)) { $response['success'] = true; $response['message'] = 'Contraseña actualizada correctamente'; } else { $response['message'] = 'Error al actualizar: ' . mysqli_error($conectar); }
