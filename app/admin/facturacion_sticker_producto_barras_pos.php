...
<tbody>
<?php
$sql_sticker_producto = "SELECT * FROM tbl15_sticker_producto WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual') 
...
$cod_info_factura_sticker          = $datos_sticker_producto['cod_info_factura_sticker'];
$nombre_tipo_precio_venta          = $datos_sticker_producto['nombre_tipo_precio_venta'];
$cod_estado_permitir_venta         = $datos_sticker_producto['cod_estado_permitir_venta'];
