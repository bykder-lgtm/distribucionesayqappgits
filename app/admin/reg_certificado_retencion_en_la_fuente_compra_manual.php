...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_certificado_retencion_en_la_fuente_compra.php"><font size='+1'>Registrar Certificado Retefuente Manual (Compra)</font></a></th>
    </tr>
</table>
<hr>
<div class="row-fluid">
...
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/reg_certificado_retencion_en_la_fuente_compra_manual_reg.php">
<fieldset>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<table border="1" class="table table-responsive">
	<tr>
		...
		<th style="text-align:center">TELEFONO EMPRESA</th>
		<th style="text-align:center">CORREO EMPRESA</th>
		<th style="text-align:center">DIRECCION EMPRESA</th>
		<th style="text-align:center">LOCALIDAD EMPRESA</th>
	</tr>
  	<tr>
		<td style="text-align:center"><input class="input-block-level" name="cabecera_certificado_retefuente" type="text" value="<?php echo $cabecera_emp ?>" required /></td>
		<td style="text-align:center"><input class="input-block-level" name="propietario_nit_certificado_retefuente" type="text" value="<?php echo $propietario_nit_emp ?>" required /></td>
		<td style="text-align:center"><input class="input-block-level" name="telefono_certificado_retefuente" type="text" value="<?php echo $telefono_emp ?>" required /></td>
		<td style="text-align:center"><input class="input-block-level" name="correo_certificado_retefuente" type="text" value="<?php echo $correo_emp ?>" required /></td>
		<td style="text-align:center"><input class="input-block-level" name="direccion_certificado_retefuente" type="text" value="<?php echo $direccion_emp ?>" required /></td>
		<td style="text-align:center"><input class="input-block-level" name="localidad_certificado_retefuente" type="text" value="<?php echo $localidad_emp ?>" required /></td>
	</tr>
</table>
...
<input type="hidden" name="nombre_certificado_retefuente" value="RETENCIÓN APLICADA A COMPRAS DECLARANTES">
<input type="hidden" name="nombre_origen_modulo" value="COMPRA">
<input type="hidden" name="nombre_origen_creacion" value="MANUAL">
