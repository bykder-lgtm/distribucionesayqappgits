...
$sql_user_vendedor = "SELECT nombres, apellidos, cod_estado_origen_produccion, cod_origen_produccion_user FROM tbl15_administrador WHERE (cod_administrador = '$cod_administrador')";
$consulta_user_vendedor = mysqli_query($conectar, $sql_user_vendedor);
$matriz_permiso_usuario = mysqli_fetch_assoc($consulta_user_vendedor);
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h3 class="text-primary"><a href="../admin/lista_caja_virtual_cocina.php?pagina=<?php echo $pagina ?>"><?php echo $nombre_concepto_multi_virtual; ?>S PEDIDOS</a></h3>
