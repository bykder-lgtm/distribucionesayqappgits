...
if (isset($_GET['pagina'])) { $pagina = addslashes($_GET['pagina']); } else { $pagina = 'facturacion_compra_iva_no_inc_temporal_producto_manual_pos.php'; }
?>
<br>
<table class="table table-striped">
    <tr>
        <th style="text-align:center"><a href="../admin/facturacion_compra_iva_no_inc_temporal_producto_manual_pos.php"><font size='+1'>Lista Factura Compra Abierta</font></a></th>
