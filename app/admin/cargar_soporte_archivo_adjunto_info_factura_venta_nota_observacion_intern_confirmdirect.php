...
?>
    ...
    <form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/cargar_soporte_archivo_adjunto_info_factura_venta_nota_observacion_intern_confirmdirect_reg.php">
