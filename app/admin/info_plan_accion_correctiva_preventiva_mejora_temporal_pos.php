...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_plan_accion_correctiva_preventiva_mejora_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            //let id = this.id;
            $.post("guardar_plan_accion_correctiva_preventiva_mejora_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
...
<form method="post" name="formulario" action="../admin/plan_accion_correctiva_preventiva_mejora_producto_reg.php">
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  ...
  <tr>
   ...
   <td style="text-align:center;"><?php echo $cod_info_plan_accion_correctiva_preventiva_mejora ?></td>
...
<input type="hidden" name="cod_plan_accion_correctiva_preventiva_mejora_temporal[]" value="<?php echo $datos_temporal['cod_plan_accion_correctiva_preventiva_mejora_temporal']; ?>">
<?php } ?>
