...
$cod_empresa_contratante = intval($_POST['cod_empresa_contratante']);
$nombre_empresa_contratante = addslashes($_POST['nombre_empresa_contratante']);

$actualizar_historia_clinica = "UPDATE tbl15_empresa_contratante SET nombre_empresa_contratante = '$nombre_empresa_contratante' WHERE cod_empresa_contratante = '$cod_empresa_contratante'";
