...
tbl15_cuentas_cobrar_alerta.cod_estado_envio_correo_comision_propietario, tbl15_cuentas_cobrar_alerta.fecha_alerta_pago_comision_prop
...
AND (tbl15_producto.dia_pago_propietario_inmueble <> '') AND (tbl15_cuentas_cobrar_alerta.cod_excluir_pago_propietario = '1') ORDER BY tbl15_cuentas_cobrar_alerta.fecha_pago ASC";
...
$fecha_alerta_mes                                  = date('Y-m-d', strtotime($fecha_pago.'+1 month'));
...
if ($nombre_tipo_cobro_propietario_inmueble == 'MES VENCIDO') { $fecha_alerta = date('Y-m', strtotime($fecha_alerta_mes)).'-'.$dia_pago_propietario; } else { $fecha_alerta = $fecha_pago; }
?>
    <tr id="cod_cuentas_cobrar_alerta<?php echo $cod_cuentas_cobrar_alerta ?>">
        ...
        <td style="text-align: center;" id="cod_cuentas_cobrar_alerta<?php echo $cod_cuentas_cobrar_alerta ?>"><font size='3'><?php echo date("d-m-Y", strtotime($fecha_pago)) ;?></font></td>
