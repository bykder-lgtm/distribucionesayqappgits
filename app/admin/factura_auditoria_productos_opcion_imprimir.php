...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_factura_auditoria WHERE (cod_info_factura_auditoria = '$cod_info_factura_auditoria')";
...
$cod_info_factura_strpad   = str_pad($cod_info_factura_auditoria, 6, "0", STR_PAD_LEFT);
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$resta                               = 1516399999;
$time_seg                            = time();
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td style="text-align:center;"><a href="../admin/resultado_auditoria_producto_manual_pos.php?cod_info_factura_auditoria=<?php echo $cod_info_factura_auditoria?>"><img src="../imagenes/cruze.gif"></a></td>
<!--
    ...
    <td align='center'><a href="../admin/imprimir_factura_venta_grande_bootstrap_mpdf_pdf.php?cod_info_factura_auditoria=<?php echo $cod_info_factura_auditoria?>" target="_blank"><img src="../imagenes/imprimir_.png"></a></td>
  -->
  </tr>
</table>
</center>
...
precio_ipc, nombre_tipo_unidad_medida FROM tbl15_factura_auditoria_producto WHERE (cod_info_factura_auditoria = '$cod_info_factura_auditoria')";
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_factura.'-'.$fecha_venta_ymd.$hora_compra_his ?></strong>_imp_cotiz_nrm</td>
  </tr>
</table>
