...
$cod_numero_hijos = intval($_POST['cod_numero_hijos']);
$nombre_numero_hijos = addslashes($_POST['nombre_numero_hijos']);

$actualizar_historia_clinica = "UPDATE tbl15_numero_hijos SET nombre_numero_hijos = '$nombre_numero_hijos' WHERE cod_numero_hijos = '$cod_numero_hijos'";
