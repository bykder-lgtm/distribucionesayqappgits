...
if (isset($_POST['cod_producto_codifcryp'])) {
	...
	cod_administrador, cod_estado_cliente, fecha_expiracion_cupon_descuento, nombre_actividad_ecoemp, direccion_contacto1, tel_contacto1, cod_sesion) 
	...
	$url_redir = "../admin/cargar_foto_tercero_cliente_siscredito_visitante_extnosesion.php?cod_tercero_codifcryp=".$cod_tercero_codifcryp;
