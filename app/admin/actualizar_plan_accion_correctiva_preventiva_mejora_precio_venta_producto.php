...
$cod_plan_accion_correctiva_preventiva_mejora      = intval($_GET['cod_plan_accion_correctiva_preventiva_mejora']);
...
$sql_temporal = "SELECT * FROM tbl15_plan_accion_correctiva_preventiva_mejora WHERE cod_plan_accion_correctiva_preventiva_mejora = '$cod_plan_accion_correctiva_preventiva_mejora'";
...
$actualizar_sql = "UPDATE tbl15_plan_accion_correctiva_preventiva_mejora SET nombre_tipo_precio_venta = '$nombre_tipo_precio_venta', 
