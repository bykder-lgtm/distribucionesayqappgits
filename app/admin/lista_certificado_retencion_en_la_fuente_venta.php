...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_certificado_retencion_en_la_fuente_venta.php"><font size='+1'>Lista Certificados Retefuente Venta</font></a></th>
        <th style="text-align:right"><a href="../admin/reporte_compra_fechas_tercero_certificado_retencion_en_la_fuente_venta.php?nombre_certificado_retefuente=<?php echo $nombre_certificado_retefuente; ?>"><font size='+1'>Registrar Certificado Por Reporte</font></a></th>
        <th style="text-align:right"><a href="../admin/reg_certificado_retencion_en_la_fuente_venta_manual.php?nombre_certificado_retefuente=<?php echo $nombre_certificado_retefuente; ?>"><font size='+1'>Registrar Certificado Manual</font></a></th>
    </tr>
</table>
<hr>
<div class="row-fluid">
...
while ($matriz_consulta = mysqli_fetch_assoc($consulta)) {
	...
	$nombre1_tercero                                     = $matriz_tercero['nombre1_tercero'].' '.$matriz_tercero['nombre2_tercero'].' '.$matriz_tercero['apellido1_tercero'].' '.$matriz_tercero['apellido2_tercero'].' ('.$matriz_tercero['identificacion_tercero'].')';
?>
	<tr>
		...
		<td style="text-align:center"><a href="../admin/certificado_de_retencion_en_la_fuente_en_compras_pdf.php?cod_certificado_retefuente=<?php echo $cod_certificado_retefuente; ?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="pdf"></a></td>
	</tr>
<?php } ?>
</tbody>
</table>
