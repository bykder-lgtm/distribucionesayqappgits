...
// escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sWhere = " WHERE (cod_administrador = '$cod_administrador') AND (cod_seguridad = '$cod_seguridad')";
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = " WHERE (cod_administrador = '$cod_administrador') AND (cod_seguridad = '$cod_seguridad') AND ( ";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="contact-form-right">
                        <div class="row p-3 mb-2 bg-primary text-white">
                            <div class="col-md-1">
                                <div style="text-align:center;" class="">T.Doc</div>
                            </div>
                            <div class="col-md-2">
                                <div style="text-align:center;" class="">Documento</div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-1">
                                <div style="text-align:center;" class="">Asesor</div>
                            </div>
                            <div class="col-md-1">
...
while ($datos_consulta = mysqli_fetch_assoc($query_consulta)) {
    ...
    $nombres_apellidos             = trim($nombre1_tercero.' '.$nombre2_tercero.' '.$apellido1_tercero.' '.$apellido2_tercero);
    ...
    //$cod_seguridad                 = $datos_consulta['cod_seguridad'];
...
?>
                        <div class="row">
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><?php echo $nombre_tipo_identificacion ?></div>
                            </div>
                            <div class="col-md-2">
                                <div style="text-align:center;" class=""><?php echo $identificacion_tercero ?></div>
                            </div>
                            <div class="col-md-2">
                                <div style="text-align:center;" class=""><?php echo $nombres_apellidos ?></div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><?php echo $usuario ?></div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/lista_soportes_cliente_siscredito_visitante_intern.php?cod_tercero=<?php echo $cod_tercero ?>&pagina=<?php echo $pagina_local ?>"><img src="../imagenes/pdf_peq.png" class="img-polaroid" alt=""></a></div>
                            </div>
                            <div class="col-md-1">
