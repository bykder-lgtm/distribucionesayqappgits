...
tbl15_cuentas_cobrar.nombre_tipo_cobro, tbl15_cuentas_cobrar.cod_renovacion_contrato, 
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_cuentas_cobrar_alerta = "SELECT deduccion_retefuente, deduccion_otro_concepto FROM tbl15_cuentas_cobrar_alerta WHERE cod_cuentas_cobrar = '$cod_cuentas_cobrar'";
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/edit_cuentas_cobrar_agrupado_detalle_factura_alquiler_rango_pago_solo_actualizar_reg.php">
    <fieldset>
    ...
    <table border="1" class="table table-responsive">
        <thead>
            ...
            <tr>
                ...
                <td style="text-align:center; font-size:24px;"><?php echo $numero_cuota ?></td>
                <input style="font-size:24px" class="input-block-level" name="numero_cuota" type="hidden" value="<?php echo $numero_cuota ?>" min="1" max="99" size="10" step="any">
                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="cod_renovacion_contrato" type="number" value="<?php echo $cod_renovacion_contrato ?>" min="0" size="10" required></td>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody>
        ...
        <hr>
        <div class="actions">
            <td style="text-align:center"><input type="submit" value="Generar Nuevas Fechas Contrato de Alquiler" name="submit" id="submitButton" class="btn btn-info pull-center" title="Click aqui para enviar" /></td>
        </div>
        </tr>
    </tbody>
</table>
