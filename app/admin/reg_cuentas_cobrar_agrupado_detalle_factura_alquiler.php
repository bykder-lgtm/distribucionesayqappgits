...
$nombre_letra_tabla_mes_periodo_pagar         = $matriz_consulta['nombre_letra_tabla_mes'];
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$fecha_impr                     = date("Ymd");
$hora_impr                      = date("His");
...
<table border="1" class="table table-responsive">
    <thead>
      ...
      <tr>
        ...
        <td style="text-align:left"><br><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_reparacion" id="deduccion_reparacion" value="0" min="0" size="5" required></td>
        ...
        <td style="text-align:left; width:25%">ATRASO <span id="dias_atraso"></span><input style="font-size:24px" class="input-block-level" type="text" name="monto_cuota_interes" id="monto_cuota_interes" value="" min="0" size="5" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_deudas_anteriores" id="deduccion_deudas_anteriores" value="0" min="0" size="5" required></td>
...
<table border="1" class="table table-responsive">
    <thead>
        ...
        <tr>
            <td style="text-align:center; font-size:28px"><?php echo $nombre_letra_tabla_mes_periodo_pagar ?></td>
...
<input type="hidden" name="cod_estado_hoy" value="<?php echo $cod_estado_hoy; ?>">
<input type="hidden" name="cod_estado_pago" value="<?php echo $cod_estado_pago; ?>">
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        ...
        var total_deduccion = parseInt(deduccion_retefuente + deduccion_reparacion + deduccion_servicio + deduccion_otro_impuesto_dian + deduccion_otro_concepto + deduccion_servicio_energia + deduccion_servicio_agua + deduccion_servicio_gas + deduccion_deudas_anteriores, 10);
        var total_ingreso = parseInt(monto_cuota_interes + ingreso_gasto_juridica + ingreso_administracion_incluida + monto_deuda_alerta + ingreso_deudas_anteriores + ingreso_otro_concepto, 10);
        var subtotal_deduccion_ingreso = total_ingreso - total_deduccion;
        var total_pagar = parseInt(subtotal_deduccion_ingreso, 10);

	    $('#abonado').val(total_pagar);
	    var abonado = parseFloat($('#abonado').val());
	    var total_pendiente = parseInt(total_pagar - abonado, 10);
