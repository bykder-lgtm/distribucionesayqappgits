...
<?php if ($cod_estado_prod_reg_producto == '1') { ?><a class="btn btn-success" href="../admin/reg_inmueble.php">Registrar Inmueble</a><?php } ?>
<br>
<!--
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4"><input type="text" class="form-control" id="busqueda_ajax" placeholder="Nombre del Inmueble" onkeyup='load(1);'><button type="button" class="btn btn-default" onclick='load(1);'><span class="glyphicon glyphicon-search" ></span> Buscar</button><span id="loader"></span></div>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_inmueble_ajax.js"></script>
