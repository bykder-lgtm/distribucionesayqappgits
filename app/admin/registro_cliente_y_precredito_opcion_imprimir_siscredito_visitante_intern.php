...
if (isset($_GET['cod_info_factura_venta'])) {
    ...
    $cod_tercero_codifcryp                              = intval($_GET['cod_tercero_codifcryp']);
    //$pagina                                             = addslashes($_GET['pagina']);
    $pagina                                             = '../admin/lista_info_factura_venta_abierta_siscredito_visitante_intern_aliado_estrategico.php';
    $pagina_redirect                                    = $pagina.'?cod_info_factura_venta='.$cod_info_factura_venta.'&cod_entidad_crediticia='.$cod_entidad_crediticia.'&cod_tercero_codifcryp='.$cod_tercero_codifcryp.'&pagina='.$pagina;
/* ----------------------------------------------------------------------------------------------------------/ */
...
/* ----------------------------------------------------------------------------------------------------------/ */
    ...
    $mostrar_datos_sql = "SELECT * FROM tbl15_entidad_crediticia WHERE (cod_entidad_crediticia = '$cod_entidad_crediticia')";
    $consulta = mysqli_query($conectar, $mostrar_datos_sql) or die(mysqli_error($conectar));
    $matriz_consulta = mysqli_fetch_assoc($consulta);

    $cod_entidad_crediticia                           = $matriz_consulta['cod_entidad_crediticia'];
?>
    <!-- Start Cart -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="contact-form-right">
                            <div class="row p-3 mb-2 bg-primary text-white">
                                ...
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                    <div style="text-align:center;" class="">Notificar Via WhatsApp Al Revisor</div>
                                </div>
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                    <div style="text-align:center;" class="">Notificar Via WhatsApp Al Cliente</div>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                    <div style="text-align:center;" class=""><a href="<?php echo $pagina_redirect ?>"><i class="fa fa-undo fa-2x"></i></a></div>
                                </div>
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                    <div style="text-align:center;" class=""><a href="../admin/contactar_por_whatapp_registro_cliente_y_precredito_revisor_siscredito_visitante_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&notificar=REVISOR&cod_entidad_crediticia=<?php echo $cod_entidad_crediticia ?>&cod_tercero_codifcryp=<?php echo $cod_tercero_codifcryp ?>&pagina=<?php echo $pagina ?>" target="_blank"><i class="fa fa-folder fa-2x"></i></a></div>
                                </div>
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                    <div style="text-align:center;" class=""><a href="../admin/contactar_por_whatapp_registro_cliente_y_precredito_revisor_siscredito_visitante_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&notificar=CLIENTE&cod_entidad_crediticia=<?php echo $cod_entidad_crediticia ?>&cod_tercero_codifcryp=<?php echo $cod_tercero_codifcryp ?>&pagina=<?php echo $pagina ?>" target="_blank"><i class="fa fa-folder-open fa-2x"></i></a></div>
                                    <!--<div style="text-align:center;" class=""><a href="../admin/lista_soportes_info_factura_venta_siscredito_visitante_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cod_tercero=<?php echo $cod_tercero ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/btn_red_social_whatsapp.jpg" alt="listo"></a></div>-->
                                </div>
                            </div>
                        </div>
                    </div>
