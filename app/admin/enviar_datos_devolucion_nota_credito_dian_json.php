...
if (isset($_REQUEST['cod_info_factura_venta'])) {
	...
	//-------------------------------------------------------------------------------------------------------------------//
	//-------------------------------------------------------------------------------------------------------------------//
	$mostrar_datos_resolucion_nota_credito = "SELECT * FROM tbl15_resolucion_facturacion WHERE nombre_tipo_resolucion_facturacion = 'NOTA CREDITO'";
	$consulta_resolucion_nota_credito = mysqli_query($conectar, $mostrar_datos_resolucion_nota_credito) or die(mysqli_error($conectar));
	$matriz_consulta_resolucion_nota_credito = mysqli_fetch_assoc($consulta_resolucion_nota_credito);

	$numero_resolucion_facturacion           = $matriz_consulta_resolucion_nota_credito['numero_resolucion_facturacion'];
	$prefijo_nota_credito                    = $matriz_consulta_resolucion_nota_credito['prefijo_resolucion_facturacion'];
	//-------------------------------------------------------------------------------------------------------------------//
	//-------------------------------------------------------------------------------------------------------------------//
	$mostrar_nota_credito = "SELECT MAX(cod_factura_nota_credito) cod_factura_nota_credito FROM tbl15_info_nota_credito WHERE (prefijo_nota_credito = '$prefijo_nota_credito')";
	$consulta_nota_credito = mysqli_query($conectar, $mostrar_nota_credito) or die(mysqli_error($conectar));
	$matriz_nota_credito = mysqli_fetch_assoc($consulta_nota_credito);

	$cod_factura_nota_credito                = $matriz_nota_credito['cod_factura_nota_credito'] + 1;
	//-------------------------------------------------------------------------------------------------------------------//
	//-------------------------------------------------------------------------------------------------------------------//
	...
	$datos_json .= '			"number": "' .$cod_factura_nota_credito. '", ';
	$datos_json .= '			"issue_date": "' .$fecha_nota_credito. '", ';
	...
	$datos_json .= '				"prefix": "' .$prefijo_nota_credito. '", ';
	...
	while ($datos = mysqli_fetch_assoc($consulta)) {
		...
		//$precio_venta_producto_sin_iva                  = $precio_venta_producto;
...
Sum(total_venta_producto -(total_venta_producto*(descuento_ptj/100))) As total_venta,
