...
<tbody>
<?php
$sql_total_forma_pago = "SELECT tbl15_historial_fecha_mantenimiento.cod_historial_fecha_mantenimiento, tbl15_producto.cod_producto_barra, 
tbl15_producto.nombre_producto, tbl15_historial_fecha_mantenimiento.fecha_compra, tbl15_historial_fecha_mantenimiento.fecha_mantenimiento, 
tbl15_historial_fecha_mantenimiento.vencimiento_lote, tbl15_historial_fecha_mantenimiento.cod_factura, 
tbl15_historial_fecha_mantenimiento.cod_info_factura_compra, tbl15_producto.precio_venta_producto
FROM tbl15_producto RIGHT JOIN tbl15_historial_fecha_mantenimiento ON tbl15_producto.cod_producto_barra = tbl15_historial_fecha_mantenimiento.cod_producto_barra
WHERE (tbl15_historial_fecha_mantenimiento.fecha_mantenimiento BETWEEN '$fecha_ini' AND '$fecha_fin') 
ORDER BY tbl15_historial_fecha_mantenimiento.fecha_mantenimiento ASC";
...
$cod_historial_fecha_mantenimiento      = $datos_total_forma_pago['cod_historial_fecha_mantenimiento'];
...
$fecha_mantenimiento                    = $datos_total_forma_pago['fecha_mantenimiento'];
...
$difrencia_seg                          = strtotime($fecha_mantenimiento) - $fecha_hoy_seg;
...
<?php
$suma_total_venta = 0;
$sql_cliente = "SELECT tbl15_historial_fecha_mantenimiento.cod_historial_fecha_mantenimiento, tbl15_producto.cod_producto_barra, 
tbl15_producto.nombre_producto, tbl15_historial_fecha_mantenimiento.fecha_compra, tbl15_historial_fecha_mantenimiento.fecha_mantenimiento, 
tbl15_historial_fecha_mantenimiento.vencimiento_lote, tbl15_historial_fecha_mantenimiento.cod_factura, tbl15_historial_fecha_mantenimiento.cod_info_factura_compra
FROM tbl15_producto RIGHT JOIN tbl15_historial_fecha_mantenimiento ON tbl15_producto.cod_producto_barra = tbl15_historial_fecha_mantenimiento.cod_producto_barra
WHERE (tbl15_historial_fecha_mantenimiento.fecha_mantenimiento BETWEEN '$fecha_ini' AND '$fecha_fin') 
ORDER BY tbl15_historial_fecha_mantenimiento.fecha_mantenimiento ASC";
...
$cod_historial_fecha_mantenimiento        = $info_cliente['cod_historial_fecha_mantenimiento'];
...
$fecha_mantenimiento                    = $info_cliente['fecha_mantenimiento'];
...
<td style="text-align: right; width:3%; font-family: Courier; font-size:5pt;"><?php echo $fecha_mantenimiento ?></td>
</tr>
<?php } ?>
</table>
</div>
