...
$nombre_archivo                          = time().'_'.$_FILES['archivo_enviado']['name'];
$fecha                                   = date("d/m/Y");
...
$ruta_archivo_excel                      = $ruta_archivador.'1615231598_PRODUCTOS_TODO.xlsx';

//copy($_FILES['archivo_enviado']['tmp_name'], $ruta_archivo_excel);
//$resultado_subida_archivo                = copy($_FILES['archivo_enviado']['tmp_name'], $ruta_archivo_excel);

$resultado_subida_archivo                = 1;

echo $ruta_archivo_excel;

if ($resultado_subida_archivo == 1) {
	$contador                                = 0;
