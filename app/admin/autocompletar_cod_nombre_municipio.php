...
if(isset($_REQUEST['term'])) {
	...
	$cod_departamento            = mysqli_real_escape_string($conectar, ($_REQUEST['cod_departamento']));
	$nombre_tipo_producto        = mysqli_real_escape_string($conectar, ($_REQUEST['nombre_tipo_producto']));

	$sql_id_departamento = "SELECT * FROM tbl15_departamento WHERE (cod_departamento = '$cod_departamento')";
