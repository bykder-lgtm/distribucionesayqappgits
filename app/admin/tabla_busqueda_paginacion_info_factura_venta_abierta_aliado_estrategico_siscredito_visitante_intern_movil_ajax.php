...
?>
        ...
        <div class="card_app_movil_enrollment mb-3 p-3">
            <div class="d-flex flex-row align-items-start mb-3">
                <div class="avatar_app_movil_enrollment me-3"></div>
                <div class="flex-grow-1">
                    <h6 class="mb-1"><strong><?php echo $nombres_apellidos ?></strong></h6>
                    <p class="mb-0 small"><strong>ID:</strong> <?php echo $cod_info_factura_venta ?></p>
                    <p class="mb-0 small"><strong>Crédito #:</strong> <?php echo $cod_factura ?></p>
                    <p class="mb-0 small"><strong>Producto:</strong> <?php echo $nombre_producto ?> - <?php echo $cod_producto_barra ?></p>
                    <span class="estado_credito_app_movil_enrollment mt-2">ESTUDIO</span>
                    <div class="row">
                        <div class="col-12">
                            <button class="btn_estudio_movil_enrollment w-100">Realizar estudio</button>
                        </div>
                    </div>
                </div>
            </div>
