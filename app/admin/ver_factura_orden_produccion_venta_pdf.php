...
$titulo_doc_pdf                    = 'ORDEN_PRODUCCION_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$autor_doc_pdf                     = 'ORDEN_PRODUCCION_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$creador_doc_pdf                   = 'ORDEN_PRODUCCION_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$tema_doc_pdf                      = 'ORDEN_PRODUCCION_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$palabras_claves_doc_pdf           = 'ORDEN_PRODUCCION_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$aaaaaa   = "ORDEN_PRODUCCION";
...
$nombres_completos                 = "ORDEN_PRODUCCION";
...
$sql_motivo_conteo = "SELECT * FROM tbl15_orden_produccion_venta_producto WHERE (cod_info_orden_produccion_factura_venta = '$cod_info_orden_produccion_factura_venta')";
...
$ruta = '../pdfs/';
$nombre_archivo = 'ORDEN_PRODUCCION_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa.'.pdf';
