...
<?php
$suma_temporal = "SELECT Sum(total_compra_producto) As total_compra FROM tbl15_transferencia_producto 
...
$datos_data_info_factura = "SELECT tbl15_info_factura_transferencia.cod_factura, tbl15_info_factura_transferencia.cod_tercero, tbl15_info_factura_transferencia.cod_caja_virtual, tbl15_info_factura_transferencia.nombre_estado_factura, 
tbl15_info_factura_transferencia.nombre_tipo_cargue_factura, tbl15_info_factura_transferencia.nombre_tipo_compra, tbl15_info_factura_transferencia.cod_empresa, tbl15_info_factura_transferencia.nombre_empresa, 
tbl15_info_factura_transferencia.razonsocial_empresa, tbl15_info_factura_transferencia.total_muestra, tbl15_info_factura_transferencia.fecha_ymdhis, tbl15_info_factura_transferencia.cuenta, 
tbl15_info_factura_transferencia.cod_estado_factura, tbl15_info_factura_transferencia.cod_base_caja, tbl15_info_factura_transferencia.descuento_ptj, tbl15_info_factura_transferencia.iva_ptj, 
tbl15_info_factura_transferencia.flete_ptj, tbl15_info_factura_transferencia.subtotal, tbl15_info_factura_transferencia.valor_iva, tbl15_info_factura_transferencia.cod_cliente, 
tbl15_info_factura_transferencia.vlr_cancelado, tbl15_info_factura_transferencia.vlr_vuelto, tbl15_info_factura_transferencia.fecha_dia, tbl15_info_factura_transferencia.fecha_mes, 
tbl15_info_factura_transferencia.fecha_anyo, tbl15_info_factura_transferencia.anyo, tbl15_info_factura_transferencia.fecha_hora, tbl15_info_factura_transferencia.fecha_remision, 
tbl15_info_factura_transferencia.nombre_ccosto, tbl15_info_factura_transferencia.garantia_meses, tbl15_info_factura_transferencia.observacion, tbl15_info_factura_transferencia.cod_tipo_pago, 
tbl15_info_factura_transferencia.cod_administrador, tbl15_info_factura_transferencia.nombre_tipo_producto, tbl15_info_factura_transferencia.total_precio_costo, tbl15_info_factura_transferencia.total_precio_compra, 
tbl15_info_factura_transferencia.total_precio_venta, tbl15_info_factura_transferencia.cod_dependencia, tbl15_info_factura_transferencia.servicio, tbl15_info_factura_transferencia.cod_tipo_forma_pago, 
tbl15_info_factura_transferencia.descripcion_tipo_forma_pago, tbl15_info_factura_transferencia.nombre_tipo_factura, 
tbl15_info_factura_transferencia.nombre_tipo_moneda, tbl15_info_factura_transferencia.cod_cierre_caja, tbl15_info_factura_transferencia.fecha_creacion, tbl15_info_factura_transferencia.fecha_modificacion, 
tbl15_info_factura_transferencia.nombre_maquina, tbl15_info_factura_transferencia.cod_tipo_cobrar, tbl15_info_factura_transferencia.cod_estado_vacuna, tbl15_info_factura_transferencia.cod_resolucion_facturacion, 
tbl15_info_factura_transferencia.total_datos_data, tbl15_info_factura_transferencia.tiempo_ejecucion, tbl15_info_factura_transferencia.ipc_ptj, tbl15_info_factura_transferencia.precio_ipc, 
tbl15_info_factura_transferencia.precio_ipc_total, tbl15_info_factura_transferencia.ret_ica_ptj, tbl15_info_factura_transferencia.total_ret_ica, tbl15_info_factura_transferencia.iva_teorico_ptj, 
tbl15_info_factura_transferencia.total_iva_teorico, tbl15_info_factura_transferencia.tarifa_rete_vigente_ptj, tbl15_info_factura_transferencia.total_tarifa_rete_vigente, 
tbl15_info_factura_transferencia.rete_iva_asumido_ptj, tbl15_info_factura_transferencia.total_rete_iva_asumido, tbl15_info_factura_transferencia.iva_19, tbl15_info_factura_transferencia.iva_5, 
tbl15_info_factura_transferencia.nombre_rete_fuente_ptj, tbl15_info_factura_transferencia.total_compra_imp, tbl15_info_factura_transferencia.total_precio_ipc, tbl15_info_factura_transferencia.total_descuento, 
tbl15_info_factura_transferencia.total_rete_fuente, tbl15_info_factura_transferencia.total_factura_compra_retefuente, tbl15_info_factura_transferencia.total_factura_compra, 
tbl15_info_factura_transferencia.cod_doc_soporte, tbl15_info_factura_transferencia.total_inv_precio_costo, tbl15_info_factura_transferencia.total_inv_precio_compra, 
tbl15_info_factura_transferencia.total_inv_precio_venta, tbl15_info_factura_transferencia.total_compra_precio_costo, tbl15_info_factura_transferencia.total_compra_precio_compra, 
tbl15_info_factura_transferencia.total_compra_precio_venta, tbl15_info_factura_transferencia.total_inv_compra_desp_factura, tbl15_info_factura_transferencia.cod_estado, 
tbl15_info_factura_transferencia.subtotal_total_precio_compra, tbl15_info_factura_transferencia.subtotal_total_precio_costo, 
tbl15_tercero.nombre1_tercero, tbl15_tipo_pago.nombre_tipo_pago, tbl15_tipo_forma_pago.nombre_tipo_forma_pago, 
tbl15_info_factura_transferencia.cod_tipo_inventario, tbl15_info_factura_transferencia.cod_tipo_producto_consumo
FROM tbl15_tipo_pago RIGHT JOIN (tbl15_tipo_forma_pago RIGHT JOIN (tbl15_tercero RIGHT JOIN tbl15_info_factura_transferencia ON tbl15_tercero.cod_tercero = tbl15_info_factura_transferencia.cod_tercero) 
ON tbl15_tipo_forma_pago.cod_tipo_forma_pago = tbl15_info_factura_transferencia.cod_tipo_forma_pago) ON tbl15_tipo_pago.cod_tipo_pago = tbl15_info_factura_transferencia.cod_tipo_pago
WHERE (tbl15_info_factura_transferencia.cod_info_factura_transferencia = '$cod_info_factura_transferencia')";
...
$tab                                     = 'tbl15_info_factura_transferencia';
$tipo                                    = 'eliminar';
$campo                                   = 'cod_info_factura_transferencia';
?>
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            var tipo_ajax = "tbl15_info_factura_transferencia";
            $.post("guardar_info_factura_y_factura_compra_producto_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_factura_transferencia; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  ...
  <tr>
    <th style="text-align:center;"></th>
    <!--<th style="text-align:center;"><a href="../admin/eliminar_compra.php?llave=<?php echo $cod_info_factura_transferencia?>&tab=<?php echo $tab?>&tipo=<?php echo $tipo?>&campo=<?php echo $campo?>"><img src=../imagenes/eliminar_grand.png alt="Eliminar"></a></th>-->
    <th style="text-align:center;"><?php echo $cod_info_factura_transferencia ?></th>
    ...
    <!--<th style="text-align:center;"><a href="../admin/edit_facturacion_compra_iva_inc_producto_manual_pos.php?cod_info_factura_transferencia=<?php echo $cod_info_factura_transferencia?>&tab=<?php echo $tab?>&tipo=<?php echo $tipo?>&campo=<?php echo $campo?>"><img src=../imagenes/editar.png alt="Eliminar"></a></th>-->
    <th style="text-align:center;"></th>
  </tr>
</table>
