...
<a href="#"><h4>Registrar Nuevo Credito&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
</div>
<hr>
<div class="row-fluid">
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="busqueda_ajax" placeholder="Buscar Registro" onkeyup='load(1);'><button type="button" class="btn btn-default" onclick='load(1);'><span class="glyphicon glyphicon-search" ></span> Buscar</button><span id="loader"></span></div>
...
function load(page){
    ...
    var numero_registro_por_pagina = 0;
    var tabla = $("#tabla").val();
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/busqueda_paginacion_siscredito_tercero_crear_nuevo_credito_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&nombre_tipo_tercero='+nombre_tipo_tercero+'&tabla='+tabla,
