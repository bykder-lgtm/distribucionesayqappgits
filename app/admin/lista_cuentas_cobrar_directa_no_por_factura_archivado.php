...
<a href="../admin/lista_cuentas_cobrar_directa_no_por_factura_archivado.php"><h4>Lista Cuentas por Cobrar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<?php if ($cod_estado_cuenta_cobrar_registrar == '1') { ?>
<a href="../admin/reg_cuentas_cobrar_manual_directa_no_por_factura.php">Crear nueva cuenta por cobrar</h4></a>
<?php } ?>
</div>
