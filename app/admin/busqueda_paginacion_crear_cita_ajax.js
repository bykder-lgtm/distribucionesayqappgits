...
function load(page){
	...
	$("#loader").fadeIn('slow');
	$.ajax({
		url:'../admin/busqueda_paginacion_crear_cita_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&buscar_por='+buscar_por,
...
function eliminar (id){
	...
	if (confirm("Realmente deseas eliminar el proyecto?")){	
		$.ajax({
		type: "GET",
		url: "../admin/busqueda_paginacion_crear_cita_ajax.php",
