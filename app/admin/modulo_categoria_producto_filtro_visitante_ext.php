...
if ($cod_categoria == $cod_categoria_get) { ?><a href="../admin/ver_producto_visitante_ext.php?cod_categoria=<?php echo $cod_categoria ?>" class="list-group-item list-group-item-action <?php echo $active ?>"><?php echo $nombre_categoria ?> <small class="text-muted">(<?php echo $total_cat ?>)</small></a>
<?php } else { ?><a href="../admin/ver_producto_visitante_ext.php?cod_categoria=<?php echo $cod_categoria ?>" class="list-group-item list-group-item-action"><?php echo $nombre_categoria ?> <small class="text-muted">(<?php echo $total_cat ?>)</small></a><?php } ?>
