...
$data_sql = ("UPDATE tbl15_factura_compra_producto SET cod_historia_clinica = '$cod_historia_clinica' WHERE cod_info_factura_compra = '$cod_info_factura_compra'");
...
$cod_compra_producto_temporal  = intval($_POST['id']);
...
$data_sql = ("UPDATE tbl15_compra_producto_temporal SET nombre_producto = '$nombre_producto' WHERE cod_compra_producto_temporal = '$cod_compra_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
precio_costo_producto = '$precio_costo_producto', total_costo_producto = '$total_costo_producto' WHERE cod_compra_producto_temporal = '$cod_compra_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$data_sql = ("UPDATE tbl15_compra_producto_temporal SET dto1 = '$dto1', descuento = '$descuento', total_dto = '$total_dto', precio_costo_producto = '$precio_costo_producto', 
...
$data_sql = ("UPDATE tbl15_compra_producto_temporal SET precio_venta_producto = '$precio_venta_producto' WHERE cod_compra_producto_temporal = '$cod_compra_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$datos_info_temporal = "SELECT und_venta FROM tbl15_factura_compra_producto WHERE (cod_factura_compra_producto = '$cod_factura_compra_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_audiometria') && ($tipo_ajax=='tbl15_factura_compra_producto')) {
$und_audiometria              = intval($_POST['valor']);
$cod_factura_compra_producto           = intval($_POST['id']);

$datos_info_temporal = "SELECT precio_venta_producto FROM tbl15_factura_compra_producto WHERE (cod_factura_compra_producto = '$cod_factura_compra_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_factura_compra_producto SET und_audiometria = '$und_audiometria', total_venta_audiometria = '$total_venta_audiometria',  
total_venta_producto = '$total_venta_producto' WHERE cod_factura_compra_producto = '$cod_factura_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_optometria') && ($tipo_ajax=='tbl15_factura_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_factura_compra_producto SET und_optometria = '$und_optometria', total_venta_optometria = '$total_venta_optometria',  
total_venta_producto = '$total_venta_producto' WHERE cod_factura_compra_producto = '$cod_factura_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_electrocardiograma') && ($tipo_ajax=='tbl15_factura_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_factura_compra_producto SET und_electrocardiograma = '$und_electrocardiograma', total_venta_electrocardiograma = '$total_venta_electrocardiograma',  
total_venta_producto = '$total_venta_producto' WHERE cod_factura_compra_producto = '$cod_factura_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
