...
<?php if (isset($_GET['cod_info_factura_compra'])) { 
	...
	$datos_url_ajax                         = '../admin/factura_compra_productos_opcion_imprimir.php'.'?'.'cod_info_factura_compra='.$cod_info_factura_compra.'&'.'pagina='.$pagina;

	$sql_info_factura_compra = "SELECT cod_factura, cod_tercero, cod_resolucion_facturacion FROM tbl15_info_factura_compra WHERE (cod_info_factura_compra = '$cod_info_factura_compra')";
	...
	$cod_factura                            = $matriz_info_factura_compra['cod_factura'];
	$cod_tercero                            = $matriz_info_factura_compra['cod_tercero'];
	$cod_resolucion_facturacion             = $matriz_info_factura_compra['cod_resolucion_facturacion'];
...
?>
	<table class="table table-striped">
		<thead>
			<tr>
				<th style="text-align:center"><img src="../imagenes/ajax-loader.gif"><br>Enviando Dcoumento Soporte <?php echo $prefijo_resolucion_facturacion.$cod_factura; ?></th>
			</tr>
			<tr>
	...
	$(document).ready(function() {
	    ...
	    var pagina_redirect_imprimir = '../admin/factura_compra_productos_opcion_imprimir.php'+'?'+'cod_info_factura_compra='+cod_info_factura_compra+'&cod_tipo_pago='+cod_tipo_pago+'&conexion_internet='+conexion_internet+'&pagina='+pagina

	    var datos_url_ajax = 'id='+cod_info_factura_compra+'&'+'cod_info_factura_compra='+cod_info_factura_compra+'&'+'tab='+tab+'&'+'campo='+campo+'&'+'tipo_ajax='+tipo_ajax+'&'+'pagina='+pagina;

	    $.ajax({
	        type: "GET",
	        url: "../admin/enviar_datos_factura_documento_soporte_dian_json.php",
	        data: datos_url_ajax,
	        //dataType: 'json',
	        beforeSend: function(objeto){
	            //$('#apidian'+cod_info_factura_compra).html('<img src="../imagenes/ajax-loader.gif"> Enviando...');
	        },
	        success:function(respuesta){
	            ...
	            if(respuesta.errors) {
	                ...
	                $.ajax({
	                    type: "POST",
	                    url: "../admin/guardar_factura_documento_soporte_enviada_error_dian_dataico_json_ajax.php",
	                    data: datos_url_ajax,
	                    beforeSend: function(objeto){
	                ...
	                if (dataico_dian_status == 'DIAN_ACEPTADO') {
	                    ...
	                    $.ajax({
	                        type: "POST",
	                        url: "../admin/guardar_factura_documento_soporte_enviada_dian_dataico_json_ajax.php",
	                        data: datos_url_ajax,
	                        beforeSend: function(objeto){
		                        //$('#estadodian'+cod_info_factura_compra).html("");
	                        },
	                        success:function(respuesta){
...
/*
	...
	var url_redirect = '../admin/factura_compra_productos_opcion_imprimir.php'+'?'+'cod_info_factura_compra='+cod_info_factura_compra+'&cod_tipo_pago='+cod_tipo_pago+'&conexion_internet='+conexion_internet+'&tiempo_espera_resp='+tiempo_espera_resp+'&pagina='+pagina;
