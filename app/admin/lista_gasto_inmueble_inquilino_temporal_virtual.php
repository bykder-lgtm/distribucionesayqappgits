    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="shop-cat-box">
                ...
                <a class="btn btn-success" href="../admin/crear_caja_virtual_sesion_gasto_inmueble_inquilino.php?pagina=<?php echo $pagina ?>">CREAR NUEVO GASTO A INQUILINO</a>
            </div>
        </div>
    </div>
</div>
...
<?php if ($cod_estado_eliminar_caja_mesa_virtual=='1') { ?>
<td style="text-align:center;"><a href="../admin/eliminar_caja_virtual_info_gasto_inmueble_inquilino_venta.php?cod_info_gasto_inmueble_inquilino_venta=<?php echo $cod_info_gasto_inmueble_inquilino_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina_local ?>"><img src=../imagenes/eliminar.png alt="eliminar"></td>
<?php } ?>
</tr>
<?php } ?>
</table>
