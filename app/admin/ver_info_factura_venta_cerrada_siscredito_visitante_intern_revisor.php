...
if (isset($_GET['cod_info_factura_venta'])) {
    ...
    $pagina = '../admin/lista_soportes_camara_o_documento_info_factura_venta_siscredito_visitante_intern_revisor.php';
                    ...
                    <div class="contact-form-right">
                        <div class="row title-left">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                                <div class="" style="text-align:center;"><a href="<?php echo $pagina_redirect_regresar ?>"><i class="fa fa-undo fa-2x"></i></a></div>
                            </div>

                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                                <div class="" style="text-align:center;"><h3>Transacción - Cerrada</h3></div>
                            </div>
                            
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                                <div class="" style="text-align:center;"><a href="<?php echo $pagina_redirect_edit_factura ?>"><i class="fa fa-edit fa-2x"></i></a></div>
                            </div>

                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                                <div class="" style="text-align:center;"><a href="<?php echo $pagina_redirect_imprimir_factura ?>"><i class="fa fa-print fa-2x"></i></a></div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group"><strong>Lider</strong>
                                    <br><?php echo $nombres_apellidos_lider ?>
                            ...
                            <div class="col-md-2">
                                <div class="form-group"><strong>Coordinador</strong>
                                    <br><?php echo $nombres_apellidos_coordinador ?>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group"><strong>Asesor</strong>
                                    <br><?php echo $nombres_apellidos_asesor ?>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group"><strong>Aliado</strong>
                                    <br><?php echo $nombres_apellidos_aliado_estrategico ?>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group"><strong>Revisor</strong>
                                    <br><?php echo $nombres_apellidos_revisor ?>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                                            ...
                                            <div class="media mb-2 border-bottom">
                                                <div class="media-body"> <a href="detail.html"> <?php echo $nombre_producto ?></a>
                                                    ...
                                                    <div class="small text-muted">
                                                        <span class="mx-2">
                                                        Imei 1: <input type="text" name="serial1_producto" id="serial1_producto<?php echo $incre;?>" class="<?php echo $cod_venta_producto;?>" value="<?php echo $serial1_producto ?>" disabled>
                                                        Imei 2: <input type="text" name="serial2_producto" id="serial2_producto<?php echo $incre;?>" class="<?php echo $cod_venta_producto;?>" value="<?php echo $serial2_producto ?>" disabled>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
