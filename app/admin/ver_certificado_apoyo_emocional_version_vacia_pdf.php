...
if (isset($_GET['cod_certificado_apoyo_emocional_codifcryp'])) { 
	...
	$nombres_completos                   = "CERTIFICADO DE APOYO EMOCIONAL-".$nombres_cli.'_'.$apellido1_cli.'-'.$nombre_empresa.'-'.$cedula.'-'.$cod_consentimiento_informado;
	/* --------------------------------------------------------------------------------------------------------------------------------- */
	/* --------------------------------------------------------------------------------------------------------------------------------- */
	...
	<br>
	'.$estructura_profesional_certificado_apoyo_emocional_eng.'
	<br>
	...
	$ruta = '../pdfs/';
	$nombre_archivo = 'CERTIFICADO_APOYO_EMOCIONAL.pdf';
