...
<?php
$suma_temporal = "SELECT Sum(total_venta_producto) As total_venta, Sum(total_costo_producto) As total_compra FROM tbl15_transferencia_producto_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_factura_transferencia WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
$consulta_data_info_factura = mysqli_query($conectar, $datos_data_info_factura);
$data_info_factura = mysqli_fetch_assoc($consulta_data_info_factura);
$factura_ocupada = mysqli_num_rows($consulta_data_info_factura);

$cod_info_factura_transferencia      = $data_info_factura['cod_info_factura_transferencia'];
...
$cod_info_factura_strpad             = str_pad($cod_info_factura_transferencia, 6, "0", STR_PAD_LEFT);
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_transferencia_temporal_producto_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_factura_transferencia; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            //let id = this.id;
            $.post("guardar_info_factura_transferencia_temporal_producto_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
...
<form method="post" name="formulario" action="../admin/transferencia_producto_reg.php">
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  ...
  <tr>
    <td style="text-align:center;"></td>
   <td style="text-align:center;"><?php echo $cod_info_factura_transferencia ?></td>
...
<?php 
$sql_temporal = "SELECT cod_transferencia_producto_temporal FROM tbl15_transferencia_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<input type="hidden" name="cod_transferencia_producto_temporal[]" value="<?php echo $datos_temporal['cod_transferencia_producto_temporal']; ?>" size="4">
<?php } ?>

<?php $pagina ='facturacion_transferencia_temporal_producto_manual_pos.php'; ?>
<input type="hidden" name="cod_info_factura_transferencia" value="<?php echo $cod_info_factura_transferencia ?>" size="10">
