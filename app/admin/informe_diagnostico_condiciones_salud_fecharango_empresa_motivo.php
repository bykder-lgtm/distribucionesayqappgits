...
<div class="table-responsive">
<table class="table table-striped" style="font-family:mono;  font-size:<?php echo $tamano_font_informe_emp ?>pt">
<tr><td style="text-align:center"><strong>MOTIVO: <?php echo $nombre_motivo ?></strong></td></tr>
</table>
</div>
...
<?php echo $total_muestra ?> funcionarios, practicando <?php echo $poblacion_eval ?> exámenes médicos ocupacionales 
entre la fecha de <?php echo $fecha_ini_esp ?> a fecha de <?php echo $fecha_fin_esp ?>, con una cobertura del <?php echo round($ptj_cobertura, 2) ?>%. </td></tr>
</table>
</div>
...
$contador ++;
        ...
        if ($contador == 0) { $ptj_edad = ($total_edad_20_00 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = 'Menor 20'; }
        if ($contador == 1) { $ptj_edad = ($total_edad_20_29 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '20 - 29'; }
        if ($contador == 2) { $ptj_edad = ($total_edad_30_39 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '30 - 39'; }
        if ($contador == 3) { $ptj_edad = ($total_edad_40_49 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '40 - 49'; }
        if ($contador == 4) { $ptj_edad = ($total_edad_50_00 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = 'MAYOR 50'; }
...
unset($conteo_vector_edad);
        ...
        if ($posicion_indice == 0) { $ptj_edad = ($total_edad_20_00 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = 'Menor 20'; }
        if ($posicion_indice == 1) { $ptj_edad = ($total_edad_20_29 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '20 - 29'; }
        if ($posicion_indice == 2) { $ptj_edad = ($total_edad_30_39 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '30 - 39'; }
        if ($posicion_indice == 3) { $ptj_edad = ($total_edad_40_49 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '40 - 49'; }
        if ($posicion_indice == 4) { $ptj_edad = ($total_edad_50_00 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = 'MAYOR 50'; }
?>
<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<br><br>
<tr><td style="text-align:left">Un <?php echo round($ptj_edad_final, 2) ?> % de las personas evaluadas se encuentran en el rango de <?php echo $nombre_posicion_vector_etaric ?> años</td></tr>
</table>
...
for($i=0; $i<count($vector_edad); $i++) {
  ...
  if ($posicion_vector == 0) { $ptj_edad = ($total_edad_20_00 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = 'Menor 20'; }
  if ($posicion_vector == 1) { $ptj_edad = ($total_edad_20_29 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '20 - 29'; }
  if ($posicion_vector == 2) { $ptj_edad = ($total_edad_30_39 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '30 - 39'; }
  if ($posicion_vector == 3) { $ptj_edad = ($total_edad_40_49 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = '40 - 49'; }
  if ($posicion_vector == 4) { $ptj_edad = ($total_edad_50_00 / $total_poblacion) * 100; $nombre_posicion_vector_etaric = 'MAYOR 50'; }
?>
<tr>
<td><?php echo $nombre_posicion_vector_etaric ?></td>
...
<br><br>
<tr><td style="text-align:left">El porcentaje predominante corresponde a los Trabajadores <?php echo $nombre_posicion_vector_antig ?> de antigüedad en la Empresa.</td></tr>
</table>
</div>
...
<tr><td style="text-align:left">Para un total de <?php echo round($sobreso_ptj + $obesidad_total, 2) ?>%  de problemas de sobrepeso y obesidad.</td></tr>
...
GROUP BY tbl15_cie10diag.cie10_diag ORDER BY conteo_cie10_cod DESC";
$result1 = mysqli_query($conectar, $query1);
while ($dato01 = mysqli_fetch_assoc($result1)) { 
$contador++;
...
var chartdiv13 = AmCharts.makeChart( "chartdiv13", {
  ...
  "type": "serial",
    ...
    dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_diagnostico_cie10_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&total_muestra=<?php echo $total_muestra ?>&total_motivo=<?php echo $total_motivo ?>&<?php echo $url_motivos ?>" },
