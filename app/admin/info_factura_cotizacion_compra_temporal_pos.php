...
<?php
$suma_temporal = "SELECT Sum(total_compra_producto) As total_compra FROM tbl15_cotizacion_compra_producto_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_cotizacion_factura_compra WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_cotizacion_compra_producto_temporal";
...
<form method="post" name="formulario" action="../admin/cotizacion_compra_producto_reg.php">
...
<?php 
$sql_temporal = "SELECT cod_cotizacion_compra_producto_temporal FROM tbl15_cotizacion_compra_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<input type="hidden" name="cod_cotizacion_compra_producto_temporal[]" value="<?php echo $datos_temporal['cod_cotizacion_compra_producto_temporal']; ?>" size="4">
<?php } ?>
