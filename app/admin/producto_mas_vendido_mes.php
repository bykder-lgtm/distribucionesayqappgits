...
<a class="btn btn-danger" href="../admin/producto_mas_vendido_mes.php">MAS VENDIDOS DEL MES (<?php echo $fecha_mes_venta_producto?>)<a/> -
<a class="btn btn-success" href="../admin/producto_mas_vendido_mes_anterior.php">MAS VENDIDOS MES ANTERIOR (<?php echo $fecha_mes_venta_producto_anterior?>)<a/> - 
...
<table class="table table-striped">
  <thead>
    <tr>
      <th style="text-align:center"><a href="../admin/descargar_productos_mas_vendidos_csv.php?fecha_mes_venta_producto=<?php echo $fecha_mes_venta_producto?>">DESCARGAR ARCHIVO PRODUCTOS MAS VENDIDOS MES<img src=../imagenes/descargar.png alt="descargar"></a></th>
    </tr>
  </thead>
</table>
