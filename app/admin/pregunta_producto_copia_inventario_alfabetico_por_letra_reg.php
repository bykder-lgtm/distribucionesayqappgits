...
$nombre_tipo_inventario             = "POR_LETRA";
//*************************************************************************************************************************//
if (isset($_POST['nombre_letra_alfabeto'])) {

$nombre_letra_alfabeto              = addslashes($_POST['nombre_letra_alfabeto']);
$nombre_letra_alfabeto_minuscula    = strtolower($nombre_letra_alfabeto);
$nombre_letra_alfabeto_mayuscula    = strtoupper($nombre_letra_alfabeto);
...
FROM tbl15_producto WHERE nombre_producto regexp '^$nombre_letra_alfabeto'";
...
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; producto_copia_inventario_viejo.php?cod_info_producto_copia_inventario=<?php echo $cod_info_producto_copia_inventario ?>">
<?php } else { ?>
