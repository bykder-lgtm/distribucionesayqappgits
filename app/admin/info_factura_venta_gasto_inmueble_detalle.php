...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_y_gasto_inmueble_detalle_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_gasto_inmueble_detalle_venta; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
        ...
        $.ajax({
            type: "POST",
            url: "../admin/guardar_info_factura_y_gasto_inmueble_detalle_temporal_ajax.php",
            data: datos_url_ajax,
            //dataType: 'json',
...
$(document).ready(function(){
    $("#descripcion_tipo_forma_pago").on('change', function () {
            ...
            var tipo_ajax = "tbl15_info_gasto_inmueble_detalle_venta";
            var id = $(this).attr("class");
            $.post("guardar_info_factura_y_gasto_inmueble_detalle_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
-->
       ...
       <th style="text-align:center; font-size:40px;"><div id="total_gasto_ganancia"><?php echo number_format($total_gasto_ganancia, 0, ",", ".") ?></div></th>
        ...
        <td style="text-align: center;"><a href="../admin/comprobante_gasto_propietario_inmueble_detalle_temporal_imprimir_pdf.php?cod_info_gasto_inmueble_detalle_venta=<?php echo $cod_info_gasto_inmueble_detalle_venta;?>&cuenta=<?php echo $cuenta;?>&cod_caja_virtual=<?php echo $cod_caja_virtual;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>
