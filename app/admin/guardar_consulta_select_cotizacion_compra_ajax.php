...
$sql_data = "UPDATE tbl15_info_cotizacion_factura_compra SET cod_tercero = '$cod_tercero' WHERE (cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra')";
