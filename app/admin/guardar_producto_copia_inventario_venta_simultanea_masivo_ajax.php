...
if (($tipo_ajax=='tbl15_producto_copia_inventario') && ($campo=='und_producto_nuevo')) {
	...
	$und_producto_nuevo                     = addslashes($_REQUEST['valor']);
	$cod_estado                             = 1;

	$data_sql = ("UPDATE tbl15_producto_copia_inventario SET und_producto_nuevo = '$und_producto_nuevo', cod_estado = '$cod_estado', fecha_actualizacion = '$fecha_actualizacion' WHERE cod_producto_copia_inventario = '$cod_producto_copia_inventario'");
