...
<div class="breadcrumbs"><a href="#"><h4>Eliminando Ventas</h4></a></div>
<hr>
<div class="row-fluid">
...
if (isset($_POST['anyo'])) {
	...
	$sql_datos = "SELECT * FROM tbl15_venta_producto WHERE (fecha_anyo_venta_producto = '$anyo')";
	...
	$sql_datos = "SELECT * FROM tbl15_info_factura_venta WHERE (anyo = '$anyo')";
	$resultado_datos = mysqli_query($conectar, $sql_datos);
	while ($info_datos = mysqli_fetch_assoc($resultado_datos)) {
		...
		$borrar_sql = sprintf("DELETE FROM tbl15_info_factura_venta WHERE (anyo = '$anyo')");
		$Result1 = mysqli_query($conectar, $borrar_sql) or die(mysqli_error($conectar));
