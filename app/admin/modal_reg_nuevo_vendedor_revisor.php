    <div class="modal fade abrir_previsualizacion_datos_nuevo_vendedor" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">

                <div class="modal-header">
                    <h4 class="modal-title" id=""><i class="fa fa-user-plus"></i> Registrar Nuevo Vendedor</h4><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span></button>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">Documento *
                                                <input type="number" class="form-control" id="mod_<?php echo 'cedula' ?>" name="cedula" placeholder="" data-error="" required/>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">Nombres *
                                                <input type="text" class="form-control" id="mod_<?php echo 'nombres' ?>" name="nombres" placeholder="" data-error="" required/>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">Apellidos *
                                                <input type="text" class="form-control" id="mod_<?php echo 'apellidos' ?>" name="apellidos" placeholder="" data-error="" required/>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button class="btn hvr-hover btn-lg btn-block" id="btn_guardar_registro_nuevo_vendedor_modal" type="submit">Registrar Informacion</button>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
...
<script>
$("#btn_guardar_registro_nuevo_vendedor_modal").click(function(){
    ...
    var cedula = document.getElementById('mod_'+'cedula').value;
    var nombres = document.getElementById('mod_'+'nombres').value;
    var apellidos = document.getElementById('mod_'+'apellidos').value;
    ...
    var datos_url_ajax = "cod_info_factura_venta="+cod_info_factura_venta+"&cod_tercero="+cod_tercero+"&cedula="+cedula+"&nombres="+nombres+"&apellidos="+apellidos;

    $.ajax({
        type: "POST",
        url: "../admin/reg_modal_nuevo_vendedor_factura_venta_ajax_reg.php",
        data: datos_url_ajax,
        //dataType: 'json',
