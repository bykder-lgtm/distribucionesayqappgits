...
$datos_info = "SELECT * FROM tbl15_info_factura_transferencia WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$sql_info_factura = "SELECT cod_info_factura_transferencia, cod_tercero FROM tbl15_info_factura_transferencia WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_info_factura_transferencia     = $datos_info_factura['cod_info_factura_transferencia'];
