...
<br>
<form name="frmSubir" method="post" enctype="multipart/form-data" action="edit_cargar_foto_cliente_reg.php">
<p><input type="file" name="url_img_foto" id="url_img_foto" multiple accept="image/*" style="display:none" onchange="handleFiles(this.files)" required="required"/></p>
...
var archivo_selecionado = document.getElementById("archivo_selecionado"),
    url_img_foto = document.getElementById("url_img_foto"),
