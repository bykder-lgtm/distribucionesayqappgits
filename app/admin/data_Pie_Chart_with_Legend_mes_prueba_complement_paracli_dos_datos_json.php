...
$query1 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_audimet) AS conteo_paracli_audimet, paracli_audimet FROM tbl15_historia_clinica
...
$query2 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_visiomet) AS conteo_paracli_visiomet, paracli_visiomet FROM tbl15_historia_clinica
...
$query3 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_torax) AS conteo_paracli_torax, paracli_torax FROM tbl15_historia_clinica
...
$query4 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_espiro) AS conteo_paracli_espiro, paracli_espiro FROM tbl15_historia_clinica
...
$query5 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_ekg) AS conteo_paracli_ekg, paracli_ekg FROM tbl15_historia_clinica
...
$query6 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_rxcolum) AS conteo_paracli_rxcolum, paracli_rxcolum FROM tbl15_historia_clinica
...
$query7 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_otrcomplement) AS conteo_paracli_otrcomplement, paracli_otrcomplement FROM tbl15_historia_clinica
...
$query8 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_fisiote) AS conteo_paracli_fisiote, paracli_fisiote FROM tbl15_historia_clinica
...
$query9 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_lab) AS conteo_paracli_lab, paracli_lab FROM tbl15_historia_clinica
...
$query10 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_otro) AS conteo_paracli_otro, paracli_otro FROM tbl15_historia_clinica
...
$query11 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_audimet) AS conteo_paracli_audimet, paracli_audimet FROM tbl15_historia_clinica
GROUP BY paracli_audimet, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query12 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_visiomet) AS conteo_paracli_visiomet, paracli_visiomet FROM tbl15_historia_clinica
GROUP BY paracli_visiomet, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query13 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_torax) AS conteo_paracli_torax, paracli_torax FROM tbl15_historia_clinica
GROUP BY paracli_torax, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query14 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_espiro) AS conteo_paracli_espiro, paracli_espiro FROM tbl15_historia_clinica
GROUP BY paracli_espiro, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query15 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_ekg) AS conteo_paracli_ekg, paracli_ekg FROM tbl15_historia_clinica
GROUP BY paracli_ekg, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query16 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_rxcolum) AS conteo_paracli_rxcolum, paracli_rxcolum FROM tbl15_historia_clinica
GROUP BY paracli_rxcolum, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query17 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_otrcomplement) AS conteo_paracli_otrcomplement, paracli_otrcomplement FROM tbl15_historia_clinica
GROUP BY paracli_otrcomplement, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query18 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_fisiote) AS conteo_paracli_fisiote, paracli_fisiote FROM tbl15_historia_clinica
GROUP BY paracli_fisiote, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query19 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_lab) AS conteo_paracli_lab, paracli_lab FROM tbl15_historia_clinica
GROUP BY paracli_lab, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
...
$query20 = "SELECT $tipo_fecha, cod_estado_facturacion, nombre_empresa, Count(paracli_otro) AS conteo_paracli_otro, paracli_otro FROM tbl15_historia_clinica
GROUP BY paracli_otro, $tipo_fecha, cod_estado_facturacion, nombre_empresa 
