...
$pagina                       = addslashes($_GET['pagina'])."?&foco=".$foco."&buscar_por=".$buscar_por."&cod_producto_barra_madre=".$cod_producto_barra_madre."&pagina=facturacion_subproducto_producto_manual_pos.php";
...
$sql_data = "INSERT INTO tbl15_subproducto (cod_producto_barra_madre, cod_tercero, cod_producto, cod_producto_barra, 
nombre_producto, und_producto, nombre_tipo_producto, nombre_tipo_unidad_medida, fecha_creacion) 
VALUES ('$cod_producto_barra_madre', '$cod_tercero', '$cod_producto', '$cod_producto_barra', 
'$nombre_producto', '$und_producto', '$nombre_tipo_producto', '$nombre_tipo_unidad_medida', '$fecha_creacion')";
