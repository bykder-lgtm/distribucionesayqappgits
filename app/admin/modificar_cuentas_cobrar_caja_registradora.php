...
<style>body { background-color:#333; }</style>
      ...
      <table class="table table-striped">
        <tr>
          <td style="text-align:center;"><a href="../admin/cuentas_cobrar_detalle_factura_caja_registradora.php?cod_tercero=<?php echo $cod_tercero?>" class="btn btn-warning">Regresar</a></td>
        </tr>
      </table>
    ...
    $('#btn_numero_cero').on('click', function () {
        ...
        $.post("guardar_abono_cuenta_cobrar_caja_registradora_numeros_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, opcion:opcion, cod_cuentas_cobrar:cod_cuentas_cobrar }, function(data){
    ...
    $('#btn_guardar').on('click', function () {
        ...
        $.ajax({
          type: "POST",
          url: "../admin/modificar_cuentas_cobrar_caja_registradora_ajax.php",
          data: parametros,
          dataType: "json",
          //contentType: false,
          //processData: false,
