...
<tr>
<td style="text-align:center"><strong><a href="../admin/cuentas_cobrar_detalle_factura_caja_registradora.php?cod_tercero=<?php echo $cod_tercero;?>&cliente=<?php echo $cliente;?>"><font size="5px">REGRESAR</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
...
<form method="post" name="formulario_de_actualizacion" action="reg_abono_cuentas_cobrar_por_tercero_reg.php">
<table class="table table-striped">
<tr>
...
<tr>
<tr>
<td style="text-align:center"><input style="font-size:24px" type="number" name="abonado" value="" size="10" max="<?php echo $total_subtotal_cuenta_cobrar; ?>" required></td>
