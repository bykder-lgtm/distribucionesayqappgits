<section id="main-slider_css_slider" class="no-margin_css_slider">
    <div class="carousel slide">
        ...
        $contador1 = 0;
        $aumentar = -1;
        $sql_info_portafolio = "SELECT cod_producto, nombre_producto, descripcion_producto, url_img_orig_producto, url_img_min_producto, active_producto, cod_estado_promocion 
        FROM tbl15_producto WHERE (cod_estado_promocion = '1') ORDER BY posicion_promocion ASC";
