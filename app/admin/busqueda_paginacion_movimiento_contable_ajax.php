...
$pagina                   = $concatenador."lista_movimiento_contable.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
if($busqueda_ajax <> NULL) {
	...
	} elseif ($buscar_por == 'descripcion_movimiento') {
		$busq_aprox_izq = '%';
		$busq_aprox_der = '%';
     	$aColumns = array('tbl15_movimiento_contable.descripcion_movimiento'); //Columnas de busqueda
	} else {
		$busq_aprox_izq = '%';
		$busq_aprox_der = '%';
     	$aColumns = array('cod_producto_barra', 'nombre_producto'); //Columnas de busqueda
...
// escaping, additionally removing everything that could be (html/javascript-) code
     $sTable = "tbl15_movimiento_contable INNER JOIN tbl15_tercero ON tbl15_movimiento_contable.cod_tercero = tbl15_tercero.cod_tercero WHERE (tbl15_movimiento_contable.nombre_estado_factura = 'CERRADA') ";
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" ORDER BY tbl15_movimiento_contable.fecha_seg DESC";
} else {
    $sWhere.=" ORDER BY tbl15_movimiento_contable.fecha_seg DESC";
}
...
<thead>
	<tr class="headings">
		...
		<th style="text-align:center">NIT TERCERO</th>
		<th style="text-align:center">NOMBRE TERCERO</th>
		<th style="text-align:center">VALOR MOVIMIENTO</th>
		<th style="text-align:center">DESCRIPCION DEL MOVIMIENTO</th>
...
while ($datos_consulta = mysqli_fetch_array($query_consulta)) {
	...
	$doc_modifica                       = $datos_consulta['doc_modifica'];
	$nombre_tipo_documento              = $datos_consulta['nombre_tipo_documento'];
	$descripcion_movimiento             = $datos_consulta['descripcion_movimiento'];
	$total_costo_movimiento_contable    = $datos_consulta['total_costo_movimiento_contable'];
	$total_venta_movimiento_contable    = $datos_consulta['total_venta_movimiento_contable'];
	$cod_clientes                       = $datos_consulta['cod_clientes'];
	$nombres_clientes                   = $datos_consulta['nombres_clientes'];
	$nit_cliente                        = $datos_consulta['nit_cliente'];
	$digito                             = $datos_consulta['digito'];
	$estado_devol                       = $datos_consulta['estado_devol'];
	$motivo_devol                       = $datos_consulta['motivo_devol'];
	$direccion                          = $datos_consulta['direccion'];
	$no_cuenta                          = $datos_consulta['no_cuenta'];
	$elaborada                          = $datos_consulta['elaborada'];
	$revisada                           = $datos_consulta['revisada'];
	$autorizada                         = $datos_consulta['autorizada'];
	$contabilizada                      = $datos_consulta['contabilizada'];
	$motivo_modificacion                = $datos_consulta['motivo_modificacion'];
	$fecha_anyo                         = $datos_consulta['fecha_anyo'];
	$fecha_ymd                          = $datos_consulta['fecha_ymd'];
	$fecha_mes                          = $datos_consulta['fecha_mes'];
	$anyo                               = $datos_consulta['anyo'];
	$fecha_factura                      = $datos_consulta['fecha_factura'];
	$ip                                 = $datos_consulta['ip'];
	$cuenta                             = $datos_consulta['cuenta'];
	$cod_guia                           = $datos_consulta['cod_guia'];
...
?>
	<tr class="even pointer" id="<?php echo $cod_movimiento_contable;?>">
		...
		<td style="text-align:center"><a href="../admin/ver_movimiento_contable_pdf.php?cod_movimiento_contable=<?php echo $cod_movimiento_contable?>" target="_blank"><img src=../imagenes/imprimir_peq.png alt="imprimir"></a></td>
		<td style="text-align:center"><a href="../admin/edit_movimiento_contable.php?cod_movimiento_contable=<?php echo $cod_movimiento_contable?>"><img src=../imagenes/editar.png alt="actualizar"></a></td>
	...
	</tr id="<?php echo $cod_movimiento_contable;?>">
<?php } //end while ?>
</table>
