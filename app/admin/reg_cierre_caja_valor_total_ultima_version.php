...
//-----------------------------------------------------------------------------------------------------------------//
$sql_venta_total_contado_efectivo = "SELECT SUM(total_venta_producto) AS total_venta_sistema_contado_efectivo_cierre_caja FROM tbl15_venta_producto 
...
$total_venta_sistema_contado_efectivo_cierre_caja    = $info_venta_total_contado_efectivo['total_venta_sistema_contado_efectivo_cierre_caja'];
//-----------------------------------------------------------------------------------------------------------------//
$sql_cuentas_cobrar_abonos_efectivo = "SELECT SUM(abonado) AS total_abono_efectivo_cuenta_cobrar_cierre_caja FROM tbl15_cuentas_cobrar_abonos 
WHERE (fecha_anyo = '$fecha_ymd_venta_producto') AND (cod_administrador = '$cod_administrador') AND (cod_tipo_forma_pago = '$cod_tipo_forma_pago')";
...
$total_abono_efectivo_cuenta_cobrar_cierre_caja    = $info_cuentas_cobrar_abonos_efectivo['total_abono_efectivo_cuenta_cobrar_cierre_caja'];
//-----------------------------------------------------------------------------------------------------------------//
$total_sistema_contado_efectivo_cierre_caja    = $total_venta_sistema_contado_efectivo_cierre_caja + $total_abono_efectivo_cuenta_cobrar_cierre_caja;
//-----------------------------------------------------------------------------------------------------------------//
...
<table border="1" class="table table-responsive">
	<thead>
		...
		<tr>
			<td style="text-align:center"><strong>Nota:</strong> No contar la base. Se debe sacar la base y solo contar el efectivo de las ventas y los abonos de las cuentas por cobrar</td>
    	</tr>
	</thead>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<table border="1" class="table table-responsive">
	<thead>
		...
		<?php if ($cod_seguridad == '1') { ?>
		<tr>
			<th style="text-align:right; font-size: 20px">TOTAL ABONOS EN EFECTIVO (SISTEMA):</th>
			<td style="text-align:right; font-size: 30px" id="total_abono_efectivo_cuenta_cobrar_cierre_caja"><?php echo number_format($total_abono_efectivo_cuenta_cobrar_cierre_caja, 0, ",", ".") ?></td>
    		<input type="hidden" name="total_abono_efectivo_cuenta_cobrar_cierre_caja" id="total_abono_efectivo_cuenta_cobrar_cierre_caja_hidden" value="<?php echo $total_abono_efectivo_cuenta_cobrar_cierre_caja ?>">
		</tr>
		<?php } else { ?>
		<input type="hidden" name="total_abono_efectivo_cuenta_cobrar_cierre_caja" id="total_abono_efectivo_cuenta_cobrar_cierre_caja_hidden" value="<?php echo $total_abono_efectivo_cuenta_cobrar_cierre_caja ?>">
		<?php } ?>
		...
		<?php if ($cod_seguridad == '1') { ?>
		<tr>
			<th style="text-align:right; font-size: 20px">TOTAL VENTA EN EFECTIVO + ABONOS EN EFECTIVO (SISTEMA):</th>
		...
		<tr>
			<th style="text-align:right; font-size: 20px">CONTEO CAJA EN EFECTIVO + ABONOS + BASE:</th>
		...
		<tr>
			<th style="text-align:right; font-size: 20px" title="No contar la base. Se debe sacar la base y solo contar el efectivo de las ventas y los abonos de las cuentas por cobrar">TOTAL CONTEO CAJA EN EFECTIVO:</th>
...
$(document).ready(function(){
    $("#cod_administrador").on('change', function () {
            ...
            var datos_enviar = 'cod_administrador='+cod_administrador+'&fecha_ymd_venta_producto='+fecha_ymd_venta_producto+'&campo='+campo+'&tipo_ajax='+tipo_ajax;
	   		...
	   		$.ajax({
	            type: "POST",
	            url: "../admin/calcular_venta_cierre_caja_ultima_version_ajax.php",
	            ...
	            success: function(respuesta){
	          		...
	          		var total_abono_efectivo_cuenta_cobrar_cierre_caja = respuesta.total_abono_efectivo_cuenta_cobrar_cierre_caja;
	                ...
	                $("#total_abono_efectivo_cuenta_cobrar_cierre_caja").html(total_abono_efectivo_cuenta_cobrar_cierre_caja.toLocaleString("es-ES"));
	                ...
	                $("#total_abono_efectivo_cuenta_cobrar_cierre_caja_hidden").val(total_abono_efectivo_cuenta_cobrar_cierre_caja);
	            }
	   		});
    });
});
