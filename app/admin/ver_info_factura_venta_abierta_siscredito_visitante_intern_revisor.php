                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div class="contact-form-right">
                        <div class="row title-left">
                            ...
                            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                <div class="" style="text-align:center;"><h3>Transacción - Abierta</h3></div>
                            </div>
                                            ...
                                            <div class="media mb-2 border-bottom">
                                                <div class="media-body"> <a href="detail.html"> <?php echo $nombre_producto ?></a>
                                                    ...
                                                    <div class="small text-muted">
                                                        <span class="mx-2">
                                                        Imei 1: <input type="text" name="serial1_producto" id="serial1_producto<?php echo $incre;?>" class="<?php echo $cod_venta_producto_temporal;?>" value="<?php echo $serial1_producto ?>" disabled>
                                                        Imei 2: <input type="text" name="serial2_producto" id="serial2_producto<?php echo $incre;?>" class="<?php echo $cod_venta_producto_temporal;?>" value="<?php echo $serial2_producto ?>" disabled>
                                                        </span>
                                                    </div>
                                                    <?php } ?>
                                                </div>
