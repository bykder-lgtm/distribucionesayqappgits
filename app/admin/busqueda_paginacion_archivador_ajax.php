...
$pagina                   = $concatenador."lista_archivador.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
<tr class="even pointer">
	<td style="text-align:center"><a href="../admin/ver_historial_archivo_adjunto.php?cod_archivador=<?php echo $cod_archivador?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/proceso.png" class="img-polaroid" alt=""></a></td>
