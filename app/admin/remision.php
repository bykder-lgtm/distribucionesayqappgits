...
<a href="../admin/tbl15_remision.php"><h4>Remisiones&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control" id="buscar_por" onchange='load(1);'>
                ...
                <option value="cod_historia_clinica">Codigo historia clinica</option>
                <option value="cod_remision">Codigo Remision</option>
            </select>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_remision_ajax.js"></script>
</body>
</html>