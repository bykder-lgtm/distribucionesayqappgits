...
$tabla              = 'tbl15_trabajo_altura';
$pagina             = '../admin/lista_reasigancion_tareas_trabajo_alturas.php';
?>
...
<div class="breadcrumbs">
<a href="../admin/lista_aptos_trabajo_alturas.php?pagina=<?php echo $pagina ?>"><h4>Aptos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_no_cumple_trabajo_alturas.php?pagina=<?php echo $pagina ?>">No Cumple&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_reasigancion_tareas_trabajo_alturas.php?pagina=<?php echo $pagina ?>">Reasignacion de tareas</h4></a>
</div>
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control" id="buscar_por" onchange='load(1);'>
                ...
                <option value="cod_trabajo_altura">Codigo Altura</option>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_reasigancion_tareas_trabajo_alturas_ajax.js"></script>
</body>
</html>