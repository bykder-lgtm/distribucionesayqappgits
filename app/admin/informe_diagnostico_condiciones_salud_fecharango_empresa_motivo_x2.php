...
$motivo2_limpia                      = str_replace(' ', '_', $motivo2);
?>
<!DOCTYPE HTML>
<head>
<meta charset="utf-8">
<title><?php echo $nombre_empresa_limpia.'__'.$motivo.'__'.$motivo2.'__'.$fecha_ini_ymd.'__'.$fecha_fin_ymd;?></title>
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2'))) GROUP BY cod_estado_facturacion";
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND ((cod_estado_facturacion)=2) AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2'))) GROUP BY cod_estado_facturacion";
...
GROUP BY dat_ocupa_carg1, nombre_empresa, motivo";
$result1 = mysqli_query($conectar, $query1);
...
FROM tbl15_historia_clinica
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1))
GROUP BY nombre_empresa, motivo";
$result2 = mysqli_query($conectar, $query2);
$datos2 = mysqli_fetch_assoc($result2);
?>
<div class="table-responsive">
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_personevaluada_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
WHERE ((tbl15_historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (tbl15_historia_clinica.nombre_empresa='$nombre_empresa') AND (tbl15_historia_clinica.motivo='$motivo') AND (tbl15_historia_clinica.cod_estado_facturacion=1) AND ((tbl15_cliente.nombre_sexo)='M'))
...
FROM tbl15_cliente RIGHT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente 
WHERE ((tbl15_historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (tbl15_historia_clinica.nombre_empresa='$nombre_empresa') AND (tbl15_historia_clinica.motivo='$motivo') AND (tbl15_historia_clinica.cod_estado_facturacion=1) AND ((tbl15_cliente.nombre_sexo)='F'))
GROUP BY tbl15_cliente.nombre_sexo";
$result2 = mysqli_query($conectar, $query2);
$datos2 = mysqli_fetch_assoc($result2);
...
<tr><td style="text-align:left"><br><br>Se encontró predominio del tbl15_sexo <?php echo $sexo_txt ?> con el <?php echo round($porcentaje_sexo, 2) ?>%.</td></tr>
</table>
</div>
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_sexo_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
FROM tbl15_cliente RIGHT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente
HAVING ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (tbl15_historia_clinica.nombre_empresa='$nombre_empresa') AND (tbl15_historia_clinica.motivo='$motivo') AND (tbl15_historia_clinica.cod_estado_facturacion=1))";
$result1 = mysqli_query($conectar, $query1);
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_edad_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
<?php echo $pos1_nombre_escolaridad ?> con un <?php echo round($pos1_ptj_escolaridad, 2) ?>%; 
en segundo lugar está <?php echo $pos2_nombre_escolaridad ?>, con <?php echo round($pos2_ptj_escolaridad, 2) ?>%; 
en tercer lugar <?php echo $pos3_nombre_escolaridad ?>, con <?php echo round($pos3_ptj_escolaridad, 2) ?>%.</td></tr>
</table>
</div>
...
var chartdiv04 = AmCharts.makeChart("chartdiv04", {
    ...
    dataLoader: { "url": "data_3D_Column_Chart_fecharango_empresa_motivo_x2_escolaridad_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
FROM tbl15_historia_clinica
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1)) 
GROUP BY dat_ocupa_carg1, nombre_empresa, motivo ORDER BY conteo_dat_ocupa_carg1 DESC";
$result2 = mysqli_query($conectar, $query2);
...
var chartdiv05 = AmCharts.makeChart("chartdiv05", {
    ...
    dataLoader: { "url": "data_3D_Column_Chart_fecharango_empresa_motivo_x2_cargo_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_distribucion_edad_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
dataLoader: { "url": "data_Simple_Column_Chart_fecharango_empresa_motivo_x2_peligros.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
<br><br>
<tr><td style="text-align:left">El <?php echo round($fuma_ptj, 2) ?>% de las personas evaluadas refirió fumar, 
un  <?php echo round($exfum_ptj, 2) ?>% ser exfumadores y 
un <?php echo round($nofum_ptj, 2) ?> % refirió no ser fumador.</td></tr>
</table>
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_habito_extra_lab_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_actividad_fisica_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='BAJO PESO'))
GROUP BY exa_fis_interpreimc, nombre_empresa, motivo";
$result1 = mysqli_query($conectar, $query1);
$dato01 = mysqli_fetch_assoc($result1);

$query2 = "SELECT fecha_ymd, cod_estado_facturacion, Count(exa_fis_interpreimc) AS exa_fis_interpreimc, nombre_empresa, motivo
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='PESO NORMAL'))
GROUP BY exa_fis_interpreimc, nombre_empresa, motivo";
$result2 = mysqli_query($conectar, $query2);
$dato02 = mysqli_fetch_assoc($result2);
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='SOBREPESO'))
GROUP BY exa_fis_interpreimc, nombre_empresa, motivo";
$result3 = mysqli_query($conectar, $query3);
$dato03 = mysqli_fetch_assoc($result3);
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD I'))
GROUP BY exa_fis_interpreimc, nombre_empresa, motivo";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD II'))
GROUP BY exa_fis_interpreimc, nombre_empresa, motivo";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD III'))
GROUP BY exa_fis_interpreimc, nombre_empresa, motivo";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD EXTREMA'))
GROUP BY exa_fis_interpreimc, nombre_empresa, motivo";
...
<br><br>
<tr><td style="text-align:left">El <?php echo round($sobreso_ptj, 2) ?>% de la población presenta sobrepeso y el <?php echo round($obesidad_total, 2) ?>% obesidad.</td></tr>
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_imc_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_enfermedad_laboral_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND ((ant_impor_accilab)='SI'))
GROUP BY ant_impor_accilab, nombre_empresa, motivo";
$result1 = mysqli_query($conectar, $query1);
$dato01 = mysqli_fetch_assoc($result1);

$query2 = "SELECT fecha_ymd, cod_estado_facturacion, Count(ant_impor_accilab) AS ant_impor_accilab, nombre_empresa, motivo
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1) AND ((ant_impor_accilab)='NO'))
GROUP BY ant_impor_accilab, nombre_empresa, motivo";
$result2 = mysqli_query($conectar, $query2);
$dato02 = mysqli_fetch_assoc($result2);
...
dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_accidente_laboral_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
...
WHERE ((tbl15_historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (tbl15_historia_clinica.nombre_empresa='$nombre_empresa') AND (tbl15_historia_clinica.motivo='$motivo') AND (tbl15_historia_clinica.cod_estado_facturacion=1)) 
GROUP BY tbl15_historia_clinica.nombre_empresa, tbl15_cie10diag.cie10_diag, tbl15_historia_clinica.motivo ORDER BY conteo_cie10_cod DESC";
$result1 = mysqli_query($conectar, $query1);
?>
...
<br><br>
<tr><td style="text-align:left">Los diagnósticos de mayor incidencia encontradas en los Trabajadores evaluados en el <?php echo $nombre_empresa ?>, se presentan a continuación:<br></td></tr>
</table>
</div>
...
?>
<tr>
    <td style="text-align:left"><?php echo $contador ?>. <?php echo $nombre_cie10_diag ?>, personas afectadas, equivalentes al <?php echo round($conteo_cie10_cod_ptj, 2) ?>% de la Población.<br></td>
</tr>
<?php
}
?>
...
var chartdiv13 = AmCharts.makeChart( "chartdiv13", {
  ...
  "type": "serial",
    ...
    dataLoader: { "url": "data_Pie_Chart_with_Legend_fecharango_empresa_motivo_x2_diagnostico_cie10_json.php?fecha_ini=<?php echo $fecha_ini ?>&fecha_fin=<?php echo $fecha_fin ?>&nombre_empresa=<?php echo $nombre_empresa ?>&motivo=<?php echo $motivo ?>&motivo2=<?php echo $motivo2 ?>" },
