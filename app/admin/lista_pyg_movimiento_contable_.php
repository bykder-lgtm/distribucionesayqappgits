...
<table class="table table-striped">
    <tr>
        ...
        <th style="text-align:left"><a href="../admin/reg_pyg_movimiento_contable_.php"><font size='+2'>Crear Nuevo Pyg</font></a></th>
		<?php } ?>
    </tr>
</table>
...
<?php } ?>
<?php if ($cod_estado_contabilidad_pyg_editar == '1') { ?>
<td style="text-align:center"><a href="../admin/edit_pyg_movimiento_contable.php?cod_pyg=<?php echo $cod_pyg?>&fecha_mes=<?php echo $fecha_mes?>"><img src=../imagenes/editar.png alt="actualizar"></a></td>
<?php } ?>
<?php if ($cod_estado_contabilidad_pyg_eliminar == '1') { ?>
