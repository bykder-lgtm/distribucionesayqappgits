...
<td align="Left"><a href="../admin/reg_cita_venta_producto_reg.php?cod_producto=<?php echo $cod_producto?>&cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta?>&foco=<?php echo $foco?>&pagina=<?php echo $pagina?>" tabindex=3><?php echo $nombre_producto ?></a></td>
