...
?>
    ...
    while ($info_tipo_forma_pago = mysqli_fetch_assoc($resultado_tipo_forma_pago)) {
        ...
        $sql_movimiento_contable_cuenta_personal = "SELECT * FROM tbl15_movimiento_contable_cuenta_personal WHERE (nombre_modulo_puc = '$nombre_modulo_puc' AND cod_tipo_forma_pago = '$cod_tipo_forma_pago')";
        $resultado_movimiento_contable_cuenta_personal = mysqli_query($conectar, $sql_movimiento_contable_cuenta_personal);
        $total_reg = mysqli_num_rows($resultado_movimiento_contable_cuenta_personal);
    ...
    ?>
        <tr>
            <th style="text-align:left;"><a href="../admin/reg_movimiento_contable_cuenta_personal.php?nombre_modulo_puc=<?php echo $nombre_modulo_puc?>&cod_tipo_forma_pago=<?php echo $cod_tipo_forma_pago ?>&pagina=<?php echo $pagina ?>"><?php echo $nombre_tipo_forma_pago ?></a> | <?php echo $nombre_puc_concat ?></th>
        </tr>
    <?php } ?>
