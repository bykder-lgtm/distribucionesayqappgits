...
if($action == 'ajax') {
    ...
    $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_lider = '$cod_administrador')";
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_lider = '$cod_administrador') AND ( ";
...
<?php
    ...
    tbl15_info_factura_venta.cod_administrador_lider, tbl15_info_factura_venta.cod_administrador_lider, tbl15_info_factura_venta.cod_administrador_lider, 
    ...
    while ($datos_cuenta_cobrar = mysqli_fetch_assoc($consulta_datos_cuenta_cobrar)) {
        ...
        $nombres_apellidos_lider                                  = $datos_administrador_lider['nombres'].' '.$datos_administrador_lider['apellidos'];
        /* ----------------------------------------------------------------------------------------------------------/ */
        $sql_administrador_asesor = "SELECT nombres, apellidos FROM tbl15_administrador WHERE (cod_administrador = '$cod_administrador_lider')";
                ...
                <div class="row">
                    ...
                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                        <div class="detalle-info-box" style="background: white; padding: 1rem; border-radius: 8px; border: 2px solid #e2e8f0; margin-bottom: 1rem;">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                                <p class="detalle-label" style="color: #2d3748; font-weight: 600; margin: 0; font-size: 1.2rem;">
                                    <i class="fa fa-sitemap" style="color: #0E112B; font-size: 1.2rem; margin-right: 0.3rem;"></i> lider
                                </p>
                                <!--
                                <button type="button" class="btn btn-sm" style="background: #0E112B; color: white !important; padding: 0.35rem 0.8rem; font-size: 0.95rem; border: none; border-radius: 4px; font-weight: 500; transition: all 0.2s ease;" onclick="abrirModalCambiarlider()" onmouseover="this.style.background='#1a1f3a'; this.style.boxShadow='0 2px 4px rgba(14, 17, 43, 0.2)';" onmouseout="this.style.background='#0E112B'; this.style.boxShadow='none';">
                                    <i class="fa fa-edit" style="margin-right: 0.3rem; color: white !important;"></i> Cambiar
        ...
        <div class="modal-content modal-detalle-content">
            <div class="modal-detalle-wrapper">
                ...
                <div class="modal-body detalle-section">
                    ...
                    <div class="detalle-info-box">
                        <p class="detalle-label" style="font-size: 1.3rem; color: #2d3748 !important;"><i class="fa fa-user" style="font-size: 1.3rem; color: #667eea;"></i> Seleccione el nuevo lider</p>
                        <select id="selectNuevolider" class="form-control" style="background-color: white !important; color: #2d3748 !important; border: 2px solid #e2e8f0; border-radius: 8px; padding: 1.25rem; font-size: 1.6rem; font-weight: 600; width: 100%; height: auto; min-height: 60px;">
...
function abrirModalDetalleCredito(nombres_apellidos, identificacion_tercero, monto_deuda, monto_deuda_sin_interes, monto_cuota, nombre_tipo_pago, cod_entidad_crediticia, nombre_entidad_crediticia, nombre_operador_credito, nombre_tienda, nombre_aliado, nombre_banco_cuenta, nombre_estado_facturacion, nombre_estado_revision, nombres_apellidos_asesor, observacion_tercero, fecha_formateada, hora_formateada, contanenar_nombre_producto, nombre_vendedor, cod_tercero, cod_info_factura_venta, cod_vendedor, cod_tienda, cod_banco_cuenta, numero_cuota, nombres_apellidos_lider, nombres_apellidos_lider, nombres_apellidos_aliado_estrategico, nombres_apellidos_revisor, cod_administrador_lider, cod_administrador_lider, cod_administrador_lider, cod_administrador_aliado_estrategico, cod_administrador_revisor, cod_operador_credito) {
    ...
    window.codAdministradorliderActual = cod_administrador_lider;
    window.codAdministradorAsesorActual = cod_administrador_lider;
...
function guardarCambiolider() { guardarCambioEquipo('cod_administrador_lider', 'selectNuevolider', 'modalCambiarlider', 'lider', 'alertalider', 'btnGuardarlider'); }
function guardarCambioAsesor() { guardarCambioEquipo('cod_administrador_lider', 'selectNuevoAsesor', 'modalCambiarAsesor', 'Asesor', 'alertaAsesor', 'btnGuardarAsesor'); }
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                } else if (campo === 'cod_administrador_lider') {
                    window.modalParams.cod_administrador_lider = valorSeleccionado;
                    window.codAdministradorliderActual = valorSeleccionado;
                } else if (campo === 'cod_administrador_lider') {
                    window.modalParams.cod_administrador_lider = valorSeleccionado;
