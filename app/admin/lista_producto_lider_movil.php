...
<style>
/* ============================================ */
/* LISTA PRODUCTOS lider - TEMA VERDE ESMERALDA */
/* ============================================ */
...
$sql_productos = "SELECT p.*, t.nombre_tienda FROM tbl15_producto p INNER JOIN tbl15_tienda t ON p.cod_tienda = t.cod_tienda WHERE t.cod_administrador = '$cod_administrador' AND t.cod_estado != '0' AND p.cod_estado != '0'";
...
<nav class="bottom-nav">
    <a href="dashboard_lider_movil.php" class="nav-item">
        <i class="fa-solid fa-house"></i>
        <span>Inicio</span>
    </a>
    <a href="lista_tienda_lider_movil.php" class="nav-item">
        <i class="fa-solid fa-store"></i>
        <span>Tiendas</span>
    </a>
    <a href="lista_info_factura_venta_lider_movil.php" class="nav-item">
        <i class="fa-solid fa-credit-card"></i>
        <span>Créditos</span>
    </a>
    <a href="lista_producto_lider_movil.php" class="nav-item active">
        <i class="fa-solid fa-boxes-stacked"></i>
        <span>Productos</span>
    </a>
    <a href="config_lider_movil.php" class="nav-item">
...
function filtrarProductos(busqueda) {
    ...
    window.searchTimeout = setTimeout(function() {
        window.location.href = 'lista_producto_lider_movil.php?busqueda=' + encodeURIComponent(busqueda);
    }, 500);
}
...
$('#formProducto').on('submit', function(e) {
    ...
    var url = $('#cod_producto').val() ? '../admin/edit_producto_modal_lider_ajax_reg.php' : '../admin/reg_producto_modal_lider_ajax_reg.php';
