...
if (isset($_GET['cod_nota_observacion'])) {
   ...
   <!-- Start Cart -->
    <form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/soporte_por_revisar_cliente_info_factura_venta_siscredito_visitante_intern_reg.php">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="contact-form-right">
                            <div class="row">
                                <div class="col-md-4">
                                    <div style="text-align:center;" class="">Soporte: 
                                        <img src="<?php echo $url_img_orig_producto ?>" class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div style="text-align:center;" class="">Nota Observacion: 
                                        <?php echo $nombre_nota_observacion ?>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div style="text-align:center;" class="">Fecha | Hora: 
                                        <?php echo $fecha_ymd ?> | <?php echo $fecha_hora ?>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div style="text-align:center;" class="">Estado: 
                                        <select name="codigo_estado_revision" id="codigo_estado_revision" class="form-control" required>
                                        <?php if (isset($codigo_estado_revision)) { echo "<option value='0' $seleccionado >Escoger</option>"; } else { echo "<option value='0' $seleccionado >Escoger</option>"; }
                                             $sql_consulta="SELECT * FROM tbl15_estado_revision WHERE (codigo_estado_revision <> '1') AND (codigo_estado_revision <> '0') AND (cod_estado = '1')";
                                            $resultado = mysqli_query($conectar, $sql_consulta);
                                            while ($contenedor=mysqli_fetch_array($resultado)) { 
                                            $codigo = $contenedor['codigo_estado_revision'];
                                            $nombre = $contenedor['nombre_estado_revision'];
                                            ?>
                                ...
                                <div class="col-md-2">
                                    <div style="text-align:center;" class="">Observacion - Comentarios: 
                                        <input type="text" class="form-control" name="descripcion_nota_observacion" placeholder="" data-error="" />
                                    </div>
                                </div>
                            </div>
                        </div>
