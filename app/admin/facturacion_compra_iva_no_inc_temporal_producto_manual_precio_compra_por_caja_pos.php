...
$cod_estado_vacuna                 = "0";
$nombre_tipo_cargue_factura        = "FACTURA_COMPRA_SIN_IVA_INC";
...
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_factura_compra_iva_no_inc_temporal_precio_compra_por_caja_pos.php'); ?>
<!-- ***************************************************************************************************************************** -->
...
<th style="text-align:center;">P.COSTO SIN IVA (POR CAJA)</th>
<th style="text-align:center;">P.COSTO POR UND</th>
...
<tbody>
<?php
$sql_compra_producto_temporal = "SELECT * FROM tbl15_compra_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual') ORDER BY cod_compra_producto_temporal DESC";
...
<?php if ($cod_estado_compra_caja_global == '1') { ?>
<td style="text-align:center;"><input name="und_unidades" type="text" id="und_unidades<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $und_unidades;?>" min="1" style="width: 40px;" /></td>
<th style="text-align:center;">X</th>
<td style="text-align:center;"><input name="und_caja" type="text" id="und_caja<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $und_caja;?>" min="1" style="width: 40px;" /></td>
<?php } ?>
...
<td style="text-align:center;">
    ...
    <?php if (isset($nombre_tipo_unidad_medida)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' selected >Selecione</option>"; }
...
<td style="text-align:center;"><input name="precio_costo_producto_por_caja" type="text" id="precio_costo_producto_por_caja<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $precio_costo_producto_por_caja;?>" style="width: 70px;" /></td>
...
<?php if ($cod_estado_dto1_global == '1') { ?>
<td style="text-align:center;"><input name="dto1" type="number" id="dto1<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $dto1;?>" style="width: 50px;" min="0"/></td>
<?php } ?>
<?php if ($cod_estado_dto2_global == '1') { ?>
<td style="text-align:center;"><input name="dto2" type="number" id="dto2<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $dto2;?>" style="width: 50px;" min="0"/></td>
<?php } ?>

<td style="text-align:center;"><input name="iva_ptj" type="number" id="iva_ptj<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $iva_ptj;?>" style="width: 50px;" min="0"/></td>
<?php if ($cod_estado_ptj_comision_global == '1') { ?>
<td style="text-align:center;"><input name="comision_ptj" type="number" id="comision_ptj<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $comision_ptj;?>" style="width: 50px;" min="0"/></td>
<?php } ?>
...
<?php if ($cod_estado_cajas_sobre_global  == '1') { ?>
<td style="text-align:center;"><input name="cajas_sobre" type="number" id="cajas_sobre<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $cajas_sobre;?>" style="width: 30px;" min="0"/></td>
<?php } ?>

<?php if ($cod_estado_und_sobre_global  == '1') { ?>
<td style="text-align:center;"><input name="und_sobre" type="number" id="und_sobre<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $und_sobre;?>" style="width: 30px;" min="0"/></td>
<?php } ?>
