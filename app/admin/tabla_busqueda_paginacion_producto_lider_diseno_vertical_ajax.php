...
$pagina = $concatenador."lista_producto_lider_diseno_vertical.php";
...
if($busqueda_ajax <> NULL) { $aColumns = array('tbl15_producto.nombre_producto', 'tbl15_producto.cod_producto_barra', 'tbl15_tienda.nombre_tienda'); }
...
if($action == 'ajax') {
    ...
    $reload                            = '../admin/lista_producto_lider_diseno_vertical.php';
