...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$cod_gasto_inmueble_detalle_venta_temporal      = intval($_GET['cod_gasto_inmueble_detalle_venta_temporal']);
...
$pagina_redirect                                = $pagina.'?cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&cod_info_gasto_inmueble_detalle_venta='.$cod_info_gasto_inmueble_detalle_venta;

$sql_gasto_inmueble_detalle_venta_temporal = "SELECT * FROM tbl15_gasto_inmueble_detalle_venta_temporal WHERE (cod_gasto_inmueble_detalle_venta_temporal = '$cod_gasto_inmueble_detalle_venta_temporal')";
$consulta_gasto_inmueble_detalle_venta_temporal = mysqli_query($conectar, $sql_gasto_inmueble_detalle_venta_temporal);
$datos_gasto_inmueble_detalle_venta_temporal = mysqli_fetch_assoc($consulta_gasto_inmueble_detalle_venta_temporal);
...
$cod_tercero                                     = $datos_gasto_inmueble_detalle_venta_temporal['cod_tercero'];
$cod_factura                                     = $datos_gasto_inmueble_detalle_venta_temporal['cod_factura'];
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_info_gasto_inmueble_detalle_venta = "SELECT * FROM tbl15_info_gasto_inmueble_detalle_venta WHERE cod_info_gasto_inmueble_detalle_venta = '$cod_info_gasto_inmueble_detalle_venta'";
$consulta_info_gasto_inmueble_detalle_venta = mysqli_query($conectar, $sql_info_gasto_inmueble_detalle_venta) or die(mysqli_error($conectar));
$datos_info_gasto_inmueble_detalle_venta = mysqli_fetch_assoc($consulta_info_gasto_inmueble_detalle_venta);

$cod_tercero_propietario                  = $datos_info_gasto_inmueble_detalle_venta['cod_tercero_propietario'];
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
<form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/gasto_inmueble_detalle_venta_temporal_soporte_archivo_adjunto_reg.php">
<fieldset>
...
<input type="hidden" name="cod_gasto_inmueble_detalle_venta_temporal" value="<?php echo $cod_gasto_inmueble_detalle_venta_temporal; ?>">
<input type="hidden" name="cod_info_gasto_inmueble_detalle_venta" value="<?php echo $cod_info_gasto_inmueble_detalle_venta; ?>">
