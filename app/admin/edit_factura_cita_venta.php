...
$sql_profesional = "SELECT cod_factura FROM tbl15_info_cita_factura_venta WHERE cod_info_cita_factura_venta = '$cod_info_cita_factura_venta'";
...
$incre                             = 0;
$tab                               = 'tbl15_info_cita_factura_venta';
$campo                             = 'cod_info_cita_factura_venta';
$tipo                              = 'eliminar';
...
var cod_info_cita_factura_venta=document.getElementById('cod_info_cita_factura_venta').value;
...
xmlhttp.open("POST","../admin/busqueda_inmediata_cita_venta_producto_php.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("buscar="+valor_buscar+"&cod_info_cita_factura_venta="+cod_info_cita_factura_venta+"&pagina="+pagina);
}
</script>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr><td bgcolor="#fff" align="center"><strong><a href="../admin/lista_info_factura_cita_venta.php">LISTA DE CITAS</a></strong></td></tr></tbody>
</table>

<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr><td bgcolor="#fff" align="center"><strong>EDICION CITAS</strong></td></tr></tbody>
</table>
...
<!-- ***************************************************************************************************************************** -->
<?php
$datos_factura = "SELECT cod_cita_venta_producto FROM tbl15_cita_venta_producto WHERE (cod_info_cita_factura_venta = '$cod_info_cita_factura_venta')";
$consulta = mysqli_query($conectar, $datos_factura);
$total_datos = mysqli_num_rows($consulta);

$suma_temporal = "SELECT  Sum(total_venta_producto) As total_venta, Sum(total_costo_producto) As total_compra FROM tbl15_cita_venta_producto WHERE (cod_info_cita_factura_venta = '$cod_info_cita_factura_venta')";
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_cita_factura_venta WHERE (cod_info_cita_factura_venta = '$cod_info_cita_factura_venta')";
$consulta_data_info_factura = mysqli_query($conectar, $datos_data_info_factura);
$data_info_factura = mysqli_fetch_assoc($consulta_data_info_factura);
$factura_ocupada = mysqli_num_rows($consulta_data_info_factura);

$cod_info_cita_factura_venta      = $data_info_factura['cod_info_cita_factura_venta'];
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            var tipo_ajax = "tbl15_info_cita_factura_venta";
            $.post("guardar_info_factura_y_cita_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_cita_factura_venta; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_cita_venta_producto";
            var id = $(this).attr("class");
            //let id = this.id;
            $.post("guardar_info_factura_y_cita_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
-->
  ...
  <tr>
   <td style="text-align:center;"><a href="../admin/eliminar_cita_venta.php?llave=<?php echo $cod_info_cita_factura_venta?>&tab=<?php echo $tab?>&campo=<?php echo $campo?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/eliminar_grand.png" class="img-polaroid" alt=""></a></td>
   <td style="text-align:center;"><?php echo $cod_info_cita_factura_venta ?></td>
...
-->
    ...
    <td style="text-align:center;"><a href="../admin/enviar_cita_venta_a_venta_producto_temporal.php?cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta?>&tab=<?php echo $tab?>&campo=<?php echo $campo?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/agregar.png" class="img-polaroid" alt=""></a></td>
  </tr>
</table>
<!-- ***************************************************************************************************************************** -->
...
<tbody>
<?php
$sql_cita_venta_producto = "SELECT * FROM tbl15_cita_venta_producto WHERE (cod_info_cita_factura_venta = '$cod_info_cita_factura_venta') ORDER BY cod_cita_venta_producto DESC";
$consulta_cita_venta_producto = mysqli_query($conectar, $sql_cita_venta_producto);
while ($datos_cita_venta_producto = mysqli_fetch_assoc($consulta_cita_venta_producto)) {
  	 	 	 	 	 	
$cod_cita_venta_producto                = $datos_cita_venta_producto['cod_cita_venta_producto'];
$cod_producto                      = $datos_cita_venta_producto['cod_producto'];
$cod_producto_barra                = $datos_cita_venta_producto['cod_producto_barra'];
$nombre_producto                   = $datos_cita_venta_producto['nombre_producto'];
$cedula                            = $datos_cita_venta_producto['cedula'];
$nombre_cliente                    = $datos_cita_venta_producto['nombre_cliente'];
$und_venta                         = $datos_cita_venta_producto['und_venta'];
$precio_costo_producto             = $datos_cita_venta_producto['precio_costo_producto'];
$total_costo_producto              = $datos_cita_venta_producto['total_costo_producto'];
$precio_venta_producto             = $datos_cita_venta_producto['precio_venta_producto'];
$total_venta_producto              = $datos_cita_venta_producto['total_venta_producto'];
$nombre_tipo_producto              = $datos_cita_venta_producto['nombre_tipo_producto'];
$nombre_tipo_unidad_medida         = $datos_cita_venta_producto['nombre_tipo_unidad_medida'];
$posologia_cantidad                = $datos_cita_venta_producto['posologia_cantidad'];
$posologia_peso                    = $datos_cita_venta_producto['posologia_peso'];
$nombre_tipo_presentacion          = $datos_cita_venta_producto['nombre_tipo_presentacion'];
$nombre_via_administracion         = $datos_cita_venta_producto['nombre_via_administracion'];
$nombre_frec_duracion              = $datos_cita_venta_producto['nombre_frec_duracion'];
$cod_tipo_cobrar                   = $datos_cita_venta_producto['cod_tipo_cobrar'];
$cod_info_cita_factura_venta            = $datos_cita_venta_producto['cod_info_cita_factura_venta'];
$nombre_tipo_precio_venta          = $datos_cita_venta_producto['nombre_tipo_precio_venta'];

$incre++;
?>
<tr style="text-align:center;" id="tr<?php echo $cod_cita_venta_producto;?>">
<td  style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_cita_venta_producto?>&cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta ?>&tab=<?php echo $tab ?>&tipo=<?php echo $tipo ?>&campo=<?php echo $campo ?>&pagina=<?php echo $pagina_local ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>
<!--<td style="text-align:center"><input name="cod_tipo_cobrar" class="cod_tipo_cobrar__<?php echo $cod_cita_venta_producto;?>" id="cod_tipo_cobrar_<?php echo $cod_cita_venta_producto;?>" type="checkbox" value="1" <?php if($cod_tipo_cobrar=='1'){ echo "checked"; } ?>></td>-->
<!--<td style="text-align:center;" id="cod_cita_venta_producto_<?php echo $cod_cita_venta_producto ?>" class="service_list" data="<?php echo $cod_cita_venta_producto ?>"><a class="eliminar" id="cod_cita_venta_producto<?php echo $cod_cita_venta_producto ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>-->
...
<td style="text-align:right;" id="und_venta_<?php echo $incre;?>"><input name="und_venta" type="number" id="und_venta-<?php echo $incre;?>" class="<?php echo $cod_cita_venta_producto;?>" onChange="calc_total_venta();" value="<?php echo $und_venta;?>" style="width: 70px;" /></td>
...
<a href="../admin/actualizar_cita_precio_venta_producto.php?nombre_tipo_precio_venta=PV<?php echo $i?>&cod_cita_venta_producto=<?php echo $cod_cita_venta_producto?>&cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta?>&pagina=<?php echo $pagina?>"><img src="<?php if ($nombre_tipo_precio_venta=="PV$i") { echo "../imagenes/PV".$i."_R.png"; } else { echo "../imagenes/PV$i.png"; } ?>"></a>
<?php } ?>
</td>
...
</tr style="text-align:right;" id="tr<?php echo $cod_cita_venta_producto;?>">
<?php } ?>
</tbody>
</table>
...
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  <tr>
<!--
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=EXCEL&cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/excel.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=FACTURA&cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/imprimir_peq.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=LISTA&cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></td>
-->
    <td style="text-align:center;"><a href="../admin/cita_venta_productos_opcion_imprimir.php?cod_info_cita_factura_venta=<?php echo $cod_info_cita_factura_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos.png" class="img-polaroid" alt=""></a></td>
  </tr>
</table>
</div>
<!-- ***************************************************************************************************************************** -->
...
$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
        ...
        var cod_cita_venta_producto = $(this).parent().attr('data');
        var dataString = 'llave='+cod_cita_venta_producto+'&'+'tab='+'<?php echo $tab ?>'+'&'+'campo='+'<?php echo $campo ?>'+'&'+'tipo='+'<?php echo $tipo ?>';
        ...
        $.ajax({
            ...
            success: function() {           
                $('#eliminar-ok').empty();
                $('#eliminar-ok').append('<div align="center" class="correcto">Se ha eliminado correctamente el codigo = '+cod_cita_venta_producto+'.</div>').fadeIn("slow");
                $('#'+parent).fadeOut("slow");
                $('#cod_producto_barra_'+cod_cita_venta_producto).fadeOut("slow");
                $('#nombre_cliente_'+cod_cita_venta_producto).fadeOut("slow");
                $('#nombre_producto_'+cod_cita_venta_producto).fadeOut("slow");
                $('#und_venta_'+cod_cita_venta_producto).fadeOut("slow");
                $('#precio_venta_producto_'+cod_cita_venta_producto).fadeOut("slow");
                $('#total_venta_producto_'+cod_cita_venta_producto).fadeOut("slow");
                $('#tr'+cod_cita_venta_producto).fadeOut("slow");
            }
        });
