                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="text-align:center;"><a href="../admin/contactar_por_whatapp_telefono_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&accion_codifcryp=<?php echo $accion_whatapp_codifcryp ?>&tipo_codifcryp=<?php echo $tipo_codifcryp ?>&origen_codifcryp=<?php echo $origen_codifcryp ?>" target="_blank"><img src="../imagenes/btn_tel_whatapp_solo.png" /><br>Enviar</a></th>
