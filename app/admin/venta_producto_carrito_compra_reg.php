...
precio_venta_producto_orig, und_producto, cod_base_caja, cod_opcion_descontable_inv, cod_categoria, cod_categoria_sub, cod_tipo_producto_cocina, cod_check_imp) 
...
latitud, longitud, latitud_longitud, cod_zona_envio, nombre_tipo_entrega, direcion_misma_factura, guarda_info_prox) 
...
$url_redir = "../admin/venta_productos_visitante_ext_opcion_imprimir.php?cod_info_factura_venta=".$cod_info_factura_venta."&cod_info_factura_venta_carrito_compra=".$cod_info_factura_venta_carrito_compra."&pagina=".$pagina;
