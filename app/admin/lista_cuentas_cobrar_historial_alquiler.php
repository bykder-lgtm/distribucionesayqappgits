...
<h4><a href="#">Historial de alquiler</a></h4>
</div>
<hr>
<div class="row-fluid">
...
<tr>
<form action="../admin/lista_cuentas_cobrar_historial_alquiler.php" method="post">
...
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar.cod_tercero
WHERE (tbl15_tercero.nombre1_tercero LIKE '%$palabra%') ORDER BY tbl15_cuentas_cobrar.cod_cuentas_cobrar DESC";
...
?>
<tr>
<td style="text-align: center;"><font size='3'><a href="../admin/cuentas_cobrar_detalle_factura_alquiler.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar; ?>&cod_tercero=<?php echo $cod_tercero; ?>&cod_factura=<?php echo $cod_factura; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/ver.png" class="img-polaroid" alt=""></a></font></td>
