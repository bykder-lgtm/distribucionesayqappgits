...
//if ($precio_compra_producto <= 99) { $contar_ceros_compra = 1; } elseif ($precio_compra_producto <= 999 && $precio_compra_producto >= 100) { $contar_ceros_compra = 2; } elseif ($precio_compra_producto <= 9999 && $precio_compra_producto >= 1000) { $contar_ceros_compra = 2; } else { $contar_ceros_compra = 1; }
...
$nombre_letra_numero_compra = $nombre_letra_numero_compra;
...
$nombre_letra_numero_compra = $nombre_letra_numero_compra.$datos_letra_numero_compra['nombre_letra_numero'];
}
