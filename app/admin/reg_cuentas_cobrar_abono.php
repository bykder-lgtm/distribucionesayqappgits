...
$sql_fecha_pago_alert = "SELECT fecha_pago FROM tbl15_cuentas_cobrar_alerta WHERE (cod_cuentas_cobrar_alerta = '$cod_cuentas_cobrar_alerta')";
...
$fecha_pago                     = $datos_fecha_pago_alert['fecha_pago'];
} else { 
...
$calcular_datos_cuenta_cobrar = "SELECT cod_cuentas_cobrar_alerta, fecha_pago FROM tbl15_cuentas_cobrar_alerta 
...
<tr>
<td style="text-align:center"><strong><font size="3px">FECHA PAGO CUOTA: <?php echo $fecha_pago; ?></font></strong></td>
</tr>
<tr>
...
<br>
<form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/reg_cuentas_cobrar_abono_reg.php">
<table class="table table-striped">
<tr>
<td style="text-align:center"><strong>VALOR ABONO</strong></td>
</tr>
<tr>
<td style="text-align:center"><input style="font-size:24px" class="input-block-level" type="text" name="abonado_number" id="abonado_number" value="" size="10"  required></td>
...
<tr>
<td style="text-align:center"><strong>OBSERVACION</strong></td>
</tr>
<tr>
