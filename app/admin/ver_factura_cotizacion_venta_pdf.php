...
$sql_info_factura = "SELECT * FROM tbl15_info_cotizacion_factura_venta WHERE cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta'";
...
$sql_tipo_cotiz = "SELECT * FROM tbl15_tipo_cotizacion WHERE cod_tipo_cotizacion = '$cod_tipo_cotizacion'";
$resultado_tipo_cotiz = mysqli_query($conectar, $sql_tipo_cotiz);
$info_tipo_cotiz = mysqli_fetch_assoc($resultado_tipo_cotiz);

$nombre_tipo_cotizacion             = $info_tipo_cotiz['nombre_tipo_cotizacion'];
...
$leyenda1_defec_global_emp                            = $info_empresa_data['leyenda1_defec_global'];
$leyenda2_defec_global_emp                            = $info_empresa_data['leyenda2_defec_global'];
$leyenda3_defec_global_emp                            = $info_empresa_data['leyenda3_defec_global'];
...
if ($cod_estado_img_impimir_factura_global == '1') { $url_img_logo_empresa = '../imagenes/logo_empresa_factura_pos_blanco_negro.jpg'; } else { $url_img_logo_empresa = '../imagenes/logo_limp.png'; }
...
$header = '
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:25pt; width:100%; border-collapse: collapse; border:1px solid #999999">
  <tr>
    <td style="text-align:left" rowspan="6" width="200"><img src="'.$url_img_logo_empresa.'" class="img img-responsive" style="width:200px;"></td>
    <th style="text-align:center; font-size:13pt;" width="442">'.$nombre_emp.'</th>
    <td style="text-align:right" rowspan="6" width="140"><barcode code="'.$pag_desarrollador_emp.'" size="1" type="QR" error="M" class="barcode" /></td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:12pt;">NIT: '.$propietario_nit_emp.'</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:12pt;"></td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:12pt;">TELEFONO: '.$telefono_emp.' - '.$correo_emp.'</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:12pt;">'.$ciudad_emp.' - '.$departamento_emp.', '.$pais_emp.'</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:12pt;"><barcode code="'.$cod_factura_strpad.'" type="C128A" size="0.6" height="1" /><br>'.$url_pag_emp.'</td>
  </tr>
</table>
';
$headerE = '
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:20pt; width:100%; border-collapse: collapse; border:1px solid #999999">
  <tr>
    <td style="text-align:left" rowspan="6" width="140"><img src="'.$url_img_logo_empresa.'" class="img img-responsive" style="width:100px;"></td>
    <th style="text-align:center; font-size:13pt;" width="442">'.$nombre_emp.'</th>
    <td style="text-align:right" rowspan="6" width="140"><barcode code="'.$pag_desarrollador_emp.'" size="1" type="QR" error="M" class="barcode" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align:center; font-size:8pt;">TELEFONO: '.$telefono_emp.' - '.$correo_emp.'</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:8pt;">'.$ciudad_emp.' - '.$departamento_emp.', '.$pais_emp.'</td>
  </tr>
  <tr>
    <td style="text-align:center; font-size:8pt;"><barcode code="'.$cod_factura_strpad.'" type="C128A" size="0.6" height="1" /><br>'.$url_pag_emp.'</td>
  </tr>
</table>
';
$footer = '
<table width="100%" style="border-top: 1px solid #000000; vertical-align: bottom; font-family:serif; font-size: 12pt; color: #000000;">
<tr><td width="100%" style="text-align: center;"><h6>'.$direccion_emp.' &nbsp;&nbsp; - &nbsp;&nbsp; Tel&eacute;fonos: '.$telefono_emp.'<br> '.$correo_emp.' &nbsp;&nbsp; - &nbsp;&nbsp; '.$ciudad_emp.' - '.$departamento_emp.' [Página {PAGENO} de {nbpg}]</h6></td></tr>
...
<!-- /////////////////////////////////////////////////// -->
<!--
<table align="center" border="0" cellpadding="1" cellspacing="4" style="font-family:mono; font-size:15pt; width:100%; border-collapse: collapse; border:1px solid #999999">
  <tr>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
  <tr>

    <td width="337" valign="top"><p>&nbsp;</p>
      <table align="" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:90%; border-collapse: collapse; border:1px solid #999999">
          <tr>
    ...
    <td width="345" valign="top"><p>&nbsp;
       <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:90%; border-collapse: collapse; border:1px solid #999999">
          <tr>
            <td style="text-align:center">'.$nombre_tipo_cotizacion.'</td>
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
  <tr>
    ...
    <td width="40" valign="top">Nit: '.$identificacion_tercero.$digito_tercero.'</td>
  </tr>
  <tr>
...
if ($nombre_tipo_cotizacion == 'ORDEN DE COMPRA') {
$codigoHTML.='
  <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
    <tr>
    <td width="40" valign="top">'.$leyenda1_defec_global_emp.'</td>
    </tr>
    <tr>
     <td width="40" valign="top">'.$leyenda2_defec_global_emp.'</td>
   </tr>
</table>
';
}

if (($nombre_tipo_cotizacion == 'COTIZACION')) {
$codigoHTML.='
  <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
    <tr>
    <td width="40" valign="top">'.$leyenda1_defec_global_emp.'</td>
...
$codigoHTML.='
  <tr>
    <td width="576" height="400" valign="top"><p>&nbsp;</p>
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
          <tr>
            <td style="text-align:center" width="80" valign="top"><strong>Cantidad</strong></td>
            <td style="text-align:left" width="250" valign="top"><strong>Descripción</strong></td>
            <td style="text-align:right" width="100" valign="top"><strong>Valor Unitario</strong></td>
            <td style="text-align:right" width="100" valign="top"><strong>Valor Total</strong></td>
            <td style="text-align:right" width="30" valign="top"></td>

           </tr>';

$sql_motivo_conteo = "SELECT * FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') ORDER BY cod_cotizacion_venta_producto DESC";
...
$und_caja_sobre                 = $info_motivo_conteo['und_caja_sobre'];
$cajas_sobre                    = $info_motivo_conteo['cajas_sobre'];
$nombre_tipo_und_caja_sobre     = $info_motivo_conteo['nombre_tipo_und_caja_sobre'];
$nombre_tipo_unidad_medida      = $info_motivo_conteo['nombre_tipo_unidad_medida'];

if ($nombre_cliente=='') { $nombre_producto_cliente = $nombre_producto; } else { $nombre_producto_cliente = $nombre_cliente.' - '.$nombre_producto; }
if ($cod_estado_mostrar_venta_por_caja_global == '1') { if ($nombre_tipo_und_caja_sobre == 'CAJA') { $und_venta = $und_venta; $und_venta_caja = intval($und_caja_sobre); $subtitulo_tipo_caja = '|'.$nombre_tipo_und_caja_sobre; } elseif ($nombre_tipo_und_caja_sobre == 'SOBRE') { $und_venta = $cajas_sobre; $und_venta_caja = ''; $subtitulo_tipo_caja = '|'.$nombre_tipo_und_caja_sobre; } else { $und_venta = $und_venta; $und_venta_caja = ''; $subtitulo_tipo_caja = "|UND"; } }
...
$codigoHTML.='
          <tr>
            ...
            <td style="text-align:center"> | '.($und_venta_caja).$subtitulo_tipo_caja.'</td>
          </tr>';
}
$codigoHTML.='
        </table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%;">
  <tr>
    <td style="text-align:center">Precios sujetos a cambios</td>
  </tr>
</table>
<!-- /////////////////////////////////////////////////// -->
<br>
...
$codigoHTML.='
  <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%; border-collapse: collapse; border:1px solid #999999">
    <tr>
     <td width="40" valign="top">'.$leyenda3_defec_global_emp.'</td>
    </tr>
</table>
';
}
