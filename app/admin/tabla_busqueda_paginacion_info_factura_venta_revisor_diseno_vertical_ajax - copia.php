...
<table class="table table-striped table-hover jambo_table bulk_action" id="tablaFacturasRevisor">
    <thead>
        ...
        <tr class="filtros-tabla">
            <th style="text-align:center"><input type="text" class="form-control filtro-input" placeholder="ID" data-column="0" style="width:7px; min-width:60px; font-size:1.2rem; padding:0.5rem;"></th>
            ...
            <th style="text-align:center"><input type="text" class="form-control filtro-input" placeholder="Línea" data-column="6" style="width:20px; min-width:120px; font-size:1.2rem; padding:0.5rem;"></th>
            <th style="text-align:center"><input type="text" class="form-control filtro-input" placeholder="Operador" data-column="7" style="width:100%; min-width:120px; font-size:1.2rem; padding:0.5rem;"></th>
            <th style="text-align:center"><input type="text" class="form-control filtro-input" placeholder="Estado" data-column="8" style="width:100%; min-width:120px; font-size:1.2rem; padding:0.5rem;"></th>
        </tr>
    </thead>
    <tbody>
<?php
...
?>
        <tr>
            ...
            <td style="text-align:left"><?php echo $nombre_aliado; ?></td>
            <td style="text-align:left; cursor:pointer; color: #81e6d9; text-decoration: underline;" onclick='abrirModalDetalleCredito(
            ...
            <td style="text-align:center"><?php echo $nombre_operador_credito; ?></td>
    <!--
        ...
        <div class="modal-content modal-detalle-content">
            ...
            <div class="modal-body detalle-section">
                ...
                <div class="detalle-info-box" style="text-align: center; background: #0E112B15; padding: 1rem; border-radius: 8px; margin-bottom: 1rem;">
                    <p class="detalle-label" style="justify-content: center; color: #2d3748; font-weight: 600; margin-bottom: 0.5rem; font-size: 1.3rem;"><i class="fa fa-shopping-bag" style="color: #0E112B; font-size: 1.3rem;"></i> Producto</p>
                ...
                <div class="modal-body detalle-section">
                        ...
                        <div class="col-md-12">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-id-card" style="color: #0E112B; font-size: 1.2rem;"></i> Identificación *
                                </label>
                                <input type="text" id="edit_identificacion_tercero" name="identificacion_tercero" class="form-control" required style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-user" style="color: #0E112B; font-size: 1.2rem;"></i> Primer Nombre *
                                </label>
                                <input type="text" id="edit_nombre1_tercero" name="nombre1_tercero" class="form-control" required style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-user" style="color: #0E112B; font-size: 1.2rem;"></i> Segundo Nombre
                                </label>
                                <input type="text" id="edit_nombre2_tercero" name="nombre2_tercero" class="form-control" style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-user" style="color: #0E112B; font-size: 1.2rem;"></i> Primer Apellido *
                                </label>
                                <input type="text" id="edit_apellido1_tercero" name="apellido1_tercero" class="form-control" required style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-user" style="color: #0E112B; font-size: 1.2rem;"></i> Segundo Apellido
                                </label>
                                <input type="text" id="edit_apellido2_tercero" name="apellido2_tercero" class="form-control" style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-phone" style="color: #0E112B; font-size: 1.2rem;"></i> Teléfono *
                                </label>
                                <input type="text" id="edit_telefono1_tercero" name="telefono1_tercero" class="form-control" required style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-envelope" style="color: #0E112B; font-size: 1.2rem;"></i> Correo Electrónico
                                </label>
                                <input type="email" id="edit_correo_tercero" name="correo_tercero" class="form-control" style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="detalle-info-box">
                                <label class="detalle-label" style="color: #2d3748; font-weight: 600; font-size: 1.2rem;">
                                    <i class="fa fa-map-marker" style="color: #0E112B; font-size: 1.2rem;"></i> Dirección
                                </label>
                                <textarea id="edit_direccion_tercero" name="direccion_tercero" class="form-control" rows="2" style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; background: white; color: #2d3748;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content modal-detalle-content">
            <div class="modal-detalle-wrapper">
                ...
                <div class="modal-footer" style="background: #f7fafc; border-top: 2px solid #e2e8f0; padding: 2rem; justify-content: center; gap: 1.5rem;">
                    ...
                    <button type="button" id="btnConfirmarAprobarVenta" class="btn-detalle-action" style="padding: 1.15rem 3rem; font-size: 1.4rem;">
                        <i class="fa fa-check" style="font-size: 1.4rem;"></i> Aprobar Venta
                    </button>
                </div>
                <!-- Campos ocultos -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 1.5rem;">
                ...
                <div class="alert alert-info" style="background: #e6fffa; border-left: 4px solid #4fd1c7; color: #234e52;">
                    <i class="fa fa-info-circle" style="margin-right: 0.5rem;"></i>
                    <strong>Estado seleccionado:</strong> <span id="nombreEstadoSeleccionado" style="font-weight: 600;"></span>
                </div>
            ...
            <div class="modal-footer" style="border-top: 1px solid #e2e8f0; padding: 1rem 1.5rem;">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="padding: 0.6rem 1.2rem;">
                    <i class="fa fa-times"></i> Cancelar
                </button>
                <button type="button" class="btn btn-primary" id="btnConfirmarCambioEstado" 
                    style="background: linear-gradient(135deg, #0E112B 0%, #1a1d3a 100%); border: none; padding: 0.6rem 1.2rem;">
...
// Mostrar modal de motivo de rechazo al seleccionar "RECHAZADO" en el estado de revisión de la foto
    ...
    if (precio_venta_producto > 0 && numeroCuotas > 0 && cod_entidad_crediticia) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response && success) {
                    // Mostrar resultados
                    document.getElementById('valorTotalCredito').textContent = formatearNumero(total_pagar);
...
function guardarEntidadCrediticia() {
    ...
    const valorContado = document.getElementById('precio_venta_producto').value;
    ...
    if (!valorContado || parseFloat(valorContado) <= 0) {
        alert('Por favor ingrese un valor de contado válido');
        return;
    }
    ...
    const valorTotal = parseFloat(valorTotalCredito) || 0;
            ...
            if (response && response.success) {
                ...
                setTimeout(function() {
                    if (window.modalParams) {
                        ...
                        window.modalParams.monto_deuda = formatearNumero(valorTotal);
                        window.modalParams.monto_deuda_sin_interes = formatearNumero(valorContadoNum);
        ...
        success: function(response) {
            ...
            if (response.success === true && response.imagenes && response.imagenes.length > 0) {
                ...
                $.each(response.imagenes, function(index, imagen) {
                    ...
                    var icono = 'fa-camera';
                    if (imagen.nombre_nota_observacion.indexOf('CEDULA') > -1) {
                        icono = 'fa-id-card';
                    } else if (imagen.nombre_nota_observacion.indexOf('PRODUCTO') > -1) {
                        icono = 'fa-shopping-bag';
                    } else if (imagen.nombre_nota_observacion.indexOf('FACTURA') > -1) {
                        icono = 'fa-file-text';
                    } else if (imagen.nombre_nota_observacion.indexOf('PAGO') > -1) {
                        icono = 'fa-money';
                    }
                    // Usar imagen miniatura si existe, sino la original
                    var urlImagen = imagen.url_img_min_producto || imagen.url_img_orig_producto;
                    // Verificar si la imagen tiene URL válida
                    var tieneImagen = (urlImagen && urlImagen !== '' && urlImagen !== null && urlImagen !== 'null');
                    // Crear botones de estado en lugar de select
                    var botonesEstados = '<div style="margin-top: 0.75rem; display: flex; flex-wrap: wrap; gap: 0.5rem; justify-content: center;">';
                    ...
                    if (estadosRevisionGlobal.length > 0 && tieneImagen) {
                        $.each(estadosRevisionGlobal, function(i, estado) {
                            ...
                            // Asignar colores e iconos según el estado
                            if (esActual) {
                                // La opción seleccionada: verde brillante, más grande y con check
                                colorBoton = 'background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); border: 3px solid #15803d; transform: scale(1.15);';
                                checkIcono = '<i class="fa fa-check" style="margin-right: 0.4rem; font-size: 1.1rem;"></i>';
                                if (estado.nombre_estado_revision === 'PENDIENTE') {
                                    iconoBoton = 'fa-clock-o';
                                } else if (estado.nombre_estado_revision === 'APROBADO') {
                                    iconoBoton = 'fa-check-circle';
                                } else if (estado.nombre_estado_revision === 'RECHAZADO') {
                                    iconoBoton = 'fa-times-circle';
                                } else {
                                    iconoBoton = 'fa-info-circle';
                                }
                            } else {
                                // Las opciones no seleccionadas: más pequeñas y opacas
                                if (estado.nombre_estado_revision === 'PENDIENTE') {
                                    colorBoton = 'background: #e2e8f0; color: #718096; border: 2px solid #cbd5e0; opacity: 0.7;';
                                    iconoBoton = 'fa-clock-o';
                                } else if (estado.nombre_estado_revision === 'APROBADO') {
                                    colorBoton = 'background: #c6f6d5; color: #38a169; border: 2px solid #9ae6b4; opacity: 0.7;';
                                    iconoBoton = 'fa-check-circle';
                                } else if (estado.nombre_estado_revision === 'RECHAZADO') {
                                    colorBoton = 'background: #fed7d7; color: #e53e3e; border: 2px solid #fc8181; opacity: 0.7;';
                                    iconoBoton = 'fa-times-circle';
                                } else {
                                    colorBoton = 'background: #bee3f8; color: #4299e1; border: 2px solid #90cdf4; opacity: 0.7;';
                                    iconoBoton = 'fa-info-circle';
                                }
                            }
                            
                            var estiloBoton = 'padding: 0.6rem 1rem; border-radius: 6px; font-size: 0.85rem; font-weight: 600; ' + 'cursor: pointer; transition: all 0.3s ease; ' + (esActual ? 'color: white; box-shadow: 0 4px 15px rgba(34, 197, 94, 0.5), 0 0 20px rgba(34, 197, 94, 0.3); font-size: 1rem; font-weight: 700; text-shadow: 0 1px 2px rgba(0,0,0,0.2);' : '') + colorBoton;
                            
                            if (esActual) {
                                estiloBoton += ' pointer-events: none;';
                            }
                            
                            botonesEstados += '<button type="button" class="btn btn-estado-revision" ' +
                                'data-cod-nota="' + imagen.cod_nota_observacion + '" ' +
                                'data-estado="' + estado.codigo_estado_revision + '" ' +
                                'data-nombre-estado="' + estado.nombre_estado_revision + '" ' +
                                'style="' + estiloBoton + '" ' +
                                (esActual ? 'disabled' : '') + '>' +
                                checkIcono +
                                '<i class="fa ' + iconoBoton + '" style="margin-right: 0.3rem;"></i>' +
                                estado.nombre_estado_revision +
                                '</button>';
                        });
                    } else if (!tieneImagen) {
                        botonesEstados += '<div style="padding: 0.75rem; background: #f7fafc; border-radius: 6px; color: #a0aec0; font-size: 0.9rem; text-align: center; width: 100%;">' + '<i class="fa fa-ban" style="margin-right: 0.3rem;"></i>Sin imagen cargada' + '</div>';
                    } else {
                        botonesEstados += '<div style="padding: 0.75rem; background: #fed7d7; border-radius: 6px; color: #e53e3e; font-size: 0.9rem; text-align: center; width: 100%;">' + '<i class="fa fa-exclamation-triangle" style="margin-right: 0.3rem;"></i>Sin estados disponibles' + '</div>';
                    }
                    ...
                    if (nombreEstadoActual === 'RECHAZADO' && imagen.descripcion_nota_observacion && imagen.descripcion_nota_observacion.trim() !== '') {
                        motivoRechazoHtml = 
                            '<div style="margin-top: 1rem; padding: 0.75rem; background: #fed7d7; border-left: 4px solid #e53e3e; border-radius: 4px; text-align: left;">' +
                            '<p style="margin: 0; color: #742a2a; font-size: 0.85rem; font-weight: 600;">' +
                            '<i class="fa fa-exclamation-triangle" style="margin-right: 0.3rem;"></i>Motivo del Rechazo:' +
                            '</p>' +
                            '<p style="margin: 0.25rem 0 0 0; color: #742a2a; font-size: 0.9rem; line-height: 1.4;">' +
                            imagen.descripcion_nota_observacion +
                            '</p>' +
                            '</div>';
                    }
                    ...
                    var tarjetaHtml = 
                        ...
                        '<div class="detalle-info-box" style="background: white; padding: 1rem; border-radius: 8px; border: 2px solid #e2e8f0; text-align: center; height: 100%;">' +
                        '<p class="detalle-label" style="color: #2d3748; font-weight: 600; margin-bottom: 1rem; font-size: 1.1rem; justify-content: center;">' +
                        '<i class="fa ' + icono + '" style="color: #0E112B; font-size: 1.1rem; margin-right: 0.5rem;"></i>' +
                        '<span style="font-size: 1rem;">' + imagen.nombre_nota_observacion +' (*'+ imagen.cod_estado_obligatorio+ ' * ' + imagen.cod_estado_obligatorio2 +')</span>' +
                        '</p>' +
                        ...
                        '<label style="display: block; color: #2d3748; font-weight: 600; font-size: 0.95rem; margin-bottom: 0.5rem; text-align: center;">' +
                ...
                // No se necesita deshabilitar nada ya que los botones se crean deshabilitados cuando no hay imagen
...
// Manejador para cambio de estado de revisión de imagen
$(document).on('change', '.select-estado-revision', function() {
    var $select = $(this);
    var codNotaObservacion = $select.data('cod-nota');
...
$(document).on('click', '#btnConfirmarAprobarVenta', function() {
    ...
    // Obtener variables necesarias (puedes ajustar estos valores según tu sistema)
    ...
    $.ajax({
        url: '../admin/aprovar_venta_estado_facturacion_ajax.php',
        type: 'POST',
        data: {
            cod_info_factura_venta: codInfoFacturaVenta,
            cuenta: cuenta,
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                // Recargar la tabla después de mostrar el modal
                //setTimeout(function() { if (typeof load === 'function') { load(1); } }, 2000);
            } else {
                $('#alertaAprobarVenta').removeClass('alert-success').addClass('alert-danger').text('Error: ' + response.message).show();
                $('#btnConfirmarAprobarVenta').prop('disabled', false).html('<i class="fa fa-check"></i> Aprobar Venta');
            }
        },
        error: function(xhr, status, error) {
