...
<?php if ($cod_estado_info_empresa_editar == '1') { ?><td align="center"><a href="../admin/edit_info_empresa_app.php?cod_info_empresa=<?php echo $cod_info_empresa?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td><?php } ?>
</tr>
<?php
}
?>
