...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>Lista Gastos a Inquilinos de Inmuebles deducidos</font></a></th>
        <th style="text-align:right"><a href="../admin/buscar_por_cod_factura_venta_gasto_inmueble_detalle.php"><font size='+2'>Buscar Por Contrato</font></a></th>
        <th style="text-align:right"><a href="../admin/lista_gasto_inmueble_inquilino_temporal_virtual.php"><font size='+2'>Crear Nuevo Gasto</font></a></th>
    </tr>
</table>
...
<th style="text-align:center; font-size:13pt;">Inquilino | Inmueble</th>
<th style="text-align:center; font-size:13pt;">Concepto</th>
<th style="text-align:center; font-size:13pt;">Descripcion</th>
<th style="text-align:center; font-size:13pt;">Costo Administracion de Reparacion (P.Compra)</th>
<th style="text-align:center; font-size:13pt;">Costo Final (P.Venta)</th>
<th style="text-align:center; font-size:13pt;">Ganancia</th>
...
$sql_total_tipo_factura = "SELECT * FROM tbl15_gasto_inmueble_inquilino_venta 
WHERE (fecha_gasto_inmueble_detalle BETWEEN '$fecha_gasto_inmueble_detalle_ini' AND '$fecha_gasto_inmueble_detalle_fin') 
$filtro_consulta_tercero $filtro_consulta_cod_factura ORDER BY cod_info_gasto_inmueble_inquilino_venta DESC";
...
while ($datos_total_tipo_factura = mysqli_fetch_assoc($consulta_total_tipo_factura)) {
    ...
    $cod_gasto_inmueble_inquilino_venta                = $datos_total_tipo_factura['cod_gasto_inmueble_inquilino_venta'];
    $cod_info_gasto_inmueble_inquilino_venta           = $datos_total_tipo_factura['cod_info_gasto_inmueble_inquilino_venta'];
    ...
    $incren_sup                                   = $cod_gasto_inmueble_inquilino_venta;
...
<tr id="<?php echo $cod_gasto_inmueble_inquilino_venta;?>">
<?php if ($cod_estado_facturacion_venta_editar == '1') { ?>
<!--<td id="edit<?php echo $cod_gasto_inmueble_inquilino_venta;?>" style="text-align:center"><a href="../admin/edit_factura_venta.php?cod_gasto_inmueble_inquilino_venta=<?php echo $cod_gasto_inmueble_inquilino_venta ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>-->
<?php } ?>
<td style="text-align:center; font-size:11pt;" id="cod_factura<?php echo $cod_gasto_inmueble_inquilino_venta;?>"><?php echo ($cod_factura)?></td>
<td style="text-align:left; font-size:11pt;" id="nombre_tercero<?php echo $cod_gasto_inmueble_inquilino_venta;?>"><?php echo $nombre_tercero?> | <?php echo $nombre_producto?></td>
<td style="text-align:left; font-size:11pt;" id="nombre_gasto_inmueble_detalle<?php echo $cod_gasto_inmueble_inquilino_venta;?>"><?php echo $nombre_gasto_inmueble_detalle?></td>
<td style="text-align:left;" id="cod_gasto_inmueble_inquilino_venta<?php echo $cod_gasto_inmueble_inquilino_venta ?>"><textarea name="descripcion_gasto_inmueble_detalle" id="<?php echo $cod_gasto_inmueble_inquilino_venta;?>" class="input-block-level" rows="1" cols="50"><?php echo $descripcion_gasto_inmueble_detalle;?></textarea></td>
<td style="text-align:center; font-size:11pt;" id="cod_gasto_inmueble_inquilino_venta<?php echo $cod_gasto_inmueble_inquilino_venta ?>"><input style="font-size:24px; width: 110px;" type="text" name="precio_compra_producto" id="precio_compra_producto<?php echo $cod_gasto_inmueble_inquilino_venta;?>" class="<?php echo $cod_gasto_inmueble_inquilino_venta;?>" value="<?php echo $precio_compra_producto;?>" /></td>
<td style="text-align:center; font-size:11pt;" id="cod_gasto_inmueble_inquilino_venta<?php echo $cod_gasto_inmueble_inquilino_venta ?>"><input style="font-size:24px; width: 110px;" type="text" name="precio_venta_producto" id="precio_venta_producto<?php echo $cod_gasto_inmueble_inquilino_venta;?>" class="<?php echo $cod_gasto_inmueble_inquilino_venta;?>" value="<?php echo $precio_venta_producto;?>" /></td>
<td style="text-align:right; font-size:11pt;" id="ganancia<?php echo $cod_gasto_inmueble_inquilino_venta ?>"><?php echo number_format($ganancia, 0, ",", ".");?></td>
<td style="text-align:center; font-size:11pt;" id="fecha_gasto_inmueble_detalle<?php echo $cod_gasto_inmueble_inquilino_venta;?>"><?php echo date("d-m-Y", strtotime($fecha_gasto_inmueble_detalle))?></td>
<td style="text-align: center;"><a href="../admin/cuentas_cobrar_abonos_alquiler_comprobante_gasto_inmueble_inquilino_imprimir_pdf.php?cod_info_gasto_inmueble_inquilino_venta=<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>&cod_gasto_inmueble_inquilino_venta=<?php echo $cod_gasto_inmueble_inquilino_venta;?>&cod_cuentas_cobrar_alerta=<?php echo $cod_cuentas_cobrar_alerta;?>&fecha_mes=<?php echo $fecha_mes;?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes;?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo;?>&cod_estado_pago=<?php echo $cod_estado_pago;?>&cod_estado_aprobado=1&pagina=<?php echo $pagina_local;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>
<td style="text-align:center; font-size:11pt;" id="cod_gasto_inmueble_inquilino_venta<?php echo $cod_gasto_inmueble_inquilino_venta;?>"><?php echo $cod_gasto_inmueble_inquilino_venta?></td>
<?php if ($cod_estado_facturacion_venta_imprimir == '1') { ?>
<!--<td style="text-align:center;" id="edit<?php echo $cod_gasto_inmueble_inquilino_venta;?>"><a href="../admin/venta_productos_opcion_imprimir.php?cod_gasto_inmueble_inquilino_venta=<?php echo $cod_gasto_inmueble_inquilino_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></td>-->
<?php } ?>
</tr id="<?php echo $cod_gasto_inmueble_inquilino_venta;?>">
<?php } ?>
</tbody>
...
$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
        ...
        var cod_gasto_inmueble_inquilino_venta = $(this).parent().attr('data');
        var dataString = 'llave='+cod_gasto_inmueble_inquilino_venta+'&'+'tab='+'<?php echo $tab ?>'+'&'+'campo='+'<?php echo $campo ?>'+'&'+'tipo='+'<?php echo $tipo ?>';
        ...
        $.ajax({
            ...
            success: function() {           
                $('#eliminar-ok').empty();
                $('#eliminar-ok').append('<div align="center" class="correcto">Se ha eliminado correctamente el codigo = '+cod_gasto_inmueble_inquilino_venta+'.</div>').fadeIn("slow");
                $('#'+parent).fadeOut("slow");
                $('#cod_info_factura_'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#cod_factura'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#nombre_empresa'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#fecha_anyo'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#fecha_hora'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#nombre_tipo_producto'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#edit'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#excel'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#imp'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#lista'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#tr'+cod_gasto_inmueble_inquilino_venta).fadeOut("slow");
                //$('#'+parent).remove();
            }
        });
    });
...
$(document).ready(function(){
    $('textarea[name="descripcion_gasto_inmueble_detalle"]').change(function(){ 
        ...
        var tab  = "tbl15_gasto_inmueble_inquilino_venta";
        //let id = this.id;
        var id = $(this).attr("id");

        $.ajax({ 
            url:"edit_gasto_inmueble_inquilino_ajax_reg.php", 
            method:"GET", 
