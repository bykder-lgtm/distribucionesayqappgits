...
$total_deuda                       = intval($total_venta - $total_abonado);
...
<tr>
<td style="text-align:center"><strong><a href="../admin/cuentas_cobrar_abonos.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar;?>&cod_factura=<?php echo $cod_factura;?>&cod_tercero=<?php echo $cod_tercero;?>&cliente=<?php echo $cliente;?>"><font size="5px">REGRESAR</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
...
<form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/modificar_cuentas_cobrar_reg.php">
<table class="table table-striped">
    <tr>
    ...
    <tr>
        <td style="text-align:center"><input style="font-size:24px; width: 150px;" type="number" name="abonado" value="" max="<?php echo $total_deuda; ?>" required></td>
