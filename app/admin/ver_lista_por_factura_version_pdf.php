...
tbl15_historia_clinica.fecha_ymd, tbl15_historia_clinica.nombre_empresa FROM tbl15_cliente RIGHT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente 
WHERE (((tbl15_historia_clinica.cod_factura)='$cod_factura')) ORDER BY tbl15_historia_clinica.fecha_ymd DESC";
