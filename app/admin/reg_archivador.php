...
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/reg_archivador_reg.php">
<fieldset>
...
<table border="1" class="table table-responsive">
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:center;"><input style="width: 300px;" class="input-block-level" name="nombre_paciente" type="text" value="" placeholder="" required/></td>
      <td style="text-align:center;"><input style="width: 300px;" class="input-block-level" name="nombre_medico_tratante" type="text" value="" placeholder="" /></td>
<!--
...
-->
      <td style="text-align:center;"><input style="width: 100px;" class="input-block-level" name="cod_historia_clinica" type="text" value="" placeholder="" /></td>
