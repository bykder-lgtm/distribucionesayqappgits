...
$pagina                   = $concatenador."lista_consentimiento_informado.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    // escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sTable = "tbl15_historia_clinica RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_consentimiento_informado ON tbl15_administrador.cod_administrador = tbl15_consentimiento_informado.cod_administrador) ON tbl15_cliente.cod_cliente = tbl15_consentimiento_informado.cod_cliente) ON tbl15_historia_clinica.cod_historia_clinica = tbl15_consentimiento_informado.cod_historia_clinica";
     ...
     elseif ($buscar_por=='nombre_empresa') { $columnas_busqueda = array('tbl15_consentimiento_informado.nombre_empresa'); }
     elseif ($buscar_por=='fecha_ymd') { $columnas_busqueda = array('tbl15_consentimiento_informado.fecha_ymd'); }
     elseif ($buscar_por=='cod_consentimiento_informado') { $columnas_busqueda = array('tbl15_consentimiento_informado.cod_consentimiento_informado'); }
     else {  }
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" ORDER BY tbl15_consentimiento_informado.fecha_time DESC";
} else {
    $sWhere.=" ORDER BY tbl15_consentimiento_informado.fecha_time DESC";
}
    ...
    $reload = '../admin/lista_consentimiento_informado.php';
    //loop through fetched data
    if ($numrows>0) { ?>
<table class="table table-striped jambo_table bulk_action">
<thead>
<tr class="headings">
<th class="column-title">ATR</th>
...
$sql_consulta = "SELECT tbl15_consentimiento_informado.cod_consentimiento_informado, tbl15_consentimiento_informado.cod_historia_clinica, 
tbl15_consentimiento_informado.cod_cliente, tbl15_consentimiento_informado.cod_administrador, tbl15_consentimiento_informado.motivo_cosulta, 
...
tbl15_consentimiento_informado.fecha_time, tbl15_cliente.url_img_foto_min, tbl15_cliente.url_img_firma_min 
...
$cod_consentimiento_informado        = $datos_consulta['cod_consentimiento_informado'];
...
$motivo_cosulta            = $datos_consulta['motivo_cosulta'];
...
<td align="center"><?php echo $cod_consentimiento_informado?></td>
<td><?php echo $cedula?></td>
<td><?php echo $nombres.' '.$apellido1?></td>
<td><?php echo $motivo_cosulta?></td>
<td><?php echo $nombre_prof.' '.$apellidos_prof?></td>
<td><?php echo $fecha_dmy?></td>
<td align="center"><a href="../admin/ver_trabajo_altura_version_pdf.php?cod_consentimiento_informado=<?php echo $cod_consentimiento_informado?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>" target="_blank"><img src="../imagenes/imprimir_peq.png" class="img-polaroid" alt=""></a></td>
<td align="center"><a href="../admin/edit_consentimiento_informado.php?cod_consentimiento_informado=<?php echo $cod_consentimiento_informado?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
</tr>
<?php } //end while ?>
<tr>
