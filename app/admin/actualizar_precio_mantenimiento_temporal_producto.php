...
$sql_temporal = "SELECT * FROM tbl15_mantenimiento_producto_temporal WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'";
...
$actualizar_sql = "UPDATE tbl15_mantenimiento_producto_temporal SET nombre_tipo_precio_venta = '$nombre_tipo_precio_venta', 
