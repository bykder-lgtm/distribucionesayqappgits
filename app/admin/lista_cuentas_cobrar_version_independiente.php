...
<h4>Cuentas por Cobrar - <a href="../admin/reg_cuentas_cobrar_manual_caja_registradora.php">Crear nueva cuenta por cobrar</a></h4>
<?php } ?>
</div>
<hr>
<div class="row-fluid">
...
<tr>
<form action="../admin/lista_cuentas_cobrar_version_independiente.php" method="post">
...
if (isset($_POST['palabra'])) { 
	...
	$calcular_datos_cuenta_cobrar = "SELECT cod_tercero, nombre1_tercero, apellido1_tercero, total_monto_deuda_cuenta_cobrar, total_subtotal_cuenta_cobrar, total_abonado_cuenta_cobrar, direccion_tercero, 
...
?>
		<tr>
			...
			<?php } ?>
			<td><font size='4'><a href="../admin/cuentas_cobrar_detalle_factura_caja_registradora.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $identificacion_tercero;?></a></font></td>
			<td><font size='4'><a href="../admin/cuentas_cobrar_detalle_factura_caja_registradora.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $cliente;?></a></font></td>
			...
			<td style="text-align: center;"><font size='4'><a href="../admin/cuentas_cobrar_cliente_actualizar_caja_registradora.php?cod_tercero=<?php echo $cod_tercero; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/correcto.png"></a></font></td>
		</tr>
<?php } ?>
	</tbody>
</table>
