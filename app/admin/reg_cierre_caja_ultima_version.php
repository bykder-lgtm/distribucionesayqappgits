...
?>
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/reg_cierre_caja_ultima_version_reg.php">
<fieldset>
...
<table border="1" class="table table-responsive">
	<thead>
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">USUARIO:</th>
			<td style="text-align:center">
				<select name="cod_administrador" id="cod_administrador" class="input-block-level" data-show-subtext="true" data-live-search="true" style="font-size:30px; width: 400px; height: 50px;" required>
		...
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">FECHA:</th>
			<?php if ($cod_seguridad == '1') { ?>
			<td style="text-align:left"><input type="date" name="fecha_ymd_venta_producto" id="fecha_ymd_venta_producto" class="input-block-level" value="<?php echo $fecha_ymd_venta_producto ?>" style="font-size:30px; width: 400px; height: 50px;" required></td>
			<?php } else { ?>
			<td style="font-size:50px; width: 400px; height: 50px;"><?php echo $fecha_ymd_venta_producto ?></td>
		...
		<?php if ($cod_seguridad == '1') { ?>
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">TOTAL VENTA CAJA SISTEMA:</th>
			<td style="font-size:50px; width: 400px; height: 50px;" id="total_sistema_cierre_caja">$ <?php echo number_format($total_sistema_cierre_caja, 0, ",", ".") ?></td>
		...
		<?php if ($cod_seguridad == '1') { ?>
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">TOTAL VENTA CAJA SISTEMA EN EFECTIVO:</th>
			<td style="font-size:50px; width: 400px; height: 50px;" id="total_sistema_contado_efectivo_cierre_caja"><?php echo number_format($total_sistema_contado_efectivo_cierre_caja, 0, ",", ".") ?></td>
		...
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">BASE + EFECTIVO FISICO:</th>
			<td style="font-size:50px; width: 400px; height: 50px;" id="total_base_mas_fisico_cierre_caja"></td>
			<input type="hidden" name="total_base_mas_fisico_cierre_caja" id="total_base_mas_fisico_cierre_caja_oculto" value="">
		</tr>
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">BASE CAJA:</th>
			<td style="text-align:left"><input type="number" name="total_base_cierre_caja" class="input-block-level" id="total_base_cierre_caja" onChange="calc_valor();" value="<?php echo $total_base_cierre_caja ?>" step="any" min=0 oninput="validity.valid||(value='');" style="font-size:50px; width: 400px; height: 50px;" required></td>
		</tr>
		<tr>
			<th style="text-align:right; font-size:30px; width: 600px; height: 50px;">TOTAL CAJA EN EFECTIVO FISICO:</th>
			<td style="font-size:50px; width: 400px; height: 50px;" id="total_fisico_cierre_caja"></td>
...
?>
		<tr>
			<th style="text-align:right; font-size:50px; width: 400px; height: 50px;">$ <?php echo number_format($valor_moneda, 0, ",", ".") ?></th>
    		<td style="text-align:left"><input type="number" name="<?php echo $nombre_moneda ?>" class="input-block-level" id="und_moneda<?php echo $incre;?>" value="" onChange="calc_valor();" step="any" min=0 oninput="validity.valid||(value='');" style="font-size:50px; width: 400px; height: 50px;" required></td>
