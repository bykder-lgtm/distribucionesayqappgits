...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_y_compra_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, campo_incre:campo_incre, id:<?php echo $cod_info_factura_compra; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            $.post("guardar_info_factura_y_compra_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, campo_incre:campo_incre, id:id }, function(data){
                $("#modelo").html(data);
            });
   });
});
...
<?php if ($total_datos_temp_compra <> '0') { ?>
...
<?php if ($cod_estado_soporte_factura_compra_global == '1') { ?>
    <td style="text-align:center"><br><br><input type="file" name="url_img1" id="url_img1"></td>
<?php } ?>
...
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  ...
  <tr>
    ...
    <?php if ($cod_estado_tipo_compra_global == '1') { ?>
    <td style="text-align:center;">
        <select name="nombre_tipo_compra" id="nombre_tipo_compra" class="selectpicker" data-show-subtext="true" data-live-search="true" style="width: 140px;" required>
