<?php 
$nombre_pagina                            = "Imprimir Factura";
...
if ($cod_estado_agrupar_por_producto_imp_global == '1') { 
  ...
  $select_productos_imp = 'SUM(und_venta) as und_venta, precio_venta_producto, SUM(total_venta_producto) as total_venta_producto, comentario_producto, cod_producto, cod_producto_barra, nombre_producto, iva_ptj, precio_ipc, comentario_producto'; 
} else { 
  $agrupar_productos_imp = ''; 
  $select_productos_imp = 'und_venta, precio_venta_producto, total_venta_producto, comentario_producto, cod_producto, cod_producto_barra, nombre_producto, iva_ptj, precio_ipc, comentario_producto'; 
}
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$resta                               = 1516399999;
...
<table class="table table-dark">
    <thead>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">TIPO FACTURA:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo $nombre_tipo_factura; ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">FACTURA NO:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo $cod_factura; ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">TIPO DE PAGO:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo $nombre_tipo_pago; ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">FACTURA:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo $cod_factura; ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">CLIENTE:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo $nombre_cliente; ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">SUBTOTAL:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($subtotal_base_sin_descuento, 0, ",", "."); ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">%DESCUENTO:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo intval($descuento_ptj_dif).'%'; ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">$DESCUENTO:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($total_descuento_venta, 0, ",", "."); ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">IVA:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($total_iva, 0, ",", "."); ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">TOTAL VENTA:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($total_venta_temp, 0, ",", "."); ?></th>
        </tr>
        <?php if (($cod_tipo_pago == '2') && ($cod_estado_tipo_venta_zapateria_global == '1')) { ?>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">ABONADO:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($abonado, 0, ",", "."); ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-light border" style="text-align:center; font-size:20pt;">PENDIENTE:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($subtotal, 0, ",", "."); ?></th>
        </tr>
        <?php } ?>

        <?php if ($cod_tipo_pago == '1') { ?>
        <tr>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;">RECIBIDO:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($vlr_cancelado, 0, ",", "."); ?></th>
        </tr>
        <tr>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;">CAMBIO:</th>
            <th scope="col" class="col-6 bg-success border" style="text-align:center; font-size:20pt;"><?php echo number_format($vlr_cambio, 0, ",", "."); ?></th>
        </tr>
        <?php } ?>
    </thead>
</table>
...
<table class="table table-dark">
    <thead>
        <tr>
            <th scope="col" style="text-align:center;"><a href="<?php echo $pagina?>" id="listo"><img src="../imagenes/listo.png" alt="listo"><br>REGRESAR</a></th>
            <?php if ($cod_estado_habilitar_btn_imp_venta_nav_global == '0') { ?>
            <th scope="col" style="text-align:center;"><a href="javascript:void(0);" id="foco_btn_imprimir" onclick="printPageArea('area_imprimible_invisible')"><img src="../imagenes/imprimir_directa_pos.png" alt="imprimir"><br>IMPRIMIR FACTURA</a></th>
            <?php } ?>
            <?php if ($cod_estado_btn_imprimir_venta_nav_zapateria_global == '1') { ?>
            <th scope="col" style="text-align:center;"><a href="javascript:void(0);" id="foco_btn_imprimir2" onclick="printPageAreaCocina('area_imprimible_invisible_cocina')"><img src="../imagenes/imprimir_directa_pos.png" alt="imprimir"><br>IMPRIMIR TICKET</a></th>
            <?php } ?>
            <?php if ($cod_estado_habilitar_btn_imp_venta_direct_driv_global == '0') { ?>
            <th scope="col" style="text-align:center;"><button id="btnImprimir"><img src="../imagenes/imprimir_2.png" alt="imprimir"></button><br>IMPRIMIR FACTURA</th>
            <?php } ?>
            <?php if ($cod_estado_habilitar_btn_imp_nav_carta_pdf_global == '0') { ?>
            <th scope="col" style="text-align:center;"><a href="../admin/ver_factura_venta_pdf.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta?>" target="_blank"><img src="../imagenes/imprimir_.png"></a><br>IMPRIMIR FACTURA PDF</th>
            <?php } ?>
            <?php if ($cod_estado_abrir_cajon_monedero_driv_direct == '1') { ?>
            <th scope="col" style="text-align:center;"><button id="btnAbrirCaja"><img src="../imagenes/abrir_caja_reg.png" alt="Abrir"></button><br>ABRIR CAJON MONEDERO</th>
            <?php } ?>
        </tr>
    </thead>
</table>
...
<th style="text-align: center; width:50%; font-family: Courier; font-size:9pt;"><strong>DESCIPCION</strong></th>
...
<td style="text-align: center; width:10%; font-family: Courier; font-size:7pt;"><strong>CANT</strong></td>
<?php if ($cod_estado_comentario_venta_mostrar_imprimir_global == '1') { ?><th style="text-align: center; width:10%; font-family: Courier; font-size:7pt;">..</th><?php } ?>
<td style="text-align: center; width:50%; font-family: Courier; font-size:7pt;"><strong>DESCIPCION</strong></td>
