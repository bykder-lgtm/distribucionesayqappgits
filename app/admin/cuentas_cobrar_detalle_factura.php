...
<tr>
<td style="text-align: center;"><strong><a href="../admin/lista_cuentas_cobrar.php"><font size="5px">REGRESAR</font></a></strong></td>
</tr>
<tr>
...
<!--
<tr>
<td style="text-align: center;"><strong><a href="../admin/ver_cuentas_cobrar_abonos_globales.php?cod_tercero=<?php echo $cod_tercero ?>&cliente=<?php echo $cliente ?>"><font size="5px">VER ABONOS GLOBALES</font></a></strong></td><br><br>
</tr>
-->
</table>
...
<tr>
<?php
if ($cod_estado_cuenta_cobrar_abono_glob_global== '1') { 
if ($total_facturas > 1) { ?>
<td style="text-align: center;"><a href="../admin/cuentas_cobrar_abono_global_cliente.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar?>&cod_tercero=<?php echo $cod_tercero?>"><img src=../imagenes/abono_global.png alt="imprimir"><br>ABONO GLOBAL</a></td>
<?php } else { ?>
<td style="text-align: center;"><a href="../admin/modificar_cuentas_cobrar.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar?>&cod_factura=<?php echo $cod_factura?>&cod_tercero=<?php echo $cod_tercero?>&cliente=<?php echo $cliente?>"><img src=../imagenes/abono_global.png alt="imprimir"><br>ABONO GLOBAL</a></td>
<?php } ?>
<?php } ?>
...
<table class="table table-striped">
	<tr>
		...
		<td style="text-align: center;"><strong>ARCHIVAR</strong></td>
		<?php } ?>
...
?>
	<tr>
		<?php if ($cod_estado_cuenta_cobrar_eliminar == '1') { ?>
			<!--<?php if ($subtotal <= '0') { ?><td style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_cuentas_cobrar; ?>&tab=<?php echo $tab; ?>&campo=<?php echo $campo; ?>&tipo=<?php echo $tipo; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td><?php } else { ?><td></td><?php } ?>-->
			<?php if ($subtotal <= '0') { ?><td style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_cuentas_cobrar; ?>&tab=<?php echo $tab2; ?>&campo=<?php echo $campo; ?>&tipo=<?php echo $tipo; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/btn_archivar.png" class="img-polaroid" alt=""></a></td><?php } else { ?><td></td><?php } ?>
		<?php } ?>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:10pt;">
  <tr>
    <th style="text-align: left; width: 50%; font-family: Courier; font-size:10pt;">NIT CLIENTE: <?php echo $identificacion_tercero; ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 50%; font-family: Courier; font-size:10pt;">NOMBRE CLIENTE: <?php echo $nombre_cliente; ?></th>
  </tr>
</table>
...
<table border="1" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:9pt;">
	<tr>
		<th style="text-align: center; width:10%; font-family: Courier; font-size:9pt;">FACT</th>
		<th style="text-align: center; width:50%; font-family: Courier; font-size:9pt;">CREDIT</th>
		<th style="text-align: center; width:15%; font-family: Courier; font-size:9pt;">ABONAD</th>
		<th style="text-align: center; width:5%; font-family: Courier; font-size:9pt;">PENDIENTE</th>
		<!--<th style="text-align: center; width:5%; font-family: Courier; font-size:9pt;">FECHA</th>-->
	<tr>
</tr>
<?php
...
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar.cod_tercero 
WHERE (tbl15_cuentas_cobrar.cod_tercero='$cod_tercero')  AND (tbl15_cuentas_cobrar.cod_estado_archivado = '0') ORDER BY tbl15_cuentas_cobrar.fecha_invert DESC";
$consulta_datos_cuenta_cobrar = mysqli_query($conectar, $calcular_datos_cuenta_cobrar);
$total_datos = mysqli_num_rows($consulta_datos_cuenta_cobrar);
while ($datos_cuenta_cobrar = mysqli_fetch_assoc($consulta_datos_cuenta_cobrar)) {
...
?>
<tr>
<td style="text-align: center; font-family: Courier; font-size:9pt;"><strong><?php echo $cod_factura ?></strong></td>
<td style="text-align: right; font-family: Courier; font-size:9pt;"><strong><?php echo number_format($monto_deuda, 0, ",", ".") ?></strong></td>
<td style="text-align: right; font-family: Courier; font-size:9pt;"><strong><?php echo number_format($abonado, 0, ",", ".") ?></strong></td>
<td style="text-align: right; font-family: Courier; font-size:9pt;"><strong><?php echo number_format($subtotal, 0, ",", ".") ?></strong></td>
<!--<td style="text-align: right; font-family: Courier; font-size:9pt;"><strong><?php echo $fecha ?></strong></td>-->
</tr>
<?php } ?>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:9pt;">
  <tr>
    <th style="text-align: left; width: 50%; font-family: Courier; font-size:9pt;">TOTAL CREDITO:</th>
    <th style="text-align: right; width: 45%; font-family: Courier; font-size:9pt;">$ <?php echo number_format($monto_deuda_smtr_1, 0, ",", ".") ?></th>
    <th style="text-align: center; width: 5%; font-family: Courier; font-size:9pt;"></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 50%; font-family: Courier; font-size:9pt;">TOTAL ABONADO:</th>
    <th style="text-align: right; width: 45%; font-family: Courier; font-size:9pt;">$ <?php echo number_format($abonado_smtr_1, 0, ",", ".") ?></th>
    <th style="text-align: center; width: 5%; font-family: Courier; font-size:9pt;"></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 50%; font-family: Courier; font-size:9pt;">TOTAL PENDIENTE:</th>
    <th style="text-align: right; width: 45%; font-family: Courier; font-size:9pt;">$ <?php echo number_format($subtotal_smtr_1, 0, ",", ".") ?></th>
    <th style="text-align: center; width: 5%; font-family: Courier; font-size:9pt;"></th>
  </tr>
</table>
