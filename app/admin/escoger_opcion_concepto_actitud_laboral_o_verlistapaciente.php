...
$sql_actitud_laboral = "SELECT * FROM tbl15_actitud_laboral WHERE cod_historia_clinica = '$cod_historia_clinica'";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/edit_concepto_actitud_laboral.php?cod_actitud_laboral=<?php echo $cod_actitud_laboral ?>&cod_historia_clinica=<?php echo $cod_historia_clinica ?>&cod_cliente=<?php echo $cod_cliente ?>"><button type="button" class="btn btn-primary">Desea Digilenciar el Concepto de Aptitud Laboral?</button></a>
