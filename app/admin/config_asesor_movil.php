...
<style>
/* ============================================ */
/* CONFIG ASESOR - TEMA VERDE ESMERALDA        */
/* ============================================ */
...
.menu-item-icon.green { background: rgba(16, 185, 129, 0.15); color: #10b981; }
...
<main class="page-container">
    ...
    <div class="profile-card animate-in delay-1">
        ...
        <div class="profile-role">Asesor Comercial</div>
    ...
    <div class="menu-section animate-in delay-2">
        ...
        <div class="menu-list">
            <a href="dashboard_asesor_movil.php" class="menu-item">
            ...
            <a href="lista_tarea_asesor_movil.php" class="menu-item">
            ...
            <a href="lista_tienda_asesor_movil.php" class="menu-item">
            ...
            <a href="mapa_tiendas_asesor_movil.php" class="menu-item">
                <div class="menu-item-icon green">
    ...
    <div class="menu-section animate-in delay-3">
        ...
        <div class="menu-list">
            <a href="edit_perfil_asesor.php" class="menu-item">
                <div class="menu-item-icon purple">
            ...
            <a href="cambiar_contrasena_asesor_movil.php" class="menu-item">
                <div class="menu-item-icon blue">
...
<!--
    <div class="menu-section animate-in delay-3">
        ...
        <div class="menu-list">
            <a href="lista_tienda_asesor_diseno_vertical.php" class="menu-item">
                <div class="menu-item-icon green">
...
function marcarTodasLeidasMovil() {
    Swal.fire({
        title: '¿Marcar todas como leídas?', text: 'Se marcarán todas las notificaciones pendientes como leídas', icon: 'question', showCancelButton: true, confirmButtonColor: '#10b981',
