...
$sql_laboratorio = "SELECT tbl15_laboratorio.cod_laboratorio, tbl15_laboratorio.nombre_laboratorio, tbl15_laboratorio.cod_estado, tbl15_laboratorio.cod_tipo_historia_clinica, 
tbl15_tipo_historia_clinica.nombre_tipo_historia_clinica, tbl15_estado.nombre_estado
FROM tbl15_tipo_historia_clinica RIGHT JOIN (tbl15_estado RIGHT JOIN tbl15_laboratorio ON tbl15_estado.cod_estado = tbl15_laboratorio.cod_estado) ON 
tbl15_tipo_historia_clinica.cod_tipo_historia_clinica = tbl15_laboratorio.cod_tipo_historia_clinica";
