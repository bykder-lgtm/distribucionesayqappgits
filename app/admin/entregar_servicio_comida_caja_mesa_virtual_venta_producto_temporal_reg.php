...
if (isset($_GET["cod_venta_producto_temporal"])) {
    ...
    if ($cod_estado_deshabilitar_und_venta_atendido_cocina_chef == '1') {
        $data_sql = ("UPDATE tbl15_venta_producto_temporal SET cod_estado_componente_und_venta = '$cod_estado_componente_und_venta' WHERE (cod_venta_producto_temporal = '$cod_venta_producto_temporal')") ;
        $exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
    }
?>
