...
<a href="../admin/facturacion_venta_temporal_gasto_inmueble_detalle.php"><h4><?php echo $nombre_concepto_multi_virtual; ?>S VIRTUALES</a>
</div>
<hr>
-->
...
if (isset($_GET['cod_tercero_propietario']) && ($_GET['cod_tercero_propietario'] <> '') && ($_GET['cod_tercero_propietario'] <> '0')) { $cod_tercero_propietario = intval($_GET['cod_tercero_propietario']); $filtro_tercero_propietario = "AND (cod_tercero_propietario = '$cod_tercero_propietario')"; } else { $cod_tercero_propietario = ''; $filtro_tercero_propietario = ""; }
...
<form action="" id="" method="GET">
    <table class="table table-striped" cellspacing="0" cellpadding="20">
      <tr>
        <th style="text-align:center;">CUENTAS DE INMUEBLES PROPIETARIOS</th>
      </tr>
    </table>
    ...
    <table class="table table-striped" cellspacing="0" cellpadding="20">
      <tr>
        ...
        <th style="text-align:center;"><a href="../admin/crear_caja_virtual_sesion_gasto_inmueble_detalle.php?pagina=<?php echo $pagina ?>">CREAR NUEVO GASTO A PROPIETARIOS</a></th>
      </tr>
    </table>
...
WHERE (nombre_estado_factura = 'ABIERTA') $filtro_tercero_propietario $filtro_buscar_mesa $ordenar_consulta";
} else {
$mostrar_datos_sql = "SELECT cod_caja_virtual, cuenta, cod_info_gasto_inmueble_detalle_venta, cod_tercero, fecha_anyo, cod_administrador, 
fecha_hora, cod_base_caja, nombre_producto, 
fecha_modificacion, cod_tercero_propietario, cod_factura FROM tbl15_info_gasto_inmueble_detalle_venta 
WHERE (cuenta = '$cuenta_actual') AND (nombre_estado_factura = 'ABIERTA') $filtro_tercero_propietario $filtro_buscar_mesa $ordenar_consulta";
}
...
<td style="text-align:left;"><a href="../admin/entrar_sesion_gasto_inmueble_detalle_temporal_caja_virtual.php?cod_info_gasto_inmueble_detalle_venta=<?php echo $cod_info_gasto_inmueble_detalle_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo $nombre_producto_concat; ?></a></td>

<td style="text-align:left;"><a href="../admin/entrar_sesion_gasto_inmueble_detalle_temporal_caja_virtual.php?cod_info_gasto_inmueble_detalle_venta=<?php echo $cod_info_gasto_inmueble_detalle_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo $nombre1_tercero_propietario.' | '.$nombre_producto; ?></a></td>
<td style="text-align:center;"><a href="../admin/entrar_sesion_gasto_inmueble_detalle_temporal_caja_virtual.php?cod_info_gasto_inmueble_detalle_venta=<?php echo $cod_info_gasto_inmueble_detalle_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><?php echo number_format($total_precio_venta_producto_ciclo, 0, ",", "."); ?></a></td>
<td style="text-align:center;"><?php echo $cod_info_gasto_inmueble_detalle_venta ?></td>
<?php if ($cod_estado_eliminar_caja_mesa_virtual=='1') { ?>
<td style="text-align:center;"><a href="../admin/eliminar_caja_virtual_info_gasto_inmueble_detalle_venta.php?cod_info_gasto_inmueble_detalle_venta=<?php echo $cod_info_gasto_inmueble_detalle_venta ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina_local ?>"><img src=../imagenes/eliminar.png alt="eliminar"></td>
<?php } ?>
</tr>
<?php } ?>
</table>
