...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_certificado_retencion_en_la_fuente_venta.php"><font size='+1'>Registrar Certificado Retefuente Manual (Venta)</font></a></th>
    </tr>
</table>
<hr>
<div class="row-fluid">
...
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/reg_certificado_retencion_en_la_fuente_venta_manual_reg.php">
<fieldset>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<input type="hidden" name="nombre_certificado_retefuente" value="RETENCIÓN APLICADA A VENTAS DECLARANTES">
<input type="hidden" name="nombre_origen_modulo" value="VENTA">
