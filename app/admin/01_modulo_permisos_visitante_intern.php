...
if ($url_pag_redirec_ini_sesion == '') {
	$url_pag_redirec_ini_sesion = '../admin/lista_info_factura_venta_revisor_diseno_vertical.php';
} else {
	$url_pag_redirec_ini_sesion = $url_pag_redirec_ini_sesion;
}


if ($cod_estado_cliente == '1') { 
	$nombre_tipo_tercero = 'CLIENTE'; 
	$nombre_compo_interes_ptj = '';
	$nombre_compo_aval_ptj = '';
} elseif ($cod_estado_lider == '1') { 
	$nombre_tipo_tercero = 'LIDER'; 
	$nombre_compo_interes_ptj = 'lider_interes_ptj';
	$nombre_compo_aval_ptj = 'lider_aval_ptj';
} elseif ($cod_estado_coordinador == '1') { 
	$nombre_tipo_tercero = 'COORDINADOR'; 
	$nombre_compo_interes_ptj = 'coordinador_interes_ptj';
	$nombre_compo_aval_ptj = 'coordinador_aval_ptj';
} elseif ($cod_estado_asesor == '1') {
	$nombre_tipo_tercero = 'ASESOR'; 
	$nombre_compo_interes_ptj = 'asesor_interes_ptj';
	$nombre_compo_aval_ptj = 'asesor_aval_ptj';
} elseif ($cod_estado_proveedor == '1') { 
	$nombre_tipo_tercero = 'PROVEEDOR'; 
	$nombre_compo_interes_ptj = 'proveedor_interes_ptj';
	$nombre_compo_aval_ptj = 'proveedor_aval_ptj';
} elseif ($cod_estado_vendedor == '1') { 
	$nombre_tipo_tercero = 'VENDEDOR'; 
	$nombre_compo_interes_ptj = 'vendedor_interes_ptj';
	$nombre_compo_aval_ptj = 'vendedor_aval_ptj';
} elseif ($cod_estado_aliado_estrategico == '1') {
