...
if (isset($_GET['fecha_ymd_venta_producto_ini'])) {
  ...
  $nombre_tipo_asunto                         = 'Recordatorio Cumpleaños de Clientes';
  ...
  * { line-height: inherit; }
  ...
  <thead>
    <tr>
      ...
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Mensaje</span></th>
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Observaciones</span></th>
      <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Fecha Cumplaños</span></th>
    </tr>
  </thead>
  <tbody>
  ";
  ...
  if ($dias_seg > 0) { $mensaje_dias_cumple = "CUMPLE DENTRO DE ".$dias." DIAS"; $total_reg++;} elseif ($dias_seg < 0) { $mensaje_dias_cumple = "CUMPLIO HACE ".$dias." DIAS"; } else { $mensaje_dias_cumple = "CUMPLE HOY"; }
  ...
  $mensaje .= "
    <tr>
      <td style='text-align:left'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$nombre_tercero."</span></td>
      <td style='text-align:left'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$mensaje_dias_cumple."</span></td>
      <td style='text-align:left'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$concat_observ."</span></td>
      <td style='text-align:center'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$fecha_cumpleanos_actual."</span></td>
    </tr>
  ";
  }
  }
  ...
  if ($total_reg <> '0') {
    ...
    $cod_tipo_modulo_envio_correo         = "4";
    $nombre_tipo_modulo_envio_correo      = "CUMPLEAÑOS DE TERCEROS - EDITAXE POS";
    $id_origen_correo                     = "";
    $nombre_tabla_origen_correo           = "tbl15_tercero";
    $nombre_campo_origen_correo           = "cod_tercero";
    $nombre_origen_correo                 = "Recordatorio cumpleaños tercero";
