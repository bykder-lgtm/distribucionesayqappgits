...
$(document).ready(function() {
    ...
    $.ajax({
        type: "POST",
        dataType: 'html',
        url: "../admin/guardar_consulta_select_factura_compra_manual_interna_ajax.php",
...
function Cargar_nombre_cliente(valor, campo, tipo_ajax) {
    ...
    $('#'+capa_cargar_datos).load("../admin/recargar_consulta_select_factura_compra_manual_interna_ajax.php", { 'valor': valor, 'campo': campo, 'tipo_ajax': tipo_ajax });
