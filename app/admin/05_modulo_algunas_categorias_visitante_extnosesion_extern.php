...
?>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="<?php echo $nombre_carpeta_pagina ?>/<?php echo $nombre_carpeta_pagina ?>/<?php echo $url_categoria_orig ?>" alt="" />
                        <a class="btn hvr-hover" href="<?php echo $nombre_carpeta_pagina ?>/admin/ver_catalogo_producto_visitante_extnosesion.php?nombre_categoria_codifcryp=<?php echo $nombre_categoria_codifcryp ?>">VER MAS</a>
