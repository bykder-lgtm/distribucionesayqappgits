...
$pagina                   = $concatenador."lista_cuentas_cobrar_alerta_historial_alquiler_detalle.php";
...
// escaping, additionally removing everything that could be (html/javascript-) code
    ...
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = "WHERE ((nombre_tipo_tercero = '$nombre_tipo_tercero') OR (nombre_tipo_tercero = 'AMBOS')) AND (";
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" WHERE ((nombre_tipo_tercero = '$nombre_tipo_tercero') OR (nombre_tipo_tercero = 'AMBOS')) ORDER BY cod_tercero DESC";
} else {
...
include_once('../ajax/pagination.php'); //include pagination file
    ...
    $reload             = '../admin/lista_cuentas_cobrar_alerta_historial_alquiler_detalle.php';
