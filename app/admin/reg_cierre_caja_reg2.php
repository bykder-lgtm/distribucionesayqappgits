...
//---------------------------------------------------------------------------------------------------------------------------------------------//
  ...
  $pagina                                                       = "../admin/factura_cierre_caja_opcion_imprimir.php"."?cod_cierre_cajas=".$cod_cierre_cajas;
//---------------------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------------------//
  ...
  $agregar_operacion = "INSERT INTO tbl15_cierre_caja (cod_cierre_caja, total_sistema_cierre_caja, total_sistema_contado_efectivo_cierre_caja, 
  total_base_mas_fisico_cierre_caja, resultado_cierre_caja, total_fisico_cierre_caja, 
  ...
  VALUES ('$cod_cierre_caja', '$total_sistema_cierre_caja', '$total_sistema_contado_efectivo_cierre_caja', 
  '$total_base_mas_fisico_cierre_caja', '$resultado_cierre_caja', '$total_fisico_cierre_caja', 
  '$moneda_50', '$moneda_100', '$moneda_200', '$moneda_500', '$moneda_1000', '$moneda_2000', '$moneda_5000', 
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
  if ($cod_estado_generar_movimiento_contable_automatico_global == '1') {
    ...
    $fecha_anyo_seg                                             = strtotime($fecha_ymd_venta_producto);
    $fecha_dia                                                  = date("Y-m-d", $fecha_anyo_seg);
    $fecha_mes                                                  = date("Y-m", $fecha_anyo_seg);
    $anyo                                                       = date("Y", $fecha_anyo_seg);
...
/* ----------------------------------------------------------------------------------------------------------/ */
    ...
    if ($total_venta_producto_contado_efectivo > 0) {
      ...
      $tipo_puc                                                 = 'ACTIVO';
      $und_vendida                                              = '1';
      $costo_movimiento_contable                                = $total_venta_producto_contado_efectivo;
      $total_costo_movimiento_contable                          = $total_venta_producto_contado_efectivo;
    ...
    if ($total_venta_contado_transferencia_electronica > 0) {
      ...
      $cod_puc                                                  = '2541';
      $codigo_puc                                               = '11100502';
      $nombre_puc                                               = 'CUENTA BANCOLOMBIA 1';
      $tipo_puc                                                 = 'ACTIVO';
      $und_vendida                                              = '1';
      $costo_movimiento_contable                                = $total_venta_contado_transferencia_electronica;
      $total_costo_movimiento_contable                          = $total_venta_contado_transferencia_electronica;
