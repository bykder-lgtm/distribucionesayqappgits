...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>LISTA DE INVENTARIOS</font></a></th>

        <th style="text-align:right"><a href="../admin/pregunta_producto_copia_inventario_inicial.php?si=<?php echo $si ?>&pagina=<?php echo $pagina ?>"><font size='+2'>CREAR INVENTARIO INICIAL</font></a></th>

        <?php if ($cod_estado_nuevo_inventario_por_letra_global == '1') { ?>
        <th style="text-align:right"><a href="../admin/pregunta_producto_copia_inventario_alfabetico_por_letra.php?pagina=<?php echo $pagina ?>"><font size='+2'>NUEVO INVENTARIO POR LETRA</font></a></th>
        <?php } ?>

        <?php if ($cod_estado_prod_nuevo_invenario == '1') { ?>
        <th style="text-align:right"><a href="../admin/pregunta_producto_copia_inventario_por_dependencia.php?pagina=<?php echo $pagina ?>"><font size='+2'>NUEVO INVENTARIO</font></a></th>
        <?php } ?>
    </tr>
</table>
...
<td style="text-align:center"><a href="../admin/cargar_producto_copia_inventario.php?cod_info_producto_copia_inventario=<?php echo $cod_info_producto_copia_inventario?>&pagina=<?php echo $pagina?>"><img src=../imagenes/mas2.png alt="mas"></a></td>
<?php } ?>
<?php } else  { ?>
