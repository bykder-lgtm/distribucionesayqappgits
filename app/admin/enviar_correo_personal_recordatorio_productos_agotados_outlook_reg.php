...
if (isset($_GET['fecha_ymd_venta_producto_ini'])) {
  ...
  $nombre_tipo_asunto                         = 'Productos Agotados';
  ...
  * { line-height: inherit; }
  ...
  <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Und</span></th>
  ...
  <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Fecha Modificacion</span></th>
  </tr>
  </thead>
  <tbody>
  ";
  ...
  $sql_total_forma_pago = "SELECT und_producto, cod_producto_barra, nombre_producto, tope_min, nombre_producto, precio_venta_producto, cod_opcion_descontable_inv, fecha_ult_venta, fecha_modificacion
  FROM tbl15_producto WHERE (und_producto <= '0') AND (cod_opcion_descontable_inv = '0') 
  ...
  $und_producto                            = $datos_total_forma_pago['und_producto'];
  $cod_producto_barra                      = $datos_total_forma_pago['cod_producto_barra'];
  $nombre_producto                         = $datos_total_forma_pago['nombre_producto'];
  $tope_min                                = $datos_total_forma_pago['tope_min'];
  $nombre_producto                         = $datos_total_forma_pago['nombre_producto'];
  $precio_venta_producto                   = $datos_total_forma_pago['precio_venta_producto'];
  $cod_opcion_descontable_inv              = $datos_total_forma_pago['cod_opcion_descontable_inv'];
  $fecha_ult_venta                         = $datos_total_forma_pago['fecha_ult_venta'];
  $fecha_modificacion                      = $datos_total_forma_pago['fecha_modificacion'];
  ...
  <td style='text-align:center'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".number_format($und_producto, 0, ",", ".")."</span></td>
  ...
  <td style='text-align:center'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$fecha_modificacion."</span></td>
  ...
  if ($total_reg <> '0') {
    $cod_tipo_modulo_envio_correo         = "3";
    $nombre_tipo_modulo_envio_correo      = "PRODUCTOS AGOTADOS - EDITAXE POS";
    $id_origen_correo                     = "";
    $nombre_tabla_origen_correo           = "tbl15_producto";
    $nombre_campo_origen_correo           = "cod_producto_barra";
    $nombre_origen_correo                 = "Recordatorio productos agotados";
