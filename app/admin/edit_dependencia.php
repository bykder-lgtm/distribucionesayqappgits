...
$mostrar_datos_sql = "SELECT * FROM tbl15_dependencia WHERE cod_dependencia = '$cod_dependencia'";
...
?>
<form name="formulario_edicion" accept-charset="utf-8" method="post" action="../admin/edit_dependencia_reg.php">
<fieldset>
...
<td><input type="text" name="nombre_dependencia" value="<?php echo ($nombre_dependencia) ?>"  class="input-block-level" required/></td>
<td>        
