...
$sql_info_factura = "SELECT * FROM tbl15_info_factura_mantenimiento WHERE cod_info_factura_venta = '$cod_info_factura_venta'";
  ...
  <tr>
    ...
    <td width="345" valign="top"><p>&nbsp;
       <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:90%">
          <tr>
            <td style="text-align:center">FACTURA DE MANTENIMIENTO</td>
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
  <tr>
    ...
    <td width="40" valign="top">Nit: '.$identificacion_tercero.'</td>
  </tr>
  <tr>
    ...
    <td width="576" height="400" valign="top"><p>&nbsp;</p>
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
          <tr>
            ...
            <td style="text-align:left" width="250" valign="top"><strong>Comentario</strong></td>
...
$sql_motivo_conteo = "SELECT * FROM tbl15_mantenimiento_producto WHERE (cod_factura = '$cod_factura') ORDER BY cod_venta_producto DESC";
...
$comentario_producto            = $info_motivo_conteo['comentario_producto'];
...
$codigoHTML.='
          <tr>
            ...
            <td style="text-align:left">'.$comentario_producto.'</td>
