...
if (isset($_GET['cod_estado_hoy'])) { $cod_estado_hoy = addslashes($_GET['cod_estado_hoy']); } else { $cod_estado_hoy = '0'; }
if (isset($_GET['cod_estado_pago'])) { $cod_estado_pago = addslashes($_GET['cod_estado_pago']); } else { $cod_estado_pago = '2'; }
...
<script type="text/javascript" src="../admin/busqueda_paginacion_cuentas_cobrar_alerta_agrupado_historial_alquiler_inquilino_detalle_ajax.js"></script>
