...
<div class="modal fade" id="modalDetalleCredito" tabindex="-1" aria-labelledby="modalDetalleCreditoLabel" aria-hidden="true">
    ...
    <div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 0.1rem; display: block; position: relative;">
        <button type="button" class="btn-close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Cerrar" style="position: absolute; top: 0.8rem; right: 0.8rem; background: none; border: none; cursor: pointer; z-index: 10;">
			...
			<div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 1.5rem; display: block; position: relative;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    <div style="text-align: left;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">Valor a Credito</p>
                        <p style="font-size: 1.2rem; font-weight: 700; color: white; margin: 0;">$<span id="modalValorCredito"></span></p>
                    </div>
                    <div style="text-align: right;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">Valor de Contado</p>
                        <p style="font-size: 1.2rem; font-weight: 700; color: white; margin: 0;">$<span id="modalTotalPrecioVenta"></span></p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    <div style="text-align: left;">
                        ...
                        <p style="font-size: 1.2rem; font-weight: 700; color: white; margin: 0;"><span id="modalTipoVenta"></span></p>
                    </div>
                    <div style="text-align: right;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">Asesor</p>
                        <p style="font-size: 1rem; font-weight: 700; margin: 0;"><span id="modalNombresApellidosAsesor" style="color: white;"></span></p>
                    </div>
                </div>
            </div>
			...
			<div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 1.5rem; display: block; position: relative;">
				...
				<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    <div style="text-align: left;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">Línea de Crédito</p>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <p style="font-size: 1.2rem; font-weight: 700; color: white; margin: 0;"><span id="modal_entidad_crediticia"></span></p>
                            <button type="button" id="btnEditarEntidadCrediticia" onclick="abrirModalEditarEntidadCrediticia(document.getElementById('modalIDApp').textContent, document.getElementById('modalCodEntidadCrediticia').value)" 
                                style="background: #667eea; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: center;">
                                <i class="fa fa-edit" style="margin-right: 4px;"></i>Editar
                            </button>
                        </div>
                    </div>
                    <div style="text-align: right;">
			...
			<div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 1.5rem; display: block; position: relative;">
				<div style="margin-bottom: 1rem;">
					<p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.8rem; text-align: center;">
						<i class="fa fa-camera" style="margin-right: 8px; color: #00d4ff;"></i>Imágenes Capturadas</p>
					<div id="modal_imagenes_container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 12px; max-height: 200px; overflow-y: auto;">
            ...
            <!-- Footer con botón de cierre prominente -->
            <div class="modal-footer" style="border-top: 1px solid rgba(255,255,255,0.06); padding: 1rem; justify-content: center;">
                <button type="button" id="btnCerrarModalDetalleCredito" class="btn" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Cerrar" style="background: linear-gradient(90deg,#ef4444,#f97316); color: #fff; font-weight:700; padding: 0.75rem 1.25rem; border-radius: 10px; width: 100%; max-width: 320px;">
                    Cerrar
                </button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 500px;">
        <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 8px 25px rgba(0,0,0,0.15); background: #ffffff;">
            <div class="modal-header" style="border-bottom: 1px solid #e2e8f0; padding: 1.5rem;">
                <h5 class="modal-title" id="modalEditarEntidadCrediticiaLabel" style="color: #2d3748; font-weight: 700;">
                    <i class="fa fa-credit-card" style="margin-right: 8px; color: #667eea;"></i>
                    Editar Linea de Credito y Simular
                </h5>
                <button type="button" class="btn-close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Cerrar" style="background: none; border: none; font-size: 1.5rem; color: #a0aec0;">×</button>
            </div>
            
            <div class="modal-body" style="padding: 2rem;">
                <input type="hidden" id="cod_info_factura_venta_editar" value="">
                
                <!-- Selección de Entidad Crediticia -->
                <div class="mb-3">
                    <label style="color: #4a5568; font-weight: 600; margin-bottom: 0.5rem; display: block;">Entidad Crediticia</label>
                    <select id="cod_entidad_crediticia" class="form-control" style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 0.9rem;" onchange="actualizarPorcentajeEntidad()">
                ...
                <div id="infoEntidadSeleccionada" style="background: #f7fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 1rem; margin-bottom: 1rem; display: none;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: #4a5568; font-size: 0.85rem;">Porcentaje de interés:</span>
                        <span id="porcentajeEntidad" style="color: #667eea; font-weight: 700; font-size: 1rem;"></span>
                    </div>
                </div>
                <!-- Valor de Contado -->
                <div class="mb-3">
                    <label style="color: #4a5568; font-weight: 600; margin-bottom: 0.5rem; display: block;">Valor de Contado</label>
                    <input type="number" id="precio_venta_producto" class="form-control" 
                        style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 0.9rem;" 
                        placeholder="Ingrese el valor de contado"
                        onkeyup="calcularValorCredito()" onchange="calcularValorCredito()">
                </div>
                <!-- Número de Cuotas -->
                <div class="mb-3">
                    <label style="color: #4a5568; font-weight: 600; margin-bottom: 0.5rem; display: block;">Número de Cuotas</label>
                ...
                <div id="resultadosCalculo" style="background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 10px; padding: 1.5rem; color: white; margin-bottom: 1rem; display: none;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <div style="text-align: center;">
                            <p style="font-size: 0.8rem; opacity: 0.8; margin-bottom: 0.3rem;">Valor Total</p>
                    ...
                    <div style="text-align: center; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.2);">
                        <p style="font-size: 0.8rem; opacity: 0.8; margin-bottom: 0.3rem;">Intereses Generados</p>
                        <p style="font-size: 1.1rem; font-weight: 700; margin: 0;">$<span id="interesesGenerados">0</span></p>
                    </div>
                </div>
            </div>
            
            <div class="modal-footer" style="border-top: 1px solid #e2e8f0; padding: 1.5rem; justify-content: space-between;">
                <button type="button" class="btn btn-light" data-dismiss="modal" data-bs-dismiss="modal" 
                    style="padding: 0.75rem 1.5rem; border-radius: 8px; font-weight: 600; color: #4a5568;">
                    Cancelar
                </button>
                <button type="button" id="btnGuardarEntidadCrediticia" onclick="guardarEntidadCrediticia()" 
                    style="background: linear-gradient(135deg, #48bb78, #38a169); color: white; border: none; border-radius: 8px; padding: 0.75rem 1.5rem; font-weight: 600;">
...
function abrirModalDetalleCredito(nombre, cedula, valor, tipoVenta, entidad_crediticia, operador_credito, tienda, aliado, nombre_banco_cuenta, estadoCredito, estado_revision, fecha, hora, observacion_tercero, idApp, nombres_apellidos_asesor, total_precio_venta, codEntidadCrediticia) { 
    document.getElementById('modalNombreCliente').textContent = nombre;
    document.getElementById('modalCedulaCliente').textContent = cedula;
    document.getElementById('modalValorCredito').textContent = valor;
    document.getElementById('modalTipoVenta').textContent = tipoVenta;
    document.getElementById('modal_entidad_crediticia').textContent = entidad_crediticia;
    //document.getElementById('modal_operador_credito').textContent = operador_credito;
    document.getElementById('modalTienda').textContent = tienda;
    document.getElementById('modalAliado').textContent = aliado;
    ...
    document.getElementById('modalIDApp').textContent = idApp;
    document.getElementById('modalNombresApellidosAsesor').textContent = nombres_apellidos_asesor;
    document.getElementById('modalTotalPrecioVenta').textContent = total_precio_venta;
    document.getElementById('modalCodEntidadCrediticia').value = codEntidadCrediticia;
    ...
    if (estadoCredito === 'PAGADO' || estadoCredito === 'Pagado') {
        estadoElement.style.backgroundColor = 'rgba(72, 187, 120, 0.2)';
        estadoElement.style.color = '#48bb78';
        estadoElement.style.border = '1px solid #48bb78';
    } else if (estadoCredito === 'PENDIENTE' || estadoCredito === 'Pendiente') {
        estadoElement.style.backgroundColor = 'rgba(237, 137, 54, 0.2)';
        estadoElement.style.color = '#ed8936';
        estadoElement.style.border = '1px solid #ed8936';
    } else if (estadoCredito === 'VENCIDO' || estadoCredito === 'Vencido') {
        estadoElement.style.backgroundColor = 'rgba(245, 101, 101, 0.2)';
        estadoElement.style.color = '#f56565';
        estadoElement.style.border = '1px solid #f56565';
    } else {
        estadoElement.style.backgroundColor = 'rgba(66, 153, 225, 0.2)';
        estadoElement.style.color = '#4299e1';
        estadoElement.style.border = '1px solid #4299e1';
    }

    // Cargar imágenes guardadas
    cargarImagenesModal(idApp);
...
function cargarImagenesModal(cod_info_factura_venta) {
    ...
    $.ajax({
        url: '../admin/obtener_imagenes_nota_observacion_modal_ajax.php', // Temporal para debugging
        type: 'POST',
        dataType: 'text', // Cambiar a text para ver la respuesta cruda
        ...
        success: function(responseText) {
            ...
            if (response && response.success && response.imagenes && response.imagenes.length > 0) {
                ...
                response.imagenes.forEach(function(imagen) {
                    html += `
                        <div style="border-radius: 8px; overflow: hidden; border: 2px solid rgba(102, 126, 234, 0.3); background: rgba(0, 0, 0, 0.5);">
                            <img src="${imagen.url_img_min_producto}" 
                                 ...
                                 onclick="mostrarImagenCompleta('${imagen.url_img_orig_producto}', '${imagen.nombre_nota_observacion}')">
                            <div style="padding: 6px; text-align: center;">
                                <p style="font-size: 0.7rem; color: #a0aec0; margin: 0; line-height: 1.2;">${imagen.nombre_nota_observacion}</p>
                            </div>
                        </div>
                    `;
                });
...
function abrirModalEditarEntidadCrediticia(codInfoFacturaVenta, codEntidadCrediticia) {
...
function calcularValorCredito() {
    ...
    const select = document.getElementById('cod_entidad_crediticia');
    const cod_entidad_crediticia = select.options[select.selectedIndex];
    
    if (precio_venta_producto > 0 && numeroCuotas > 0 && cod_entidad_crediticia.value) {
        const porcentajeInteres = parseFloat(cod_entidad_crediticia.getAttribute('data-porcentaje')) || 0;
        const interes_ptj = porcentajeInteres;
        
        // Cálculo del crédito con interés simple
        const intereses = (precio_venta_producto * interes_ptj * numeroCuotas) / 100;
        //const valorTotal = precio_venta_producto + intereses;
	    const total_pagar = Math.round(precio_venta_producto / ((100/100) - (interes_ptj / 100)), -3);
        const valorPorCuota = total_pagar / numeroCuotas;
        
        // Mostrar resultados
        document.getElementById('valorTotalCredito').textContent = formatearNumero(total_pagar);
        document.getElementById('valorPorCuota').textContent = formatearNumero(valorPorCuota);
        document.getElementById('interesesGenerados').textContent = formatearNumero(intereses);
...
function guardarEntidadCrediticia() {
    ...
    const intereses = (valorContadoNum * porcentajeInteres * numeroCuotasNum) / 100;
    const valorTotal = valorContadoNum + intereses;
    //const valorPorCuota = valorTotal / numeroCuotasNum;
    
    // Enviar datos al servidor
    $.ajax({
        url: '../admin/actualizar_entidad_crediticia_ajax.php',
        type: 'POST',
        data: {
            cod_info_factura_venta: codInfoFacturaVenta,
        ...
        success: function(response) {
            if (response && response.success) {
                ...
                alert('Entidad crediticia actualizada correctamente');
                
                // Cerrar modal
                $('#modalEditarEntidadCrediticia').modal('hide');
                
                // Actualizar los datos en el modal de detalle si está abierto
                actualizarDatosModalDetalle(selectedOption.textContent, valorTotal, valorContado);
...
function procesarSolicitudCredito(codInfoFacturaVenta, codTercero) {
    ...
    const modalElement = document.getElementById('modalEstudioCredito');
    if (!modalElement) {
        console.error('Modal modalEstudioCredito no encontrado en el DOM');
        alert('Error: No se puede abrir el modal. Modal no encontrado.');
        return;
    }
    ...
    // Abrir el modal de estudio de crédito usando múltiples métodos
    try {
        // Método 1: jQuery modal
        $('#modalEstudioCredito').modal({
            backdrop: 'static',
            keyboard: false,
            show: true
        });
        ...
        // Método 3: Fallback manual si los anteriores fallan
        setTimeout(() => {
            ...
            if (!isVisible) {
                console.warn('Modal no se mostró con métodos estándar, usando fallback');
                // Usar la función fallback definida dentro del document.ready
                if (typeof abrirModalFallback === 'function') {
                    abrirModalFallback('modalEstudioCredito');
                } else {
...
$(document).on('click', '#btn_procesar_solicitud', function(e) {
    e.preventDefault();
    console.log('Clic en btn_procesar_solicitud detectado');
    ...
    console.log('Datos obtenidos:', { codInfoFacturaVenta, codTercero });
    
    // Verificar que se obtuvieron los datos
    if (!codInfoFacturaVenta || !codTercero) {
        console.error('Faltan datos en el botón');
...
$(document).ready(function() {   
    // ============================================
    // Función de fallback para abrir modal manualmente
    // ============================================
    function abrirModalFallback(modalId) {
        console.log('Intentando abrir modal con fallback:', modalId);
        ...
        // Método 1: Forzar display block
        modal.style.display = 'block';
        modal.style.visibility = 'visible';
        modal.style.opacity = '1';
        modal.style.zIndex = '9999';
        
        // Agregar clase show de Bootstrap
        ...
        console.log('Modal abierto con fallback exitosamente');
        return true;
    }
    ...
    $('#btnSiguienteModalCaptura').click(function() {
        ...
        // Validar que todas las imágenes obligatorias estén cargadas
        var todasImagenesObligatoriasCargadas = validarTodasImagenesCargadas();
        
        if (!todasImagenesObligatoriasCargadas) {
            // El mensaje de error ya se muestra dentro de la función validarTodasImagenesCargadas()
            return;
        }
            ...
            if (success) {
                ...
                $.ajax({
                    ...
                    beforeSend: function(objeto){
                        $('#btnSiguienteModalCaptura').html('<i class="fa fa-spinner fa-spin"></i> Notificando via Telegram..');
                    },
                    success:function(respuesta){
                        ...
                        $.ajax({
                            ...
                            data: datos_url_ajax,
                            beforeSend: function(objeto){
                                $('#btnSiguienteModalCaptura').html('<img src="../imagenes/ajax-loader.gif"> Notificando via Telegram...');
                            },
                            success:function(respuesta){
...
function reabrirModalOrigen() {
    if (window.modalOrigenCamara) {
        ...
        setTimeout(() => {
            if (window.modalOrigenCamara === 'modalListaCapturaImagenes') {
                $('#modalListaCapturaImagenes').modal('show');
                console.log('Modal modalListaCapturaImagenes reabierto exitosamente');
...
function abrirModalCamara(cod_nota_observacion) {
    ...
    // Detectar desde qué modal se está abriendo la cámara
    let modalOrigen = null;
    
    // Verificar si modalListaCapturaImagenes está abierto
    const modalListaCaptura = document.getElementById('modalListaCapturaImagenes');
    if (modalListaCaptura && modalListaCaptura.classList.contains('show')) {
        modalOrigen = 'modalListaCapturaImagenes';
        console.log('Cámara abierta desde modalListaCapturaImagenes');
    }
    ...
    try {
        ...
        if (btnLinterna) {
            if (window.torchEnabled) {
                ...
                btnLinterna.innerHTML = '<i class="fa fa-lightbulb"></i>';
...
function cerrarModalCamara() {
    ...
    // Reabrir el modal de origen si se cerró por cancelación
    setTimeout(() => {
        reabrirModalOrigen();
    }, 200);
}
...
$(document).on('click', '#btnSiguienteModalProcesarOtrasImagenes', function(e) {
    e.preventDefault();

    console.log('btnSiguienteModalProcesarOtrasImagenes clickeado');
    ...
    if (!codInfo) {
        alert('No se ha identificado la información de factura (cod_info_factura_venta).');
        return;
    }
    ...
    $('#mostrar_datos_ajax_obtener_nota_observacion_modal_otras_imagenes').children('.col-12').each(function() {
        ...
        if (isMandatory && !hasImg && !btnDisabled) {
            missing.push(codNota);
        }
    });

    if (missing.length > 0) {
        alert('Faltan fotos obligatorias. Por favor capture todas las imágenes marcadas con * antes de continuar.');
        return;
    }

    // Todas las imágenes obligatorias están presentes: enviar al servidor
    ...
    $.ajax({
        url: '../admin/procesar_otras_imagenes_credito_ajax.php',
        type: 'POST',
        dataType: 'json',
        data: {
            action: action,
        ...
        success: function(response) {
            console.log('Respuesta procesar_otras_imagenes_credito_ajax:', response);
            if (response && response.success) {
                ...
                // Mostrar el modal de notificaciones WhatsApp después de un pequeño delay
                setTimeout(function() {
                ...
                alert('Error procesando imágenes: ' + (response.message || 'Error desconocido'));
                $btn.prop('disabled', false).text(originalText);
            }
        },
        error: function(xhr, status, error) {
            console.error('Error en AJAX procesar_otras_imagenes_credito_ajax:', error);
...
$(document).on('click', '#btnNotificarCliente', function(e) {
    ...
    if (!codInfo) {
        alert('No se encontró el código de factura.');
        return;
    }
    ...
    console.log('Notificación al cliente enviada, modal permanece abierto');
});
...
$(document).on('click', '#btnNotificarRevisor', function(e) {
    ...
    // El modal permanece abierto para permitir más notificaciones
    console.log('Notificación al revisor enviada, modal permanece abierto');
});
