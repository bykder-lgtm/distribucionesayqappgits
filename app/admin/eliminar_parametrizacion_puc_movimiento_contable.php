...
if (isset($_GET["cod_parametrizacion_puc_movimiento_contable"])) {
	...
	$borrar_sql = sprintf("DELETE FROM tbl15_parametrizacion_puc_movimiento_contable WHERE (cod_parametrizacion_puc_movimiento_contable = '$cod_parametrizacion_puc_movimiento_contable')");
