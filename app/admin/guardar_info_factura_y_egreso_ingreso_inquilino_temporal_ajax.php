...
$cod_gasto_inmueble_inquilino_venta_temporal   = addslashes($_POST['id']);
...
// ------------------------------------------------------------------------------------------------- //
$datos_info = "SELECT * FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (cod_estado_factura = '1') AND (cuenta = '$cuenta_actual')";
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_historia_clinica') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_historia_clinica         = intval($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_detalle_venta SET cod_historia_clinica = '$cod_historia_clinica' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_historia_clinica = '$cod_historia_clinica' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_anyo') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
...
WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET fecha_anyo = '$fecha_anyo', fecha_dia = '$fecha_dia', fecha_mes = '$fecha_mes', anyo = '$anyo' 
WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_entrega') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$fecha_entrega                = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta       = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET fecha_entrega = '$fecha_entrega' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_pago') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$fecha_pago                = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta       = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET fecha_pago = '$fecha_pago' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre1_tercero') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$nombre1_tercero               = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta        = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET nombre1_tercero = UPPER('$nombre1_tercero') WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_moneda') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$nombre_tipo_moneda           = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET nombre_tipo_moneda = '$nombre_tipo_moneda' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_factura') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$nombre_tipo_factura         = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET nombre_tipo_factura = '$nombre_tipo_factura' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_forma_pago') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$nombre_tipo_forma_pago         = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET nombre_tipo_forma_pago = '$nombre_tipo_forma_pago' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_inventario') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_tipo_inventario                = intval($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_tipo_inventario = '$cod_tipo_inventario' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_forma_pago') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_tipo_forma_pago                = intval($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_tipo_forma_pago = '$cod_tipo_forma_pago' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_pago') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_tipo_pago         = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_tipo_pago = '$cod_tipo_pago' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tercero') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_tercero                        = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$datos_data_info_factura = "SELECT observacion_tercero FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (cod_tercero = '$cod_tercero') ORDER BY cod_info_gasto_inmueble_inquilino_venta DESC";
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_tercero = '$cod_tercero' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_tercero = '$cod_tercero', observacion_tercero = '$observacion_tercero' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo trim($observacion_tercero); } else { echo ""; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_factura') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_factura                                       = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$datos_data_info_factura = "SELECT observacion_tercero FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta') ORDER BY cod_info_gasto_inmueble_inquilino_venta DESC";
$consulta_data_info_factura = mysqli_query($conectar, $datos_data_info_factura);
$data_info_factura = mysqli_fetch_assoc($consulta_data_info_factura);
$factura_ocupada = mysqli_num_rows($consulta_data_info_factura);
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_factura = '$cod_factura' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_factura = '$cod_factura', observacion_tercero = '$observacion_tercero' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_base_caja') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_base_caja                      = intval($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$datos_mesa_ocupada = "SELECT cuenta FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (cod_base_caja = '$cod_base_caja') AND (nombre_estado_factura = 'ABIERTA')";
...
if ($mesa_ocupada == '0') {
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_base_caja = '$cod_base_caja' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_base_caja = '$cod_base_caja' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
//if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
} else {
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_prioridad') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_prioridad                      = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_prioridad = '$cod_prioridad' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_prioridad = '$cod_prioridad' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo trim($observacion_tercero); } else { echo ""; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_metodo_envio') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_tipo_metodo_envio              = intval($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_tipo_metodo_envio = '$cod_tipo_metodo_envio' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_administrador') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
...
$sql_animal = "SELECT MAX(cod_caja_virtual) AS cod_caja_virtual, MAX(cod_base_caja) AS cod_base_caja FROM tbl15_gasto_inmueble_inquilino_venta_temporal";
...
$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_administrador = '$cod_administrador', cuenta = '$cuenta', cod_caja_virtual = '$cod_caja_virtual' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_administrador = '$cod_administrador', cuenta = '$cuenta', cod_caja_virtual = '$cod_caja_virtual' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
} else {
$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_administrador = '$cod_administrador', cuenta = '$cuenta' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_administrador = '$cod_administrador', cuenta = '$cuenta' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
}
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='observacion_tercero') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$observacion_tercero                   = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta       = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET observacion_tercero = '$observacion_tercero' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_cliente') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$cod_cliente                  = intval($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_cliente = '$cod_cliente' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_empresa') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
...
$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET cod_empresa = '$cod_empresa', cod_cliente = '$cod_cliente', nombre_empresa = '$nombre_empresa', razonsocial_empresa = '$razonsocial_empresa' 
	WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
?>
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_producto') && ($tipo_ajax=='tbl15_info_gasto_inmueble_inquilino_venta')) {
$nombre_tipo_producto         = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET nombre_tipo_producto = '$nombre_tipo_producto' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_producto_barra') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$cod_producto_barra           = addslashes($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_producto_barra = '$cod_producto_barra' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_producto') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$nombre_producto              = addslashes(strtoupper($_POST['valor']));
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET nombre_producto = '$nombre_producto' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='comentario_producto') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$comentario_producto           = addslashes($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET comentario_producto = '$comentario_producto' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='descripcion_gasto_inmueble_detalle') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$descripcion_gasto_inmueble_detalle           = addslashes($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET descripcion_gasto_inmueble_detalle = '$descripcion_gasto_inmueble_detalle' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
	...
	$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET precio_venta_producto = '$precio_venta_producto', total_venta_producto = '$total_venta_producto' 
	...
	$sql_productos = "SELECT SUM(precio_venta_producto) AS precio_venta_producto FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_factura = '$cod_factura') $filtro_incluido";
	$productos_consulta = mysqli_query($conectar, $sql_productos) or die(mysqli_error($conectar));
	$datos_producto = mysqli_fetch_assoc($productos_consulta);

	$total_gasto                                = $datos_producto['precio_venta_producto'];
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_compra_producto') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
	header('Content-Type: application/json');
	$respuesta_ajax                             = array();
	...
	$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET precio_compra_producto = '$precio_compra_producto', total_compra_producto = '$total_compra_producto' 
	WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
	$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

	if (mysqli_affected_rows($conectar) > 0) { $afectado = "SI"; } else { $afectado = "NO"; }

	$sql_productos = "SELECT SUM(precio_compra_producto) AS precio_compra_producto FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_factura = '$cod_factura') $filtro_incluido";
	$productos_consulta = mysqli_query($conectar, $sql_productos) or die(mysqli_error($conectar));
	$datos_producto = mysqli_fetch_assoc($productos_consulta);

	$total_gasto                                = $datos_producto['precio_compra_producto'];
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='url_img1') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
	header('Content-Type: application/json');
	$respuesta_ajax                             = array();
	...
	$nombre_normal2                             = $fecha_ymdHis.'_'.$cod_gasto_inmueble_inquilino_venta_temporal.'.'.$formato_img2;
	...
	$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET url_img_orig_producto = '$url_img_orig_producto', url_img_min_producto = '$url_img_min_producto'
	WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
	$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_gasto_inmueble_detalle') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET fecha_gasto_inmueble_detalle = '$fecha_gasto_inmueble_detalle',
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_origen_produccion') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$cod_origen_produccion        = intval($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_origen_produccion = '$cod_origen_produccion' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='peso_producto') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$peso_producto           = addslashes($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET peso_producto = '$peso_producto' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='unidad_medida_peso') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$unidad_medida_peso           = addslashes($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET unidad_medida_peso = '$unidad_medida_peso' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='descripcion_tipo_forma_pago') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$descripcion_tipo_forma_pago         = addslashes(($_POST['valor']));
$cod_info_gasto_inmueble_inquilino_venta              = intval($_POST['nombre_campo_incre']);

$data_sql = ("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET descripcion_tipo_forma_pago = '$descripcion_tipo_forma_pago' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='placa_producto') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$placa_producto           = addslashes($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET placa_producto = UPPER('$placa_producto') WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_ymd_parqueo_ini') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal')";
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET fecha_ymd_parqueo_ini = '$fecha_ymd_parqueo_ini' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_hora_parqueo_ini') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET fecha_hora_parqueo_ini = '$fecha_hora_parqueo_ini' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_ymd_parqueo_fin') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET fecha_ymd_parqueo_fin = '$fecha_ymd_parqueo_fin' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_hora_parqueo_fin') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET fecha_hora_parqueo_fin = '$fecha_hora_parqueo_fin' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_frec_duracion') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$nombre_frec_duracion         = addslashes(strtoupper($_POST['valor']));
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET nombre_frec_duracion = '$nombre_frec_duracion' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_venta') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
$datos_info_temporal = "SELECT precio_compra_producto, precio_gasto_inmueble_detalle_venta, cod_caja_virtual FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal')";
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET und_venta = '$und_venta', total_compra_producto = '$total_compra_producto', 
...
$sql_base_iva = "SELECT Sum((total_gasto_inmueble_detalle_venta)/((iva_ptj/100)+(100/100))) As subtotal_base_iva, cod_info_gasto_inmueble_inquilino_venta
FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_info_gasto_inmueble_inquilino_venta       = $matriz_base_iva['cod_info_gasto_inmueble_inquilino_venta'];
...
if ($cod_estado_limite_venta_pos_factura_electronica_global == '1') {
	...
	$sql_data = sprintf("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET nombre_tipo_factura = '$nombre_tipo_factura' WHERE (cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta')");
	$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}

}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_caja_sobre') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
$datos_info_temporal = "SELECT precio_compra_producto, precio_gasto_inmueble_detalle_venta, cajas_sobre, und_sobre, nombre_tipo_und_caja_sobre, und_venta, cod_info_gasto_inmueble_inquilino_venta  
FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);

$cod_info_gasto_inmueble_inquilino_venta       = $info_temporal['cod_info_gasto_inmueble_inquilino_venta'];
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET und_caja_sobre = '$und_caja_sobre', und_venta = '$und_venta', total_compra_producto = '$total_compra_producto', 
...
$datos_info_total = "SELECT SUM(total_gasto_inmueble_detalle_venta) AS total_venta FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta')";
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_gasto_inmueble_detalle_venta') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$precio_gasto_inmueble_detalle_venta        = addslashes($_POST['valor']);
$cod_gasto_inmueble_inquilino_venta_temporal  = intval($_POST['id']);

$datos_info_temporal = "SELECT und_venta, precio_costo_producto, cod_producto_barra, cod_info_gasto_inmueble_inquilino_venta FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta') AND (cod_producto_barra <> '33333333') AND (cod_producto_barra <> '22222222')";
...
$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET precio_gasto_inmueble_detalle_venta = '$precio_gasto_inmueble_detalle_venta', total_gasto_inmueble_detalle_venta = '$total_gasto_inmueble_detalle_venta',
cod_estado_permitir_venta = '$cod_estado_permitir_venta', nombre_tipo_precio = '$nombre_tipo_precio' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_cliente') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$nombre_cliente              = addslashes(strtoupper($_POST['valor']));
$cod_gasto_inmueble_inquilino_venta_temporal = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET nombre_cliente = '$nombre_cliente' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_cobrar') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$cod_tipo_cobrar             = addslashes(($_POST['valor']));
$id                          = addslashes($_POST['id']);
$frag                        = explode("__", $id);
$cod_gasto_inmueble_inquilino_venta_temporal = $frag[1];

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET cod_tipo_cobrar = '$cod_tipo_cobrar' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_alerta') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$fecha_alerta                = addslashes(($_POST['valor']));
$cod_gasto_inmueble_inquilino_venta_temporal = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_gasto_inmueble_inquilino_venta_temporal SET fecha_alerta = '$fecha_alerta' WHERE cod_gasto_inmueble_inquilino_venta_temporal = '$cod_gasto_inmueble_inquilino_venta_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='observacion_tercero') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
$observacion_tercero                   = addslashes($_POST['valor']);
$cod_info_gasto_inmueble_inquilino_venta       = intval($_POST['id']);
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='identificacion_tercero') && ($tipo_ajax=='tbl15_gasto_inmueble_inquilino_venta_temporal')) {
...
cod_tipo_pago, cod_info_gasto_inmueble_inquilino_venta, cod_factura, precio_costo_producto, precio_gasto_inmueble_detalle_venta, und_venta, iva_ptj, fecha_ymd_gasto_inmueble_detalle_venta, fecha_hora_gasto_inmueble_detalle_venta, cuenta 
...
$cod_info_gasto_inmueble_inquilino_venta         = $info_datos['cod_info_gasto_inmueble_inquilino_venta'];
...
FROM tbl15_gasto_inmueble_detalle_venta WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'";
...
$agregar_regis = sprintf("UPDATE tbl15_info_gasto_inmueble_inquilino_venta SET total_precio_compra = '$total_precio_compra', total_precio_venta = '$total_precio_venta', 
total_datos_data = '$total_datos_data' WHERE cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta'");
...
if ($cod_tipo_pago == '2') {
$sql_total_deuda_credito = "SELECT SUM(total_gasto_inmueble_detalle_venta) AS monto_deuda FROM tbl15_gasto_inmueble_detalle_venta WHERE (cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta')";
