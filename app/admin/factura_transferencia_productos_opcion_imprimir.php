...
$pagina                               = addslashes($_GET['pagina']).'?cod_info_factura_transferencia='.$cod_info_factura_transferencia;
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_factura_transferencia WHERE (cod_info_factura_transferencia = '$cod_info_factura_transferencia')";
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <!--<td align='center'><a href="../admin/imprimir_factura_venta_grande_bootstrap_mpdf_pdf.php?cod_info_factura_transferencia=<?php echo $cod_info_factura_transferencia?>" target="_blank"><img src="../imagenes/imprimir_.png"></a></td>-->
  </tr>
</table>
</center>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
FROM tbl15_factura_transferencia_producto WHERE (cod_info_factura_transferencia = '$cod_info_factura_transferencia')";
