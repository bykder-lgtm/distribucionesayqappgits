...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (habit_tox_fum_nofum_exfum='Fuma') AND ((nombre_empresa)='$nombre_empresa'))
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (habit_tox_fum_nofum_exfum='No Fuma') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY habit_tox_fum_nofum_exfum, nombre_empresa";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (habit_tox_fum_nofum_exfum='Exfumador') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY habit_tox_fum_nofum_exfum, nombre_empresa";
