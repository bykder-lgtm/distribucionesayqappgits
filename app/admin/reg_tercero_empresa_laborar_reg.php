...
if ((isset($_POST["insersion"])) && ($_POST["insersion"] == "formulario_de_insersion")) {
	...
	<?php } else {
		...
		cod_estado_dto_tercero, dto1_con_iva_tercero, dto2_con_iva_tercero, dto1_sin_iva_tercero, dto2_sin_iva_tercero, dto1_excento_iva_tercero, dto2_excento_iva_tercero) 
	...
	?>
	<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_tercero_empresa_laborar.php">
	<?php } ?>
<?php } ?>
<!-- ***************************************************************************************************************************** -->
