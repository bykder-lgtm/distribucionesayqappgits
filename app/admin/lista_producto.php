...
<?php if ($cod_estado_prod_reg_producto == '1') { ?><a class="btn btn-success" href="../admin/reg_producto.php">Registrar Producto</a><?php } ?>
<?php if ($cod_estado_prod_inventario_producto_masivo == '1') { ?><a class="btn btn-info" href="../admin/lista_inventario_masivo_editable_ajax.php">Lista Productos Masivo</a><?php } ?>
<br>
<a class="btn btn-danger" href="../admin/lista_producto_tope_min.php">Lista Productos Stock</a>
<a class="btn btn-primary" href="../admin/facturacion_venta_temporal_producto_manual_pos.php">Facturar Productos</a>
<!--
...
<script type="text/javascript" src="../admin/busqueda_paginacion_producto_ajax.js"></script>
