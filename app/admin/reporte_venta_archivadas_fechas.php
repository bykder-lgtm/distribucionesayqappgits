...
<h4>Reporte Ventas Archivadas&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php if ($cod_estado_reporte_venta_archivada_y_normal == '1') { ?>
<a href="../admin/reporte_venta_archivadas_y_normales_fechas.php">Reporte Ventas Archivadas y Normales</h4></a>
<?php } ?>
</div>

<div class="breadcrumbs">
<a class="btn btn-primary" href="#"><h6>Reporte Ventas Archivadas</h6></a>
</div>
<div class="row-fluid">
...
if (isset($_GET['fecha_ymd_venta_producto_ini'])) {
    ...
    if ($cod_estado_facturacion_venta_acceso_facturas_otros_user == '1') {
        if ($cod_administrador==0) {
            ...
            $filtro_consulta_vendedor_rel = "AND (tbl15_venta_producto_archivado.cod_administrador = '$cod_administrador')";
        }
    } else {
        $filtro_consulta_vendedor = "AND (cod_administrador = '$cod_administrador')";
        $filtro_consulta_vendedor_rel = "AND (tbl15_venta_producto_archivado.cod_administrador = '$cod_administrador')";
    ...
    if ($cod_estado_hora_reporte_venta_global == '1') {
        ...
        $condicion_hora_reporte_venta_rel        = "AND (tbl15_venta_producto_archivado.fecha_hora_venta_producto BETWEEN '".$fecha_hora_venta_producto_ini."' AND '".$fecha_hora_venta_producto_fin."')";
        $condicion_hora_reporte_venta_info       = "AND (fecha_hora BETWEEN '".$fecha_hora_venta_producto_ini."' AND '".$fecha_hora_venta_producto_fin."')";
        $condicion_hora_reporte_venta_info_rel   = "AND (tbl15_venta_producto_archivado.fecha_hora BETWEEN '".$fecha_hora_venta_producto_ini."' AND '".$fecha_hora_venta_producto_fin."')";
    } else {
...
if (isset($_GET['fecha_ymd_venta_producto_ini'])) {
    ...
    if ($cod_tercero==0) {
        ...
        $filtro_consulta_tercero_rel = "AND (tbl15_venta_producto_archivado.cod_tercero = '$cod_tercero')";
    }
    if ($cod_tipo_pago==0) {
        ...
        $filtro_consulta_tipo_pago_rel = "AND (tbl15_venta_producto_archivado.cod_tipo_pago = '$cod_tipo_pago')";
    }
    if ($cod_tipo_forma_pago==0) {
        ...
        $filtro_consulta_tipo_forma_pago_rel = "AND (tbl15_venta_producto_archivado.cod_tipo_forma_pago = '$cod_tipo_forma_pago')";
    }
    if ($cod_dependencia==0) {
        ...
        $filtro_consulta_dependencia_rel = "AND (tbl15_venta_producto_archivado.cod_dependencia = '$cod_dependencia')";
    }
    if ($nombre_tipo_factura=='0') {
        ...
        $filtro_consulta_nombre_tipo_factura_rel = "AND (tbl15_venta_producto_archivado.nombre_tipo_factura = '$nombre_tipo_factura')";
    }
    if ($nombre_tipo_compra=='0') {
        ...
        $filtro_consulta_nombre_tipo_compra_rel = "AND (tbl15_venta_producto_archivado.nombre_tipo_compra = '$nombre_tipo_compra')";
    }
    ...
    if ($cod_tipo_metodo_envio==0) {
        ...
        $filtro_consulta_tipo_metodo_envio_rel = "AND (tbl15_venta_producto_archivado.cod_tipo_metodo_envio = '$cod_tipo_metodo_envio')";
    }
    /* --------------------------------------------------------------------------------------------------------------------------------- */
    /* --------------------------------------------------------------------------------------------------------------------------------- */
    ...
    /* --------------------------------------------------------------------------------------------------------------------------------- */
    /* --------------------------------------------------------------------------------------------------------------------------------- */
    $sql_total_servicio_propina = "SELECT SUM(total_venta_producto) AS total_suma_servicio_propina FROM tbl15_venta_producto_archivado 
    WHERE (fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') $condicion_hora_reporte_venta
...
$sql_total_forma_pago = "SELECT Sum(tbl15_venta_producto_archivado.total_venta_producto) AS suma_total_venta_producto, tbl15_tipo_forma_pago.nombre_tipo_forma_pago
FROM tbl15_tipo_forma_pago RIGHT JOIN tbl15_venta_producto_archivado ON tbl15_tipo_forma_pago.cod_tipo_forma_pago = tbl15_venta_producto_archivado.cod_tipo_forma_pago
WHERE (tbl15_venta_producto_archivado.fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') $condicion_hora_reporte_venta_rel 
...
<table class="table table-striped">
<tr>
<td style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#"><strong>VENTAS GENERALES ARCHIVADAS</strong></a></td>
</tr>
</table>
...
<thead>
    <tr>
        ...
        <th style="text-align:center; background-color:#DBE0F3; color:#000;">Fecha Archivado</th>
...
tbl15_venta_producto_archivado.nombre_tipo_compra, tbl15_venta_producto_archivado.cod_tipo_metodo_envio, tbl15_venta_producto_archivado.nombre_tipo_cobro, tbl15_venta_producto_archivado.fecha_archivado
...
while ($info_cliente = mysqli_fetch_assoc($resultado_cliente)) {
    ...
    $fecha_archivado               = $info_cliente['fecha_archivado'];
...
?>
    <tr>
        ...
        <td style="text-align:center"><?php echo $fecha_archivado?></td>
...
<table class="table table-striped">
<tr>
<td style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#"><strong>VENTAS POR FACTURA ARCHIVADAS</strong></a></td>
</tr>
</table>
...
<th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#">Fecha Archivado</a></th>
<th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#">ID</a></th>
</tr>
</thead>
<tbody>
<?php
$sql_total_tipo_factura = "SELECT * FROM tbl15_info_factura_venta_archivado 
WHERE (fecha_anyo BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') 
...
$fecha_archivado               = $datos_total_tipo_factura['fecha_archivado'];
