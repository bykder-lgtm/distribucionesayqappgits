...
$subquery_aliados = "SELECT cod_administrador FROM tbl15_administrador WHERE cod_coordinador = '$cod_administrador' AND cod_seguridad = '23' AND cod_estado != '0' AND cod_estado_activacion_usuario != '3'";
