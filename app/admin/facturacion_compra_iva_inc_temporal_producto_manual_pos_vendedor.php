...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
<td bgcolor="#fff" align="center"><strong><a href="../admin/lista_info_factura_compra_abierta_temporal_vendedor.php">LISTA FACTURA DE COMPRA ABIERTA</a></strong></td> 
    </tr></tbody>
</table>
<br>
<!--
...
-->
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_factura_compra_temporal_pos_vendedor.php'); ?>
<!-- ***************************************************************************************************************************** -->
...
<?php if ($cod_estado_compra_caja_global == '1') { ?>
<td style="text-align:center;"><?php echo $und_unidades;?></td>
<th style="text-align:center;">X</th>
<td style="text-align:center;"><?php echo $und_caja;?></td>
<?php } ?>
...
<?php if ($cod_estado_impoconsumo_global == '1') { ?>
<td style="text-align:center;"><?php echo $precio_ipc;?></td>
<?php } ?>
