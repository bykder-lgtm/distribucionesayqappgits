...
<!-- ***************************************************************************************************************************** -->
<?php
//if (isset($_GET['cod_cuentas_cobrar_alerta'])) { $cod_cuentas_cobrar_alerta = intval($_GET['cod_cuentas_cobrar_alerta']); } else { $cod_cuentas_cobrar_alerta = 0; }
...
<table class="table table-striped">
  <tr>
    <td style="text-align: center;"><strong>NIT INQUILINO: <?php echo $identificacion_tercero; ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: center;"><strong>NOMBRE INQUILINO: <?php echo $nombre_cliente; ?></strong></td>
  </tr>
</table>
