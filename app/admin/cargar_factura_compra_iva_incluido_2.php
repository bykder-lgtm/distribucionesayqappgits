...
var cod_info_factura_compra = document.getElementById('cod_info_factura_compra').value;
...
if (last != valor)
myajax.Link('guardar_cargar_factura_temporal.php?valor='+valor+'&campo='+campo+'&id='+id+'&nombre_pagina='+nombre_pagina+'&cod_info_factura_compra='+cod_info_factura_compra);
}
</script>
</head>
...
<!-- ***************************************************************************************************************************** -->
<?php
$nombre_pagina                     = "cargar_factura_compra_iva_incluido.php";
...
$datos_info_factura_compra = "SELECT cod_info_factura_compra FROM tbl15_info_factura_compra WHERE (estado = 'abierto') AND (vendedor = '$cuenta_actual') AND (nombre_tipo_cargue_factura = '$nombre_tipo_cargue_factura')";
$consulta_info_factura_compra = mysqli_query($conectar, $datos_info_factura_compra);
$info_factura_compra = mysqli_fetch_assoc($consulta_info_factura_compra);

$cod_info_factura_compra              = $info_factura_compra['cod_info_factura_compra'];

$sql = "SELECT * FROM cargar_factura_temporal WHERE (cod_info_factura_compra = '$cod_info_factura_compra') ORDER BY cod_cargar_factura_temporal DESC";
...
$datos_factura = "SELECT cod_info_factura_compra FROM tbl15_info_factura_compra WHERE (estado = 'abierto') AND (vendedor = '$cuenta_actual') AND (nombre_tipo_cargue_factura = '$nombre_tipo_cargue_factura')";
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_caja_virtual.php?pagina=<?php echo $pagina ?>">CAJAS VIRTUALES</a></strong></td>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_info_factura_venta.php">LISTA DE FACTURAS</a></strong></td>
    </tr></tbody>
</table>
<br>
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody>
    	<tr>
            <td bgcolor="#fff" align="center"><a href="../admin/facturacion_venta_temporal_producto_barras_pos.php"><strong>Barras</strong></a></td>
    		<td bgcolor="#fff" align="center"><strong>Manual: [<?php echo $cod_caja_virtual ?>]<input type="text" id="busqueda" name="busqueda" onkeyup="hacer_busqueda()" style="height:40" placeholder="Buscar"/><input type="hidden" id="pagina" name="pagina" value="<?php echo $pagina_local ?>"/></strong><div id="logo_cargador"></div></td>
    	</tr>
    </tbody>
</table>
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_factura_compra.php'); ?>
<!-- ***************************************************************************************************************************** -->
<?php include_once("../admin/modal_registrar_tercero.php"); ?>
<!-- ***************************************************************************************************************************** -->
