...
if ((isset($_POST["insersion"])) && ($_POST["insersion"] == "formulario_de_insersion")) {
	...
	$obtener_empresa = "SELECT identificacion_tercero FROM tbl15_entidad_crediticia WHERE identificacion_tercero = '".($identificacion_tercero)."'";
	...
	<?php } else {
		$sql_data = "INSERT INTO tbl15_entidad_crediticia (nombre_tipo_tercero, nombre_tipo_identificacion, identificacion_tercero, digito_tercero, nombre1_tercero, 
		...
		dto2_excento_iva_tercero, total_puntos_redimibles_campanya_tercero, 
		lider_interes_ptj, coordinador_interes_ptj, asesor_interes_ptj, vendedor_interes_ptj, proveedor_interes_ptj, aliado_estrategico_interes_ptj, 
		entidad_crediticia_interes_ptj, lider_aval_ptj, coordinador_aval_ptj, asesor_aval_ptj, vendedor_aval_ptj, proveedor_aval_ptj, 
		aliado_estrategico_aval_ptj, entidad_crediticia_aval_ptj, interes_ptj, aval_ptj) 
	...
	?>
	<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_siscredito_entidad_crediticia.php">
	<?php } ?>
<?php } ?>
<!-- ***************************************************************************************************************************** -->
