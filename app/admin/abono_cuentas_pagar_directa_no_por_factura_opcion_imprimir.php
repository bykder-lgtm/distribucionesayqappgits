...
<!-- ***************************************************************************************************************************** -->
<?php 
if (isset($_GET['cod_cuentas_pagar_abonos'])) { 
...
?>
  <table class="table table-striped">
    <tr>
      <td><font color='black' size= "+3">ABONO CUENTAS POR PAGAR:</font></td>
      <td style="text-align:right;" colspan="2"><font color='black' size= "+3"><?php echo $cod_cuentas_pagar_abonos; ?></font></td>
    </tr>
    <tr>
      <td><font color='black' size= "+3">NOMBRE PROVEEDOR:</font></td>
  ...
  <table class="table table-striped">
    <tr>
      <td style="text-align:center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $pagina ?>?cod_cuentas_pagar_abonos=<?php echo $cod_cuentas_pagar_abonos ?>&cod_tercero=<?php echo $cod_tercero ?>&cliente=<?php echo $cliente ?>&cod_info_factura_compra=<?php echo $cod_info_factura_compra ?>" id="listo"><img src="../imagenes/listo.png" alt="listo"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
      ...
      <td style="text-align:center; width:50%"><button id="btnImprimirAbonoCuentaPagar"><img src="../imagenes/imprimir_2.png" alt="imprimir"></button></td>
      <?php } ?>
      <!--<td style="text-align: center;"><a href="javascript:void(0);" id="foco_btn_imprimir" onclick="printPageArea('area_imprimible_invisible')"><img src="../imagenes/imprimir_directa_pos.png" alt="imprimir"></a></td>-->
    </tr>
  </table>
  ...
  $(document).ready(function(){  
    $('#btnImprimirAbonoCuentaPagar').click(function(){
    var cod_cuentas_pagar_abonos = <?php echo $cod_cuentas_pagar_abonos ?>;
    var origen = "0";  
...
<!--<td style="text-align:center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../admin/cuentas_pagar_abonos_imprimir_80mm_pdf.php?cod_cuentas_pagar_abonos=<?php echo $cod_cuentas_pagar_abonos ?>&cod_factura=<?php echo $cod_factura ?>&cod_tercero=<?php echo $cod_tercero ?>&cliente=<?php echo $cliente ?>" target="_blank"><img src=../imagenes/imprimir_1.png alt="imprimir"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>-->
</table>
</div>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:10pt;">
<tr>
<td style="text-align: center; width: 99%; font-family: Courier; font-size:10pt;"><strong>ABONOS CUENTAS POR PAGAR</strong></td>
</tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:10pt;">
  <tr>
    ...
    <td style="text-align: center; width: 40%; font-family: Courier; font-size:10pt;"><strong><?php echo number_format($total_monto_deuda_cuenta_pagar, 0, ",", ".") ?></strong></td>
  ...
  <tr>
    ...
    <td style="text-align: center; width: 40%; font-family: Courier; font-size:10pt;"><strong><?php echo number_format($total_abonado_cuenta_pagar, 0, ",", ".") ?></strong></td>
    <td style="text-align: left; width: 2%; font-family: Courier; font-size:10pt;"></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 40%; font-family: Courier; font-size:10pt;"><strong>SALDO PENDIENTE:</strong></td>
    <td style="text-align: center; width: 40%; font-family: Courier; font-size:10pt;"><strong><?php echo number_format($total_subtotal_cuenta_pagar, 0, ",", ".") ?></strong></td>
    <td style="text-align: left; width: 2%; font-family: Courier; font-size:10pt;"></td>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:10pt;">
  ...
  <tr>
    <td style="text-align: center; width: 95%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha_impr.$hora_impr.'-'.$cod_cuentas_pagar_abonos ?></strong>_imp_cob_opcimpr</td>
  </tr>
</table>
