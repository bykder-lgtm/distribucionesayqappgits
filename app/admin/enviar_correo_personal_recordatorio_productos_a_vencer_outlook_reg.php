...
if (isset($_GET['fecha_ymd_venta_producto_ini'])) {
  ...
  $nombre_tipo_asunto                         = 'Productos a Vencer';
  ...
  * { line-height: inherit; }
  ...
  <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Fecha Vencimiento</span></th>
  <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Lote</span></th>
  <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>VENCE EN</span></th>
  ...
  <th style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>Proveedor</span></th>
  </tr>
  </thead>
  <tbody>
  ";
  ...
  $total_reg = mysqli_num_rows($consulta_total_forma_pago);
  ...
  <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$fecha_vencimiento."</span></td>
  <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$vencimiento_lote."</span></td>
  <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$dias_a_vencer." Dias</span></td>
  ...
  <td style='text-align:center;'><span style='color: #ffffff; font-size: 12px; line-height: 16.8px; font-family: Lato, sans-serif;'>".$nombre1_tercero."</span></td>
  </tr>
  ";
  }
  $mensaje .= "
  ...
  if ($total_reg <> '0') {
      ...
      $cod_tipo_modulo_envio_correo         = "2";
      $nombre_tipo_modulo_envio_correo      = "PRODUCTOS A VENCER - EDITAXE POS";
      $id_origen_correo                     = "";
      $nombre_tabla_origen_correo           = "tbl15_historial_fecha_vencimiento";
      $nombre_campo_origen_correo           = "cod_historial_fecha_vencimiento";
      $nombre_origen_correo                 = "Recordatorio productos a vencer";
