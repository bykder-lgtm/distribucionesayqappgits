...
$pagina                   = $concatenador."lista_reasigancion_tareas_trabajo_alturas.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = "WHERE (";
        $sWhere = "WHERE ((tbl15_trabajo_altura.nombre_acepta_trab_altura LIKE 'REASIGNACION DE TAREAS') AND ";
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" WHERE (tbl15_trabajo_altura.nombre_acepta_trab_altura LIKE 'REASIGNACION DE TAREAS') ORDER BY tbl15_trabajo_altura.fecha_time DESC";
} else {
    ...
    $reload = '../admin/lista_reasigancion_tareas_trabajo_alturas.php';
