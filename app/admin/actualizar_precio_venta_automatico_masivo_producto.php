...
$pagina_local                       = addslashes($_GET['pagina']).'?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&pagina='.$pagina; 
...
$sql_venta_producto = "SELECT cod_venta_producto, cod_producto_barra, und_venta, precio_compra_producto, precio_venta_producto, nombre_tipo_precio_venta 
FROM tbl15_venta_producto WHERE (cod_info_factura_venta = '$cod_info_factura_venta') AND (nombre_tipo_precio_venta <> 'PVAR')";
...
$sql_data = sprintf("UPDATE tbl15_venta_producto SET precio_venta_producto = '$precio_venta_producto', total_venta_producto = '$total_venta_producto', 
nombre_tipo_precio_venta = '$nombre_tipo_precio_venta' WHERE cod_venta_producto = '$cod_venta_producto'");
