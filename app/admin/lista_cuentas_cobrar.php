...
<table class="table table-striped">
    <tr>
        <?php if ($cod_estado_cuenta_cobrar_registrar == '1') { ?>
            ...
            <th style="text-align:right"><a href="../admin/reg_cuentas_cobrar_manual.php"><font size='+1'>Crear nueva cuenta por cobrar</font></a></th>
        <?php } ?>
    </tr>
</table>
...
<table class="table table-striped">
	<tr>
		...
		<th style="text-align:center"><a href="../admin/descargar_cuentas_cobrar_spout_xlsx.php?fecha_hoy=<?php echo $fecha_hoy?>"><img src=../imagenes/btn_xlsx.png alt="imprimir_peq"></a></th>
...
if (isset($_POST['palabra'])) { 
	...
	?>
		<tr>
			<?php if ($cod_estado_cuenta_cobrar_eliminar == '1') { ?>
				<?php if ($subtotal <= '0') { ?><td style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_tercero; ?>&tab=<?php echo $tab2; ?>&campo=<?php echo $campo; ?>&tipo=<?php echo $tipo; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/btn_archivar.png" class="img-polaroid" alt=""></a></td><?php } else { ?><td></td><?php } ?>
			<?php } ?>
