...
if ($_GET['cod_movimiento_contable'] <> NULL) {
  ...
  if ($nombre_tipo_documento == 'RECIBO DE CAJA') {
    $titulo_documento = 'DEBE';
  } elseif ($nombre_tipo_documento == 'COMPROBANTE DE EGRESO') {
...
$titulo_doc_pdf                     = $nombre_tipo_documento.' '.$cod_movimiento_contable;
$autor_doc_pdf                      = $nombre_tipo_documento.' '.$cod_movimiento_contable;
$creador_doc_pdf                    = $nombre_tipo_documento.' '.$cod_movimiento_contable;
$tema_doc_pdf                       = $nombre_tipo_documento.' '.$cod_movimiento_contable;
$palabras_claves_doc_pdf            = $nombre_tipo_documento.' '.$cod_movimiento_contable;
...
<table align="center" border="1" cellspacing="0" cellpadding="1" style="font-family:mono; font-size:11pt; width:100%">
  <tr>
    <td style="text-align:center">'.$nombre_tipo_documento.' NO: '.$cod_guia.'</td>
  </tr>
</table>

<table align="center" border="1" cellspacing="0" cellpadding="1" style="font-family:mono; font-size:11pt; width:100%">
  <tr>
    <td colspan="3">FECHA EMISION: '.$fecha_ymd.'</td>
    <td style="text-align:left; width:150px">DOCUMENTO QUE MODIFICA:</td>
    <td >'.$doc_modifica.'</td>
  </tr>
  <tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="1" style="font-family:mono; font-size:11pt; width:100%">
  <tr> 
    <td style="width:50%">
    <table align="center" border="1" cellspacing="0" cellpadding="1" style="font-family:mono; font-size:11pt; width:100%"><tr><td style="text-align:center">DEBITOS</td></tr></table>
...
$codigoHTML.='
    <table align="center" border="1" cellspacing="0" cellpadding="1" style="font-family:mono; font-size:11pt; width:100%"><tr><td style="text-align:center">CREDITOS</td></tr></table>
...
$ruta = '../pdfs/';
$nombre_archivo = $nombre_tipo_documento.' '.$anyo;
