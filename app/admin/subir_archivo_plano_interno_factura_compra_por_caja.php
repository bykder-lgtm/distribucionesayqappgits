...
<table class="table table-striped">
    <tr>
        <th style="text-align:center"><a href="../admin/lista_info_factura_compra_externa_copidrogas_abierta_temporal.php"><font size='+2'>Cargar Factura Compra Interna Por Caja (Archivo Plano)</font></a></th>
    </tr>
</table>

<div class="table-responsive">

<form action="subir_archivo_plano_interno_factura_compra_por_caja_reg.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
    <table class="table table-striped">
        <thead>
            <tr>
