...
<div class="breadcrumbs"><a href="<?php echo $pagina ?>"><h4>Editar Arrendatario</h4></a></div>
<div class="row-fluid">
...
$deduccion_retefuente          = $info_cliente['deduccion_retefuente'];
$deduccion_otro_impuesto_dian  = $info_cliente['deduccion_otro_impuesto_dian'];
$deduccion_imp_cuatroxmil      = $info_cliente['deduccion_imp_cuatroxmil'];
$ingreso_impuesto_iva          = $info_cliente['ingreso_impuesto_iva'];
$deduccion_otro_concepto       = $info_cliente['deduccion_otro_concepto'];
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/edit_inquilino_reg.php">
<fieldset>
    	...
    	<tr>
			<td>
				<select id="select_nombre_tipo_tercero" name="nombre_tipo_tercero" class="input-block-level"  style="font-size:15px">
			        ...
			        $consulta2_sql = "SELECT * FROM tbl15_tipo_tercero WHERE ((nombre_tipo_tercero = 'INQUILINO') OR (nombre_tipo_tercero = 'AMBOS')) AND (cod_estado = '1') ORDER BY cod_tipo_tercero DESC";
...
<table border="1" class="table table-responsive">
	<tbody>
		<tr>
			...
			<th style="text-align:center">OTROS CONCEPTOS (DEDUCCION DESCUENTO A INQUILINO)</th>
			<!--
			<th style="text-align:center">OTROS IMPUESTOS (DIAN)  (DEDUCCION)</th>
			<th style="text-align:center">CUATRO POR MIL  (DEDUCCION)</th>
			-->
		</tr>
    	<tr>
			<td><input class="input-block-level" style="font-size:24px" name="deduccion_retefuente" type="number" min="0" value="<?php echo $deduccion_retefuente ?>"/></td>
			<td><input class="input-block-level" style="font-size:24px" name="deduccion_otro_concepto" type="number" min="0" value="<?php echo $deduccion_otro_concepto ?>"/></td>
			<!--
			<td><input class="input-block-level" name="deduccion_otro_impuesto_dian" type="number" min="0" value="<?php echo $deduccion_otro_impuesto_dian ?>"/></td>
			<td><input class="input-block-level" name="deduccion_imp_cuatroxmil" type="number" min="0" value="<?php echo $deduccion_imp_cuatroxmil ?>"/></td>
			-->
    	</tr>
    </tbody>
</table>
