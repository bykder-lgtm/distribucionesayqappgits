...
$cod_gasto_inmueble_inquilino_venta        = intval($_GET['cod_gasto_inmueble_inquilino_venta']);
...
$cod_factura                               = $datos_info_gasto_inmueble_inquilino_venta['cod_factura'];
$cod_tercero                               = $datos_info_gasto_inmueble_inquilino_venta['cod_tercero'];
$cod_administrador                         = $datos_info_gasto_inmueble_inquilino_venta['cod_administrador'];
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_consulta_cliente = "SELECT identificacion_tercero, nombre1_tercero, nombre2_tercero, apellido1_tercero, apellido2_tercero, nombre_tipo_identificacion, digito_tercero FROM tbl15_tercero WHERE cod_tercero = '$cod_tercero'";
...
$digito_tercero                       = $total_cliente['digito_tercero'];
...
if ($digito_tercero == '0') { $digito_tercero_inquilino = ''; } else { $digito_tercero_inquilino = '-'.$digito_tercero; }
$identificacion_tercero_inquilino     = $total_cliente['identificacion_tercero'];
//-----------------------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------------------//
...
$digito_tercero_propietario                 = $total_propietario['digito_tercero'];
if ($digito_tercero_propietario == '0') { $digito_tercero_propietario = ''; } else { $digito_tercero_propietario = ' - '.$digito_tercero_propietario; }
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
if ($cod_estado_aprobado == '1') { $url_img_firma_pago = '../imagenes/firma_usuario/firma_aprobado_por_inquilino.png'; } else { $url_img_firma_pago = '../imagenes/firma_usuario/firma_aprobado_por_inquilino.png'; }
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
$titulo_doc_pdf                    = 'COMPROBANTE_CUENTA_DE_ARREGLO_INQUILINO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_alerta.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$autor_doc_pdf                     = 'COMPROBANTE_CUENTA_DE_ARREGLO_INQUILINO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_alerta.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$creador_doc_pdf                   = 'COMPROBANTE_CUENTA_DE_ARREGLO_INQUILINO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_alerta.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$tema_doc_pdf                      = 'COMPROBANTE_CUENTA_DE_ARREGLO_INQUILINO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_alerta.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$palabras_claves_doc_pdf           = 'COMPROBANTE_CUENTA_DE_ARREGLO_INQUILINO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_alerta.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
  ...
  <tr>
    <td width="576" height="10" valign="top"><p>&nbsp;</p>
        <table align="center" border="0" cellpadding="5px" cellspacing="2px" style="font-family:mono; font-size:'.$tamano_font_remision_emp.'pt; width:100%">
          ...
          <tr>
            <th style="text-align:center;" colspan="2">CUENTA DE ARREGLO ARRENDATARIO: '.$nombre_tipo_producto.'</th>
          </tr>
          <tr>
    ...
    <th width="576" height="10" valign="top"><p>&nbsp;</p>
        <table align="center" border="0" cellpadding="" cellspacing="2px" style="font-family:mono; font-size:'.$tamano_font_remision_emp.'pt; width:100%">
          ...
          <tr>
            ...
            <th style="text-align:left;" valign="top">'.$nombre1_tercero.' | '.number_format($identificacion_tercero_inquilino, 0, ",", ".").$digito_tercero_inquilino.'</th>
          </tr>
          <tr>
        ...
        <table align="center" border="0" cellpadding="" cellspacing="2px" style="font-family:mono; font-size:'.$tamano_font_remision_emp.'pt; width:100%">
          <tr>
           ...
           ';
            ...
            $total_gasto = 0;
            $obtener_cie10diag = "SELECT * FROM tbl15_gasto_inmueble_inquilino_venta WHERE (cod_info_gasto_inmueble_inquilino_venta = '$cod_info_gasto_inmueble_inquilino_venta') ORDER BY cod_gasto_inmueble_inquilino_venta DESC";
            ...
            $cod_gasto_inmueble_inquilino_venta    = $info_cie10diag['cod_gasto_inmueble_inquilino_venta'];
...
$codigoHTML.='
        <table align="center" border="0" cellpadding="" cellspacing="2px" style="font-family:mono; font-size:'.$tamano_font_remision_emp.'pt; width:100%">
          <tr>
            <th style="text-align:left;">TOTAL GASTADO: '.number_format($total_gasto, 0, ",", ".").'</th>
           </tr>
          <tr>
    ...
    <th width="576" height="10" valign="top"><p>&nbsp;</p>
        <table align="center" border="0" cellpadding="" cellspacing="2px" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
          ...
          <tr>
            ...
            <th style="text-align:left;" valign="top">_______________________________<br>'.$nombre1_tercero.'<br>'.$nombre_tipo_identificacion.': '.number_format($identificacion_tercero_inquilino, 0, ",", ".").$digito_tercero_inquilino.'</th>
            <th style="text-align:left;" valign="top"></th>
          </tr>
        </table>
  </tr>
...
$ruta = '../pdfs/';
$nombre_archivo = 'COMPROBANTE_CUENTA_DE_ARREGLO_ARRENDATARIO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_info_gasto_inmueble_inquilino_venta.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero.'.pdf';
