...
$(function () {
    $('#container_grafico_estadistico').highcharts({
        ...
        xAxis: [{
            categories: [
<?php
$sql = "SELECT SUM(total_venta_producto) AS total_venta_producto, fecha_mes_venta_producto FROM tbl15_venta_producto GROUP BY fecha_mes_venta_producto ORDER BY fecha_ymd_venta_producto ASC";
