...
$nombres_completos                   = "ENCUESTA DE SATISFACION AL USUARIO-".$nombres_cli.'_'.$apellido1_cli.'-'.$nombre_empresa.'-'.$cedula.'-'.$cod_satisfacion_usuario_encuesta;
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
...
$palabras_claves_doc_pdf             = $nombres_cli.' '.$apellido1_cli.'-'.$nombre_empresa.'-'.$cedula.'-'.$cod_satisfacion_usuario_encuesta;
...
<table align="center" border="1" cellspacing="0" cellpadding="0" style="font-family:mono;  font-size:'.$tamano_font_manaliment_emp.'pt; width:100%">
  <tr>
    ...
    <td width="50%" rowspan="3" align="center">ENCUESTA DE SATISFACIÓN AL USUARIO</td>
...
<table style="text-align:center" border="1" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    <td style="text-align:center">'.$dia.'</td>
    <td style="text-align:center">'.$mes.'</td>
    <td style="text-align:center">'.$anyo.'</td>
  </tr>
</table>
<br>
<!-- ***************************************************************************************************************************** -->
...
<table style="text-align:center" border="1" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td style="text-align:left">'.$calif_serv_global.'</td>
  </tr>
</table>
<br>
<!-- ***************************************************************************************************************************** -->
...
<table style="text-align:center" border="1" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    ...
    <td style="text-align:left">'.$examedic_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">AUDIOMETRÍA</td>
    <td style="text-align:left">'.$audiomet_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">OPTOMETRÍA</td>
    <td style="text-align:left">'.$optomet_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">VISIOMETRÍA</td>
    <td style="text-align:left">'.$visiomet_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">ESPEROMETRÍA</td>
    <td style="text-align:left">'.$espiro_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">OSTEMUSCULAR</td>
    <td style="text-align:left">'.$osteomusc_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">VACUNACIÓN</td>
    <td style="text-align:left">'.$vacunacion_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">LABORATORIO CLÍNICO</td>
    <td style="text-align:left">'.$labclinic_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">RECEPCIÓN</td>
    <td style="text-align:left">'.$recep_experiencia_servicio.'</td>
  </tr>
  <tr>
    <td style="text-align:left">OTROS</td>
    <td style="text-align:left">'.$otros_experiencia_servicio.'</td>
  </tr>
</table>
<br>
<!-- ***************************************************************************************************************************** -->
...
<table style="text-align:center" border="1" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    <td style="text-align:left">'.$comentario_suger.'</td>
  </tr>
</table>
<br>
...
<table style="text-align:center" border="1" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td style="text-align:left">'.$nombre_recomend_ips.'</td>
  </tr>
</table>
<br>
<!-- ***************************************************************************************************************************** -->
...
<table style="text-align:center" border="1" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td style="text-align:left">Nombre del paciente: '.$nom_ape.'</td>
  </tr>
  <tr>
    <td style="text-align:left">Cedula: '.$cedula.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Telefono de contacto: '.$tel_contacto1.'</td>
  </tr>
  <tr>
...
$ruta = '../pdfs/';
$nombre_archivo = 'ENCUESTA_SATISFACION_USUARIO_'.$nombres_cli.'_'.$apellido1_cli.'_'.$nombre_empresa.'_'.$fecha_ymd.'-'.$cedula.'-'.$fecha_hoy.'.pdf';
