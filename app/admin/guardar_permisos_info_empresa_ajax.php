...
if (isset($_REQUEST['campo_incre'])) { $campo_incre = addslashes($_REQUEST['campo_incre']); $incre = $campo_incre; } else { $campo_incre = 0; $incre = $campo_incre; }
// ------------------------------------------------------------------------------------------------- //
if (($tipo_ajax=='tbl15_info_empresa')) {
	$valor                        = addslashes($_POST['valor']);
	$cod_info_empresa             = 1;

	$data_sql = ("UPDATE tbl15_info_empresa SET $campo = '$valor' WHERE cod_info_empresa = '$cod_info_empresa'");
