...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>Lista Gastos a propietario de Inmuebles</font></a></th>
...
$filtro_consulta_tercero $filtro_consulta_cod_factura ORDER BY cod_info_gasto_inmueble_inquilino_venta DESC LIMIT 0, 800";
...
?>
<tr id="<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>">
<?php if ($cod_estado_facturacion_venta_editar == '1') { ?>
<!--<td id="edit<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>" style="text-align:center"><a href="../admin/edit_factura_venta.php?cod_info_gasto_inmueble_inquilino_venta=<?php echo $cod_info_gasto_inmueble_inquilino_venta ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>-->
<?php } ?>
<td style="text-align:center; font-size:13pt;" id="cod_factura<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><?php echo ($cod_factura)?></td>
<td style="text-align:left; font-size:13pt;" id="nombre_tercero<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><?php echo $nombre_tercero?> | <?php echo $nombre_producto?></td>
<td style="text-align:left; font-size:13pt;" id="nombre_gasto_inmueble_detalle<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><?php echo $nombre_gasto_inmueble_detalle?></td>
<td style="text-align:left; font-size:13pt;" id="descripcion_gasto_inmueble_detalle<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><?php echo $descripcion_gasto_inmueble_detalle?></td>
<td style="text-align:right; font-size:13pt;" id="precio_venta_producto<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><?php echo number_format($precio_venta_producto, 0, ",", ".") ?></td>
<td style="text-align:center; font-size:13pt;" id="fecha_gasto_inmueble_detalle<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><?php echo date("d-m-Y", strtotime($fecha_gasto_inmueble_detalle))?></td>
<td style="text-align:center; font-size:13pt;" id="cod_info_gasto_inmueble_inquilino_venta<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><?php echo $cod_info_gasto_inmueble_inquilino_venta?></td>
<?php if ($cod_estado_facturacion_venta_imprimir == '1') { ?>
<!--<td style="text-align:center;" id="edit<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>"><a href="../admin/venta_productos_opcion_imprimir.php?cod_info_gasto_inmueble_inquilino_venta=<?php echo $cod_info_gasto_inmueble_inquilino_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></td>-->
<?php } ?>
<!--
<td id="excel<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>" style="text-align:center"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=EXCEL&cod_info_gasto_inmueble_inquilino_venta=<?php echo $cod_info_gasto_inmueble_inquilino_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/excel.png" class="img-polaroid" alt=""></a></td>
<td id="lista<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>" style="text-align:center"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=LISTA&cod_info_gasto_inmueble_inquilino_venta=<?php echo $cod_info_gasto_inmueble_inquilino_venta?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></td>
-->
</tr id="<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>">
<?php } ?>
</tbody>
...
$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
        ...
        var cod_info_gasto_inmueble_inquilino_venta = $(this).parent().attr('data');
        var dataString = 'llave='+cod_info_gasto_inmueble_inquilino_venta+'&'+'tab='+'<?php echo $tab ?>'+'&'+'campo='+'<?php echo $campo ?>'+'&'+'tipo='+'<?php echo $tipo ?>';
        ...
        $.ajax({
            ...
            success: function() {           
                $('#eliminar-ok').empty();
                $('#eliminar-ok').append('<div align="center" class="correcto">Se ha eliminado correctamente el codigo = '+cod_info_gasto_inmueble_inquilino_venta+'.</div>').fadeIn("slow");
                $('#'+parent).fadeOut("slow");
                $('#cod_info_factura_'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#cod_factura'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#nombre_empresa'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#fecha_anyo'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#fecha_hora'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#nombre_tipo_producto'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#edit'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#excel'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#imp'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#lista'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                $('#tr'+cod_info_gasto_inmueble_inquilino_venta).fadeOut("slow");
                //$('#'+parent).remove();
            }
        });
    });
