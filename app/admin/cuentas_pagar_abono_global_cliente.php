...
$calcular_datos_cuenta_pagar = "SELECT tbl15_tercero.nombre1_tercero, tbl15_tercero.apellido1_tercero, tbl15_cuentas_pagar.cod_tercero, 
...
//$calcular_abonado = "SELECT Sum(abonado) AS abonado FROM cuentas_pagar_abonos WHERE cod_tercero = '$cod_tercero'";
...
<tr>
<td><strong><a href="../admin/cuentas_pagar_detalle_factura.php?cod_tercero=<?php echo $cod_tercero;?>&cliente=<?php echo $cliente;?>"><font size="5px">REGRESAR</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
...
<form method="post" name="formulario_de_actualizacion" action="cuentas_pagar_abono_global_cliente_reg.php">
<table class="table table-striped">
<tr>
...
<tr>
<td style="text-align:center"><input style="font-size:24px" type="text" name="abonado" value="" size="10"  required></td>
...
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_pagar ON tbl15_tercero.cod_tercero = tbl15_cuentas_pagar.cod_tercero 
WHERE (tbl15_cuentas_pagar.cod_tercero='$cod_tercero') AND (tbl15_cuentas_pagar.subtotal > 0) ORDER BY tbl15_cuentas_pagar.subtotal ASC";
$consulta_datos_cuenta_pagar = mysqli_query($conectar, $calcular_datos_cuenta_pagar) or die(mysqli_error($conectar));
$total_datos = mysqli_num_rows($consulta_datos_cuenta_pagar);
