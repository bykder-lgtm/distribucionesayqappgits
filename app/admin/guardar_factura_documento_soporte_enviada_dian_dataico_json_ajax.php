...
if (($campo=='cod_info_factura_compra') && ($tipo_ajax=='tbl15_info_factura_compra')) {
    ...
    $sql_info_factura_compra = "SELECT cod_info_factura_compra FROM tbl15_info_factura_compra WHERE (cod_resolucion_facturacion = '$cod_resolucion_facturacion') AND (cod_factura = '$cod_factura')";
    ...
    $cod_info_factura_compra                      = $datos_info_factura_compra['cod_info_factura_compra'];

	$tiempo_final                                = microtime(true);
	$tiempo_ejecucion_dian_dataico               = $tiempo_final - $tiempo_inicial;

	$data_sql = ("UPDATE tbl15_info_factura_compra SET cod_estado_factura_electronica_enviado_dian = '$cod_estado_factura_electronica_enviado_dian', 
	...
	tiempo_ejecucion_dian_dataico = '$tiempo_ejecucion_dian_dataico' WHERE cod_info_factura_compra = '$cod_info_factura_compra'");
