...
<a href="#"><h4>Reporte Cuentas por Cobrar a Vencer Fecha de Pago</h4></a>
</div>
<hr>
<div class="row-fluid">
...
?>
	<tr>
		...
		<td style="text-align: left; <?php echo $color_alerta_fondo; ?>; <?php echo $color_alerta_letra; ?>"><a href="<?php echo $url_redirect ?>"><?php echo $cliente;?></a></td>
