...
<form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/cargar_soporte_archivo_adjunto_info_factura_venta_nota_observacion_reg.php">
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
    ...
    <thead>
        ...
        <tr>
            <td style="text-align:center"><input type="file" name="url_img1" id="url_img1" multiple accept="image/*" style="display:none" onchange="handleFiles(this.files)" required="required"/><a href="#" class="btn btn-default" id="archivo_selecionado">Selecione el archivo</a><div id="vista_archivo"></div></td>
             <td style="text-align:center;"><input class="input-block-level" name="nombre_nota_observacion" type="text" value="" placeholder="" /></td>
...
<tr id="elim<?php echo $cod_nota_observacion;?>">
    <td style="text-align:center" id="elim<?php echo $cod_nota_observacion;?>"><a href="../admin/soporte_principal_factura_venta_reg.php?cod_nota_observacion=<?php echo $cod_nota_observacion?>&cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&pagina=<?php echo $pagina_local ?>"><img src="<?php echo $url_img_active ?>" class="img-polaroid" alt=""></a></td>
