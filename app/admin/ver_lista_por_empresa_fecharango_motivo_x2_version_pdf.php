...
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo_db2 == $motivo2)) {
...
tbl15_historia_clinica.fecha_ymd, tbl15_historia_clinica.nombre_empresa 
FROM tbl15_cliente RIGHT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente 
WHERE ((tbl15_historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (tbl15_historia_clinica.nombre_empresa='$nombre_empresa') AND ((tbl15_historia_clinica.motivo='$motivo') OR (tbl15_historia_clinica.motivo='$motivo2')) AND (cod_estado_facturacion=1)) ORDER BY tbl15_historia_clinica.fecha_ymd DESC";
