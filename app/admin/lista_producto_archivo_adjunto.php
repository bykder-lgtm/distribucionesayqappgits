...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_producto.php"><font size='+2'>Lista Archivos Adjuntos de Producto</font></a></th>
    </tr>
</table>
...
?>
		<tr>
      <td style="text-align:center"><a href="<?php echo $url_archivo_adjunto?>" target="_blank"><img src="../imagenes/adjuntar_archivo.png" class="img-polaroid" alt=""></a></td>
...
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/reg_producto_archivo_adjunto_reg.php">
<fieldset>
<table border="1" class="table table-responsive">
	<thead>
		<tr>
			<th style="text-align:center">CARGAR ARCHIVO</th>
		</tr>
		<tr>
			<th style="text-align:center"><input type="file" name="archivo_adjunto" id="archivo_adjunto" required></th>
		</tr>
	</thead>
</table>
