...
if ($buscar_por == 'documento_nombre_inquilino') {
	$mostrar_datos_sql = "SELECT * FROM tbl15_tercero WHERE ((nombre1_tercero LIKE '%$buscar%') OR (identificacion_tercero LIKE '$buscar')) AND ((nombre_tipo_tercero = '$nombre_tipo_tercero') OR (nombre_tipo_tercero = 'AMBOS')) ORDER BY nombre1_tercero ASC";
	$consulta = mysqli_query($conectar, $mostrar_datos_sql) or die(mysqli_error($conectar));
	$total_resultados = mysqli_num_rows($consulta);
} elseif ($buscar_por == 'cod_producto_barra') {
	$mostrar_datos_sql = "SELECT * FROM tbl15_tercero WHERE ((identificacion_tercero LIKE '$buscar')) ORDER BY nombre1_tercero ASC";
	$consulta = mysqli_query($conectar, $mostrar_datos_sql) or die(mysqli_error($conectar));
	$total_resultados = mysqli_num_rows($consulta);
} elseif ($buscar_por == 'cod_producto_barra_nombre_producto') {
	$mostrar_datos_sql = "SELECT * FROM tbl15_tercero WHERE (nombre1_tercero LIKE '$buscar%') OR (identificacion_tercero LIKE '$buscar') ORDER BY nombre1_tercero ASC";
	$consulta = mysqli_query($conectar, $mostrar_datos_sql) or die(mysqli_error($conectar));
	$total_resultados = mysqli_num_rows($consulta);
} else {
	$mostrar_datos_sql = "SELECT * FROM tbl15_tercero WHERE ((nombre1_tercero LIKE '%$buscar%') OR (identificacion_tercero LIKE '$buscar')) AND ((nombre_tipo_tercero = '$nombre_tipo_tercero') OR (nombre_tipo_tercero = 'AMBOS')) ORDER BY nombre1_tercero ASC";
