...
if (isset($_POST['nombre_empresa_contratante']) <> '') { $nombre_empresa_contratante = mysqli_real_escape_string($conectar, ($_POST['nombre_empresa_contratante'])); } else { $nombre_empresa_contratante = ''; }

$obtener_empresa_contratante = "SELECT nombre_empresa_contratante FROM tbl15_empresa_contratante WHERE nombre_empresa_contratante = '".($nombre_empresa_contratante)."'";
...
<?php } else {
$sql_data = "INSERT INTO tbl15_empresa_contratante (nombre_empresa_contratante) VALUES ('$nombre_empresa_contratante')";
