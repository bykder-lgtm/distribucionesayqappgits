...
$actualizar_sql = "UPDATE tbl15_gastos_tabla SET conceptos = '$conceptos' WHERE cod_gastos_tabla = '$cod_gastos_tabla'";
$resultado_actualizacion = mysqli_query($conectar, $actualizar_sql) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_concepto_egreso.php">
<?php } ?>
<!-- ***************************************************************************************************************************** -->
