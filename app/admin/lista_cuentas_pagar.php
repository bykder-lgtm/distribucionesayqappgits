...
<?php if ($cod_estado_cuenta_pagar_registrar == '1') { ?><h4>Cuentas por Pagar - <a href="../admin/reg_cuentas_pagar_manual.php">Crear nueva cuenta por pagar</a></h4><?php } ?>
</div>
<hr>
<div class="row-fluid">
...
<tr>
<form action="../admin/lista_cuentas_pagar.php" method="post">
...
<table class="table table-striped">
	<tr>
		<th style="text-align:center"><font size='4'>TOTAL PENDIENTE</font></th>
		<th style="text-align:center"><font size='4'><?php echo number_format($total_subtotal, 0, ",", ".") ?></font></th>
		<th style="text-align:center"><a href="../admin/descargar_cuentas_pagar_spout_xlsx.php?fecha_hoy=<?php echo $fecha_hoy?>"><img src=../imagenes/btn_xlsx.png alt="imprimir_peq"></a></th>
	</tr>
</table>
...
if (isset($_POST['palabra'])) { 
	...
	FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_pagar ON tbl15_tercero.cod_tercero = tbl15_cuentas_pagar.cod_tercero
	WHERE (tbl15_tercero.nombre1_tercero LIKE '%$palabra%') OR (tbl15_tercero.apellido1_tercero LIKE '%$palabra%') GROUP BY tbl15_cuentas_pagar.cod_tercero 
...
?>
	<tr>
		...
		<td><font size='4'><a href="../admin/cuentas_pagar_detalle_factura.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $identificacion_tercero;?></a></font></td>
		<td><font size='4'><a href="../admin/cuentas_pagar_detalle_factura.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $cliente;?></a></font></td>
		...
		<?php if ($cod_estado_cuenta_pagar_editar == '1') { ?>
		<td style="text-align: center;"><font size='4'><a href="../admin/edit_cuentas_pagar.php?cod_tercero=<?php echo $cod_tercero; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/editar.png"></a></font></td>
		<?php } ?>
		<!--<td style="text-align: center;"><font size='4'><a href="../admin/cuentas_pagar_cliente_actualizar.php?cod_tercero=<?php echo $cod_tercero; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/correcto.png"></a></font></td>-->
	</tr>
<?php } ?>
