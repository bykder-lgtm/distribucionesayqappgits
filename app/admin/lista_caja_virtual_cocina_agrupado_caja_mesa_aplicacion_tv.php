...
while ($venta_producto_temporal_agrupado = mysqli_fetch_assoc($resul_venta_producto_temporal_agrupado)) {
    ...
    $fecha_hora_pedido_inicial                      = date("Y-m-d H:i:s", $fecha_seg_venta_producto);
    ...
    foreach ($datos_info_factura_venta_agrupados as $datos_agrupados) {
        ...
        ?>
                                            <tr>
                                                ...
                                                <!--<th style="text-align:center;"><?php echo $fecha_hora_pedido_inicial; ?></th>-->
                                                <?php if ($cod_estado_prioridad_caja_mesa_global == '1') { ?><th style="text-align:center;"><?php echo $cod_prioridad; ?></th><?php } ?>
                                                <th style="text-align:center;"><a href="../admin/entregar_servicio_comida_agrupado_caja_mesa_virtual_info_venta_producto_reg.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&pagina=<?php echo $pagina_local ?>"><img src=../imagenes/entregar_servicio_comida.png alt="entregar_servicio_comida"></th>
...
function refrescar_pagina_aplicacion_tv_ajax(){
    ...
    $.ajax({
        type: "POST",
        url: "../admin/refrescar_pagina_caja_virtual_cocina_agrupado_caja_mesa_aplicacion_tv_ajax.php",
        data: datos_url_ajax,
        //dataType: 'json',
