...
<div class="breadcrumbs"><a href="../admin/lista_info_empresa_app.php"><h4>Info Empresa</h4></a></div>
<div class="row-fluid">
...
$mostrar_datos_sql = "SELECT * FROM tbl15_info_empresa WHERE cod_info_empresa = '1'";
...
<th>Nit Empresa</th>
<th>Icono</th>
<?php if ($cod_estado_info_empresa_editar == '1') { ?><th>Edit</th><?php } ?>
</tr>
</thead>
<tbody>
<?php
...
<?php if ($cod_estado_info_empresa_editar == '1') { ?><td align="center"><a href="../admin/edit_info_empresa_siscredito.php?cod_info_empresa=<?php echo $cod_info_empresa?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td><?php } ?>
</tr>
<?php
}
?>
