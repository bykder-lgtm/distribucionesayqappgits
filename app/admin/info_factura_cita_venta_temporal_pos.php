...
<?php
$suma_temporal = "SELECT Sum(total_venta_producto) As total_venta, Sum(total_costo_producto) As total_compra FROM tbl15_cita_venta_producto_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_cita_factura_venta WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_cita_venta_producto_temporal";
...
<form method="post" name="formulario" action="../admin/cita_venta_producto_reg.php">
...
-->
  ...
  <tr>
   ...
   <td style="text-align:center;"><input name="fecha_hora" id="fecha_hora" type="time" value="<?php echo $fecha_hora ?>" style="width: 140px;" required/></td>
<!--
...
<?php 
$sql_temporal = "SELECT cod_cita_venta_producto_temporal FROM tbl15_cita_venta_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<input type="hidden" name="cod_cita_venta_producto_temporal[]" value="<?php echo $datos_temporal['cod_cita_venta_producto_temporal']; ?>" size="4">
<?php } ?>  
<?php $pagina ='facturacion_cita_venta_temporal_producto_manual_pos.php'; ?>
<input type="hidden" name="cod_info_cita_factura_venta" value="<?php echo $cod_info_cita_factura_venta ?>" size="10">
