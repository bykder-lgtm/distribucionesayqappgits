...
?>
    ...
    <div class="cart-box-main">
        ...
        <form name="formulario_de_actualizacion" method="POST" enctype="multipart/form-data" action="../admin/simulador_credito_producto_visitante_extnosesion_resultado.php">
            <div id="salida_info_actualizada_carrito_compra_ajax" class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-main table-responsive">
                            <div class="mb-3">
                                <label for="address">Nombre del producto</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="valor_credito" id="valor_credito" value="<?php echo $precio_venta_producto_mas_comision_funcionamiento ?>" placeholder="" min="1000" required>
