                        <div class="filter-sidebar-left">
                            <div class="title-left">
                                <h3><a href="../admin/ver_producto_visitante_extnosesion.php">Categorias</a></h3>
                            </div>
<?php
...
while ($datos_producto_categoria = mysqli_fetch_assoc($consulta_producto_categoria)) {
    ...
    if ($cod_categoria == $cod_categoria_get) { ?><a href="../admin/ver_producto_visitante_extnosesion.php?cod_categoria=<?php echo $cod_categoria ?>" class="list-group-item list-group-item-action <?php echo $active ?>"><?php echo $nombre_categoria ?> <small class="text-muted">(<?php echo $total_cat ?>)</small></a>
    <?php } else { ?><a href="../admin/ver_producto_visitante_extnosesion.php?cod_categoria=<?php echo $cod_categoria ?>" class="list-group-item list-group-item-action"><?php echo $nombre_categoria ?> <small class="text-muted">(<?php echo $total_cat ?>)</small></a><?php } ?>
