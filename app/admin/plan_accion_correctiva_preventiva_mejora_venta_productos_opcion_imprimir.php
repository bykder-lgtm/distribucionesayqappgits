...
$pagina                               = addslashes($_GET['pagina']).'?cod_info_plan_accion_correctiva_preventiva_mejora='.$cod_info_plan_accion_correctiva_preventiva_mejora;
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_plan_accion_correctiva_preventiva_mejora WHERE (cod_info_plan_accion_correctiva_preventiva_mejora = '$cod_info_plan_accion_correctiva_preventiva_mejora')";
...
Sum(total_venta_producto*(descuento_ptj/100)) AS total_desc, Sum(total_venta_producto) AS total_venta_neta FROM tbl15_plan_accion_correctiva_preventiva_mejora 
...
<table class="table table-striped">
  ...
  <tr>
    <td><font color='black' size= "+3">ORDEN DE PRODUCCION NO:</font></td>
  ...
  <tr>
    <td><font color='black' size= "+3">TOTAL ORDEN DE PRODUCCION:</font></td>
  ...
  <tr>
    ...
    <td align='center'><a href="../admin/ver_factura_plan_accion_correctiva_preventiva_mejora_venta_pdf.php?cod_info_plan_accion_correctiva_preventiva_mejora=<?php echo $cod_info_plan_accion_correctiva_preventiva_mejora?>" target="_blank"><img src="../imagenes/imprimir_.png"></a></td>
  </tr>
</table>
</center>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>ORDEN DE PRODUCCION NO: <?php echo $prefijo_resolucion_facturacion.' '.$cod_factura; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>NIT CLIENTE: <?php echo ($cedula_cli); ?></strong></td>
  </tr>
  <tr>
...
FROM tbl15_plan_accion_correctiva_preventiva_mejora WHERE (cod_info_plan_accion_correctiva_preventiva_mejora = '$cod_info_plan_accion_correctiva_preventiva_mejora')";
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_factura.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_cotiz_nrm</td>
  </tr>
</table>
