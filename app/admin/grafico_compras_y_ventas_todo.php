...
'COMPRAS Y VENTAS TOTALES',
        ...
        series: [{
            ...
            data: [
<?php
$sql = "SELECT SUM(total_venta_producto) AS total_venta FROM tbl15_venta_producto";
...
?>
            ...
            data: [
<?php
$sql = "SELECT SUM(precio_costo_producto*unidades_total) AS total_compra FROM facturas_cargadas_inv";
$result = mysqli_query($conectar, $sql) or die(mysqli_error($conectar));
while ($registros = mysqli_fetch_array($result)) {
