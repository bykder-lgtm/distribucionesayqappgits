...
if ($cod_tienda <= 0) { header("Location: lista_tienda_coordinador_movil.php"); exit; }
...
if (!$tienda) { header("Location: lista_tienda_coordinador_movil.php"); exit; }
...
<main class="page-container">
    <div class="page-header">
        <a href="lista_tienda_coordinador_movil.php" class="back-btn">
    ...
    <div class="profile-card">
        ...
        <div class="profile-body">
            ...
            <div class="detail-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(99, 102, 241, 0.2); padding-bottom: 0.5rem;">
            ...
            <div class="action-buttons">
                <a href="lista_tienda_coordinador_movil.php" class="action-btn-full back"><i class="fa-solid fa-arrow-left"></i>Volver al Listado</a>
            </div>
        </div>
    </div>
</main>
        ...
        <div class="modal-body">
            ...
            <div style="text-align: center; margin-bottom: 1.5rem;">
                <div style="background: linear-gradient(135deg, rgba(99,102,241,0.2), rgba(79,70,229,0.2)); border-radius: 12px; padding: 1rem; margin-bottom: 1rem;">
                    <i class="fa-solid fa-camera" style="font-size: 2.5rem; color: #6366f1;"></i>
                    <h3 style="color: #6366f1; margin: 0.5rem 0;">Cargar Imágenes de Tienda</h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.gestionarFirma = function(accion) {
        ...
        Swal.fire({
            ...
            text: texto, icon: icono, showCancelButton: true, confirmButtonColor: accion === 'aceptar' ? '#6366f1' : '#ef4444', cancelButtonColor: '#6b7280', confirmButtonText: 'Sí, ' + accion,
