...
<a class="btn btn-primary" href="#"><h6>Reporte Abonos Cuentas por Pagar Por Rango de Fechas</h6></a>
</div>
<div class="row-fluid">
...
<?php if ($cod_estado_cuenta_pagar == '1') { ?>
    ...
    <table class="table table-striped">
        <tr>
            <td style="text-align:center; background-color:#DBE0F3; color:#000;"><strong>PROVEEDOR</strong></td>
    ...
    $sql = "SELECT * FROM tbl15_cuentas_pagar_abonos WHERE (fecha_anyo BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') 
    $filtro_consulta_vendedor $filtro_consulta_tercero $filtro_consulta_tipo_forma_pago ORDER BY cod_cuentas_pagar_abonos DESC";
    ...
    <table class="table table-striped">
        <tr>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#">ABONOS POR FORMA DE PAGO</a></th>
        </tr>
    </table>
    ...
    $sql_abonos_cuenta_cobrar_forma_pago = "SELECT SUM(abonado) AS abonado_forma_pago, cod_tipo_forma_pago, fecha_pago FROM tbl15_cuentas_pagar_abonos WHERE (fecha_anyo BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') 
