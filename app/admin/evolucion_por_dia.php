...
<?php $sql_consulta = "SELECT fecha_ymd FROM tbl15_evolucion GROUP BY fecha_ymd ORDER BY fecha_ymd DESC";
...
ON tbl15_historia_clinica.cod_historia_clinica = tbl15_evolucion.cod_historia_clinica HAVING (tbl15_evolucion.fecha_ymd = '$fecha_ymd') ORDER BY tbl15_evolucion.fecha_time DESC";
