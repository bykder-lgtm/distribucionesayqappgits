<div class="nav-bottom">
    <div class="popup-whatsapp fadeIn">
        <div class="content-whatsapp -top"><img src="<?php echo $nombre_carpeta_pagina ?>/imagenes/secretary.png" width="50"><button type="button" class="closePopup">X</button>
...
-->
        <div class="content-whatsapp -bottom">
          <input class="whats-input" id="whats-in" type="text" Placeholder="Enviar mensaje..." />
            <button class="send-msPopup" id="send-btn" type="button"><img src="<?php echo $nombre_carpeta_pagina ?>/imagenes/btn_enviar_whatsapp.png"></button>
        </div>
    </div>
    <button type="button" id="whats-openPopup" class="whatsapp-button"><div class="float"><img src="<?php echo $nombre_carpeta_pagina ?>/imagenes/btn_whatsapp_flotante.png"></div></button>
