...
if (isset($_REQUEST['nombre_tipo_origen_simulacion'])) { 
    ...
    $cod_categoria                            = intval($_REQUEST['cod_categoria']);
            ...
            ?>
                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2" style="text-align:center;">
                                            <div class="products-single fix">
                                                ...
                                                <div class="why-text">
                                                    <form name="formulario_insersion" method="GET" action="../admin/reg_siscredito_tercero_cliente_simulador_por_cuotas_max_entidad_crediticia.php">
                                                    <?php echo $texto_ini_mensaje_para_descuento_entidad_crediticia ?> <?php echo $calculo_descuento_respecto_al_mayor ?>% <?php echo $texto_fin_mensaje_para_descuento_entidad_crediticia ?>
                                                    <br>
                                                    <h4>
                                                        <span>
                                                    ...
                                                    <h4>
                                                        ...
                                                        <input type="hidden" name="valor_credito" value="<?php echo $total_pagar ?>" />
