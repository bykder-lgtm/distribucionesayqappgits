...
<a href="../admin/lista_gasto_inmueble_inquilino_temporal_virtual.php"><h4>Crear Gastos a Inquilino de Inmuebles</a>
</div>
<hr>
<div class="row-fluid">
...
$sql_mesas_caja_en_uso = "SELECT cod_base_caja FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (nombre_estado_factura = 'ABIERTA') ORDER BY cod_base_caja";
...
$sql_animal = "SELECT MAX(cod_caja_virtual) AS cod_caja_virtual, MAX(cod_base_caja) AS cod_base_caja FROM tbl15_info_gasto_inmueble_inquilino_venta";
...
<?php for ($i=1; $i < $cantidad_caja_mesa+1; $i++) { 
		...
		<th style="text-align:center"><a href="../admin/crear_caja_virtual_sesion_gasto_inmueble_inquilino_sesion_reg.php?cod_caja_virtual=<?php echo $cod_caja_virtual?>&cod_base_caja=<?php echo $i ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/mesa_caja_disponible.png"><br><?php echo $nombre_concepto_multi_virtual.' '.$i; ?></a></th>
		<?php
		} else { ?>
...
<form method="post" name="formulario_de_actualizacion" action="../admin/crear_caja_virtual_sesion_gasto_inmueble_inquilino_sesion_reg.php">
<table class="table table-striped">
<tr>
...
<input type="hidden" name="pagina" value="facturacion_venta_temporal_gasto_inmueble_inquilino.php">
</tr>
</table>
</form>
</div>
