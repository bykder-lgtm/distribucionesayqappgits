...
$incren_sup = 0;
$sql_gasto_inmueble_scrip = "SELECT cod_gasto_inmueble_inquilino_venta_temporal FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_factura = '$cod_factura') 
...
$datos_factura = "SELECT cod_gasto_inmueble_inquilino_venta_temporal FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_factura = '$cod_factura') AND (cod_tipo_estado_incluido = '0')";
$consulta = mysqli_query($conectar, $datos_factura);
$total_datos = mysqli_num_rows($consulta);

$datos_data_info_gasto_inmueble_detalle = "SELECT * FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (nombre_estado_factura = 'ABIERTA') AND (cod_factura = '$cod_factura') AND (cod_tipo_estado_incluido = '0')";
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_gasto_inmueble_inquilino_temporal_virtual.php?pagina=<?php echo $pagina ?>">LISTA DE GASTOS ABIERTOS | </a></strong></td>
        <?php if ($cod_seguridad==1) { ?>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/reporte_gasto_inmueble_venta_relacionado_deducido_inquilino.php">LISTA DE GASTOS DEDUCIDOS</a></strong></td>
        <?php } else { ?>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/reporte_gasto_inmueble_venta_relacionado_deducido_inquilino.php">LISTA DE GASTOS DEDUCIDOS</a></strong></td>
        <?php } ?>
    </tr></tbody>
...
<?php } ?>
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_factura_venta_gasto_inmueble_inquilino_get.php'); ?>
<!-- ***************************************************************************************************************************** -->
...
$sql_gasto_inmueble_inquilino_venta_temporal = "SELECT * FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_factura = '$cod_factura') AND (cod_tipo_estado_incluido = '0') 
ORDER BY cod_gasto_inmueble_inquilino_venta_temporal DESC";
