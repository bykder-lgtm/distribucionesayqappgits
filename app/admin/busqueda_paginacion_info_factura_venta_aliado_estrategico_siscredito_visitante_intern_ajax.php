...
// escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador = '$cod_administrador')";
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador = '$cod_administrador') AND ( ";
...
while ($datos_cuenta_cobrar = mysqli_fetch_assoc($consulta_datos_cuenta_cobrar)) {
    ...
    $sql_venta_producto_temporal = "SELECT cod_producto_barra, nombre_producto, serial1_producto, serial2_producto FROM $tabla_productos_venta 
...
?>
                        <div class="row">
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/lista_soportes_info_factura_venta_siscredito_visitante_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/ver.png"></a></div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/checkout_info_factura_venta_siscredito_visitante_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/editar.png"></a></div>
                            </div>
                        </div>
                        <hr>
<?php } ?>
