...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" WHERE (tbl15_historia_clinica.cod_estado_facturacion = '1') AND ((tbl15_historia_clinica.nombre_empresa = '') OR (tbl15_historia_clinica.nombre_empresa = '-1')) ORDER BY tbl15_historia_clinica.fecha_time DESC";
} else {
    $sWhere.=" AND (tbl15_historia_clinica.cod_estado_facturacion = '1') AND ((tbl15_historia_clinica.nombre_empresa = '') OR (tbl15_historia_clinica.nombre_empresa = '-1')) ORDER BY tbl15_historia_clinica.fecha_time DESC";
}
