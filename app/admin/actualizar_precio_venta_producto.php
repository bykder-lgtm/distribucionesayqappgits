...
$sql_temporal = "SELECT * FROM tbl15_venta_producto WHERE cod_venta_producto = '$cod_venta_producto'";
...
if ($precio_venta_producto1 == '0') {
$precio_venta_producto = $precio_venta_producto1;
...
$actualizar_sql = "UPDATE tbl15_venta_producto SET nombre_tipo_precio_venta = '$nombre_tipo_precio_venta', 
precio_venta_producto = '$precio_venta_producto', total_venta_producto = '$total_venta_producto'
