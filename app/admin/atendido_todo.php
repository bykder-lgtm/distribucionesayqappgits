...
WHERE ((tbl15_historia_clinica.cod_estado_facturacion)=1) ORDER BY tbl15_historia_clinica.fecha_time DESC";
$resultado_cliente = mysqli_query($conectar, $sql_cliente);
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_citas = "SELECT COUNT(cod_historia_clinica) AS conteo_historia_clinica FROM tbl15_historia_clinica";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido = "SELECT COUNT(cod_historia_clinica) AS conteo_historia_clinica FROM tbl15_historia_clinica WHERE cod_estado_facturacion = '1'";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_no_atendido = "SELECT COUNT(cod_historia_clinica) AS conteo_historia_clinica FROM tbl15_historia_clinica WHERE cod_estado_facturacion = '0'";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_evolucion = "SELECT COUNT(cod_evolucion) AS conteo_evoluciones FROM tbl15_evolucion";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_hombre = "SELECT Count(tbl15_cliente.nombre_sexo) AS conteo_hombre, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.cod_estado_facturacion
FROM tbl15_cliente LEFT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente
GROUP BY tbl15_cliente.nombre_sexo, tbl15_historia_clinica.cod_estado_facturacion
HAVING (((tbl15_cliente.nombre_sexo)='M') AND ((tbl15_historia_clinica.cod_estado_facturacion)=1))";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_mujer = "SELECT Count(tbl15_cliente.nombre_sexo) AS conteo_mujer, tbl15_cliente.nombre_sexo, tbl15_historia_clinica.cod_estado_facturacion
FROM tbl15_cliente LEFT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente
GROUP BY tbl15_cliente.nombre_sexo, tbl15_historia_clinica.cod_estado_facturacion
HAVING (((tbl15_cliente.nombre_sexo)='F') AND ((tbl15_historia_clinica.cod_estado_facturacion)=1))";
...
<th><p class="th_color">Precio</p></th>
<th><p class="th_color">Factura</p></th>
