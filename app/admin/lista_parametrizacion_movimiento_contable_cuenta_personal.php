...
<a href="#"><h4>Saldo Cuentas Personales Activas&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_parametrizacion_movimiento_contable_cuenta_personal_inactiva.php">Cuentas Personales Inactivas&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_movimiento_contable_cuenta_personal_historial_modificacion.php">Historial de Modificaciones Manuales</h4></a>
</div>
<hr>
<div class="row-fluid">
...
$sql_movimiento_contable_cuenta_personal = "SELECT SUM(total_saldo) AS total_saldo_movimiento_contable_cuenta_personal FROM tbl15_movimiento_contable_cuenta_personal WHERE (cod_estado = '1')";
...
$matriz_movimiento_contable_cuenta_personal = mysqli_fetch_assoc($consulta_movimiento_contable_cuenta_personal);

$total_saldo_movimiento_contable_cuenta_personal                 = $matriz_movimiento_contable_cuenta_personal['total_saldo_movimiento_contable_cuenta_personal'];
?>
...
?>
		<tr>
            ...
            <?php if ($cod_estado_egreso_editar == '1') { ?><td style="text-align:center; font-size: 20px;"><a href="../admin/edit_movimiento_contable_cuenta_personal.php?cod_movimiento_contable_cuenta_personal=<?php echo $cod_movimiento_contable_cuenta_personal?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td><?php } ?>
		</tr>
	<?php } ?>
            ...
            <th style="text-align:right; font-size: 30px;"><?php echo number_format($total_saldo_movimiento_contable_cuenta_personal, 0, ",", "."); ?></th>
            <!--<th style="text-align:center; font-size: 20px;"></th>-->
