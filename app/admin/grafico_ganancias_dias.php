...
$(function () {
    $('#container_grafico_estadistico').highcharts({
        ...
        xAxis: {
            categories: [
<?php
$sql = "SELECT SUM(total_venta_producto - total_compra_producto) AS ganacia, fecha_anyo FROM tbl15_venta_producto GROUP BY fecha_ymd_venta_producto ORDER BY fecha_ymd_venta_producto ASC";
...
?>
        ...
        series: [{
            ...
            data: [
<?php
$sql = "SELECT SUM(total_venta_producto - total_compra_producto) AS ganacia, fecha_ymd_venta_producto FROM tbl15_venta_producto GROUP BY fecha_ymd_venta_producto ORDER BY fecha_ymd_venta_producto ASC";
$result = mysqli_query($conectar, $sql) or die(mysqli_error($conectar));
while ($registros = mysqli_fetch_array($result)) {
