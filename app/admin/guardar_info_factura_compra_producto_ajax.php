...
$data_sql = ("UPDATE tbl15_compra_producto SET cod_historia_clinica = '$cod_historia_clinica' WHERE cod_info_factura_compra = '$cod_info_factura_compra'");
...
$data_sql = ("UPDATE tbl15_compra_producto SET cod_tercero = '$cod_tercero' WHERE cod_info_factura_compra = '$cod_info_factura_compra'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
FROM tbl15_compra_producto WHERE (cod_info_factura_compra = '$cod_info_factura_compra')";
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_producto_barra') && ($tipo_ajax=='tbl15_compra_producto')) {
$cod_producto_barra           = addslashes($_POST['valor']);
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET cod_producto_barra = '$cod_producto_barra' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_producto') && ($tipo_ajax=='tbl15_compra_producto')) {
$nombre_producto              = addslashes(strtoupper($_POST['valor']));
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET nombre_producto = '$nombre_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_frec_duracion') && ($tipo_ajax=='tbl15_compra_producto')) {
$nombre_frec_duracion         = addslashes(strtoupper($_POST['valor']));
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET nombre_frec_duracion = '$nombre_frec_duracion' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_unidades') && ($tipo_ajax=='tbl15_compra_producto')) {
...
FROM tbl15_compra_producto WHERE (cod_compra_producto = '$cod_compra_producto')";
...
$data_sql = ("UPDATE tbl15_compra_producto SET und_unidades = '$und_unidades', und_compra = '$und_compra', total_compra_producto = '$total_compra_producto', 
precio_costo_producto = '$precio_costo_producto', total_costo_producto = '$total_costo_producto', precio_ipc_total = '$precio_ipc_total' 
WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_caja') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET und_caja = '$und_caja', und_compra = '$und_compra', total_compra_producto = '$total_compra_producto', 
precio_costo_producto = '$precio_costo_producto', total_costo_producto = '$total_costo_producto', precio_ipc_total = '$precio_ipc_total' 
WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_compra') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET und_compra = '$und_compra', total_compra_producto = '$total_compra_producto', 
precio_costo_producto = '$precio_costo_producto', total_costo_producto = '$total_costo_producto', precio_ipc_total = '$precio_ipc_total' 
WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_compra_producto') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET precio_compra_producto = '$precio_compra_producto', total_compra_producto = '$total_compra_producto', 
precio_costo_producto = '$precio_costo_producto', total_costo_producto = '$total_costo_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='iva_ptj') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET iva_ptj = '$iva_ptj', valor_iva = '$valor_iva', precio_costo_producto = '$precio_costo_producto', 
total_costo_producto = '$total_costo_producto', total_compra_producto = '$total_compra_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='dto1') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET dto1 = '$dto1', descuento = '$descuento', total_dto = '$total_dto', precio_costo_producto = '$precio_costo_producto', 
total_costo_producto = '$total_costo_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='dto2') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET dto2 = '$dto2', descuento = '$descuento', total_dto = '$total_dto', precio_costo_producto = '$precio_costo_producto', 
total_costo_producto = '$total_costo_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_ipc') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET precio_ipc = '$precio_ipc', precio_ipc_total = '$precio_ipc_total', total_compra_producto = '$total_compra_producto' 
WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto') && ($tipo_ajax=='tbl15_compra_producto')) {
$precio_venta_producto                    = intval($_POST['valor']);
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET precio_venta_producto = '$precio_venta_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto2') && ($tipo_ajax=='tbl15_compra_producto')) {
$precio_venta_producto2                    = intval($_POST['valor']);
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET precio_venta_producto2 = '$precio_venta_producto2' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto3') && ($tipo_ajax=='tbl15_compra_producto')) {
$precio_venta_producto3                    = intval($_POST['valor']);
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET precio_venta_producto3 = '$precio_venta_producto3' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto4') && ($tipo_ajax=='tbl15_compra_producto')) {
$precio_venta_producto4                    = intval($_POST['valor']);
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET precio_venta_producto4 = '$precio_venta_producto4' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto5') && ($tipo_ajax=='tbl15_compra_producto')) {
$precio_venta_producto5                    = intval($_POST['valor']);
$cod_compra_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET precio_venta_producto5 = '$precio_venta_producto5' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_venta') && ($tipo_ajax=='tbl15_compra_producto')) {
$und_venta                    = intval($_POST['valor']);
$cod_compra_producto  = intval($_POST['id']);

$datos_info_temporal = "SELECT precio_costo_producto, precio_venta_producto FROM tbl15_compra_producto WHERE (cod_compra_producto = '$cod_compra_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_compra_producto SET und_venta = '$und_venta', total_costo_producto = '$total_costo_producto', total_venta_producto = '$total_venta_producto', 
cod_estado_permitir_venta = '$cod_estado_permitir_venta' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$datos_info_temporal = "SELECT und_venta, precio_costo_producto FROM tbl15_compra_producto WHERE (cod_compra_producto = '$cod_compra_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_compra_producto SET precio_venta_producto = '$precio_venta_producto', total_venta_producto = '$total_venta_producto',
cod_estado_permitir_venta = '$cod_estado_permitir_venta' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_cliente') && ($tipo_ajax=='tbl15_compra_producto')) {
$nombre_cliente              = addslashes(strtoupper($_POST['valor']));
$cod_compra_producto = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET nombre_cliente = '$nombre_cliente' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_cobrar') && ($tipo_ajax=='tbl15_compra_producto')) {
$cod_tipo_cobrar             = addslashes(($_POST['valor']));
$id                          = addslashes($_POST['id']);
$frag                        = explode("__", $id);
$cod_compra_producto = $frag[1];

$data_sql = ("UPDATE tbl15_compra_producto SET cod_tipo_cobrar = '$cod_tipo_cobrar' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if (mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_alerta') && ($tipo_ajax=='tbl15_compra_producto')) {
$fecha_alerta                = addslashes(($_POST['valor']));
$cod_compra_producto = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_compra_producto SET fecha_alerta = '$fecha_alerta' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$datos_info_temporal = "SELECT und_venta FROM tbl15_compra_producto WHERE (cod_compra_producto = '$cod_compra_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_audiometria') && ($tipo_ajax=='tbl15_compra_producto')) {
$und_audiometria              = intval($_POST['valor']);
$cod_compra_producto           = intval($_POST['id']);

$datos_info_temporal = "SELECT precio_venta_producto FROM tbl15_compra_producto WHERE (cod_compra_producto = '$cod_compra_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_compra_producto SET und_audiometria = '$und_audiometria', total_venta_audiometria = '$total_venta_audiometria',  
total_venta_producto = '$total_venta_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_optometria') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET und_optometria = '$und_optometria', total_venta_optometria = '$total_venta_optometria',  
total_venta_producto = '$total_venta_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_electrocardiograma') && ($tipo_ajax=='tbl15_compra_producto')) {
...
$data_sql = ("UPDATE tbl15_compra_producto SET und_electrocardiograma = '$und_electrocardiograma', total_venta_electrocardiograma = '$total_venta_electrocardiograma',  
total_venta_producto = '$total_venta_producto' WHERE cod_compra_producto = '$cod_compra_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
