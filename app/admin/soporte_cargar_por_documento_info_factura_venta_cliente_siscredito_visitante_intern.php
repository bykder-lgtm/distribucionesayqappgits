...
if (isset($_GET['cod_nota_observacion'])) {
    ...
    ?>
        <!-- Start Cart  -->
    <form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/soporte_cargar_por_documento_info_factura_venta_cliente_siscredito_visitante_intern_reg.php">
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align:center; width:80%"><input class="form-control" name="nombre_nota_observacion" type="text" value="<?php echo $nombre_nota_observacion ?>" placeholder="" readonly required/></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="submit-button text-center">
                                <button class="btn hvr-hover" id="submit" type="submit">Guardar Soporte</button>
