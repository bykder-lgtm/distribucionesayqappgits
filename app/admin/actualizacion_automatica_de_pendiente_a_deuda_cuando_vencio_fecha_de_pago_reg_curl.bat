...
cd curl
cd x86
curl %ruta_http_produccion%/actualizacion_automatica_de_pendiente_a_deuda_cuando_vencio_fecha_de_pago_reg.php?fecha_ymd_venta_producto_ini=%fecha_ymd_venta_producto_ini%
::curl %ruta_http_prueba%/actualizacion_automatica_de_pendiente_a_deuda_cuando_vencio_fecha_de_pago_reg.php?fecha_ymd_venta_producto_ini=%fecha_ymd_venta_producto_ini%
pause