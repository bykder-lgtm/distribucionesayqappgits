...
$(document).on('click','#btn_guardar_aliado',function(e){
    ...
    $.ajax({
        type: 'POST',
        url: '../admin/reg_tienda_modal_asesor_ajax_reg.php',
        data: formData,
        dataType: 'json',
        processData: false,
        contentType: false,
