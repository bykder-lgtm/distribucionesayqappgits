...
.value-amount.green { color: #10b981; }
            ...
            <div class="detail-section">
                ...
                <div class="values-summary">
                    ...
                    <div class="value-box">
                        ...
                        <span class="value-amount" style="color: #22c55e;" id="detValorContado"></span>
                    </div>
                </div>
            ...
            <div class="detail-section">
                ...
                <div style="background: rgba(16, 185, 129, 0.05); border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 12px; padding: 1rem;">
                    ...
                    <div id="comprbanteActual" style="display: none; margin-bottom: 1rem; text-align: center;">
                        <div style="background: rgba(16, 185, 129, 0.1); padding: 1rem; border-radius: 8px; margin-bottom: 0.75rem;">
                            <i class="fa-solid fa-file-check" style="font-size: 2rem; color: #10b981; margin-bottom: 0.5rem; display: block;"></i>
                            <p style="color: rgba(255,255,255,0.8); margin: 0; font-size: 0.85rem; font-weight: 600;">Comprobante registrado</p>
                            <a id="linkComprobanteActual" href="#" target="_blank" style="color: #10b981; text-decoration: none; font-size: 0.8rem; display: inline-flex; align-items: center; gap: 0.5rem; margin-top: 0.5rem;">
                    ...
                    <div style="position: relative;">
                        ...
                        <label for="inputComprobante" style="display: block; cursor: pointer; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; text-align: center; padding: 1rem; border-radius: 10px; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 15px rgba(16, 185, 129, 0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                    ...
                    <div id="previewComprobante" style="display: none; margin-top: 1rem; text-align: center;">
                        <div style="background: rgba(16, 185, 129, 0.1); padding: 1rem; border-radius: 8px;">
                            <i class="fa-solid fa-file-alt" style="font-size: 2rem; color: #10b981; margin-bottom: 0.5rem; display: block;"></i>
                            <p id="nombreArchivoComprobante" style="color: #10b981; margin: 0; font-size: 0.85rem; font-weight: 600;"></p>
...
<div class="modal-overlay" id="modalComprobanteOverlay">
    <div class="modal-container modal-sm">
        ...
        <div class="modal-body-custom">
            ...
            <div id="compComprobanteActual" style="display: none; margin-top: 1.5rem;">
                <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); padding: 1rem; border-radius: 12px; text-align: center;">
                    ...
                    <a id="compLinkActual" href="#" target="_blank" style="display: inline-flex; align-items: center; gap: 0.5rem; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 0.6rem 1.25rem; border-radius: 10px; text-decoration: none; font-size: 0.85rem; font-weight: 600; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 15px rgba(16, 185, 129, 0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                        <i class="fa-solid fa-external-link-alt"></i> Ver comprobante
                    </a>
                </div>
            ...
            <div style="margin-top: 1.5rem;">
                ...
                <div id="compPreview" style="display: none; margin-top: 1rem;">
                    <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); padding: 1rem; border-radius: 10px; text-align: center;">
                        <i class="fa-solid fa-file-alt" style="font-size: 2rem; color: #10b981; margin-bottom: 0.5rem; display: block;"></i>
                        <p id="compNombreArchivo" style="color: #10b981; margin: 0; font-size: 0.85rem; font-weight: 600;"></p>
        ...
        <div class="modal-footer-custom">
            ...
            <button class="btn-modal" id="compBtnCargar" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; display: none;" onclick="compCargarArchivo()">
                <i class="fa-solid fa-upload"></i> Cargar Comprobante
            </button>
        </div>
    </div>
...
function filtrarCreditos(busqueda) {
    ...
    window.searchTimeout = setTimeout(function() {
        ...
        window.location.href = 'lista_info_factura_venta_asesor_movil.php?estado=' + estado + '&busqueda=' + encodeURIComponent(busqueda);
    }, 500);
}
...
function cargarComprobante() {
    ...
    Swal.fire({
        ...
        html: '<i class="fa-solid fa-spinner fa-spin" style="font-size: 2rem; color: #10b981;"></i><p style="margin-top: 1rem;">Por favor espere...</p>',
