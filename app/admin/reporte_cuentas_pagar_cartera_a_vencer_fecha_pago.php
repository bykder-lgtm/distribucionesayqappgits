...
<table class="table table-striped">
	<tr>
		<th style="text-align: center;"><h4>Listado a Vencer</h4></th>
	</tr>
</table>
...
FROM tbl15_cuentas_pagar WHERE ((tbl15_cuentas_pagar.cod_estado_pago = '0') OR (tbl15_cuentas_pagar.subtotal > '0')) AND (fecha_pago > '$fecha_hoy') ORDER BY tbl15_cuentas_pagar.cod_cuentas_pagar DESC";
...
while ($datos_cuenta_pagar = mysqli_fetch_assoc($consulta_datos_cuenta_pagar)) {
	...
	if ($condicional_fecha_subtotal && $condicional_estado_pago) { 
		...
		$url_actualizar_estado_pago = '../admin/actualizar_estado_pago_cuenta_cobrar_reg.php?cod_cuentas_pagar='.$cod_cuentas_pagar.'&cod_factura='.$cod_factura.'&cod_info_factura_compra='.$cod_info_factura_compra.'&cod_tercero='.$cod_tercero.'&cod_estado_pago='.$cod_estado_pago_invert.'&pagina='.$pagina;
...
?>
	<tr>
		<td style="text-align: center; <?php echo $color_alerta_fondo; ?>; <?php echo $color_alerta_letra; ?>"><a href="<?php echo $url_redirect ?>" target="_blank"><img src="../imagenes/ver.png"></a></td>
		...
		<td style="text-align: center; <?php echo $color_alerta_fondo; ?>; <?php echo $color_alerta_letra; ?>"><?php echo $cod_cuentas_pagar; ?></td>
	</tr>
	<?php //} ?>
<?php } ?>
</table>
