...
$pagina                   = $concatenador."lista_cita_firma_tactil_paciente.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" WHERE (tbl15_historia_clinica.cod_estado_facturacion = '0') ORDER BY tbl15_historia_clinica.fecha_time DESC";
} else {
    $sWhere.=" AND (tbl15_historia_clinica.cod_estado_facturacion = '0') ORDER BY tbl15_historia_clinica.fecha_time DESC";
}
    ...
    $reload = '../admin/lista_cita_historia_clinica_individual.php';
...
<?php if ($cod_seguridad == 1) { ?><th class="column-title">Atender</th><?php } else { } ?>
<?php if ($cod_seguridad == 2) { ?><th class="column-title">Atender</th><?php } else { } ?>
<?php if ($cod_seguridad == 3) { ?><th class="column-title">Ver Cita</th><?php } else { } ?>
...
<th class="column-title">Tipo HC</th>
...
tbl15_historia_clinica.url_img_foto_orig FROM $sTable $sWhere LIMIT $registro_inicio,$per_page";
...
<?php if ($url_img_firma_orig <> '') { ?><td style="text-align:center"><a href="../admin/reg_asignar_firma_tactil_paciente.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina_red=<?php echo $pagina ?>"><img src="../imagenes/existe_firma.png" class="img-polaroid" alt=""></a></td>
<?php } else { ?><td style="text-align:center"><a href="../admin/reg_asignar_firma_tactil_paciente.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina_red=<?php echo $pagina ?>"><img src="../imagenes/no_existe_firma.png" class="img-polaroid" alt=""></a></td><?php } ?>

<?php if ($cod_seguridad == 1) { ?><td style="text-align:center"><a href="../admin/reg_historia_clinica_mejorada.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/btn_hc_generica.png" class="img-polaroid" alt=""></a></td><?php } else { } ?>
<?php if ($cod_seguridad == 2) { ?><td style="text-align:center"><a href="../admin/reg_historia_clinica_mejorada.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/btn_hc_generica.png" class="img-polaroid" alt=""></a></td><?php } else { } ?>
<?php if ($cod_seguridad == 3) { ?><td style="text-align:center"><a href="../admin/vista_previa_cita_foto_firma_paciente.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/btn_hc_generica.png" class="img-polaroid" alt=""></a></td><?php } else { } ?>
...
<?php if ($url_img_foto <> '') { ?><td style="text-align:center"><a href="../admin/edit_cargar_foto_cliente.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina_red=<?php echo $pagina ?>"><img src="../imagenes/existe_archivo.png" class="img-polaroid" alt=""></a></td>
<?php } else { ?><td style="text-align:center"><a href="../admin/edit_cargar_foto_cliente.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina_red=<?php echo $pagina ?>"><img src="../imagenes/no_existe_archivo.png" class="img-polaroid" alt=""></a></td><?php } ?>
