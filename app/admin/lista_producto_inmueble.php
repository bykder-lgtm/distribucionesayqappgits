...
<!-- ***************************************************************************************************************************** -->
<?php if (isset($_GET['cod_estado_inmueble'])) { $cod_estado_inmueble = intval($_GET['cod_estado_inmueble']); } else { $cod_estado_inmueble = ''; } ?>
...
<?php if ($cod_estado_prod_reg_producto == '1') { ?><a class="btn btn-success" href="../admin/reg_producto_inmueble.php">Registrar Inmueble</a><?php } ?>
<br>
<!--
<a class="btn btn-success" data-toggle="modal" data-target=".abrir_modal_registrar">Registrar Producto</a>
<a class="btn btn-success" href="../admin/reg_producto_inmueble.php">Registrar Producto&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            <select class="form-control" name="cod_estado_inmueble" id="cod_estado_inmueble" onchange="load(1)" style="width: 100px;">
            <?php if (isset($cod_estado_inmueble)) { echo "<option value='-1' selected >TODO</option>"; } else { echo "<option value='-1' selected >TODO</option>"; }
            $consulta2_sql = ("SELECT cod_estado_inmueble, nombre_estado_inmueble FROM tbl15_estado_inmueble");
            ...
            <input type="text" class="form-control" id="busqueda_ajax" placeholder="Nombre o Codigo del Inmueble" onkeyup='load(1);'><button type="button" class="btn btn-default" onclick='load(1);'><span class="glyphicon glyphicon-search" ></span> Buscar</button><span id="loader"></span>
        </div>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_producto_inmueble_ajax.js"></script>
