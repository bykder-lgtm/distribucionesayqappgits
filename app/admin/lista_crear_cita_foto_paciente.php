...
<a href="../admin/lista_paciente_buscar.php"><h4>Programar Cita Paciente&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control" id="buscar_por" onchange='load(1);'>
                <option value="nombres">Nombre Paciente</option>
                <option value="nombre_contacto1">Nombre Propietario</option>
                <option value="cedula">Codigo Paciente</option>
            </select>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_crear_cita_foto_paciente_ajax.js"></script>
</body>
</html>