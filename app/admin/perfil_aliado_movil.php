...
<style><?php include_once("../estilo_css/estilo_perfil_aliado.css"); ?></style>
        ...
        <div class="perfil-card" id="cardSeguridad">
            ...
            <div class="view-mode">
                ...
                <div class="btn-group-perfil" style="margin-top: 1rem;">
                    <button type="button" class="btn-perfil btn-perfil-primary" onclick="window.location.href='cambiar_contrasena_aliado_movil.php'"><i class="fa fa-key"></i> Cambiar Contraseña</button>
                </div>
            </div>
        </div>
    </div>
