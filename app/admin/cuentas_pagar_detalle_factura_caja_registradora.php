...
$tab                               = 'tbl15_cuentas_pagar_por_factura';
$campo                             = 'cod_tercero';
$tipo                              = 'eliminar';
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
<tr>
<td style="text-align: center;"><strong><a href="../admin/lista_cuentas_pagar_version_independiente.php"><font size="5px">REGRESAR</font></a></strong></td>
</tr>
<tr>
...
<tr>
<td style="text-align: center;"><a href="../admin/reg_abono_cuentas_pagar_caja_registradora.php?cod_tercero=<?php echo $cod_tercero?>&pagina=<?php echo $pagina?>"><font size="6px">NUEVO ABONO</font></a></td>
</tr>
<?php } ?>
</table>
</table>
...
tbl15_cuentas_pagar.mensaje, tbl15_cuentas_pagar.fecha_pago, tbl15_cuentas_pagar.fecha, tbl15_cuentas_pagar.vendedor, tbl15_cuentas_pagar.cod_info_factura_venta
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:10pt;">
<tr>
<td style="text-align: center; width: 90%; font-family: Courier; font-size:10pt;"><strong>CUENTAS POR PAGAR (POR PROVEEDOR)</strong></td>
</tr>
</table>
