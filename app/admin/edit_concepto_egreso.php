...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_egreso.php"><font size='+2'>EDITAR CONCEPTO DE EGRESOS</font></a></th>
    </tr>
</table>

<div class="table-responsive">
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/edit_concepto_egreso_reg.php">
<table class="table table-striped">
<thead>
<tr>
