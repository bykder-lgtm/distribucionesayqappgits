...
$pagina                                              = addslashes($_GET['pagina']).'?cod_info_factura_transferencia_bodega='.$cod_info_factura_transferencia_bodega;
$cod_info_factura_transferencia_bodega_codif         = DAXCODIFCRYPTOR::encodifdax($cod_info_factura_transferencia_bodega);
$cod_info_factura_transferencia_bodega_codif_cryp    = DAXCODIFCRYPTOR::encriptardax($cod_info_factura_transferencia_bodega_codif);
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_factura_transferencia_bodega WHERE (cod_info_factura_transferencia_bodega = '$cod_info_factura_transferencia_bodega')";
...
$cod_tipo_inventario                 = $info_fact['cod_tipo_inventario'];
$nombre_empresa                      = $info_fact['nombre_empresa'];
$razonsocial_empresa                 = $info_fact['razonsocial_empresa'];
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
Sum(total_venta_producto) As subtotal_base, 
Sum(total_venta_producto) As total_iva, 
Sum(total_venta_producto) AS total_desc, Sum(total_venta_producto) AS total_venta_neta FROM tbl15_transferencia_bodega_producto 
...
$cod_info_factura_strpad   = str_pad($cod_info_factura_transferencia_bodega, 6, "0", STR_PAD_LEFT);
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$resta                               = 1516399999;
$time_seg                            = time();
...
<table class="table table-striped">
  <tr>
    <td><font color='black' size= "+3">TRANSFERENCIA DE SALIDA NO:</font></td>
    <td style="text-align:right;" colspan="2"><font color='black' size= "+3"><?php echo $cod_factura; ?></font></td>
  </tr>
  <tr>
    <td><font color='black' size= "+3">DE:</font></td>
    <td style="text-align:right;" colspan="2"><font color='black' size= "+3"><?php echo $nombre_empresa; ?></font></td>
  </tr>
  <tr>
    <td><font color='black' size= "+3">A:</font></td>
    <td style="text-align:right;" colspan="2"><font color='black' size= "+3"><?php echo $razonsocial_empresa; ?></font></td>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>TRANSFERENCIA DE SALIDA NO: <?php echo $cod_factura; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>DE: <?php echo $nombre_empresa; ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>A: <?php echo $razonsocial_empresa; ?></strong></td>
  </tr>
  <tr>
...
<tr>
<td style="text-align: center; width:35%; font-family: Courier; font-size:8pt;"><strong>CODIGO/CANT</strong></td>
<td style="text-align: center; width:40%; font-family: Courier; font-size:8pt;"><strong>DESCRIPCION</strong></td>
<td style="text-align: center; width:7%; font-family: Courier; font-size:8pt;"><strong>T.COMPRA</strong></td>
<td style="text-align: center; width:2%; font-family: Courier; font-size:8pt;"><strong></strong></td>
</tr>
<?php
$total_compra_producto_sum   = 0;
...
nombre_tipo_unidad_medida, precio_compra_producto, total_compra_producto
...
$total_compra_producto_sum   = $total_compra_producto_sum + $total_compra_producto;
...
?>
<tr>
<td style="text-align: left; width:35%; font-family: Courier; font-size:8pt;"><strong><?php echo $cod_producto_barra.'<br>'.$und_venta.' '.$nombre_tipo_unidad_medida.' X '.number_format($precio_compra_producto, 0, ",", ".") ?></strong></td>
<td style="text-align: left; width:40%; font-family: Courier; font-size:8pt;"><strong><?php echo $nombre_producto ?></strong></td>
<td style="text-align: right; width:7%; font-family: Courier; font-size:8pt;"><strong><?php echo number_format($total_compra_producto, 0, ",", ".") ?></strong></td>
<td style="text-align: left; width:2%; font-family: Courier; font-size:7pt;"><strong></strong></td>
</tr>
<?php } ?>
</table>
...
<th style="text-align: right;width:50%;"><?php echo number_format($total_compra_producto_sum, 0, ",", ".") ?></th>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  <tr>
    <td style="text-align: center; width: 9%; font-family: Courier; font-size:8pt;"><strong></strong></td>
    <td style="text-align: center; width: 9%; font-family: Courier; font-size:8pt;"><strong></strong></td>
    <td style="text-align: center; width: 9%; font-family: Courier; font-size:8pt;"><strong></strong></td>
    <td style="text-align: center; width: 9%; font-family: Courier; font-size:8pt;"><strong></strong></td>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_info_factura_transferencia_bodega.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_transf</td>
  </tr>
</table>
...
<script>  
 $(document).ready(function(){  
  ...
  var cod_info_factura_transferencia_bodega = <?php echo $cod_info_factura_transferencia_bodega ?>;  
    $.ajax({ url:"imprimir_factura_venta_ticket_pos.php", method:"GET", data:{cod_info_factura_transferencia_bodega:cod_info_factura_transferencia_bodega, campo:"cod_info_factura_transferencia_bodega", id:cod_info_factura_transferencia_bodega }, 
