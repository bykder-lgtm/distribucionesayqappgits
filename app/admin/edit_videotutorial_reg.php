...
$cod_videotutorial                = intval($_POST['cod_videotutorial']);
...
$cod_estado                       = addslashes($_POST['cod_estado']);

$actualizar_historia_clinica = "UPDATE tbl15_videotutorial SET nombre_videotutorial = '$nombre_videotutorial', descripcion_videotutorial = '$descripcion_videotutorial', 
url_videotutorial = '$url_videotutorial', cod_estado = '$cod_estado' WHERE cod_videotutorial = '$cod_videotutorial'";
