...
<style>
/* ============================================ */
/* LISTA PRODUCTOS ASESOR - TEMA VERDE ESMERALDA */
/* ============================================ */
...
<nav class="bottom-nav">
    <a href="dashboard_asesor_movil.php" class="nav-item">
        <i class="fa-solid fa-house"></i>
        <span>Inicio</span>
    </a>
    <a href="lista_tienda_asesor_movil.php" class="nav-item">
        <i class="fa-solid fa-store"></i>
        <span>Tiendas</span>
    </a>
    <a href="lista_info_factura_venta_asesor_movil.php" class="nav-item">
        <i class="fa-solid fa-credit-card"></i>
        <span>Créditos</span>
    </a>
    <a href="lista_producto_asesor_movil.php" class="nav-item active">
        <i class="fa-solid fa-boxes-stacked"></i>
        <span>Productos</span>
    </a>
    <a href="config_asesor_movil.php" class="nav-item">
...
function filtrarProductos(busqueda) {
    ...
    window.searchTimeout = setTimeout(function() {
        window.location.href = 'lista_producto_asesor_movil.php?busqueda=' + encodeURIComponent(busqueda);
    }, 500);
}
...
$('#formProducto').on('submit', function(e) {
    ...
    var url = $('#cod_producto').val() ? '../admin/edit_producto_modal_asesor_ajax_reg.php' : '../admin/reg_producto_modal_asesor_ajax_reg.php';
