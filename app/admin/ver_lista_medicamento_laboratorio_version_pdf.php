...
$sql_cliente = "SELECT nombres, nombre_especie, nombre_raza, nombre_sexo FROM tbl15_cliente WHERE cod_cliente = '$cod_cliente'";
...
$titulo_doc_pdf            = 'LISTA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$autor_doc_pdf             = 'LISTA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$creador_doc_pdf           = 'LISTA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$tema_doc_pdf              = 'LISTA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$palabras_claves_doc_pdf   = 'LISTA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa;
$aaaaaa   = "LISTA";
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:20pt; width:100%">
  ...
  <tr>
    <td style="text-align:center; font-size:8pt;">RM: '.$reg_medico_emp.'</td>
  </tr>
  <tr>
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
  <tr>
    <td width="87" valign="top">Paciente: '.$nombres.'</td>
    <td width="40" valign="top">Sexo: '.$nombre_sexo.'</td>
  </tr>
  <tr>
    <td width="87" valign="top">Raza: '.$nombre_raza.'</td>
    <td width="40" valign="top">Especie: '.$nombre_especie.'</td>
  </tr>
</table>
<!-- /////////////////////////////////////////////////// -->
<br>
...
$codigoHTML.='
          <tr>
            <td style="text-align:center" width="2" valign="top"><strong>#</strong></td>
            <td style="text-align:center" width="5" valign="top"><strong>Cantidad</strong></td>
            <td style="text-align:center" width="5" valign="top"><strong>MD</strong></td>
            <td style="text-align:center" width="250" valign="top"><strong>Concepto</strong></td>
            <td style="text-align:center" width="125" valign="top"><strong>Descripcion</strong></td>
           </tr>';

$sql_motivo_conteo = "SELECT * FROM tbl15_venta_producto WHERE (cod_info_factura_venta = '$cod_info_factura_venta') AND (nombre_tipo_producto <> 'HISTORIA_CLINICA') ORDER BY cod_venta_producto DESC";
...
$nombre_frec_duracion           = $info_motivo_conteo['nombre_frec_duracion'];
...
$codigoHTML.='
          <tr>
            ...
            <td style="text-align:center">'.$nombre_tipo_unidad_medida.'</td>
            <td style="text-align:left">'.$nombre_producto_cliente.'</td>
            <td style="text-align:left">'.$nombre_frec_duracion.'</td>
          </tr>';
}
$codigoHTML.='
  </tr>
...
$ruta = '../pdfs/';
$nombre_archivo = 'LISTA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_tipo_producto.'_'.$nombre_empresa.'.pdf';
