...
FROM tbl15_cotizacion_venta_producto_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_cotizacion_factura_venta WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_cotizacion_venta_producto_temporal";
...
<form method="post" name="formulario" action="../admin/cotizacion_venta_producto_reg.php">
...
<?php 
$sql_temporal = "SELECT cod_cotizacion_venta_producto_temporal FROM tbl15_cotizacion_venta_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<input type="hidden" name="cod_cotizacion_venta_producto_temporal[]" value="<?php echo $datos_temporal['cod_cotizacion_venta_producto_temporal']; ?>" size="4">
<?php } ?>  
<?php $pagina ='facturacion_cotizacion_venta_temporal_producto_manual_pos.php'; ?>
<input type="hidden" name="cod_info_cotizacion_factura_venta" value="<?php echo $cod_info_cotizacion_factura_venta ?>" size="10">
