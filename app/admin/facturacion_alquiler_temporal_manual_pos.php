...
$sql_info_factura_venta = "SELECT cod_info_factura_venta FROM tbl15_info_factura_venta WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_caja_virtual.php?pagina=<?php echo $pagina ?>"><?php echo $nombre_concepto_multi_virtual; ?>S VIRTUALES | </a></strong></td>
        ...
        <?php } else { ?>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_info_factura_venta_vendedor.php">LISTA DE FACTURAS</a></strong></td>
        <?php } ?>
    </tr></tbody>
</table>
<br>
...
<!-- ***************************************************************************************************************************** -->
<?php if ($total_datos_info_factura_venta <> 0) { include_once("../admin/modal_registrar_tercero.php"); } ?>
<!-- ***************************************************************************************************************************** -->
...
var i=0;
var incre = <?php echo $total_datos_temporal;?>;
var und_venta_text = "";
...
$(document).ready(function() {
    ...
    var incrent = <?php echo $total_datos_temporal;?>;
