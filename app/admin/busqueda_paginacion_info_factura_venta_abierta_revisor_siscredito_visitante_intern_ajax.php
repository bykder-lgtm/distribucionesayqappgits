...
// escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_revisor = '$cod_administrador') AND (nombre_estado_factura = '$nombre_estado_factura')";
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_revisor = '$cod_administrador') AND (nombre_estado_factura = '$nombre_estado_factura') AND ( ";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="contact-form-right">
                        <div class="row p-3 mb-2 bg-primary text-white">
                            ...
                            <div class="col-md-3">
                                <div style="text-align:center;" class="">Nombres / Producto</div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class="">Estado - Factura</div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class="">Entidad</div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class="">Total Deuda</div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class="">Cuota</div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class="">Operador Credito</div>
                            </div>
                            <div class="col-md-2">
                                <div style="text-align:center;" class="">Telefono / Correo / Direccion</div>
                            </div>
                            <div class="col-md-1">
                        ...
                        <!--
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/checkout_info_factura_venta_cerrada_siscredito_visitante_intern_revisor.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/editar.png"></a></div>
                            </div>
                        -->
                        </div>
<?php
...
while ($datos_cuenta_cobrar = mysqli_fetch_assoc($consulta_datos_cuenta_cobrar)) {
    ...
    $sql_venta_producto_temporal = "SELECT cod_producto_barra, nombre_producto, serial1_producto, serial2_producto FROM tbl15_venta_producto_temporal WHERE (cod_info_factura_venta = '$cod_info_factura_venta')";
...
?>
                        <div class="row">
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/lista_soportes_camara_o_documento_info_factura_venta_siscredito_visitante_intern_previsualizacion_revisor.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/expediente.png"></a></div>
                                <!--<div style="text-align:center;" class=""><a href="../admin/lista_soportes_camara_o_documento_info_factura_venta_siscredito_visitante_intern_revisor.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/expediente.png"></a></div>-->
                            </div>
                            <div class="col-md-3">
                                <div style="text-align:center;" class=""><?php echo $nombres_apellidos ?> | <?php echo $identificacion_tercero ?><br>(<?php echo $nombre_producto ?> - <?php echo $cod_producto_barra ?> <br> IMEI1: <?php echo $serial1_producto ?><br> IMEI2: <?php echo $serial2_producto ?>)</div> 
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="<?php echo $url_imprimir ?>"><?php echo $nombre_estado_factura ?><br><?php echo $nombre_tipo_factura ?>|<?php echo $cod_factura ?></a></div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><?php echo $nombre_entidad_crediticia ?></div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><?php echo number_format($monto_deuda, 0, ",", ".") ?></div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><?php echo number_format($monto_cuota, 0, ",", ".") ?><br><?php echo $nombre_tipo_cobro ?></div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><?php echo $nombre_operador_credito ?></div>
                            </div>
                            <div class="col-md-2">
                                <div style="text-align:center;" class=""><?php echo $telefono1_tercero ?> <br> <?php echo $correo_tercero ?> <br> <?php echo $direccion_tercero ?></div>
                            </div>
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><?php echo $cod_info_factura_venta ?></div>
                            </div>
                        <!--
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/checkout_info_factura_venta_abierta_siscredito_visitante_intern_revisor.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/editar.png"></a></div>
                            </div>
                        -->
                        </div>
                        <hr>
