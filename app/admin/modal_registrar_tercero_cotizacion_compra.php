        ...
        <div class="flex" id="flex">
            <div class="modal_contenido">
                ...
                <form method="post" enctype="multipart/form-data" id="formulario_nuevo_registro_modal" name="formulario_nuevo_registro_modal" class="form-horizontal form-label-left input_mask">
                    <input type="hidden" name="cod_info_impuesto_facturas_hidden" id="cod_info_cotizacion_factura_compra" value="<?php echo $cod_info_cotizacion_factura_compra ?>" placeholder="">
...
function Cargar_nombre_cliente(valor, campo, tipo_ajax) {
    ...
    $('#'+capa_cargar_datos).load("../admin/recargar_consulta_select_cotizacion_compra_ajax.php", { 'valor': valor, 'campo': campo, 'tipo_ajax': tipo_ajax });
}
