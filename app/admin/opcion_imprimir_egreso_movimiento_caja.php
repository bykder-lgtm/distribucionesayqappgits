...
<tr>
<td style="text-align: center; width:10%; font-family: Courier; font-size:8pt;"><strong><?php echo $nombre_concepto_movimiento_caja ?> (<?php echo $nombre_tipo_puc ?>) | <?php echo $nombre1_tercero ?> (<?php echo $cod_factura ?>)</strong></td>
