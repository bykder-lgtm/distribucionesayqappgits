                                                ...
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        -->
                                                            ...
                                                            <a class="cart" href="../admin/producto_detalle_visitante_extnosesion.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>">Ver Producto</a>
                                                            <!--<a class="cart" data-id="<?php echo $cod_producto_barra ?>" id="<?php echo $cod_producto_barra ?>">Ver Producto</a>-->
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <a class="cart" href="../admin/producto_detalle_visitante_extnosesion.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>">Ver Producto</a>
                                                    <!--<a class="hvr-hover" data-id="<?php echo $cod_producto_barra ?>" id="<?php echo $cod_producto_barra ?>">Ver Producto</a>-->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
