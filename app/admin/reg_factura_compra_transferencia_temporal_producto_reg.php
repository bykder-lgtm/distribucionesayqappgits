...
$buscar_por                         = 'nombre_producto';
$foco                               = 'busqueda';
$pagina                             = "../admin/facturacion_transferencia_temporal_producto_manual_pos.php?&cod_info_factura_compra=".$cod_info_factura_compra."&foco=".$foco."&buscar_por=".$buscar_por."&pagina=facturacion_transferencia_temporal_producto_manual_pos.php";

$sql_autoincremento_info_factura = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '$base_datos' AND TABLE_NAME = 'tbl15_info_factura_transferencia'";
...
$cod_info_factura_transferencia     = $datos_autoincremento_info_factura['AUTO_INCREMENT'];

$sql_producto = "SELECT * FROM tbl15_factura_compra_producto WHERE (cod_info_factura_compra = '$cod_info_factura_compra')";
...
$cod_factura_compra_producto        = $datos_producto['cod_factura_compra_producto'];
...
$und_venta                          = $datos_producto['und_compra'];
$cod_caja_virtual                   = $datos_producto['cod_caja_virtual'];
...
$cod_estado_permitir_venta          = '1';
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_transferencia_producto_temporal (cod_info_factura_transferencia, cod_tercero, cod_producto, cod_producto_barra, nombre_producto, und_venta, 
...
cod_administrador, cod_tipo_cobrar, cod_caja_virtual, nombre_tipo_precio_venta, cod_estado_permitir_venta, cod_factura_compra_producto) 
VALUES ('$cod_info_factura_transferencia', '$cod_tercero', '$cod_producto', '$cod_producto_barra', '$nombre_producto', '$und_venta', 
'$precio_compra_producto', '$total_compra_producto', '$precio_costo_producto', '$total_costo_producto', 
'$precio_venta_producto', '$total_venta_producto', '$posologia_cantidad', '$posologia_peso', '$nombre_tipo_producto', '$nombre_tipo_unidad_medida', '$nombre_tipo_presentacion', 
'$nombre_via_administracion', '$nombre_frec_duracion', '$fecha_ymd_venta_producto', '$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', '$fecha_seg_venta_producto', '$cuenta', 
'$cod_administrador', '$cod_tipo_cobrar', '$cod_caja_virtual', '$nombre_tipo_precio_venta', '$cod_estado_permitir_venta', '$cod_factura_compra_producto')";
...
$sql_data = "INSERT INTO tbl15_info_factura_transferencia (cod_info_factura_transferencia, nombre_estado_factura, fecha_ymdhis, cuenta, cod_estado_factura, cod_caja_virtual, fecha_dia, fecha_mes, 
...
VALUES ('$cod_info_factura_transferencia', '$nombre_estado_factura', '$fecha_ymdhis', '$cuenta', '$cod_estado_factura', '$cod_caja_virtual', '$fecha_dia', '$fecha_mes', 
'$fecha_anyo', '$anyo', '$fecha_hora', '$cod_tipo_pago', '$cod_administrador', '$cod_dependencia', '$cod_tipo_forma_pago', 
'$nombre_tipo_factura', '$nombre_tipo_moneda', '$cod_tercero', '$cod_tipo_inventario')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="1; <?php echo $pagina?>">
<?php
} 
?>
<!-- ***************************************************************************************************************************** -->
