...
$pagina                   = $concatenador."lista_paciente.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    // escaping, additionally removing everything that could be (html/javascript-) code
     ...
     if ($buscar_por=='nombres_apellidos') { $columnas_busqueda = array('nombres'); } 
    ...
    $reload = '../admin/lista_paciente.php';
    //loop through fetched data
    if ($numrows>0) { ?>
<table class="table table-striped jambo_table bulk_action">
<thead>
<tr class="headings">
<th style="text-align:center" class="column-title">Atender</th>
...
<tbody>
<?php
$insersion = 'formulario_de_insersion';
...
estrato_contacto1, municipio_contacto1, ocupacion_contacto1, tel_contacto1, direccion_contacto1, cod_empresa
...
<td style="text-align:center"><a href="../admin/reg_asignar_cita_foto_paciente_get_reg.php?cod_cliente=<?php echo $cod_cliente?>&cod_empresa=<?php echo $cod_empresa?>&insersion=<?php echo $insersion?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/btn_hc_generica.png" class="img-polaroid" alt=""></a></td>
...
<td align="center"><a href="../admin/edit_paciente.php?cod_cliente=<?php echo $cod_cliente?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
<?php } else { } ?>
</tr>
<?php } //end while ?>
<tr>
