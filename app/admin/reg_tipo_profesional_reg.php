...
if (isset($_POST['nombre_tipo_historia_clinica']) <> '') { $nombre_tipo_historia_clinica = mysqli_real_escape_string($conectar, ($_POST['nombre_tipo_historia_clinica'])); } else { $nombre_tipo_historia_clinica = ''; }

$obtener_tipo_historia_clinica = "SELECT nombre_tipo_historia_clinica FROM tbl15_tipo_historia_clinica WHERE nombre_tipo_historia_clinica = '".($nombre_tipo_historia_clinica)."'";
...
<?php } else {
$sql_data = "INSERT INTO tbl15_tipo_historia_clinica (nombre_tipo_historia_clinica) VALUES ('$nombre_tipo_historia_clinica')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_tipo_profesional.php">
<?php } } ?>
<!-- ***************************************************************************************************************************** -->
