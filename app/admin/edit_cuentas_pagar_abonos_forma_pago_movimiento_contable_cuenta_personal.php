...
if (isset($_GET['cod_cuentas_pagar_abonos'])) {
    ...
    <tr>
    <td style="text-align:center"><strong><a href="../admin/cuentas_pagar_abonos.php?cod_cuentas_pagar=<?php echo $cod_cuentas_pagar;?>&cod_factura=<?php echo $cod_factura;?>&cod_info_factura_compra=<?php echo $cod_info_factura_compra;?>&cod_tercero=<?php echo $cod_tercero;?>&pagina=<?php echo $pagina;?>&cliente=<?php echo $cliente;?>"><font size="5px">REGRESAR</font></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>
    <tr>
    ...
    <form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/edit_cuentas_pagar_abonos_forma_pago_movimiento_contable_cuenta_personal_reg.php">
    <table class="table table-striped">
        <tr>
    ...
    <input type="hidden" name="cod_cuentas_pagar_abonos" value="<?php echo $cod_cuentas_pagar_abonos; ?>">
