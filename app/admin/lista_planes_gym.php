...
<h4>Lista de Planes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/lista_planes_gym_archivado.php">Lista de Planes - Planes Archivados</h4></a>
</div>
...
<tr>
	...
	<th style="text-align:center">MARCAR EXPIRACION</th>
</tr>
</thead>
<tbody>
<?php
$mostrar_datos_sql = "SELECT * FROM tbl15_info_factura_venta WHERE (fecha_fin_renta_alquiler <> '') AND (nombre_estado_factura = 'CERRADA') AND (cod_estado_alquiler_renta = '1') ORDER BY fecha_fin_renta_alquiler ASC";
