...
<input type='hidden' value='<?php echo $nombre_nota_observacion;?>' id='nombre_nota_observacion<?php echo $cod_nota_observacion;?>'>
                            ...
                            <?php if ($codigo_estado_revision == '0') { // 0 POR CARGAR ?>
                                <div class="col-md-6">
                                    <div style="text-align:center; <?php echo $color_fondo_celda_estado ?>; <?php echo $color_letra_celda_estado ?>" class=""><?php echo $url_estado_soporte.$previsualizar_soporte ?>
                            ...
                            <!--
                                <div class="col-md-1">
                                    <div style="text-align:center;" class=""><a href="../admin/soportes_info_factura_venta_productos_opcion_imprimir_siscredito_visitante_intern.php?cod_nota_observacion=<?php echo $cod_nota_observacion ?>&cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cod_tercero=<?php echo $cod_tercero ?>&pagina=<?php echo $pagina ?>"><?php echo $notificacion_via_whatsapp ?></a></div>
                                </div>
