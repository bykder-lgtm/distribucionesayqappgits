...
<table class="table table-striped">
    <tr>
        <th style="text-align:center"><a href="#"><font size='+2'>Actualizar Productos Del Inventario Por Archivo Plano</font></a></th>
    </tr>
</table>
...
<form action="../admin/actualizar_productos_inventario_campos_punto_y_coma_csv_reg.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
    <table class="table table-striped">
        <thead>
            <tr>
