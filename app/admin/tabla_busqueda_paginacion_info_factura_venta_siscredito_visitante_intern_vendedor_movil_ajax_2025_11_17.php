        ...
        <div class="card_app_movil_enrollment mb-3 p-3">
            <div class="d-flex flex-row align-items-start mb-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <?php if ($codigo_estado_facturacion == '0' && $codigo_tipo_estado_cargue_documentacion == '0') { ?><!-- En Solicitud y Sin cargue de Documentación -->
                    <div class="row mt-2">
                        <div class="col-12">
                    ...
                    <?php } elseif ($codigo_estado_facturacion == '1' && $codigo_tipo_estado_cargue_documentacion == '2') { ?><!-- En Proceso y Sin cargue de Documentación final-->
                    <div class="row mt-2">
                        <div class="col-12">
                            ...
                            <p id="texto_aviso" class="estilo_rainbow_shine">Atento al grupo para envío del código o link al cliente</p>
                        </div>
                    </div>
                    <?php } elseif ($codigo_estado_facturacion == '2' && $codigo_tipo_estado_cargue_documentacion == '3') { ?><!-- En Generación de Factura -->
                    <div class="row mt-2">
                        <div class="col-6">
    ...
    <div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 0.1rem; display: block; position: relative;">
        <button type="button" class="btn-close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Cerrar" style="position: absolute; top: 0.8rem; right: 0.8rem; background: none; border: none; cursor: pointer; z-index: 10;">
			...
			<div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 1.5rem; display: block; position: relative;">
                <div style="text-align: center; width: 100%;">
                    <h5 class="modal-title" id="modalDetalleCreditoLabel" style="font-weight: 700; font-size: 1.3rem; margin: 0; text-align: center;">
                        <span id="modalNombreProducto" style="color: #00d4ff;"></span>
                    </h5>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    ...
                    <div style="text-align: right;">
                        ...
                        <p style="font-size: 1.2rem; font-weight: 700; color: white; margin: 0 0 8px 0;"><span id="modal_entidad_crediticia"></span></p>
                        <div style="display: flex; align-items: right; gap: 8px;">
                            <button type="button" id="btnEditarEntidadCrediticia" onclick="abrirModalCambiarEntidadCrediticia(document.getElementById('modalIDApp').textContent, document.getElementById('modalCodEntidadCrediticia').value)" 
                                style="background: #667eea; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: right;">
                                <i class="fa fa-edit" style="margin-right: 4px;"></i>Cambiar
                            </button>
                        </div>
                    </div>
			...
			<div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 1.5rem; display: block; position: relative;">
				...
				<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    ...
                    <div style="text-align: left;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">Vendedor</p>
                        <p style="font-size: 1rem; font-weight: 700; margin: 0 0 8px 0;"><span id="modalNombresApellidosVendedor" style="color: white;"></span></p>
<!--
                        <div style="display: flex; align-items: center; justify-content: flex-end; gap: 8px;">
                            <button type="button" onclick="abrirModalCambiarVendedor(document.getElementById('modalIDApp').textContent, document.getElementById('modalCodVendedor').value)" 
                            ...
                            <button type="button" onclick="abrirModalRegistrarVendedor(document.getElementById('modalIDApp').textContent)" 
                                style="background: #10b981; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: center;">
                                <i class="fa fa-plus" style="margin-right: 4px;"></i>Nuevo
                            </button>
                        </div>
-->
                    </div>
                    ...
                    <div style="text-align: right;">
                        ...
                        <p style="font-size: 1rem; font-weight: 700; margin: 0 0 8px 0;"><span id="modal_nombre_banco_cuenta" style="color: white;"></span></p>
<!--
                        <div style="display: flex; align-items: center; justify-content: flex-end; gap: 8px;">
                            <button type="button" onclick="abrirModalCambiarBancoCuenta(document.getElementById('modalIDApp').textContent, document.getElementById('modalCodBancoCuenta').value)" 
                                style="background: #667eea; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: center;">
                                <i class="fa fa-edit" style="margin-right: 4px;"></i>Cambiar
                            </button>
                            <button type="button" onclick="abrirModalRegistrarBancoCuenta(document.getElementById('modalIDApp').textContent)" 
                                style="background: #10b981; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: center;">
                                <i class="fa fa-plus" style="margin-right: 4px;"></i>Nuevo
                            </button>
                        </div>
-->
                    ...
                    <div style="text-align: left;">
                        ...
                        <p style="font-size: 0.9rem; font-weight: 400; color: white; margin: 0 0 8px 0;"><span id="modal_observacion_tercero"></span></p>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <button type="button" onclick="abrirModalEditarObservacion(document.getElementById('modalIDApp').textContent, document.getElementById('modal_observacion_tercero').textContent)" 
                                style="background: #667eea; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: center;">
                    ...
                    <div style="text-align: right;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">ID</p>
                        <p style="font-size: 1rem; font-weight: 700; margin: 0 0 8px 0;"><span id="modalIDApp" style="color: white;"></span></p>
                    </div>
                </div>
...
-->
			...
			<div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 1.5rem; display: block; position: relative;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    <div style="text-align: left;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">Fecha</p>
                        <p style="font-size: 1.2rem; font-weight: 700; color: white; margin: 0;"><span id="modalFechaCreacion"></span></p>
                    </div>
                    <div style="text-align: right;">
                        <p style="color: #a0aec0; font-size: 0.85rem; margin-bottom: 0.3rem;">Hora</p>
                        <p style="font-size: 1rem; font-weight: 700; margin: 0;"><span id="modalHora" style="color: white;"></span></p>
                    </div>
                </div>
            </div>
			...
			<div class="modal-header" style="border-bottom: 1px solid rgba(102, 126, 234, 0.3); padding: 1.5rem; display: block; position: relative;">
                <div style="text-align: center;">
                    ...
                    <p style="font-size: 1.2rem; font-weight: 700; color: white; margin: 0 0 8px 0;"><span id="modalTienda"></span></p>
<!--
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <button type="button" onclick="abrirModalCambiarTienda(document.getElementById('modalIDApp').textContent, document.getElementById('modalCodTienda').value)" 
                            style="background: #667eea; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: center;">
                            <i class="fa fa-edit" style="margin-right: 4px;"></i>Cambiar
                        </button>
                        <button type="button" onclick="abrirModalRegistrarTienda(document.getElementById('modalIDApp').textContent)" 
                            style="background: #10b981; color: white; border: none; border-radius: 6px; padding: 4px 8px; font-size: 0.7rem; cursor: pointer; display: flex; align-items: center;">
                            <i class="fa fa-plus" style="margin-right: 4px;"></i>Nuevo
                        </button>
                    </div>
            ...
            <div class="modal-body" style="padding: 2rem;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select id="cod_entidad_crediticia" class="form-control" style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; height: auto; min-height: 45px; line-height: 1.5;" onchange="actualizarPorcentajeEntidad()">
                    ...
                    <div class="col-md-6">
                        <label style="color: #4a5568; font-weight: 600; margin-bottom: 0.5rem; display: block;">Tipo de Simulación</label>
                        <select id="cod_tipo_simulacion_credito" name="cod_tipo_simulacion_credito" class="form-control" onchange="calcularValorCredito()" style="border: 2px solid #e2e8f0; border-radius: 8px; padding: 0.75rem; font-size: 1rem; height: auto; min-height: 45px; line-height: 1.5;">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label style="color: #4a5568; font-weight: 600; margin-bottom: 0.5rem; display: block;"><div id="text_label_valor">Valor de Contado</div></label>
...
#modalListaCapturaImagenes #btnGuardarModalCaptura:hover {
    background-color: #5a2d91 !important;
}
...
function abrirModalDetalleCredito(nombres_apellidos, identificacion_tercero, monto_deuda, monto_deuda_sin_interes, nombre_tipo_pago, cod_entidad_crediticia, nombre_entidad_crediticia, nombre_operador_credito, nombre_tienda, nombre_aliado, nombre_banco_cuenta, nombre_estado_facturacion, nombre_estado_revision, nombres_apellidos_asesor, observacion_tercero, fecha_formateada, hora_formateada, contanenar_nombre_producto, nombre_vendedor, cod_tercero, cod_info_factura_venta, cod_vendedor, cod_tienda, cod_banco_cuenta) {
    ...
    console.log('Desplegar modal: modalDetalleCredito:', { codInfoFacturaVenta: cod_info_factura_venta, codTercero: cod_tercero });
...
function enviarImagenesAjax(cod_info_factura_venta, cod_tercero, cod_tipo_metodo_aprobacion) {
    ...
    $.ajax({
        url: '../admin/reg_procesar_imagenes_credito_modal_ajax_reg.php', // Archivo PHP que procesará las imágenes
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
function abrirModalCamara(cod_nota_observacion) {
    ...
    var cod_tipo_metodo_aprobacion = '1';
    ...
    canvas.toBlob(async (blob) => {
        try {
            ...
            if (result.success) {
                ...
                cerrarModalCamara();
                // Solo mostrar previsualización si NO es modalProcesarOtrasImagenes
                // porque ese modal se reabrirá y recargará con datos frescos del servidor
                if (window.modalOrigenCamara !== 'modalProcesarOtrasImagenes') {
                    // Mostrar previsualización en modalListaCapturaImagenes u otros modales
                    mostrarPrevisualizacion(result.url, result.cod_info_factura_venta, result.cod_nota_observacion, result.cod_tercero);
                } else {
                    console.log('Foto capturada desde modalProcesarOtrasImagenes - reabrirModalOrigen se encargará de mostrar la foto cuando recargue los datos');
                    // Reabrir el modal directamente sin intentar mostrar previsualización
                    reabrirModalOrigen();
                }
            } else {
                $('#mensajeErrorGuardarFoto').text(result.message || 'Error desconocido');
                $('#modalErrorGuardarFoto').modal('show');
            }
