...
if ((isset($_GET['cod_ingre_operacional'])) && ($_GET['cod_ingre_operacional'] != "")) {

$cod_ingre_operacional           = intval($_GET["cod_ingre_operacional"]);
$cod_pyg                         = intval($_GET["cod_pyg"]);
$fecha_mes                       = addslashes($_GET["fecha_mes"]);

$borrar_sql = ("DELETE FROM tbl15_ingre_operacional WHERE cod_ingre_operacional = '$cod_ingre_operacional'");
