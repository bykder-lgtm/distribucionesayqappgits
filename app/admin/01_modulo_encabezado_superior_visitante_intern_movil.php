...
<header class="header_app_movil_enrollment">
  <div class="container d-flex align-items-center">
    ...
    <div>
      <h5 class="mb-0 fw-bold">Gestión de solicitudes</h5>
      <small class="text-white"><?php echo $nombre_tienda ?></small>
    </div>
  </div>
</header>

<?php include_once("../admin/modal_registrar_tercero_factura_venta_movil_aliado_estrategico.php"); ?>
