...
if (isset($_REQUEST['precio_venta_producto'])) {
    ...
    //---------------------------------------------------------------------------------------------------------------------------------//
    if (isset($_REQUEST['cod_producto_codifcryp']) && ($_REQUEST['cod_producto_codifcryp'] <> '')) { 
    ...
    ?>
    <!-- Start Cart  -->
    <form name="formulario_de_actualizacion" method="POST" enctype="multipart/form-data" action="../admin/simulador_credito_producto_visitante_intern_interes_max_entidad_crediticia_resultado_get.php">
