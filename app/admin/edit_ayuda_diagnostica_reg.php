...
$cod_ayuda_diagnostica = intval($_POST['cod_ayuda_diagnostica']);
...
$actualizar_historia_clinica = "UPDATE tbl15_ayuda_diagnostica SET nombre_ayuda_diagnostica = '$nombre_ayuda_diagnostica', 
cod_tipo_historia_clinica = '$cod_tipo_historia_clinica', cod_estado = '$cod_estado' 
WHERE cod_ayuda_diagnostica = '$cod_ayuda_diagnostica'";
