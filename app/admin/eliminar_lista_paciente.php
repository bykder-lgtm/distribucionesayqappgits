...
$.ajax({
        url:'busqueda_paginacion_eliminar_lista_paciente_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&buscar_por='+buscar_por,
        ...
        $(document).on('click', '#cod_concatenado', function(e){
            ...
            SwalDelete(cod_cliente, nombres_apellidos, cedula, action, page, busqueda_ajax, numero_registro_por_pagina, buscar_por);
            e.preventDefault();
        });
...
//****************************************************************************************************//
function SwalDelete(cod_cliente, nombres_apellidos, cedula, action, page, busqueda_ajax, numero_registro_por_pagina, buscar_por){
    swal({
        title: 'Estás seguro?',
...
function leer_registros(action, page, busqueda_ajax, numero_registro_por_pagina, buscar_por){
    $.ajax({
        url:"busqueda_paginacion_eliminar_lista_paciente_ajax.php",
        method:"POST",
