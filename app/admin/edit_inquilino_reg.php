...
if (isset($_POST['deduccion_otro_impuesto_dian']) <> '') { $deduccion_otro_impuesto_dian = intval($_POST['deduccion_otro_impuesto_dian']); } else { $deduccion_otro_impuesto_dian = ''; }
if (isset($_POST['deduccion_imp_cuatroxmil']) <> '') { $deduccion_imp_cuatroxmil = intval($_POST['deduccion_imp_cuatroxmil']); } else { $deduccion_imp_cuatroxmil = ''; }
if (isset($_POST['ingreso_impuesto_iva']) <> '') { $ingreso_impuesto_iva = intval($_POST['ingreso_impuesto_iva']); } else { $ingreso_impuesto_iva = ''; }
...
deduccion_retefuente = '$deduccion_retefuente', deduccion_otro_impuesto_dian = '$deduccion_otro_impuesto_dian', deduccion_imp_cuatroxmil = '$deduccion_imp_cuatroxmil', 
ingreso_impuesto_iva = '$ingreso_impuesto_iva', deduccion_otro_concepto = '$deduccion_otro_concepto' 
WHERE cod_tercero = '$cod_tercero'");
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

$pagina                       = addslashes($_POST['pagina']);
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_inquilino.php">
<?php } else { ?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/lista_inquilino.php">
<?php } ?>
<!-- ***************************************************************************************************************************** -->
