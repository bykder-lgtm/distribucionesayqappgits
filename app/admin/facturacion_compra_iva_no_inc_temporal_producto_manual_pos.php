...
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_factura_compra_iva_no_inc_temporal_pos.php'); ?>
<!-- ***************************************************************************************************************************** -->
...
<th style="text-align:center;">P.COSTO (SIN IVA)</th>
...
<?php if ($cod_estado_compra_caja_global == '1') { ?>
<td style="text-align:center;"><input name="und_unidades" type="number" id="und_unidades<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $und_unidades;?>" min="1" style="width: 40px;" /></td>
<th style="text-align:center;">X</th>
<td style="text-align:center;"><input name="und_caja" type="number" id="und_caja<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $und_caja;?>" min="1" style="width: 40px;" /></td>
<?php } ?>
...
<td style="text-align:center;"><input name="precio_costo_producto" type="text" id="precio_costo_producto<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $precio_costo_producto;?>" style="width: 70px;" /></td>

<input name="precio_compra_producto" type="hidden" id="precio_compra_producto<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $precio_compra_producto;?>" style="width: 70px;" >
...
<?php if ($cod_estado_ganancia_ptj_global  == '1') { ?>
<td style="text-align:center;"><input name="ganancia_ptj" type="number" id="ganancia_ptj<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $ganancia_ptj;?>" style="width: 50px;" min="0"/></td>
<?php } ?>
...
<?php if ($cod_estado_peso_producto_global  == '1') { ?>
<td style="text-align:center;"><input name="peso_producto" type="number" id="peso_producto<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $peso_producto;?>" style="width: 30px;" min="0"/></td>
<?php } ?>
...
<?php if ($cod_estado_meses_garantia_global  == '1') { ?>
<td style="text-align:center;"><input name="meses_garantia" type="number" id="meses_garantia<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $meses_garantia;?>" style="width: 40px;" min="0"/></td>
<?php } ?>
