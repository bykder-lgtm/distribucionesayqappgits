...
$sql_historia_clinica = "SELECT tbl15_historia_clinica.cod_historia_clinica, tbl15_cliente.cod_cliente, tbl15_cliente.nombre_ocupacion, tbl15_cliente.cod_entidad, tbl15_cliente.cedula, 
tbl15_cliente.nombres, tbl15_cliente.apellido1, tbl15_cliente.apellido2, tbl15_cliente.fecha_nac_ymd, tbl15_cliente.fecha_nac_time, tbl15_cliente.edad_anyo, tbl15_cliente.nombre_grupo_rh, 
tbl15_cliente.tel_cliente, tbl15_cliente.correo, tbl15_cliente.direccion, tbl15_cliente.nombre_ciudad, tbl15_cliente.nombre_pais, tbl15_historia_clinica.motivo, tbl15_historia_clinica.nombre_laboratorio, tbl15_historia_clinica.fecha_reg_time, tbl15_historia_clinica.fecha_time, tbl15_historia_clinica.fecha_ymd, tbl15_historia_clinica.cuenta, tbl15_historia_clinica.fecha_dmy, 
...
tbl15_historia_clinica.descripcion_ayuda_diagnostica FROM tbl15_cliente RIGHT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente
...
$nombres_completos = "Medicamentos: ".$nombres.' '.$apellido1.' '.$apellido2;
...
<tr><td width="5%" style="text-align: center;"><img src="../imagenes/logo_superior.png" width="120px" />
<td width="95%" style="text-align: center;"><strong>DR. '.$propietario_nombres_apellidos.'</strong>
<br>'.$info_legal_emp.'<br>'.$cabecera_emp.'<br>'.$eslogan_emp.' - RM: '.$nit_emp.'</td></tr>
</table>
';
...
<tr><td width="100%" style="text-align: center;"><h6>'.$direccion_emp.' - Tel&eacute;fonos: '.$telefono_emp.'<br>
Email: '.$correo_emp.' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; '.$ciudad_emp.' - '.$pais_emp.' [P. {PAGENO}]</h6></td></tr>
</table>
';

$footerE = '
<table width="100%" style="border-top: 1px solid #000000; vertical-align: bottom; font-family:serif; font-size: 12pt; color: #000000;">
<tr><td width="100%" style="text-align: center;"><h6>'.$direccion_emp.' - Tel&eacute;fonos: '.$telefono_emp.'
<br>Email: '.$correo_emp.' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; '.$ciudad_emp.' - '.$pais_emp.' [P. {PAGENO}]</h6></td></tr>
</table>
</body>
</html>
';
