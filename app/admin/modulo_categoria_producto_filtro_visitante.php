...
<?php
$sql_producto_categoria = "SELECT nombre_categoria, count(nombre_categoria) AS total_cat FROM tbl15_producto WHERE (nombre_estado = 'HABILITADO') GROUP BY nombre_categoria";
...
$nombre_categoria                  = $datos_producto_categoria['nombre_categoria'];
...
if ($nombre_categoria == $nombre_categoria_get) { ?><a href="../admin/ver_producto.php?nombre_categoria_codifcryp=<?php echo $nombre_categoria_codifcryp ?>" class="list-group-item list-group-item-action <?php echo $active ?>"><?php echo $nombre_categoria ?> <small class="text-muted">(<?php echo $total_cat ?>)</small></a>
<?php } else { ?><a href="../admin/ver_producto.php?nombre_categoria_codifcryp=<?php echo $nombre_categoria_codifcryp ?>" class="list-group-item list-group-item-action"><?php echo $nombre_categoria ?> <small class="text-muted">(<?php echo $total_cat ?>)</small></a><?php } ?>
