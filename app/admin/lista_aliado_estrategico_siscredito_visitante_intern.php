...
<?php //include_once("06_modulo_imagen_head.php"); ?>
    <!-- Start Cart  -->
<?php 
$cod_seguridad                               = '23'; //ALIADO ESTRATEGIC 
$nombre_tipo_tercero_text                    = ucfirst(strtolower('ALIADO ESTRATEGICO'));
                ...
                <div class="table-main">
                    <div class="mb-2">
                        ...
                        <div class="col-12 d-flex shopping-box">
                            ...
                            <a href="../admin/reg_siscredito_tercero_aliado_estrategico.php?cod_producto_codifcryp=0&cod_seguridad=<?php echo $cod_seguridad ?>&valor_credito=0&cod_entidad_crediticia=0&cod_tipo_cobro=0&cod_meses_credito=0" class="ml-auto btn hvr-hover">Registrar Nuevo <?php echo $nombre_tipo_tercero_text ?></a> 
...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/busqueda_paginacion_cliente_y_aliado_estrategico_siscredito_visitante_intern_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&cod_administrador='+cod_administrador+'&cod_seguridad='+cod_seguridad+'&tabla='+tabla, 
