<?php
$nombre_pagina          = "Catalogo de Productos";
$cod_seguridad_pag      = "1";
...
<?php if (isset($_GET['abrev_tienda'])) { $abrev_tienda = addslashes($_GET['abrev_tienda']); } else { $abrev_tienda = ''; } ?>
...
<?php include_once("../admin/modulo_categoria_producto_filtro_visitante_extnosesion.php"); ?>
...
if (isset($_GET['cod_categoria'])) {
    ...
    cod_categoria, cod_estado, cod_tienda FROM tbl15_producto WHERE (nombre_estado = 'HABILITADO') AND (cod_categoria = '$cod_categoria') ORDER BY nombre_producto DESC";
}
elseif (isset($_GET['buscador'])) { 
    ...
    $sql_producto = "SELECT cod_producto, cod_producto_barra, nombre_producto, und_producto, precio_venta_producto, descripcion_producto, 
    precio_venta_producto2, url_img_min_producto, url_img_orig_producto, nombre_promocion, nombre_promocion_ing, 
    cod_categoria, cod_estado, cod_tienda FROM tbl15_producto WHERE (nombre_estado = 'HABILITADO') AND (nombre_producto LIKE '%$buscador_get%') ORDER BY nombre_producto DESC";
}
elseif (isset($_GET['nombre_marca_codifcryp'])) { 
    ...
    $sql_producto = "SELECT cod_producto, cod_producto_barra, nombre_producto, und_producto, precio_venta_producto, descripcion_producto, 
    precio_venta_producto2, url_img_min_producto, url_img_orig_producto, nombre_promocion, nombre_promocion_ing, 
    cod_categoria, cod_estado, cod_tienda FROM tbl15_producto WHERE (nombre_estado = 'HABILITADO') AND (nombre_marca LIKE '$nombre_marca') ORDER BY nombre_producto DESC";
}
elseif (isset($_GET['abrev_tienda'])) { 
    $abrev_tienda = addslashes($_GET['abrev_tienda']); 

    $sql_tienda = "SELECT * FROM tbl15_tienda WHERE (abrev_tienda = '$abrev_tienda')";
    ...
    $cod_tienda                          = $datos_tienda['cod_tienda'];
    ...
    $sql_producto = "SELECT cod_producto, cod_producto_barra, nombre_producto, und_producto, precio_venta_producto, descripcion_producto, 
    precio_venta_producto2, url_img_min_producto, url_img_orig_producto, nombre_promocion, nombre_promocion_ing, 
    cod_categoria, cod_estado, cod_tienda FROM tbl15_producto WHERE (nombre_estado = 'HABILITADO') ORDER BY nombre_producto DESC";
}
...
while ($datos_producto = mysqli_fetch_assoc($consulta_producto)) {
    ...
    $sql_promocion = "SELECT * FROM tbl15_tienda WHERE cod_tienda = '$cod_tienda'";
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="<?php echo $url_img_min_producto ?>" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                        <!--    
                                                        ...
                                                        -->
                                                            ...
                                                            <a href="../admin/simulador_credito_producto_visitante_extnosesion.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>" class="cart_modif">Simular Pago a Credito</a>
                                                            <!--
                                                            <a href="../admin/simulador_pago_credito_producto_visitante_extnosesion.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>" class="cart_modif">Pagar por Credito</a>
                                                            <a href="../admin/simulador_pago_contado_producto_visitante_extnosesion.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>" class="cart_modif">Pagar por Contado</a>
                                                            -->
...
if (isset($_GET['cod_categoria'])) { 
    ...
    $sql_producto = "SELECT cod_producto, cod_producto_barra, nombre_producto, und_producto, precio_venta_producto, descripcion_producto, 
    precio_venta_producto2, url_img_min_producto, url_img_orig_producto, nombre_promocion, nombre_promocion_ing, 
    cod_categoria, cod_estado, cod_tienda FROM tbl15_producto WHERE (nombre_estado = 'HABILITADO') AND (cod_categoria = '$cod_categoria_get') ORDER BY nombre_producto DESC";
}
elseif (isset($_GET['buscador'])) { 
    $buscador_get = addslashes($_GET['buscador']); 
...
$(document).ready(function() {
    ...
    $('.hvr-hover').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "../admin/reg_venta_temporal_producto_visitante_extnosesion_ajax_reg.php",
            data: datos_url_ajax,
