...
$data_sql = ("UPDATE tbl15_orden_produccion_venta_producto SET cod_tercero = '$cod_tercero' WHERE cod_info_orden_produccion_factura_venta = '$cod_info_orden_produccion_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_frec_duracion') && ($tipo_ajax=='tbl15_orden_produccion_venta_producto')) {
$nombre_frec_duracion         = addslashes(strtoupper($_POST['valor']));
$cod_orden_produccion_venta_producto  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_orden_produccion_venta_producto SET nombre_frec_duracion = '$nombre_frec_duracion' WHERE cod_orden_produccion_venta_producto = '$cod_orden_produccion_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
cod_estado_permitir_venta = '$cod_estado_permitir_venta' WHERE cod_orden_produccion_venta_producto = '$cod_orden_produccion_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$datos_info_temporal = "SELECT und_venta, precio_costo_producto FROM tbl15_orden_produccion_venta_producto WHERE (cod_orden_produccion_venta_producto = '$cod_orden_produccion_venta_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_cobrar') && ($tipo_ajax=='tbl15_orden_produccion_venta_producto')) {
$cod_tipo_cobrar             = addslashes(($_POST['valor']));
$id                          = addslashes($_POST['id']);
$frag                        = explode("__", $id);
$cod_orden_produccion_venta_producto = $frag[1];

$data_sql = ("UPDATE tbl15_orden_produccion_venta_producto SET cod_tipo_cobrar = '$cod_tipo_cobrar' WHERE cod_orden_produccion_venta_producto = '$cod_orden_produccion_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
