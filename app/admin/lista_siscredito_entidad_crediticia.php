...
<a href="#"><h4>Lista de Entidad Crediticia&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<?php if ($cod_estado_tercero_registrar == '1') { ?><a href="../admin/reg_siscredito_entidad_crediticia.php?nombre_tipo_tercero=<?php echo $nombre_tipo_tercero?>">Registrar Entidad Crediticia</h4></a><?php } ?>
</div>
<hr>
<div class="row-fluid">
...
<!-- ***************************************************************************************************************************** -->
<?php
$sql_tercero_cliente = "SELECT * FROM tbl15_entidad_crediticia WHERE (nombre_tipo_tercero = '$nombre_tipo_tercero')";
...
<table class="table table-striped">
	<thead>
		<tr>
			<th style="text-align:right; width: 30%">Total Entidad Crediticias: </th>
...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/busqueda_paginacion_siscredito_entidad_crediticia_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&nombre_tipo_tercero='+nombre_tipo_tercero+'&tabla='+tabla,
