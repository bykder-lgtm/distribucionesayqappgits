...
$cod_tbl15_satisfacion_usuario_encuesta      = intval($_GET['id']);
...
$data_sql = ("UPDATE tbl15_tbl15_satisfacion_usuario_encuestaSET fecha_ymd = '$fecha_ymd', fecha_time = '$fecha_time', fecha_mes = '$fecha_mes', 
...
$data_sql = ("UPDATE tbl15_tbl15_satisfacion_usuario_encuestaSET $campo = '$valor_intro' WHERE cod_tbl15_satisfacion_usuario_encuesta= '$cod_satisfacion_usuario_encuesta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
