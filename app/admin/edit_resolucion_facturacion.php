...
<div class="breadcrumbs"><a href="../admin/lista_resolucion_facturacion.php"><h4>Editar Resolucion</h4></a></div>
<div class="row-fluid">
...
$cod_resolucion_facturacion                 = intval($_GET['cod_resolucion_facturacion']);

$sql_cliente = "SELECT * FROM tbl15_resolucion_facturacion WHERE cod_resolucion_facturacion = '$cod_resolucion_facturacion'";
...
$nombre_tipo_resolucion_facturacion         = $info_cliente['nombre_tipo_resolucion_facturacion'];
$numero_resolucion_facturacion              = $info_cliente['numero_resolucion_facturacion'];
$ini_resolucion_facturacion                 = $info_cliente['ini_resolucion_facturacion'];
$fin_resolucion_facturacion                 = $info_cliente['fin_resolucion_facturacion'];
$prefijo_resolucion_facturacion             = $info_cliente['prefijo_resolucion_facturacion'];
$fecha_resolucion_facturacion               = $info_cliente['fecha_resolucion_facturacion'];
$vigencia_meses_resolucion_facturacion      = $info_cliente['vigencia_meses_resolucion_facturacion'];
$nombre_tipo_estado                         = $info_cliente['nombre_tipo_estado'];
$cod_origen_resolucion_facturacion          = $info_cliente['cod_origen_resolucion_facturacion'];
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/edit_resolucion_facturacion_reg.php">
<fieldset>
    	...
    	<tr>
			...
			<td style="text-align:center">
				<select name="nombre_tipo_resolucion_facturacion"  id="nombre_tipo_resolucion_facturacion_select" class="selectpicker" data-show-subtext="true" data-live-search="true" style="width: 220px;" required>
					...
					$consulta2_sql = ("SELECT cod_tipo_resolucion_facturacion, nombre_tipo_resolucion_facturacion FROM tbl15_tipo_resolucion_facturacion 
					WHERE (cod_origen_resolucion_facturacion = '$cod_origen_resolucion_facturacion') AND (cod_estado = '1') ORDER BY cod_tipo_resolucion_facturacion ASC");
					$consulta2 = mysqli_query($conectar, $consulta2_sql);
					while ($datos2 = mysqli_fetch_assoc($consulta2)) {
			...
			<td style="text-align:center"><input class="input-block-level" name="numero_resolucion_facturacion" type="text" value="<?php echo $numero_resolucion_facturacion; ?>" required /></td>
			<td style="text-align:center"><input class="input-block-level" name="ini_resolucion_facturacion" type="text" value="<?php echo $ini_resolucion_facturacion; ?>" required /></td>
			<td style="text-align:center"><input class="input-block-level" name="fin_resolucion_facturacion" type="text" value="<?php echo $fin_resolucion_facturacion; ?>" required /></td>
    	</tr>
	</thead>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<table border="1" class="table table-responsive">
	<thead>
    	...
    	<tr>
			<td style="text-align:center"><input class="input-block-level" name="prefijo_resolucion_facturacion" type="text" value="<?php echo $prefijo_resolucion_facturacion; ?>" /></td>
			<td style="text-align:center"><input class="input-block-level" name="fecha_resolucion_facturacion" type="date" value="<?php echo $fecha_resolucion_facturacion; ?>" /></td>
			<td style="text-align:center"><input class="input-block-level" name="vigencia_meses_resolucion_facturacion" type="number" value="<?php echo $vigencia_meses_resolucion_facturacion; ?>" min="1"/></td>
			<td style="text-align:center">
				<select name="nombre_tipo_estado" class="selectpicker" data-show-subtext="true" data-live-search="true" style="width: 200px;" required>
					<?php if (isset($nombre_tipo_estado)) { echo ""; } else { echo ""; }
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<input type="hidden" name="cod_resolucion_facturacion" value="<?php echo $cod_resolucion_facturacion ?>">
