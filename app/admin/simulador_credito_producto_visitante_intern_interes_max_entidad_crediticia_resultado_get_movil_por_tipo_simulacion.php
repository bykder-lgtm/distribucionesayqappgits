...
$(document).ready(function(){
    ...
    <!-- Header de Resultados -->
        ...
        -->
        <div class="info-producto-card-simulador">
            ...
            <!--
            <div class="info-item-simulador"><i class="fa fa-dollar-sign"></i><span class="label">Valor de contado:</span><span class="value">$<?php echo number_format($precio_venta_producto, 0, ",", ".") ?></span></div>
            -->
            <div class="info-item-simulador">
        ...
        <?php
            while ($datos_entidad_crediticia = mysqli_fetch_assoc($consulta_entidad_crediticia)) {
                ...
                $texto_ini_mensaje_para_descuento_entidad_crediticia              = $datos_entidad_crediticia['texto_ini_mensaje_para_descuento_entidad_crediticia'];
                $texto_fin_mensaje_para_descuento_entidad_crediticia              = $datos_entidad_crediticia['texto_fin_mensaje_para_descuento_entidad_crediticia'];
                $observaciones_entidad_crediticia                                 = $datos_entidad_crediticia['observaciones_entidad_crediticia'];
                $url_pagina_web_consulta                                          = $datos_entidad_crediticia['url_pagina_web_consulta'];
        ...
        <div class="entidad-card-simulador">
            ...
            <form name="formulario_<?php echo $cod_entidad_crediticia_db ?>" method="GET" action="../admin/reg_siscredito_tercero_cliente_simulador_por_cuotas_max_entidad_crediticia.php">
                ...
                <div class="resultado_url_pagina_web_consulta_simulador">
                    <?php if (!empty($url_pagina_web_consulta)) { ?>
        ...
        <?php } else { ?>
        <div class="no-resultados-simulador"><i class="fa fa-exclamation-circle"></i><h3>No hay opciones disponibles</h3><p>No se encontraron lineas de credito para esta simulación.</p></div>
        <?php } ?>
    </main>
<?php } else { ?>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-abrir-modal-solicitud', function(e) {
        ...
        // Obtener el número de cuotas seleccionado del formulario padre
        var selectCuotas = formularioEntidad.find('select[name="cod_meses_credito"]');
        var codMesesCredito = selectCuotas.val();
...
$(document).ready(function() {
    ...
    $('#formSolicitudCredito').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "../admin/reg_siscredito_tercero_cliente_simulador_por_cuotas_max_entidad_crediticia_ajax_reg.php",
            data: formData,
            beforeSend: function() {
