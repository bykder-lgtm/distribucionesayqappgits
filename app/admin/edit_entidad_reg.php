...
$actualizar_historia_clinica = "UPDATE tbl15_entidad SET nombre_entidad = '$nombre_entidad', direccion = '$direccion', telefono = '$telefono', 
correo = '$correo' WHERE cod_entidad = '$cod_entidad'";
