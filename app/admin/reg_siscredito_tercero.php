...
//-----------------------------------------------------------------------------------------------------------------//
if (isset($_GET['cod_seguridad'])) { $cod_seguridad = addslashes($_GET['cod_seguridad']); } else { $cod_seguridad = '25'; }
...
<a href="../admin/lista_siscredito_tercero.php?nombre_tipo_tercero=<?php echo $nombre_tipo_tercero?>">Lista de <?php echo $nombre_tipo_tercero_titulo?></h4></a>
</div>
<hr>
<div class="row-fluid">
...
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/reg_siscredito_tercero_reg.php?nombre_tipo_tercero=<?php echo $nombre_tipo_tercero ?>">
<fieldset>
    	...
    	<tr>
			<td>
				<select id="select_nombre_tipo_tercero" name="nombre_tipo_tercero" class="input-block-level"  style="font-size:15px">
			        ...
			        $consulta2_sql = "SELECT cod_seguridad, nombre_seguridad, cod_estado_tipo_tercero FROM tbl15_seguridad WHERE (cod_seguridad = '$cod_seguridad') AND (cod_estado_tipo_tercero = '1')";
