...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control" id="buscar_por" onchange='load(1);'>
                ...
                <option value="cod_actitud_laboral">Codigo Aptitud</option>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_actitud_laboral_ajax.js"></script>
</body>
</html>