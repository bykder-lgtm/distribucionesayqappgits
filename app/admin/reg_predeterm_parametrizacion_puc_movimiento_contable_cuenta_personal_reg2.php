...
if (isset($_GET["cod_movimiento_contable_cuenta_personal"])) {
	...
	$actualizar_sql = "UPDATE tbl15_movimiento_contable_cuenta_personal SET cod_estado_puc = '0' WHERE (nombre_modulo_puc = '$nombre_modulo_puc' AND cod_tipo_forma_pago = '$cod_tipo_forma_pago')";
	$resultado_actualizacion = mysqli_query($conectar, $actualizar_sql) or die(mysqli_error($conectar));

	$actualizar_sql = "UPDATE tbl15_movimiento_contable_cuenta_personal SET cod_estado_puc = '$cod_estado_puc' WHERE cod_movimiento_contable_cuenta_personal = '$cod_movimiento_contable_cuenta_personal'";
	$resultado_actualizacion = mysqli_query($conectar, $actualizar_sql) or die(mysqli_error($conectar));
?>
