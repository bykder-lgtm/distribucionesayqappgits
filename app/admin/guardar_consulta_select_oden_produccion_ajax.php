...
if (($_POST['nombre1_tercero'] <> '') && ($tipo_ajax=='registrar')) {
	...
	if ($nombre_sino == 'SI') {
		...
		if ($info_existencia=='0') {
			...
			$sql_data = "UPDATE tbl15_info_orden_produccion_factura_venta SET cod_tercero = '$cod_tercero' WHERE (cod_info_orden_produccion_factura_venta = '$cod_info_orden_produccion_factura_venta')";
