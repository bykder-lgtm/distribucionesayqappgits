...
if ($campo == 'identificacion_tercero') {
	...
	$sql_dato_tercero = "SELECT nombre1_tercero, nombre2_tercero, apellido1_tercero, apellido2_tercero FROM tbl15_tercero WHERE identificacion_tercero = '".($identificacion_tercero)."'";
    ...
    $nombre_tercero                       = trim($info_dato_tercero['nombre1_tercero'].' '.$info_dato_tercero['nombre2_tercero'].' '.$info_dato_tercero['apellido1_tercero'].' '.$info_dato_tercero['apellido2_tercero']);

	if($existe_dato_tercero > 0) {
		$resultado                        = $existe_dato_tercero;
		$mensaje                          = "<img src=../imagenes/advertencia.gif>EL DOCUMENTO: ".$identificacion_tercero." EXISTE EN LA LISTA<img src=../imagenes/advertencia.gif>";
	} else {
		$resultado                        = $existe_dato_tercero;
