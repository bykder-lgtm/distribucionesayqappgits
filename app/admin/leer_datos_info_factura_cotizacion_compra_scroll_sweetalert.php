...
$seleccionado                                                      = 0;
$pagina                                                            = "../admin/lista_info_factura_cotizacion_compra.php";
...
<thead>
	<tr>
        <?php if ($cod_estado_cotizacion_compra_editar == '1') { ?>
        ...
        <?php if ($cod_estado_cotizacion_compra_imprimir == '1') { ?>
...
<tbody>
<?php
$sql_info_factura = "SELECT * FROM tbl15_info_cotizacion_factura_compra WHERE (nombre_estado_factura = 'CERRADA') ORDER BY cod_info_cotizacion_factura_compra DESC LIMIT $registro_inicio, $cantidad_reg_por_pagina";
...
while ($info_info_factura = mysqli_fetch_assoc($resultado_info_factura)) {
    ...
    $total_precio_compra                       = $info_info_factura['total_precio_compra'];
...
?>
	<tr>
        <?php if ($cod_estado_cotizacion_compra_editar == '1') { ?>
        <td id="edit<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:center"><a href="../admin/edit_factura_cotizacion_compra.php?cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
        <?php } ?>
        <td style="text-align:center" id="cod_factura<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:center"><?php echo $cod_factura?></td>
        <td style="text-align:left" id="nombre_empresa<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:left"><?php echo $nombre_cliente?></td>
        <td style="text-align:right" id="nombre_empresa<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:left"><?php echo number_format($total_factura_compra_retefuente, 0, ",", ".") ?></td>
        <td style="text-align:center" id="fecha_anyo<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:center"><?php echo $fecha_anyo?></td>
        <td style="text-align:center" id="fecha_hora<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:center"><?php echo $fecha_hora?></td>
        <td style="text-align:center" id="nombre_tipo_producto<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:center"><?php echo $nombre_tipo_factura?></td>
        <?php if ($cod_estado_cotizacion_compra_imprimir == '1') { ?>
        <td style="text-align:center" id="edit<?php echo $cod_info_cotizacion_factura_compra;?>" style="text-align:center"><a href="../admin/cotizacion_compra_productos_opcion_imprimir.php?cod_info_cotizacion_factura_compra=<?php echo $cod_info_cotizacion_factura_compra ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></td>
        <?php } ?>
        <td style="text-align:center" id="nombre_tipo_cotizacion<?php echo $cod_info_cotizacion_factura_compra;?>"><?php echo $cod_info_cotizacion_factura_compra?></td>
	</tr>
<?php } ?>
</tbody>
</table>