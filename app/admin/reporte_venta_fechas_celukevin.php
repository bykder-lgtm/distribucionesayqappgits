...
if (isset($_GET['fecha_ymd_venta_producto_ini'])) {
    ...
    if ($cod_estado_calcular_ptjganancia_venta_ref_pcompra_pventa_global == '1') { $total_utilidad_bruta_porcentaje = (($total_utilidad_bruta / $total_suma_compra_producto) * 100); } else { $total_utilidad_bruta_porcentaje = (($total_utilidad_bruta / $total_suma_venta_producto) * 100); }
    /* --------------------------------------------------------------------------------------------------------------------------------- */
    /* --------------------------------------------------------------------------------------------------------------------------------- */
    ...
    WHERE (fecha_anyo BETWEEN '$fecha_ymd_venta_producto_fin' AND '$fecha_ymd_venta_producto_fin') AND (tipo_puc = 'EGRESOS') AND (cod_tipo_forma_pago = '$efectivo')";
    ...
    WHERE (fecha_anyo BETWEEN '$fecha_ymd_venta_producto_fin' AND '$fecha_ymd_venta_producto_fin') AND (tipo_puc = 'EGRESOS') AND (cod_tipo_forma_pago = '$transfer')";
    ...
    WHERE (fecha_anyo BETWEEN '$fecha_ymd_venta_producto_fin' AND '$fecha_ymd_venta_producto_fin') AND (tipo_puc = 'EGRESOS')";
...
<div class="container">
    ...
    <table class="table table-striped">
        <tr>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total abono cuenta cobrar credito">Total Abonos (Cuentas Cobrar)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total abono en efectivo cuenta cobrar credito">Total Abono En Efectivo (Cuentas Cobrar)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total abono en transferencia cuenta cobrar credito">Total Abono En Transferencia (Cuentas Cobrar)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total utilidad neta abono cuenta cobrar credito">Total Utilidad Neta Abonos (Cuentas Cobrar)</a></th>
        </tr>
        <tr>
            ...
            <td style="text-align:center;"><?php echo number_format($total_abono_en_transferencia_cuenta_cobrar_credito, 0, ",", ".") ?></td>
            <td style="text-align:center;"><?php echo number_format($total_utilidad_neta_abono_cuenta_cobrar_credito, 0, ",", ".") ?></td>
        </tr>
    </table>

    <table class="table table-striped">
        <tr>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total abono cuenta pagar credito">Total Abonos (Cuentas Pagar)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total abono en efectivo cuenta pagar credito">Total Abono En Efectivo (Cuentas Pagar)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total abono en transferencia cuenta pagar credito">Total Abono En Transferencia (Cuentas Pagar)</a></th>
        </tr>
        <tr>
            ...
            <td style="text-align:center;"><?php echo number_format($total_abono_en_transferencia_cuenta_pagar_credito, 0, ",", ".") ?></td>
        </tr>
    </table>

    <table class="table table-striped">
        <tr>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total caja venta fisica">Total Venta Caja (En Efectivo)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total base cierre caja">Total Base (En Efectivo)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total caja venta fisica mas base vendedor">Total Caja + Base (En Efectivo)</a></th>
        </tr>
        <tr>
            ...
            <td style="text-align:center;"><?php echo number_format($total_caja_venta_fisica_mas_base_vendedor, 0, ",", ".") ?></td>
        </tr>
    </table>
...
<?php if ($cod_estado_reporte_venta_total_compra_caja_registradora_global==1) { ?>
    <table class="table table-striped">
        <tr>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total factura compra movimiento contable personal">Total Factura de Compra</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total factura compra movimiento contable personal contado">Total Factura de Compra (Contado)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total factura compra movimiento contable personal credito">Total Factura de Compra (Credito)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total factura compra movimiento contable personal efectivo">Total Factura de Compra (En Efectivo)</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total factura compra movimiento contable personal transfer">Total Factura de Compra (Transferencia)</a></th>
        </tr>
        <tr>
            <td style="text-align:center;"><?php echo number_format($total_factura_compra_movimiento_contable_personal, 0, ",", ".") ?></td>
            <td style="text-align:center;"><?php echo number_format($total_factura_compra_movimiento_contable_personal_contado, 0, ",", ".") ?></td>
            <td style="text-align:center;"><?php echo number_format($total_factura_compra_movimiento_contable_personal_credito, 0, ",", ".") ?></td>
...
<?php } ?>
    ...
    <table class="table table-striped">
        <tr>
            ...
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total comision_venta">Total Comision</th>
            <?php } ?>
            <?php if ($cod_estado_propina_global == '1') { ?>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total suma servicio propina">Total Propina</th>
            <?php } ?>
            <?php if ($cod_estado_mod_domicilio_y_estado_habilitado_producto_global == '1') { ?>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total suma servic0domicilio">Total Domicilio</th>
            <?php } ?>
        </tr>
        <tr>
            <?php if ($cod_estado_ptj_comision_global == '1') { ?>
...
<div class="container">
    <table class="table table-striped">
        <thead>
            <tr>
                <th style="text-align:center; background-color:#DBE0F3; color:#000; width:10%;"><a href="#" title="nombre tipo forma_pago efectivo">Caja En Efectivo.</a></th>
                <th style="text-align:center; background-color:#DBE0F3; color:#000; width:10%;"><a href="#" title="totales forma pago efectivo">Total Caja (En Efectivo).</a></th>
            </tr>
        </thead>
    <tbody>
    <?php
...
<table class="table table-striped">
    <thead>
        <tr>
            <th style="text-align:center; background-color:#DBE0F3; color:#000; width:10%;"><a href="#" title="nombre tipo forma pago">Forma de Pago</a></th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000; width:10%;"><a href="#" title="suma total venta producto">Total Venta</a></th>
        </tr>
    </thead>
<tbody>
<?php
...
<div class="container">
    ...
    <table class="table table-striped">
    <tr>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">FORMA PAGO</a></th>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="total abonado">ABONOS</a></th>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">FECHA</a></th>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">HORA</a></th>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">ID</a></th>
...
<div class="container">
    ...
    <thead>
    <tr>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">Porcentaje Iva</a></th>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">Valor Base</a></th>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">Valor Iva</a></th>
    <th style="text-align:center; background-color:#DBE0F3; color:#000;"><a href="#" title="aaaaaa">Valor Total</a></th>
    </tr>
    </thead>
    <tbody>
    <?php
...
<?php if ($cod_estado_reporte_venta_total_ganancia==1) { ?>
  <tr>
    <td style="text-align: left; width: 55%; font-family: Courier; font-size:9pt;"><strong>TOTAL UTILIDAD BRUTA:</strong></td>
    <td style="text-align: right; width: 30%; font-family: Courier; font-size:9pt;"><strong><?php echo number_format($total_utilidad_bruta_contado, 0, ",", ".") ?></strong></td>
    <td style="text-align: left; width: 2%; font-family: Courier; font-size:9pt;"></td>
  </tr>
<?php } ?>
<?php if ($cod_estado_reporte_venta_total_utilidad==1) { ?>
  <tr>
    <td style="text-align: left; width: 55%; font-family: Courier; font-size:9pt;"><strong>TOTAL UTILIDAD NETA:</strong></td>
