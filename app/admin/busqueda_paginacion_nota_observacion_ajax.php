...
$pagina                   = $concatenador."lista_nota_observacion.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
if($busqueda_ajax <> NULL) {
	if($buscar_por == 'nombre_producto') {
		...
		$busq_aprox_izq = '%';
		$busq_aprox_der = '%';
     	$aColumns = array('nombre_nota_observacion'); //Columnas de busqueda
	} else {
		$busq_aprox_izq = '%';
		$busq_aprox_der = '%';
     	$aColumns = array('cod_producto_barra', 'nombre_producto'); //Columnas de busqueda
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" ORDER BY cod_nota_observacion DESC";
} else {
    $sWhere.=" ORDER BY cod_nota_observacion DESC";
}
include_once('../ajax/pagination.php'); //include pagination file
    ...
    $reload             = '../admin/lista_nota_observacion.php';
...
while ($datos_consulta = mysqli_fetch_array($query_consulta)) {
	...
	$cod_nota_observacion                           = $datos_consulta['cod_nota_observacion'];
	$nombre_nota_observacion                        = $datos_consulta['nombre_nota_observacion'];
	$fecha_ymd                                      = $datos_consulta['fecha_ymd'];
	$cuenta                                         = $datos_consulta['cuenta'];
	$cod_tipo_nota_observacion                      = $datos_consulta['cod_tipo_nota_observacion'];
	...
	$cod_info_cotizacion_factura_compra             = $datos_consulta['cod_info_cotizacion_factura_compra'];
	$cod_info_cotizacion_factura_venta              = $datos_consulta['cod_info_cotizacion_factura_venta'];
	$cod_info_factura_auditoria                     = $datos_consulta['cod_info_factura_auditoria'];
	$cod_info_factura_transferencia                 = $datos_consulta['cod_info_factura_transferencia'];
	$cod_info_factura_transferencia_bodega_entrada  = $datos_consulta['cod_info_factura_transferencia_bodega_entrada'];
	$cod_info_factura_transferencia_bodega          = $datos_consulta['cod_info_factura_transferencia_bodega'];
	$cod_movimiento_contable                        = $datos_consulta['cod_movimiento_contable'];
	$cod_egreso                                     = $datos_consulta['cod_egreso'];
...
</tr id="<?php echo $cod_nota_observacion;?>">
<?php } //end while ?>
</table>
