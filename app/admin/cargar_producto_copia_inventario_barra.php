...
<form method="GET" name="formulario" action="../admin/reg_cargar_producto_copia_inventario.php">
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody>
    	<tr>
            <th style="text-align:center"><a href="../admin/cargar_producto_copia_inventario.php?cod_info_producto_copia_inventario=<?php echo $cod_info_producto_copia_inventario ?>&pagina=<?php echo $pagina_local ?>">MANUAL</a></th>
            <td bgcolor="#fff" align="center"><input name="cod_producto_barra" id="busqueda" style="height:26" placeholder="C&oacute;digo del producto" required autofocus/><input type="submit" style="font-size:15px" name="buscador" tabindex=3 value="Cargar Producto" /></td>
    	</tr>
            <input type="hidden" name="cod_producto_copia_inventario" value="0">
            <input type="hidden" name="cod_info_producto_copia_inventario" value="<?php echo $cod_info_producto_copia_inventario; ?>">
            <input type="hidden" name="buscar_por" value="cod_producto_barra_nombre_producto">
