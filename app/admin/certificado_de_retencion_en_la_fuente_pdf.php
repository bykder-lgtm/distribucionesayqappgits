...
$cabecera_certificado_retefuente                                   = $matriz_consulta['cabecera_certificado_retefuente'];
$propietario_nit_certificado_retefuente                            = $matriz_consulta['propietario_nit_certificado_retefuente'];
$telefono_certificado_retefuente                                   = $matriz_consulta['telefono_certificado_retefuente'];
$correo_certificado_retefuente                                     = $matriz_consulta['correo_certificado_retefuente'];
$direccion_certificado_retefuente                                  = $matriz_consulta['direccion_certificado_retefuente'];
$localidad_certificado_retefuente                                  = $matriz_consulta['localidad_certificado_retefuente'];
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
	<tr>
    	<td style="text-align:center; font-size:17px; font-weight: bold;">'.$cabecera_certificado_retefuente.'</td>
	</tr>
	<tr>
		<td align="center"><p style="font-size:12px">'.$cabecera_certificado_retefuente.' - NIT '.$propietario_nit_certificado_retefuente.'</p></td>
	</tr>
	<tr>
		<td align="center"><p style="font-size:12px">'.$telefono_certificado_retefuente.' / '.$correo_certificado_retefuente.'</p></td>
	</tr>
	<tr>
		<td align="center"><p style="font-size:12px">DIRECCION: '.$direccion_certificado_retefuente.' / '.$localidad_certificado_retefuente.'</p></td>
	</tr>
</table>
';
