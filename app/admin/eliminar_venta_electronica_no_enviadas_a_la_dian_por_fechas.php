...
<div class="breadcrumbs"><a href="../admin/menu_eliminar_venta.php"><h4>Archivar Facturas de Venta No Enviadas a la Dian Por Fecha</h4></a></div>
<hr>
<div class="row-fluid">
...
?>
<form name="formulario" method="post" enctype="multipart/form-data" action="../admin/eliminar_venta_electronica_no_enviadas_a_la_dian_por_fechas_reg.php">
	...
	<tr>
		...
		<td style="text-align:center;"><input type="submit" value="Archivar Facturas de Venta" name="submit" id="submitButton" class="btn btn-info pull-center" title="Click aqui para enviar" />
	</tr>
	</thead>
	</table>
</form>
