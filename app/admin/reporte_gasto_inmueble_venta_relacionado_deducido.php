...
<table class="table table-striped">
    <tr>
        ...
        <th style="text-align:right"><a href="../admin/lista_gasto_inmueble_detalle_temporal_virtual.php"><font size='+2'>Crear Nuevo Gasto</font></a></th>
    </tr>
</table>
...
while ($datos_total_tipo_factura = mysqli_fetch_assoc($consulta_total_tipo_factura)) {
    ...
    $url_img_orig_producto                             = $datos_total_tipo_factura['url_img_orig_producto'];
    ...
    $incren_sup                                   = $cod_gasto_inmueble_detalle_venta;
...
<tr id="<?php echo $cod_gasto_inmueble_detalle_venta;?>">
<?php if ($cod_estado_facturacion_venta_editar == '1') { ?>
<!--<td id="edit<?php echo $cod_gasto_inmueble_detalle_venta;?>" style="text-align:center"><a href="../admin/edit_factura_venta.php?cod_gasto_inmueble_detalle_venta=<?php echo $cod_gasto_inmueble_detalle_venta ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>-->
<?php } ?>
<td style="text-align:center; font-size:11pt;" id="cod_factura<?php echo $cod_gasto_inmueble_detalle_venta;?>"><?php echo ($cod_factura)?></td>
<td style="text-align:left; font-size:11pt;" id="nombre_tercero<?php echo $cod_gasto_inmueble_detalle_venta;?>"><?php echo $nombre_tercero?> | <?php echo $nombre_producto?></td>
<td style="text-align:left; font-size:11pt;" id="nombre_gasto_inmueble_detalle<?php echo $cod_gasto_inmueble_detalle_venta;?>"><?php echo $nombre_gasto_inmueble_detalle?></td>
...
<td style="text-align:center; font-size:11pt;" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>"><input style="font-size:24px; width: 110px;" type="text" name="precio_compra_producto" id="precio_compra_producto<?php echo $cod_gasto_inmueble_detalle_venta;?>" class="<?php echo $cod_gasto_inmueble_detalle_venta;?>" value="<?php echo $precio_compra_producto;?>" /></td>
<td style="text-align:center; font-size:11pt;" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>"><input style="font-size:24px; width: 110px;" type="text" name="precio_venta_producto" id="precio_venta_producto<?php echo $cod_gasto_inmueble_detalle_venta;?>" class="<?php echo $cod_gasto_inmueble_detalle_venta;?>" value="<?php echo $precio_venta_producto;?>" /></td>
<td style="text-align:right; font-size:11pt;" id="ganancia<?php echo $cod_gasto_inmueble_detalle_venta ?>"><?php echo number_format($ganancia, 0, ",", ".");?></td>
<td style="text-align:center; font-size:11pt;" id="fecha_gasto_inmueble_detalle<?php echo $cod_gasto_inmueble_detalle_venta;?>"><?php echo date("d-m-Y", strtotime($fecha_gasto_inmueble_detalle))?></td>
...
<td style="text-align:center; font-size:11pt;" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta;?>"><?php echo $cod_gasto_inmueble_detalle_venta?></td>
<?php if ($cod_estado_facturacion_venta_imprimir == '1') { ?>
<!--<td style="text-align:center;" id="edit<?php echo $cod_gasto_inmueble_detalle_venta;?>"><a href="../admin/venta_productos_opcion_imprimir.php?cod_gasto_inmueble_detalle_venta=<?php echo $cod_gasto_inmueble_detalle_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></td>-->
<?php } ?>
</tr id="<?php echo $cod_gasto_inmueble_detalle_venta;?>">
<?php } ?>
</tbody>
...
$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
        ...
        var cod_gasto_inmueble_detalle_venta = $(this).parent().attr('data');
        var dataString = 'llave='+cod_gasto_inmueble_detalle_venta+'&'+'tab='+'<?php echo $tab ?>'+'&'+'campo='+'<?php echo $campo ?>'+'&'+'tipo='+'<?php echo $tipo ?>';
        ...
        $.ajax({
            ...
            success: function() {           
                $('#eliminar-ok').empty();
                $('#eliminar-ok').append('<div align="center" class="correcto">Se ha eliminado correctamente el codigo = '+cod_gasto_inmueble_detalle_venta+'.</div>').fadeIn("slow");
                $('#'+parent).fadeOut("slow");
                $('#cod_info_factura_'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#cod_factura'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#nombre_empresa'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#fecha_anyo'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#fecha_hora'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#nombre_tipo_producto'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#edit'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#excel'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#imp'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
                $('#lista'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
...
$(document).ready(function(){
    $('textarea[name="descripcion_gasto_inmueble_detalle"]').change(function(){ 
        ...
        var tab  = "tbl15_gasto_inmueble_detalle_venta";
        //let id = this.id;
        var id = $(this).attr("id");

        $.ajax({ 
            url:"edit_gasto_inmueble_detalle_ajax_reg.php", 
            method:"GET", 
