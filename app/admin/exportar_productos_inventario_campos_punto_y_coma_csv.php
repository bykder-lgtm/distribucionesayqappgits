...
$hora                                = date("H_i_s");
$nombre_archivo                      = "PRODUCTOS_INVENTARIO_ARCHIVO_PLANO".'_'.$nombre_empresa."_".$fecha.'_'.$hora.'.csv';

$salida                              = "";

$salida .= '0ID'.';'.'CODIGO_BARRAS'.';'.'CODIGO_BARRAS2'.';'.'NOMBRE_PRODUCTO'.';'.'UNIDADES_'.$nombre_campo_undidades_inv1.';'.'UNIDADES_'.$nombre_campo_undidades_inv2.';'.'UNIDADES_BODEGA2'.';'.'PRECIO_COMPRA'.';'.'TOTAL_PCOMPRA'.';'.
...
while ($datos = mysqli_fetch_assoc($consulta)) {
	...
	$salida .= $cod_producto.';'.$cod_producto_barra.';'.$cod_producto_barra2.';'.$nombre_producto.';'.$und_producto.';'.$und_producto_bodega.';'.$und_producto_bodega2.';'.$precio_compra_producto.';'.$total_pcompra.';'.
