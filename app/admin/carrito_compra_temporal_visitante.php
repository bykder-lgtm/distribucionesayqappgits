...
?>
                                <tr id="tr-<?php echo $cod_carrito_compra_temporal;?>">
                                    ...
                                    <td id="und_venta-<?php echo $cod_carrito_compra_temporal;?>" class="quantity-box"><input type="number" name="<?php echo $campo_codifcryp;?>" onChange="calc_total_venta();" id="und_venta<?php echo $incre;?>" min="1" max="1" data_codifcryp="<?php echo $cod_carrito_compra_temporal;?>" size="4" min="0" step="1" class="c-input-text qty text" value="<?php echo $und_venta;?>">
...
-->
                ...
                <div class="col-12 d-flex shopping-box"><a href="../admin/checkout_visitante.php" class="ml-auto btn hvr-hover">Revisar Compra</a> </div>
            </div>
...
<script type="text/javascript">
    $("input").change(function(){  
        ...
        $.ajax({  
            url:"actualizar_und_precio_vend_carrito_compra_ajax.php",  
            method:"POST",  
            data:{cod_carrito_compra_temporal:cod_carrito_compra_temporal, valor:valor, campo_codifcryp:campo_codifcryp, accion_codifcryp:accion_codifcryp, origen_codifcryp:origen_codifcryp, vendedor_codifcryp:vendedor_codifcryp},
            beforeSend: function(objeto){
                $('#loader').html('<img src="../imagenes/loader.gif">');
            },
            success:function(respuesta){
