...
$subquery_aliados = "SELECT cod_administrador FROM tbl15_administrador WHERE cod_asesor = '$cod_administrador' AND cod_seguridad = '23' AND cod_estado != '0' AND cod_estado_activacion_usuario != '3'";
...
WHERE t.cod_aliado_estrategico IN ($subquery_aliados) AND t.ubicacion_gps_tienda IS NOT NULL AND t.ubicacion_gps_tienda != '' AND t.cod_estado != '0' $condiciones";
