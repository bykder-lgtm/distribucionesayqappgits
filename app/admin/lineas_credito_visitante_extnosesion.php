<?php 
$nombre_pagina          = "Lineas de Credito";
$cod_seguridad_pag      = "1";
...
<?php //include_once("../admin/05_modulo_slider_nosotros_visitante_extnosesion.php"); ?>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="../archivador/img_producto/orig/publicidad_entidad_crediticia_01.jpg" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="../archivador/img_producto/orig/publicidad_entidad_crediticia_02.jpg" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="../archivador/img_producto/orig/publicidad_entidad_crediticia_03.jpg" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="../archivador/img_producto/orig/publicidad_entidad_crediticia_04.jpg" alt="" />
                        </div>
                    </div>
