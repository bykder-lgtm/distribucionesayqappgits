...
$nombre_producto           = $datos_consulta['nombre_producto'];
            ...
            if ($eliminar_registro = mysqli_query($conectar,"UPDATE tbl15_producto SET cod_estado_promocion = '0' WHERE cod_producto = '".$id."'")) { ?>
...
// escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sWhere = "WHERE (cod_estado_promocion = '1')";
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = " WHERE (cod_estado_promocion = '1') AND (";
...
<tr class="even pointer">
    ...
    <?php if ($cod_estado_prod_url_img_producto_orig == '1') { ?>
    <td style="text-align:center"><a href="../admin/lista_producto_imagen.php?cod_producto=<?php echo $cod_producto?>&pagina=<?php echo $pagina ?>"><img src="<?php echo $url_img_min_producto ?>" style="width:300px;" class="img-rounded" alt=""></a></td>
    <?php } ?>
