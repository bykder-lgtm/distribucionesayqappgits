...
<head>
    ...
    <title>Mapa de Tiendas (Asesor) - <?php echo $nombre_empresa; ?></title>
    ...
    <style>
        :root {
            ...
            --bg_gradient: <?php echo $bg_gradient; ?>;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .popup-header { background: var(--bg_gradient); padding: 12px 15px; }
        ...
        .marker-cluster-small div { background-color: rgba(16, 185, 129, 0.8) !important; color: white !important; font-weight: 700; }
        .marker-cluster-medium { background-color: rgba(5, 150, 105, 0.4) !important; }
...
<body>
    ...
    <header class="app-header">
        <a href="config_asesor_movil.php" class="back-btn">
