...
if (isset($_GET['cod_info_producto_copia_inventario'])) {
    ...
    $paginar_edirect = '../admin/producto_copia_inventario_completo_version2.php?cod_info_producto_copia_inventario='.$cod_info_producto_copia_inventario;
?>
    <table class="table table-striped">
        <tr>
            <th style="text-align:center;"><img src=../imagenes/advertencia.gif alt='Advertencia'><a href="<?php echo $paginar_edirect;?>">ALERTA HAY PRODUCTOS SIN CONTAR</a><img src=../imagenes/advertencia.gif alt='Advertencia'></th>
        </tr>
        <tr>
            <td style="text-align:justify;">Por favor marque los productos sin contar con el check que esta en la parte derecha "<img src="../imagenes/check_vacio.png">", 
            una vez haga esto de le click en el mensaje que sale en la parte de arriba <strong>"ALERTA HAY PRODUCTOS SIN CONTAR"</strong>, 
            para intentar guardar el inventario nuevamente, en caso contrario este mensaje volverá a desplegarse y no podrá guardar el inventario hasta no marcar todos los prodctos como contados.</td>
        </tr>
    </table>
