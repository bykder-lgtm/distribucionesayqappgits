...
$tab = 'tbl15_ayuda_diagnostica';
$tipo = 'eliminar';
$campo = 'cod_ayuda_diagnostica';

$sql_cliente = "SELECT cod_ayuda_diagnostica, nombre_ayuda_diagnostica, cod_estado FROM tbl15_ayuda_diagnostica ORDER BY nombre_ayuda_diagnostica ASC";
