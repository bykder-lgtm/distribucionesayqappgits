...
<a href="../admin/lista_paciente_buscar.php"><h4>Foto y firma del paciente&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></h4>
</div>
<hr>
<div class="row-fluid">
...
?>
<form name="frmSubir" method="post" enctype="multipart/form-data" action="reg_asignar_foto_firma_paciente_reg.php">
<fieldset>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<table align="center" border="1" class="table table-responsive" cellspacing="0" cellpadding="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    ...
    <tbody>
    <tr>
<td style="text-align:center"><?php echo ($fecha_ymd_hora) ?></td>
<td style="text-align:center"><?php echo ($motivo) ?></td>
<!-- /////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<table border="1" class="table table-responsive">
    <thead><tr><th style="text-align:center; width:30%" bgcolor="#FAC090">VISTA PREVIA</th><th style="text-align:center; width:50%" bgcolor="#FAC090">IMAGEN TOMADA</th></tr></thead>
    <tbody>
        <tr>
            <td style="text-align:center; width:30%"><div align="center" id="vista_previa_camara"></div>
            <form>
                <input type="button" value="Tomar Foto" onClick="tomar_foto(<?php echo $cod_cliente ?>, <?php echo $cedula ?>)">
            </form>
        </td>
            <td style="text-align:center; width:50%">
                <div align="center" id="vista_imagen_tomada">
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<table border="1" class="table table-responsive">
    <thead><tr><th style="text-align:center; width:50%" bgcolor="#FAC090">IMAGEN FIRMA</th><th style="text-align:center; width:50%" bgcolor="#FAC090">FIRMA TOMADA</th></tr></thead>
    <tbody>
        <tr>
            <td style="text-align:center; width:50%">
                <div id="area_firma">
                    <div id="area_firma_actualizar" style="border: 1px solid #000; height: 150px; width: 400px;">
                        ...
                        <input type="button" value="Tomar Firma" onClick="tomar_firma(<?php echo $cod_cliente ?>, <?php echo $cedula ?>)">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <td style="text-align:center; width:50%"><div align="center" id="vista_firma_tomada">
<input type="hidden" name="url_img_firma" value="<?php echo $url_img_firma_sesion ?>"><img src="<?php echo $url_img_firma_sesion ?>"/>
            </div><br><br><br><br><input type="checkbox" id="foco_firma"></td>
        </tr>
    </tbody>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
function tomar_firma(cod_cliente, cedula) {
    html2canvas([document.getElementById('img_firma')], {
        onrendered: function (canvas) {
            ...
            $.ajax({
                url: '../admin/guardar_img_firma_ajax.php',
                data: { cod_cliente:cod_cliente, cedula:cedula, img_data:img_data },
                type: 'post',
                dataType: 'json',
...
<script>
$("#cod_grupo_area_cargo").change(function() {
    var cod_grupo_area_cargo = $("#cod_grupo_area_cargo").val();
            $.ajax({

                url: '../admin/guardar_variable_sesion_campos_firma_tactil_ajax.php',
                data: { cod_cliente:<?php echo $cod_cliente ?>, cedula:<?php echo $cedula ?>, cod_grupo_area_cargo:cod_grupo_area_cargo },
                type: 'post',
                dataType: 'json',
