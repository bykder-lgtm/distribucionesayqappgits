...
$agreg_reg = "INSERT INTO tbl15_movimiento_contable_temporal_concepto (cod_movimiento_contable, und_vendida,  
nombre_tipo_movimiento, nombre_tipo_documento, fecha_anyo, fecha_mes, fecha_seg, fecha_ymd, anyo, 
ip, cuenta)
VALUES ('$cod_movimiento_contable', '$und_vendida', 
'$nombre_tipo_movimiento', '$nombre_tipo_documento', '$fecha_anyo', '$fecha_mes', '$fecha_seg', '$fecha_ymd', '$anyo', 
'$ip', '$cuenta')";
$resultado_ventas = mysqli_query($conectar, $agreg_reg) or die(mysqli_error($conectar));
}
$agreg_reg = "INSERT INTO tbl15_movimiento_contable (nombre_tipo_documento, nombre_estado_factura, fecha_anyo, fecha_mes, fecha_seg, fecha_ymd, 
anyo, ip, cuenta, fecha_factura)
VALUES ('$nombre_tipo_documento', '$nombre_estado_factura', '$fecha_anyo', '$fecha_mes', '$fecha_seg', '$fecha_ymd', 
'$anyo', '$ip', '$cuenta', '$fecha_factura')";
$resultado_ventas = mysqli_query($conectar, $agreg_reg) or die(mysqli_error($conectar));
?>
