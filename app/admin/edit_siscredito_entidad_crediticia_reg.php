...
if ((isset($_POST["ins_edit"])) && ($_POST["ins_edit"] == "formulario_insert_edit")) {
	...
	if (isset($_POST['total_puntos_redimibles_campanya_tercero']) <> '') { $total_puntos_redimibles_campanya_tercero = mysqli_real_escape_string($conectar, ($_POST['total_puntos_redimibles_campanya_tercero'])); } else { $total_puntos_redimibles_campanya_tercero = ''; }
	...
	if (isset($_POST['lider_interes_ptj']) <> '') { $lider_interes_ptj = mysqli_real_escape_string($conectar, ($_POST['lider_interes_ptj'])); } else { $lider_interes_ptj = ''; }
	if (isset($_POST['coordinador_interes_ptj']) <> '') { $coordinador_interes_ptj = mysqli_real_escape_string($conectar, ($_POST['coordinador_interes_ptj'])); } else { $coordinador_interes_ptj = ''; }
	if (isset($_POST['asesor_interes_ptj']) <> '') { $asesor_interes_ptj = mysqli_real_escape_string($conectar, ($_POST['asesor_interes_ptj'])); } else { $asesor_interes_ptj = ''; }
	if (isset($_POST['vendedor_interes_ptj']) <> '') { $vendedor_interes_ptj = mysqli_real_escape_string($conectar, ($_POST['vendedor_interes_ptj'])); } else { $vendedor_interes_ptj = ''; }
	if (isset($_POST['proveedor_interes_ptj']) <> '') { $proveedor_interes_ptj = mysqli_real_escape_string($conectar, ($_POST['proveedor_interes_ptj'])); } else { $proveedor_interes_ptj = ''; }
	if (isset($_POST['aliado_estrategico_interes_ptj']) <> '') { $aliado_estrategico_interes_ptj = mysqli_real_escape_string($conectar, ($_POST['aliado_estrategico_interes_ptj'])); } else { $aliado_estrategico_interes_ptj = ''; }
	if (isset($_POST['entidad_crediticia_interes_ptj']) <> '') { $entidad_crediticia_interes_ptj = mysqli_real_escape_string($conectar, ($_POST['entidad_crediticia_interes_ptj'])); } else { $entidad_crediticia_interes_ptj = ''; }
	if (isset($_POST['lider_aval_ptj']) <> '') { $lider_aval_ptj = mysqli_real_escape_string($conectar, ($_POST['lider_aval_ptj'])); } else { $lider_aval_ptj = ''; }
	if (isset($_POST['coordinador_aval_ptj']) <> '') { $coordinador_aval_ptj = mysqli_real_escape_string($conectar, ($_POST['coordinador_aval_ptj'])); } else { $coordinador_aval_ptj = ''; }
	if (isset($_POST['asesor_aval_ptj']) <> '') { $asesor_aval_ptj = mysqli_real_escape_string($conectar, ($_POST['asesor_aval_ptj'])); } else { $asesor_aval_ptj = ''; }
	if (isset($_POST['vendedor_aval_ptj']) <> '') { $vendedor_aval_ptj = mysqli_real_escape_string($conectar, ($_POST['vendedor_aval_ptj'])); } else { $vendedor_aval_ptj = ''; }
	if (isset($_POST['proveedor_aval_ptj']) <> '') { $proveedor_aval_ptj = mysqli_real_escape_string($conectar, ($_POST['proveedor_aval_ptj'])); } else { $proveedor_aval_ptj = ''; }
	if (isset($_POST['aliado_estrategico_aval_ptj']) <> '') { $aliado_estrategico_aval_ptj = mysqli_real_escape_string($conectar, ($_POST['aliado_estrategico_aval_ptj'])); } else { $aliado_estrategico_aval_ptj = ''; }
	if (isset($_POST['entidad_crediticia_aval_ptj']) <> '') { $entidad_crediticia_aval_ptj = mysqli_real_escape_string($conectar, ($_POST['entidad_crediticia_aval_ptj'])); } else { $entidad_crediticia_aval_ptj = ''; }
	$interes_ptj                   = $entidad_crediticia_interes_ptj;
	$aval_ptj                      = $entidad_crediticia_aval_ptj;
	...
	if (isset($_POST['fecha_ymd_venta_producto_ini_consulta'])) {
	    ...
	    $pagina_redirect                         = "../admin/lista_siscredito_entidad_crediticia.php".'?'.'cod_administrador='.$cod_administrador_consulta.'&'.'nombre_tipo_tercero='.$nombre_tipo_tercero.'&'.'cod_dependencia='.$cod_dependencia_consulta.'&'.'cod_tipo_pago='.$cod_tipo_pago_consulta.'&'.'nombre_tipo_compra='.$nombre_tipo_compra_consulta.'&'.'cod_tipo_forma_pago='.$cod_tipo_forma_pago_consulta.'&'.'nombre_tipo_factura='.$nombre_tipo_factura_consulta.'&'.'fecha_ymd_venta_producto_ini='.$fecha_ymd_venta_producto_ini_consulta.'&'.'fecha_ymd_venta_producto_fin='.$fecha_ymd_venta_producto_fin_consulta.'&'.'submit=Ver+Registros';
	} else {
	    $pagina_redirect                         = "../admin/lista_siscredito_entidad_crediticia.php".'?'.'nombre_tipo_tercero='.$nombre_tipo_tercero;

	}

	$sql_data = sprintf("UPDATE tbl15_entidad_crediticia SET nombre_tipo_tercero = '$nombre_tipo_tercero', nombre_tipo_identificacion = '$nombre_tipo_identificacion', 
	identificacion_tercero = '$identificacion_tercero', digito_tercero = '$digito_tercero', nombre1_tercero = UPPER('$nombre1_tercero'), 
	...
	dto1_excento_iva_tercero = '$dto1_excento_iva_tercero', dto2_excento_iva_tercero = '$dto2_excento_iva_tercero', total_puntos_redimibles_campanya_tercero = '$total_puntos_redimibles_campanya_tercero',
	lider_interes_ptj = '$lider_interes_ptj', coordinador_interes_ptj = '$coordinador_interes_ptj', asesor_interes_ptj = '$asesor_interes_ptj', vendedor_interes_ptj = '$vendedor_interes_ptj', 
	proveedor_interes_ptj = '$proveedor_interes_ptj', aliado_estrategico_interes_ptj = '$aliado_estrategico_interes_ptj', entidad_crediticia_interes_ptj = '$entidad_crediticia_interes_ptj', 
	lider_aval_ptj = '$lider_aval_ptj', coordinador_aval_ptj = '$coordinador_aval_ptj', asesor_aval_ptj = '$asesor_aval_ptj', vendedor_aval_ptj = '$vendedor_aval_ptj', 
	proveedor_aval_ptj = '$proveedor_aval_ptj', aliado_estrategico_aval_ptj = '$aliado_estrategico_aval_ptj', entidad_crediticia_aval_ptj = '$entidad_crediticia_aval_ptj',
	interes_ptj = '$interes_ptj', aval_ptj = '$aval_ptj' 
	WHERE cod_entidad_crediticia = '$cod_entidad_crediticia'");
