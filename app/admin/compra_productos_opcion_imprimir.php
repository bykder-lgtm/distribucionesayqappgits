...
<table class="table table-striped">
  ...
  <tr>
    <td><font color='black' size= "+3">FACTURA DE COTIZACION NO:</font></td>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>FACTURA DE COTIZACION DE VENTA: <?php echo $prefijo_resolucion_facturacion.' '.$cod_factura; ?></strong></td>
  </tr>
  <tr>
