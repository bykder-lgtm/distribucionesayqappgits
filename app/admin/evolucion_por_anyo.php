...
<?php $sql_consulta = "SELECT fecha_anyo FROM tbl15_evolucion GROUP BY fecha_anyo ORDER BY fecha_ymd DESC";
...
ON tbl15_historia_clinica.cod_historia_clinica = tbl15_evolucion.cod_historia_clinica HAVING (tbl15_evolucion.fecha_anyo = '$fecha_anyo') ORDER BY tbl15_evolucion.fecha_time DESC";
