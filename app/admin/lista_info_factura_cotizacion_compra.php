...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>Lista Cotizaciones de Compra</font></a></th>
        <?php if ($cod_estado_cotizacion_compra_registrar == '1') { ?>
        <th style="text-align:right"><a href="../admin/facturacion_cotizacion_compra_temporal_producto_manual_pos.php"><font size='+2'>Cotizar Compra</font></a></th>
        <?php } ?>
    </tr>
</table>
...
function leer_registros(){
    ...
    function cargar_datos_encontrados(limite_inicial, limite_final) {
        ...
        $.ajax({
            url:"../admin/leer_datos_info_factura_cotizacion_compra_scroll_sweetalert.php",
            method:"POST",
    ...
    if (busqueda == '') { 
        ...
        $('#cargar_datos_ajax').load('../admin/leer_datos_info_factura_cotizacion_compra_scroll_sweetalert.php?cantidad_reg_por_pagina='+cantidad_reg_por_pagina+'&paginador_actual='+paginador_actual+'&buscar_por='+buscar_por+'&busqueda='+busqueda);  
    }
}
</script>