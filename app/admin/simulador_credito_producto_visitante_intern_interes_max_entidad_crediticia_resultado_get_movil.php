    ...
    <!-- Header de Resultados -->
        ...
        <?php
            while ($datos_entidad_crediticia = mysqli_fetch_assoc($consulta_entidad_crediticia)) {
                ...
                $cod_estado_aplicar_cuota_max                                     = $datos_entidad_crediticia['cod_estado_aplicar_cuota_max'];
                ...
                if ($cod_estado_aplicar_cuota_max == '1') {
                    $numero_cuotas = $meses_max_entidad_crediticia;
                }
                //---------------------------------------------------------------------------------------------------------------------------------//
