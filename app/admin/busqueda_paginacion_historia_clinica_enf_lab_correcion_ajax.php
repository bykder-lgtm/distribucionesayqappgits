...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" WHERE (tbl15_historia_clinica.cod_estado_facturacion = '1') AND ((tbl15_historia_clinica.enf_lab = 'SI')) ORDER BY tbl15_historia_clinica.fecha_time DESC";
} else {
    $sWhere.=" AND (tbl15_historia_clinica.cod_estado_facturacion = '1') AND ((tbl15_historia_clinica.enf_lab = 'SI')) ORDER BY tbl15_historia_clinica.fecha_time DESC";
}
...
<th class="column-title">Enfermedad Laboral</th>
...
tbl15_historia_clinica.url_img_foto_min, tbl15_historia_clinica.url_img_foto_orig, tbl15_historia_clinica.enf_lab, 
...
$enf_lab                         = $datos_consulta['enf_lab'];
