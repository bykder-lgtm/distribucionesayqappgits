...
<?php if ($cod_estado_prod_reg_producto == '1') { ?><a class="btn btn-success" href="../admin/reg_solicitud_arriendo.php">Registrar Solicitud de Arriendo</a><?php } ?>
<br>
<!--
...
<script type="text/javascript" src="../admin/busqueda_paginacion_solicitud_arriendo_ajax.js"></script>
