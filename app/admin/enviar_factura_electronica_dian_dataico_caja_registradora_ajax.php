...
<?php if (isset($_GET['cod_info_factura_venta'])) { 
	...
	$datos_url_ajax                         = '../admin/opcion_imprimir_factura_venta_caja_registradora.php'.'?'.'cod_info_factura_venta='.$cod_info_factura_venta.'&'.'pagina='.$pagina;
...
?>
	...
	$(document).ready(function() {
	    ...
	    var pagina_redirect_imprimir = '../admin/opcion_imprimir_factura_venta_caja_registradora.php'+'?'+'cod_info_factura_venta='+cod_info_factura_venta+'&cod_tipo_pago='+cod_tipo_pago+'&conexion_internet='+conexion_internet+'&pagina='+pagina
