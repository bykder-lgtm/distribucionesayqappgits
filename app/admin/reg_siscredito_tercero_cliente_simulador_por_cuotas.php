...
<?php if (isset($_GET['cod_producto_codifcryp'])) { 
    ...
    $numero_cuotas                               = intval($_GET['numero_cuotas']);
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form action="../admin/reg_tercero_visitante_intern_siscredito_por_cuotas_reg.php" method="post" id="contactForm">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">Fecha Reg
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">Total Deuda: $ <?php echo number_format($total_pagar, 0, ",", "."); ?>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
