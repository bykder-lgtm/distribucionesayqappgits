...
$nombre_archivo               = "INFO_IMPUESTO_FACTURAS_TODO.xlsx";                     
	...
	//Rows iterator                
		foreach ($contar_hojas->getRowIterator() as $datos_reg_excel) {
			...
			if ($contador > 1) {
				...
				$query = "INSERT INTO ventas (cod_info_impuesto_facturas, descuento, iva, flete, cod_factura, cod_clientes, vlr_cancelado, 
				vlr_vuelto, vendedor, estado, fecha_dia, fecha_mes, fecha_anyo, anyo, fecha_hora, tipo_pago, fecha_remision, nombre_ccosto, 
				garantia_meses, observacion, bolsa, cod_base_caja, tiempo_ejecucion, envio_dian, envio_dian_fecha_ymdhis, envio_dian_usuario, 
				cod_factura_dian, cod_tipo_forma_pago, nombre_tipo_forma_pago, descripcion_tipo_forma_pago, servicio, nombre_tipo_factura, 
				nombre_tipo_moneda, cod_factura_electronica, ptj_ipc, precio_ipc, precio_ipc_total, cod_dependencia) 
				VALUES ('$cod_info_impuesto_facturas', '$descuento', '$iva', '$flete', '$cod_factura', '$cod_clientes', '$vlr_cancelado', 
				'$vlr_vuelto', '$vendedor', '$estado', '$fecha_dia', '$fecha_mes', '$fecha_anyo', '$anyo', '$fecha_hora', '$tipo_pago', '$fecha_remision', '$nombre_ccosto', 
				'$garantia_meses', '$observacion', '$bolsa', '$cod_base_caja', '$tiempo_ejecucion', '$envio_dian', '$envio_dian_fecha_ymdhis', '$envio_dian_usuario', 
				'$cod_factura_dian', '$cod_tipo_forma_pago', '$nombre_tipo_forma_pago', '$descripcion_tipo_forma_pago', '$servicio', '$nombre_tipo_factura', 
				'$nombre_tipo_moneda', '$cod_factura_electronica', '$ptj_ipc', '$precio_ipc', '$precio_ipc_total', '$cod_dependencia')";
