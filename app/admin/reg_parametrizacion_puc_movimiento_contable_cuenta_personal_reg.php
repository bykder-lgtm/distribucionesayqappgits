...
//---------------------------------------------------------------------FACTURA NUEVA INICIO----------------------------------------------------------------//
	$sql_data = "INSERT INTO tbl15_movimiento_contable_cuenta_personal (cod_puc, codigo_puc, nombre_puc, tipo_puc, nombre_movimiento_contable_cuenta_personal, fecha_ymd_movimiento_caja, fecha_mes_movimiento_caja, 
	fecha_anyo_movimiento_caja, fecha_hora_movimiento_caja, fecha_seg_movimiento_caja, fecha_creacion, cod_estado) 
	VALUES ('$cod_puc', '$codigo_puc', '$nombre_puc', '$tipo_puc', '$nombre_movimiento_contable_cuenta_personal', '$fecha_ymd_movimiento_caja', '$fecha_mes_movimiento_caja', 
	'$fecha_anyo_movimiento_caja', '$fecha_hora_movimiento_caja', '$fecha_seg_movimiento_caja', '$fecha_creacion', '$cod_estado')";
