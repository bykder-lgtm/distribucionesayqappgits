...
// ------------------------------------------------------------------------------------------------- //
$sql_infos_empresas = "SELECT cod_estado_generar_movimiento_contable_automatico_global, cod_estado_movimiento_contable_cuenta_personal_global, codigo_tipo_modulo_cuenta_cobrar_defect_global 
...
if ($tipo == 'eliminar' && $tab == 'tbl15_venta_producto') {
	...
	if ($cod_tipo_pago == '2' && $cod_cuentas_cobrar <> '0') {
		...
		$mensaje                                         = $matriz_cuentas_cobrar['mensaje'].' | '.'alter debolucion por btn inf venta_'.date("Y-m-d H:i:s")."_".$cuenta_actual;

		$sql_info_tercero = "SELECT total_monto_deuda_cuenta_cobrar AS total_monto_deuda_cuenta_cobrar_db, total_abonado_cuenta_cobrar AS total_abonado_cuenta_cobrar_db 
		...
		$total_abonado_cuenta_cobrar_db                     = $matriz_info_tercero['total_abonado_cuenta_cobrar_db'];
		...
		if ($codigo_tipo_modulo_cuenta_cobrar_defect_global == '0') {
			...
			$total_subtotal_cuenta_cobrar                  = $total_monto_deuda_cuenta_cobrar - $total_abonado_cuenta_cobrar_db;
			...
			$data_sql = ("UPDATE tbl15_tercero SET total_monto_deuda_cuenta_cobrar = '$total_monto_deuda_cuenta_cobrar', total_subtotal_cuenta_cobrar = '$total_subtotal_cuenta_cobrar' 
...
if ($tipo == 'eliminar' && $tab == 'tbl15_info_factura_venta') {
	...
	if ($cod_tipo_pago == '2' && $cod_cuentas_cobrar <> '0' && $nombre_estado_factura_dataico_dian == '') {
		...
		$mensaje                                         = $matriz_cuentas_cobrar['mensaje'].' | '.'archivado por debolucion btn sup venta_'.date("Y-m-d H:i:s")."_".$cuenta_actual;
