...
<a href="../admin/lista_parametrizacion_modulos_tipo_forma_pago.php"><h4>Agregar cuentas al modulo</a></h4>
</div>
<hr>
<div class="row-fluid">
...
function hacer_busqueda() {
    ...
    xmlhttp.open("POST","../admin/busqueda_inmediata_puc_movimiento_contable_php.php",true);
...
<table class="table table-striped">
	...
	<tbody>
<?php
$sql_parametrizacion_puc_movimiento_contable = "SELECT * FROM tbl15_parametrizacion_puc_movimiento_contable WHERE (nombre_modulo_puc = '$nombre_modulo_puc' AND cod_tipo_forma_pago = '$cod_tipo_forma_pago') ORDER BY cod_parametrizacion_puc_movimiento_contable DESC";
...
while ($info_parametrizacion_puc_movimiento_contable = mysqli_fetch_assoc($resultado_parametrizacion_puc_movimiento_contable)) {
	...
	$cod_parametrizacion_puc_movimiento_contable      = $info_parametrizacion_puc_movimiento_contable['cod_parametrizacion_puc_movimiento_contable'];
	...
	$tipo_puc                                         = $info_parametrizacion_puc_movimiento_contable['tipo_puc'];
	$cod_estado                                       = $info_parametrizacion_puc_movimiento_contable['cod_estado'];
    $saldo_inicial_puc                                = $info_parametrizacion_puc_movimiento_contable['saldo_inicial_puc'];
    $subtotal_puc                                     = $info_parametrizacion_puc_movimiento_contable['subtotal_puc'];
    $saldo_actual_puc                                 = $info_parametrizacion_puc_movimiento_contable['saldo_actual_puc'];
    $fecha_creacion                                   = $info_parametrizacion_puc_movimiento_contable['fecha_creacion'];
    $cod_estado_puc                                   = $info_parametrizacion_puc_movimiento_contable['cod_estado_puc'];
