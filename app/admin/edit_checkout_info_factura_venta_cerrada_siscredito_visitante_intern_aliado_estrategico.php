...
if (isset($_GET['cod_info_factura_venta'])) {
    ...
    /* ----------------------------------------------------------------------------------------------------------/ */
    $pagina_redirect                                                = $pagina_local.'?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&modo_venta_por_defecto='.$modo_venta_por_defecto.'&pagina='.$pagina;
    /* ----------------------------------------------------------------------------------------------------------/ */
    $tipo_ajax                     = "tbl15_venta_producto";
    $nombre_tipo_transaccion       = "Edición de Transacción - Cerrada";
?>
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
    <?php include_once("../admin/info_factura_venta_pos_edit_checkout_siscredito_visitante_intern_aliado_estrategico.php"); ?>
