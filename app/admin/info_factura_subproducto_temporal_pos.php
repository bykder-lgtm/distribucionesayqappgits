...
<?php
$suma_temporal = "SELECT Sum(total_venta_producto) As total_venta, Sum(total_costo_producto) As total_compra FROM tbl15_subproducto_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_factura_subproducto WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<?php 
$sql_temporal = "SELECT cod_subproducto_temporal FROM tbl15_subproducto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
