...
<input type="text" value="administrador" class="form-control" name="cuenta" placeholder="Usuario" required="" autofocus="" required/>
<input type="password" value="admin951" class="form-control" name="contrasena" id="pass" placeholder="Contraseña" required="">
<br><br>
<button class="btn btn-lg btn-primary btn-block" type="submit" id="enviar" onclick="cifrar()">Entrar</button>
<?php
if (isset($_GET['error'])) { $error = $_GET['error']; echo '<br><font color="red">'.utf8_decode($error).'.</font>'; }
?>
</form>
</div>
</div>
