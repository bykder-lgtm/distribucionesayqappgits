...
?>
    ...
    <main class="container pb-5 mb-5">
        ...
        <div class="simulador-card-movil"><div class="info-text"><i class="fa fa-info-circle"></i>Completa los datos para simular tu crédito y conocer las cuotas mensuales.</div>
            ...
            <form name="formulario_de_actualizacion" method="POST" autocomplete="off" action="../admin/simular_por_precio_contado_aliado_movil_resultado.php">
                <div class="form-group-simulador">
                    ...
                    <label for="precio_venta_producto_formateado"><i class="fa fa-dollar-sign"></i>Valor del producto (Contado) *</label>
...
if (selectTipoSimulacion) {
    selectTipoSimulacion.addEventListener('change', function() {
        try {
            if (this.value === '2') {
                window.location.href = 'simular_por_precio_cerdito_aliado_movil.php';
            }
