...
<div class="breadcrumbs"><a href="#">Guardando ... Asignando permisos</a> <img src="../imagenes/popup_ajax_loader.gif" class="img-polaroid" alt=""></div>
...
$sql_datos_admin = "SELECT cod_seguridad FROM tbl15_administrador WHERE cod_administrador = '$cod_administrador'";
$consulta_datos_admin = mysqli_query($conectar, $sql_datos_admin) or die(mysqli_error($conectar));
$matriz_datos_admin = mysqli_fetch_assoc($consulta_datos_admin);

$cod_seguridad                                                       = $matriz_datos_admin['cod_seguridad'];
