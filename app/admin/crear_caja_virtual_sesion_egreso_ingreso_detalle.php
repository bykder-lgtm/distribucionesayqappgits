...
<a href="../admin/lista_egreso_ingreso_detalle_temporal_virtual.php"><h4>Crear Gastos a Propietario de Inmuebles</a>
</div>
<hr>
<div class="row-fluid">
...
<?php for ($i=1; $i < $cantidad_caja_mesa+1; $i++) { 
		...
		<th style="text-align:center"><a href="../admin/crear_caja_virtual_sesion_egreso_ingreso_detalle_sesion_reg.php?cod_caja_virtual=<?php echo $cod_caja_virtual?>&cod_base_caja=<?php echo $i ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/mesa_caja_disponible.png"><br><?php echo $nombre_concepto_multi_virtual.' '.$i; ?></a></th>
		<?php
		} else { ?>
...
<form method="post" name="formulario_de_actualizacion" action="../admin/crear_caja_virtual_sesion_egreso_ingreso_detalle_sesion_reg.php">
<table class="table table-striped">
<tr>
...
<input type="hidden" name="pagina" value="facturacion_venta_temporal_egreso_ingreso_detalle.php">
</tr>
</table>
</form>
</div>
