...
<th style="text-align:center">CODIGO 2</th>
<?php } ?>
...
<th style="text-align:center;">IMPO CONSUMO</th>
<?php } ?>
...
while ($datos_compra_producto_temporal = mysqli_fetch_assoc($consulta_compra_producto_temporal)) {
    ...
    $cod_producto_barra2                           = $datos_compra_producto_temporal['cod_producto_barra2'];
...
<?php if ($cod_estado_cod_barra2_global == '1') { ?>
<td style="text-align:center;"><input name="cod_producto_barra2" type="text" id="cod_producto_barra2<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $cod_producto_barra2;?>" style="width: 70px;" /></td>
<?php } ?>
...
<td style="text-align:center;">
    <input name="precio_compra_producto" type="text" id="precio_compra_producto<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $precio_compra_producto;?>" style="width: 70px;" />
    <?php if ($cod_estado_promediar_precio_compra_y_venta_cargar_factura_global == '1') { ?><br><div id="precio_compra_producto_promedio<?php echo $incre;?>"><?php echo number_format($precio_compra_producto_promedio, 0, ",", ".") ?></div><?php } ?>
</td>
...
<?php if ($cod_estado_impoconsumo_global == '1') { ?>
<td style="text-align:center;"><input name="precio_ipc" type="text" id="precio_ipc<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $precio_ipc;?>" style="width: 60px;" /></td>
<?php } ?>
