...
$sql = "SELECT cod_parametrizacion_entidad_crediticia_cuota, cuota, interes_ptj, ptj_seguro, ptj_fondo_garantia, tipo_ptj_seguro, tipo_fondo_garantia, fecha_creacion, fecha_modificacion 
