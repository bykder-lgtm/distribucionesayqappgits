    ...
    <section class="search_bar_app_movil_enrollment">
        <div class="container py-3">
            <!-- Botones de navegación -->
             <?php include_once("../admin/menu_facturas_abiertas_cerradas_comprobante_pago_vendedor.php"); ?>
