...
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, cod_estado_facturacion, nombre_empresa, motivo 
FROM tbl15_historia_clinica WHERE (cod_factura = '$cod_factura') GROUP BY motivo";
