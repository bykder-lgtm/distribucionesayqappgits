...
if (isset($_POST['cod_historia_clinica'])) {
	...
	$url = 'http://editaxe.xyz/consultorio/admin/ver_medicamentos_ayudas_diagnosticas_pdf_para_envio_correo.php?cedula_idget='.$cedula_idget;
	//-----------------------------------------------------------------------------------------------------------------------------//
	//-----------------------------------------------------------------------------------------------------------------------------//
	...
	$cod_tipo_modulo_envio_correo         = "11";
	$nombre_tipo_modulo_envio_correo      = "MEDICAMENTOS Y AYUDAS DIAGNOSTICAS PDF - CLINICO";
	...
	$nombre_origen_correo                 = "Recordatorio medicamentos y ayudas diagnosticas";
