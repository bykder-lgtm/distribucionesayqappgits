<?php 
$nombre_pagina          = "CatÃ¡logo de Productos";
$cod_seguridad_pag      = "1";
...
<style>
    ...
    .producto-imagen-container-catalogo {
        position: relative;
        width: 100%;
        padding-top: 85%; /* Aspecto mÃ¡s compacto */
        overflow: hidden;
        background: #f8f9fa;
    }
    ...
    /* Estilo para texto sujeto a lÃ­nea de crÃ©dito */
    ...
    .prev_entidades_crediticias_container_part2 {
        ...
        gap: 0.25rem;            /* SeparaciÃ³n reducida entre logos */
        flex-wrap: wrap;         /* Permitir salto en pantallas muy pequeÃ±as */
        margin: 0.15rem 0;       /* Espacio vertical reducido */
        padding: 0.05rem;        /* Padding interno mÃ¡s pequeÃ±o */
    }
    ...
    /* Estilos especÃ­ficos para imÃ¡genes mÃ¡s pequeÃ±as en part3 */
    .prev_entidades_crediticias_container_part3 .prev_entidades_crediticias img {
        max-height: 18px;        /* ImÃ¡genes mÃ¡s pequeÃ±as que el estÃ¡ndar de 24px */
    }
    .prev_entidades_crediticias {
        ...
        background: rgba(245, 158, 11, 0.05); /* Fondo sutil */
    ...
    .prev_entidades_crediticias img {
        display: block;
        max-height: 24px;        /* Altura estÃ¡ndar */
        width: auto;
        object-fit: contain;
        transition: all 0.2s ease;
    }

    /* Responsive para mÃ³viles medianos (576px y menos) */
    @media (max-width: 576px) {
        .prev_entidades_crediticias_container_part2 {
            gap: 0.15rem;        /* SeparaciÃ³n mÃ¡s reducida */
        ...
        .prev_entidades_crediticias {
            padding: 0.08rem 0.15rem; /* Padding mÃ¡s compacto */
        }
        .prev_entidades_crediticias img {
            max-height: 20px;    /* Logos mÃ¡s pequeÃ±os */
        }
        /* ImÃ¡genes mÃ¡s pequeÃ±as especÃ­ficas para part3 en mÃ³viles medianos */
        .prev_entidades_crediticias_container_part3 .prev_entidades_crediticias img {
            max-height: 16px;
        }
    }

    /* Responsive para mÃ³viles pequeÃ±os (400px y menos) */
    @media (max-width: 400px) {
        .prev_entidades_crediticias_container_part2 {
            gap: 0.1rem;         /* SeparaciÃ³n muy mÃ­nima */
            margin: 0.08rem 0;   /* Margen ultra mÃ­nimo */
            padding: 0.03rem;    /* Padding ultra mÃ­nimo */
        }
        .prev_entidades_crediticias_container_part3 {
            gap: 0.1rem;         /* SeparaciÃ³n muy mÃ­nima */
            margin: 0.08rem 0;   /* Margen ultra mÃ­nimo */
        ...
        .prev_entidades_crediticias {
            padding: 0.05rem 0.1rem; /* MÃ¡ximo compacto */
            border-radius: 3px;     /* Bordes mÃ¡s pequeÃ±os */
        }
        .prev_entidades_crediticias img {
            max-height: 18px;    /* Logos muy pequeÃ±os para pantallas diminutas */
        }
        /* ImÃ¡genes mÃ¡s pequeÃ±as especÃ­ficas para part3 en mÃ³viles pequeÃ±os */
        .prev_entidades_crediticias_container_part3 .prev_entidades_crediticias img {
            max-height: 14px;
        }
    }

    /* Responsive para pantallas muy pequeÃ±as (320px y menos) */
    @media (max-width: 320px) {
        .prev_entidades_crediticias_container_part2 {
            gap: 0.05rem;        /* SeparaciÃ³n ultra mÃ­nima */
            flex-direction: row; /* Forzar fila aunque sean muchos logos */
            overflow-x: auto;    /* Scroll horizontal si no caben */
            padding: 0.02rem 0;  /* Padding mÃ­nimo vertical */
        ...
        .prev_entidades_crediticias {
            ...
            min-width: 30px;         /* Ancho mÃ­nimo para evitar colapso */
        }
        .prev_entidades_crediticias img {
            max-height: 16px;    /* Logos extra pequeÃ±os */
            min-width: 20px;     /* Ancho mÃ­nimo para legibilidad */
        }
        /* ImÃ¡genes mÃ¡s pequeÃ±as especÃ­ficas para part3 en pantallas muy pequeÃ±as */
        .prev_entidades_crediticias_container_part3 .prev_entidades_crediticias img {
            max-height: 12px;
            min-width: 16px;
        }
...
<?php
// Variables de encriptaciÃ³n y configuraciÃ³n
$tab                               = "producto";
...
// Obtener el interÃ©s predeterminado
...
// Determinar la tienda del vendedor: viene de tbl15_administrador.cod_tienda
$cod_tienda_sesion = 0;
...
if (!empty($cod_tienda_filtro)) {
    ...
    // Para vendedor: obtener cod_tienda directamente de su perfil
    $sql_tienda_vendedor = "SELECT cod_tienda FROM tbl15_administrador WHERE cod_administrador = '$cod_administrador'";
...
$nombre_tienda_mostrar = "CatÃ¡logo de Productos";
...
<!--
    <div class="header-catalogo">
        <h1><i class="fa fa-shopping-bag"></i> CatÃ¡logo de Productos</h1>
        <p>Encuentra los mejores productos con crÃ©dito</p>
    </div>
-->
    <div class="header-catalogo-tienda">
        <div class="container text-center">
            ...
            <?php if ($cod_tienda_sesion > 0 && $nombre_tienda_mostrar != "CatÃ¡logo de Productos"): ?>
                <p class="mb-0" style="font-size: 0.8rem; opacity: 0.9;">CatÃ¡logo de Productos</p>
            <?php endif; ?>
        </div>
    </div>
    <style>
    ...
    <main class="container py-2 mb-5">
            ...
            <div class="container">
                <div class="search-container-custom">
                    <form action="" method="GET" class="search-form-custom">
                        ...
                        <input type="search" class="search-input-custom" name="buscador" id="buscador" value="<?php echo $buscador_get ?>" placeholder="Busca por nombre, cÃ³digo o descripciÃ³n..." autocomplete="on">
                        <button type="button" class="search-clear-btn" id="clearSearch" title="Limpiar bÃºsqueda"><i class="fa fa-times"></i></button>
        ...
        <!-- Filtro de CategorÃ­as Compacto (Pills Horizontales) -->
...
// Filtro por tienda del vendedor (siempre filtra por su tienda asignada)
if ($cod_tienda_sesion > 0) {
    $sql_producto .= " AND (cod_tienda = '$cod_tienda_sesion')";
}
...
?>
            <div class="producto-card-movil-catalogo">
                ...
                <div class="producto-info-catalogo">
                    ...
                    <a href="../admin/resultado_simulador_credito_vendedor_movil.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>&cod_categoria=<?php echo $cod_categoria ?>&nombre_tipo_origen_simulacion=<?php echo $nombre_tipo_origen_simulacion ?>" id="btn-cotizar-producto-catalogo" class="btn-cotizar-producto-catalogo"><i class="fa fa-calculator"></i> Cotizar a CrÃ©dito</a>
                </div>
            </div>
<?php 
    }
...
?>
    <div class="col-12">
        <div class="empty-state">
            <i class="fa fa-box-open"></i><h3>No se encontraron productos</h3><p>Intenta con otra bÃºsqueda o categorÃ­a</p>
        </div>
    </div>
<?php
}
...
$(document).ready(function() {
    ...
    function toggleClearButton() { if(searchInput.val().trim() !== '') { clearBtn.addClass('show'); } else { clearBtn.removeClass('show'); } }
    
    // Verificar al cargar la pÃ¡gina
    toggleClearButton();
    
    // Verificar mientras se escribe
    searchInput.on('input', function() { toggleClearButton(); });
    ...
    clearBtn.on('click', function() {
        ...
        // Si hay parÃ¡metros en la URL, recargar sin el buscador
    ...
    searchInput.on('keypress', function(e) { if(e.which === 13) { searchForm.submit(); } });
    // Efecto de foco en el input
    searchInput.on('focus', function() { $(this).attr('placeholder', 'Escribe aquÃ­...'); }).on('blur', function() { $(this).attr('placeholder', 'Busca por nombre, cÃ³digo o descripciÃ³n...'); });
    // AnimaciÃ³n al enviar formulario
    searchForm.on('submit', function() { if(searchInput.val().trim() !== '') { $('.search-btn-custom').html('<i class="fa fa-spinner fa-spin"></i> Buscando...'); } });
});
</script>
<?php
// Obtener el prÃ³ximo cÃ³digo de producto si hay tienda
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="text-muted">Se guardarÃ¡ versiÃ³n original y miniatura.</small>
...
<script>
// FunciÃ³n para formatear nÃºmero con separador de miles
function formatearMiles(valor) {
    valor = valor.replace(/\D/g, '');
    return valor.replace(/\B(?=(\d{3})+(?!\d))/g, '.');
}

// FunciÃ³n para limpiar formato de miles
...
document.addEventListener('DOMContentLoaded', function() {
    // Inicializar Quill editor para descripciÃ³n de producto
    ...
    if (precioCompraInput) {
        ...
        precioCompraInput.addEventListener('paste', function(e) {
            setTimeout(() => { this.value = formatearMiles(this.value); }, 10);
        });
    }
    ...
    if (btnGuardar) {
        btnGuardar.addEventListener('click', function() {
            ...
            if (!valido) {
                ...
                Swal.fire({ icon: 'error', title: 'Campos requeridos', text: 'Por favor complete todos los campos marcados con *', confirmButtonColor: '#f59e0b' });
                return;
            }
            ...
            // Enviar datos
            fetch('reg_producto_tienda_vendedor_ajax.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        icon: 'success', title: 'Producto registrado', text: data.message, confirmButtonColor: '#f59e0b'
                    }).then(() => {
                    ...
                    if (precioCompra && precioCompra.value) { precioCompra.value = formatearMiles(precioCompra.value); }
                    if (precioVenta && precioVenta.value) { precioVenta.value = formatearMiles(precioVenta.value); }
                    Swal.fire({ icon: 'error', title: 'Error', text: data.message, confirmButtonColor: '#f59e0b' });
                }
            })
            .catch(error => {
                if (precioCompra && precioCompra.value) { precioCompra.value = formatearMiles(precioCompra.value); }
                if (precioVenta && precioVenta.value) { precioVenta.value = formatearMiles(precioVenta.value); }
                Swal.fire({ icon: 'error', title: 'Error de conexiÃ³n', text: 'No se pudo procesar la solicitud', confirmButtonColor: '#f59e0b' });
            })
            .finally(() => {
