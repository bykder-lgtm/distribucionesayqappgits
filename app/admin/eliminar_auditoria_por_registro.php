...
if ($tipo == 'eliminar' && $tab == 'tbl15_factura_auditoria_producto') {
$cod_factura_auditoria_producto         = intval($_GET['llave']);

$sql_factura_auditoria_producto = "SELECT * FROM tbl15_factura_auditoria_producto WHERE (cod_factura_auditoria_producto = '$cod_factura_auditoria_producto')";
...
$cod_info_factura_auditoria             = $datos_factura_auditoria_producto['cod_info_factura_auditoria'];
...
$borrar_sql = sprintf("DELETE FROM tbl15_factura_auditoria_producto WHERE cod_factura_auditoria_producto = '$cod_factura_auditoria_producto'");
