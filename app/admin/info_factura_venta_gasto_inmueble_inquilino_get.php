...
FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_factura = '$cod_factura') AND (cod_tipo_estado_incluido = '0')";
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (nombre_estado_factura = 'ABIERTA') AND (cod_factura = '$cod_factura') AND (cod_tipo_estado_incluido = '0')";
...
-->
       ...
       <th style="text-align:center; font-size:40px;"><div id="total_gasto_ganancia"><?php echo number_format($total_gasto_ganancia, 0, ",", ".") ?></div></th>
        ...
        <?php 
        $sql_temporal = "SELECT cod_gasto_inmueble_inquilino_venta_temporal FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cod_factura = '$cod_factura') AND (cod_tipo_estado_incluido = '0')";
