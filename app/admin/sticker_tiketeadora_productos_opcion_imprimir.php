...
<table class="table table-striped">
  <tr>
    ...
    <td style="text-align:center;"><a href="../admin/descargar_sticker_producto_xls.php?cod_info_factura_sticker=<?php echo $cod_info_factura_sticker?>"><img src=../imagenes/xls.png alt="imprimir_peq"></a></td>
  </tr>
</table>
</center>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
?>
<tr>
<td style="text-align: center; width:99%; font-family: Courier; font-size:10pt;">.</td>
</tr>
<tr>
<td style="text-align: center; width:99%; font-family: Courier; font-size:10pt;"><strong><?php echo $nombre_producto ?></strong></td>
</tr>
<tr>
<td style="text-align: center; width:99%; font-family: Courier; font-size:10pt;"><div id="codigo_codabar_php<?php echo $incremento ?>"></div></td>
</tr>
<!--
<tr>
<td style="text-align: center; width:99%; font-family: Courier; font-size:10pt;"><?php echo $cod_producto_barra ?></td>
</tr>
-->
<tr>
<td style="text-align: center; width:99%; font-family: Courier; font-size:10pt;"><strong><?php echo $cod_producto_barra ?> <?php echo $precio_compra_producto ?> <?php echo $precio_venta_producto ?> <?php echo $cod_tercero ?></strong></td>
</tr>
<script>
$("#codigo_codabar_php"+<?php echo $incremento ?>).html('<img src="class_php\\barcode.php?text='+<?php echo $cod_producto_barra ?>+'&size=40&codetype=Code128&print=false"/>');
</script>
<?php } ?>
