...
.menu-item-modern.active .menu-label {
  ...
  <nav class="btn_menu_navegacion_movil_enrollment d-flex justify-content-around">
    ...
    <a href="../admin/simulador_credito_visitante_intern_interes_max_entidad_crediticia_libre_aliado_movil.php" id="simulador_credito" class="menu-item-modern <?php echo esMenuActivo('simulador_credito'); ?>">
...
-->
    <a href="../admin/lista_catalogo_productos_aliado_movil_visitante_intern.php" id="lista_catalogo" class="menu-item-modern <?php echo esMenuActivo(['lista_catalogo', 'catalogo_producto']); ?>">
