...
<!-- 1******************************************************* MODULO MENU DE NAVEGACION *********************************************** -->
<?php $pagina_red           = addslashes($_GET['pagina_red']); ?>
...
$pagina                     = $pagina_red.'?cod_cliente='.$cod_cliente;
...
<br>
<form name="frmSubir" method="post" enctype="multipart/form-data" action="edit_cargar_firma_cliente_reg.php">
