...
<head>
<meta charset="utf-8">
<title>DIAGNOSTICO_DE_CONDICIONES_DE_SALUD_<?php echo $nombre_empresa_limpia.'__'.$motivo_limpia.'__'.$fecha_ini_ymd.'__'.$fecha_fin_ymd;?></title>
...
<!--<button class="ExportToWord"> Exportar a Word(.doc)</button>-->

<div id="contenido_exportar_word">
<body id="pageBody">
...
<script type="text/javascript">
    $(function() {   
        $(".ExportToWord").click(function(event) {
            $("#contenido_exportar_word").wordExport();
        });
    });
    </script>
</html>