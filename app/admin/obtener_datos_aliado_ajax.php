...
$sql = "SELECT cod_administrador, identificacion_tercero, telefono1_tercero, correo_tercero, direccion_tercero, barrio_tercero, cod_departamento, cod_municipio, cod_tipo_sector FROM tbl15_administrador WHERE cod_administrador = '$cod_aliado'";
