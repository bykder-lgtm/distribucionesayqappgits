...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($cod_administrador_edit) || empty($cedula) || empty($nombres) || empty($apellidos) || empty($correo) || empty($telefono) || empty($cod_coordinador)) { echo json_encode(['status' => 'error', 'message' => 'Por favor complete todos los campos obligatorios.']); exit; }
    ...
    telefono1_tercero = '$telefono', cod_coordinador = '$cod_coordinador' WHERE cod_administrador = '$cod_administrador_edit' AND cod_seguridad = '22'";
