...
<style>
/* ============================================ */
/* SIMULADOR DE CRÉDITO - DISEÑO PREMIUM       */
/* ============================================ */
...
.simulator-hero::before {
    ...
    right: 0;
    height: 3px;
    background: linear-gradient(90deg, #667eea, #764ba2, #48dbfb, #667eea);
...
.form-group-sim:focus-within .input-icon-sim { color: #667eea; }
...
.info-box-sim i { color: #667eea; font-size: 1rem; margin-top: 0.1rem; }
...
.btn-submit-sim:hover { transform: translateY(-2px); box-shadow: 0 12px 35px rgba(102, 126, 234, 0.5); }
...
-->
        ...
        <form name="formulario_de_actualizacion" method="POST" autocomplete="off" action="../admin/simulador_credito_producto_visitante_intern_interes_max_entidad_crediticia_resultado_get_movil.php">
            <div class="form-group-sim">
                ...
                <select id="cod_tipo_simulacion_credito" name="cod_tipo_simulacion_credito" class="form-control-sim" onchange="calcularValorCredito()">
            ...
            <div class="form-group-sim">
                <label><i class="fa fa-dollar-sign"></i> Valor del Producto (Contado) *</label>
