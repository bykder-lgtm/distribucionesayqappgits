...
tbl15_cliente.edad_anyo, tbl15_cliente.edad_mes, tbl15_cliente.nombre_contacto1 AS nombre_contacto, 
tbl15_cliente.identificacion_contacto1 AS identificacion_contacto, tbl15_cliente.estrato_contacto1 AS estrato_contacto, tbl15_cliente.municipio_contacto1 AS municipio_contacto, 
tbl15_cliente.ocupacion_contacto1 AS ocupacion_contacto, tbl15_cliente.tel_contacto1 AS tel_contacto, tbl15_cliente.parentesco_contacto1, tbl15_cliente.direccion_contacto1 AS direccion_contacto, 
...
tbl15_historia_clinica.nombre_contacto1, tbl15_historia_clinica.identificacion_contacto1, tbl15_historia_clinica.estrato_contacto1, tbl15_historia_clinica.municipio_contacto1, 
tbl15_historia_clinica.ocupacion_contacto1, tbl15_historia_clinica.tel_contacto1, tbl15_historia_clinica.correo_contacto1, tbl15_historia_clinica.direccion_contacto1, 
...
$nombre_documento                    = "HISTORIA CLÍNICA-".$nombres_cli.' '.$apellido1_cli.'-'.$nombre_empresa.'-'.$cedula.'-'.$cod_historia_clinica;
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
