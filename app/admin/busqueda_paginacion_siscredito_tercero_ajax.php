...
//---------------------------------------------------------------------------------------------------------------------------------//
$pagina                                                      = $concatenador."lista_siscredito_tercero.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
include_once('../ajax/pagination.php'); //include pagination file
    ...
    $reload                      = '../admin/lista_siscredito_tercero.php';
...
<thead>
	<tr class="headings">
		...
		<th style="text-align:center">Crear Usuario</th>
	</tr>
</thead>
<tbody>
<?php
...
<tr class="even pointer">
	...
	<?php if ($cod_estado_tercero_editar == '1') { ?><td style="text-align:center"><a href="../admin/edit_siscredito_tercero.php?cod_tercero=<?php echo $cod_tercero?>&nombre_tipo_tercero=<?php echo $nombre_tipo_tercero ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td><?php } ?>
	<?php if ($cod_estado_existe_usuario == '1') { ?><td style="text-align:center"><img src="../imagenes/correcto_visitante.png" class="img-polaroid" alt="" id="foco<?php echo $cod_tercero?>"></td><?php } else { ?><td style="text-align:center"><a href="../admin/reg_siscredito_tercero_crear_usuario_reg.php?cod_tercero=<?php echo $cod_tercero?>&nombre_tipo_tercero=<?php echo $nombre_tipo_tercero ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/btn_dian_disabled_peq.png" class="img-polaroid" alt="" id="foco<?php echo $cod_tercero?>"></a></td><?php } ?>
</tr>
<?php } ?>
</table>
