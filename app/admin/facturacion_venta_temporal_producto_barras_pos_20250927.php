...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_caja_virtual.php?pagina=<?php echo $pagina ?>">CAJAS VIRTUALES VENTA</a></strong></td>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody>
    	<tr>
            ...
            <td bgcolor="#fff" align="center"><a href="../admin/facturacion_venta_temporal_producto_manual_pos.php<?php echo $url_visit_user_extern ?>"><strong>Venta Manual</strong></a></td>
            <?php } ?>
            ...
            <td bgcolor="#fff" align="center"><strong>Buscar por:</strong>
                ...
                [<?php echo $cod_base_caja ?>]<input name="cod_producto_barra" id="busqueda" style="height:26" placeholder="C&oacute;digo del producto" required autofocus/><input type="submit" style="font-size:15px" name="buscador" tabindex=3 value="Cargar Producto" />
            </td>
    	</tr>
