...
$nombre_tipo_identificacion                                         = isset($_POST['nombre_tipo_identificacion']) ? addslashes($_POST['nombre_tipo_identificacion']) : "CC";
$cod_seguridad                                                      = "23";
...
if (isset($_POST['identificacion_tercero'])) {
    ...
    if($existe_dato_aliado > 0) {
        ...
        cod_tipo_sector, nit_razon_social, nombre_razon_social, cod_departamento, cod_municipio) 
        ...
        '$cod_aliado_estrategico', '$url_pag_redirec_ini_sesion', '$cod_caja_virtual', '$cod_caja', '$nombre_maquina', '$cod_lider', '$cod_coordinador', '$cod_asesor', 
        '$cod_tipo_sector', '$nit_razon_social', UPPER('$nombre_razon_social'), '$cod_departamento', '$cod_municipio')";
