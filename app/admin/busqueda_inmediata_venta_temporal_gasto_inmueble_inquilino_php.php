...
$mostrar_datos_sql = "SELECT cod_gasto_inmueble, nombre_gasto_inmueble FROM tbl15_gasto_inmueble WHERE ((nombre_gasto_inmueble LIKE '%$buscar%')) AND (cod_estado = '1') ORDER BY nombre_gasto_inmueble ASC";
...
<td style="text-align:left;"><a href="../admin/reg_venta_temporal_gasto_inmueble_inquilino_reg.php?cod_gasto_inmueble=<?php echo $cod_gasto_inmueble?>&cod_factura=<?php echo $cod_factura?>&buscar_por=<?php echo $buscar_por?>&nombre_tipo_moneda=<?php echo $nombre_tipo_moneda?>&nombre_tipo_factura=<?php echo $nombre_tipo_factura?>&foco=<?php echo $foco?>&cod_estado_vacuna=<?php echo $cod_estado_vacuna?>&cuenta=<?php echo $cuenta?>&cod_caja_virtual=<?php echo $cod_caja_virtual?>&pagina=<?php echo $pagina?>"><?php echo $nombre_gasto_inmueble ?></a></td>
</tr>
<?php } ?>
</table>
</div>
