...
<a class="btn btn-primary" href="../admin/lista_egreso_movimiento_caja.php"><h6>Lista conceptos de egreso</h6></a>
</div>
<div class="row-fluid">
...
<td style="text-align:center"><a href="../admin/edit_concepto_egreso_movimiento_caja.php?cod_gastos_tabla=<?php echo $cod_gastos_tabla ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
</tr>
<?php } ?>
</tbody>
</table>
