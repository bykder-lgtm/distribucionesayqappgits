...
FROM tbl15_producto WHERE (und_producto > '0')";
...
<th style="text-align:center">Total Inv Precio Compra Mostrador + Bodega</th>
<th style="text-align:center">Total Inv Precio Venta Mostrador + Bodega</th>
...
<th style="text-align:center"><?php echo number_format($total_compra_producto_mostrador_bodega, 0, ",", ".") ?></th>
<th style="text-align:center"><?php echo number_format($total_venta_producto_mostrador_bodega, 0, ",", ".") ?></th>
<?php } ?>
</tr>
</table>
</div>
...
<td style="text-align:center"><a href="../admin/descargar_inventario_xls.php?cod_administrador=<?php echo $cod_administrador?>"><img src=../imagenes/xls.png alt="imprimir_peq"></a></td>
<td style="text-align:center"><a href="../admin/descargar_inventario_xlsx.php?cod_administrador=<?php echo $cod_administrador?>"><img src=../imagenes/btn_xlsx.png alt="imprimir_peq"></a></td>
<td style="text-align:center"><a href="../admin/imprimir_inventario_pdf.php?cod_administrador=<?php echo $cod_administrador?>" target="_blank"><img src=../imagenes/pdf.png alt="pdf"></a></td>
</tr>
</table>
<?php } ?>
...
<tbody>
<?php
$sql_info_factura = "SELECT * FROM tbl15_producto ORDER BY nombre_producto ASC";
