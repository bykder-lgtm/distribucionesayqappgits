...
cd curl
cd x86
curl %ruta_http_produccion%/enviar_correo_personal_recordatorio_cumpleanos_tercero_outlook_reg.php?fecha_ymd_venta_producto_ini=%fecha_ymd_venta_producto_ini%
::curl %ruta_http_prueba%/enviar_correo_personal_recordatorio_cumpleanos_tercero_outlook_reg.php?fecha_ymd_venta_producto_ini=%fecha_ymd_venta_producto_ini%
pause