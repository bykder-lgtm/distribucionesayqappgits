...
<a class="btn btn-primary" href="#"><h6>Reporte Compras Por Rango de Fechas Agrupado Producto</h6></a>
</div>
  <script>
...
if ($cod_administrador==0) {
  ...
  SUM(tbl15_factura_compra_producto.und_compra) AS und_compra, tbl15_factura_compra_producto.precio_compra_producto, SUM(tbl15_factura_compra_producto.total_compra_producto) AS total_compra_producto, 
  tbl15_factura_compra_producto.precio_costo_producto, tbl15_factura_compra_producto.total_costo_producto, SUM(tbl15_factura_compra_producto.precio_venta_producto) AS precio_venta_producto, 
  ...
  WHERE (tbl15_factura_compra_producto.fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') 
  GROUP BY tbl15_factura_compra_producto.cod_producto_barra DESC";
} else {
  $sql_cliente = "SELECT tbl15_factura_compra_producto.cod_factura_compra_producto, tbl15_factura_compra_producto.cod_producto, tbl15_factura_compra_producto.cod_producto_barra, 
  tbl15_factura_compra_producto.cod_info_factura_compra, tbl15_factura_compra_producto.cod_factura, tbl15_factura_compra_producto.cod_historia_clinica, tbl15_factura_compra_producto.nombre_producto, 
  SUM(tbl15_factura_compra_producto.und_compra AS und_compra, tbl15_factura_compra_producto.precio_compra_producto, SUM(tbl15_factura_compra_producto.total_compra_producto) AS total_compra_producto, 
