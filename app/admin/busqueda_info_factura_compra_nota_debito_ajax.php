...
while ($datos_total_tipo_factura = mysqli_fetch_assoc($consulta)) {
	...
	<tr class="even pointer">
        <td style="text-align:center"><a href="../admin/reg_factura_compra_nota_debito.php?cod_info_factura_compra=<?php echo $cod_info_factura_compra ?>"><?php echo $nombre_tipo_factura?></a></td>
        <td style="text-align:center"><a href="../admin/reg_factura_compra_nota_debito.php?cod_info_factura_compra=<?php echo $cod_info_factura_compra ?>"><?php echo ($prefijo_resolucion_facturacion.'|'.$cod_factura)?></a></td>
        <td style="text-align:left"><a href="../admin/reg_factura_compra_nota_debito.php?cod_info_factura_compra=<?php echo $cod_info_factura_compra ?>"><?php echo $nombre_tercero?></a></td>
