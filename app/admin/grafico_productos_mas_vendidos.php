...
$(function () {
    $('#container_grafico_estadistico').highcharts({
        ...
        xAxis: {
            categories: [
<?php
$sql = "SELECT SUM(unidades_vendidas) AS unidades_vendidas, cod_productos, nombre_productos FROM tbl15_venta_producto GROUP BY cod_productos ORDER BY unidades_vendidas DESC LIMIT 0,100";
