...
$pagina                       = addslashes($_GET['pagina'])."?&foco=".$foco."&pagina=facturacion_cotizacion_compra_temporal_producto_manual_pos.php";
...
$datos_info = "SELECT * FROM tbl15_info_cotizacion_factura_compra WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$sql_autoincremento_info_factura = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '$base_datos' AND TABLE_NAME = 'tbl15_info_cotizacion_factura_compra'";
...
$cod_info_cotizacion_factura_compra             = $datos_autoincremento_info_factura['AUTO_INCREMENT'];
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_info_cotizacion_factura_compra (cod_info_cotizacion_factura_compra, nombre_estado_factura, fecha_ymdhis, cuenta, cod_estado_factura, cod_caja_virtual, fecha_dia, fecha_mes, 
fecha_anyo, anyo, fecha_hora, cod_tipo_pago, cod_administrador, cod_dependencia, cod_tipo_forma_pago, 
nombre_tipo_factura, nombre_tipo_moneda, cod_tercero, nombre_tipo_cargue_factura) 
VALUES ('$cod_info_cotizacion_factura_compra', '$nombre_estado_factura', '$fecha_ymdhis', '$cuenta', '$cod_estado_factura', '$cod_caja_virtual', '$fecha_dia', '$fecha_mes', 
'$fecha_anyo', '$anyo', '$fecha_hora', '$cod_tipo_pago', '$cod_administrador', '$cod_dependencia', '$cod_tipo_forma_pago', 
'$nombre_tipo_factura', '$nombre_tipo_moneda', '$cod_tercero', '$nombre_tipo_cargue_factura')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

$sql_data = "INSERT INTO tbl15_cotizacion_compra_producto_temporal (cod_info_cotizacion_factura_compra, cod_tercero, cod_producto, cod_producto_barra, nombre_producto, und_compra, 
...
VALUES ('$cod_info_cotizacion_factura_compra', '$cod_tercero', '$cod_producto', '$cod_producto_barra', '$nombre_producto', '$und_compra', 
'$precio_compra_producto', '$total_compra_producto',  '$precio_costo_producto', '$total_costo_producto', 
'$precio_venta_producto', '$precio_venta_producto2', '$precio_venta_producto3', '$precio_venta_producto4', '$precio_venta_producto5', 
'$nombre_tipo_producto', '$nombre_tipo_unidad_medida', '$iva_ptj', '$precio_compra_producto_viejo', '$precio_costo_producto_viejo', 
'$fecha_ymd_venta_producto', '$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', '$fecha_seg_venta_producto', '$cuenta', 
...
$sql_info_factura = "SELECT cod_info_cotizacion_factura_compra, cod_tercero FROM tbl15_info_cotizacion_factura_compra WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_info_cotizacion_factura_compra             = $datos_info_factura['cod_info_cotizacion_factura_compra'];
