...
$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora SET cod_historia_clinica = '$cod_historia_clinica' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
...
$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora SET fecha_ymd_venta_producto = '$fecha_ymd_venta_producto', fecha_mes_venta_producto = '$fecha_mes_venta_producto', 
...
$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora SET cod_administrador = '$cod_administrador' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_moneda') && ($tipo_ajax=='tbl15_info_factura_venta')) {
...
FROM tbl15_plan_accion_correctiva_preventiva_mejora WHERE cod_plan_accion_correctiva_preventiva_mejora = '$cod_plan_accion_correctiva_preventiva_mejora'";
$resultado_datos = mysqli_query($conectar, $sql_datos);
$info_datos = mysqli_fetch_assoc($resultado_datos);
...
$data_sql = ("UPDATE tbl15_plan_accion_correctiva_preventiva_mejora SET und_venta = '$und_venta', total_costo_producto = '$total_costo_producto', total_compra_producto = '$total_compra_producto' , total_venta_producto = '$total_venta_producto'
...
FROM tbl15_plan_accion_correctiva_preventiva_mejora WHERE cod_info_factura_venta = '$cod_info_factura_venta'";
...
$agregar_operacion = "INSERT INTO tbl15_operacion (cod_plan_accion_correctiva_preventiva_mejora, cod_producto_barra, nombre_producto, origen_operacion, cod_factura, 
...
VALUES ('$cod_plan_accion_correctiva_preventiva_mejora', '$cod_producto_barra', '$nombre_producto', '$origen_operacion', '$cod_factura', 
'$unidades_vendidas', '$und_vend_orig', '$devoluciones', '$precio_compra_producto', '$precio_costo_producto', '$precio_venta_producto', 
...
if ($cod_tipo_pago == '2') {
$sql_total_deuda_credito = "SELECT SUM(total_venta_producto) AS monto_deuda FROM tbl15_plan_accion_correctiva_preventiva_mejora WHERE (cod_info_factura_venta = '$cod_info_factura_venta')";
