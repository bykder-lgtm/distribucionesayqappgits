...
$cod_estado                     = intval($_POST['pagina']);

$sql_data = "INSERT INTO tbl15_laboratorio (nombre_laboratorio, cod_tipo_historia_clinica, cod_estado) VALUES ('$nombre_laboratorio', '$cod_tipo_historia_clinica', '$cod_estado')";
