                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="contact-form-right">
                        <div class="row p-3 mb-2 bg-primary text-white">
                            <div class="col-md-12">
                                <div style="text-align:center;" class=""><?php echo $nombre_cliente ?></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="table-main">
                    <div class="mb-2">
                        <div class="col-12 d-flex shopping-box"><a href="../admin/reg_soportes_cliente_siscredito_visitante_intern.php?cod_tercero=<?php echo $cod_tercero ?>&pagina=<?php echo $pagina_local ?>" class="ml-auto btn hvr-hover">Registrar Nuevo Soporte</a> </div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="contact-form-right">
                            ...
                            -->
                                ...
                                <div class="col-md-2">
                                    <div style="text-align:center;" class="">Soporte</div>
                                </div>
                                <div class="col-md-2">
...
<input type='hidden' value='<?php echo $nombre_nota_observacion;?>' id='nombre_nota_observacion<?php echo $cod_nota_observacion;?>'>
                            ...
                            -->
                                ...
                                <div class="col-md-2">
                                    <div style="text-align:center;" class=""><a href="#" class='' title='Previsualizar' onclick="obtener_datos_mostrar_imagen_modal('<?php echo $cod_nota_observacion;?>');" data-toggle="modal" data-target=".abrir_previsualizacion_imagen"><img src="../imagenes/pdf_peq.png" class="img-polaroid" alt=""></a></div>
                                    <!--<div style="text-align:center;" class=""><a href="<?php echo $url_img_orig_producto ?>" target="_blank"><img src="../imagenes/pdf_peq.png" class="img-polaroid" alt=""></a></div>-->
                                </div>
                                <div class="col-md-2">
                                    <div style="text-align:center;" class=""><?php echo $nombre_estado_revision ?></div>
                                </div>
                                <div class="col-md-2">
