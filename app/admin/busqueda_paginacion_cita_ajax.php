...
<?php if ($cod_seguridad == 1) { ?><th style="text-align:center" class="column-title">Atender</th><?php } else { } ?>
<?php if ($cod_seguridad == 2) { ?><th style="text-align:center" class="column-title">Atender</th><?php } else { } ?>
<?php if ($cod_seguridad == 3) { ?><th style="text-align:center" class="column-title">Atender</th><?php } else { } ?>
...
$sql_consulta = "SELECT tbl15_historia_clinica.cod_historia_clinica, tbl15_historia_clinica.cod_cliente, 
tbl15_historia_clinica.cod_administrador, tbl15_cliente.nombre_especie, tbl15_cliente.nombre_raza, tbl15_cliente.nombre_contacto1,
...
<?php if ($cod_seguridad == 3) { ?><td style="text-align:center"><a href="../admin/ver_cita_historia_clinica.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/btn_hc_generica.png" class="img-polaroid" alt=""></a></td><?php } else { } ?>
