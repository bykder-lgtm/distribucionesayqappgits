...
$datos_data_info_factura = "SELECT * FROM tbl15_info_factura_auditoria  WHERE (cod_info_factura_auditoria = '$cod_info_factura_auditoria')";
...
<?php 
$sql_temporal = "SELECT cod_factura_auditoria_producto FROM tbl15_factura_auditoria_producto WHERE (cod_info_factura_auditoria = '$cod_info_factura_auditoria')";
...
<input type="hidden" name="cod_factura_auditoria_producto[]" value="<?php echo $datos_temporal['cod_factura_auditoria_producto']; ?>" size="4">
<?php } ?>
