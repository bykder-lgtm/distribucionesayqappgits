                            ...
                            <div class="table-main">
                                <div class="mb-2">
                                    <div class="col-12 d-flex shopping-box">
                                        <select class="form-control" id="numero_registro_por_pagina" onchange='load(1);' style="width: 50px;">
                                        ...
                                        <select class="form-control" name="buscar_por" id="buscar_por" onchange="load(1)" style="width: 100px;">
