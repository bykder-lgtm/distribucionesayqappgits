...
<table class="table table-striped">
	<thead>
		<tr>
			<th style="text-align:center">Total Terceros</th>
...
<tbody>
<?php
$sql_cliente = "SELECT * FROM tbl15_tercero $condicional_consulta_tercero_rel ORDER BY cod_tercero DESC";
...
<?php if ($cod_estado_tercero_editar == '1') { ?>
<td style="text-align:center"><a href="../admin/edit_tercero_empresa_laborar.php?cod_tercero=<?php echo $cod_tercero?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
<?php } ?>
</tr>
<?php } ?>
</tbody>
