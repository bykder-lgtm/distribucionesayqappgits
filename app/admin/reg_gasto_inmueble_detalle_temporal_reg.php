...
$pagina_redirect                                    = '../admin/reg_comision_propietario_detalle_factura_alquiler.php'."?cod_cuentas_cobrar=".$cod_cuentas_cobrar."&cod_cuentas_cobrar_alerta=".$cod_cuentas_cobrar_alerta."&fecha_mes=".$fecha_mes."&nombre_tabla_mes=".$nombre_tabla_mes."&nombre_tabla_anyo=".$nombre_tabla_anyo."&cod_estado_envio_correo_cuenta_cobro=".$cod_estado_envio_correo_cuenta_cobro."&cod_factura=".$cod_factura."&numero_alerta=".$numero_alerta."&cod_tercero=".$cod_tercero."&cliente=".$cliente."&cod_estado_hoy=".$cod_estado_hoy."&cod_estado_pago=".$cod_estado_pago."&buscar_por=".$buscar_por."&foco=".$foco."&palabra=".$palabra."&pagina=".$pagina;
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_gasto_inmueble_detalle_temporal (cod_gasto_inmueble, nombre_gasto_inmueble_detalle, cod_cuentas_cobrar, cod_cuentas_cobrar_alerta, cod_cuentas_cobrar_abonos, cod_factura, cod_tercero, 
...
VALUES ('$cod_gasto_inmueble', '$nombre_gasto_inmueble_detalle', '$cod_cuentas_cobrar', '$cod_cuentas_cobrar_alerta', '$cod_cuentas_cobrar_abonos', '$cod_factura', '$cod_tercero', 
'$cod_tercero_propietario', '$cod_producto', '$cod_producto_barra', '$nombre_producto', '$fecha_gasto_inmueble_detalle', '$fecha', '$fecha_mes', '$anyo', '$fecha_invert', '$fecha_seg', '$fecha_creacion')";
