...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_inventario') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_tipo_inventario                = intval($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_tipo_inventario = '$cod_tipo_inventario' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET cod_tercero = '$cod_tercero' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_mantenimiento') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_tipo_mantenimiento             = addslashes($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_tipo_mantenimiento = '$cod_tipo_mantenimiento' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_mantenimiento') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$fecha_mantenimiento           = addslashes($_POST['valor']);
$cod_info_factura_venta  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET fecha_mantenimiento = '$fecha_mantenimiento' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_producto_barra') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$cod_producto_barra           = addslashes($_POST['valor']);
$cod_venta_producto_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET cod_producto_barra = '$cod_producto_barra' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_producto') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$nombre_producto              = addslashes(strtoupper($_POST['valor']));
$cod_venta_producto_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET nombre_producto = '$nombre_producto' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='comentario_producto') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$comentario_producto           = addslashes($_POST['valor']);
$cod_venta_producto_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET comentario_producto = '$comentario_producto' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_frec_duracion') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$nombre_frec_duracion         = addslashes(strtoupper($_POST['valor']));
$cod_venta_producto_temporal  = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET nombre_frec_duracion = '$nombre_frec_duracion' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_venta') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$und_venta                    = addslashes($_POST['valor']);
$cod_venta_producto_temporal  = intval($_POST['id']);

$datos_info_temporal = "SELECT precio_costo_producto, precio_venta_producto FROM tbl15_mantenimiento_producto_temporal WHERE (cod_venta_producto_temporal = '$cod_venta_producto_temporal')";
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET und_venta = '$und_venta', total_costo_producto = '$total_costo_producto', total_venta_producto = '$total_venta_producto', 
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$precio_venta_producto        = intval($_POST['valor']);
$cod_venta_producto_temporal  = intval($_POST['id']);

$datos_info_temporal = "SELECT und_venta, precio_costo_producto FROM tbl15_mantenimiento_producto_temporal WHERE (cod_venta_producto_temporal = '$cod_venta_producto_temporal')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET precio_venta_producto = '$precio_venta_producto', total_venta_producto = '$total_venta_producto',
cod_estado_permitir_venta = '$cod_estado_permitir_venta' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_cliente') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$nombre_cliente              = addslashes(strtoupper($_POST['valor']));
$cod_venta_producto_temporal = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET nombre_cliente = '$nombre_cliente' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_cobrar') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$cod_tipo_cobrar             = addslashes(($_POST['valor']));
$id                          = addslashes($_POST['id']);
$frag                        = explode("__", $id);
$cod_venta_producto_temporal = $frag[1];

$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET cod_tipo_cobrar = '$cod_tipo_cobrar' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_alerta') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
$fecha_alerta                = addslashes(($_POST['valor']));
$cod_venta_producto_temporal = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto_temporal SET fecha_alerta = '$fecha_alerta' WHERE cod_venta_producto_temporal = '$cod_venta_producto_temporal'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='identificacion_tercero') && ($tipo_ajax=='tbl15_mantenimiento_producto_temporal')) {
