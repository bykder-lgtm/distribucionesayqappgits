            ...
            <div class="modal-content" style="background: linear-gradient(135deg, #0a0e27 0%, #1a1d3a 100%); color: white; border-radius: 15px; border: 1px solid rgba(37, 211, 102, 0.3);">
                ...
                <div class="modal-body" style="padding: 1.25rem;">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        <label style="color: #a0aec0; font-size: 0.8rem; font-weight: 600; margin-bottom: 0.4rem; display: block;"><i class="fa fa-id-card" style="margin-right: 5px;"></i> NÃºmero de CÃ©dula</label>
                        <input type="text" id="cedulaWhatsapp" class="form-control" placeholder="Ingresa tu nÃºmero de cÃ©dula" style="background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); color: white; border-radius: 8px; padding: 0.6rem 0.8rem; font-size: 0.9rem;">
                    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-video-content">
            ...
            <div class="modal-body modal-video-body">
                <div class="video-container" id="videoContainer"><!-- El iframe del video se insertarÃ¡ aquÃ­ --></div>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body" style="padding: 1.5rem;">
                ...
                <form id="formAgregarVideo" enctype="multipart/form-data">
                    ...
                    <div class="form-group-video">
                        ...
                        <input type="text" id="nombre_videotutorial" name="nombre_videotutorial" class="form-control-video" placeholder="Ej: CÃ³mo simular un crÃ©dito" required>
                    </div>
                        ...
                        <div class="form-group-video">
                            ...
                            <div class="file-upload-container">
                                ...
                                <div class="file-upload-box" id="fileUploadBox" onclick="document.getElementById('archivo_video').click();">
                                    <i class="fa fa-cloud-upload-alt"></i><p>Haz clic para seleccionar un video</p><small>Formatos: MP4, WebM, OGG (MÃ¡x: 100MB)</small>
                                </div>
                    ...
                    <div class="form-group-video">
                        <label for="descripcion_videotutorial"><i class="fa fa-align-left"></i> DescripciÃ³n (Opcional)</label>
                        <textarea id="descripcion_videotutorial" name="descripcion_videotutorial" class="form-control-video" rows="3" placeholder="Breve descripciÃ³n del contenido del video..."></textarea>
                    </div>
...
function cambiarTipoVideo(tipo) {
    ...
    // Limpiar campos de la otra secciÃ³n
    if (tipo === 'youtube') {
...
document.getElementById('archivo_video').addEventListener('change', function(e) {
    ...
    if (file) {
        ...
        if (file.size > 100 * 1024 * 1024) {
            alert('El archivo es demasiado grande. MÃ¡ximo 100MB');
            e.target.value = '';
            return;
        }
...
document.getElementById('formAgregarVideo').addEventListener('submit', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                mostrarNotificacion('success', 'Â¡Ã‰xito!', 'Video tutorial registrado correctamente');
        ...
        error: function() {
            mostrarNotificacion('error', 'Error de conexiÃ³n', 'No se pudo conectar con el servidor');
        },
        complete: function() {
            btn.disabled = false;
...
// ===================== FUNCIÃ“N DE NOTIFICACIONES TOAST =====================
...
function enviarWhatsappConsulta() {
    ...
    if (!cedula) {
        alert('Por favor ingresa tu nÃºmero de cÃ©dula');
