...
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT motivo, costo_motivo_consulta, fecha_ymd, cod_estado_facturacion, razonsocial_empresa FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (razonsocial_empresa='$razonsocial_empresa') AND (motivo='$motivo') AND (cod_estado_facturacion=1)) ORDER BY fecha_time";
...
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT motivo, costo_motivo_consulta, fecha_ymd, cod_estado_facturacion, razonsocial_empresa FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (razonsocial_empresa='$razonsocial_empresa') AND ((motivo='$motivo') 
OR (motivo='$motivo2')) AND (cod_estado_facturacion=1)) ORDER BY fecha_time";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
...
$sql_motivo_conteo = "SELECT motivo, costo_motivo_consulta, fecha_ymd, cod_estado_facturacion, razonsocial_empresa FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (razonsocial_empresa='$razonsocial_empresa') AND ((motivo='$motivo') 
OR (motivo='$motivo2') OR (motivo='$motivo3')) AND (cod_estado_facturacion=1)) ORDER BY fecha_time";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
...
$sql_motivo_conteo = "SELECT motivo, costo_motivo_consulta, fecha_ymd, cod_estado_facturacion, razonsocial_empresa FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (razonsocial_empresa='$razonsocial_empresa') AND ((motivo='$motivo') 
  OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4')) AND (cod_estado_facturacion=1)) ORDER BY fecha_time";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
...
$sql_motivo_conteo = "SELECT motivo, costo_motivo_consulta, fecha_ymd, cod_estado_facturacion, razonsocial_empresa FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (razonsocial_empresa='$razonsocial_empresa') AND ((motivo='$motivo') 
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5')) AND (cod_estado_facturacion=1)) ORDER BY fecha_time";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
...
AND (cod_estado_facturacion=1)) ORDER BY fecha_time";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
