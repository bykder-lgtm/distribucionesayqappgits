...
<div class="breadcrumbs"><a href="<?php echo $pagina ?>"><h4>Enviar Medicamentos a Correo Electrónico</h4></a></div>
<div class="row-fluid">
...
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/enviar_medicamentos_correo_reg.php">
<fieldset>
