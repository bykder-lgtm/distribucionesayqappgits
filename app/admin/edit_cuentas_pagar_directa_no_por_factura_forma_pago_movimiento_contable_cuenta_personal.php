...
if (isset($_GET['cod_cuentas_pagar_abonos'])) {
    ...
    <form name="formulario_de_actualizacion" method="post" enctype="multipart/form-data" action="../admin/edit_cuentas_pagar_directa_no_por_factura_forma_pago_movimiento_contable_cuenta_personal_reg.php">
    <table class="table table-striped">
        <tr>
