...
<!--<a class="btn btn-primary" href="#"><h6>Lista Notas Credito</h6></a>-->
</div>
<div class="row-fluid">
...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+1'>Lista Notas Credito</font></a></th>
        <th style="text-align:right"><a href="../admin/buscar_info_factura_venta_nota_credito.php"><font size='+1'>Crear Nueva Nota Credito</font></a></th>
    </tr>
</table>
<!-- ***************************************************************************************************************************** -->
...
<?php
        ...
        $sql_total_tipo_factura = "SELECT * FROM tbl15_info_nota_credito 
        ...
        ORDER BY cod_info_nota_credito DESC LIMIT 0, 800";
        ...
        $cod_info_nota_credito                              = $datos_total_tipo_factura['cod_info_nota_credito'];
        ...
        $actualiza_producto = sprintf("UPDATE tbl15_info_nota_credito SET total_precio_venta = '$total_precio_venta' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
        ...
        if ($subtotal > '0') { $url_redirect = '<a href="../admin/modificar_cuentas_cobrar.php?cod_cuentas_cobrar='.$cod_cuentas_cobrar.'&cod_factura='.$cod_factura.'&cod_info_nota_credito='.$cod_info_nota_credito.'&cod_tercero='.$cod_tercero.'&cliente='.$cliente.'&pagina='.$pagina.'">'.number_format($subtotal, 0, ",", ".").'</a>'; } else { $url_redirect = number_format($subtotal, 0, ",", "."); }
?>
        <tr>
            ...
            <td style="text-align:center;"><?php echo $cod_info_nota_credito?></td>
        </tr>
<?php } ?>
    </tbody>
</table>
