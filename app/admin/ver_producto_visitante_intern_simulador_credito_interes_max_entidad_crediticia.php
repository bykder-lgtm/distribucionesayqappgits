                                                ...
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        -->
                                                            ...
                                                            <a href="../admin/simulador_credito_producto_visitante_intern_interes_max_entidad_crediticia.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>&precio_venta_producto=<?php echo $precio_venta_producto ?>&nombre_tipo_origen_simulacion=<?php echo $nombre_tipo_origen_simulacion ?>" class="cart_modif">Cotizar Credito</a>
...
if (isset($_GET['cod_categoria'])) { 
    ...
    $sql_producto = "SELECT cod_producto, cod_producto_barra, nombre_producto, und_producto, precio_venta_producto, descripcion_producto, 
    precio_venta_producto2, url_img_min_producto, url_img_orig_producto, nombre_promocion, nombre_promocion_ing, 
    cod_categoria, cod_estado, cod_tienda FROM tbl15_producto WHERE (nombre_estado = 'HABILITADO') AND (cod_tienda = '$cod_tienda') AND (cod_categoria = '$cod_categoria_get') ORDER BY nombre_producto DESC";
}
elseif (isset($_GET['buscador'])) { 
    $buscador_get = addslashes($_GET['buscador']); 
