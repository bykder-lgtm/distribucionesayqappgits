...
//-------------------------------------------------------------------------------------------------------------------//
	...
	$precio_venta_producto              = (($iva_ptj/100) * $total_venta);
...
//-------------------------------------------------------------------------------------------------------------------//
	...
	cod_tipo_cobrar, cuenta, fecha_seg_venta_producto) 
    ...
    $sql_data = sprintf("UPDATE tbl15_info_factura_venta SET cod_base_caja = '$cod_base_caja' WHERE (cod_info_factura_venta = '$cod_info_factura_venta')");
