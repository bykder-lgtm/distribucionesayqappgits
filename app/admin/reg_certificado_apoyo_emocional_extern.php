...
<!-- ***************************************************************************************************************************** -->
<div class="ibod">
<div class="jumbotron"><h1>Formulario para Certificado de Apoyo Emocional</h1></div>
<div class="fcontacto">
<div class="logito"><p class="editaxe_interactivo"><?php echo $nombre_emp ?></p></div>

<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/reg_certificado_apoyo_emocional_extern_reg.php">
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<hr>
<div class="actions">
<input type="submit" value="Enviar Información" name="submit" id="submitButton" class="btn btn-info pull-center" title="Click aqui para enviar" />
</div>
</form>
</div>
</div>
