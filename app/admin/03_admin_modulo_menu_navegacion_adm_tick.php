...
-->
<li class=""><a href="../admin/lista_producto_adm_tick.php"><i class="fa fa-list-alt"></i> Productos</a></li>
<!--
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="">
                        ...
                        <ul class="dropdown-menu dropdown-usermenu pull-right">
                            ...
                            <li><a href="../admin/salir.php"><i class="fa fa-sign-out pull-right"></i> Cerrar Sesión</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
