...
$nombre_tipo_inventario             = "CON_EXISTENCIA";
...
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/producto_copia_inventario_con_existencia_no_cargados_masivo.php?cod_info_producto_copia_inventario=<?php echo $cod_info_producto_copia_inventario ?>">
<?php } else { ?>
