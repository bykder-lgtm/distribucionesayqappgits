    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <?php include_once("../admin/modal_mostrar_formulario_registro_simulador_credito_producto_visitante_extnosesion.php"); ?>
            </div>
            <?php
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="text-align:center; font-size: 18px" class="hvr-hover">
                                                Valor aproximado a pagar por cada cuota: $ <?php echo number_format($cuota_credito, 0, ",", ".") ?>
                                                <br>
                                                Cuotas: <?php echo $numero_cuotas ?> <?php echo $nombre_tipo_cobro ?>ES
                                            </th>
                                        </tr>
                                        <tr>
                                        </tr>
                                        <tr>
                                            <th style="text-align:center;"><a href="#" class='btn hvr-hover_modif' title='Previsualizar' onclick="obtener_datos_mostrar_ventana_modal('<?php echo $cod_entidad_crediticia;?>');" data-toggle="modal" data-target=".abrir_previsualizacion_imagen">Solicita tu crédito ahora</a></th>
                                            <!--<th style="text-align:center;"><a class="btn hvr-hover_modif" href="../admin/reg_siscredito_tercero_cliente_simulador_visitante_extnosesion.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>&valor_credito=<?php echo $valor_credito ?>&cod_entidad_crediticia=<?php echo $cod_entidad_crediticia ?>&cod_tipo_cobro=<?php echo $cod_tipo_cobro ?>&cod_meses_credito=<?php echo $cod_meses_credito ?>">Solicita tu crédito ahora</a></th>-->
                                        </tr>
                                    </thead>
                                </table>
                            </div>
            ...
            <input type='hidden' value='<?php echo $cod_entidad_crediticia;?>' id='cod_entidad_crediticia<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $interes_ptj;?>' id='interes_ptj<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $aval_ptj;?>' id='aval_ptj<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $total_interes;?>' id='total_interes<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $total_pagar;?>' id='total_pagar<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $numero_cuotas;?>' id='numero_cuotas<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $cuota_credito;?>' id='cuota_credito<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $cod_producto;?>' id='cod_producto<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $cod_producto_barra;?>' id='cod_producto_barra<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $nombre_producto;?>' id='nombre_producto<?php echo $cod_entidad_crediticia;?>'>
            <input type='hidden' value='<?php echo $precio_venta_producto;?>' id='precio_venta_producto<?php echo $cod_entidad_crediticia;?>'>
            <?php } ?>
        </div>
    </div>
<?php } ?>
...
<script>
function obtener_datos_mostrar_ventana_modal(id){

    var cod_entidad_crediticia = $("#cod_entidad_crediticia"+id).val();
    var interes_ptj = $("#interes_ptj"+id).val();
    var aval_ptj = $("#aval_ptj"+id).val();
    var total_interes = $("#total_interes"+id).val();
    var total_pagar = $("#total_pagar"+id).val();
    var numero_cuotas = $("#numero_cuotas"+id).val();
    var cuota_credito = $("#cuota_credito"+id).val();

    $("#cod_entidad_crediticia").val(cod_entidad_crediticia);
    $("#mod_"+"cod_entidad_crediticia").html(cod_entidad_crediticia);
    $("#mod_"+"nombre_producto").html(nombre_producto);
