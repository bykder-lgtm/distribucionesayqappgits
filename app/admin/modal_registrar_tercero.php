        ...
        <div class="flex" id="flex">
            <div class="modal_contenido">
                ...
                <form method="post" enctype="multipart/form-data" id="formulario_nuevo_registro_modal" name="formulario_nuevo_registro_modal" class="form-horizontal form-label-left input_mask">
                    <input type="hidden" name="cod_info_impuesto_facturas_hidden" id="cod_info_factura_venta" value="<?php echo $cod_info_factura_venta ?>" placeholder="">
                ...
                <div class="modal_cuerpo">
                    <div class="form-group">
                        ...
                        <!--<div class="col-md-4 col-sm-4 col-xs-4">-->
                            <select name="cod_pais" id="cod_pais" class="chosen" data-show-subtext="true" data-live-search="true" required>
...
function Limpiar_campos() {
    ...
    document.getElementById('cod_pais').value="";
