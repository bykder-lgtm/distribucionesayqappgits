...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$cod_info_cita_factura_venta   = intval($_POST['cod_info_cita_factura_venta']);
$fecha_anyo                    = addslashes($_POST['fecha_anyo']);
$fecha_hora                    = addslashes($_POST['fecha_hora']);
...
$sql_maxima_factura = "SELECT Max(cod_factura) AS cod_factura FROM tbl15_info_cita_factura_venta WHERE (nombre_estado_factura = 'CERRADA')";
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_info_imp_factura = "SELECT * FROM tbl15_info_cita_factura_venta WHERE cod_info_cita_factura_venta = '$cod_info_cita_factura_venta'";
...
FROM tbl15_cita_venta_producto_temporal WHERE (cod_info_cita_factura_venta = '$cod_info_cita_factura_venta')";
...
if (isset($_POST['cod_info_cita_factura_venta'])) {

for ($i=0; $i < $total_datos; $i++) {

$cod_cita_venta_producto_temporal       = $_POST['cod_cita_venta_producto_temporal'][$i];

$sql_mconsulta = "SELECT * FROM tbl15_cita_venta_producto_temporal WHERE (cod_cita_venta_producto_temporal = '$cod_cita_venta_producto_temporal')";
...
$agregar_reg_venta_producto = "INSERT INTO tbl15_cita_venta_producto (cod_info_cita_factura_venta, cod_factura, cod_producto, cod_producto_barra, 
...
VALUES ('$cod_info_cita_factura_venta', '$cod_factura', '$cod_producto', '$cod_producto_barra', 
'$nombre_producto', '$und_venta', '$precio_compra_producto', '$total_compra_producto', '$precio_costo_producto', '$total_costo_producto', '$precio_venta_producto', 
'$total_venta_producto', '$nombre_tipo_producto', '$und_producto', '$fecha_ymd_venta_producto', '$fecha_hora_venta_producto',
'$nombre_tipo_unidad_medida', '$posologia_cantidad', '$posologia_peso', '$nombre_tipo_presentacion',
'$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', '$fecha_seg_venta_producto', '$cuenta', '$cod_administrador', 
...
//----------------------------------------------------------------------- ---------------------------------------------------------//
//----------------------------------------------------------------------- ---------------------------------------------------------//
$borrar_sql = sprintf("DELETE FROM tbl15_cita_venta_producto_temporal WHERE (cod_info_cita_factura_venta = '$cod_info_cita_factura_venta')");
...
$agregar_regis = sprintf("UPDATE tbl15_info_cita_factura_venta SET cod_estado_factura = '$cod_estado_factura', cod_factura = '$cod_factura', fecha_anyo = '$fecha_anyo', 
...
$url_redir = "../admin/cita_venta_productos_opcion_imprimir.php?cod_info_cita_factura_venta=".$cod_info_cita_factura_venta."&cod_tipo_pago=".$cod_tipo_pago."&pagina=".$pagina;
