...
$sql_info_totales_ingresos_pyg = "SELECT SUM(costo_movimiento_contable) AS total_costo_movimiento_contable_ingresos_pyg FROM tbl15_movimiento_contable_cuenta_personal_concepto 
WHERE (fecha_anyo BETWEEN '$fecha_anyo_ini' AND '$fecha_anyo_fin') AND (tipo_puc = 'INGRESOS')";
...
$sql_info_totales_egresos_pyg = "SELECT SUM(costo_movimiento_contable) AS total_costo_movimiento_contable_egresos_pyg FROM tbl15_movimiento_contable_cuenta_personal_concepto 
WHERE (fecha_anyo BETWEEN '$fecha_anyo_ini' AND '$fecha_anyo_fin') AND (tipo_puc = 'EGRESOS')";
...
<table class="table table-striped">
    <tr>
        <?php if ($cod_estado_movimiento_contable_personal_registrar == '1') { ?>
            ...
            <?php if ($cod_estado_movimiento_contable_personal_appyeimi_global == '1') { ?><th style="text-align:left"><a href="../admin/reg_movimiento_contable_cuenta_personal_appyeimi.php?tipo_modulo=NORMAL"><font size='+1'>REGISTRAR NUEVO MOVIMIENTO DOBLE</font></a></th><?php } ?>
            <th style="text-align:left"><a href="../admin/reg_movimiento_contable_cuenta_personal.php?tipo_modulo=NORMAL"><font size='+1'>REGISTRAR NUEVO MOVIMIENTO</font></a></th>
            <th style="text-align:left"><a href="../admin/reg_concepto_movimiento_caja.php">.</a></th>
        <?php } ?>
...
<table class="">
  <tr>
    <th style="text-align:center; width:100px; font-size:<?php echo $tamano_font_emp ?>px;">COD PUC</th>
    <th style="text-align:left; width:600px; font-size:<?php echo $tamano_font_emp ?>px;">NOMBRE CUENTA PERSONAL</th>
    <th style="text-align:right; width:50px; font-size:<?php echo $tamano_font_emp ?>x;">SALDO</th>
    <th style="text-align:center; width:60px; font-size:<?php echo $tamano_font_emp ?>px;"></th>
    <th style="text-align:right; width:100px; font-size:<?php echo $tamano_font_emp ?>px;">ID</th>
  </tr>
<?php
...
?>
  <tr>
    <td style="text-align:center; font-size:<?php echo $tamano_font_emp ?>px;"><?php echo $codigo_puc ?></td>
    <td style="text-align:left; font-size:<?php echo $tamano_font_emp ?>px;"><?php echo $nombre_puc ?></td>
    <td style="text-align:right; font-size:<?php echo $tamano_font_emp ?>px;"><?php echo number_format($total_saldo, 0, ",", ".") ?></td>
    <td style="text-align:right; font-size:<?php echo $tamano_font_emp ?>px;"></td>
    <td style="text-align:right; font-size:<?php echo $tamano_font_emp ?>px;"><?php echo $cod_movimiento_contable_cuenta_personal ?></td>
  </tr>
<?php } ?>
  <tr>
    <th style="text-align:center; font-size:<?php echo $tamano_font_emp ?>px;"></th>
    <th style="text-align:left; font-size:<?php echo $tamano_font_emp ?>px;">TOTAL SALDO</th>
    <th style="text-align:right; font-size:<?php echo $tamano_font_emp ?>px;"><?php echo number_format($total_saldo_movimiento_contable_cuenta_personal, 0, ",", ".") ?></th>
    <th style="text-align:right; font-size:<?php echo $tamano_font_emp ?>px;"></th>
    <th style="text-align:right; font-size:<?php echo $tamano_font_emp ?>px;"></th>
  </tr>
</table>
