...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>Reporte Pagos</font></a></th>
    </tr>
</table>
...
?>
<fieldset><legend>TOTAL INGRESOS</legend>
    <table class="table table-striped">
        <thead>
            <tr>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL INGRESO POR INTERESES</th>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL INGRESO POR REPARACIONES</th>
                ...
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL INGRESO INMOBILIARIA</th>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL INGRESO JURIDICA (INGRESO)</th>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL INGRESO JURIDICA (ARRIENDO)</th>
...
<fieldset><legend>TOTAL GASTOS</legend>
    <table class="table table-striped">
        <thead>
            <tr>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL GASTOS INMOBILIARIA</th>
            </tr>
        </thead>
        <tbody>
            <tr>
...
<fieldset><legend>TOTAL PAGOS</legend>
    <table class="table table-striped">
        <thead>
            <tr>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL VALOR PAGADO A PROPIETARIO</th>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">TOTAL VALOR PAGADO POR INQUILINOS</th>
            </tr>
        </thead>
        <tbody>
            <tr>
...
<fieldset><legend>PAGOS DE INQUILINOS</legend>
    <table class="table table-striped">
    <thead>
    <tr>
        <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">CONTRATO</th>
...
<fieldset><legend>PAGOS SOLICITUD ARRIENDO</legend>
    <table class="table table-striped">
    <thead>
    <tr>
...
<fieldset><legend>INGRESOS POR REPARACIONES</legend>
<table class="table table-striped">
        <thead>
            <tr>
            <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">CONTRATO</th>
...
<fieldset><legend>INGRESOS INMOBILIARIA</legend>
    <table class="table table-striped">
        <tr>
...
<fieldset><legend>GASTOS INMOBILIARIA</legend>
    <table class="table table-striped">
        <tr>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;">CONCEPTO</th>
            <th style="text-align:center; background-color:#DBE0F3; color:#000;">VALOR</th>
...
<?php } ?>
        <tr>
            <th style="text-align:right; background-color:#DBE0F3; color:#000;"></th>
            <th style="text-align:right; background-color:#DBE0F3; color:#000;">TOTAL</th>
            <th style="text-align:right; background-color:#DBE0F3; color:#000;"><?php echo number_format($total_otros_egresos_inmobil, 0, ",", ".") ?></th>
            <th style="text-align:right; background-color:#DBE0F3; color:#000;"></th>
            <th style="text-align:right; background-color:#DBE0F3; color:#000;"></th>
            <th style="text-align:right; background-color:#DBE0F3; color:#000;"></th>
        </tr>
