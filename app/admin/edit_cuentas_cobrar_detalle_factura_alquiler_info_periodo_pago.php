...
$(function(){
    ...
    $("#deduccion_retefuente").keyup(function () {
        var deduccion_retefuente = parseFloat($(this).val());
    ...
    $("#deduccion_otro_concepto").keyup(function () {
        var deduccion_otro_concepto = parseFloat($(this).val());
...
$pagina_regresar                = $pagina.'?cod_cuentas_cobrar_alerta='.$cod_cuentas_cobrar_alerta.'&cod_cuentas_cobrar='.$cod_cuentas_cobrar.'&cod_tercero='.$cod_tercero.'&cod_factura='.$cod_factura.'&pagina='.$pagina;
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$calcular_datos_cuenta_cobrar = "SELECT * FROM tbl15_cuentas_cobrar_alerta WHERE (cod_cuentas_cobrar_alerta = '$cod_cuentas_cobrar_alerta')";
...
$deduccion_retefuente           = $datos_cuenta_cobrar['deduccion_retefuente'];
$deduccion_otro_concepto        = $datos_cuenta_cobrar['deduccion_otro_concepto'];
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/edit_cuentas_cobrar_detalle_factura_alquiler_info_periodo_pago_reg.php">
    <fieldset>
    ...
    <table border="1" class="table table-responsive">
        <thead>
            <tr>
                ...
                <th style="text-align:center">RETEFUENTE PARA TERCEROS (DEDUCCION)</th>
                <th style="text-align:center">OTROS CONCEPTOS (DEDUCCION)</th>
                <th style="text-align:center">FECHA LIMITE PAGO</th>
                <th style="text-align:center"># RENOVACION</th>
            </tr>
            <tr>
            <td style="text-align:center">
                <select name="nombre_tabla_mes" id="nombre_tabla_mes" class="selectpicker" data-show-subtext="true" data-live-search="true" style="width: 120px;" tabindex="1">
                ...
                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="monto_deuda_sin_interes" id="monto_deuda_sin_interes" type="text" value="<?php echo $monto_cuota ?>" min="1" size="10" required></td>
                <input name="monto_deuda_sin_interes_hidden" id="monto_deuda_sin_interes_hidden" type="hidden" value="<?php echo $monto_cuota ?>" min="1" size="10" required>

                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="deduccion_retefuente" id="deduccion_retefuente" type="text" value="<?php echo $deduccion_retefuente ?>" min="0" size="10" ></td>
                <input name="deduccion_retefuente_hidden" id="deduccion_retefuente_hidden" type="hidden" value="<?php echo $deduccion_retefuente ?>" min="0" size="10" >

                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="deduccion_otro_concepto" id="deduccion_otro_concepto" type="text" value="<?php echo $deduccion_otro_concepto ?>" min="0" size="10" ></td>
                <input name="deduccion_otro_concepto_hidden" id="deduccion_otro_concepto_hidden" type="hidden" value="<?php echo $deduccion_otro_concepto ?>" min="" size="10">

                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="fecha_pago" type="date" value="<?php echo $fecha_pago ?>" size="10" required></td>
                <td style="text-align:center"><input style="font-size:24px" class="input-block-level" name="cod_renovacion_contrato" type="number" value="<?php echo $cod_renovacion_contrato ?>" size="10" required></td>
            </tr>
        </thead>
    </table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody>
        ...
        <hr>
        <div class="actions">
            <td style="text-align:center"><input type="submit" value="Guardar Cambios" name="submit" id="submitButton" class="btn btn-info pull-center" title="Click aqui para enviar" /></td>
        </div>
        </tr>
    </tbody>
</table>
