...
$pagina2                           = "../admin/lista_info_factura_cotizacion_venta.php";

$pagina_local                      = $_SERVER['PHP_SELF'];
$cod_info_cotizacion_factura_venta = intval($_GET['cod_info_cotizacion_factura_venta']);
$origen                            = 'PARACLINICOS';

$sql_profesional = "SELECT cod_factura FROM tbl15_info_cotizacion_factura_venta WHERE cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta'";
...
$incre                             = 0;
$tab                               = 'tbl15_cotizacion_venta_producto';
$campo                             = 'cod_cotizacion_venta_producto';
$tab2                              = 'tbl15_info_cotizacion_factura_venta';
$campo2                            = 'cod_info_cotizacion_factura_venta';
$tipo                              = 'eliminar';
...
var cod_info_cotizacion_factura_venta = <?php echo $cod_info_cotizacion_factura_venta; ?>;
...
xmlhttp.open("POST","../admin/busqueda_inmediata_cotizacion_venta_producto_php.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("buscar="+valor_buscar+"&cod_info_cotizacion_factura_venta="+cod_info_cotizacion_factura_venta+"&pagina="+pagina);
}
</script>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr><td bgcolor="#fff" align="center"><strong><a href="../admin/lista_info_factura_cotizacion_venta.php">LISTA DE COTIZACIONES</a></strong></td></tr></tbody>
</table>

<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr><td bgcolor="#fff" align="center"><strong>EDICION COTIZACION DE VENTA</strong></td></tr></tbody>
</table>
...
<!-- ***************************************************************************************************************************** -->
<?php
$datos_factura = "SELECT cod_cotizacion_venta_producto FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta')";
...
FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta')";
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_cotizacion_factura_venta WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta')";
$consulta_data_info_factura = mysqli_query($conectar, $datos_data_info_factura);
$data_info_factura = mysqli_fetch_assoc($consulta_data_info_factura);
$factura_ocupada = mysqli_num_rows($consulta_data_info_factura);

$cod_info_cotizacion_factura_venta      = $data_info_factura['cod_info_cotizacion_factura_venta'];
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            var tipo_ajax = "tbl15_info_cotizacion_factura_venta";
            $.post("guardar_info_factura_y_cotizacion_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_cotizacion_factura_venta; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_cotizacion_venta_producto";
            var id = $(this).attr("class");
            //let id = this.id;
            $.post("guardar_info_factura_y_cotizacion_venta_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
-->
    ...
    <th style="text-align:center;">ENVIAR A VENTAS</th>
  </tr>
  <tr>
   <td style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_info_cotizacion_factura_venta?>&tab=<?php echo $tab2?>&campo=<?php echo $campo2?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina2?>"><img src="../imagenes/eliminar_grand.png" class="img-polaroid" alt=""></a></td>
   <td style="text-align:center;"><?php echo $cod_info_cotizacion_factura_venta ?></td>
...
-->
    ...
    <td style="text-align:center;"><a href="../admin/enviar_cotizacion_venta_a_venta_producto_temporal.php?cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta?>&tab=<?php echo $tab?>&campo=<?php echo $campo?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/agregar.png" class="img-polaroid" alt=""></a></td>
  </tr>
</table>
<!-- ***************************************************************************************************************************** -->
...
<thead>
    <tr>
        ...
        <?php if ($cod_estado_cajas_sobre_global  == '1') { ?><th style="text-align:center;">PRESENTACION</th><?php } ?>
        <?php if ($cod_estado_und_sobre_global  == '1') { ?><th style="text-align:center;">SOBRE</th><?php } ?>
        <?php if ($cod_estado_cotizacion_und_inventario == '1') { ?><th style="text-align:center;">UND INV</th><?php } ?>
        <?php if ($cod_estado_cotizacion_precio_compra  == '1') { ?><th style="text-align:center;">PRECIO COMPRA</th><?php } ?>
...
<tbody>
<?php
$sql_cotizacion_venta_producto = "SELECT * FROM tbl15_cotizacion_venta_producto WHERE (cod_info_cotizacion_factura_venta = '$cod_info_cotizacion_factura_venta') ORDER BY cod_cotizacion_venta_producto DESC";
$consulta_cotizacion_venta_producto = mysqli_query($conectar, $sql_cotizacion_venta_producto);
while ($datos_cotizacion_venta_producto = mysqli_fetch_assoc($consulta_cotizacion_venta_producto)) {

    $cod_cotizacion_venta_producto                = $datos_cotizacion_venta_producto['cod_cotizacion_venta_producto'];
    $cod_producto                                 = $datos_cotizacion_venta_producto['cod_producto'];
    $cod_producto_barra                           = $datos_cotizacion_venta_producto['cod_producto_barra'];
    $nombre_producto                              = $datos_cotizacion_venta_producto['nombre_producto'];
    $cedula                                       = $datos_cotizacion_venta_producto['cedula'];
    $nombre_cliente                               = $datos_cotizacion_venta_producto['nombre_cliente'];
    $und_venta                                    = $datos_cotizacion_venta_producto['und_venta'];
    $precio_compra_producto                       = $datos_cotizacion_venta_producto['precio_compra_producto'];
    $precio_costo_producto                        = $datos_cotizacion_venta_producto['precio_costo_producto'];
    $total_costo_producto                         = $datos_cotizacion_venta_producto['total_costo_producto'];
    $precio_venta_producto                        = $datos_cotizacion_venta_producto['precio_venta_producto'];
    $total_venta_producto                         = $datos_cotizacion_venta_producto['total_venta_producto'];
    $nombre_tipo_producto                         = $datos_cotizacion_venta_producto['nombre_tipo_producto'];
    $nombre_tipo_unidad_medida                    = $datos_cotizacion_venta_producto['nombre_tipo_unidad_medida'];
    $posologia_cantidad                           = $datos_cotizacion_venta_producto['posologia_cantidad'];
    $posologia_peso                               = $datos_cotizacion_venta_producto['posologia_peso'];
    $nombre_tipo_presentacion                     = $datos_cotizacion_venta_producto['nombre_tipo_presentacion'];
    $nombre_via_administracion                    = $datos_cotizacion_venta_producto['nombre_via_administracion'];
    $nombre_frec_duracion                         = $datos_cotizacion_venta_producto['nombre_frec_duracion'];
    $cod_tipo_cobrar                              = $datos_cotizacion_venta_producto['cod_tipo_cobrar'];
    $cod_info_cotizacion_factura_venta            = $datos_cotizacion_venta_producto['cod_info_cotizacion_factura_venta'];
    $nombre_tipo_precio_venta                     = $datos_cotizacion_venta_producto['nombre_tipo_precio_venta'];
    $peso_producto                                = $datos_cotizacion_venta_producto['peso_producto'];
    $cajas_sobre                                  = $datos_cotizacion_venta_producto['cajas_sobre'];
    $und_sobre                                    = $datos_cotizacion_venta_producto['und_sobre'];
    $und_caja_sobre                               = $datos_cotizacion_venta_producto['und_caja_sobre'];
    $nombre_tipo_und_caja_sobre                   = $datos_cotizacion_venta_producto['nombre_tipo_und_caja_sobre'];
    $incre++;
    ...
    $datos_info_producto = "SELECT und_producto FROM tbl15_producto WHERE cod_producto_barra = '$cod_producto_barra'";
    $consulta_info_producto = mysqli_query($conectar, $datos_info_producto);
    $existe_producto = mysqli_num_rows($consulta_info_producto);
    $info_producto = mysqli_fetch_assoc($consulta_info_producto);

    $und_producto                                 = $info_producto['und_producto'];
?>
    <tr style="text-align:center;" id="tr<?php echo $cod_cotizacion_venta_producto;?>">
        <td style="text-align:right;" id="existe_producto_<?php echo $incre;?>"><?php echo $existe_producto;?></td>
        <td  style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_cotizacion_venta_producto?>&cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta ?>&tab=<?php echo $tab ?>&tipo=<?php echo $tipo ?>&campo=<?php echo $campo ?>&pagina=<?php echo $pagina_local ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>
        <!--<td style="text-align:center"><input name="cod_tipo_cobrar" class="cod_tipo_cobrar__<?php echo $cod_cotizacion_venta_producto;?>" id="cod_tipo_cobrar_<?php echo $cod_cotizacion_venta_producto;?>" type="checkbox" value="1" <?php if($cod_tipo_cobrar=='1'){ echo "checked"; } ?>></td>-->
        <!--<td style="text-align:center;" id="cod_cotizacion_venta_producto_<?php echo $cod_cotizacion_venta_producto ?>" class="service_list" data="<?php echo $cod_cotizacion_venta_producto ?>"><a class="eliminar" id="cod_cotizacion_venta_producto<?php echo $cod_cotizacion_venta_producto ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>-->
        ...
        <td style="text-align:right;" id="und_venta_<?php echo $incre;?>"><input name="und_venta" type="number" id="und_venta-<?php echo $incre;?>" class="<?php echo $cod_cotizacion_venta_producto;?>" onChange="calc_total_venta();" value="<?php echo $und_venta;?>" style="width: 70px;" /></td>
                
        <td style="text-align:center;" id="nombre_tipo_unidad_medida_<?php echo $incre;?>"><?php echo $nombre_tipo_und_caja_sobre.$nombre_tipo_unidad_medida_contidad;?></td>

        <?php if ($cod_estado_peso_producto_global == '1') { ?>
        <td style="text-align:center;" id="peso_producto_<?php echo $incre;?>"><input name="peso_producto" type="number" id="peso_producto-<?php echo $incre;?>" class="<?php echo $cod_cotizacion_venta_producto;?>" value="<?php echo $peso_producto;?>" style="width: 70px;" /></td>
        <?php } ?>

        <?php if ($cod_estado_cajas_sobre_global  == '1') { ?><td style="text-align:center;" id="cajas_sobre_<?php echo $incre;?>"><input name="cajas_sobre" type="number" id="cajas_sobre<?php echo $incre;?>" class="<?php echo $cod_cotizacion_venta_producto;?>" value="<?php echo $cajas_sobre;?>" style="width: 70px;" /></td><?php } ?>
        <?php if ($cod_estado_und_sobre_global  == '1') { ?><td style="text-align:center;" id="und_sobre_<?php echo $incre;?>"><input name="und_sobre" type="number" id="und_sobre<?php echo $incre;?>" class="<?php echo $cod_cotizacion_venta_producto;?>" value="<?php echo $und_sobre;?>" style="width: 70px;" /></td><?php } ?>

        <?php if ($cod_estado_cotizacion_und_inventario == '1') { ?><td style="text-align:right;" id="precio_compra_producto_<?php echo $incre;?>"><?php echo number_format($und_producto, 0, ",", "."); ?></td><?php } ?>
        <?php if ($cod_estado_cotizacion_precio_compra  == '1') { ?><td style="text-align:right;" id="precio_compra_producto_<?php echo $incre;?>"><?php echo number_format($precio_compra_producto, 0, ",", "."); ?></td><?php } ?>
        ...
        <?php if ($cod_estado_precio_venta_variable_disponible=='1') { ?>
            <?php if ($nombre_tipo_precio_venta=='PVAR') { ?>
               ...
               <td style="text-align:right;" id="precio_venta_producto_<?php echo $incre;?>"><input name="precio_venta_producto" type="text" id="precio_venta_producto-<?php echo $incre;?>" class="<?php echo $cod_cotizacion_venta_producto;?>" onChange="calc_total_venta();" value="<?php echo $precio_venta_producto;?>" step="any" style="width: 100px; height: 29px;" /></td>
              <?php } else { ?>
              <td style="text-align:center;">
                <?php for ($i=1; $i <= $numero_precio; $i++) { ?>
                <a href="../admin/actualizar_cotizacion_precio_venta_producto.php?nombre_tipo_precio_venta=PV<?php echo $i?>&i=<?php echo $i?>&cod_cotizacion_venta_producto=<?php echo $cod_cotizacion_venta_producto?>&cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta ?>&cuenta=<?php echo $cuenta?>&cod_caja_virtual=<?php echo $cod_caja_virtual?>&pagina=<?php echo $pagina_local?>"><img src="<?php if ($nombre_tipo_precio_venta=="PV$i") { echo "../imagenes/PV".$i."_R.png"; } else { echo "../imagenes/PV$i.png"; } ?>"></a>
                <?php } ?>
              </td>
            <td style="text-align:right;" id="precio_venta_producto_<?php echo $incre;?>"><input name="precio_venta_producto" type="text" id="precio_venta_producto-<?php echo $incre;?>" class="<?php echo $cod_cotizacion_venta_producto;?>" onChange="calc_total_venta();" value="<?php echo $precio_venta_producto;?>" step="any" style="width: 100px; height: 29px;" /></td>
            <?php } ?>
    ...
    </tr style="text-align:right;" id="tr<?php echo $cod_cotizacion_venta_producto;?>">
<?php } ?>
</tbody>
</table>
...
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  <tr>
<!--
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=EXCEL&cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/excel.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=FACTURA&cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/imprimir_peq.png" class="img-polaroid" alt=""></a></td>
    <td style="text-align:center;"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=LISTA&cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></td>
-->
    <td style="text-align:center;"><a href="../admin/cotizacion_venta_productos_opcion_imprimir.php?cod_info_cotizacion_factura_venta=<?php echo $cod_info_cotizacion_factura_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos.png" class="img-polaroid" alt=""></a></td>
  </tr>
</table>
</div>
<!-- ***************************************************************************************************************************** -->
...
$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
        ...
        var cod_cotizacion_venta_producto = $(this).parent().attr('data');
        var dataString = 'llave='+cod_cotizacion_venta_producto+'&'+'tab='+'<?php echo $tab ?>'+'&'+'campo='+'<?php echo $campo ?>'+'&'+'tipo='+'<?php echo $tipo ?>';
        ...
        $.ajax({
            ...
            success: function() {           
                $('#eliminar-ok').empty();
                $('#eliminar-ok').append('<div align="center" class="correcto">Se ha eliminado correctamente el codigo = '+cod_cotizacion_venta_producto+'.</div>').fadeIn("slow");
                $('#'+parent).fadeOut("slow");
                $('#cod_producto_barra_'+cod_cotizacion_venta_producto).fadeOut("slow");
                $('#nombre_cliente_'+cod_cotizacion_venta_producto).fadeOut("slow");
                $('#nombre_producto_'+cod_cotizacion_venta_producto).fadeOut("slow");
                $('#und_venta_'+cod_cotizacion_venta_producto).fadeOut("slow");
                $('#precio_venta_producto_'+cod_cotizacion_venta_producto).fadeOut("slow");
                $('#total_venta_producto_'+cod_cotizacion_venta_producto).fadeOut("slow");
                $('#tr'+cod_cotizacion_venta_producto).fadeOut("slow");
            }
        });
