...
$tabla = 'tbl15_manipulacion_alimento';
...
<div class="breadcrumbs">
<a href="../admin/lista_aptos_manipulacion_alimentos.php?pagina=<?php echo $pagina ?>"><h4>Aptos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_no_aptos_manipulacion_alimentos.php?pagina=<?php echo $pagina ?>">No Aptos</h4></a>
</div>
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control" id="buscar_por" onchange='load(1);'>
                ...
                <option value="cod_manipulacion_alimento">Codigo Manipulacion</option>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_no_aptos_manipulacion_alimento_ajax.js"></script>
</body>
</html>