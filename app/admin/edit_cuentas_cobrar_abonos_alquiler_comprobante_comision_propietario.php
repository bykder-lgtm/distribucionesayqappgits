...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
if (isset($_GET['cod_cuentas_cobrar_factura_comision_propietario'])) { 
    ...
    //---------------------------------------------------------------------------------------------------------------------------------//
    //---------------------------------------------------------------------------------------------------------------------------------//
    $pagina_redirect                   = '../admin/comision_propietario_detalle_factura_alquiler.php?fecha_mes='.$fecha_mes.'&nombre_tabla_mes='.$nombre_tabla_mes.'&nombre_tabla_anyo='.$nombre_tabla_anyo.'&cod_estado_envio_correo_cuenta_cobro='.$cod_estado_envio_correo_cuenta_cobro.'&pagina='.$pagina.'&cod_cuentas_cobrar='.$cod_cuentas_cobrar.'&cod_cuentas_cobrar_abonos='.$cod_cuentas_cobrar_abonos.'&cod_factura='.$cod_factura.'&cod_tercero='.$cod_tercero.'&cod_estado_pago='.$cod_estado_pago.'&cliente='.$cliente.'&palabra='.$palabra;
    //---------------------------------------------------------------------------------------------------------------------------------//
    //---------------------------------------------------------------------------------------------------------------------------------//
    $sql_fecha_pago_alert = "SELECT * FROM tbl15_cuentas_cobrar_factura_comision_propietario WHERE (cod_cuentas_cobrar_factura_comision_propietario = '$cod_cuentas_cobrar_factura_comision_propietario')";
    ...
    $cod_estado_envio_correo_comision_propietario          = $datos_fecha_pago_alert['cod_estado_envio_correo_comision_propietario'];
    ...
    $cod_administrador                                     = $datos_fecha_pago_alert['cod_administrador'];
    $deduccion_imp_cuatroxmil                              = $datos_fecha_pago_alert['deduccion_imp_cuatroxmil'];
    ...
    $calcular_datos_cuenta_cobrar = "SELECT * FROM tbl15_cuentas_cobrar_factura_comision_propietario 
    ...
    $cod_cuentas_cobrar_factura_comision_propietario      = $datos_fecha_pago_alert['cod_cuentas_cobrar_factura_comision_propietario'];
    $fecha_pago_limite                                    = $datos_fecha_pago_alert['fecha_pago'];
    $monto_deuda_alerta                                   = $datos_fecha_pago_alert['monto_deuda'];
    $deduccion_retefuente                                 = $datos_fecha_pago_alert['deduccion_retefuente'];
    $deduccion_reparacion                                 = $datos_fecha_pago_alert['deduccion_reparacion'];
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$calcular_datos_cuenta_cobrar = "SELECT fecha_pago FROM tbl15_cuentas_cobrar_alerta WHERE (cod_cuentas_cobrar_alerta = '$cod_cuentas_cobrar_alerta')";
...
$fecha_pago_limite                                 = date("d-m-Y", strtotime($fecha_pago));
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_consulta_producto = "SELECT cod_producto_barra, nombre_tipo_producto, direccion_producto, descripcion_producto, cod_tercero, referencia_catastral_inmueble, numero_matricula_inmueble 
...
<table border="1" class="table table-responsive">
    <thead>
        ...
        <tr>
            ...
            <td style="text-align:center"><a id="foco_adjunto" href="../admin/cuentas_cobrar_detalle_factura_alquiler.php?cod_cuentas_cobrar=<?php echo $cod_cuentas_cobrar ?>&cod_tercero=<?php echo $cod_tercero ?>&cod_factura=<?php echo $cod_factura ?>&pagina=<?php echo $pagina_local ?>&palabra=<?php echo $palabra ?>">VER</a></td>
...
<table border="1" class="table table-responsive">
    <thead>
        <tr>
            ...
            <th style="text-align:center">IMPRIMIR COMPROBANTE DE COMISION PROPIETARIO</th>
            <!--<th style="text-align:center">IMPRIMIR COMROBANTE INGRESO</th>-->
            <th style="text-align:center">IMPRIMIR SALDO A FAVOR</th>
            <th style="text-align:center">IMPRIMIR CUENTAS DE GASTOS</th>
        </tr>
        <tr>
            <td style="text-align: center;"><a href="<?php echo $pagina_redirect;?>">Regresar</a></td>
            <td style="text-align: center;"><a href="../admin/cuentas_cobrar_abonos_alquiler_comprobante_comision_propietario_imprimir_pdf.php?cod_cuentas_cobrar_factura_comision_propietario=<?php echo $cod_cuentas_cobrar_factura_comision_propietario;?>&fecha_mes=<?php echo $fecha_mes;?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes;?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo;?>&cod_estado_envio_correo_cuenta_cobro=<?php echo $cod_estado_envio_correo_cuenta_cobro;?>&cod_estado_pago=<?php echo $cod_estado_pago;?>&pagina=<?php echo $pagina_local;?>&palabra=<?php echo $palabra;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>
            <!--<td style="text-align: center;"><a href="../admin/cuentas_cobrar_abonos_alquiler_comprobante_cuenta_cobro_imprimir_pdf.php?cod_cuentas_cobrar_factura_comision_propietario=<?php echo $cod_cuentas_cobrar_factura_comision_propietario;?>&fecha_mes=<?php echo $fecha_mes;?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes;?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo;?>&cod_estado_envio_correo_cuenta_cobro=<?php echo $cod_estado_envio_correo_cuenta_cobro;?>&cod_estado_pago=<?php echo $cod_estado_pago;?>&pagina=<?php echo $pagina_local;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>-->
            <td style="text-align: center;"><a href="../admin/saldo_favor_inquilino_imprimir_pdf.php?cod_cuentas_cobrar_factura_comision_propietario=<?php echo $cod_cuentas_cobrar_factura_comision_propietario;?>&fecha_mes=<?php echo $fecha_mes;?>&nombre_tabla_mes=<?php echo $nombre_tabla_mes;?>&nombre_tabla_anyo=<?php echo $nombre_tabla_anyo;?>&cod_estado_envio_correo_cuenta_cobro=<?php echo $cod_estado_envio_correo_cuenta_cobro;?>&cod_estado_pago=<?php echo $cod_estado_pago;?>&pagina=<?php echo $pagina_local;?>&palabra=<?php echo $palabra;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>
    ...
    <tbody>
        <tr>
            <td bgcolor="#FAC090" align="center">
                <!--
                <strong>
                BUSCAR GASTOS: <input type="text" id="busqueda_gasto_inmueble" name="busqueda_gasto_inmueble" onkeyup="hacer_busqueda_gasto_inmueble()" style="height:40" placeholder="Buscar"/>
                <input type="hidden" id="valor_campos" name="valor_campos" value="<?php echo $cod_cuentas_cobrar_alerta ?>-<?php echo $cod_tercero ?>-<?php echo $pagina_local ?>"/>
                </strong>
            -->
<script type="text/javascript">
function hacer_busqueda_gasto_inmueble() {
var xmlhttp;

var valor_buscar = document.getElementById('busqueda_gasto_inmueble').value;
var valor_campos = document.getElementById('valor_campos').value;
var cod_cuentas_cobrar_factura_comision_propietario = "<?php echo $cod_cuentas_cobrar_factura_comision_propietario;?>";
var cod_cuentas_cobrar = "<?php echo $cod_cuentas_cobrar;?>";
var cod_cuentas_cobrar_alerta = "<?php echo $cod_cuentas_cobrar_alerta;?>";
var fecha_mes = "<?php echo $fecha_mes;?>";
var nombre_tabla_mes = "<?php echo $nombre_tabla_mes;?>";
var nombre_tabla_anyo = "<?php echo $nombre_tabla_anyo;?>";
var cod_estado_envio_correo_cuenta_cobro = "<?php echo $cod_estado_envio_correo_cuenta_cobro;?>";
var cod_factura = "<?php echo $cod_factura;?>";
var numero_alerta = "<?php echo $numero_alerta;?>";
var cod_tercero = "<?php echo $cod_tercero;?>";
var cliente = "<?php echo $cliente;?>";
var cod_estado_hoy = "<?php echo $cod_estado_hoy;?>";
var cod_estado_pago = "<?php echo $cod_estado_pago;?>";
var buscar_por = "<?php echo $buscar_por;?>";
var foco = "<?php echo $foco;?>";
var pagina = "<?php echo $pagina_local;?>";

if(valor_buscar=='') { document.getElementById("logo_cargador_examenes").innerHTML=""; return; }

if (window.XMLHttpRequest) { xmlhttp=new XMLHttpRequest(); } else { xmlhttp=new ActiveXObject("Microsoft.XMLHTTP"); }
xmlhttp.onreadystatechange=function() {
  if (xmlhttp.readyState==4 && xmlhttp.status==200) { document.getElementById("logo_cargador_examenes").innerHTML=xmlhttp.responseText; } else { document.getElementById("logo_cargador_examenes").innerHTML='<center><img src="../imagenes/loader.gif"/></center>'; }
}
xmlhttp.open("POST","../admin/busqueda_inmediata_gasto_inmueble_php.php",true);
xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
xmlhttp.send("buscar="+valor_buscar+"&valor_campos="+valor_campos+"&cod_cuentas_cobrar_factura_comision_propietario="+cod_cuentas_cobrar_factura_comision_propietario+"&cod_cuentas_cobrar="+cod_cuentas_cobrar+"&cod_cuentas_cobrar_alerta="+cod_cuentas_cobrar_alerta+"&fecha_mes="+fecha_mes+"&nombre_tabla_mes="+nombre_tabla_mes+"&nombre_tabla_anyo="+nombre_tabla_anyo+"&cod_estado_envio_correo_cuenta_cobro="+cod_estado_envio_correo_cuenta_cobro+"&cod_factura="+cod_factura+"&numero_alerta="+numero_alerta+"&cod_tercero="+cod_tercero+"&cliente="+cliente+"&cod_estado_hoy="+cod_estado_hoy+"&cod_estado_pago="+cod_estado_pago+"&buscar_por="+buscar_por+"&foco="+foco+"&pagina="+pagina);
}
</script>
            <div id="logo_cargador_examenes"></div>
            </td>
        </tr>
    </tbody>
</table>
...
<table border="1" class="table table-responsive">
    <thead>
        <tr>
            ...
            <?php
            $total_gasto = 0;
            $obtener_cie10diag = "SELECT * FROM tbl15_gasto_inmueble_detalle_venta WHERE (cod_cuentas_cobrar_alerta = '$cod_cuentas_cobrar_alerta') ORDER BY cod_gasto_inmueble_detalle_venta DESC";
            $consultar_cie10diag = mysqli_query($conectar, $obtener_cie10diag) or die(mysqli_error($conectar));
            while ($info_cie10diag = mysqli_fetch_assoc($consultar_cie10diag)) {
            ...
            ?>
        <tr id="tr<?php echo $cod_gasto_inmueble_detalle_venta;?>">
            <td style="text-align:left;" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>"><?php echo $nombre_gasto_inmueble_detalle;?></td>
            <td style="text-align:left;" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>"><textarea name="descripcion_gasto_inmueble_detalle" id="<?php echo $cod_gasto_inmueble_detalle_venta;?>" class="input-block-level" rows="1" cols="50"><?php echo $descripcion_gasto_inmueble_detalle;?></textarea></td>
            <td style="text-align:left;" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>"><input style="font-size:24px" type="text" name="precio_venta_producto" id="<?php echo $cod_gasto_inmueble_detalle_venta;?>" value="<?php echo $precio_venta_producto;?>" class="input-block-level" style="width: 130px;"></td>
            <td style="text-align:center;" class="" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>" dataexclu="<?php echo $cod_gasto_inmueble_detalle_venta ?>"><a class="excluir_gasto_inmueble_detalle" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>"><img src="../imagenes/eliminar_excluir_grand.png" class="img-polaroid" alt=""></a></td>
            <td style="text-align:left;" id="cod_gasto_inmueble_detalle_venta<?php echo $cod_gasto_inmueble_detalle_venta ?>"><?php echo $cod_gasto_inmueble_detalle_venta;?></td>
        </tr id="tr<?php echo $cod_gasto_inmueble_detalle_venta;?>">
        <?php } ?>
        <tr>
            <!--<th style="text-align:center"></th>-->
            <th style="text-align:center"></th>
            <th style="text-align:center; font-size:24px">TOTAL</th>
            <th style="text-align:left; font-size:24px" id="total_gasto"><?php echo number_format($total_gasto, 0, ",", ".");?></th>
            <th style="text-align:center"></th>
            <th style="text-align:center"></th>
        </tr>
    </thead>
...
<table border="1" class="table table-responsive">
    <thead>
        ...
        <tr>
            <td style="text-align:center"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_saldo_favor" id="deduccion_saldo_favor" value="<?php echo $deduccion_saldo_favor;?>" min="0" size="5" required></td>
            <input type="hidden" name="deduccion_saldo_favor_hidden" id="deduccion_saldo_favor_hidden" value="" required>
            
            <td style="text-align:center">
                <select name="cod_estado" id="cod_estado" class="<?php echo $cod_cuentas_cobrar_factura_comision_propietario;?>" data-show-subtext="true" data-live-search="true" required>
            ...
            <td style="text-align:center">
                <select name="cod_estado_envio_correo_comision_propietario" id="cod_estado_envio_correo_comision_propietario" class="<?php echo $cod_cuentas_cobrar_factura_comision_propietario;?>" data-show-subtext="true" data-live-search="true" required>
                    <?php if (isset($cod_estado_envio_correo_comision_propietario)) { echo ""; } else { echo  ""; }
                    $consulta2_sql = "SELECT cod_estado_envio_correo, nombre_estado_envio_correo FROM tbl15_estado_envio_correo ORDER BY cod_estado_envio_correo ASC";
                    $consulta2 = mysqli_query($conectar, $consulta2_sql);
                    while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                    if(isset($cod_estado_envio_correo_comision_propietario) AND $cod_estado_envio_correo_comision_propietario == $datos2['cod_estado_envio_correo']) {
                    $seleccionado = "selected"; } else { $seleccionado = ""; }
...
<table border="1" class="table table-responsive">
    <thead>
      ...
      <tr>
        ...
        <td style="text-align:left; width:20%;"><span>.</span><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_comision" id="deduccion_comision" value="<?php echo $deduccion_comision ?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left width:20%; font-size:24px"><br><input style="font-size:24px" class="input-block-level" type="text" name="monto_deuda_alerta" id="monto_deuda_alerta" value="<?php echo $monto_deuda_alerta ?>" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left;"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_imp_cuatroxmil" id="deduccion_imp_cuatroxmil" value="<?php echo $deduccion_imp_cuatroxmil ?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left;"><input style="font-size:24px" class="input-block-level" type="text" name="ingreso_impuesto_iva" id="ingreso_impuesto_iva" value="<?php echo $ingreso_impuesto_iva ?>" min="0" size="5" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left;"><span>.</span><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_retefuente" id="deduccion_retefuente" value="<?php echo $deduccion_retefuente;?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left;"><input style="font-size:24px" class="input-block-level" type="text" name="ingreso_otro_concepto" id="ingreso_otro_concepto" value="<?php echo $ingreso_otro_concepto;?>" min="0" size="5" required></td>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_reparacion" id="deduccion_reparacion" value="<?php echo $deduccion_reparacion;?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left; width:25%">ATRASO <span id="dias_atraso"></span></td>-->
        <td style="text-align:left"></td>
        <td style="text-align:left"></td>
        <input style="font-size:24px" class="input-block-level" type="hidden" name="monto_cuota_interes" id="monto_cuota_interes" value="0" min="0" size="5" required>
        <input type="hidden" name="monto_cuota_interes_hidden" id="monto_cuota_interes_hidden" value="<?php echo $monto_cuota_interes ?>" required>
      </tr>
      <tr>
        <th style="text-align:left">OTROS IMPUESTOS (DIAN): </th>
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_otro_impuesto_dian" id="deduccion_otro_impuesto_dian" value="<?php echo $deduccion_otro_impuesto_dian;?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left"></td>
        <td style="text-align:left"></td>
        <input style="font-size:24px" class="input-block-level" type="hidden" name="ingreso_gasto_juridica" id="ingreso_gasto_juridica" value="<?php echo $ingreso_gasto_juridica ?>" min="0" size="5" required>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_servicio_energia" id="deduccion_servicio_energia" value="<?php echo $deduccion_servicio_energia;?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left"></td>
        <td style="text-align:left"></td>
        <input style="font-size:24px" class="input-block-level" type="hidden" name="ingreso_administracion_incluida" id="ingreso_administracion_incluida" value="<?php echo $ingreso_administracion_incluida;?>" min="0" size="5" required>
        <input type="hidden" name="ingreso_administracion_incluida_hidden" id="ingreso_administracion_incluida_hidden" value="" required>
      </tr>
        <input style="font-size:24px" class="input-block-level" type="hidden" name="deduccion_servicio" id="deduccion_servicio" value="<?php echo $deduccion_servicio;?>" min="0" size="5" required>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_servicio_agua" id="deduccion_servicio_agua" value="<?php echo $deduccion_servicio_agua;?>" min="0" size="5" required></td>
        ...
        <td style="text-align:left"></td>
        <td style="text-align:left"></td>
        <input style="font-size:24px" class="input-block-level" type="hidden" name="ingreso_deudas_anteriores" id="ingreso_deudas_anteriores" value="<?php echo $ingreso_deudas_anteriores;?>" min="0" size="5" required>
      ...
      <tr>
        ...
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_servicio_gas" id="deduccion_servicio_gas" value="<?php echo $deduccion_servicio_gas;?>" min="0" size="5" required></td>
        <input type="hidden" name="deduccion_servicio_gas_hidden" id="deduccion_servicio_gas_hidden" value="" required>
        <!--<th style="text-align:left">OTROS CONCEPTOS: </th>-->
        <td style="text-align:left"></td>
        <td style="text-align:left"></td>
        <input style="font-size:24px" class="input-block-level" type="hidden" name="ingreso_otro_concepto" id="ingreso_otro_concepto" value="<?php echo $ingreso_otro_concepto;?>" min="0" size="5" required>
        <input type="hidden" name="ingreso_otro_concepto_hidden" id="ingreso_otro_concepto_hidden" value="" required>
      </tr>
      <tr>
        <th style="text-align:left">DEUDAS ANTERIORES MES: </th>
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_deudas_anteriores" id="deduccion_deudas_anteriores" value="<?php echo $deduccion_deudas_anteriores;?>" min="0" size="5" required></td>
      ...
      <tr>
        <th style="text-align:left">OTROS CONCEPTOS: </th>
        <td style="text-align:left"><input style="font-size:24px" class="input-block-level" type="text" name="deduccion_otro_concepto" id="deduccion_otro_concepto" value="<?php echo $deduccion_otro_concepto;?>" min="0" size="5" required></td>
...
<table border="1" class="table table-responsive">
    <thead>
        ...
        <tr>
            ...
            <td style="text-align:center"><textarea class="input-block-level" name="mensaje" id="mensaje" rows="3" cols="20"><?php echo $mensaje;?></textarea></td>
            <td style="text-align:center">
            ...
            <td style="text-align:center"><input class="input-block-level" type="date" name="fecha_pago" id="fecha_pago" style="font-size:24px" value="<?php echo $fecha_pago_reg;?>" size="10" required></td>
        </tr>
    </thead>
</table>
...
<table border="1" class="table table-responsive">
    <thead>
        <tr>
            ...
            <input type="hidden" name="total_pagar_hidden" id="total_pagar_hidden" value="<?php echo $total_pagar;?>" required>
        </tr>
            ...
            <div style="text-align:left; width: 50%; font-size:28px;" id="total_pendiente"></div>
...
<input type="hidden" name="cod_cuentas_cobrar_factura_comision_propietario" id="cod_cuentas_cobrar_factura_comision_propietario" value="<?php echo $cod_cuentas_cobrar_factura_comision_propietario; ?>">
<input type="hidden" name="cod_cuentas_cobrar" id="cod_cuentas_cobrar" value="<?php echo $cod_cuentas_cobrar; ?>">
...
<input type="hidden" name="numero_alerta" id="numero_alerta" value="<?php echo $numero_alerta; ?>">
...
<script type="text/javascript">
$('.excluir_gasto_inmueble_detalle').on('click', function () {
    var cod_gasto_inmueble_detalle_venta = $(this).parent().attr('dataexclu');
    var cod_cuentas_cobrar_alerta = '<?php echo $cod_cuentas_cobrar_alerta; ?>';
    var tipo_ajax = "tbl15_gasto_inmueble_detalle_venta";
    var campo = "cod_gasto_inmueble_detalle_venta";
    var opcion = "exluir";
    var tipo = 'exluir';
    var parametros = { llave:cod_gasto_inmueble_detalle_venta, cod_cuentas_cobrar_alerta:cod_cuentas_cobrar_alerta, valor:cod_gasto_inmueble_detalle_venta, campo:campo, tipo_ajax:tipo_ajax, opcion:opcion, tipo:tipo };

    $.ajax({
      type: "POST",
      url: "../admin/excluir_gasto_inmueble_detalle_ajax.php",
      data: parametros,
      dataType: "json",
      //contentType: false,
      //processData: false,
      ...
      success: function(respuesta){
        ...
        var cod_cuentas_cobrar_alerta = respuesta.cod_cuentas_cobrar_alerta;
        var total_gasto = respuesta.total_gasto;
        var estado = respuesta.estado;

        $('#cod_gasto_inmueble_detalle_venta'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
        $('#tr'+cod_gasto_inmueble_detalle_venta).fadeOut("slow");
        $("#total_gasto").html(''+total_gasto);
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        ...
        var monto_cuota_interes = parseFloat($('#ingreso_deudas_anteriores').val());
        ...
        var total_deduccion = deduccion_retefuente + deduccion_reparacion + deduccion_servicio + deduccion_otro_impuesto_dian + deduccion_otro_concepto + deduccion_servicio_energia + deduccion_servicio_agua + deduccion_servicio_gas + deduccion_deudas_anteriores + deduccion_imp_cuatroxmil + deduccion_comision;
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#fecha_pago').change(function(){
        var cod_cuentas_cobrar = ($('#cod_cuentas_cobrar').val());
        var cod_cuentas_cobrar_factura_comision_propietario = ($('#cod_cuentas_cobrar_factura_comision_propietario').val());
        var fecha_pago_reg = ($('#fecha_pago').val());

        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar_fecha_pago";
        var campo = "fecha_pago_reg";

        var dataString = 'fecha_pago_reg='+fecha_pago_reg+'&'+'cod_cuentas_cobrar_factura_comision_propietario='+cod_cuentas_cobrar_factura_comision_propietario+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobrar_abonos_alquiler_comprobante_comision_propietario_ajax_reg.php",
            data: dataString,
            success: function() {           
                //$('#eliminar-ok').empty();
            }
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#monto_cuota_interes').change(function(){
        ...
        var dataString = 'cod_cuentas_cobrar='+cod_cuentas_cobrar+'&'+'cod_cuentas_cobrar_factura_comision_propietario='+cod_cuentas_cobrar_factura_comision_propietario+'&'+'monto_cuota_interes='+monto_cuota_interes+'&'+'fecha_pago_reg='+fecha_pago_reg+'&'+'deduccion_retefuente='+deduccion_retefuente+'&'+'deduccion_servicio_energia='+deduccion_servicio_energia+'&'+'deduccion_servicio_agua='+deduccion_servicio_agua+'&'+'deduccion_servicio_gas='+deduccion_servicio_gas+'&'+'deduccion_deudas_anteriores='+deduccion_deudas_anteriores+'&'+'deduccion_servicio='+deduccion_servicio+'&'+'deduccion_otro_concepto='+deduccion_otro_concepto+'&'+'ingreso_otro_concepto='+ingreso_otro_concepto+'&'+'deduccion_reparacion='+deduccion_reparacion+'&'+'ingreso_gasto_juridica='+ingreso_gasto_juridica+'&'+'deduccion_otro_impuesto_dian='+deduccion_otro_impuesto_dian+'&'+'ingreso_administracion_incluida='+ingreso_administracion_incluida+'&'+'deduccion_saldo_favor='+deduccion_saldo_favor+'&'+'ingreso_deudas_anteriores='+ingreso_deudas_anteriores+'&'+'deduccion_imp_cuatroxmil='+deduccion_imp_cuatroxmil+'&'+'deduccion_comision='+deduccion_comision+'&'+'ingreso_impuesto_iva='+ingreso_impuesto_iva+'&'+'deduccion_comision_ptj='+deduccion_comision_ptj+'&'+'total_pagar='+total_pagar+'&'+'total_pendiente='+total_pendiente+'&'+'total_deduccion='+total_deduccion+'&'+'total_ingreso='+total_ingreso+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobrar_abonos_alquiler_comprobante_comision_propietario_ajax_reg.php",
            data: dataString,
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_retefuente').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_retefuente";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_reparacion').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_reparacion";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_otro_concepto').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_otro_concepto";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_servicio_energia').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_servicio_energia";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_servicio_agua').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_servicio_agua";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_servicio_gas').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_servicio_gas";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_imp_cuatroxmil').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_imp_cuatroxmil";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_deudas_anteriores').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_deudas_anteriores";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#ingreso_otro_concepto').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "ingreso_otro_concepto";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_otro_impuesto_dian').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_otro_impuesto_dian";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#deduccion_saldo_favor').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "deduccion_saldo_favor";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#monto_deuda_alerta').change(function(){
        ...
        var ingreso_deudas_anteriores = parseFloat($('#ingreso_deudas_anteriores').val());
        var cod_cuentas_cobrar = ($('#cod_cuentas_cobrar').val());
        var cod_cuentas_cobrar_alerta = ($('#cod_cuentas_cobrar_alerta').val());
        var fecha_pago_reg = ($('#fecha_pago').val());
        ...
        var total_deduccion = deduccion_retefuente + deduccion_reparacion + deduccion_servicio + deduccion_otro_impuesto_dian + deduccion_otro_concepto + deduccion_servicio_energia + deduccion_servicio_agua + deduccion_servicio_gas + deduccion_deudas_anteriores;
        ...
        var dataString = 'cod_cuentas_cobrar='+cod_cuentas_cobrar+'&'+'cod_cuentas_cobrar_factura_comision_propietario='+cod_cuentas_cobrar_factura_comision_propietario+'&'+'monto_deuda_alerta='+monto_deuda_alerta+'&'+'monto_cuota_interes='+monto_cuota_interes+'&'+'fecha_pago_reg='+fecha_pago_reg+'&'+'deduccion_retefuente='+deduccion_retefuente+'&'+'deduccion_servicio_energia='+deduccion_servicio_energia+'&'+'deduccion_servicio_agua='+deduccion_servicio_agua+'&'+'deduccion_servicio_gas='+deduccion_servicio_gas+'&'+'deduccion_deudas_anteriores='+deduccion_deudas_anteriores+'&'+'deduccion_servicio='+deduccion_servicio+'&'+'deduccion_otro_concepto='+deduccion_otro_concepto+'&'+'ingreso_otro_concepto='+ingreso_otro_concepto+'&'+'deduccion_reparacion='+deduccion_reparacion+'&'+'ingreso_gasto_juridica='+ingreso_gasto_juridica+'&'+'deduccion_otro_impuesto_dian='+deduccion_otro_impuesto_dian+'&'+'ingreso_administracion_incluida='+ingreso_administracion_incluida+'&'+'deduccion_saldo_favor='+deduccion_saldo_favor+'&'+'ingreso_deudas_anteriores='+ingreso_deudas_anteriores+'&'+'deduccion_imp_cuatroxmil='+deduccion_imp_cuatroxmil+'&'+'deduccion_comision='+deduccion_comision+'&'+'ingreso_impuesto_iva='+ingreso_impuesto_iva+'&'+'deduccion_comision_ptj='+deduccion_comision_ptj+'&'+'total_pagar='+total_pagar+'&'+'total_pendiente='+total_pendiente+'&'+'total_deduccion='+total_deduccion+'&'+'total_ingreso='+total_ingreso+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobrar_abonos_alquiler_comprobante_comision_propietario_ajax_reg.php",
            data: dataString,
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#ingreso_administracion_incluida').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "ingreso_administracion_incluida";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#ingreso_gasto_juridica').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "ingreso_gasto_juridica";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#ingreso_deudas_anteriores').change(function(){
        ...
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar";
        var campo = "ingreso_deudas_anteriores";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#cod_tipo_forma_pago').change(function(){
        ...
        var cod_cuentas_cobrar_factura_comision_propietario = ($('#cod_cuentas_cobrar_factura_comision_propietario').val());
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar_cod_tipo_forma_pago";
        var campo = "cod_tipo_forma_pago";

        var dataString = 'cod_tipo_forma_pago='+cod_tipo_forma_pago+'&'+'cod_cuentas_cobrar_factura_comision_propietario='+cod_cuentas_cobrar_factura_comision_propietario+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobrar_abonos_alquiler_comprobante_comision_propietario_ajax_reg.php",
            data: dataString,
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('#cod_administrador').change(function(){
        var cod_administrador = $('#cod_administrador').val();
        var cod_cuentas_cobrar = ($('#cod_cuentas_cobrar').val());
        var cod_cuentas_cobrar_factura_comision_propietario = ($('#cod_cuentas_cobrar_factura_comision_propietario').val());
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar_cod_administrador";
        var campo = "cod_administrador";

        var dataString = 'cod_administrador='+cod_administrador+'&'+'cod_cuentas_cobrar_factura_comision_propietario='+cod_cuentas_cobrar_factura_comision_propietario+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobrar_abonos_alquiler_comprobante_comision_propietario_ajax_reg.php",
            data: dataString,
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    $('textarea[name="mensaje"]').change(function(){ 
        ...
        var cod_cuentas_cobrar_factura_comision_propietario = ($('#cod_cuentas_cobrar_factura_comision_propietario').val());
        var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
        var tipo = "editar_mensaje";
        var campo = "mensaje";

        var dataString = 'mensaje='+mensaje+'&'+'cod_cuentas_cobrar_factura_comision_propietario='+cod_cuentas_cobrar_factura_comision_propietario+'&'+'tab='+tab+'&'+'tipo='+tipo+'&'+'campo='+campo;
        $.ajax({
            type: "POST",
            url: "../admin/edit_cuentas_cobrar_abonos_alquiler_comprobante_comision_propietario_ajax_reg.php",
            data: dataString,
...
<script>  
 $(document).ready(function(){  
  ...
  var cod_cuentas_cobrar_factura_comision_propietario = $(this).attr('class');

  var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
  var tipo = "editar";
  var campo = "cod_estado";

  let ids = this.id;
    $.ajax({ url:"edit_estado_comision_propietario_ajax_reg.php", method:"GET", data:{valor:cod_estado, campo:"cod_estado", tab:tab, tipo:tipo, campo:campo, id:cod_cuentas_cobrar_factura_comision_propietario }, success:function(data){ $('#result').html(data); }  
    });  
  });
 });  
 </script>
...
<script>  
 $(document).ready(function(){  
  ...
  $('select[name="cod_estado_envio_correo_comision_propietario"]').change(function(){ 
  var cod_estado_envio_correo_comision_propietario = $(this).val();  
  var cod_cuentas_cobrar_factura_comision_propietario = $(this).attr('class');

  var tab = "tbl15_cuentas_cobrar_factura_comision_propietario";
  var tipo = "editar";
  var campo = "cod_estado_envio_correo_comision_propietario";

  let ids = this.id;
    $.ajax({ url:"edit_estado_comision_propietario_ajax_reg.php", method:"GET", data:{valor:cod_estado_envio_correo_comision_propietario, campo:"cod_estado_envio_correo_comision_propietario", tab:tab, tipo:tipo, campo:campo, id:cod_cuentas_cobrar_factura_comision_propietario }, success:function(data){ $('#result').html(data); }  
    });  
  });
 });  
 </script>
