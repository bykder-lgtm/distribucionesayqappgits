...
if (isset($_GET['cod_info_factura_venta'])) {
    ...
    $pagina                                                         = '../admin/ver_info_factura_venta_cerrada_siscredito_visitante_intern_revisor.php';
    ...
    /* ----------------------------------------------------------------------------------------------------------/ */
    $pagina_redirect                                                = $pagina.'?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&modo_venta_por_defecto='.$modo_venta_por_defecto.'&pagina='.$pagina;
?>
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
if ($nombre_estado_factura == 'ABIERTA') {
    $pagina_redirect_regresar = '../admin/ver_info_factura_venta_abierta_siscredito_visitante_intern_revisor.php?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&modo_venta_por_defecto='.$modo_venta_por_defecto.'&pagina='.$pagina;
} else {
    $pagina_redirect_regresar = '../admin/ver_info_factura_venta_cerrada_siscredito_visitante_intern_revisor.php?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&modo_venta_por_defecto='.$modo_venta_por_defecto.'&pagina='.$pagina;
}
?>
                    ...
                    <div class="contact-form-right">
                        <div class="row title-left">
                            ...
                            <div class="col-9 col-sm-9 col-md-9 col-lg-9 col-xl-9 col-xxl-9">
                                <div class=""><h3>Edición de Transacción - Cerrada</h3></div>
                            </div>
                    ...
                    <div class="contact-form-right">
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Lider</strong>
                                    <select name="cod_administrador_lider" id="cod_administrador_lider" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        <?php if (isset($cod_administrador_lider)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' >Selecione</option>"; }
                                        $consulta2_sql = "SELECT cod_administrador, cuenta,nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '20') ORDER BY cod_administrador ASC";
                                        ...
                                        $nombre = $datos2['nombres'].' '.$datos2['apellidos'].' | '.$datos2['cuenta'].' | '.$datos2['cod_administrador'];
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Coordinador</strong>
                                    <select name="cod_administrador_coordinador" id="cod_administrador_coordinador" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        <?php if (isset($cod_administrador_coordinador)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' >Selecione</option>"; }
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '21') OR (cod_seguridad = '20') ORDER BY cod_administrador ASC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                        if(isset($cod_administrador_coordinador) AND $cod_administrador_coordinador == $datos2['cod_administrador']) {
                                        $seleccionado = "selected"; } else { $seleccionado = ""; }
                                        $codigo = $datos2['cod_administrador'];
                                        $nombre = $datos2['nombres'].' '.$datos2['apellidos'].' | '.$datos2['cuenta'].' | '.$datos2['cod_administrador'];
                                        echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?>
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                            <div class="form-group"><strong>Asesor</strong>
                                    <select name="cod_administrador_asesor" id="cod_administrador_asesor" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        <?php if (isset($cod_administrador_asesor)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' >Selecione</option>"; }
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '22') ORDER BY cod_administrador ASC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                        if(isset($cod_administrador_asesor) AND $cod_administrador_asesor == $datos2['cod_administrador']) {
                                        $seleccionado = "selected"; } else { $seleccionado = ""; }
                                        $codigo = $datos2['cod_administrador'];
                                        $nombre = $datos2['nombres'].' '.$datos2['apellidos'].' | '.$datos2['cuenta'].' | '.$datos2['cod_administrador'];
                                        echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?>
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Aliado</strong>
                                    <select name="cod_administrador_aliado_estrategico" id="cod_administrador_aliado_estrategico" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        <?php if (isset($cod_administrador_aliado_estrategico)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' >Selecione</option>"; }
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '23') ORDER BY cod_administrador ASC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                        if(isset($cod_administrador_aliado_estrategico) AND $cod_administrador_aliado_estrategico == $datos2['cod_administrador']) {
                                        $seleccionado = "selected"; } else { $seleccionado = ""; }
                                        $codigo = $datos2['cod_administrador'];
                                        $nombre = $datos2['nombres'].' '.$datos2['apellidos'].' | '.$datos2['cuenta'].' | '.$datos2['cod_administrador'];
                                        echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?>
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Revisor</strong>
                                    <select name="cod_administrador_revisor" id="cod_administrador_revisor" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        <?php if (isset($cod_administrador_revisor)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' >Selecione</option>"; }
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '27') ORDER BY cod_administrador ASC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                        if(isset($cod_administrador_revisor) AND $cod_administrador_revisor == $datos2['cod_administrador']) {
                                        $seleccionado = "selected"; } else { $seleccionado = ""; }
                                        $codigo = $datos2['cod_administrador'];
                                        $nombre = $datos2['nombres'].' '.$datos2['apellidos'].' | '.$datos2['cuenta'].' | '.$datos2['cod_administrador'];
                                        echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?>
                    ...
                    <div class="contact-form-right">
                        <form action="../admin/reg_siscredito_tercero_cliente_simulador_por_cuotas_max_entidad_crediticia_reg.php" method="post" id="contactForm">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Cliente / Comprador <a href="#" onclick="obtener_datos_tercero_factura_venta_modal('<?php echo $cod_info_factura_venta; ?>');" data-toggle="modal" data-target=".abrir_previsualizacion_datos_tercero_factura_venta"><i class="fa fa-edit fa-2x"></i></a></strong>
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Detalle del Credito <a href="#" onclick="obtener_datos_valor_credito_factura_venta_modal('<?php echo $cod_info_factura_venta; ?>');" data-toggle="modal" data-target=".abrir_previsualizacion_datos_valor_credito_factura_venta"><i class="fa fa-edit fa-2x"></i></a></strong>
                                        <br>
...
-->
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Tienda <a href="#" onclick="obtener_datos_nuevo_tienda_factura_venta_modal('<?php echo $cod_info_factura_venta; ?>');" data-toggle="modal" data-target=".abrir_previsualizacion_datos_nuevo_tienda"><i class="fa fa-plus-circle fa-2x"></i></a></strong>
                                        <select name="cod_tienda" id="cod_tienda" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            ...
                                            $consulta2_sql = "SELECT cod_tienda, nombre_tienda FROM tbl15_tienda WHERE (cod_aliado_estrategico = '$cod_administrador_aliado_estrategico') ORDER BY cod_tienda ASC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Vendedor <a href="#" onclick="obtener_datos_nuevo_vendedor_factura_venta_modal('<?php echo $cod_info_factura_venta; ?>');" data-toggle="modal" data-target=".abrir_previsualizacion_datos_nuevo_vendedor"><i class="fa fa-plus-circle fa-2x"></i></a></strong>
                                        <select name="cod_vendedor" id="cod_vendedor" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            ...
                                            $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_tienda = '$cod_tienda') AND (cod_seguridad = '2') ORDER BY cod_administrador DESC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                            if(isset($cod_vendedor) AND $cod_vendedor == $datos2['cod_administrador']) {
                                            $seleccionado = "selected"; } else { $seleccionado = ""; }
                                            $codigo = $datos2['cod_administrador'];
                                            $nombre = $datos2['nombres'].' '.$datos2['apellidos'].' | '.$datos2['cod_administrador'];
                                            echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                                    <div class="form-group"><strong>Cuenta de Banco <a href="#" onclick="obtener_datos_nuevo_banco_cuenta_factura_venta_modal('<?php echo $cod_info_factura_venta; ?>');" data-toggle="modal" data-target=".abrir_previsualizacion_datos_nuevo_banco_cuenta"><i class="fa fa-plus-circle fa-2x"></i></a></strong>
                                        <select name="cod_banco_cuenta" id="cod_banco_cuenta" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            ...
                                            FROM tbl15_banco_cuenta WHERE (cod_aliado_estrategico = '$cod_administrador_aliado_estrategico' AND cod_estado = '1') ORDER BY cod_banco_cuenta ASC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Linea de Credito</strong>
                                        <select name="cod_entidad_crediticia" id="cod_entidad_crediticia" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            <?php if (isset($cod_entidad_crediticia)) { echo "<option value='' selected >Seleccione</option>"; } else { echo "<option value='' selected >Seleccione</option>"; }
                                            $consulta2_sql = "SELECT cod_entidad_crediticia, nombre_entidad_crediticia FROM tbl15_entidad_crediticia ORDER BY cod_entidad_crediticia ASC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                            ...
                                            $nombre = $datos2['nombre_entidad_crediticia'].' | '.$datos2['cod_entidad_crediticia'];
                                            echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Operador del Credito</strong>
                                        <select name="cod_operador_credito" id="cod_operador_credito" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            <?php if (isset($cod_operador_credito)) { echo "<option value='' selected >Seleccione</option>"; } else { echo "<option value='' selected >Seleccione</option>"; }
                                            ...
                                            $nombre = $datos2['nombre_operador_credito'].' | '.$datos2['cod_operador_credito'];
                                            echo "<option value='".$codigo."' $seleccionado >".$nombre."</option>"; } ?>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Medio de Pago Credito</strong>
                                        <select name="cod_tipo_forma_pago_operador_credito" id="cod_tipo_forma_pago_operador_credito" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            <?php if (isset($cod_tipo_forma_pago_operador_credito)) { echo "<option value='' selected >Seleccione</option>"; } else { echo "<option value='' selected >Seleccione</option>"; }
                                            $consulta2_sql = "SELECT cod_tipo_forma_pago, nombre_tipo_forma_pago FROM tbl15_tipo_forma_pago WHERE (cod_estado = '1') ORDER BY cod_tipo_forma_pago ASC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
        ...
        if ($nombre_estado_factura == 'ABIERTA') { $tabla_productos_venta = 'tbl15_venta_producto'; } else { $tabla_productos_venta = 'tbl15_venta_producto'; }
        ...
        while ($datos_venta_producto = mysqli_fetch_assoc($consulta_venta_producto)) {
            ...
            $cod_categoria                                                  = $datos_venta_producto['cod_categoria'];
            $serial1_producto                                               = $datos_venta_producto['serial1_producto'];
            $serial2_producto                                               = $datos_venta_producto['serial2_producto'];
            $incre++;
        ?>
                                            <div class="media mb-2 border-bottom">
                                                <div class="media-body"> <a href="detail.html"> <?php echo $nombre_producto ?></a>
                                                    ...
                                                    <div class="small text-muted">
                                                        <span class="mx-2">
                                                        Imei 1: <input type="text" name="serial1_producto" id="serial1_producto<?php echo $incre;?>" class="<?php echo $cod_venta_producto;?>" value="<?php echo $serial1_producto ?>">
                                                        Imei 2: <input type="text" name="serial2_producto" id="serial2_producto<?php echo $incre;?>" class="<?php echo $cod_venta_producto;?>" value="<?php echo $serial2_producto ?>">
                                                        </span>
                                                    </div>
                                                    <?php } ?>
                                                </div>
        ...
        <?php } ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <a href="<?php echo $pagina_redirect ?>" class="btn hvr-hover btn-lg btn-block" id="submit" type="submit"><div id="nombre_boton_accion">Guardar Cambios</div></a>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
