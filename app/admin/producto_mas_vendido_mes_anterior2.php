...
<table widht='80%'>
<tr>
<td align="center"><strong><a href="../admin/producto_mas_vendido_mes.php"><font size='+1' color='white'>PRODUCTOS MAS VENDIDOS DEL MES (<?php echo $fecha_mes?>)<a/> - </font><font size='+1' color='yellow'>PRODUCTOS MAS VENDIDOS MES ANTERIOR (<?php echo $fecha_mes_anterior?>)</font> - </font><a href="../admin/productos_mas_vendidos.php"><font size='+1' color='white'>PRODUCTOS MAS VENDIDOS</a></font></strong></td>
</tr>
<tr>
<td align="center"></td>
</tr>
<tr>
<td align="center"><a href="../admin/descargar_productos_mas_vendidos_csv.php?fecha_mes=<?php echo $fecha_mes_anterior?>"><img src=../imagenes/descargar.png alt="descargar"></a></td>
</tr>
</table>
...
precio_venta, fecha_mes FROM ventas WHERE fecha_mes = '$fecha_mes_anterior' GROUP BY  cod_productos ORDER BY unidades_vendidas DESC";
