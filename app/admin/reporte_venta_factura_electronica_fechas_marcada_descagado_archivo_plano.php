...
<a class="btn btn-secondary" href="../admin/reporte_venta_factura_electronica_fechas.php"><h6>Reporte Ventas Por Factura Electronica Rango de Fechas</h6></a>
<a class="btn btn-primary" href="../admin/reporte_venta_factura_electronica_fechas_marcada_descagado_archivo_plano.php"><h6>Reporte Ventas Por Factura Electronica Marcadas como Descargadas Por Archivo palno</h6></a>
...
$filtro_consulta_vendedor $filtro_consulta_tercero $filtro_consulta_tipo_pago $filtro_consulta_tipo_forma_pago $filtro_consulta_dependencia $filtro_consulta_nombre_tipo_factura 
AND (cod_estado_check_factura_electronica = '1') ORDER BY cod_factura ASC";
$consulta_total_tipo_factura = mysqli_query($conectar, $sql_total_tipo_factura) or die(mysqli_error($conectar));
...
$sql_dependencia = "SELECT nombre1_tercero, apellido1_tercero FROM tbl15_tercero WHERE cod_tercero = '$cod_tercero_db'";
$consulta_dependencia = mysqli_query($conectar, $sql_dependencia) or die(mysqli_error($conectar));
$datos_dependencia = mysqli_fetch_assoc($consulta_dependencia);
...
<!--<input name="cod_estado_escogido" class="cod_estado_escogido" id="<?php echo $cod_examen_historia_clinica_paciente ?>" type='checkbox' value='1' <?php if($cod_estado_escogido=='1'){ echo 'checked'; } ?> /> <?php echo $nombre_examen_hacer_paciente ?>
-->
