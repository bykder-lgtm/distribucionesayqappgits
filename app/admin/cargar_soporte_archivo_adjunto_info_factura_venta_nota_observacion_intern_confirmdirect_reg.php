...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formulario_de_actualizacion")) {
	...
	$pagina_redirect                                    = '../admin/checkout_visitante_intern_confirmdirect.php'.'?cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&nombre_estado_factura='.$nombre_estado_factura;
/* ----------------------------------------------------------------------------------------------------------/ */
