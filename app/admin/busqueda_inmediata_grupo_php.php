...
$cod_info_grupo_alumno          = intval($_POST['cod_info_grupo_alumno']);
...
$precio_grupo_alumno    = $matriz_consulta['precio_grupo_alumno'];
$nombre_tipo_producto     = $matriz_consulta['nombre_tipo_producto'];
?>
<td align="Left"><?php echo $cod_producto_barra; ?></td>
<td align="Left"><a href="../admin/reg_grupo_alumno_reg.php?cod_producto=<?php echo $cod_producto?>&cod_info_grupo_alumno=<?php echo $cod_info_grupo_alumno?>&foco=<?php echo $foco?>&pagina=<?php echo $pagina?>" tabindex=3><?php echo $nombre_producto ?></a></td>
<td align="right"><?php echo number_format($precio_grupo_alumno, 0, ",", "."); ?></td>
