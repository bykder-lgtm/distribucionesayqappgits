...
<style><?php include_once("../estilo_css/estilo_lista_tienda_lider.css"); ?></style>
...
$sql_conteo = "SELECT COUNT(*) as total FROM tbl15_tienda t WHERE t.cod_aliado_estrategico IN ($subquery_aliados_lider) AND t.cod_estado != '0'";
...
-->
    ...
    <div class="pagination-container animate-in delay-2">
        ...
        <a href="?pagina=<?php echo max(1, $pagina - 1); ?><?php echo $base_url_params; ?>" 
        ...
        ?>
        <a href="?pagina=<?php echo $i; ?><?php echo $base_url_params; ?>" 
           class="pagination-btn <?php echo $pagina == $i ? 'active' : ''; ?>">
            <?php echo $i; ?>
        </a>
        <?php endfor; ?>

        <a href="?pagina=<?php echo min($total_paginas, $pagina + 1); ?><?php echo $base_url_params; ?>" 
...
function applyAdvancedFilters() {
    ...
    let url = 'lista_tienda_lider_movil.php?busqueda=' + encodeURIComponent(busqueda);
    if(cod_coordinador) url += '&cod_coordinador=' + encodeURIComponent(cod_coordinador);
...
function resetAllFilters() {
    const urlParams = new URLSearchParams(window.location.search);
    const cod_coordinador = urlParams.get('cod_coordinador') || '';
    let url = 'lista_tienda_lider_movil.php';
    if(cod_coordinador) url += '?cod_coordinador=' + encodeURIComponent(cod_coordinador);
    window.location.href = url;
}
