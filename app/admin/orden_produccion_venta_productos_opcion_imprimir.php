...
$pagina                               = addslashes($_GET['pagina']).'?cod_info_orden_produccion_factura_venta='.$cod_info_orden_produccion_factura_venta;
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_info_fact = "SELECT * FROM tbl15_info_orden_produccion_factura_venta WHERE (cod_info_orden_produccion_factura_venta = '$cod_info_orden_produccion_factura_venta')";
...
Sum(total_venta_producto*(descuento_ptj/100)) AS total_desc, Sum(total_venta_producto) AS total_venta_neta FROM tbl15_orden_produccion_venta_producto 
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td align='center'><a href="../admin/ver_factura_orden_produccion_venta_pdf.php?cod_info_orden_produccion_factura_venta=<?php echo $cod_info_orden_produccion_factura_venta?>" target="_blank"><img src="../imagenes/imprimir_.png"></a></td>
  </tr>
</table>
</center>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
