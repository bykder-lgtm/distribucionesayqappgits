...
$cod_compra_producto_temporal       = $_POST['cod_compra_producto_temporal'][$i];
...
$agregar_reg_compra_producto = "INSERT INTO tbl15_compra_producto (cod_info_factura_compra, cod_tercero, cod_doc_soporte, cod_caja_virtual, 
...
check_und, chk, cod_interno, cod_proveedor, cod_original, codificacion, nombre_proveedor, tope_min, cedula, 
nombre_cliente, cod_historia_clinica, posologia_cantidad, posologia_peso, nombre_frec_duracion, nombre_via_administracion, 
...
$agregar_regis = sprintf("UPDATE tbl15_info_factura_compra SET cod_estado_factura = '$cod_estado_factura', cod_factura = '$cod_factura', fecha_anyo = '$fecha_anyo', 
...
$url_redir = "../admin/compra_productos_opcion_imprimir.php?cod_info_factura_compra=".$cod_info_factura_compra."&cod_tipo_pago=".$cod_tipo_pago."&pagina=".$pagina;
