...
//-------------------------------------- -----------------------------------------------------------------//
	if (empty($_POST['cod_gasto_inmueble_detalle_venta_temporal'])) {
	} else {
		foreach ($_POST['cod_gasto_inmueble_detalle_venta_temporal'] as $clave=>$cod_gasto_inmueble_detalle_venta_temporal) {

			$obtener_cie10diag = "SELECT * FROM tbl15_gasto_inmueble_detalle_venta_temporal WHERE (cod_gasto_inmueble_detalle_venta_temporal = '$cod_gasto_inmueble_detalle_venta_temporal')";
			...
			$cod_info_gasto_inmueble_detalle_venta = $info_cie10diag['cod_info_gasto_inmueble_detalle_venta'];

			if ($cod_tipo_estado_incluido == '0') {
				$sql_insert = "INSERT INTO tbl15_gasto_inmueble_detalle_venta (nombre_gasto_inmueble_detalle, descripcion_gasto_inmueble_detalle, precio_venta_producto, precio_compra_producto, cod_gasto_inmueble, 
				...
				cod_info_gasto_inmueble_detalle_venta) 
				...
				$borrar_sql = sprintf("DELETE FROM tbl15_gasto_inmueble_detalle_venta_temporal WHERE (cod_gasto_inmueble_detalle_venta_temporal = '$cod_gasto_inmueble_detalle_venta_temporal')");
				$Result1 = mysqli_query($conectar, $borrar_sql) or die(mysqli_error($conectar));
			}
		}
		$data_sql = ("UPDATE tbl15_info_gasto_inmueble_detalle_venta SET nombre_estado_factura2 = 'CERRADA' WHERE cod_info_gasto_inmueble_detalle_venta = '$cod_info_gasto_inmueble_detalle_venta'");
		$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

		$sql_verificar_existencia = "SELECT * FROM tbl15_gasto_inmueble_detalle_venta_temporal WHERE cod_info_gasto_inmueble_detalle_venta = '$cod_info_gasto_inmueble_detalle_venta'";
		...
		if ($existe_verificar_existencia == '0') {
			$data_sql = ("UPDATE tbl15_info_gasto_inmueble_detalle_venta SET nombre_estado_factura = 'CERRADA' WHERE cod_info_gasto_inmueble_detalle_venta = '$cod_info_gasto_inmueble_detalle_venta'");
			$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
		}
		$data_sql = ("UPDATE tbl15_gasto_inmueble_detalle_venta_temporal SET cod_tipo_estado_incluido = '0' WHERE cod_info_gasto_inmueble_detalle_venta = '$cod_info_gasto_inmueble_detalle_venta'");
		$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
	}
//-------------------------------------- -----------------------------------------------------------------//
