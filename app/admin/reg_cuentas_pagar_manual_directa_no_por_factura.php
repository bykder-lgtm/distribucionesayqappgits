...
$origen                                   = 'PARACLINICOS';
$cod_sino                                 = 2;
$nombre_modulo_puc                        = 'CUENTAS POR PAGAR';
...
<?php if ($cod_estado_movimiento_contable_cuenta_personal_global == '1') { ?>
    ...
    $(document).ready(function(){
        $("#cod_tipo_forma_pago").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: "../admin/movimiento_contable_cuenta_personal_cuenta_pagar_select_ajax.php",
                data: datos_url_ajax,
                //dataType: 'json',
                beforeSend: function(objeto){
                    $('#loader').html('<img src="../imagenes/ajax-loader.gif"> Cargando...');
...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_cuentas_pagar_directa_no_por_factura.php"><font size='+2'>REGRESAR</font></a></th>
    </tr>
</table>

<div class="table-responsive">
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/reg_cuentas_pagar_manual_directa_no_por_factura_reg.php">
<table class="table table-striped">
<thead>
