...
<?php include_once("../admin/modulo_categoria_producto_filtro_visitante_intern_confirmdirect.php"); ?>
...
while ($datos_producto = mysqli_fetch_assoc($consulta_producto)) {
    ...
    $und_producto                      = intval($datos_producto['und_producto']);
    ...
    if ($und_producto > '0') { $und_producto_text = $und_producto.' disponibles'; } else { $und_producto_text = 'Agotado'; }
                                            ...
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        ...
                                                        <?php if ($und_producto > '0') { ?>
                                                            <a class="cart" data-id="<?php echo $cod_producto_barra ?>" id="<?php echo $cod_producto_barra ?>">Agregar al Carrito</a>
                                                        <?php } else { ?>
                                                            <a href="../admin/producto_detalle_intern_confirmdirect.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>" class="cart_modif">Leer Mas</a>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <p><?php echo $und_producto_text ?></p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <?php } else { ?>
                                                        <a href="../admin/producto_detalle_intern_confirmdirect.php?cod_producto_codifcryp=<?php echo $cod_producto_codifcryp ?>" class="hvr-hover_modif">Leer Mas</a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>
...
$(document).ready(function() {
    ...
    $('.hvr-hover').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "../admin/reg_venta_temporal_producto_visitante_intern_confirmdirect_ajax_reg.php",
            data: datos_url_ajax,
