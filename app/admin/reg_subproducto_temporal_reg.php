...
if (isset($_GET['cod_producto_barra'])) {
	...
	$pagina                             = '../admin/subproducto_temporal_producto_manual_pos.php'."?&cod_info_factura_subproducto=".$cod_info_factura_subproducto."&foco=".$foco."&buscar_por=".$buscar_por."&pagina=subproducto_temporal_producto_manual_pos.php";
