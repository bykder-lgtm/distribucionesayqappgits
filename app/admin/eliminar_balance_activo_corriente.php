...
if ((isset($_GET['cod_activo_corriente'])) && ($_GET['cod_activo_corriente'] != "")) {

$cod_activo_corriente            = intval($_GET["cod_activo_corriente"]);
$cod_balance_general             = intval($_GET["cod_balance_general"]);

$borrar_sql = ("DELETE FROM tbl15_activo_corriente WHERE cod_activo_corriente = '$cod_activo_corriente'");
