...
if (isset($_GET['pagina'])) { $pagina = addslashes($_GET['pagina']); } else { $pagina = 'facturacion_compra_iva_inc_temporal_producto_manual_pos_vendedor.php'; }
?>
<br>

<table class="table table-striped">
    <tr>
        <!--<th style="text-align:center"><a href="../admin/facturacion_compra_iva_inc_temporal_producto_manual_pos_vendedor.php"><font size='+1'>Lista Factura Compra Abierta</font></a></th>-->
        <?php if ($cod_estado_cargar_archivo_plano_externo_factura_compra_global == '1') { ?><th style="text-align:center"><a href="../admin/subir_archivo_plano_externo_copidrogas_factura_compra_vendedor.php"><font size='+1'>Cargar Por Archivo Plano Externo</font></a></th><?php } ?>
<!--
...
<?php if ($cod_estado_facturacion_compra == '1') { ?><td style="text-align:center;"><a href="../admin/entrar_sesion_caja_virtual_factura_compra_vendedor.php?cod_info_factura_compra=<?php echo $cod_info_factura_compra ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual_db ?>&cod_base_caja=<?php echo $cod_base_caja ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/ver.png" class="img-polaroid" alt=""></a></td><?php } ?>
