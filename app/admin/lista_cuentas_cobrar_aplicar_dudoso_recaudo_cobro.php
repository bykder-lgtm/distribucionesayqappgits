...
<h4>Cuentas por Cobrar Aplicar Dudoso Recaudo</h4>
<?php } ?>
</div>
<hr>
<div class="row-fluid">
...
$tab2                              = 'tbl15_cuentas_cobrar_archivar_por_tercero_dudoso_recaudo';
$campo                             = 'cod_tercero';
$tipo                              = 'eliminar';
...
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar.cod_tercero WHERE (tbl15_cuentas_cobrar.cod_estado_archivado = '0')";
...
<table class="table table-striped">
	<tr>
		<form action="../admin/lista_cuentas_cobrar_aplicar_dudoso_recaudo_cobro.php" method="post">
...
<thead>
	<tr>
		...
		<th style="text-align:center">APLICAR DUDOSO RECAUDO</th>
		<?php } ?>
...
if (isset($_POST['palabra'])) { 
		...
		WHERE (tbl15_tercero.nombre1_tercero LIKE '%$palabra%') OR (tbl15_tercero.apellido1_tercero LIKE '%$palabra%') AND (tbl15_cuentas_cobrar.cod_estado_archivado = '0') 
	...
	?>
		<tr>
			<?php if ($cod_estado_cuenta_cobrar_dudoso_recaudo_global == '1') { ?>
				<td style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_tercero; ?>&tab=<?php echo $tab2; ?>&campo=<?php echo $campo; ?>&tipo=<?php echo $tipo; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/btn_archivar.png" class="img-polaroid" alt=""></a></td>
			<?php } ?>
			<td><font size='4'><a href="../admin/cuentas_cobrar_detalle_factura_aplicar_dudoso_recaudo_cobro.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $identificacion_tercero;?></a></font></td>
			<td><font size='4'><a href="../admin/cuentas_cobrar_detalle_factura_aplicar_dudoso_recaudo_cobro.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $cliente;?></a></font></td>
