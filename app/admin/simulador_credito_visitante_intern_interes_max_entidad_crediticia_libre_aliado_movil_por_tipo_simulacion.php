...
?>
    ...
    <main class="container pb-5 mb-5">
        ...
        <div class="simulador-card-movil"><div class="info-text"><i class="fa fa-info-circle"></i>Completa los datos para simular tu crédito y conocer las cuotas mensuales.</div>
            ...
            <form name="formulario_de_actualizacion" method="POST" autocomplete="off" action="../admin/simulador_credito_producto_visitante_intern_interes_max_entidad_crediticia_resultado_get_movil_por_tipo_simulacion.php">
                <div class="form-group-simulador">
                    ...
                    <label for="precio_venta_producto_formateado" id="label_precio_producto"><i class="fa fa-dollar-sign"></i>Valor del producto (Contado) *</label>
...
// Cambiar texto del label según el tipo de simulación
const selectTipoSimulacion = document.getElementById('cod_tipo_simulacion_credito');
const labelPrecioProducto = document.getElementById('label_precio_producto');

selectTipoSimulacion.addEventListener('change', function() {
    const valorSeleccionado = this.value;
    if (valorSeleccionado === '1') {
        labelPrecioProducto.innerHTML = '<i class="fa fa-dollar-sign"></i>Valor del producto (Contado) *';
    } else if (valorSeleccionado === '2') {
        labelPrecioProducto.innerHTML = '<i class="fa fa-dollar-sign"></i>Valor del producto (Credito) *';
    }
});
