...
<table class="table table-striped" cellspacing="0" cellpadding="20">
  ...
  <tr>
    ...
    <td style="text-align:left;">
      <select name="cod_producto_barra[]" id="cod_producto_barra" data-placeholder="Productos" class="chosen-select" multiple tabindex="4" required>
...
if ($cod_administrador==0) {
  ...
  $porcentaje_ganancia_promedio = (($total_ganancia / $total_suma_venta_producto) * 100);
...
<table class="table table-striped">
  <tr>
    ...
    <th style="text-align:center;"><a href="#">%Ganancia Promedio</th>
  ...
  <tr>
    ...
    <td style="text-align:center;"><?php echo number_format($porcentaje_ganancia_promedio, 0, ",", ".") ?>%</td>
...
if ($cod_administrador==0) {
  ...
  WHERE (tbl15_venta_producto.fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') $filtro_cod_producto_barra
...
?>
    <tr>
      ...
      <?php if ($cod_estado_reporte_venta_total_ganancia==1) { ?>
      <td style="text-align:right"><?php echo number_format($total_ganancia_venta, 0, ",", ".")?></td>
      <td style="text-align:right"><?php echo intval($porcentaje_ganancia_venta)?>%</td>
      <?php } ?>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  <tr>
      <th style="text-align: center; width: 98%; font-family: Courier; font-size:8pt;">REPORTE DE VENTA POR PRODUCTO</th>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;">Total Venta Contado:</th>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;"><?php echo number_format($total_venta_producto_contado, 0, ",", ".") ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;">Total Venta Credito:</th>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;"><?php echo number_format($total_venta_producto_credito, 0, ",", ".") ?></th>
  </tr>
<?php if ($cod_seguridad==1) { ?>
  <tr>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;">Total Ganancia:</th>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;"><?php echo number_format($total_ganancia, 0, ",", ".") ?></th>
  </tr>
  <tr>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;">Total Comision:</th>
    <th style="text-align: left; width: 48%; font-family: Courier; font-size:8pt;"><?php echo number_format($total_comision_venta, 0, ",", ".") ?></th>
  </tr>
<?php } ?>
</table>
