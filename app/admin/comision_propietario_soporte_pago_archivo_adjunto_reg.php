...
$pagina_redirect                                    = $pagina.'?cod_cuentas_cobrar='.$cod_cuentas_cobrar.'&cod_cuentas_cobrar_alerta='.$cod_cuentas_cobrar_alerta.'&cod_factura='.$cod_factura.'&numero_alerta='.$numero_alerta.'&cod_tercero='.$cod_tercero.'&cliente='.$cliente.'&pagina='.$pagina.'&palabra='.$palabra;
...
$nombre_normal2                                     = $fecha_ymdHis.'_'.$cod_cuentas_cobrar.'_'.$cod_tercero.'_'.$cod_cuentas_cobrar_alerta.'_'.$cod_cuentas_cobrar_factura_comision_propietario.'.'.$formato_img2;
...
//-------------------------------------- -----------------------------------------------------------------//
//-------------------------------------- -----------------------------------------------------------------//
$actualizar_sql1 = "UPDATE tbl15_cuentas_cobrar_factura_comision_propietario SET url_img_orig_producto = '$url_img_orig_producto', url_img_min_producto = '$url_img_min_producto' 
