...
<a href="#"><h4>Registrar Solicitud de Arriendo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_solicitud_arriendo_inquilino.php">Lista de Solicitud de Arriendo</h4></a>
</div>
<hr>
<div class="row-fluid">
...
$fecha_solicitud_arriendo  = date("Y-m-d");

$sql_cliente = "SELECT MAX(cod_solicitud_arriendo) AS cod_solicitud_arriendo FROM tbl15_tercero";
...
$cod_solicitud_arriendo           = $info_cliente['cod_solicitud_arriendo'] + 1;
?>
<form name="formulario_insersion" accept-charset="utf-8" method="post" action="../admin/reg_solicitud_arriendo_inquilino_reg.php">
<fieldset>
	...
	<tbody>
    	...
    	<tr>
			<td>
				...
				<?php $sql_consulta = "SELECT * FROM tbl15_tipo_tercero WHERE ((nombre_tipo_tercero = '$nombre_tipo_tercero') OR (nombre_tipo_tercero = 'AMBOS')) AND (cod_estado = '1')";
    	...
    	<tr>
			<td><input class="input-block-level" name="nombre1_tercero" type="text" value="" required/></td>
...
<table border="1" class="table table-responsive">
	<tbody>
		...
		<tr>
			<td>
				<select id="select_nombre_tipo_solicitud" name="nombre_tipo_solicitud" class="input-block-level"  style="font-size:20px">
				<?php $sql_consulta = "SELECT * FROM tbl15_tipo_solicitud WHERE (cod_estado = '1')";
				$resultado = mysqli_query($conectar, $sql_consulta);
				while ($contenedor = mysqli_fetch_assoc($resultado)) { 
				$cod_tipo_solicitud = $contenedor['cod_tipo_solicitud'];
				$nombre_tipo_solicitud = $contenedor['nombre_tipo_solicitud'];
				?>
				<option value="<?php echo $nombre_tipo_solicitud ?>"><?php echo $nombre_tipo_solicitud ?></option>
				<?php } ?>
				</select>
			</td>
			...
			<td>
				<select id="nombre_tipo_producto" name="nombre_tipo_producto" class="input-block-level"  style="font-size:20px">
				<?php $sql_consulta = "SELECT cod_tipo_producto, nombre_tipo_producto FROM tbl15_tipo_producto WHERE (cod_estado = '1') ORDER BY cod_tipo_producto ASC";
				$resultado = mysqli_query($conectar, $sql_consulta);
				while ($contenedor = mysqli_fetch_assoc($resultado)) { 
				$cod_tipo_producto = $contenedor['cod_tipo_producto'];
				$nombre_tipo_producto = $contenedor['nombre_tipo_producto'];
				?>
				<option value="<?php echo $nombre_tipo_producto ?>"><?php echo $nombre_tipo_producto ?></option>
				<?php } ?>
				</select>
			</td>
			<td><input style="font-size:24px" class="input-block-level" name="tiempo_contrato_solicitud_arriendo" type="number" value="" required/></td>
			<td>
				<input style="font-size:24px" class="input-block-level" name="valor_solicitud_arriendo" id="valor_solicitud_arriendo" text="number" value="" required/>
				<input style="font-size:24px" class="input-block-level" name="valor_solicitud_arriendo_hidden" id="valor_solicitud_arriendo_hidden" type="hidden" value=""/>
			</td>
