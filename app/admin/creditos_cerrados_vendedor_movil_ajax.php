...
// escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sWhere = " WHERE (tbl15_info_factura_venta.cod_vendedor = '$cod_administrador') AND (tbl15_info_factura_venta.nombre_estado_factura = 'CERRADA')";
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = " WHERE (tbl15_info_factura_venta.cod_vendedor = '$cod_administrador') AND (tbl15_info_factura_venta.nombre_estado_factura = 'CERRADA') AND ( ";
