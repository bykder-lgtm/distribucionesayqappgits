...
FROM tbl15_cliente RIGHT JOIN tbl15_historia_clinica ON tbl15_cliente.cod_cliente = tbl15_historia_clinica.cod_cliente ORDER BY tbl15_historia_clinica.fecha_reg_time DESC";
