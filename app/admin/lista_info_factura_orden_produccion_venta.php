...
<td id="edit<?php echo $cod_info_orden_produccion_factura_venta;?>" style="text-align:center"><a href="../admin/edit_facturacion_orden_produccion_venta_producto_manual_pos.php?cod_info_orden_produccion_factura_venta=<?php echo $cod_info_orden_produccion_factura_venta ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
