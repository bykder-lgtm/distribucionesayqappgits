...
if ($cod_dependencia==0) {
	...
	$nombre_tipo_inventario             = "PARCIAL";
}
//*************************************************************************************************************************//
if (isset($_POST['si'])) {
...
fecha_copia_inventario, hora_copia_inventario, cod_administrador, fecha_creacion, nombre_tipo_inventario, nombre_letra_alfabeto, cod_factura) 
