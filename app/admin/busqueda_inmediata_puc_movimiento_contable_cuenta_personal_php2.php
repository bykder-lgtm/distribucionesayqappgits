...
?>
	...
	?>
		<tr>
			...
			<td style="text-align:left;"><a href="../admin/reg_movimiento_contable_cuenta_personal_reg.php?cod_puc=<?php echo $cod_puc?>&codigo_puc=<?php echo $codigo_puc?>&nombre_modulo_puc=<?php echo $nombre_modulo_puc?>&cod_tipo_forma_pago=<?php echo $cod_tipo_forma_pago?>&pagina=<?php echo $pagina?>"><?php echo $nombre_puc ?></a></td>
