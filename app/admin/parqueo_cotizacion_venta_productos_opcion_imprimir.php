...
$pagina                               = addslashes($_GET['pagina']).'?cod_info_parqueo_cotizacion_factura_venta='.$cod_info_parqueo_cotizacion_factura_venta;
...
$cod_info_factura_strpad   = str_pad($cod_info_parqueo_cotizacion_factura_venta, 6, "0", STR_PAD_LEFT);
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$resta                               = 1516399999;
$time_seg                            = time();
...
$("#codigo_codabar_php").html('<img src="class_php\\barcode.php?text='+cod_factura_strpad+'&size=30&codetype=Code128&print=false"/>');
...
<table class="table table-striped">
  ...
  <tr>
    <td><font color='black' size= "+3">FACTURA DE INGRESO DE PARQUEO NO:</font></td>
  ...
  <tr>
    <td><font color='black' size= "+3">TOTAL SERVICIO DE PARQUEO:</font></td>
  ...
  <tr>
    ...
    <td align='center'><a href="../admin/ver_factura_parqueo_cotizacion_venta_pdf.php?cod_info_parqueo_cotizacion_factura_venta=<?php echo $cod_info_parqueo_cotizacion_factura_venta?>" target="_blank"><img src="../imagenes/imprimir_.png"></a></td>
  </tr>
</table>
</center>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:11pt;">
<tr>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:11pt;">
<tr>
<td style="text-align: center; width: 99%; font-family: Courier; font-size:11pt;"><strong><?php echo $nombre_emp; ?></strong></td>
</tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:11pt;">
<tr>
<td style="text-align: center; width: 99%; font-family: Courier; font-size:11pt;"><strong><?php echo $localidad_emp; ?></strong></td>
</tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:11pt;">
<tr>
<td style="text-align: center; width: 99%; font-family: Courier; font-size:11pt;"><strong>NIT: <?php echo $nit_empresa_emp; ?></strong></td>
</tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:11pt;">
<tr>
<td style="text-align: center; width: 99%; font-family: Courier; font-size:11pt;"><strong>DIRECCION: <?php echo $direccion_emp; ?></strong></td>
</tr>
</table>

<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:11pt;">
<tr>
<td style="text-align: center; width: 99%; font-family: Courier; font-size:11pt;"><strong>TELEFONO: <?php echo $telefono_emp; ?></strong></td>
</tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:10pt;">
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:10pt;"><strong>TICKET DE INGRESO DE PARQUEO #: <?php echo $cod_factura; ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:10pt;"><strong>NOMBRE CLIENTE: <?php echo utf8_decode($nombre_cliente); ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:10pt;"><strong>USUARIO: <?php echo $usario_vendedor; ?></strong></td>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="2" style="font-family: Courier; font-size:10pt;">
...
$fecha_hora_parqueo_ini            = $info_venta['fecha_hora_parqueo_ini'];
$fecha_ymd_parqueo_fin             = $info_venta['fecha_ymd_parqueo_fin'];
$fecha_hora_parqueo_fin            = $info_venta['fecha_hora_parqueo_fin'];
?>
<tr>
<td style="text-align: left; width:10%; font-family: Courier; font-size:10pt;"><strong>PLACA</strong></td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:10pt;"><strong>OBSERVACION</strong></td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:10pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:10%; font-family: Courier; font-size:10pt;"><?php echo $placa_producto ?></td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:10pt;"><?php echo $comentario_producto ?></td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:10pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:10pt;">---------</td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:10pt;">----------------------------------</td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:10pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:10pt;"><strong>TOTAL A PAGAR</strong></td>
<td style="text-align: center; width:15%; font-family: Courier; font-size:10pt;"><strong>FECHA | HORA INGRESO</strong></td>
<td style="text-align: left; width:5%; font-family: Courier; font-size:10pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:10pt;"><?php echo number_format($total_venta_producto, 0, ",", ".") ?></td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:10pt;"><?php echo $fecha_ymd_parqueo_ini.' | '.$fecha_hora_parqueo_ini ?></td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:10pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:10pt;">---------</td>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:10pt;">
  <tr>
    <td style="text-align: center; width: 98%; font-family: Courier; font-size:10pt;"><div id="codigo_codabar_php"></div></td>
  </tr>
  <tr>
    <td style="text-align: center; width: 98%; font-family: Courier; font-size:10pt;"><strong>Software <?php echo $titulo_emp ?> Version <?php echo $version_emp ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: center; width: 98%; font-family: Courier; font-size:10pt;"><strong><?php echo $desarrollador_emp ?> : <?php echo $pag_desarrollador_emp ?></strong></td>
  </tr>
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:10pt;"><strong><?php echo $fecha.$hora.'-'.$cod_factura.'-'.$cod_info_parqueo_cotizacion_factura_venta.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_cotiz_parq</td>
  </tr>
</table>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>TICKET DE INGRESO DE PARQUEO #: <?php echo $prefijo_resolucion_facturacion.' '.$cod_factura; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="text-align: left; width: 98%; font-family: Courier; font-size:8pt;"><strong>USUARIO: <?php echo $usario_vendedor; ?></strong></td>
  </tr>
</table>
...
?>
<tr>
<td style="text-align: left; width:10%; font-family: Courier; font-size:8pt;"><strong>PLACA</strong></td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:8pt;"><strong>OBSERVACION</strong></td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:8pt;"></td>

</tr>
<tr>
<td style="text-align: left; width:10%; font-family: Courier; font-size:8pt;"><?php echo $placa_producto ?></td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:8pt;"><?php echo $comentario_producto ?></td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:8pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:8pt;">---------</td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:8pt;">----------------------------------</td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:8pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:8pt;"><strong>TOTAL A PAGAR</strong></td>
<td style="text-align: center; width:15%; font-family: Courier; font-size:8pt;"><strong>FECHA | HORA INGRESO</strong></td>
<td style="text-align: left; width:5%; font-family: Courier; font-size:8pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:8pt;"><?php echo number_format($total_venta_producto, 0, ",", ".") ?></td>
<td style="text-align: center; width:80%; font-family: Courier; font-size:8pt;"><?php echo $fecha_ymd_parqueo_ini.' | '.$fecha_hora_parqueo_ini ?></td>
<td style="text-align: right; width:5%; font-family: Courier; font-size:8pt;"></td>
</tr>
<tr>
<td style="text-align: left; width:15%; font-family: Courier; font-size:8pt;">---------</td>
...
<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Courier; font-size:8pt;">
  ...
  <tr>
    <td style="text-align: center; width: 99%; font-family: Courier; font-size:8pt;"><strong><?php echo $fecha.$hora.'-'.$cod_factura.'-'.$cod_info_parqueo_cotizacion_factura_venta.'-'.$fecha_venta_ymd.$hora_venta_his ?></strong>_imp_cotiz_parq</td>
  </tr>
</table>
<?php } ?>
<!--</div>-->
...
<script>  
 $(document).ready(function(){  
  ...
  var cod_info_parqueo_cotizacion_factura_venta = <?php echo $cod_info_parqueo_cotizacion_factura_venta ?>;  
    $.ajax({ url:"imprimir_factura_parque_cotizacion_venta_ticket_pos.php", method:"GET", data:{cod_info_parqueo_cotizacion_factura_venta:cod_info_parqueo_cotizacion_factura_venta, campo:"cod_info_parqueo_cotizacion_factura_venta", id:cod_info_parqueo_cotizacion_factura_venta }, 
