...
if (isset($_GET['cod_nota_observacion'])) {
    ...
    ?>
        <!-- Start Cart  -->
    <form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/soporte_por_cargar_info_factura_venta_cliente_siscredito_visitante_intern_reg.php">
