...
<h4>Cuentas por Cobrar Archivados</h4>
<?php } ?>
</div>
<hr>
<div class="row-fluid">
...
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar.cod_tercero WHERE (tbl15_cuentas_cobrar.cod_estado_archivado = '1')";
...
if (isset($_POST['palabra'])) { 
		...
		WHERE (tbl15_tercero.nombre1_tercero LIKE '%$palabra%') OR (tbl15_tercero.apellido1_tercero LIKE '%$palabra%') AND (tbl15_cuentas_cobrar.cod_estado_archivado = '1') 
	...
	?>
		<tr>
			...
			<?php } ?>
			<td><font size='4'><a href="../admin/cuentas_cobrar_detalle_factura_archivados.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $identificacion_tercero;?></a></font></td>
			<td><font size='4'><a href="../admin/cuentas_cobrar_detalle_factura_archivados.php?cod_tercero=<?php echo $cod_tercero; ?>"><?php echo $cliente;?></a></font></td>
