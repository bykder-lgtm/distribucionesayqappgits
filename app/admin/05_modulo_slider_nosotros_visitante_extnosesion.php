<section id="main-slider_css_slider" class="no-margin_css_slider">
    <div class="carousel slide">
        ...
        ?>
        <div class="item <?php echo $active_banner_slider ?>" style="background-image: url(<?php echo $url_img_banner_slider_orig ?>)">
            <div class="container">
                <div class="row slide-margin">
                    <div class="col-sm-6">
                        <div class="carousel-content">
                            ...
                            <a class="btn-slide animation animated-item-3" href="#"><?php echo $texto_boton_accion_banner_slider ?></a>
                    ...
                    <div class="col-sm-6 hidden-xs animation animated-item-4">
                        <div class="slider-img">
                            <img src="<?php echo $url_personaje_banner_slider ?>" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
