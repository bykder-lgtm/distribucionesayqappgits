...
<a class="btn btn-danger" href="../admin/productos_mas_vendidos.php">MAS VENDIDOS</a> - 
...
FROM tbl15_venta_producto GROUP BY cod_producto_barra ORDER BY und_venta DESC LIMIT 0,500";
