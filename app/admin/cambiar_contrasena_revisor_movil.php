...
?>
<!-- **************************************************** MODULO DE SESION ******************************************** -->
<?php include_once("../admin/01_admin_modulo_inicio_sesion_adm_revisor.php"); ?>
<!-- **************************************************** MODULO DE SESION ******************************************** -->
<?php include_once("../admin/01_admin_modulo_info_empresa_adm_revisor.php"); ?>
...
<head>
    ...
    <style>
        /* ============================================ */
        /* CAMBIAR PASSWORD revisor - TEMA VERDE ESMERALDA */
        /* ============================================ */
...
<main class="page-container">
    ...
    <div class="page-header animate-in">
        <h1>
            <button class="back-btn" onclick="window.location.href='dashboard_revisor_movil.php'">
...
<!-- Bottom Navigation -->
<?php include_once("../menu/05_modulo_menu_visitante_intern_revisor.php"); ?>
...
<script>
    ...
    $(document).ready(function() {
        $('#formPassword').on('submit', function(e) {
            ...
            $.ajax({
                url: 'cambiar_contrasena_revisor_ajax.php',
                type: 'POST',
                data: $(this).serialize(),
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = 'dashboard_revisor_movil.php';
                        });
