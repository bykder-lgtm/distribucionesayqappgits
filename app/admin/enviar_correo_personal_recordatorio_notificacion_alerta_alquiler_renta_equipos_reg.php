...
// ------------------------------------------------------------------------------------------------------------------------- //
  ...
  $nombre_emisor                              = "Alertas Alquiler y Rentas de Equipos ".ucwords(strtolower($nombre_emp));
  ...
  $nombre_tipo_asunto                         = 'Alquiler y Rentas de Equipos';
  $asunto_emisor_parte_superior               = $titulo_emp;
  $asunto_correo_enviar                       = "Alertas Alquiler y Rentas de Equipos - ".ucwords(strtolower($nombre_emp)).' - '.$nombre_tipo_asunto;
//-----------------------------------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------------------------------//
  $mensaje = "
  ...
  * { line-height: inherit; }
  ...
  <thead>
    <tr>
      <th style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>TERCERO</th>
      <th style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'></th>
      <th style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>VALOR</th>
      <th style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>FECHA INICIO</th>
      <th style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>FECHA FINAL</th>
  ...
  $fecha_vencimiento_ref                           = date('Y-m-d', strtotime($fecha_hoy.' +5 days'));

  $mostrar_datos_sql = "SELECT * FROM tbl15_info_factura_venta WHERE (fecha_fin_renta_alquiler BETWEEN '$fecha_hoy' AND '$fecha_vencimiento_ref') AND (nombre_estado_factura = 'CERRADA') AND (cod_estado_alquiler_renta = '1') AND (fecha_entrega_renta_alquiler = '') ORDER BY fecha_fin_renta_alquiler ASC";
  ...
  $mensaje .= "
    <tr>
      <td style='text-align:left; color: #ffffff; font-size: 12px; line-height: 16.8px;'>".$nombres_apellidos_tercero."</td>
      <td style='text-align:left; color: #ffffff; font-size: 12px; line-height: 16.8px;'>".$nombre_producto_concat."</td>
      <td style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>".number_format($total_precio_venta, 0, ",", ".")."</td>
      <td style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>".$fecha_ini_renta_alquiler."</td>
      <td style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>".$fecha_fin_renta_alquiler."</td>
      <td style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>".$titulo_alerta."</td>
      <td style='text-align:center; color: #ffffff; font-size: 12px; line-height: 16.8px;'>".$cod_info_factura_venta."</td>
    </tr>
  ";
  }
  $mensaje .= "
  ...
  if ($total_reg <> '0') {
    ...
    $nombre_tipo_modulo_envio_correo      = "NOTIFICACION - EDITAXE POS";
    $id_origen_correo                     = "";
    $nombre_tabla_origen_correo           = "tbl15_info_factura_venta";
    $nombre_campo_origen_correo           = "cod_info_factura_venta";
    $nombre_origen_correo                 = "Recordatorio Alquiler y Renta";
