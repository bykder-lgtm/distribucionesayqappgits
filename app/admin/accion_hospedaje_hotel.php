...
*/
                            ...
                            <div class="m-n2">
                                ...
                                <div class="col-sm-12 col-xl-6">
                                    <div class="bg-secondary rounded h-100 p-4">
                                        <form name="formulario" method="post" enctype="multipart/form-data" action="../admin/accion_hospedaje_hotel_reg.php">
                                            ...
                                            <div class="row text-white text-center">
                                                <div class="col-6 bg-success border" style="text-align: center;">Fecha Ingreso</div>
                                                <div class="col-6 bg-success border" style="text-align: center;">Fecha Salida</div>
                                            </div>
                                            <div class="row text-white text-center">
