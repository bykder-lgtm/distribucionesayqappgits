...
$datos_info = "SELECT * FROM tbl15_info_factura_mantenimiento WHERE (cod_estado_factura = '1') AND (cuenta = '$cuenta_actual')";
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_historia_clinica') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_historia_clinica         = intval($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_historia_clinica = '$cod_historia_clinica' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_historia_clinica = '$cod_historia_clinica' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_anyo') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET fecha_ymd_venta_producto = '$fecha_ymd_venta_producto', fecha_mes_venta_producto = '$fecha_mes_venta_producto', 
...
$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET fecha_anyo = '$fecha_anyo', fecha_dia = '$fecha_dia', fecha_mes = '$fecha_mes', anyo = '$anyo' 
WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_moneda') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$nombre_tipo_moneda           = addslashes($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET nombre_tipo_moneda = '$nombre_tipo_moneda' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_factura') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$nombre_tipo_factura         = addslashes($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET nombre_tipo_factura = '$nombre_tipo_factura' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_forma_pago') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$nombre_tipo_forma_pago         = addslashes($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET nombre_tipo_forma_pago = '$nombre_tipo_forma_pago' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_forma_pago') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_tipo_forma_pago                = intval($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_tipo_forma_pago = '$cod_tipo_forma_pago' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_tipo_forma_pago = '$cod_tipo_forma_pago' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tipo_pago') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_tipo_pago                      = intval($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_tipo_pago = '$cod_tipo_pago' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_tipo_pago = '$cod_tipo_pago' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_tercero') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_tercero                        = intval($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_tercero = '$cod_tercero' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_tercero = '$cod_tercero' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_administrador') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_administrador                  = intval($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_administrador = '$cod_administrador' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_administrador = '$cod_administrador' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_moneda') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET nombre_tipo_moneda = '$nombre_tipo_moneda' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_factura') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET nombre_tipo_factura = '$nombre_tipo_factura' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
}


// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_cliente') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$cod_cliente                  = intval($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_cliente = '$cod_cliente' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_empresa') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
...
$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_empresa = '$cod_empresa', cod_cliente = '$cod_cliente', nombre_empresa = '$nombre_empresa', razonsocial_empresa = '$razonsocial_empresa' 
	WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
?>
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_tipo_producto') && ($tipo_ajax=='tbl15_info_factura_mantenimiento')) {
$nombre_tipo_producto         = addslashes($_POST['valor']);
$cod_info_factura_venta             = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET nombre_tipo_producto = '$nombre_tipo_producto' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_factura') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$cod_factura                  = addslashes($_POST['valor']);
$cod_info_factura_venta       = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_factura = '$cod_factura' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_factura = '$cod_factura' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_cufe') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$cod_cufe                     = addslashes($_POST['valor']);
$cod_info_factura_venta       = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_info_factura_mantenimiento SET cod_cufe = '$cod_cufe' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_cufe = '$cod_cufe' WHERE cod_info_factura_venta = '$cod_info_factura_venta'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
// ------------------------------------------------------------------------------------------------- //
if (($campo=='cod_producto_barra') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$cod_producto_barra           = addslashes($_POST['valor']);
$cod_venta_producto           = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET cod_producto_barra = '$cod_producto_barra' WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_producto') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$nombre_producto              = addslashes(strtoupper($_POST['valor']));
$cod_venta_producto           = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET nombre_producto = '$nombre_producto' WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='comentario_producto') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$comentario_producto          = addslashes($_POST['valor']);
$cod_venta_producto           = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET comentario_producto = '$comentario_producto' WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_venta') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$und_venta                    = addslashes($_POST['valor']);
$cod_venta_producto           = intval($_POST['id']);
...
FROM tbl15_mantenimiento_producto WHERE cod_venta_producto = '$cod_venta_producto'";
$resultado_datos = mysqli_query($conectar, $sql_datos);
$info_datos = mysqli_fetch_assoc($resultado_datos);
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET und_venta = '$und_venta', total_costo_producto = '$total_costo_producto', total_compra_producto = '$total_compra_producto' , total_venta_producto = '$total_venta_producto'
...
if ($cod_tipo_pago == '2') {
$sql_total_deuda_credito = "SELECT SUM(total_venta_producto) AS monto_deuda FROM tbl15_mantenimiento_producto WHERE (cod_info_factura_venta = '$cod_info_factura_venta')";
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='precio_venta_producto') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$precio_venta_producto        = intval($_POST['valor']);
$cod_venta_producto           = intval($_POST['id']);

$datos_info_temporal = "SELECT und_venta FROM tbl15_mantenimiento_producto WHERE (cod_venta_producto = '$cod_venta_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET precio_venta_producto = '$precio_venta_producto', total_venta_producto = '$total_venta_producto'
WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_audiometria') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$und_audiometria              = intval($_POST['valor']);
$cod_venta_producto           = intval($_POST['id']);

$datos_info_temporal = "SELECT precio_venta_producto FROM tbl15_mantenimiento_producto WHERE (cod_venta_producto = '$cod_venta_producto')";
$consulta_info_temporal = mysqli_query($conectar, $datos_info_temporal) or die(mysqli_error($conectar));
$info_temporal = mysqli_fetch_assoc($consulta_info_temporal);
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET und_audiometria = '$und_audiometria', total_venta_audiometria = '$total_venta_audiometria',  
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_optometria') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET und_optometria = '$und_optometria', total_venta_optometria = '$total_venta_optometria',  
total_venta_producto = '$total_venta_producto' WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='und_electrocardiograma') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
...
$data_sql = ("UPDATE tbl15_mantenimiento_producto SET und_electrocardiograma = '$und_electrocardiograma', total_venta_electrocardiograma = '$total_venta_electrocardiograma',  
total_venta_producto = '$total_venta_producto' WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
...
// ------------------------------------------------------------------------------------------------- //
if (($campo=='nombre_cliente') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$nombre_cliente               = addslashes(strtoupper($_POST['valor']));
$cod_venta_producto           = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET nombre_cliente = '$nombre_cliente' WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));

if ( mysqli_affected_rows($conectar) > 0) { echo "AFECTADO SI"; } else { echo "AFECTADO NO"; }
}
// ------------------------------------------------------------------------------------------------- //
if (($campo=='fecha_alerta') && ($tipo_ajax=='tbl15_mantenimiento_producto')) {
$fecha_alerta                = addslashes(($_POST['valor']));
$cod_venta_producto_temporal = intval($_POST['id']);

$data_sql = ("UPDATE tbl15_mantenimiento_producto SET fecha_alerta = '$fecha_alerta' WHERE cod_venta_producto = '$cod_venta_producto'");
$exec_data = mysqli_query($conectar, $data_sql) or die(mysqli_error($conectar));
