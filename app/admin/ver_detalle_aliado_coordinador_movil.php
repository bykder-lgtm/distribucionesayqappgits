...
if (!$row) { header("Location: lista_aliado_coordinador_movil.php"); exit; }
...
<main class="page-container">
    <div class="page-header">
        ...
        $back_link = $cod_asesor_param > 0 
            ? 'lista_aliado_asesor_coordinador_movil.php?cod_asesor=' . $cod_asesor_param 
            : 'lista_aliado_coordinador_movil.php';
        ?>
        ...
        <div class="profile-body">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">
                            ...
                            if ($tipo_cliente_display == 'PERSONA_NATURAL') {
                                ...
                                echo '<span style="background: rgba(99, 102, 241, 0.2); color: #6366f1; padding: 0.25rem 0.6rem; border-radius: 6px; font-size: 0.75rem; font-weight: 600;"><i class="fa-solid fa-building"></i> Persona Jurídica</span>';
                            } else {
            ...
            <div class="documentacion-section">
                ...
                <div style="display: flex; flex-direction: column; gap: 0.5rem; margin-bottom: 1rem;">
                    ...
                    <a href="<?php echo htmlspecialchars($row['url_documentacion_cedula_aliado']); ?>" target="_blank" style="color: #6366f1; font-size: 0.85rem; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem; background: rgba(99, 102, 241, 0.1); border-radius: 8px;">
                        <i class="fa-solid fa-file-pdf"></i>Ver Cédula
                    </a>
                    <?php endif; ?>
                    <?php if ($rut_cargado): ?>
                    <a href="<?php echo htmlspecialchars($row['url_documentacion_rut_aliado']); ?>" target="_blank" style="color: #6366f1; font-size: 0.85rem; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem; background: rgba(99, 102, 241, 0.1); border-radius: 8px;">
                        <i class="fa-solid fa-file-pdf"></i>Ver Documento RUT
                    </a>
                    <?php endif; ?>
                    <?php if ($camara_cargada): ?>
                    <a href="<?php echo htmlspecialchars($row['url_documentacion_camaracomercio_aliado']); ?>" target="_blank" style="color: #6366f1; font-size: 0.85rem; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem; background: rgba(99, 102, 241, 0.1); border-radius: 8px;">
                    ...
                    <?php if ($res_banco && mysqli_num_rows($res_banco) > 0): ?>
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value" style="font-size: 0.8rem;">
                                ...
                                <br>
                                <a href="<?php echo htmlspecialchars($banco['url_certificado_banco_cuenta']); ?>" target="_blank" style="color: #6366f1; font-size: 0.75rem; text-decoration: none; display: inline-flex; align-items: center; gap: 0.25rem; margin-top: 0.25rem;">
                ...
                <div class="store-list">
                    <?php if (count($tiendas_arr) > 0): ?>
                        <?php foreach($tiendas_arr as $tienda): ?>
                            <div class="store-item"><a href="../admin/ver_detalle_tienda_coordinador_movil.php?cod_tienda=<?php echo $tienda['cod_tienda']; ?>"><i class="fa-solid fa-store"></i><?php echo $tienda['nombre_tienda']; ?></a></div>
                        <?php endforeach; ?>
                    <?php else: ?>
...
<div class="modal-overlay" id="modalDocumentacionAliado" style="z-index: 3000; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.8); backdrop-filter: blur(5px); display: none; align-items: center; justify-content: center; padding: 1rem;">
    <div class="modal-content" style="background: linear-gradient(135deg, #1a1f2e 0%, #0d1117 100%); border-radius: 24px; width: 100%; max-width: 500px; padding: 0; animation: fadeInScale 0.3s ease; max-height: 90vh; overflow-y: auto; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5);">
        <div class="modal-header" style="display: flex; justify-content: space-between; align-items: center; padding: 1.5rem; border-bottom: 1px solid rgba(99, 102, 241, 0.2); background: linear-gradient(135deg, rgba(99, 102, 241, 0.2), rgba(79, 70, 229, 0.2)); border-radius: 24px 24px 0 0; position: sticky; top: 0; z-index: 10;">
...
function abrirModalDocumentacionAliado(codAliadoCryp, nombreAliado, telefono, correo, urlRut, urlCamara, urlCedula) {
    ...
    if (urlRut && urlRut.trim() !== '') {
        ...
        estadoRut.innerHTML = '<i class="fa-solid fa-check-circle" style="color: #10b981;"></i><span style="color: rgba(255,255,255,0.8); font-size: 0.85rem;">RUT: Cargado</span><a href="' + urlRut + '" target="_blank" style="margin-left: auto; color: #6366f1; font-size: 0.8rem;"><i class="fa-solid fa-eye"></i></a>';
    } else {
    ...
    if (urlCamara && urlCamara.trim() !== '') {
        ...
        estadoCamara.innerHTML = '<i class="fa-solid fa-check-circle" style="color: #10b981;"></i><span style="color: rgba(255,255,255,0.8); font-size: 0.85rem;">Cámara de Comercio: Cargado</span><a href="' + urlCamara + '" target="_blank" style="margin-left: auto; color: #6366f1; font-size: 0.8rem;"><i class="fa-solid fa-eye"></i></a>';
    } else {
    ...
    if (urlCedula && urlCedula.trim() !== '') {
        ...
        estadoCedula.innerHTML = '<i class="fa-solid fa-check-circle" style="color: #10b981;"></i><span style="color: rgba(255,255,255,0.8); font-size: 0.85rem;">Cédula: Cargado</span><a href="' + urlCedula + '" target="_blank" style="margin-left: auto; color: #6366f1; font-size: 0.8rem;"><i class="fa-solid fa-eye"></i></a>';
    } else {
