...
if (isset($_POST['nombre_entidad']) <> '') { $nombre_entidad = mysqli_real_escape_string($conectar, ($_POST['nombre_entidad'])); } else { $nombre_entidad = ''; }

$obtener_entidad = "SELECT nombre_entidad FROM tbl15_entidad WHERE nombre_entidad = '".($nombre_entidad)."'";
...
$sql_data = "INSERT INTO tbl15_entidad (nombre_entidad, direccion, telefono, correo) 
