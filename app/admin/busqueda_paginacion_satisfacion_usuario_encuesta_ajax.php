...
$pagina                   = $concatenador."lista_satisfacion_usuario_encuesta.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    // escaping, additionally removing everything that could be (html/javascript-) code
     ...
     $sTable = "tbl15_historia_clinica RIGHT JOIN (tbl15_cliente RIGHT JOIN (tbl15_administrador RIGHT JOIN tbl15_tbl15_satisfacion_usuario_encuestaON tbl15_administrador.cod_administrador = tbl15_satisfacion_usuario_encuesta.cod_administrador) ON tbl15_cliente.cod_cliente = tbl15_satisfacion_usuario_encuesta.cod_cliente) ON tbl15_historia_clinica.cod_historia_clinica = tbl15_satisfacion_usuario_encuesta.cod_historia_clinica";
     ...
     elseif ($buscar_por=='nombre_empresa') { $columnas_busqueda = array('tbl15_satisfacion_usuario_encuesta.nombre_empresa'); }
     elseif ($buscar_por=='fecha_ymd') { $columnas_busqueda = array('tbl15_satisfacion_usuario_encuesta.fecha_ymd'); }
     elseif ($buscar_por=='cod_historia_clinica') { $columnas_busqueda = array('tbl15_satisfacion_usuario_encuesta.cod_historia_clinica'); }
     elseif ($buscar_por=='cod_satisfacion_usuario_encuesta') { $columnas_busqueda = array('tbl15_satisfacion_usuario_encuesta.cod_satisfacion_usuario_encuesta'); }
     else {  }
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" ORDER BY tbl15_satisfacion_usuario_encuesta.fecha_time DESC";
} else {
    $sWhere.=" ORDER BY tbl15_satisfacion_usuario_encuesta.fecha_time DESC";
}
    ...
    $reload = '../admin/lista_satisfacion_usuario_encuesta.php';
...
$sql_consulta = "SELECT tbl15_satisfacion_usuario_encuesta.cod_satisfacion_usuario_encuesta, tbl15_satisfacion_usuario_encuesta.cod_historia_clinica, 
tbl15_satisfacion_usuario_encuesta.cod_cliente, tbl15_satisfacion_usuario_encuesta.cod_administrador, 
tbl15_administrador.nombres AS nombre_prof, tbl15_administrador.apellidos AS apellidos_prof, tbl15_cliente.cedula, tbl15_cliente.nombres, 
tbl15_cliente.apellido1, tbl15_satisfacion_usuario_encuesta.fecha_time, tbl15_cliente.url_img_foto_min, tbl15_cliente.url_img_firma_min, 
tbl15_satisfacion_usuario_encuesta.nombre_empresa 
...
$cod_tbl15_satisfacion_usuario_encuesta   = $datos_consulta['cod_satisfacion_usuario_encuesta'];
...
<td style="text-align:center"><?php echo $cod_satisfacion_usuario_encuesta?></td>
<td style="text-align:center"><a href="../admin/edit_satisfacion_usuario_encuesta.php?cod_satisfacion_usuario_encuesta=<?php echo $cod_satisfacion_usuario_encuesta?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/tbl15_satisfacion_usuario_encuesta.png" class="img-polaroid" alt=""></a></td>
...
<td style="text-align:center"><?php echo $cod_satisfacion_usuario_encuesta?></td>
<td style="text-align:center"><a href="../admin/ver_satisfacion_usuario_encuesta_version_pdf.php?cod_satisfacion_usuario_encuesta=<?php echo $cod_satisfacion_usuario_encuesta?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>" target="_blank"><img src="../imagenes/imprimir_peq.png" class="img-polaroid" alt=""></a></td>
<td style="text-align:center"><a href="../admin/edit_satisfacion_usuario_encuesta.php?cod_satisfacion_usuario_encuesta=<?php echo $cod_satisfacion_usuario_encuesta?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
<!--
<td style="text-align:center"><a onClick="javascript:reportePDF(<?php echo $cod_tbl15_satisfacion_usuario_encuesta?>, <?php echo $cod_historia_clinica ?>, <?php echo $cod_cliente ?>);" style="cursor: pointer; position: relative;"><img src="../imagenes/imprimir_peq.png" class="img-polaroid"></a></td>
<td style="text-align:center"><span><img src="../imagenes/cargando.gif" class="cargando_loading<?php echo $cod_tbl15_satisfacion_usuario_encuesta?> hide"></span></td>
-->
</tr>
<?php } //end while ?>
<tr>
