...
$cod_escolaridad = intval($_POST['cod_escolaridad']);
$nombre_escolaridad = addslashes($_POST['nombre_escolaridad']);

$actualizar_historia_clinica = "UPDATE tbl15_escolaridad SET nombre_escolaridad = '$nombre_escolaridad' WHERE cod_escolaridad = '$cod_escolaridad'";
