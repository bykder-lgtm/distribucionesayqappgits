...
<a href="../admin/menu_lista.php"><h4>Lista de Proveedores&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
</div>
<hr>
<div class="row-fluid">
...
<table class="table table-striped">
	...
	<tbody>
<?php
$sql_tercero_total = "SELECT * FROM tbl15_tercero ORDER BY cod_tercero DESC";
...
<tbody>
<?php
$sql_cliente = "SELECT * FROM tbl15_tercero WHERE (nombre_tipo_tercero = 'PROVEEDOR') ORDER BY cod_tercero DESC";
