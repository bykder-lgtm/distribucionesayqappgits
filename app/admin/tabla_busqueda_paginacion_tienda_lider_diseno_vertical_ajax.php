...
$pagina = $concatenador."lista_tienda_lider_diseno_vertical.php";
...
if($busqueda_ajax <> NULL) { $aColumns = array('nombre_tienda', 'identificacion_tercero'); }
...
if($action == 'ajax') {
    ...
    $reload                            = '../admin/lista_tienda_lider_diseno_vertical.php';
