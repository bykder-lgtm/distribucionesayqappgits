...
if (isset($_GET["cod_banner_slider"])) {
  ...
  <table class="table table-striped">
      <tr>
          <th style="text-align:left"><a href="#"><font size='+2'>Cambiar Imagen del Personaje Slider</font></a></th>
      </tr>
  </table>
  <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
  ...
  <table border="1" class="table table-responsive">
  	<thead>
  		<tr>
  		  <th style="text-align:center"><img src="<?php echo $url_personaje_banner_slider_min ?>" width="50%" class="img-rounded" /></th>
  		</tr>
  	</thead>
  </table>
  <!-- ***************************************************************************************************************************** -->
  ...
  <!-- ***************************************************************************************************************************** -->
  <form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/cambiar_imagen_personaje_slider_principal_nosotros_siscredito_reg.php">
  <fieldset>
  <table border="1" class="table table-responsive">
  	<thead>
  		<tr>
