...
<?php
$suma_temporal = "SELECT Sum(total_compra_producto) As total_compra FROM tbl15_transferencia_bodega_producto_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_factura_transferencia_bodega
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_y_transferencia_bodega_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_factura_transferencia_bodega; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            //let id = this.id;
            $.post("guardar_info_factura_y_transferencia_bodega_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<form method="post" name="formulario" action="../admin/factura_transferencia_bodega_producto_reg.php">
...
<?php 
$sql_temporal = "SELECT cod_transferencia_bodega_producto_temporal FROM tbl15_transferencia_bodega_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (nombre_tipo_cargue_factura = '$nombre_tipo_cargue_factura') AND (cod_caja_virtual = '$cod_caja_virtual')";
