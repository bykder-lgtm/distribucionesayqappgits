...
$pagina                       = addslashes($_GET['pagina'])."?&cod_info_cita_factura_venta=".$cod_info_cita_factura_venta."&foco=".$foco."&pagina=edit_factura_venta.php";
...
$sql_data = "INSERT INTO tbl15_cita_venta_producto (cod_factura, cod_info_cita_factura_venta, cod_producto, cod_producto_barra, nombre_producto, und_venta, precio_costo_producto, total_costo_producto, 
...
VALUES ('$cod_factura', '$cod_info_cita_factura_venta', '$cod_producto', '$cod_producto_barra', '$nombre_producto', '$und_venta', '$precio_costo_producto', '$total_costo_producto', 
'$precio_venta_producto', '$total_venta_producto', '$nombre_tipo_producto', '$fecha_ymd_venta_producto', '$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', 
'$fecha_seg_venta_producto', '$cuenta', '$cod_administrador', 
'$nombre_tipo_unidad_medida', '$posologia_cantidad', '$posologia_peso', '$nombre_tipo_presentacion', '$nombre_via_administracion', '$nombre_frec_duracion', '$und_producto_inv')";
