...
include_once("../session/funciones_admin_visitante_extnosesion.php");
//include("../tbl15_notificacion_alerta/mostrar_noficacion_alerta.php");
if (verificar_usuario()) {
  } else { header("Location:$pagina_local");
}
...
$cod_sesion = $_SESSION['cod_sesion'];
//---------------------------------------------------------------------------------------------------------------------------------//
...
$politica_tratamiento_datos_info_empresa                           = $info_empresa_data['politica_tratamiento_datos_info_empresa'];

$info_entrega_info_empresa                                         = $info_empresa_data['info_entrega_info_empresa'];
$politica_calidad_info_empresa                                     = $info_empresa_data['politica_calidad_info_empresa'];
$principios_filosoficos_info_empresa                               = $info_empresa_data['principios_filosoficos_info_empresa'];
...
$url_redsocial_facebook                                            = $info_empresa_data['url_redsocial_facebook'];
$url_redsocial_twitter                                             = $info_empresa_data['url_redsocial_twitter'];
$url_redsocial_linkedin                                            = $info_empresa_data['url_redsocial_linkedin'];
$url_redsocial_skype                                               = $info_empresa_data['url_redsocial_skype'];
$url_redsocial_instagram                                           = $info_empresa_data['url_redsocial_instagram'];
$url_redsocial_pinterest                                           = $info_empresa_data['url_redsocial_pinterest'];
$url_redsocial_youtube                                             = $info_empresa_data['url_redsocial_youtube'];
$url_redsocial_tiktok                                              = $info_empresa_data['url_redsocial_tiktok'];
$url_redsocial_telegram                                            = $info_empresa_data['url_redsocial_telegram'];
$url_redsocial_whatsapp                                            = $info_empresa_data['url_redsocial_whatsapp'];
$url_redsocial_generic1                                            = $info_empresa_data['url_redsocial_generic1'];
$url_redsocial_generic2                                            = $info_empresa_data['url_redsocial_generic2'];
$url_redsocial_generic3                                            = $info_empresa_data['url_redsocial_generic3'];
...
$usuario_redsocial_facebook                                        = $info_empresa_data['usuario_redsocial_facebook'];
