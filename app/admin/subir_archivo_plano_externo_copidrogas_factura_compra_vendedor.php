...
$fecha                                 = date("Y/m/d");
$origen                                = 'PARACLINICOS';
$cod_tipo_origen_factura_compra        = '2';
...
<table class="table table-striped">
    <tr>
        <th style="text-align:center"><a href="../admin/lista_info_factura_compra_abierta_temporal_vendedor.php"><font size='+2'>Cargar Factura Compra Externa (Archivo Plano)</font></a></th>
    </tr>
</table>

<div class="table-responsive">

<form action="subir_archivo_plano_externo_copidrogas_factura_compra_vendedor_reg.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
    <table class="table table-striped">
        <thead>
            <tr>
