...
$(document).on('click','#btn_guardar_producto',function(e){
    ...
    $.ajax({
        type: 'POST',
        url: '../admin/reg_producto_modal_coordinador_ajax_reg.php',
        data: formData,
        dataType: 'json',
        processData: false,
        contentType: false,
...
$(document).on('click','#btn_guardar_producto_editar',function(e){
    ...
    $btn.prop('disabled', true);
    $.ajax({
        url: '../admin/edit_producto_modal_coordinador_ajax_reg.php',
        type: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
