...
<div class="breadcrumbs"><a href="../admin/eliminar_venta_electronica_no_enviadas_a_la_dian_por_fechas.php"><h4>Archivando Facturas de Venta</h4></a></div>
<hr>
<div class="row-fluid">
...
if (isset($_POST['fecha_ymd_venta_producto_ini'])) {
	...
	$sql_datos = "SELECT * FROM tbl15_venta_producto WHERE (fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') AND (cod_estado_check_factura_electronica = '$cod_estado_check_factura_electronica_ext') $filtro_consulta_nombre_tipo_factura";
	...
	echo "<br>Total registros de Venta Eliminados: ".$contador_venta;

	$sql_datos = "SELECT * FROM tbl15_info_factura_venta WHERE (fecha_anyo BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') AND (cod_estado_check_factura_electronica = '$cod_estado_check_factura_electronica_ext') $filtro_consulta_nombre_tipo_factura";
	$resultado_datos = mysqli_query($conectar, $sql_datos);
	while ($info_datos = mysqli_fetch_assoc($resultado_datos)) {
	...
	echo "<br>Total registros de Info Venta Eliminados: ".$contador_info_venta;
	echo "<br>Correcto";
}
?>
<!-- ***************************************************************************************************************************** -->
