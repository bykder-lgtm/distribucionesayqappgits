...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="../admin/lista_certificado_retencion_en_la_fuente.php"><font size='+1'>Lista Certificados Retefuente</font></a></th>
        <th style="text-align:right"><a href="../admin/reporte_compra_fechas_tercero_certificado_retencion_en_la_fuente.php"><font size='+1'>Registrar Certificado Por Reporte</font></a></th>
        <th style="text-align:right"><a href="../admin/reg_certificado_retencion_en_la_fuente.php"><font size='+1'>Registrar Certificado Manual</font></a></th>
    </tr>
</table>
<hr>
<div class="row-fluid">
...
$mostrar_datos_sql = "SELECT * FROM tbl15_certificado_retefuente ORDER BY cod_certificado_retefuente DESC";
...
while ($matriz_consulta = mysqli_fetch_assoc($consulta)) {
	...
	$sql_origen_resolucion_facturacion = "SELECT * FROM tbl15_tercero WHERE (cod_tercero = '$cod_tercero')";
	...
	$nombre1_tercero          = $matriz_origen_resolucion_facturacion['nombre1_tercero'];
?>
	<tr>
