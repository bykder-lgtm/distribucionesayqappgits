...
$pagina                       = addslashes($_GET['pagina'])."?&foco=".$foco."&pagina=facturacion_sticker_temporal_producto_manual_pos.php";
...
$datos_info = "SELECT * FROM tbl15_info_factura_sticker WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_info_factura_sticker (cod_info_factura_sticker, nombre_estado_factura, fecha_ymdhis, cuenta, cod_estado_factura, cod_caja_virtual, fecha_dia, fecha_mes, 
...
VALUES ('$cod_info_factura_sticker', '$nombre_estado_factura', '$fecha_ymdhis', '$cuenta', '$cod_estado_factura', '$cod_caja_virtual', '$fecha_dia', '$fecha_mes', 
'$fecha_anyo', '$anyo', '$fecha_hora', '$cod_tipo_pago', '$cod_administrador', '$cod_dependencia', '$cod_tipo_forma_pago', 
'$nombre_tipo_factura', '$nombre_tipo_moneda', '$cod_tercero')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

$sql_data = "INSERT INTO tbl15_sticker_producto_temporal (cod_info_factura_sticker, cod_tercero, cod_producto, cod_producto_barra, nombre_producto, und_venta, 
...
$sql_info_factura = "SELECT cod_info_factura_sticker, cod_tercero FROM tbl15_info_factura_sticker WHERE (nombre_estado_factura = '$nombre_estado_factura') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_info_factura_sticker             = $datos_info_factura['cod_info_factura_sticker'];
