...
FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$sql_maxima_factura = "SELECT Max(cod_factura) AS cod_factura FROM tbl15_info_gasto_inmueble_inquilino_venta WHERE (nombre_tipo_factura = 'ELECTRONICA') AND (nombre_estado_factura = 'CERRADA')";
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            var tipo_ajax = "tbl15_info_gasto_inmueble_inquilino_venta";
            $.post("guardar_info_factura_y_gasto_inmueble_inquilino_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_gasto_inmueble_inquilino_venta; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
        ...
        $.ajax({
            type: "POST",
            url: "../admin/guardar_info_factura_y_gasto_inmueble_inquilino_temporal_ajax.php",
            data: datos_url_ajax,
            //dataType: 'json',
...
$(document).ready(function(){
    $("#descripcion_tipo_forma_pago").on('change', function () {
            ...
            var tipo_ajax = "tbl15_info_gasto_inmueble_inquilino_venta";
            var id = $(this).attr("class");
            $.post("guardar_info_factura_y_gasto_inmueble_inquilino_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<form name="formulario" method="post" enctype="multipart/form-data" action="../admin/venta_gasto_inmueble_inquilino_reg.php">
    ...
    <table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
      <tr>
        ...
        <th style="text-align:center;">TOTAL COSTO ADMINISTRACION DE REPARACION</th>
        <th style="text-align:center;">TOTAL COSTO FINAL</th>
      ...
      <tr>
       ...
       <td style="text-align:center;"><?php echo $cod_info_gasto_inmueble_inquilino_venta ?></td>
        ...
        <td style="text-align:left">
            ...
            $nombre                         = 'CONT: '.$datos2['cod_factura'].' |  INQ: '.$nombre1_tercero_inquilino.' ['.$nombre_producto.']';
...
-->
       ...
       <th style="text-align:center; font-size:40px;"><div id="total_gasto_ganancia"><?php echo number_format($total_gasto_ganancia, 0, ",", ".") ?></div></th>
        ...
        <td style="text-align: center;"><a href="../admin/comprobante_gasto_inquilino_inmueble_detalle_no_deducido_imprimir_pdf.php?cod_info_gasto_inmueble_inquilino_venta=<?php echo $cod_info_gasto_inmueble_inquilino_venta;?>&cuenta=<?php echo $cuenta_actual;?>&cod_caja_virtual=<?php echo $cod_caja_virtual;?>" target="_blank"><img src=../imagenes/pdf_peq.png alt="Adjuntar"></a></td>
        ...
        <?php 
        $sql_temporal = "SELECT cod_gasto_inmueble_inquilino_venta_temporal FROM tbl15_gasto_inmueble_inquilino_venta_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
        ...
        <input type="hidden" name="cod_gasto_inmueble_inquilino_venta_temporal[]" value="<?php echo $datos_temporal['cod_gasto_inmueble_inquilino_venta_temporal']; ?>">
        <?php } ?>

        <?php $pagina ='facturacion_venta_temporal_producto_manual_pos.php'; ?>
        <input type="hidden" name="cod_info_gasto_inmueble_inquilino_venta" value="<?php echo $cod_info_gasto_inmueble_inquilino_venta ?>" size="10">
