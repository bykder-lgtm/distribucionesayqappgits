        ...
        <div class="flex" id="flex">
            <div class="modal_contenido">
                ...
                <form method="post" enctype="multipart/form-data" id="formulario_nuevo_registro_modal" name="formulario_nuevo_registro_modal" class="form-horizontal form-label-left input_mask">
                    <input type="hidden" name="cod_info_impuesto_facturas_hidden" id="cod_info_factura_compra" value="<?php echo $cod_info_factura_compra ?>" placeholder="">
                ...
                <div class="modal_cuerpo">
                    <div class="form-group">
                        ...
                        <!--<div class="col-md-4 col-sm-4 col-xs-4">-->
                            ...
                            <?php $sql_consulta="SELECT * FROM tbl15_tipo_tercero WHERE (nombre_tipo_tercero = 'PROVEEDOR') ORDER BY cod_tipo_tercero ASC";
                ...
                <div class="modal_cuerpo">
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-4">Razon Social<span class="required">:</span></label>
                        <!--<div class="col-md-4 col-sm-4 col-xs-4">-->
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4"></div>
                          ...
                          <input type="hidden" name="nombre2_tercero" id="nombre2_tercero" value="" class="form-control" placeholder="">
                          <input type="hidden" name="apellido1_tercero" id="apellido1_tercero" value="" class="form-control" placeholder="">
                          <input type="hidden" name="apellido2_tercero" id="apellido2_tercero" value="" class="form-control" placeholder="">
...
function Cargar_nombre_cliente(valor, campo, tipo_ajax) {
    ...
    $('#'+capa_cargar_datos).load("../admin/recargar_consulta_select_factura_compra_ajax.php", { 'valor': valor, 'campo': campo, 'tipo_ajax': tipo_ajax });
}
