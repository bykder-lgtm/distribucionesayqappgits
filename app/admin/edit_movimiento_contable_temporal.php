...
<a class="btn btn-primary" href="../imagenes/tabla_comprativa_causacion_puc_movimiento_contable.jpg" target="_blank"><h6>Movimiento Contable</h6></a>
</div>
<div class="row-fluid">
...
if (isset($_GET['cod_movimiento_contable'])) {
  ...
  $sql_mov_contable_credito = "SELECT * FROM tbl15_movimiento_contable_temporal_concepto 
  ...
  $diferencia = $total_datos_debitos - $total_datos_creditos;
...
<table class="table table-striped">
  ...
  <tr>
    <th style="text-align:left; width:250px"><?php echo $titulo_documento ?>:</th>
...
<table class="table table-striped">
  <tr>
    <td style="text-align:center">
      <?php if ($url_img_orig_producto <> '') { ?><a href="<?php echo $url_img_orig_producto?>" target="_blank"><img src="../imagenes/pdf_peq.png" class="img-polaroid" alt=""><a/><br><?php } ?>
      <a href="../admin/cargar_soporte_archivo_adjunto_movimiento_contable_nota_observacion.php?cod_movimiento_contable=<?php echo $cod_movimiento_contable ?>&pagina=<?php echo $pagina_local ?>">CARGAR SOPORTE</a>
    </td>
  </tr>
</table>
<?php } ?>
...
$comentario                                     = $info_movimiento_contable_temporal_concepto['comentario'];
...
?>
          <tr id="tr<?php echo $cod_movimiento_contable_temporal_concepto;?>">
            ...
            <td style="text-align:center"><input type="text" name="codigo_puc[]" class="codigo_puc" id="<?php echo $cod_movimiento_contable_temporal_concepto ?>" value="<?php echo $codigo_puc ?>" style="text-align: center; font-size:18px; width:100px;"></td>
            <td style="text-align:left"><input type="text" name="nombre_puc[]" class="nombre_puc_<?php echo $cod_movimiento_contable_temporal_concepto ?>" id="nombre_puc_z_<?php echo $cod_movimiento_contable_temporal_concepto ?>" value="<?php echo $nombre_puc ?>" style="text-align: left; font-size:18px; width:250px;"></td>
            <td style="text-align:center"><input type="text" name="comentario[]" class="comentario<?php echo $incre ?>" id="<?php echo $cod_movimiento_contable_temporal_concepto ?>" value="<?php echo $comentario ?>" style="text-align: left; font-size:18px; width:250px;"></td>
            <td style="text-align:center"><input type="text" name="costo_movimiento_contable[]" class="costo_movimiento_contable_debitos<?php echo $incre ?>" data="DEBITOS" id="<?php echo $cod_movimiento_contable_temporal_concepto ?>" value="<?php echo $costo_movimiento_contable ?>" style="text-align: center; font-size:18px; width:100px;"></td>
            ...
            <input type="hidden" name="cod_puc[]" class="cod_puc_<?php echo $cod_movimiento_contable_temporal_concepto ?>">
          </tr id="tr<?php echo $cod_movimiento_contable_temporal_concepto;?>">
<?php } ?>
        </table>
...
$costo_movimiento_diario                      = 0;
$total_costo_movimiento_diario                = 0;
$nombre_tabla                                 = "movimiento_diario_pago";
...
?>
    <table border="1" style="text-align:center; font-family:mono; font-size:12pt; width:99%"><tr><th style="text-align:center">CREDITOS<a href="../admin/reg_movimiento_contable_temporal_concepto_reg.php?cod_movimiento_contable=<?php echo $cod_movimiento_contable?>&nombre_tipo_documento=<?php echo $nombre_tipo_documento?>&nombre_tipo_movimiento=CREDITOS"><img src=../imagenes/mas.png alt="mas"></a></th></tr></table>
...
?>
            ...
            <td style="text-align:center"><a href="../admin/eliminar.php?llave=<?php echo $cod_movimiento_contable_temporal_concepto ?>&cod_movimiento_contable=<?php echo $cod_movimiento_contable ?>&tab=<?php echo $tab ?>&tipo=<?php echo $tipo ?>&campo=<?php echo $campo ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/eliminar.png" class="img-polaroid" alt=""></a></td>
              ...
              <td style="text-align:left"><input type="text" name="nombre_puc[]" class="nombre_puc_<?php echo $cod_movimiento_contable_temporal_concepto ?>" id="nombre_puc_z_<?php echo $cod_movimiento_contable_temporal_concepto ?>" value="<?php echo $nombre_puc ?>" style="text-align: left; font-size:18px; width:250px;"></td>
            <td style="text-align:center"><input type="text" name="comentario[]" class="comentario<?php echo $incre ?>" id="<?php echo $cod_movimiento_contable_temporal_concepto ?>" value="<?php echo $comentario ?>" style="text-align: left; font-size:18px; width:250px;"></td>
              <td style="text-align:center"><input type="text" name="costo_movimiento_contable[]" class="costo_movimiento_contable_creditos<?php echo $incres ?>" data="CREDITOS" id="<?php echo $cod_movimiento_contable_temporal_concepto ?>" value="<?php echo $costo_movimiento_contable ?>" style="text-align: center; font-size:18px; width:100px;"></td>
              <input type="hidden" name="und_vendida[]" value="<?php echo $und_vendida ?>">
              <input type="hidden" name="cod_movimiento_contable_temporal_concepto[]" value="<?php echo $cod_movimiento_contable_temporal_concepto ?>">
              <input type="hidden" name="cod_puc[]" class="cod_puc_<?php echo $cod_movimiento_contable_temporal_concepto ?>">
            </tr id="tr<?php echo $cod_movimiento_contable_temporal_concepto;?>">
...
<br>
<?php 
if ($total_costo_movimiento_contable_debito > $total_costo_movimiento_contable_credito) { $mensaje = '<img src="../imagenes/advertencia.gif">> Las cuentas no suman igual valor ><img src="../imagenes/advertencia.gif">'; } 
elseif ($total_costo_movimiento_contable_credito > $total_costo_movimiento_contable_debito) { $mensaje = '<img src="../imagenes/advertencia.gif">< Las cuentas no suman igual valor <<img src="../imagenes/advertencia.gif">'; } 
           ...
           if (nombre_tipo_movimiento == 'DEBITOS') {
              ...
              for (i=1; i<=total_datos_debitos; i++){
                ...
                if (total_costo_movimiento_contable_debitos_msj > total_costo_movimiento_contable_creditos_msj) {
                  total_movimiento_contable_mensaje = '<img src="../imagenes/advertencia.gif">> Las cuentas no suman igual valor ><img src="../imagenes/advertencia.gif">';
