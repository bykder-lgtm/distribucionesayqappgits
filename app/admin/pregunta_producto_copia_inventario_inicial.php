...
$pagina                      = $_GET['pagina'];
?>
<form method="post" name="formulario" action="../admin/pregunta_producto_copia_inventario_inicial_reg.php">
<table class="table table-striped">
    <tr>
        <th style="text-align:center">DESEA HACER UNA COPIA DEL INVENTARIO INICAL ?</th>
    </tr>
    <tr>
