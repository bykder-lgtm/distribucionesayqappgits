...
$pagina                   = $concatenador."lista_certificado_apoyo_emocional.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
if($action == 'ajax') {
    ...
    $cod_certificado_apoyo_emocional_get  = intval($_REQUEST['cod_certificado_apoyo_emocional_get']);
...
if($busqueda_ajax <> NULL) {
	...
	} elseif ($buscar_por == 'nombre_certificado_apoyo_emocional') {
		$busq_aprox_izq = '%';
		$busq_aprox_der = '%';
     	$aColumns = array('nombre_certificado_apoyo_emocional'); //Columnas de busqueda
	} elseif ($buscar_por == 'nombre_nota_observacion') {
		$busq_aprox_izq = '%';
		$busq_aprox_der = '%';
     	$aColumns = array('nombre_propietario_mascota', 'documento_propietario_mascota', 'nombre_mascota', 'nombre_raza_mascota', 'fecha_certificado_apoyo_emocional'); //Columnas de busqueda
	} else {
		$busq_aprox_izq = '%';
		$busq_aprox_der = '%';
     	$aColumns = array('cod_producto_barra', 'nombre_producto'); //Columnas de busqueda
...
// escaping, additionally removing everything that could be (html/javascript-) code
     $sTable = "tbl15_certificado_apoyo_emocional";
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" ORDER BY cod_certificado_apoyo_emocional DESC";
} else {
    $sWhere.=" ORDER BY cod_certificado_apoyo_emocional DESC";
}
include_once('../ajax/pagination.php'); //include pagination file
    ...
    $reload             = '../admin/lista_certificado_apoyo_emocional.php';
    //loop through fetched data
    if ($cantidad_registros>0) { ?>
<table class="table table-striped jambo_table bulk_action">
<thead>
<tr class="headings">
	<th style="text-align:center">PROPIETARIO MASCOTA</th>
...
while ($datos_consulta = mysqli_fetch_array($query_consulta)) {
	...
	$cod_certificado_apoyo_emocional                                   = $datos_consulta['cod_certificado_apoyo_emocional'];
	...
	$nombre_propietario_mascota                                        = $datos_consulta['nombre_propietario_mascota'];
	$documento_propietario_mascota                                     = $datos_consulta['documento_propietario_mascota'];
	$direccion_propietario_mascota                                     = $datos_consulta['direccion_propietario_mascota'];
	$nombre_mascota                                                    = $datos_consulta['nombre_mascota'];
	$nombre_raza_mascota                                               = $datos_consulta['nombre_raza_mascota'];
	$edad_mascota                                                      = $datos_consulta['edad_mascota'];
	$color_mascota                                                     = $datos_consulta['color_mascota'];
	$peso_mascota                                                      = $datos_consulta['peso_mascota'];
	$talla_mascota                                                     = $datos_consulta['talla_mascota'];
	$fecha_certificado_apoyo_emocional                                 = $datos_consulta['fecha_certificado_apoyo_emocional'];
	$hora_certificado_apoyo_emocional                                  = $datos_consulta['hora_certificado_apoyo_emocional'];
	$cod_estado                                                        = $datos_consulta['cod_estado'];

	if ($cod_estado == '1') { 
		$texto_estado = 'DILIGENCIADO'; 
		$url_enlace_pdf = '../admin/ver_certificado_apoyo_emocional_version_pdf.php?cod_certificado_apoyo_emocional_codifcryp='.$cod_certificado_apoyo_emocional_codifcryp; 
		$url_imagen_pdf = '<br><img src="../imagenes/pdf_peq.png" class="img-polaroid" alt="">'; 
		$url_imagen_pdf = '<br><img src="../imagenes/pdf_peq.png" class="img-polaroid" alt="">'; 
		$blank_target = 'target="_blank"'; 
	} else { 
		$texto_estado = 'POR REVISAR'; 
		$url_enlace_pdf = '../admin/edit_certificado_apoyo_emocional.php?cod_certificado_apoyo_emocional='.$cod_certificado_apoyo_emocional.'&pagina='.$pagina; 
		$url_imagen_pdf = ''; 
		$blank_target = ''; 
	}
	if ($cod_certificado_apoyo_emocional == $cod_certificado_apoyo_emocional_get) { $color_celda = "background-color:#DBE0F3; color:#000;"; } else { $color_celda = ""; }

?>
<tr class="even pointer">
	<td style="text-align:left; <?php echo $color_celda; ?>"><?php echo $nombre_propietario_mascota; ?></td>
	<td style="text-align:center; <?php echo $color_celda; ?>"><?php echo $documento_propietario_mascota; ?></td>
	<td style="text-align:left; <?php echo $color_celda; ?>"><?php echo $direccion_propietario_mascota; ?></td>
	<td style="text-align:center; <?php echo $color_celda; ?>"><?php echo $nombre_mascota; ?></td>
	<td style="text-align:center; <?php echo $color_celda; ?>"><?php echo $nombre_raza_mascota; ?></td>
	<td style="text-align:center; <?php echo $color_celda; ?>"><?php echo $fecha_certificado_apoyo_emocional; ?> | <?php echo $hora_certificado_apoyo_emocional; ?></td>
	<td style="text-align:center; <?php echo $color_celda; ?>"><a href="<?php echo $url_enlace_pdf; ?>" <?php echo $blank_target; ?>><?php echo $texto_estado; ?><?php echo $url_imagen_pdf; ?></a></td>
	<td style="text-align:center; <?php echo $color_celda; ?>"><?php echo $cod_certificado_apoyo_emocional; ?></td>
	<td style="text-align:center; <?php echo $color_celda; ?>"><a href="../admin/edit_certificado_apoyo_emocional.php?cod_certificado_apoyo_emocional=<?php echo $cod_certificado_apoyo_emocional?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
</tr>
<?php } //end while ?>
</table>
