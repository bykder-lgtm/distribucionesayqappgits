...
<table class="table table-striped">
    <tbody><tr>
        ...
        <th style="text-align:center">FALTAN POR CARGAR</th>
...
<table class="table table-striped">
    <tbody>
        <tr>
        <th style="text-align:center"><a>INVENTARIO DE PRODUCTOS SIN CARGAR [<?php echo $total_productos_faltan_por_cargar ?>]</a></th>
    </tr>
</tbody>
</table>
...
<tbody>
<?php
while ($info_productos_faltan_por_cargar = mysqli_fetch_assoc($resultado_productos_faltan_por_cargar)) {

$cod_producto_copia_inventario          = $info_productos_faltan_por_cargar['cod_producto_copia_inventario'];
$cod_producto_barra                     = $info_productos_faltan_por_cargar['cod_producto_barra'];
$nombre_producto                        = $info_productos_faltan_por_cargar['nombre_producto'];
$und_producto_nuevo                     = $info_productos_faltan_por_cargar['und_producto_nuevo'];
$und_producto_viejo                     = $info_productos_faltan_por_cargar['und_producto_viejo'];
$precio_compra_producto                 = $info_productos_faltan_por_cargar['precio_compra_producto'];
$precio_venta_producto                  = $info_productos_faltan_por_cargar['precio_venta_producto'];
$comentario_copia_inventario            = $info_productos_faltan_por_cargar['comentario_copia_inventario'];
$fecha_actualizacion                    = $info_productos_faltan_por_cargar['fecha_actualizacion'];
$cod_administrador                      = $info_productos_faltan_por_cargar['cuenta'];
