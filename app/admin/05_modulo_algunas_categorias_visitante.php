...
<?php
$sql_producto = "SELECT * FROM tbl15_categoria ORDER BY cod_categoria ASC";
...
?>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        ...
                        <a class="btn hvr-hover" href="../admin/ver_producto.php?nombre_categoria_codifcryp=<?php echo $nombre_categoria_codifcryp ?>">VER MAS</a>
