...
//---------------------------------------------------------------------------------------------------------------------------------//
$serguridad_pagina                                = 1; 
$cod_info_gasto_inmueble_detalle_venta            = intval($_GET['cod_info_gasto_inmueble_detalle_venta']);
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$datos_data_info_factura = "SELECT * FROM tbl15_info_gasto_inmueble_detalle_venta WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_tercero_propietario                    = $data_info_factura['cod_tercero_propietario'];
...
$cod_tercero_inquilino                      = $datos_info_cuentas_cobrar['cod_tercero_propietario'];
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_consulta_cliente = "SELECT identificacion_tercero, nombre1_tercero, nombre2_tercero, apellido1_tercero, apellido2_tercero, nombre_tipo_identificacion FROM tbl15_tercero WHERE cod_tercero = '$cod_tercero_propietario'";
...
$cod_info_gasto_inmueble_detalle_venta_strpad           = str_pad($cod_info_gasto_inmueble_detalle_venta, 6, "0", STR_PAD_LEFT);
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
...
$obtener_gasto = "SELECT SUM(precio_venta_producto) AS total_gastado_saldo_favor FROM tbl15_gasto_inmueble_detalle_venta_temporal WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual') ORDER BY cod_gasto_inmueble_detalle_venta_temporal DESC";
...
$titulo_doc_pdf                    = 'COMPROBANTE_CUENTA_DE_ARREGLO_ARRENDATARIO_NO_DEDUCIDO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$autor_doc_pdf                     = 'COMPROBANTE_CUENTA_DE_ARREGLO_ARRENDATARIO_NO_DEDUCIDO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$creador_doc_pdf                   = 'COMPROBANTE_CUENTA_DE_ARREGLO_ARRENDATARIO_NO_DEDUCIDO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$tema_doc_pdf                      = 'COMPROBANTE_CUENTA_DE_ARREGLO_ARRENDATARIO_NO_DEDUCIDO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$palabras_claves_doc_pdf           = 'COMPROBANTE_CUENTA_DE_ARREGLO_ARRENDATARIO_NO_DEDUCIDO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
    ...
    <td width="576" height="10" valign="top"><p>&nbsp;</p>
        <table align="center" border="0" cellpadding="5px" cellspacing="2px" style="font-family:mono; font-size:'.$tamano_font_remision_emp.'pt; width:100%">
          <tr>
            ...
            <th style="text-align:center;" rowspan="6"><barcode code="'.$cod_info_gasto_inmueble_detalle_venta_strpad.'" type="C128A" size="0.6" height="1" /></th>
          </tr>
          <tr>
            <th style="text-align:center;" colspan="2">REGIMEN: '.$regimen_emp.'</th>
          </tr>
          <tr>
            <th style="text-align:center;" colspan="2">GASTOS TEMP: '.$nombre_tipo_producto.'</th>
          </tr>
          <tr>
...
$sql_gasto_inmueble_detalle_venta_temporal = "SELECT * FROM tbl15_gasto_inmueble_detalle_venta_temporal WHERE (cod_info_gasto_inmueble_detalle_venta = '$cod_info_gasto_inmueble_detalle_venta') 
...
$codigoHTML.='
        <table align="center" border="0" cellpadding="" cellspacing="2px" style="font-family:mono; font-size:'.$tamano_font_remision_emp.'pt; width:100%">
          <tr>
			<td style="text-align:left;">EN LETRA: '.convertir_numeros_a_letras($total_gastado_saldo_favor).'</td>
           </tr>
        </table>
<br>';
...
$ruta = '../pdfs/';
$nombre_archivo = 'COMPROBANTE_CUENTA_DE_ARREGLO_ARRENDATARIO_NO_DEDUCIDO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$cod_info_gasto_inmueble_detalle_venta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero.'.pdf';
