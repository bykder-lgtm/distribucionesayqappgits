...
tbl15_cliente.nombres, tbl15_cliente.apellidos, tbl15_cliente.fecha_nac_ymd, tbl15_cliente.fecha_nac_time, tbl15_cliente.edad_anyo, tbl15_cliente.nombre_grupo_rh, tbl15_cliente.tel_cliente, tbl15_cliente.correo, 
tbl15_cliente.direccion, tbl15_cliente.nombre_ciudad, tbl15_cliente.nombre_pais, tbl15_historia_clinica.motivo, tbl15_historia_clinica.nombre_laboratorio, tbl15_historia_clinica.fecha_reg_time, 
tbl15_historia_clinica.fecha_time, tbl15_historia_clinica.fecha_ymd, tbl15_historia_clinica.cuenta, tbl15_historia_clinica.fecha_dmy, 
...
$apellidos = $info_historia_clinica['apellidos'];
...
$nombres_completos = "Ayudas Diagnosticas: ".$nombres.' '.$apellidos;
...
$tema_doc_pdf = "Ayudas Diagnósticas";
...
<p>
<strong>Nombre:</strong> '.$nombres.' '.$apellidos.'&nbsp;&nbsp;&nbsp;&nbsp; 
