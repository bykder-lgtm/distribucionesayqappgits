...
$cod_cotizacion_venta_producto      = intval($_GET['cod_cotizacion_venta_producto']);
...
$sql_temporal = "SELECT * FROM tbl15_cotizacion_venta_producto WHERE cod_cotizacion_venta_producto = '$cod_cotizacion_venta_producto'";
...
$actualizar_sql = "UPDATE tbl15_cotizacion_venta_producto SET nombre_tipo_precio_venta = '$nombre_tipo_precio_venta', 
