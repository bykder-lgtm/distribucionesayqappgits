...
function hacer_busqueda() {
    ...
    xmlhttp.open("POST","../admin/busqueda_info_factura_venta_nota_credito_ajax.php",true);
...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><font size='+1'><a href="../admin/lista_info_nota_credito.php">Buscar Factura Para Nota de Credito</a></font></th>
    </tr>
</table>
...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/busqueda_info_factura_venta_nota_credito_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&tabla='+tabla,
