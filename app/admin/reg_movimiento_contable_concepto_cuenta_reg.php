...
$agreg_reg = "INSERT INTO tbl15_movimiento_contable_concepto (cod_movimiento_contable, nombre_tipo_movimiento, 
...
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/edit_movimiento_contable_cuenta.php?cod_movimiento_contable=<?php echo $cod_movimiento_contable?>">
<?php } ?>