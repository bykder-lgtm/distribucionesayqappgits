...
if (isset($_GET['fecha_pago_reg_ini'])) { 
	...
	$fecha                         = date("Y_m_d");
	$hora                          = date("H_i_s");
	$nombre_archivo                = "REPORTE_GENERAL_GASTOS_DETALLADO_".$fecha_pago_reg_ini.'_A_'.$fecha_pago_reg_fin;
	$cabecera_emp                  = "REPORTE_GENERAL_GASTOS_DETALLADO";
...
// Then a foreach
	...
	$writer->addRow(array('TOTAL', $total_costo_ingreso,));
