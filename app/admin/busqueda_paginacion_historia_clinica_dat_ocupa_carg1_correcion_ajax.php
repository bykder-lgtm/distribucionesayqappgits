...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" WHERE (tbl15_historia_clinica.cod_estado_facturacion = '1') AND ((tbl15_historia_clinica.dat_ocupa_carg1 = '') OR (tbl15_historia_clinica.dat_ocupa_carg1 = ' - ')) ORDER BY tbl15_historia_clinica.fecha_time DESC";
} else {
    $sWhere.=" AND (tbl15_historia_clinica.cod_estado_facturacion = '1') AND ((tbl15_historia_clinica.dat_ocupa_carg1 = '') OR (tbl15_historia_clinica.dat_ocupa_carg1 = ' - ')) ORDER BY tbl15_historia_clinica.fecha_time DESC";
}
...
tbl15_historia_clinica.url_img_foto_min, tbl15_historia_clinica.url_img_foto_orig, tbl15_historia_clinica.dat_ocupa_carg1,
...
$dat_ocupa_carg1                 = $datos_consulta['dat_ocupa_carg1'];
