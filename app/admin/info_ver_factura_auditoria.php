...
<?php
$suma_temporal = "SELECT Sum(total_compra_producto) As total_compra FROM tbl15_factura_auditoria_producto 
...
$datos_data_info_factura = "SELECT tbl15_info_factura_auditoria.cod_factura, tbl15_info_factura_auditoria.cod_tercero, tbl15_info_factura_auditoria.cod_caja_virtual, tbl15_info_factura_auditoria.nombre_estado_factura, 
tbl15_info_factura_auditoria.nombre_tipo_cargue_factura, tbl15_info_factura_auditoria.nombre_tipo_compra, tbl15_info_factura_auditoria.cod_empresa, tbl15_info_factura_auditoria.nombre_empresa, 
tbl15_info_factura_auditoria.razonsocial_empresa, tbl15_info_factura_auditoria.total_muestra, tbl15_info_factura_auditoria.fecha_ymdhis, tbl15_info_factura_auditoria.cuenta, 
tbl15_info_factura_auditoria.cod_estado_factura, tbl15_info_factura_auditoria.cod_base_caja, tbl15_info_factura_auditoria.descuento_ptj, tbl15_info_factura_auditoria.iva_ptj, 
tbl15_info_factura_auditoria.flete_ptj, tbl15_info_factura_auditoria.subtotal, tbl15_info_factura_auditoria.valor_iva, tbl15_info_factura_auditoria.cod_cliente, 
tbl15_info_factura_auditoria.vlr_cancelado, tbl15_info_factura_auditoria.vlr_vuelto, tbl15_info_factura_auditoria.fecha_dia, tbl15_info_factura_auditoria.fecha_mes, 
tbl15_info_factura_auditoria.fecha_anyo, tbl15_info_factura_auditoria.anyo, tbl15_info_factura_auditoria.fecha_hora, tbl15_info_factura_auditoria.fecha_remision, 
tbl15_info_factura_auditoria.nombre_ccosto, tbl15_info_factura_auditoria.garantia_meses, tbl15_info_factura_auditoria.observacion, tbl15_info_factura_auditoria.cod_tipo_pago, 
tbl15_info_factura_auditoria.cod_administrador, tbl15_info_factura_auditoria.nombre_tipo_producto, tbl15_info_factura_auditoria.total_precio_costo, tbl15_info_factura_auditoria.total_precio_compra, 
tbl15_info_factura_auditoria.total_precio_venta, tbl15_info_factura_auditoria.cod_dependencia, tbl15_info_factura_auditoria.servicio, tbl15_info_factura_auditoria.cod_tipo_forma_pago, 
tbl15_info_factura_auditoria.descripcion_tipo_forma_pago, tbl15_info_factura_auditoria.nombre_tipo_factura, 
tbl15_info_factura_auditoria.nombre_tipo_moneda, tbl15_info_factura_auditoria.cod_cierre_caja, tbl15_info_factura_auditoria.fecha_creacion, tbl15_info_factura_auditoria.fecha_modificacion, 
tbl15_info_factura_auditoria.nombre_maquina, tbl15_info_factura_auditoria.cod_tipo_cobrar, tbl15_info_factura_auditoria.cod_estado_vacuna, tbl15_info_factura_auditoria.cod_resolucion_facturacion, 
tbl15_info_factura_auditoria.total_datos_data, tbl15_info_factura_auditoria.tiempo_ejecucion, tbl15_info_factura_auditoria.ipc_ptj, tbl15_info_factura_auditoria.precio_ipc, 
tbl15_info_factura_auditoria.precio_ipc_total, tbl15_info_factura_auditoria.ret_ica_ptj, tbl15_info_factura_auditoria.total_ret_ica, tbl15_info_factura_auditoria.iva_teorico_ptj, 
tbl15_info_factura_auditoria.total_iva_teorico, tbl15_info_factura_auditoria.tarifa_rete_vigente_ptj, tbl15_info_factura_auditoria.total_tarifa_rete_vigente, 
tbl15_info_factura_auditoria.rete_iva_asumido_ptj, tbl15_info_factura_auditoria.total_rete_iva_asumido, tbl15_info_factura_auditoria.iva_19, tbl15_info_factura_auditoria.iva_5, 
tbl15_info_factura_auditoria.nombre_rete_fuente_ptj, tbl15_info_factura_auditoria.total_compra_imp, tbl15_info_factura_auditoria.total_precio_ipc, tbl15_info_factura_auditoria.total_descuento, 
tbl15_info_factura_auditoria.total_rete_fuente, tbl15_info_factura_auditoria.total_factura_compra_retefuente, tbl15_info_factura_auditoria.total_factura_compra, 
tbl15_info_factura_auditoria.cod_doc_soporte, tbl15_info_factura_auditoria.total_inv_precio_costo, tbl15_info_factura_auditoria.total_inv_precio_compra, 
tbl15_info_factura_auditoria.total_inv_precio_venta, tbl15_info_factura_auditoria.total_compra_precio_costo, tbl15_info_factura_auditoria.total_compra_precio_compra, 
tbl15_info_factura_auditoria.total_compra_precio_venta, tbl15_info_factura_auditoria.total_inv_compra_desp_factura, tbl15_info_factura_auditoria.cod_estado, 
tbl15_info_factura_auditoria.subtotal_total_precio_compra, tbl15_info_factura_auditoria.subtotal_total_precio_costo, 
tbl15_tercero.nombre1_tercero, tbl15_tipo_pago.nombre_tipo_pago, tbl15_tipo_forma_pago.nombre_tipo_forma_pago, 
tbl15_info_factura_auditoria.cod_tipo_inventario, tbl15_info_factura_auditoria.cod_tipo_producto_consumo
FROM tbl15_tipo_pago RIGHT JOIN (tbl15_tipo_forma_pago RIGHT JOIN (tbl15_tercero RIGHT JOIN tbl15_info_factura_auditoria ON tbl15_tercero.cod_tercero = tbl15_info_factura_auditoria.cod_tercero) 
ON tbl15_tipo_forma_pago.cod_tipo_forma_pago = tbl15_info_factura_auditoria.cod_tipo_forma_pago) ON tbl15_tipo_pago.cod_tipo_pago = tbl15_info_factura_auditoria.cod_tipo_pago
WHERE (tbl15_info_factura_auditoria.cod_info_factura_auditoria = '$cod_info_factura_auditoria')";
...
$sql_info_factura_auditoria = "SELECT url_img_orig_producto, url_img_min_producto FROM tbl15_info_factura_auditoria WHERE (cod_info_factura_auditoria = '$cod_info_factura_auditoria')";
$consulta_info_factura_auditoria = mysqli_query($conectar, $sql_info_factura_auditoria);
$matriz_info_factura_auditoria = mysqli_fetch_assoc($consulta_info_factura_auditoria);

$url_img_orig_producto                   = $matriz_info_factura_auditoria['url_img_orig_producto'];
$url_img_min_producto                    = $matriz_info_factura_auditoria['url_img_min_producto'];
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_factura_y_factura_auditoria_producto_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_factura_auditoria; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            var tipo_ajax = "tbl15_factura_auditoria_producto";
            var id = $(this).attr("class");
            //let id = this.id;
            $.post("guardar_info_factura_y_factura_auditoria_producto_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  ...
  <tr>
    <th style="text-align:center;"></th>
    <th style="text-align:center;"><a href="../admin/eliminar_auditoria.php?llave=<?php echo $cod_info_factura_auditoria?>&tab=<?php echo $tab?>&tipo=<?php echo $tipo?>&campo=<?php echo $campo?>"><img src=../imagenes/eliminar_grand.png alt="Eliminar"></a></th>
    ...
    <?php if ($cod_estado_inventario_bodega_global == '1') { ?>
    <th style="text-align:center;"><a href="../admin/reg_factura_compra_transferencia_temporal_producto_reg.php?cod_info_factura_auditoria=<?php echo $cod_info_factura_auditoria?>&tab=<?php echo $tab?>&tipo=<?php echo $tipo?>&campo=<?php echo $campo?>"><img src=../imagenes/repetir.png alt="Eliminar"></a></th>
    <?php } ?>
    <?php if ($cod_estado_sticker_barras_global == '1') { ?>
    <th style="text-align:center;"><a href="../admin/reg_sticker_factura_compra_reg.php?cod_info_factura_auditoria=<?php echo $cod_info_factura_auditoria?>&tab=<?php echo $tab?>&tipo=<?php echo $tipo?>&campo=<?php echo $campo?>"><img src=../imagenes/sticker_estandar_128_pdf_con_barra_peq.png alt="Eliminar"></a></th>
    <?php } ?>
    <th style="text-align:center;"><a href="<?php echo $url_img_orig_producto?>" target="_blank"><img src=../imagenes/adjuntar_archivo.png alt="Eliminar"></a></th>


    <th style="text-align:center;"><a href="../admin/factura_auditoria_productos_opcion_imprimir.php?cod_info_factura_auditoria=<?php echo $cod_info_factura_auditoria?>&tab=<?php echo $tab?>&tipo=<?php echo $tipo?>&campo=<?php echo $campo?>&pagina=<?php echo $pagina?>"><img src=../imagenes/imprimir_directa_pos.png alt="Eliminar"></a></th>
    <th style="text-align:center;"><a href="../admin/edit_facturacion_compra_iva_inc_producto_manual_pos.php?cod_info_factura_auditoria=<?php echo $cod_info_factura_auditoria?>&tab=<?php echo $tab?>&tipo=<?php echo $tipo?>&campo=<?php echo $campo?>"><img src=../imagenes/editar.png alt="Eliminar"></a></th>
    <th style="text-align:center;"></th>
  </tr>
</table>
