...
$nombre_tipo_nota_observacion = "NOTAS PERSONALES";

if (isset($_GET['delete'])) {
  $delete = $_GET['delete'];
  $sql = "DELETE FROM tbl15_nota_observacion where cod_nota_observacion = ".$delete;
 ...
 if(isset($_POST['submit'])){
        ...
        // make sql query
        $query = "INSERT INTO tbl15_nota_observacion(cod_administrador, nombre_nota_observacion, descripcion_nota_observacion, nombre_tipo_nota_observacion, fecha_ymd, fecha_hora) 
        VALUES('$session_id','$nombre_nota_observacion','$descripcion_nota_observacion', '$nombre_tipo_nota_observacion', '$fecha_ymd', '$fecha_hora')";
    ...
    //********************Selection********************
     $query = "SELECT cod_nota_observacion, nombre_nota_observacion, descripcion_nota_observacion, fecha_ymd FROM tbl15_nota_observacion WHERE nombre_tipo_nota_observacion = \"$nombre_tipo_nota_observacion\" ORDER BY cod_nota_observacion DESC";
    if(mysqli_query($conn, $query)){
...
<body>
  ...
  <!-- NOMBRE USUARIO HORIZONTAL INICIO -->
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
        <li class="dropdown">
          <?php //$query= mysqli_query($conn,"select * from register where cod_administrador = '$session_id'")or die(mysqli_error());
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <?php echo "Usuario sesion"; ?> <b class="caret"></b>
          </a>
  ...
  <!-- MENU NAVEGACION COLUMNA VERTICAL 1 INICIO -->
                <nav class="nav-primary hidden-xs">
                  <ul class="nav">
                    <li  class="active">
                      <a href="../admin/lista_apuntes_notas.php" class="active"><i class="fa fa-pencil icon"><b class="bg-info"></b></i><span>Notes</span></a>
                    </li>
                  </ul>
                </nav>
  <!-- MENU NAVEGACION COLUMNA VERTICAL 1  FIN -->
              </div>
            </section>
  ...
  <!-- REGISTRAR NOTA COLUMNA VERTICAL 2 INICIO -->
                  <aside class="aside-lg bg-light lter b-r">
                    <div class="wrapper">
                      <h4 class="m-t-none">Registrar Apunte</h4>
                      <form method="POST">
                        <div class="form-group">
                          <label>Titulo</label>
                          <input name="nombre_nota_observacion" type="text" placeholder="Titulo" class="input-sm form-control">
                        </div>
                        <div class="form-group">
                          <label>Descripcion</label>
                          <textarea name="descripcion_nota_observacion" class="form-control" rows="8" data-minwords="8" data-required="true" placeholder="Descripcion ......"></textarea>
                        </div>
                        <div class="m-t-lg"><button class="btn btn-sm btn-default" name="submit" type="submit">Add an event</button></div>
                      </form>
                    </div>
                </aside>
  <!-- REGISTRAR NOTA COLUMNA VERTICAL 2 FIN -->

  <!-- CICLO NOTA ABREV COLUMNA VERTICAL 3 INICIO -->
                          ...
                          <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <li class="list-group-item">
                                <div class="btn-group pull-right">
                                    <a href="../admin/edit_apuntes_notas.php?edit=<?php echo $note['cod_nota_observacion'];?>"><button type="button" class="btn btn-sm btn-default" title="Show"><i class="fa fa-eye"></i></button></a>
                                    <a href="../admin/lista_apuntes_notas.php?delete=<?php echo $note['cod_nota_observacion'];?>"><button type="button" class="btn btn-sm btn-default" title="Remove"><i class="fa fa-trash-o bg-danger"></i></button></a>
                                  </div>
                                <h3 style = "text-transform:uppercase;"><b><?php echo $note['nombre_nota_observacion'] ?></b></h3>
                                <p><?php echo substr($note['descripcion_nota_observacion'], 0, 200)?></p>
  ...
  <!-- CICLO NOTA ABREV COLUMNA VERTICAL 3 FIN -->

  <!-- CICLO NOTA COMPELTA COLUMNA VERTICAL 4 INICIO -->
                    ...
                    <section class="scrollable">
                      <div class="wrapper">
                        <section class="panel panel-default">
                          <?php
                             $get_note = mysqli_query($conn,"select * from tbl15_nota_observacion WHERE cod_administrador = \"$session_id\" LIMIT 1") or die(mysqli_error());
                          ...
                          <ul class="list-group">
                            <li class="list-group-item">
                                <p><?php echo $row['descripcion_nota_observacion']; ?> </p>
                            </li>
                          </ul>
                          <?php } ?> 
                        </section>
                        ...
                        <section class="panel clearfix bg-info lter">
                          <div class="panel-body">
                            ...
                            <div class="clear">
                              ...
                              <a href="#" target="_blank" class="btn btn-xs btn-success m-t-xs">Subscribe</a>
                            </div>
                          </div>
                        </section>
-->
  ...
  <!-- CICLO NOTA COMPELTA COLUMNA VERTICAL 4 FIN -->
          </section>
