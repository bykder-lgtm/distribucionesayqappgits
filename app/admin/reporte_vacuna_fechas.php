...
<a class="btn btn-primary" href="#"><h6>Reporte Vacunas Por Rango de Fechas</h6></a>
</div>
<div class="row-fluid">
...
<table align="center" border="0" width="25%" cellspacing="0" style="font-family: Mono; font-size: <?php echo $tamano_font_emp ?>pt;">
  ...
  <tr>
    ...
    <td><strong><em><input class="input-block-level" name="fecha_ymd_venta_producto_ini" type="date" value="<?php echo $fecha_ymd_venta_producto_ini ?>" required/></em></strong></td>
  </tr>
  <tr>
    <td><strong><em>FECHA FIN: </em></strong></td>
    <td><strong><em><input class="input-block-level" name="fecha_ymd_venta_producto_fin" type="date" value="<?php echo $fecha_ymd_venta_producto_fin ?>" required/></em></strong></td>
  </tr>
  <tr>
...
WHERE (fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') AND (nombre_tipo_producto = '$nombre_tipo_producto')";
...
<td align="center">TIPO: <?php echo $nombre_tipo_producto ?><br>FECHA INI: <?php echo $fecha_ymd_venta_producto_ini ?><br>FECHA FIN: <?php echo $fecha_ymd_venta_producto_fin ?></td>
</form> 
...
WHERE (tbl15_venta_producto.fecha_ymd_venta_producto BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') AND (tbl15_venta_producto.nombre_tipo_producto = '$nombre_tipo_producto')
