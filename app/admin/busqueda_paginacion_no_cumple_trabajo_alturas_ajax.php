...
$pagina                   = $concatenador."lista_no_cumple_trabajo_alturas.php";
//---------------------------------------------------------------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------------------------------------------------------------//
    ...
    if ( $_GET['busqueda_ajax'] != "" ) {
        $sWhere = "WHERE (";
        $sWhere = "WHERE ((tbl15_trabajo_altura.nombre_acepta_trab_altura LIKE 'NO CUMPLE') AND ";
...
if ($_GET['busqueda_ajax'] == "") {
    $sWhere.=" WHERE (tbl15_trabajo_altura.nombre_acepta_trab_altura LIKE 'NO CUMPLE') ORDER BY tbl15_trabajo_altura.fecha_time DESC";
} else {
    ...
    $reload = '../admin/lista_no_cumple_trabajo_alturas.php';
    //loop through fetched data
    if ($numrows>0) { ?>
<table class="table table-striped jambo_table bulk_action">
<thead>
<tr class="headings">
<th style="text-align:center" class="column-title">TBA</th>
...
<th style="text-align:center" class="column-title">Remisión</th>
...
$sql_consulta = "SELECT tbl15_trabajo_altura.cod_trabajo_altura, tbl15_trabajo_altura.cod_historia_clinica, tbl15_trabajo_altura.nombre_acepta_trab_altura,
...
tbl15_trabajo_altura.fecha_time, tbl15_cliente.url_img_foto_min, tbl15_cliente.url_img_firma_min, tbl15_trabajo_altura.nombre_empresa, 
...
$nombre_acepta_trab_altura = $datos_consulta['nombre_acepta_trab_altura'];
$nombre_empresa            = $datos_consulta['nombre_empresa'];
$nombre_tipo_remision      = $datos_consulta['nombre_tipo_remision'];
$fecha_control             = $datos_consulta['fecha_control'];
...
<td style="text-align:center"><?php echo $cod_trabajo_altura?></td>
<td style="text-align:center"><a href="../admin/edit_trabajo_altura.php?cod_trabajo_altura=<?php echo $cod_trabajo_altura?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/tbl15_trabajo_altura.png" class="img-polaroid" alt=""></a></td>
<td style="text-align:left"><?php echo $cedula?></td>
<td style="text-align:left"><?php echo $nombres.' '.$apellido1?></td>
<td style="text-align:center"><?php echo $motivo_trabajo_altura?></td>
<td style="text-align:left"><?php echo $nombre_empresa?></td>
<td style="text-align:center"><?php echo $nombre_acepta_trab_altura?></td>
<td style="text-align:center"><?php echo $nombre_tipo_remision?></td>
<td style="text-align:center"><?php echo $fecha_control?></td>
<td style="text-align:center"><?php echo $fecha_dmy?></td>
<td style="text-align:center"><?php echo $cod_historia_clinica?></td>
<td style="text-align:center"><a href="../admin/ver_trabajo_altura_version_pdf.php?cod_trabajo_altura=<?php echo $cod_trabajo_altura?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>" target="_blank"><img src="../imagenes/imprimir_peq.png" class="img-polaroid" alt=""></a></td>
<td style="text-align:center"><a href="../admin/edit_trabajo_altura.php?cod_trabajo_altura=<?php echo $cod_trabajo_altura?>&cod_cliente=<?php echo $cod_cliente?>&cod_historia_clinica=<?php echo $cod_historia_clinica?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
</tr>
<?php } //end while ?>
<tr>
