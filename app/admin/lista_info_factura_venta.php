...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th style="text-align:center; font-size:13pt;">Edit</th>
            <?php } ?>
            <?php if ($cod_estado_duplicar_factura_venta == '1') { ?>
            <th style="text-align:center; font-size:13pt;">Duplicar</th>
            <?php } ?>
            ...
            <th style="text-align:center; font-size:13pt;">Abonado</th>
            <th style="text-align:center; font-size:13pt;">Pendiente</th>
            ...
            <th style="text-align:center; font-size:13pt;"></th>
            <?php if ($cod_estado_observacion_tercero_venta_global == '1') { ?><th style="text-align:center; font-size:13pt;">Observacion</th><?php } ?>
            <th style="text-align:center; font-size:13pt;"><?php echo $nombre_concepto_multi_virtual; ?></th>
            <?php if ($cod_estado_servicio_cava_global == '1') { ?><th style="text-align:center; font-size:13pt;">Cava</th><?php } ?>
            ...
            <?php if ($cod_estado_enviar_factura_venta_electronica_dian_api == '1') { ?><!--<th style="text-align:center; font-size:13pt;">Dian</th>--><?php } ?>
...
?>
        <tr id="<?php echo $cod_info_factura_venta;?>">
            <?php if ($cod_estado_facturacion_venta_editar == '1') { ?>
            <th id="edit<?php echo $cod_info_factura_venta;?>" style="text-align:center"><a href="../admin/edit_factura_venta.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></th>
            <?php } ?>
            <?php if ($cod_estado_duplicar_factura_venta == '1') { ?>
            <th id="edit<?php echo $cod_info_factura_venta;?>" style="text-align:center"><a href="../admin/duplicar_factura_venta_venta.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>"><img src="../imagenes/duplicar_factura_venta.png" class="img-polaroid" alt=""></a></th>
            <?php } ?>
            <!--<th class="service_list" id="cod_info_factura_venta<?php echo $cod_info_factura_venta ?>" data="<?php echo $cod_info_factura_venta ?>"><a class="eliminar" id="cod_info_factura_venta<?php echo $cod_info_factura_venta ?>"><img src="../imagenes/eliminar_grand.png" class="img-polaroid" alt=""></a></th>-->
            <th style="text-align:center; font-size:13pt;" id="cod_factura<?php echo $cod_info_factura_venta;?>"><?php echo ($prefijo_resolucion_facturacion.'|'.$cod_factura)?></th>
            <th style="text-align:left; font-size:13pt;" id="nombre_tercero<?php echo $cod_info_factura_venta;?>"><?php echo $nombre_tercero?><?php if ($cod_estado_saldo_recarga_global == '1') { echo "<br>(".$cliente_vendedor_tercero.' - '.$cod_administrador_tercero.')'; } ?></th>
            <th style="text-align:right; font-size:13pt;" id="total_precio_venta<?php echo $cod_info_factura_venta;?>"><?php echo number_format($total_precio_venta, 0, ",", ".") ?></th>

            <?php if ($cod_estado_modulo_cuenta_cobrar_abono_editar_venta_global == '1') { ?>
            <th style="text-align:right; font-size:13pt;" id="total_precio_venta<?php echo $cod_info_factura_venta;?>"><?php echo number_format($abonado, 0, ",", ".") ?></th>
            <th style="text-align:right; font-size:13pt;" id="total_precio_venta<?php echo $cod_info_factura_venta;?>"><?php echo $url_redirect?></th>
            <th style="text-align:right; font-size:13pt;" id="total_precio_venta<?php echo $cod_info_factura_venta;?>"><?php echo $boton_alerta_caducidad ?></th>
            <?php } ?>

            <th style="text-align:center; font-size:13pt;" id="fecha_anyo<?php echo $cod_info_factura_venta;?>"><?php echo $fecha_anyo?></th>
            <th style="text-align:center; font-size:13pt;" id="fecha_hora<?php echo $cod_info_factura_venta;?>"><?php echo $fecha_hora?></th>
            <th style="text-align:center; font-size:13pt;" id="nombre_tipo_pago<?php echo $cod_info_factura_venta;?>"><?php echo $nombre_tipo_pago?></th>
            <th style="text-align:center; font-size:13pt;" id="nombre_tipo_forma_pago<?php echo $cod_info_factura_venta;?>"><?php echo $nombre_tipo_forma_pago?></th>
            <th style="text-align:center; font-size:13pt;" id="nombre_tipo_factura<?php echo $cod_info_factura_venta;?>"><?php echo $nombre_tipo_factura?></th>
            <th style="text-align:center; font-size:13pt;" id="nombre_tipo_factura<?php echo $cod_info_factura_venta;?>"><?php echo $cuenta?></th>
            <th style="text-align:center; font-size:13pt;" id="cod_info_factura_venta<?php echo $cod_info_factura_venta;?>"><?php echo $nombre_estado_factura_dataico_dian?></th>
            <?php if ($cod_estado_observacion_tercero_venta_global == '1') { ?><th style="text-align:left; font-size:13pt;" id="observacion_tercero<?php echo $cod_info_factura_venta;?>"><?php echo $observacion_tercero?></th><?php } ?>
            <th style="text-align:center; font-size:13pt;" id="cod_info_factura_venta<?php echo $cod_info_factura_venta;?>"><?php echo $cod_base_caja?></th>
            <?php if ($cod_estado_servicio_cava_global == '1') { ?><th style="text-align:center"><a href="<?php echo $url_entrega_cava; ?>"><?php echo $img_entrega_cava; ?></a></th><?php } ?>
            <th style="text-align:center; font-size:13pt;" id="cod_info_factura_venta<?php echo $cod_info_factura_venta;?>"><?php echo $cod_info_factura_venta?></th>
            <?php if ($cod_estado_facturacion_venta_imprimir == '1') { ?>
            <th style="text-align:center;" id="edit<?php echo $cod_info_factura_venta;?>"><a href="../admin/venta_productos_opcion_imprimir.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></th>
            <?php } ?>
            <!--
            <th id="excel<?php echo $cod_info_factura_venta;?>" style="text-align:center"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=EXCEL&cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/excel.png" class="img-polaroid" alt=""></a></th>
            <th id="lista<?php echo $cod_info_factura_venta;?>" style="text-align:center"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=LISTA&cod_info_factura_venta=<?php echo $cod_info_factura_venta?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></th>
            -->
            <?php if ($cod_estado_enviar_factura_venta_electronica_dian_api == '1') { ?><!--<td style="text-align:center;" id="apidian<?php echo $cod_info_factura_venta ?>" class="service_list" data="<?php echo $cod_info_factura_venta ?>"><a class="EnviarFacturaDianDataico" id="cod_info_factura_venta<?php echo $cod_info_factura_venta ?>" style="cursor:pointer;"><img src="../imagenes/btn_dian_peq.png" class="img-polaroid" alt=""></a></td>--><?php } ?>
