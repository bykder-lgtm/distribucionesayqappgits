...
$borrar_sql = sprintf("DELETE FROM tbl15_info_cotizacion_factura_compra WHERE cod_info_cotizacion_factura_compra = '$cod_info_cotizacion_factura_compra'");
...
$Result1 = mysqli_query($conectar, $borrar_sql) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/admin/lista_info_factura_cotizacion_compra.php">
<?php } ?>
