...
if (isset($_POST['nombre_escolaridad']) <> '') { $nombre_escolaridad = mysqli_real_escape_string($conectar, ($_POST['nombre_escolaridad'])); } else { $nombre_escolaridad = ''; }

$obtener_escolaridad = "SELECT nombre_escolaridad FROM tbl15_escolaridad WHERE nombre_escolaridad = '".($nombre_escolaridad)."'";
...
<?php } else {
$sql_data = "INSERT INTO tbl15_escolaridad (nombre_escolaridad) VALUES ('$nombre_escolaridad')";
