...
if (isset($_GET['fecha_pago_reg_ini'])) {
    ...
    if ($cod_tercero==0) {
        ...
        $filtro_consulta_tercero                     = "AND (cod_tercero_propietario = '$cod_tercero')";
        $filtro_consulta_tercero_rel                 = "AND (tbl15_venta_producto.cod_tercero_propietario = '$cod_tercero')";
    }
...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>Reporte Pagos Propietarios</font></a></th>
    </tr>
</table>
...
<fieldset><legend>INFO</legend>
    <table class="table table-striped">
        <thead>
            <tr>
                <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">PROPIETARIO</th>
...
<fieldset><legend>PAGOS A PROPIETARIOS</legend>
    <table class="table table-striped">
    <thead>
    <tr>
        ...
        <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">CUATRO POR MIL</th>
        <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">RETEFUENTE PARA TERCEROS</th>
        <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">REPARACIONES</th>
        <th style="text-align:center; font-size:11pt; background-color:#DBE0F3; color:#000;">OTROS CONCEPTOS</th>
    ...
    $total_deduccion_imp_cuatroxmil                    = 0;
    $total_deduccion_retefuente                        = 0;
    $total_deduccion_reparacion                        = 0;
    $total_deduccion_otro_concepto                     = 0;
    ...
    cod_tercero_propietario, fecha_pago_reg, cod_producto, nombre_producto, cod_administrador, hora_pago_reg, cod_factura, cod_tercero, deduccion_imp_cuatroxmil, 
    deduccion_retefuente, deduccion_reparacion, deduccion_otro_concepto 
FROM tbl15_cuentas_cobrar_factura_comision_propietario WHERE (fecha_pago_reg BETWEEN '$fecha_pago_reg_ini' AND '$fecha_pago_reg_fin') $filtro_consulta_tercero $filtro_consulta_cod_factura 
    ...
    $total_deduccion_imp_cuatroxmil                   += $deduccion_imp_cuatroxmil;
    $total_deduccion_retefuente                       += $deduccion_retefuente;
    $total_deduccion_reparacion                       += $deduccion_reparacion;
    $total_deduccion_otro_concepto                    += $deduccion_otro_concepto;
    ...
    <tr>
        ...
        <td style="text-align:right; font-size:11pt;"><?php echo number_format($deduccion_imp_cuatroxmil, 0, ",", ".") ?></td>
        <td style="text-align:right; font-size:11pt;"><?php echo number_format($deduccion_retefuente, 0, ",", ".") ?></td>
        <td style="text-align:right; font-size:11pt;"><?php echo number_format($deduccion_reparacion, 0, ",", ".") ?></td>
        <td style="text-align:right; font-size:11pt;"><?php echo number_format($deduccion_otro_concepto, 0, ",", ".") ?></td>
    ...
    <?php } ?>
        ...
        <th style="text-align:right; font-size:11pt; background-color:#DBE0F3; color:#000;"><?php echo number_format($total_deduccion_imp_cuatroxmil, 0, ",", ".") ?></th>
        <th style="text-align:right; font-size:11pt; background-color:#DBE0F3; color:#000;"><?php echo number_format($total_deduccion_retefuente, 0, ",", ".") ?></th>
        <th style="text-align:right; font-size:11pt; background-color:#DBE0F3; color:#000;"><?php echo number_format($total_deduccion_reparacion, 0, ",", ".") ?></th>
        <th style="text-align:right; font-size:11pt; background-color:#DBE0F3; color:#000;"><?php echo number_format($total_deduccion_otro_concepto, 0, ",", ".") ?></th>
        <th style="text-align:right; font-size:11pt; background-color:#DBE0F3; color:#000;"></th>
        <th style="text-align:right; font-size:11pt; background-color:#DBE0F3; color:#000;"></th>
        <th style="text-align:right; font-size:11pt; background-color:#DBE0F3; color:#000;"></th>
    </tbody>
