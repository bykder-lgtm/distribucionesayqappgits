...
<!--<link href="../estilo_css/jquerysctipttop.css" rel="stylesheet" type="text/css">-->
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    /** IE SUPPORT **/
    var canvasDiv = document.getElementById('img_firma');
...
/** Save Canvas **/
$("#tomar_firma").click(function saveSig() {
        var canvas_img_data = canvas.toDataURL('image/jpg');
        var img_data = canvas_img_data.replace(/^data:image\/(png|jpg);base64,/, "");
        $.ajax({
            url: '../admin/guardar_img_firma_ajax.php',
            data: { cod_cliente:<?php echo $cod_cliente ?>, cedula:<?php echo $cedula ?>, img_data:img_data },
            type: 'post',
            dataType: 'json',
    ...
    /** Clear Canvas **/
 $("#borrar_firma").click(function clearSig() {
    ...
    $('#img_firma').mousemove(function (e) {
        if (paint) {
    ...
    $('#img_firma').mousedown(function (e) {
...
<table border="1" class="table table-responsive">
    ...
    <tbody>
        <tr>
            ...
            <form><input type="button" value="Tomar Foto" onClick="tomar_foto()"></form>
        </td>
            <td style="text-align:center; width:50%"><div align="center" id="vista_imagen_tomada"></div></td>
        </tr>
    </tbody>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
...
<div class="content">
        <div class="left">
            <div id="img_firma" style="border: 1px solid #000; height: 150px; width: 400px;"></div>
            <button id="borrar_firma" type="button">Borar Firma</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button id="tomar_firma" type="button">Tomar Firma</button>
            <span class="add-on"><div align="center" id="vista_firma_tomada"></div></span>
        </div>
</div>
</table>
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
