...
if ((isset($_GET['cod_costo_operacional'])) && ($_GET['cod_costo_operacional'] != "")) {

$cod_costo_operacional           = intval($_GET["cod_costo_operacional"]);
$cod_pyg                         = intval($_GET["cod_pyg"]);
$fecha_mes                       = addslashes($_GET["fecha_mes"]);

$borrar_sql = ("DELETE FROM tbl15_costo_operacional WHERE cod_costo_operacional = '$cod_costo_operacional'");
