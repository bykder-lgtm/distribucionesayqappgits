...
<td style="text-align:center">
    <input name="precio_venta_producto<?php echo $contador; ?>" type="number" id="precio_venta_producto<?php echo $contador;?>" class="<?php echo $cod_cambio_precio_venta_predeterm_producto_temporal;?>" value="<?php echo $precio_ventas;?>" min="0" style="width: 100px;" />
</td>
<?php } ?>
