...
<a href="#"><h4>Lista de <?php echo $nombre_tipo_tercero_titulo?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<?php if ($cod_estado_tercero_registrar == '1') { ?><a href="../admin/reg_siscredito_tercero.php?nombre_tipo_tercero=<?php echo $nombre_tipo_tercero?>">Registrar <?php echo $nombre_tipo_tercero_titulo?></h4></a><?php } ?>
</div>
<hr>
<div class="row-fluid">
...
<!-- ***************************************************************************************************************************** -->
<?php
$sql_tercero_cliente = "SELECT * FROM tbl15_tercero WHERE (nombre_tipo_tercero = '$nombre_tipo_tercero')";
...
<table class="table table-striped">
	<thead>
		<tr>
			<th style="text-align:right; width: 30%">Total <?php echo $nombre_tipo_tercero_titulo?>s: </th>
			<td style="text-align:left; width: 30%"><?php echo number_format($total_reg_cliente, 0, ",", ".")?></td>
		</tr>
	</thead>
</table>
...
function load(page){
    ...
    var nombre_tipo_tercero = "<?php echo $nombre_tipo_tercero; ?>";
    var numero_registro_por_pagina = $("#numero_registro_por_pagina").val();
    var tabla = $("#tabla").val();
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/busqueda_paginacion_siscredito_tercero_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&numero_registro_por_pagina='+numero_registro_por_pagina+'&nombre_tipo_tercero='+nombre_tipo_tercero+'&tabla='+tabla,
