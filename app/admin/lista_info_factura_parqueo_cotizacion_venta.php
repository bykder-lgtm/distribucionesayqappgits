...
<a class="btn btn-primary" href="#"><h6>Lista Parqueos</h6></a>
</div>
<div class="row-fluid">
...
$fecha                                             = date("Y-m-d");
$filtro_consulta_nombre_estado_factura_cerrada     = "(nombre_estado_factura = 'CERRADA')";
...
$filtro_consulta_vendedor_rel = "AND (tbl15_info_parqueo_cotizacion_factura_venta.cod_administrador = '$cod_administrador')";
}
if ($cod_tercero==0) {
...
$filtro_consulta_tercero_rel = "AND (tbl15_info_parqueo_cotizacion_factura_venta.cod_tercero = '$cod_tercero')";
}
if ($cod_tipo_pago==0) {
...
$filtro_consulta_tipo_pago_rel = "AND (tbl15_info_parqueo_cotizacion_factura_venta.cod_tipo_pago = '$cod_tipo_pago')";
}
...
$filtro_consulta_tipo_forma_pago_rel = "AND (tbl15_info_parqueo_cotizacion_factura_venta.cod_tipo_forma_pago = '$cod_tipo_forma_pago')";
}
if ($cod_factura=='0' || $cod_factura=='') {
$filtro_consulta_cod_factura = "WHERE ";
$filtro_consulta_cod_factura_rel = "WHERE ";
} else {
$filtro_consulta_cod_factura = "WHERE (cod_factura = '$cod_factura') AND ";
$filtro_consulta_cod_factura_rel = "WHERE (tbl15_info_parqueo_cotizacion_factura_venta.fecha_anyo BETWEEN '$fecha_ymd_venta_producto_ini' AND '$fecha_ymd_venta_producto_fin') AND (tbl15_info_parqueo_cotizacion_factura_venta.cod_factura = '$cod_factura')";
}
...
$filtro_consulta_nombre_tipo_factura_rel = "AND (tbl15_info_parqueo_cotizacion_factura_venta.nombre_tipo_factura = '$nombre_tipo_factura')";
}
...
<table class="table table-striped">
    <tr>
        <th style="text-align:left"><a href="#"><font size='+2'>Lista Ingreso de Parqueo</font></a></th>
        <th style="text-align:right"><a href="../admin/facturacion_parqueo_cotizacion_venta_temporal_producto_manual_pos.php"><font size='+2'>Registrar Ingreso Parqueo</font></a></th>
    </tr>
</table>
...
<table class="table table-striped" cellspacing="0" cellpadding="20">
  <tr>
    ...
    <td style="text-align:center;"><input type="number" id="cod_factura" name="cod_factura" value="" autofocus/></td>
...
<tbody>
<?php
$sql_info_factura = "SELECT * FROM tbl15_info_parqueo_cotizacion_factura_venta 
$filtro_consulta_cod_factura  
$filtro_consulta_vendedor $filtro_consulta_tercero $filtro_consulta_tipo_pago $filtro_consulta_tipo_forma_pago 
$filtro_consulta_nombre_estado_factura_cerrada 
ORDER BY cod_info_parqueo_cotizacion_factura_venta DESC LIMIT 0, 800";
...
$cod_info_parqueo_cotizacion_factura_venta    = $info_info_factura['cod_info_parqueo_cotizacion_factura_venta'];
...
?>
<tr id="<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>">
<td id="edit<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><a href="../admin/edit_factura_parqueo_cotizacion_venta.php?cod_info_parqueo_cotizacion_factura_venta=<?php echo $cod_info_parqueo_cotizacion_factura_venta ?>"><img src="../imagenes/editar.png" class="img-polaroid" alt=""></a></td>
<!--<td class="service_list" id="cod_info_parqueo_cotizacion_factura_venta<?php echo $cod_info_parqueo_cotizacion_factura_venta ?>" data="<?php echo $cod_info_parqueo_cotizacion_factura_venta ?>"><a class="eliminar" id="cod_info_parqueo_cotizacion_factura_venta<?php echo $cod_info_parqueo_cotizacion_factura_venta ?>"><img src="../imagenes/eliminar_grand.png" class="img-polaroid" alt=""></a></td>-->
<td style="text-align:center" id="cod_factura<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><?php echo $cod_factura?></td>
<td style="text-align:left" id="nombre_empresa<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:left"><?php echo $nombre_cliente?></td>
<td style="text-align:right" id="nombre_empresa<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:left"><?php echo number_format($total_precio_venta, 0, ",", ".") ?></td>
<td style="text-align:center" id="fecha_anyo<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><?php echo $fecha_anyo?></td>
<td style="text-align:center" id="fecha_hora<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><?php echo $fecha_hora?></td>
<td style="text-align:center" id="edit<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><a href="../admin/parqueo_cotizacion_venta_productos_opcion_imprimir.php?cod_info_parqueo_cotizacion_factura_venta=<?php echo $cod_info_parqueo_cotizacion_factura_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></td>
<td style="text-align:center" id="imp<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><a href="../admin/enviar_parqueo_cotizacion_venta_a_venta_producto_temporal.php?cod_info_parqueo_cotizacion_factura_venta=<?php echo $cod_info_parqueo_cotizacion_factura_venta ?>&tab=<?php echo $tab?>&campo=<?php echo $campo?>&tipo=<?php echo $tipo?>&pagina=<?php echo $pagina?>&fecha=<?php echo $fecha_anyo ?>"><img src="../imagenes/salida_grande.png" class="img-polaroid" alt=""></a></td>
<!--
<td id="excel<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=EXCEL&cod_info_parqueo_cotizacion_factura_venta=<?php echo $cod_info_parqueo_cotizacion_factura_venta ?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/excel.png" class="img-polaroid" alt=""></a></td>
<td id="lista<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>" style="text-align:center"><a href="../admin/redireccionador_evaluados_paraclinicos.php?fecha=<?php echo $fecha_anyo ?>&origen=<?php echo $origen ?>&destino=LISTA&cod_info_parqueo_cotizacion_factura_venta=<?php echo $cod_info_parqueo_cotizacion_factura_venta?>&cod_factura=<?php echo $cod_factura ?>" target="_blank"><img src="../imagenes/ver_lista_peq.png" class="img-polaroid" alt=""></a></td>
-->
</tr id="<?php echo $cod_info_parqueo_cotizacion_factura_venta;?>">
<?php } ?>
</tbody>
...
$(document).ready(function() {
    ...
    $('.eliminar').click(function(){
        ...
        var cod_info_parqueo_cotizacion_factura_venta = $(this).parent().attr('data');
        var dataString = 'llave='+cod_info_parqueo_cotizacion_factura_venta+'&'+'tab='+'<?php echo $tab ?>'+'&'+'campo='+'<?php echo $campo ?>'+'&'+'tipo='+'<?php echo $tipo ?>';
        ...
        $.ajax({
            ...
            success: function() {           
                $('#eliminar-ok').empty();
                $('#eliminar-ok').append('<div align="center" class="correcto">Se ha eliminado correctamente el codigo = '+cod_info_parqueo_cotizacion_factura_venta+'.</div>').fadeIn("slow");
                $('#'+parent).fadeOut("slow");
                $('#cod_info_factura_'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#cod_factura'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#nombre_empresa'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#fecha_anyo'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#fecha_hora'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#nombre_tipo_producto'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#edit'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#excel'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#imp'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#lista'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                $('#tr'+cod_info_parqueo_cotizacion_factura_venta).fadeOut("slow");
                //$('#'+parent).remove();
            }
        });
    });
