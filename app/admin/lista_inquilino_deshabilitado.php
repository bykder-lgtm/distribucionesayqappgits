...
<a class="btn btn-primary" href="#">Arrendatarios Deshabilitados</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="btn btn-success" href="../admin/lista_inquilino.php">Arrendatarios Habilitados</a>
<?php } ?>
<br>
<!--
...
<script type="text/javascript" src="../admin/busqueda_paginacion_inquilino_deshabilitado_ajax.js"></script>
