...
<div class="breadcrumbs"><a href="<?php echo $pagina; ?>"><h4>Editar Dependencia</h4></a></div>
<div class="row-fluid">
...
<!-- ***************************************************************************************************************************** -->
<?php
$cod_tipo_inmueble             = intval($_GET['cod_tipo_inmueble']);

$mostrar_datos_sql = "SELECT * FROM tbl15_tipo_inmueble WHERE cod_tipo_inmueble = '$cod_tipo_inmueble'";
...
?>
<form name="formulario_edicion" accept-charset="utf-8" method="post" action="../admin/edit_tipo_inmueble_reg.php">
<fieldset>
...
<td><input type="text" name="nombre_tipo_inmueble" value="<?php echo ($nombre_tipo_inmueble) ?>"  class="input-block-level" required/></td>
<td>        
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<hr>
<input type="hidden" name="cod_tipo_inmueble" value="<?php echo $cod_tipo_inmueble ?>"/>
