...
<?php //include_once("../admin/05_modulo_algunas_categorias.php"); ?>
        ...
        <div class="container">
            ...
            <?php
                $sql_producto = "SELECT * FROM tbl15_portafolio_servicio WHERE (cod_estado = '10') ORDER BY cod_portafolio_servicio ASC";
            ...
            ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div style="text-align:center;" class="shop-cat-bo">
                        <div id="div4_simulflag"><img style="width:120px;" class="img-fluid" src="../imagenes/requisito_correo.png" alt="" /></div>
