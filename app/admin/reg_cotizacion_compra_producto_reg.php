...
$pagina                             = addslashes($_GET['pagina'])."?&cod_info_cotizacion_factura_compra=".$cod_info_cotizacion_factura_compra."&foco=".$foco."&pagina=edit_factura_cotizacion_compra.php";
...
//---------------------------------------------------------------------FACTURA NUEVA INICIO----------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_cotizacion_compra_producto (cod_info_cotizacion_factura_compra, cod_tercero, cod_producto, cod_producto_barra, nombre_producto, und_compra, 
