...
$fecha_ymd_venta_producto_ini            = "2010-01-01";
}
...
if ($cod_administrador==0) {
$filtro_consulta_vendedor = "AND (cod_administrador = '$cod_administrador')";
$filtro_consulta_vendedor_rel = "AND (cod_administrador = '$cod_administrador')";
} else {
$filtro_consulta_vendedor = "AND (cod_administrador = '$cod_administrador')";
$filtro_consulta_vendedor_rel = "AND (tbl15_venta_producto.cod_administrador = '$cod_administrador')";
}
...
<?php if ($cod_estado_facturacion_venta == '1') { ?>
...
<td style="text-align:left" id="nombre_tercero<?php echo $cod_info_factura_venta;?>" style="text-align:left"><?php echo $nombre_tercero?></td>
...
<td style="text-align:center" id="nombre_tipo_pago<?php echo $cod_info_factura_venta;?>" style="text-align:center"><?php echo $nombre_tipo_pago?></td>
<td style="text-align:center" id="nombre_tipo_forma_pago<?php echo $cod_info_factura_venta;?>" style="text-align:center"><?php echo $nombre_tipo_forma_pago?></td>
<td style="text-align:center" id="nombre_tipo_factura<?php echo $cod_info_factura_venta;?>" style="text-align:center"><?php echo $nombre_tipo_factura?></td>
<td style="text-align:center" id="nombre_tipo_factura<?php echo $cod_info_factura_venta;?>" style="text-align:center"><?php echo $cuenta?></td>
<?php if ($cod_estado_observacion_tercero_venta_global == '1') { ?><td style="text-align:left" id="observacion_tercero<?php echo $cod_info_factura_venta;?>" style="text-align:center"><?php echo $observacion_tercero?></td><?php } ?>
<td style="text-align:center" id="cod_info_factura_venta<?php echo $cod_info_factura_venta;?>" style="text-align:center"><?php echo $cod_info_factura_venta?></td>
<?php if ($cod_estado_facturacion_venta_imprimir == '1') { ?>
<td style="text-align:center" id="edit<?php echo $cod_info_factura_venta;?>" style="text-align:center"><a href="../admin/venta_productos_opcion_imprimir.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta ?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/imprimir_directa_pos_peq2.png" class="img-polaroid" alt=""></a></td>
<?php } ?>
<!--
