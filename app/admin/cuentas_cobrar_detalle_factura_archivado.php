...
$sql_total_facturas = "SELECT tbl15_cuentas_cobrar_copia.cod_cuentas_cobrar, tbl15_cuentas_cobrar_copia.cod_factura, tbl15_cuentas_cobrar_copia.cod_tercero, 
...
tbl15_cuentas_cobrar_copia.mensaje, tbl15_cuentas_cobrar_copia.fecha_pago, tbl15_cuentas_cobrar_copia.vendedor, tbl15_cuentas_cobrar_copia.cod_info_factura_venta
...
WHERE (tbl15_cuentas_cobrar_copia.cod_tercero='$cod_tercero') AND (tbl15_cuentas_cobrar_copia.subtotal > '0') ORDER BY tbl15_cuentas_cobrar_copia.fecha_invert DESC";
...
$calcular_datos_cuenta_cobrar = "SELECT tbl15_cuentas_cobrar_copia.cod_cuentas_cobrar, tbl15_cuentas_cobrar_copia.cod_factura, tbl15_cuentas_cobrar_copia.cod_tercero, 
tbl15_cuentas_cobrar_copia.monto_deuda, tbl15_cuentas_cobrar_copia.abonado, tbl15_cuentas_cobrar_copia.subtotal, tbl15_tercero.nombre1_tercero, tbl15_tercero.apellido1_tercero, 
tbl15_cuentas_cobrar_copia.mensaje, tbl15_cuentas_cobrar_copia.fecha, tbl15_cuentas_cobrar_copia.vendedor
FROM tbl15_tercero RIGHT JOIN tbl15_cuentas_cobrar_copia ON tbl15_tercero.cod_tercero = tbl15_cuentas_cobrar_copia.cod_tercero 
WHERE (tbl15_cuentas_cobrar_copia.cod_tercero='$cod_tercero') ORDER BY tbl15_cuentas_cobrar_copia.fecha_invert DESC";
$consulta_datos_cuenta_cobrar = mysqli_query($conectar, $calcular_datos_cuenta_cobrar);
$total_datos = mysqli_num_rows($consulta_datos_cuenta_cobrar);
while ($datos_cuenta_cobrar = mysqli_fetch_assoc($consulta_datos_cuenta_cobrar)) {
