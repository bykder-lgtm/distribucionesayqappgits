...
if (isset($_GET['precio_venta_producto_pred'])) { $precio_venta_producto_pred = addslashes($_GET['precio_venta_producto_pred']); } else { $precio_venta_producto_pred = 'precio_venta_producto'; }
  ...
  <tr>
    ...
    <td style="text-align:center;">
        <select name="nombre_tipo_producto" id="nombre_tipo_producto" class="selectpicker" data-show-subtext="true" data-live-search="true" style="width: 150px;">
            ...
            $consulta2_sql = "SELECT cod_tipo_producto, nombre_tipo_producto, cod_estado FROM tbl15_tipo_producto WHERE (cod_estado = '1') ORDER BY nombre_tipo_producto ASC";
            $consulta2 = mysqli_query($conectar, $consulta2_sql);
            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
    ...
    <td style="text-align:center;">
        <select name="nombre_tipo_precio_venta" id="nombre_tipo_precio_venta" class="selectpicker" data-show-subtext="true" data-live-search="true" style="width: 150px;">
            ...
            $consulta2_sql = "SELECT cod_tipo_precio_venta, nombre_tipo_precio_venta, cod_estado FROM tbl15_tipo_precio_venta WHERE (cod_estado = '1') ORDER BY cod_tipo_precio_venta ASC";
            $consulta2 = mysqli_query($conectar, $consulta2_sql);
            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
...
<table class="table table-striped">
    <tr>
        <th style="text-align:center"><a href="<?php echo $pagina ?>?precio_venta_producto_pred=precio_venta_producto&cod_barra_nombre_producto=<?php echo $cod_barra_nombre_producto?>&cod_dependencia=<?php echo $cod_dependencia?>&nombre_tipo_producto=<?php echo $nombre_tipo_producto?>&nombre_tipo_precio_venta=<?php echo $nombre_tipo_precio_venta?>&nombre_tipo_unidad_medida=<?php echo $nombre_tipo_unidad_medida?>&nombre_estado=<?php echo $nombre_estado?>&cod_categoria=<?php echo $cod_categoria?>&nombre_tipo_compra=<?php echo $nombre_tipo_compra?>&cod_tipo_producto_cocina=<?php echo $cod_tipo_producto_cocina?>&nombre_promocion=<?php echo $nombre_promocion?>&cod_opcion_descontable_inv=<?php echo $cod_opcion_descontable_inv?>">PROBLEMA PRECIO VENTA 1</a></th>
        <th style="text-align:center"><a href="<?php echo $pagina ?>?precio_venta_producto_pred=precio_venta_producto2&cod_barra_nombre_producto=<?php echo $cod_barra_nombre_producto?>&cod_dependencia=<?php echo $cod_dependencia?>&nombre_tipo_producto=<?php echo $nombre_tipo_producto?>&nombre_tipo_precio_venta=<?php echo $nombre_tipo_precio_venta?>&nombre_tipo_unidad_medida=<?php echo $nombre_tipo_unidad_medida?>&nombre_estado=<?php echo $nombre_estado?>&cod_categoria=<?php echo $cod_categoria?>&nombre_tipo_compra=<?php echo $nombre_tipo_compra?>&cod_tipo_producto_cocina=<?php echo $cod_tipo_producto_cocina?>&nombre_promocion=<?php echo $nombre_promocion?>&cod_opcion_descontable_inv=<?php echo $cod_opcion_descontable_inv?>">PROBLEMA PRECIO VENTA 2</a></th>
        <th style="text-align:center"><a href="<?php echo $pagina ?>?precio_venta_producto_pred=precio_venta_producto3&cod_barra_nombre_producto=<?php echo $cod_barra_nombre_producto?>&cod_dependencia=<?php echo $cod_dependencia?>&nombre_tipo_producto=<?php echo $nombre_tipo_producto?>&nombre_tipo_precio_venta=<?php echo $nombre_tipo_precio_venta?>&nombre_tipo_unidad_medida=<?php echo $nombre_tipo_unidad_medida?>&nombre_estado=<?php echo $nombre_estado?>&cod_categoria=<?php echo $cod_categoria?>&nombre_tipo_compra=<?php echo $nombre_tipo_compra?>&cod_tipo_producto_cocina=<?php echo $cod_tipo_producto_cocina?>&nombre_promocion=<?php echo $nombre_promocion?>&cod_opcion_descontable_inv=<?php echo $cod_opcion_descontable_inv?>">PROBLEMA PRECIO VENTA 3</a></th>
        <th style="text-align:center"><a href="<?php echo $pagina ?>?precio_venta_producto_pred=precio_venta_producto4&cod_barra_nombre_producto=<?php echo $cod_barra_nombre_producto?>&cod_dependencia=<?php echo $cod_dependencia?>&nombre_tipo_producto=<?php echo $nombre_tipo_producto?>&nombre_tipo_precio_venta=<?php echo $nombre_tipo_precio_venta?>&nombre_tipo_unidad_medida=<?php echo $nombre_tipo_unidad_medida?>&nombre_estado=<?php echo $nombre_estado?>&cod_categoria=<?php echo $cod_categoria?>&nombre_tipo_compra=<?php echo $nombre_tipo_compra?>&cod_tipo_producto_cocina=<?php echo $cod_tipo_producto_cocina?>&nombre_promocion=<?php echo $nombre_promocion?>&cod_opcion_descontable_inv=<?php echo $cod_opcion_descontable_inv?>">PROBLEMA PRECIO VENTA 4</a></th>
        <!--<th style="text-align:center"><a href="<?php echo $pagina ?>?precio_venta_producto_pred=precio_venta_producto5&cod_barra_nombre_producto=<?php echo $cod_barra_nombre_producto?>&cod_dependencia=<?php echo $cod_dependencia?>&nombre_tipo_producto=<?php echo $nombre_tipo_producto?>&nombre_tipo_precio_venta=<?php echo $nombre_tipo_precio_venta?>&nombre_tipo_unidad_medida=<?php echo $nombre_tipo_unidad_medida?>&nombre_estado=<?php echo $nombre_estado?>&cod_categoria=<?php echo $cod_categoria?>&nombre_tipo_compra=<?php echo $nombre_tipo_compra?>&cod_tipo_producto_cocina=<?php echo $cod_tipo_producto_cocina?>&nombre_promocion=<?php echo $nombre_promocion?>&cod_opcion_descontable_inv=<?php echo $cod_opcion_descontable_inv?>">PROBLEMA PRECIO VENTA 5</a></th>-->
    </tr>
</table>
...
<th style="text-align:center">FECHA MANTENIMEINTO</th>
<?php } ?>
...
FROM tbl15_producto WHERE (precio_compra_producto >= $precio_venta_producto_pred) AND ($precio_venta_producto_pred <> '0') 
