...
?>
                        <div class="row">
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/lista_soportes_camara_o_documento_info_factura_venta_siscredito_visitante_intern_previsualizacion_aliado_estrategico.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&nombre_estado_factura=<?php echo $nombre_estado_factura; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/expediente.png"></a></div>
                                <!--<div style="text-align:center;" class=""><a href="../admin/lista_soportes_camara_o_documento_info_factura_venta_siscredito_visitante_intern_aliado_estrategico.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/expediente.png"></a></div>-->
                        ...
                        <!--
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/checkout_info_factura_venta_abierta_siscredito_visitante_intern_aliado_estrategico.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/editar.png"></a></div>
                            </div>
                        -->
                        </div>
                        <hr>
