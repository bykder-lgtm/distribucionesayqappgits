...
?>
	...
	?>
		<tr>
			...
			<td style="text-align:left;"><a href="../admin/reg_parametrizacion_puc_movimiento_caja_fisica_reg.php?cod_puc=<?php echo $cod_puc?>&pagina=<?php echo $pagina?>"><?php echo $nombre_puc ?></a></td>
