...
?>
<!-- **************************************************** MODULO DE SESION ******************************************** -->
<?php include "../admin/01_admin_modulo_inicio_sesion_adm_asesor.php"; ?>
<!-- **************************************************** MODULO DE SESION ******************************************** -->
<?php include "../admin/01_admin_modulo_info_empresa_adm_asesor.php"; ?>
<!DOCTYPE html>
<html lang="es">
    <head>
<meta charset="UTF-8">
...
<?php include "../admin/02_admin_modulo_estilo_css_adm_asesor.php"; ?>
...
<?php include "../admin/03_admin_modulo_menu_navegacion_adm_asesor.php"; ?>
...
<!-- ******************************************************* MODULO FOOTER *********************************************** -->
<?php include "../admin/04_admin_modulo_footer_adm_asesor.php"; ?>
<!-- ******************************************************* MODULO FOOTER *********************************************** -->
            </div>
        </div>
<!-- ******************************************************* MODULO PLANTILLA JS *********************************************** -->
<?php include "../admin/05_admin_modulo_js_adm_asesor.php"; ?>
<!-- ******************************************************* MODULO PLANTILLA JS *********************************************** -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="cod_coordinador" id="cod_coordinador" class="form-control" required>
                                    <?php $cod_administrador_coordinador = 0;
                                    if (isset($cod_administrador_coordinador)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' selected >Selecione</option>"; }
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="cod_asesor" id="cod_asesor" class="form-control" required>
                                    <?php $cod_administrador_asesor = $cod_administrador;
                                    if (isset($cod_administrador_asesor)) { echo "<option value='' >Selecione</option>"; } else { echo "<option value='' selected >Selecione</option>"; }
...
$(document).on('click','#btn_guardar_aliado',function(e){
    ...
    $.ajax({
        type: 'POST',
        url: '../admin/reg_aliado_modal_asesor_ajax_reg.php',
        data: data,
