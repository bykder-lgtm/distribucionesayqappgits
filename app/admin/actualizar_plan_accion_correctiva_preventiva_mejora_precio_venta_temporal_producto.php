...
$cod_plan_accion_correctiva_preventiva_mejora_temporal        = intval($_GET['cod_plan_accion_correctiva_preventiva_mejora_temporal']);
...
$sql_temporal = "SELECT * FROM tbl15_plan_accion_correctiva_preventiva_mejora_temporal WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'";
...
$actualizar_sql = "UPDATE tbl15_plan_accion_correctiva_preventiva_mejora_temporal SET nombre_tipo_precio_venta = '$nombre_tipo_precio_venta', 
precio_venta_producto = '$precio_venta_producto1', total_venta_producto = '$total_precio_venta_producto1'
WHERE cod_plan_accion_correctiva_preventiva_mejora_temporal = '$cod_plan_accion_correctiva_preventiva_mejora_temporal'";
