                    ...
                    <div class="contact-form-right">
                        <div class="row title-left">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 col-xxl-9">
                                <div class=""><h3>Edición de Transacción - Abierta</h3></div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Lider</strong>
                                    <select name="cod_administrador_lider" id="cod_administrador_lider" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        ...
                                        $consulta2_sql = "SELECT cod_administrador, cuenta,nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '20') ORDER BY cod_administrador DESC";
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Coordinador</strong>
                                    <select name="cod_administrador_coordinador" id="cod_administrador_coordinador" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        ...
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '21') OR (cod_seguridad = '20') ORDER BY cod_administrador DESC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                            ...
                            <div class="form-group"><strong>Asesor</strong>
                                    <select name="cod_administrador_asesor" id="cod_administrador_asesor" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        ...
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '22') ORDER BY cod_administrador DESC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Aliado</strong>
                                    <select name="cod_administrador_aliado_estrategico" id="cod_administrador_aliado_estrategico" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        ...
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '23') ORDER BY cod_administrador DESC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                <div class="form-group"><strong>Revisor</strong>
                                    <select name="cod_administrador_revisor" id="cod_administrador_revisor" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                        ...
                                        $consulta2_sql = "SELECT cod_administrador, cuenta, nombres, apellidos FROM tbl15_administrador WHERE (cod_seguridad = '27') ORDER BY cod_administrador DESC";
                                        $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                        while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Tipo de Pago</strong>
                                        <select name="cod_tipo_pago" id="cod_tipo_pago" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            ...
                                            $consulta2_sql = "SELECT cod_tipo_pago, nombre_tipo_pago FROM tbl15_tipo_pago ORDER BY cod_tipo_pago DESC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Linea de Credito</strong>
                                        <select name="cod_entidad_crediticia" id="cod_entidad_crediticia" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            ...
                                            $consulta2_sql = "SELECT cod_entidad_crediticia, nombre_entidad_crediticia FROM tbl15_entidad_crediticia ORDER BY cod_entidad_crediticia DESC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                    <div class="form-group"><strong>Operador del Credito</strong>
                                        <select name="cod_operador_credito" id="cod_operador_credito" class="form-control" data-show-subtext="true" data-live-search="true" tabindex="1" required>
                                            ...
                                            $consulta2_sql = "SELECT cod_operador_credito, nombre_operador_credito FROM tbl15_operador_credito ORDER BY cod_operador_credito DESC";
                                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
