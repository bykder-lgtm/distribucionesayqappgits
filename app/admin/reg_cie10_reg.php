...
$obtener_escolaridad = "SELECT codigo_cie10 FROM tbl15_cie10 WHERE codigo_cie10 = '".($codigo_cie10)."'";
...
<?php } else {
$sql_data = "INSERT INTO tbl15_cie10 (codigo_cie10, descripcion_cie10, cod_estado_cie10) VALUES ('$codigo_cie10', '$descripcion_cie10', '$cod_estado_cie10')";
