...
$titulo_doc_pdf            = 'LISTA_EVALUADOS_'.$nombre_empresa_contratante;
$autor_doc_pdf             = 'LISTA_EVALUADOS_'.$nombre_empresa_contratante;
$creador_doc_pdf           = 'LISTA_EVALUADOS_'.$nombre_empresa_contratante;
$tema_doc_pdf              = 'LISTA_EVALUADOS_'.$nombre_empresa_contratante;
$palabras_claves_doc_pdf   = 'LISTA_EVALUADOS_'.$nombre_empresa_contratante;
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
  <tr>
    <td width="87" valign="top">Empresa: '.$nombre_empresa_contratante.'</td>
...
$ruta = '../pdfs/';
$nombre_archivo = 'LISTA_EVALUADOS_'.$nombre_empresa_contratante.'_INI'.$fecha_ini.'_FIN'.$fecha_fin.'.pdf';
