...
?>
                        ...
                        <!--
                            <div class="col-md-1">
                                <div style="text-align:center;" class=""><a href="../admin/checkout_info_factura_venta_cerrada_siscredito_visitante_intern.php?cod_info_factura_venta=<?php echo $cod_info_factura_venta; ?>&pagina=<?php echo $pagina; ?>"><img src="../imagenes/editar.png"></a></div>
                            </div>
						-->
                        </div>
                        <hr>
