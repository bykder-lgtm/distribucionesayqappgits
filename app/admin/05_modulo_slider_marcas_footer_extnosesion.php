...
?>
            <div class="item">
                <div class="ins-inner-box">
                    ...
                    <div class="hov-in"><a href="../admin/ver_producto_extnosesion.php?nombre_marca_codifcryp=<?php echo $nombre_tipo_marca_codifcryp ?>"><i class="fab fa-instagram"></i></a></div>
                </div>
            </div>
<?php } ?>
        </div>
