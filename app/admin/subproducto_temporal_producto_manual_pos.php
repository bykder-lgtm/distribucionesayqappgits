...
$incre                             = 0;
$tab                               = 'tbl15_subproducto_temporal_nuevo';
...
if (isset($_GET['cod_info_factura_subproducto'])) { $cod_info_factura_subproducto = addslashes($_GET['cod_info_factura_subproducto']); } else { $cod_info_factura_subproducto = 0; }
...
$total_datos = mysqli_num_rows($consulta_data_info_factura);


$sql_subproducto_temporal = "SELECT * FROM tbl15_subproducto_temporal WHERE (cod_info_factura_subproducto = '$cod_info_factura_subproducto') ORDER BY cod_subproducto_temporal DESC";
$consulta_subproducto_temporal = mysqli_query($conectar, $sql_subproducto_temporal);
$existe_temporal = mysqli_num_rows($consulta_subproducto_temporal);
?>
...
function hacer_busqueda() {
    ...
    var cod_info_factura_subproducto = "<?php echo $cod_info_factura_subproducto ?>";
    ...
    xmlhttp.open("POST","../admin/busqueda_inmediata_subproducto_temporal_php.php",true);
    xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    xmlhttp.send("cod_info_factura_subproducto="+cod_info_factura_subproducto+"&buscar="+valor_buscar+"&buscar_por="+buscar_por+"&nombre_tipo_moneda="+nombre_tipo_moneda+"&nombre_tipo_factura="+nombre_tipo_factura+"&tipo_busqueda="+tipo_busqueda+"&cod_estado_vacuna="+cod_estado_vacuna+"&pagina="+pagina);
}
</script>
...
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_subproducto_temporal_pos.php'); ?>
<!-- ***************************************************************************************************************************** -->
<!-- ***************************************************************************************************************************** -->
