...
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
$sql_info_factura = "SELECT * FROM tbl15_info_factura_venta WHERE cod_factura = '$cod_factura_max'";
...
$motivo2_db                        = $info_info_factura['motivo2'];
$motivo3_db                        = $info_info_factura['motivo3'];
$motivo4_db                        = $info_info_factura['motivo4'];
$motivo5_db                        = $info_info_factura['motivo5'];
$motivo6_db                        = $info_info_factura['motivo6'];
$motivo7_db                        = $info_info_factura['motivo7'];
$motivo8_db                        = $info_info_factura['motivo8'];
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
if ($total_motivo==1) { 
...
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$fecha_ymdhis', '$cuenta')";
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa_contratante='$nombre_empresa_contratante') AND (motivo='$motivo') AND (cod_estado_facturacion=1)) GROUP BY motivo";
...
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo2_db == $motivo2)) {
$cod_factura                    = $info_info_factura['cod_factura'];
} else {
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
cod_estado_facturacion, nombre_empresa, motivo FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa_contratante='$nombre_empresa_contratante') AND ((motivo='$motivo') 
...
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo2_db == $motivo2) && ($motivo3_db == $motivo3)) {
$cod_factura                    = $info_info_factura['cod_factura'];
} else {
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo2_db == $motivo2) && ($motivo3_db == $motivo3) && ($motivo4_db == $motivo4)) {
$cod_factura                    = $info_info_factura['cod_factura'];
} else {
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo2_db == $motivo2) && ($motivo3_db == $motivo3) && ($motivo4_db == $motivo4) && ($motivo5_db == $motivo5)) {
$cod_factura                    = $info_info_factura['cod_factura'];
} else {
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo2_db == $motivo2) && ($motivo3_db == $motivo3) && ($motivo4_db == $motivo4) && ($motivo5_db == $motivo5) && ($motivo6_db == $motivo6)) {
$cod_factura                    = $info_info_factura['cod_factura'];
} else {
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, motivo6, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo2_db == $motivo2) && ($motivo3_db == $motivo3) && ($motivo4_db == $motivo4) && ($motivo5_db == $motivo5) && ($motivo6_db == $motivo6) && ($motivo7_db == $motivo7)) {
$cod_factura                    = $info_info_factura['cod_factura'];
} else {
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, motivo6, motivo7, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$motivo7', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
if (($fecha_ini_db == $fecha_ini) && ($fecha_fin_db == $fecha_fin) && ($nombre_empresa_db == $nombre_empresa) && ($motivo_db == $motivo) && ($motivo2_db == $motivo2) && ($motivo3_db == $motivo3) && ($motivo4_db == $motivo4) && ($motivo5_db == $motivo5) && ($motivo6_db == $motivo6) && ($motivo7_db == $motivo7) && ($motivo8_db == $motivo8)) {
$cod_factura                    = $info_info_factura['cod_factura'];
} else {
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, motivo6, motivo7, motivo8, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa_contratante', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$motivo7', '$motivo8', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa_contratante='$nombre_empresa_contratante') AND ((motivo='$motivo') 
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5') OR (motivo='$motivo6') OR (motivo='$motivo7') 
OR (motivo='$motivo8') OR (motivo='$motivo9')) 
AND (cod_estado_facturacion=1)) GROUP BY motivo";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa_contratante='$nombre_empresa_contratante') AND ((motivo='$motivo') 
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5') OR (motivo='$motivo6') OR (motivo='$motivo7') 
OR (motivo='$motivo8') OR (motivo='$motivo9') OR (motivo='$motivo10')) 
AND (cod_estado_facturacion=1)) GROUP BY motivo";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa_contratante='$nombre_empresa_contratante') AND ((motivo='$motivo') 
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5') OR (motivo='$motivo6') OR (motivo='$motivo7') 
OR (motivo='$motivo8') OR (motivo='$motivo9') OR (motivo='$motivo10') OR (motivo='$motivo11')) 
AND (cod_estado_facturacion=1)) GROUP BY motivo";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa_contratante='$nombre_empresa_contratante') AND ((motivo='$motivo') 
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5') OR (motivo='$motivo6') OR (motivo='$motivo7') 
OR (motivo='$motivo8') OR (motivo='$motivo9') OR (motivo='$motivo10') OR (motivo='$motivo11') OR (motivo='$motivo12')) 
AND (cod_estado_facturacion=1)) GROUP BY motivo";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa_contratante='$nombre_empresa_contratante') AND ((motivo='$motivo') 
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5') OR (motivo='$motivo6') OR (motivo='$motivo7') 
OR (motivo='$motivo8') OR (motivo='$motivo9') OR (motivo='$motivo10') OR (motivo='$motivo11') OR (motivo='$motivo12') OR (motivo='$motivo13')) 
AND (cod_estado_facturacion=1)) GROUP BY motivo";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
...
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5') OR (motivo='$motivo6') OR (motivo='$motivo7') 
OR (motivo='$motivo8') OR (motivo='$motivo9') OR (motivo='$motivo10') OR (motivo='$motivo11') OR (motivo='$motivo12') 
OR (motivo='$motivo13') OR (motivo='$motivo14')) 
AND (cod_estado_facturacion=1)) GROUP BY motivo";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
...
OR (motivo='$motivo2') OR (motivo='$motivo3') OR (motivo='$motivo4') OR (motivo='$motivo5') OR (motivo='$motivo6') OR (motivo='$motivo7') 
OR (motivo='$motivo8') OR (motivo='$motivo9') OR (motivo='$motivo10') OR (motivo='$motivo11') OR (motivo='$motivo12') 
OR (motivo='$motivo13') OR (motivo='$motivo14') OR (motivo='$motivo15')) 
AND (cod_estado_facturacion=1)) GROUP BY motivo";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
//-----------------------------------------------------------------------------------------------------//
...
$titulo_doc_pdf                    = 'FACTURA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_empresa_contratante;
$autor_doc_pdf                     = 'FACTURA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_empresa_contratante;
$creador_doc_pdf                   = 'FACTURA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_empresa_contratante;
$tema_doc_pdf                      = 'FACTURA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_empresa_contratante;
$palabras_claves_doc_pdf           = 'FACTURA_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$nombre_empresa_contratante;
$aaaaaa   = "FACTURA";
...
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
  <tr>
    <td width="87" valign="top">Señor (es): '.$nombre_empresa_contratante.'</td>
