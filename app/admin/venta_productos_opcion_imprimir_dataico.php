...
if (isset($_GET['cod_info_factura_venta'])) {
	...
	<table class="table table-striped">
	  <tr>
        <td style="text-align:center;" id="resultado_envio_dian<?php echo $cod_info_factura_venta ?>"></td>
        <td style="text-align:center;" id="enviando_cargador<?php echo $cod_info_factura_venta ?>"><img src="../imagenes/loader.gif" class="img-polaroid" alt=""><br>Enviando Factura Electronica</td>
        <td style="text-align:center;" id="resultado_error_envio_dian_dataico<?php echo $cod_info_factura_venta ?>"></td>
        <td style="text-align:center;" id="resultado_envio_dataico<?php echo $cod_info_factura_venta ?>"></td>
	  </tr>
	</table>
	<?php } ?>
...
-->
	...
	<table class="table table-striped">
	  <tr>
	    ...
	    <td style="text-align:center;"><a href="../admin/cuentas_cobrar_detalle_factura_directa_no_por_factura.php?cod_tercero=<?php echo $cod_tercero?>"><img src="../imagenes/remision.png"><br>CUENTA POR COBRAR</a></td>
		<?php } ?>
	...
	<?php } else { ?>
		...
		<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:7pt;">
		  <tr>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong>SUBTOTAL</strong></td>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong>%DESC</strong></td>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong>$DESC</strong></td>
		    <?php if ($regimen_emp == 'RESPONSABLE_DE_IVA') { ?><td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong>IVA</strong></td><?php } ?>
			<?php if ($existe_servicio_propina <> '0') { ?>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong><?php echo $nombre_producto_propina." ".$ptj_servicio_propina."%" ?></strong></td>
			<?php } ?>
		    <td style="text-align: center; width: 5%; font-family: Helvetica; font-size:7pt;"><strong></strong></td>
		  </tr>
		  <tr>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong><?php echo number_format($subtotal_base_sin_descuento, 0, ",", ".") ?></strong></td>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong><?php echo intval($descuento_ptj_dif) ?>%</strong></td>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong><?php echo number_format(abs($total_descuento_venta), 0, ",", ".") ?></strong></td>
		    <?php if ($regimen_emp == 'RESPONSABLE_DE_IVA') { ?><td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong><?php echo number_format($total_iva, 0, ",", ".") ?></strong></td><?php } ?>
			<?php if ($existe_servicio_propina <> '0') { ?>
		    <td style="text-align: center; width: 9%; font-family: Helvetica; font-size:7pt;"><strong><?php echo number_format($total_venta_producto_propina, 0, ",", ".") ?></strong></td>
			<?php } ?>
		  </tr>
		</table>
		...
		<?php if ($cod_tipo_pago == '1') { ?>
			...
			<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:7pt;">
			  <tr>
			    <td style="text-align: center; width: 40%; font-family: Helvetica; font-size:7pt;"><strong>RECIBIDO</strong></td>
		...
		<?php if ($cod_estado_btn_imp_pos_nav_orden_compra_global == '0') { ?>
			...
			<table border="0" width="275px" cellspacing="0" cellpadding="0" style="font-family: Helvetica; font-size:7pt;">
			  <tr>
			    <td style="text-align: center;">CUFE:<div id="cufe_factura_electronica1"></div></td>
			  </tr>
			  <tr>
			    <td style="text-align: center;"><div id="cufe_factura_electronica2"></div></td>
			  </tr>
			  <tr>
			    <td style="text-align: center;"><img id="qr_factura_electronica"></td>
			  </tr>
			</table>
			<?php } ?>
		...
		$(document).ready(function() {
	        ...
	        $.ajax({
	            ...
	            success:function(respuesta){
	                ...
	                if(respuesta.errors) {
	                    var error = respuesta.errors[0].error;
	                    var path = respuesta.errors[0].path;
	                    ...
	                    var resultado_error_envio_dian_dataico = error+" ["+path+"]";
                        ...
                        $('#resultado_error_envio_dian_dataico'+cod_info_factura_venta).html("<img src="+imagen_status_error+" class='img-polaroid'>"+"<br>"+resultado_error_envio_dian_dataico);
	                } else {
	                    var cod_factura_prefijo = respuesta.number;
	                    var prefijo_resolucion_facturacion = respuesta.numbering.prefix;
	                    var numero_resolucion_facturacion = respuesta.numbering.resolution_number;
	                    var dataico_email_status = respuesta.email_status;
	                    var dataico_uuid = respuesta.uuid;
	                    var cod_cufe = respuesta.cufe;

	                    var issue_date = respuesta.issue_date;
	                    var customer_status = respuesta.customer_status;
	                    var pdf_url = respuesta.pdf_url;
	                    var invoice_type_code = respuesta.invoice_type_code;
	                    var payment_means = respuesta.payment_means;
	                    var dian_status = respuesta.dian_status;

	                    if (dian_status == 'DIAN_ACEPTADO') {
	                        var cod_estado_factura_electronica_enviado_dian = 1;
	                        var cod_estado_factura_electronica_enviado_dataico = 1;
	                        var datos_url_ajax = 'campo='+campo+'&'+'tipo_ajax='+tipo_ajax+'&'+'cod_factura_prefijo='+cod_factura_prefijo+'&'+'prefijo_resolucion_facturacion='+prefijo_resolucion_facturacion+'&'+'numero_resolucion_facturacion='+numero_resolucion_facturacion+'&'+'cod_estado_factura_electronica_enviado_dian='+cod_estado_factura_electronica_enviado_dian+'&'+'cod_estado_factura_electronica_enviado_dataico='+cod_estado_factura_electronica_enviado_dataico+'&'+'dataico_email_status='+dataico_email_status+'&'+'dataico_uuid='+dataico_uuid+'&'+'cod_cufe='+cod_cufe+'&'+'customer_status='+customer_status+'&'+'issue_date='+issue_date+'&'+'pdf_url='+pdf_url+'&'+'invoice_type_code='+invoice_type_code+'&'+'payment_means='+payment_means+'&'+'dian_status='+dian_status;
	                    ...
	                    if (dian_status == 'DIAN_NO_ENVIADO') {
	                        ...
	                        $.ajax({
	                            ...
	                            success:function(respuesta){
									...
									//var qr_factura_electronica = new QRCode(document.getElementById("qr_factura_electronica"), { width : 90, height : 90 });
									//function makeCode () { qr_factura_electronica.makeCode(url_vpfe_dian_qr); }
									//makeCode();
