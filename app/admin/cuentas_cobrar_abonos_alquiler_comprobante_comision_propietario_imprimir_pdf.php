...
$mes_del_anyo                               = $nombre_tabla_mes;
$dia_del_anyo                               = date("d", strtotime($fecha_pago));

if (date('L', strtotime($fecha_pago))) { $anyo_biciesto = 'SI'; } else { $anyo_biciesto = 'NO'; }

if (($mes_del_anyo == '01') && ($dia_del_anyo == 31 || $dia_del_anyo == 30 || $dia_del_anyo == 29)) {
	$fecha_calculo = new DateTime($fecha_pago);
	$fecha_calculo->modify( 'last day of +1 month' );
	$fecha_pago_final = $fecha_calculo->format('Y-m-d');
} else {
...
$titulo_doc_pdf                    = 'COMPROBANTE_PAGO_COMISION_PROPIETARIO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_factura_comision_propietario.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$autor_doc_pdf                     = 'COMPROBANTE_PAGO_COMISION_PROPIETARIO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_factura_comision_propietario.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$creador_doc_pdf                   = 'COMPROBANTE_PAGO_COMISION_PROPIETARIO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_factura_comision_propietario.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$tema_doc_pdf                      = 'COMPROBANTE_PAGO_COMISION_PROPIETARIO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_factura_comision_propietario.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;
$palabras_claves_doc_pdf           = 'COMPROBANTE_PAGO_COMISION_PROPIETARIO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_factura_comision_propietario.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero;

$cod_factura_strpad                = str_pad($cod_factura, 6, "0", STR_PAD_LEFT);
$cod_info_factura_strpad           = str_pad($cod_cuentas_cobrar_factura_comision_propietario, 6, "0", STR_PAD_LEFT);
$nombres_completos                 = "COMPROBANTE_COMISION_PROPIETARIO";
//$mpdf = new mPDF('c','Legal');
$modo_hoja                         = 'c';
$formato_hoja                      = 'A4';
$default_font_size_hoja            = '0';
$default_font_hoja                 = '';
$margin_left_hoja                  = $margen_izq;
$margin_right_hoja                 = $margen_der;
$margin_top_hoja                   = $margen_inf_encabezado;
$margin_bottom_hoja                = $margen_sup_encabezado;
$margin_header_hoja                = $posicion_sup_encabezado;
$margin_footer_hoja                = $posicion_inf_encabezado;
$orientation_hoja                  = 'P';
...
$ruta = '../pdfs/';
$nombre_archivo = 'COMPROBANTE_PAGO_COMISION_PROPIETARIO_'.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'_'.$cod_cuentas_cobrar.'_'.$cod_cuentas_cobrar_factura_comision_propietario.'_'.$cod_cuentas_cobrar_alerta.'_'.$nombre_tipo_producto.'_'.$nombre1_tercero.'.pdf';
