...
<table class="table table-striped">
	<tr>
		<th style="text-align: center;"><h4>Listado Cartera Vencida</h4></th>
	</tr>
</table>
...
FROM tbl15_cuentas_cobrar WHERE ((tbl15_cuentas_cobrar.cod_estado_pago = '0') OR (tbl15_cuentas_cobrar.subtotal <> '0')) ORDER BY tbl15_cuentas_cobrar.cod_cuentas_cobrar DESC";
