...
$datos_factura = "SELECT cod_compra_producto_temporal FROM tbl15_compra_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
xmlhttp.open("POST","../admin/busqueda_inmediata_factura_compra_temporal_producto_php.php",true);
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_info_factura_compra.php">LISTA DE FACTURAS COMPRA</a></strong></td>
    </tr></tbody>
</table>
<br>
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
...
<td style="text-align:center;"><input name="und_unidades" type="number" id="und_unidades<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $und_unidades;?>" style="width: 40px;" /></td>
<th style="text-align:center;">X</th>
<td style="text-align:center;"><input name="und_caja" type="number" id="und_caja<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $und_caja;?>" style="width: 40px;" /></td>
...
<td style="text-align:center;"><input name="precio_compra_producto" type="text" id="precio_compra_producto<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" onChange="calc_total_compra();" value="<?php echo $precio_compra_producto;?>" style="width: 100px;" /></td>
<td style="text-align:center;"><input name="dto1" type="number" id="dto1<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $dto1;?>" style="width: 40px;" /></td>
<td style="text-align:center;"><input name="dto2" type="number" id="dto2<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $dto2;?>" style="width: 40px;" /></td>
<td style="text-align:center;"><input name="iva_ptj" type="number" id="iva_ptj<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $iva_ptj;?>" style="width: 40px;" /></td>
<td style="text-align:center;"><input name="precio_ipc" type="number" id="precio_ipc<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $precio_ipc;?>" style="width: 100px;" /></td>
...
<td style="text-align:center;"><input name="precio_venta_producto<?php echo $contador; ?>" type="number" id="precio_venta_producto<?php echo $incre;?>" class="<?php echo $cod_compra_producto_temporal;?>" value="<?php echo $precio_ventas;?>" style="width: 100px;" /></td>
<?php } ?>
