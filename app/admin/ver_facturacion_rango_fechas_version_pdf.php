...
GROUP BY motivo, nombre_empresa, cod_estado_facturacion, fecha_time
HAVING (((nombre_empresa)='$nombre_empresa') AND (cod_estado_facturacion=1) AND ((fecha_time)>='$fecha_seg_ini' And (fecha_time)<='$fecha_seg_fin'))";
