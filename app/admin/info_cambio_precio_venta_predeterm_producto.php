...
<?php
$suma_temporal = "SELECT Sum(total_venta_producto) As total_venta, Sum(total_compra_producto) As total_compra FROM tbl15_cambio_precio_venta_predeterm_producto_temporal 
...
$datos_data_info_factura = "SELECT * FROM tbl15_info_cambio_precio_venta_predeterm_producto WHERE (nombre_estado_factura = 'ABIERTA') AND (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
$consulta_data_info_factura = mysqli_query($conectar, $datos_data_info_factura);
$data_info_factura = mysqli_fetch_assoc($consulta_data_info_factura);
$factura_ocupada = mysqli_num_rows($consulta_data_info_factura);

$cod_info_cambio_precio_venta_predeterm_producto      = $data_info_factura['cod_info_cambio_precio_venta_predeterm_producto'];
...
$(document).ready(function(){
    $("#fecha_anyo").on('change', function () {
            ...
            $.post("guardar_info_cambio_precio_venta_predeterm_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_cambio_precio_venta_predeterm_producto; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
$(document).ready(function(){
    $("input").on('change', function () {
            ...
            //let id = this.id;
            $.post("guardar_info_cambio_precio_venta_predeterm_producto_temporal_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:id }, function(data){
...
<form method="post" name="formulario" action="../admin/cambio_precio_venta_predeterm_producto_temporal_reg.php">
<table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
  ...
  <tr>
    <td style="text-align:center;"></td>
    <td style="text-align:center;"><?php echo $cod_info_cambio_precio_venta_predeterm_producto ?></td>
...
-->
   ...
   <td style="text-align:center;"><input name="observacion" id="observacion" type="text" value="<?php echo $observacion ?>" style="width: 400px;"/></td>

    <td style="text-align:center;"><input type="image" src="../imagenes/guardar.png" tabindex=3 name="vender" value="Guardar" /></td>
    <td style="text-align:center;"></td>

<?php 
$sql_temporal = "SELECT cod_cambio_precio_venta_predeterm_producto_temporal FROM tbl15_cambio_precio_venta_predeterm_producto_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
<input type="hidden" name="cod_cambio_precio_venta_predeterm_producto_temporal[]" value="<?php echo $datos_temporal['cod_cambio_precio_venta_predeterm_producto_temporal']; ?>" size="4">
<?php } ?>

<?php $pagina ='facturacion_cambio_precio_venta_predeterm_producto_temporal.php'; ?>
<input type="hidden" name="cod_info_cambio_precio_venta_predeterm_producto" value="<?php echo $cod_info_cambio_precio_venta_predeterm_producto ?>" size="10">
