...
cd curl
cd x86
curl %ruta_http_produccion%/actualizacion_automatica_cod_estado_pago_propietario_reg.php?fecha_ymd_venta_producto_ini=%fecha_ymd_venta_producto_ini%
::curl %ruta_http_prueba%/actualizacion_automatica_cod_estado_pago_propietario_reg.php?fecha_ymd_venta_producto_ini=%fecha_ymd_venta_producto_ini%
pause