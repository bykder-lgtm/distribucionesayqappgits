...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$obtener_diseno_usario_vendedor = "SELECT cuenta, nombres, apellidos, cod_caja FROM tbl15_administrador WHERE (cuenta = '$cuenta')";
...
$telefono_cli                        = $matriz_cliente['telefono1_tercero'];
...
WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual') AND (cod_producto_barra <> '22222222' AND cod_producto_barra <> '33333333')";
...
$printer->setEmphasis(true);
$printer->text("TICKET DE PREVENTA"."\n");
...
$resultado_sql = "SELECT $select_productos_imp FROM tbl15_venta_producto_temporal WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual') 
...
$printer->text(str_pad("".number_format($subtotal_venta, 0, ",", "."), 8));
$printer->text("\n");

if ($existe_servicio_propina <> '0') {
$printer->text(str_pad($nombre_producto_propina." ".$ptj_servicio_propina."%: ", 20));
$printer->text(str_pad("".number_format($total_venta_producto_propina, 0, ",", "."), 8));
$printer->text("\n");
}

if ($existe_servicio_descuento <> '0') {
$printer->text(str_pad($nombre_producto_descuento.": ", 20));
$printer->text(str_pad("".number_format($total_venta_producto_descuento, 0, ",", "."), 8));
$printer->text("\n");
}
...
$printer->text(str_pad("".number_format($total_venta, 0, ",", "."), 8));
$printer->text("\n");
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$printer->setTextSize(1, 1);
...
$printer->text("".$fecha.$hora."-".$cod_factura."-".$cod_info_factura_venta."_prevdriv58");
$printer->feed(3);
...
$printer->text("\n");
$printer->text(str_pad("CLIENTE: ".$nombre_cliente, 35));
$printer->text(str_pad("TELEFONO: ".$telefono_cli, 23));
$printer->text("\n");
$printer->text(str_pad("DIRECCIÓN: ".$direccion_cli, 20));
$printer->text("\n");
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$printer->setJustification(Printer::JUSTIFY_CENTER);
...
$printer->text(str_pad("DESCRIPCION", 36));
...
$nombre_producto1   = substr(trim($nombre_producto), 0, 33);
$nombre_producto2   = substr(trim($nombre_producto), 33, 32);

$printer->setJustification(Printer::JUSTIFY_LEFT);
$printer->text(str_pad($und_venta, 6));
$printer->text(str_pad($nombre_producto1, 36));
...
if ($nombre_producto2 <> "") {
	...
	$printer->text(str_pad($nombre_producto2, 36));
	$printer->text(str_pad("", 7,' ',STR_PAD_LEFT));
	$printer->text(str_pad("", 10,' ',STR_PAD_LEFT));
}
$printer->text("\n");
} else {
	$nombre_producto1   = substr($nombre_producto, 0, 36);
	$nombre_producto2   = "";
...
$printer->text(str_pad("SUBTOTAL: ", 30));
$printer->text(str_pad("".number_format($subtotal_venta, 0, ",", "."), 25));
$printer->text("\n");

if ($existe_servicio_propina <> '0') {
	$printer->text(str_pad($nombre_producto_propina." ".$ptj_servicio_propina."%: ", 30));
	$printer->text(str_pad("".number_format($total_venta_producto_propina, 0, ",", "."), 25));
	$printer->text("\n");
}

if ($existe_servicio_descuento <> '0') {
	$printer->text(str_pad($nombre_producto_descuento.": ", 30));
	$printer->text(str_pad("".number_format($total_venta_producto_descuento, 0, ",", "."), 25));
	$printer->text("\n");
}
...
$printer->text(str_pad("".number_format($total_venta, 0, ",", "."), 10));
$printer->text("\n");
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$printer->setTextSize(1, 1);
...
$printer->text("<== ".$fecha.$hora."-".$cod_factura."-".$cod_info_factura_venta."_prevdriv80 ==>");
$printer->feed(1);
