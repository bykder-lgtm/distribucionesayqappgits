...
if ($action == 'ajax') {
    ...
    $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_revisor = '$cod_administrador') AND (tbl15_info_factura_venta.nombre_estado_factura = '$nombre_estado_factura')";

    if ($_GET['busqueda_ajax'] != "") {
        $sWhere = " WHERE (tbl15_info_factura_venta.cod_administrador_revisor = '$cod_administrador') AND (tbl15_info_factura_venta.nombre_estado_factura = '$nombre_estado_factura') AND ( ";
    ...
    tbl15_info_factura_venta.url_img_orig_producto AS url_comprobante_pago
    FROM $sTable $sWhere LIMIT $registro_inicio, $numero_registro_por_pagina";
                ...
                while ($datos_cuenta_cobrar = mysqli_fetch_assoc($consulta_datos_cuenta_cobrar)) {
                    ...
                    $url_comprobante_pago                      = $datos_cuenta_cobrar['url_comprobante_pago'];
                    /* ----------------------------------------------------------------------------------------------------------/ */
