...
<table class="table table-striped">
    <tbody><tr>
        ...
        <th style="text-align:center">PRODUCTOS CARGADOS</th>
...
<table class="table table-striped">
    <tbody>
        <tr>
        <th style="text-align:center"><a>INVENTARIO DE PRODUCTOS CARGADOS [<?php echo $total_productos_cargados ?>]</a></th>
    </tr>
</tbody>
</table>
...
<tbody>
<?php
while ($info_productos_cargados = mysqli_fetch_assoc($resultado_productos_cargados)) {

$cod_producto_copia_inventario          = $info_productos_cargados['cod_producto_copia_inventario'];
$cod_producto_barra                     = $info_productos_cargados['cod_producto_barra'];
$nombre_producto                        = $info_productos_cargados['nombre_producto'];
...
$precio_compra_producto                 = $info_productos_cargados['precio_compra_producto'];
$precio_venta_producto                  = $info_productos_cargados['precio_venta_producto'];
$comentario_copia_inventario            = $info_productos_cargados['comentario_copia_inventario'];
$fecha_actualizacion                    = $info_productos_cargados['fecha_actualizacion'];
$cod_administrador                      = $info_productos_cargados['cuenta'];
