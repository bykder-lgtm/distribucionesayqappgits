...
$nombre_tipo_inventario                                = "TODO_INMEDIATO_VENTA_SIMULTANEA";
$nombre_letra_alfabeto                                 = "TODAS";
$cod_estado                                            = 0;
$conteo_modificacion_inv_imediato_venta_simultanea     = 0;
//*************************************************************************************************************************//
if (isset($_POST['si'])) {
	...
	$sql_data = sprintf("UPDATE tbl15_producto SET conteo_modificacion_inv_imediato_venta_simultanea = '$conteo_modificacion_inv_imediato_venta_simultanea'");
	$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
?>
<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/producto_copia_inventario_imediato_venta_simultanea_masivo.php?cod_info_producto_copia_inventario=<?php echo $cod_info_producto_copia_inventario ?>">
<?php } else { ?>
