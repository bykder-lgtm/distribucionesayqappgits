...
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, motivo, motivo2, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$motivo', '$motivo2', '$fecha_ymdhis', '$cuenta')";
...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (nombre_empresa='$nombre_empresa') AND ((motivo='$motivo') OR (motivo='$motivo2')) AND (cod_estado_facturacion=1)) GROUP BY motivo";
