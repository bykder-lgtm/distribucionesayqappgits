...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$cod_info_orden_produccion_factura_venta        = intval($_POST['cod_info_orden_produccion_factura_venta']);
...
$nombre_comentario             = addslashes($_POST['nombre_comentario']);
$nombre_tipo_pendiente         = addslashes($_POST['nombre_tipo_pendiente']);
$descripcion_tipo_pendiente    = addslashes($_POST['descripcion_tipo_pendiente']);
$fecha_entrega                 = addslashes($_POST['fecha_entrega']);
$hora_entrega                  = addslashes($_POST['hora_entrega']);
...
$sql_maxima_factura = "SELECT Max(cod_factura) AS cod_factura FROM tbl15_info_orden_produccion_factura_venta WHERE (nombre_estado_factura = 'CERRADA')";
...
//---------------------------------------------------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------//
$sql_info_imp_factura = "SELECT * FROM tbl15_info_orden_produccion_factura_venta WHERE cod_info_orden_produccion_factura_venta = '$cod_info_orden_produccion_factura_venta'";
...
FROM tbl15_orden_produccion_venta_producto_temporal WHERE (cod_info_orden_produccion_factura_venta = '$cod_info_orden_produccion_factura_venta')";
...
if (isset($_POST['cod_info_orden_produccion_factura_venta'])) {

for ($i=0; $i < $total_datos; $i++) {

$cod_orden_produccion_venta_producto_temporal       = $_POST['cod_orden_produccion_venta_producto_temporal'][$i];

$sql_mconsulta = "SELECT * FROM tbl15_orden_produccion_venta_producto_temporal WHERE (cod_orden_produccion_venta_producto_temporal = '$cod_orden_produccion_venta_producto_temporal')";
...
$agregar_reg_venta_producto = "INSERT INTO tbl15_orden_produccion_venta_producto (cod_info_orden_produccion_factura_venta, cod_factura, cod_producto, cod_producto_barra, 
...
VALUES ('$cod_info_orden_produccion_factura_venta', '$cod_factura', '$cod_producto', '$cod_producto_barra', 
'$nombre_producto', '$und_venta', '$precio_compra_producto', '$total_compra_producto', '$precio_costo_producto', '$total_costo_producto', '$precio_venta_producto', 
'$total_venta_producto', '$nombre_tipo_producto', '$und_producto', '$fecha_ymd_venta_producto', '$fecha_hora_venta_producto',
'$nombre_tipo_unidad_medida', '$posologia_cantidad', '$posologia_peso', '$nombre_tipo_presentacion',
'$fecha_mes_venta_producto', '$fecha_anyo_venta_producto', '$fecha_seg_venta_producto', '$cuenta', '$cod_administrador', 
...
//----------------------------------------------------------------------- ---------------------------------------------------------//
//----------------------------------------------------------------------- ---------------------------------------------------------//
$borrar_sql = sprintf("DELETE FROM tbl15_orden_produccion_venta_producto_temporal WHERE (cod_info_orden_produccion_factura_venta = '$cod_info_orden_produccion_factura_venta')");
...
$agregar_regis = sprintf("UPDATE tbl15_info_orden_produccion_factura_venta SET cod_estado_factura = '$cod_estado_factura', cod_factura = '$cod_factura', fecha_anyo = '$fecha_anyo', 
...
monto_deuda = '$monto_deuda', total_abono = '$total_abono', subtotal = '$subtotal'
...
if ($vlr_cancelado <> '0') {
$agregar_reg_abono = "INSERT INTO tbl15_orden_produccion_abonos (cod_info_orden_produccion_factura_venta, cod_factura,  
...
VALUES ('$cod_info_orden_produccion_factura_venta', '$cod_factura',  
'$monto_deuda', '$subtotal', '$abonado', '$cod_administrador', '$vendedor','$cuenta', '$fecha_pago', '$fecha_anyo', '$hora',
'$anyo', '$fecha_invert', '$fecha_seg', '$fecha_creacion', '$cod_tipo_forma_pago')";
$resultado_abono = mysqli_query($conectar, $agregar_reg_abono) or die(mysqli_error($conectar));
}
$url_redir = "../admin/orden_produccion_venta_productos_opcion_imprimir.php?cod_info_orden_produccion_factura_venta=".$cod_info_orden_produccion_factura_venta."&cod_tipo_pago=".$cod_tipo_pago."&pagina=".$pagina;
