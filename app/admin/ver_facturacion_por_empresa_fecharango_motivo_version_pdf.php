...
$nombre_tipo_producto              = 'EVALUADOS';
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
...
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, motivo6, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, motivo6, motivo7, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$motivo7', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO tbl15_info_factura_venta (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo, total_muestra, motivo, motivo2, motivo3, motivo4, motivo5, motivo6, motivo7, motivo8, fecha_ymdhis, cuenta, nombre_tipo_producto) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$total_muestra', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$motivo7', '$motivo8', '$fecha_ymdhis', '$cuenta', '$nombre_tipo_producto')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
    ...
    <td width="345" valign="top"><p>&nbsp;
       <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:90%">
          <tr>
            ...
            <td style="text-align:center">N&ordm;. '.str_pad($cod_factura, 4, "0", STR_PAD_LEFT).'</td>
          </tr>
          <tr>
            <td style="text-align:center">TIPO</td>
            <td style="text-align:center">'.$nombre_tipo_producto.'</td>
          </tr>
      </table>
    </td>
  </tr>
