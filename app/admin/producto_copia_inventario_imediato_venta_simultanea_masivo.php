...
?>
    ...
    <form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/producto_copia_inventario_imediato_venta_simultanea_masivo_reg.php">
        <table class="table table-striped">
            <tr>
...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'../admin/producto_copia_inventario_imediato_venta_simultanea_masivo_busqueda_ajax.php?action=ajax&page='+page+'&busqueda_ajax='+busqueda_ajax+'&buscar_por='+buscar_por+'&tabla='+tabla+'&cod_info_producto_copia_inventario='+cod_info_producto_copia_inventario,
