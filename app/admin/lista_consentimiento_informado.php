...
$tabla = 'tbl15_consentimiento_informado';
?>
...
<a href="../admin/lista_paciente_buscar.php"><h4>Consentimiento Informado&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/lista_crear_nuevo_registro.php?tabla=<?php echo $tabla ?>">Registrar Consentimiento Informado&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
<a href="../admin/ver_consentimiento_informado_version_vacia_pdf.php" target="_blank">Version Imprimible</h4></a>
</div>
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <select class="form-control" id="buscar_por" onchange='load(1);'>
                ...
                <option value="cod_consentimiento_informado">Codigo Consentimiento Informado</option>
            </select>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_consentimiento_informado_ajax.js"></script>
</body>
</html>