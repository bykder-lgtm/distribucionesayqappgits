...
/* ----------------------------------------------------------------------------------------------------------/ */
		$doc_modifica                                      = "";
		$descripcion_movimiento                            = "Abono cuenta por pagar: ".$nombres_clientes.' | '.$fecha_anyo.' | '.$comentario;
...
//---------------------------------------------------------------------------------------------------------------------------------//
	if ($cod_estado_movimiento_contable_cuenta_personal_global == '1') {
		...
		$comentario                                            = "Abono cuenta por pagar: ".$nombres_clientes.' | '.$mensaje." | ID: ".$cod_cuentas_pagar_abonos;
...
//-------------------------------------- -----------------------------------------------------------------//
?>
	<META HTTP-EQUIV="REFRESH" CONTENT="0; ../admin/abono_cuentas_pagar_directa_no_por_factura_opcion_imprimir.php?cod_cuentas_pagar_abonos=<?php echo $cod_cuentas_pagar_abonos ?>&cod_tercero=<?php echo $cod_tercero ?>&cliente=<?php echo $cliente ?>&pagina=<?php echo $pagina ?>">
<?php } ?>