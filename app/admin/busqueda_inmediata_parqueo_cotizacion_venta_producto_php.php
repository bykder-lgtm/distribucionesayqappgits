...
$cod_info_cotizacion_factura_venta          = intval($_POST['cod_info_parqueo_cotizacion_factura_venta']);
$pagina                                     = addslashes($_POST['pagina']);
$nombre_tipo_producto                       = 'SERVICIO PARQUEO';
...
<td align="Left"><a href="../admin/reg_parqueo_cotizacion_venta_producto_reg.php?cod_producto=<?php echo $cod_producto?>&cod_info_parqueo_cotizacion_factura_venta=<?php echo $cod_info_parqueo_cotizacion_factura_venta?>&foco=<?php echo $foco?>&pagina=<?php echo $pagina?>" tabindex=3><?php echo $nombre_producto ?></a></td>
