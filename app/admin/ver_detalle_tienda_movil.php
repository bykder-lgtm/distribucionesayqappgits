...
if ($cod_tienda <= 0) {
    header("Location: lista_tienda_asesor_movil.php");
    exit;
}
...
LEFT JOIN tbl15_banco_cuenta b ON t.cod_banco_cuenta = b.cod_banco_cuenta 
WHERE t.cod_tienda = '$cod_tienda'";
$resultado = mysqli_query($conectar, $sql);
$tienda = mysqli_fetch_assoc($resultado);

if (!$tienda) { header("Location: lista_tienda_asesor_movil.php"); exit; }
...
<main class="page-container">
    <div class="page-header">
        <a href="lista_tienda_asesor_movil.php" class="back-btn">
        ...
        <div class="profile-body">
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value"><?php echo $tienda['nombre_banco_cuenta'] ?: 'No asignado'; ?></span>
                    </div>
                    -->
                </div>
            </div>
            ...
            <div class="detail-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(16, 185, 129, 0.2); padding-bottom: 0.5rem;">
                    <h3 class="section-title" style="border: none; margin: 0; padding: 0;"><i class="fa-solid fa-file-contract"></i>Documentación Legal</h3>
            
                    <button type="button" class="btn" onclick="mostrarModalDocumentos()" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: none; padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.75rem; font-weight: 600; cursor: pointer;">
                        <i class="fa-solid fa-upload"></i> Cargar Documento
                    </button>
                </div>
                <div class="document-section">
                    <div class="document-item">
                        <div class="document-label"><i class="fa-solid fa-file-pdf"></i>RUT</div><div>
                            <?php if (!empty($tienda['url_documentacion_rut_tienda'])): ?>
                                <span class="document-status uploaded">Cargado</span>
                                <a href="<?php echo $tienda['url_documentacion_rut_tienda']; ?>" target="_blank" class="document-link"><i class="fa-solid fa-eye"></i> Ver</a>
                                <button onclick="eliminarDocumento('rut')" class="document-delete"><i class="fa-solid fa-trash"></i></button>
                            <?php else: ?>
                                <span class="document-status missing">No cargado</span>
                                <button onclick="cargarDocumento('rut')" class="document-upload"><i class="fa-solid fa-upload"></i> Cargar</button>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="document-item">
                        <div class="document-label"><i class="fa-solid fa-file-pdf"></i>Cámara de Comercio</div><div>
                            <?php if (!empty($tienda['url_documentacion_camaracomercio_tienda'])): ?>
                                <span class="document-status uploaded">Cargado</span>
                                <a href="<?php echo $tienda['url_documentacion_camaracomercio_tienda']; ?>" target="_blank" class="document-link"><i class="fa-solid fa-eye"></i> Ver</a>
                                <button onclick="eliminarDocumento('camaracomercio')" class="document-delete"><i class="fa-solid fa-trash"></i></button>
                            <?php else: ?>
                                <span class="document-status missing">No cargado</span>
                                <button onclick="cargarDocumento('camaracomercio')" class="document-upload"><i class="fa-solid fa-upload"></i> Cargar</button>
                            <?php endif; ?>
                        </div>
                    </div>

                    <div class="document-item">
                        <div class="document-label"><i class="fa-solid fa-file-pdf"></i>Contrato Firmado</div><div>
                            <?php if (!empty($tienda['url_documentacion_contratofirma_tienda'])): ?>
                                <span class="document-status uploaded">Cargado</span>
                                <a href="<?php echo $tienda['url_documentacion_contratofirma_tienda']; ?>" target="_blank" class="document-link"><i class="fa-solid fa-eye"></i> Ver</a>
                                <button onclick="eliminarDocumento('contratofirma')" class="document-delete"><i class="fa-solid fa-trash"></i></button>
                            <?php else: ?>
                                <span class="document-status missing">No cargado</span>
                                <button onclick="cargarDocumento('contratofirma')" class="document-upload"><i class="fa-solid fa-upload"></i> Cargar</button>
                            <?php endif; ?>
                        </div>
                    </div>
                    
                    <div class="document-item">
                        <div class="document-label"><i class="fa-solid fa-file-pdf"></i>Documento Extra 1</div>
                        <div>
                            <?php if (!empty($tienda['url_documentacion_extra1_tienda'])): ?>
                                <span class="document-status uploaded">Cargado</span>
                                <a href="<?php echo $tienda['url_documentacion_extra1_tienda']; ?>" target="_blank" class="document-link"><i class="fa-solid fa-eye"></i> Ver</a>
                                <button onclick="eliminarDocumento('extra1')" class="document-delete"><i class="fa-solid fa-trash"></i></button>
                            <?php else: ?>
                                <span class="document-status missing">No cargado</span>
                                <button onclick="cargarDocumento('extra1')" class="document-upload"><i class="fa-solid fa-upload"></i> Cargar</button>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="document-item">
                        <div class="document-label"><i class="fa-solid fa-file-pdf"></i>Documento Extra 2</div>
                        <div>
                            <?php if (!empty($tienda['url_documentacion_extra2_tienda'])): ?>
                                <span class="document-status uploaded">Cargado</span>
                                <a href="<?php echo $tienda['url_documentacion_extra2_tienda']; ?>" target="_blank" class="document-link"><i class="fa-solid fa-eye"></i> Ver</a>
                                <button onclick="eliminarDocumento('extra2')" class="document-delete"><i class="fa-solid fa-trash"></i></button>
                            <?php else: ?>
                                <span class="document-status missing">No cargado</span>
                                <button onclick="cargarDocumento('extra2')" class="document-upload"><i class="fa-solid fa-upload"></i> Cargar</button>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="detail-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(16, 185, 129, 0.2); padding-bottom: 0.5rem;">
                    ...
                    <button type="button" class="btn" data-toggle="modal" data-target="#modalRegistrarVendedor" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: none; padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.75rem; font-weight: 600; cursor: pointer;">
            ...
            <div class="detail-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; border-bottom: 1px solid rgba(16, 185, 129, 0.2); padding-bottom: 0.5rem;">
                    ...
                    <button type="button" class="btn" data-toggle="modal" data-target="#modalRegistrarProducto" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: none; padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.75rem; font-weight: 600; cursor: pointer;">
            ...
            <div class="action-buttons">
                <a href="editar_tienda_movil.php?cod_tienda=<?php echo $cod_tienda; ?>" class="action-btn-full edit"><i class="fa-solid fa-edit"></i>Editar Tienda</a>
                <a href="lista_tienda_asesor_movil.php" class="action-btn-full back"><i class="fa-solid fa-arrow-left"></i>Volver al Listado</a>
            </div>
        </div>
    </div>
</main>
        ...
        <div class="modal-body">
            ...
            <div style="text-align: center; margin-bottom: 1.5rem;">
                <div style="background: linear-gradient(135deg, rgba(16,185,129,0.2), rgba(5,150,105,0.2)); border-radius: 12px; padding: 1rem; margin-bottom: 1rem;">
                    <i class="fa-solid fa-camera" style="font-size: 2.5rem; color: #10b981;"></i>
                    <h3 style="color: #10b981; margin: 0.5rem 0;">Cargar Imágenes de Tienda</h3>
            ...
            <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 12px; padding: 1rem; margin-bottom: 1.5rem;">
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.5rem;">
                    ...
                    <button onclick="copiarEnlaceImagenes()" style="background: #6366f1; color: white; border: none; padding: 0.75rem; border-radius: 8px; cursor: pointer; font-size: 0.85rem; font-weight: 600; transition: all 0.3s ease;" title="Copiar enlace">
                        <i class="fa-solid fa-copy"></i> Copiar
                    </button>
                </div>
            </div>
...
<div class="modal fade" id="modalCargarDocumento" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-upload"></i> Cargar Documento</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div id="result_document"></div>
                <form id="formCargarDocumento" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Tipo de Documento</label>
                        <select name="tipo_documento" id="tipo_documento" class="form-control" required>
                            <option value="">Seleccione el tipo</option>
                            <option value="rut">RUT</option>
                            <option value="camaracomercio">Cámara de Comercio</option>
                            <option value="contratofirma">Contrato Firmado</option>
                            <option value="extra1">Documento Extra 1</option>
                            <option value="extra2">Documento Extra 2</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Archivo *</label>
                        <input type="file" name="documento" id="documento_file" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" class="form-control" required>
                        <small class="text-muted">Formatos permitidos: PDF, DOC, DOCX, JPG, PNG (Máx. 10MB)</small>
                    </div>
                    <div class="form-group">
                        <label>Descripción (Opcional)</label>
                        <div id="editor_descripcion_documento" style="background: white; border: 1px solid #ddd; border-radius: 8px; min-height: 150px;"></div>
                        <input type="hidden" name="descripcion_documento" id="hidden_descripcion_documento">
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_cargar_documento"><i class="fa fa-upload"></i> Cargar Documento</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-producto" id="modalRegistrarVendedor" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-user-plus"></i> Registrar Nuevo Vendedor</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="identificacion_tercero" id="vend_identificacion" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="telefono1_tercero" id="vend_telefono" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="btn_guardar_vendedor"><i class="fa fa-save"></i> Guardar Vendedor</button>
            </div>
        </div>
    </div>
</div>
...
// Función auxiliar para mostrar el modal (compatibilidad)
...
function eliminarDocumento(tipo) {
    Swal.fire({
        title: '¿Eliminar documento?', text: 'Esta acción no se puede deshacer', icon: 'warning', showCancelButton: true, confirmButtonColor: '#ef4444', cancelButtonColor: '#6c757d', confirmButtonText: 'Sí, eliminar', cancelButtonText: 'Cancelar'
    }).then((result) => {
        if (result.isConfirmed) {
            fetch('eliminar_documento_ajax.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify({
                    cod_tienda: <?php echo $cod_tienda; ?>,
                    tipo_documento: tipo
                })
            })
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        icon: 'success', title: 'Documento eliminado', text: data.message, confirmButtonColor: '#10b981'
                    }).then(() => {
                        location.reload();
                    });
                } else {
            ...
            .catch(error => {
                Swal.fire({ icon: 'error', title: 'Error de conexión', text: 'No se pudo procesar la solicitud', confirmButtonColor: '#10b981' });
            });
        }
    });
}
...
// Función para limpiar formato de miles (obtener solo el número)
...
// Event listener para carga de documentos
document.addEventListener('DOMContentLoaded', function() {
    // Inicializar Quill editor para descripción de documento
    quillDescripcion = new Quill('#editor_descripcion_documento', {
        theme: 'snow',
    ...
    // Formatear campos de precio con separador de miles
    ...
    if (precioCompraInput) {
        ...
        // Formatear al pegar
        precioCompraInput.addEventListener('paste', function(e) {
            setTimeout(() => {
    ...
    if (precioVentaInput) {
        ...
        // Formatear al pegar
        precioVentaInput.addEventListener('paste', function(e) {
            setTimeout(() => {
                this.value = formatearMiles(this.value);
            }, 10);
        });
    ...
    if (btnGuardar) {
        btnGuardar.addEventListener('click', function() {
            ...
            // Capturar el contenido del editor Quill de producto
            if (quillProducto) {
                const descripcionHTML = quillProducto.root.innerHTML;
                // Si el editor está vacío, enviar vacío
                if (quillProducto.getText().trim().length === 0) {
                    document.getElementById('hidden_descripcion_producto').value = '';
                } else {
                    document.getElementById('hidden_descripcion_producto').value = descripcionHTML;
                }
            }
            
            // Limpiar formato de precios antes de enviar
            ...
            if (precioCompra) {
                precioCompra.value = limpiarMiles(precioCompra.value);
            }
            if (precioVenta) {
                precioVenta.value = limpiarMiles(precioVenta.value);
            }
            ...
            if (!valido) {
                // Restaurar formato si hay error
                ...
                Swal.fire({ icon: 'error', title: 'Campos requeridos', text: 'Por favor complete todos los campos marcados con *', confirmButtonColor: '#10b981' });
                return;
            }
            ...
            // Enviar datos
            fetch('reg_producto_tienda_ajax.php', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        icon: 'success', title: 'Producto registrado', text: data.message, confirmButtonColor: '#10b981'
                    }).then(() => {
                        $('#modalRegistrarProducto').modal('hide');
                        location.reload(); // Recargar para mostrar el nuevo producto
                    });
                } else {
                    // Restaurar formato en caso de error
                    if (precioCompra && precioCompra.value) { precioCompra.value = formatearMiles(precioCompra.value); }
                    if (precioVenta && precioVenta.value) { precioVenta.value = formatearMiles(precioVenta.value); }
            ...
            .catch(error => {
                // Restaurar formato en caso de error de conexión
                if (precioCompra && precioCompra.value) { precioCompra.value = formatearMiles(precioCompra.value); }
                if (precioVenta && precioVenta.value) { precioVenta.value = formatearMiles(precioVenta.value); }
    ...
    // Limpiar formulario al cerrar modal de productos
    $('#modalRegistrarProducto').on('hidden.bs.modal', function() {
        ...
        // Limpiar editor Quill de producto
        if (quillProducto) { quillProducto.setContents([]); }
        // Restablecer colores de bordes
    ...
    if (btnGuardarVendedor) {
        btnGuardarVendedor.addEventListener('click', function() {
            ...
            if (!emailRegex.test(correo)) {
                Swal.fire({ icon: 'warning',  title: 'Correo inválido', text: 'Por favor ingresa un correo electrónico válido', confirmButtonColor: '#10b981' });
                return;
            }
            ...
            fetch('registrar_vendedor_tienda_ajax.php', {
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        icon: 'success', title: '¡Vendedor Registrado!', text: data.message || 'El vendedor ha sido registrado exitosamente', confirmButtonColor: '#10b981'
                    }).then(() => {
                        $('#modalRegistrarVendedor').modal('hide');
                        location.reload(); // Recargar para mostrar el nuevo vendedor
                    });
                } else {
                    Swal.fire({ icon: 'error', title: 'Error', text: data.message || 'No se pudo registrar el vendedor', confirmButtonColor: '#10b981' });
                }
            })
            .catch(error => {
    ...
    // Manejo de documentos
    const btnCargarDoc = document.getElementById('btn_cargar_documento');
    if (btnCargarDoc) {
        btnCargarDoc.addEventListener('click', function() {
            const form = document.getElementById('formCargarDocumento');
            
            // Capturar el contenido del editor Quill
            if (quillDescripcion) {
                const descripcionHTML = quillDescripcion.root.innerHTML;
                document.getElementById('hidden_descripcion_documento').value = descripcionHTML;
            }
            
            const formData = new FormData(form);
            
            const tipoDoc = document.getElementById('tipo_documento').value;
            const archivo = document.getElementById('documento_file').files[0];
            ...
            if (archivo.size > 10 * 1024 * 1024) {
                Swal.fire({ icon: 'error', title: 'Archivo muy grande', text: 'El archivo no puede superar los 10MB', confirmButtonColor: '#10b981' });
                return;
            }
            ...
            fetch('cargar_documento_ajax.php', {
                method: 'POST', body: formData
            })
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        icon: 'success', title: 'Documento cargado', text: data.message, confirmButtonColor: '#10b981'
                    }).then(() => {
            ...
            .catch(error => {
                Swal.fire({ icon: 'error', title: 'Error de conexión', text: 'No se pudo cargar el documento', confirmButtonColor: '#10b981' });
            })
            .finally(() => {
                this.innerHTML = btnOriginal;
                this.disabled = false;
    ...
    $('#modalCargarDocumento').on('hidden.bs.modal', function() {
        ...
        document.getElementById('result_document').innerHTML = '';
    ...
    window.abrirModalRevisionFirma = function(codTiendaCryp, nombreTienda, codEstadoFirma, urlFirma) {
        ...
        if (codEstadoFirma === '0' && urlFirma.length > 0) {
            ...
            // Mostrar mensaje de firma pendiente
    ...
    window.copiarEnlaceDirecto = function(enlace) {
    ...
    window.gestionarFirma = function(accion) {
        ...
        Swal.fire({
            ...
            text: texto, icon: icono, showCancelButton: true, confirmButtonColor: accion === 'aceptar' ? '#10b981' : '#ef4444', cancelButtonColor: '#6b7280', confirmButtonText: 'Sí, ' + accion,
            cancelButtonText: 'Cancelar', background: '#1a1f2e', color: 'white',
            customClass: { container: 'swal2-above-modal' }
        }).then((result) => {
            if (result.isConfirmed) {
                // Aquí iría la lógica para guardar la decisión en la base de datos
                Swal.fire({
    ...
    window.compartirImagenesWhatsApp = function() {
        ...
        // Construir URL para cargar imágenes
        var currentPath = window.location.pathname;
        var basePath = currentPath.substring(0, currentPath.lastIndexOf('/app/admin/') + '/app/admin/'.length);
