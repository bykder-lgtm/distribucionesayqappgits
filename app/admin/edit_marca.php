...
<div class="breadcrumbs"><a href="<?php echo $pagina; ?>"><h4>Editar Marca</h4></a></div>
<div class="row-fluid">
...
$mostrar_datos_sql = "SELECT * FROM tbl15_marca WHERE cod_marca = '$cod_marca'";
...
?>
<form name="formulario_edicion" accept-charset="utf-8" method="post" action="../admin/edit_marca_reg.php">
<fieldset>
...
<td><input type="text" name="nombre_marca" value="<?php echo ($nombre_marca) ?>"  class="input-block-level" required/></td>
<td>        
