                ...
                <div class="table-main">
                    <div class="mb-2">
                        ...
                        <div class="col-12 d-flex shopping-box">
                            ...
                            <a href="../admin/reg_siscredito_tercero_cliente_simulador.php?cod_producto_codifcryp=0&cod_seguridad=<?php echo $cod_seguridad ?>&valor_credito=0&cod_entidad_crediticia=0&cod_tipo_cobro=0&cod_meses_credito=0" class="ml-auto btn hvr-hover">Registrar Nuevo <?php echo $nombre_tipo_tercero_text ?></a> 
