...
?>
    <!-- Start Cart  -->
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/reg_soportes_cuenta_cobrar_cliente_siscredito_visitante_intern_reg.php">
                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        ...
                        <table class="table">
                          ...
                          <tbody>
                                <tr>
                                    ...
                                    <td style="text-align:center; width:80%"><input class="form-control" name="nombre_nota_observacion" type="text" value="" placeholder="" required/></td>
                        ...
                        <div class="submit-button text-center">
                            <!--<button class="btn hvr-hover" id="submit" type="submit">Registrar Soporte</button>-->
