...
<a class="btn btn-primary" href="#"><h6>Devoluciones en Inventario</h6></a>
</div>
<div class="row-fluid">
...
<tbody>
<?php
$sql_info_factura = "SELECT * FROM tbl15_operacion WHERE (fecha_devolucion BETWEEN '$fecha_devolucion_ini' AND '$fecha_devolucion_fin') AND (origen_operacion = 'inventario') $filtro_vendedor ORDER BY cod_operacion DESC";
...
<td style="text-align:center"><?php echo $und_inventario?></td>
<td style="text-align:center"><?php echo $und_nuevas?></td>
<td style="text-align:center"><?php echo $unidades_faltantes?></td>
