...
$cuenta_actual                         = 'visitante';
$nombres_des                           = 'visitante';
$apellidos_des                         = 'visitante';
$nombre_sexo_des                       = 'visitante';
$url_img_firma_sesion                  = 'visitante';
$url_img_foto_sesion                   = 'visitante';
$tipo_dispositivo                      = 'visitante';
$cod_cliente_sesion                    = 'visitante';
$cod_administrador                     = 'visitante';
$cod_base_caja                         = 'visitante';
$cod_seguridad                         = 'visitante';
$cod_caja_virtual                      = 'visitante';
$token                                 = 'visitante';
...
$ca_cryp                               = 'visitante';
$tokn_cryp                             = 'visitante';
$pag_redirec_sesion_cryp               = 'visitante';
$estilo_css                            = 'visitante';
$tipo_usuario                          = 'visitante';
$tipo_menu                             = 'visitante';
$cod_administrador                     = 'visitante';
$cod_seguridad                         = 'visitante';
$vendedor_codifcryp                    = 'visitante';
$token                                 = 'visitante';
$inicio_sesion                         = 'visitante';
$tipo_menu                             = 'visitante';
$pagina_salir_visitante                = 'visitante';
$descripcion_producto                  = "";
//---------------------------------------------------------------------------------------------------------------------------------//
$pag_redirec_sesion                    = 'visitante';
//---------------------------------------------------------------------------------------------------------------------------------//
