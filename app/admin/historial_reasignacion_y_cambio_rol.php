...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-control { background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.4); color: white; }
        .form-control:focus { background: rgba(59, 130, 246, 0.1); border-color: #60a5fa; color: white; box-shadow: 0 0 0 0.25rem rgba(59, 130, 246, 0.25); }
        
        .table-container { background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.2); border-radius: 15px; overflow: hidden; }
        ...
        .table-hover tbody tr:hover td { background-color: rgba(59, 130, 246, 0.2) !important; color: #ffffff !important;}
        ...
        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap" style="gap:15px;">
            ...
            <div style="flex-grow: 1; max-width: 400px;">
                <div class="input-group">
                    <span class="input-group-text bg-transparent text-white" style="border-color: rgba(59, 130, 246, 0.4);"><i class="fa-solid fa-magnifying-glass"></i></span>
