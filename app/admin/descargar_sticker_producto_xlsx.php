...
->setCreator("STICKER_BARRAS")
->setLastModifiedBy("STICKER_BARRAS")
->setTitle("LISTA - "."STICKER_BARRAS")
->setSubject("LISTA - "."STICKER_BARRAS")
->setDescription("STICKER_BARRAS")
->setKeywords("STICKER_BARRAS")
->setCategory("STICKER_BARRAS");
// Add some data
...
$thisSheet->setCellValueExplicit('A'.$increment, $cod_producto_barra, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('B'.$increment, $nombre_producto, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('C'.$increment, $und_venta, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('D'.$increment, $precio_compra_producto, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('E'.$increment, $precio_venta_producto, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('F'.$increment, $codif_letra_precio_compra, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('G'.$increment, $codif_letra_precio_venta, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('H'.$increment, $fecha_ult_compra, \PHPExcel_Cell_DataType::TYPE_STRING);
$thisSheet->setCellValueExplicit('I'.$increment, $cod_tercero, \PHPExcel_Cell_DataType::TYPE_STRING);
}
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle("STICKER_BARRAS");
...
//$objWriter = PHPExcel_Cell::setValueBinder(new PHPExcel_Cell_StringValueBinder());
