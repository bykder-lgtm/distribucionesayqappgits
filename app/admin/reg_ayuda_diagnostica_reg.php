...
if (isset($_POST['nombre_ayuda_diagnostica']) <> '') { $nombre_ayuda_diagnostica = mysqli_real_escape_string($conectar, ($_POST['nombre_ayuda_diagnostica'])); } else { $nombre_ayuda_diagnostica = ''; }
...
$sql_data = "INSERT INTO tbl15_ayuda_diagnostica (nombre_ayuda_diagnostica, cod_tipo_historia_clinica, cod_estado) 
