...
$incre                                           = 0;
$tab                                             = 'tbl15_transferencia_bodega_producto';
$campo                                           = 'cod_transferencia_bodega_producto';
$tipo                                            = 'eliminar';
$cod_estado_vacuna                               = '0';
...
$datos_factura = "SELECT cod_transferencia_bodega_producto FROM tbl15_transferencia_bodega_producto WHERE (cod_info_factura_transferencia_bodega = '$cod_info_factura_transferencia_bodega')";
...
<tbody>
<?php
$sql_transferencia_bodega_producto = "SELECT * FROM tbl15_transferencia_bodega_producto WHERE (cod_info_factura_transferencia_bodega = '$cod_info_factura_transferencia_bodega') 
...
$cedula                                        = $datos_transferencia_bodega_producto['cedula'];
$nombre_cliente                                = $datos_transferencia_bodega_producto['nombre_cliente'];
$und_compra                                    = $datos_transferencia_bodega_producto['und_compra'];
$und_unidades                                  = $datos_transferencia_bodega_producto['und_unidades'];
$und_caja                                      = $datos_transferencia_bodega_producto['und_caja'];
$precio_costo_producto                         = $datos_transferencia_bodega_producto['precio_costo_producto'];
$precio_compra_producto                        = $datos_transferencia_bodega_producto['precio_compra_producto'];
$total_costo_producto                          = $datos_transferencia_bodega_producto['total_costo_producto'];
$total_compra_producto                         = $datos_transferencia_bodega_producto['total_compra_producto'];
$precio_venta_producto                         = $datos_transferencia_bodega_producto['precio_venta_producto'];
$precio_venta_producto2                        = $datos_transferencia_bodega_producto['precio_venta_producto2'];
$precio_venta_producto3                        = $datos_transferencia_bodega_producto['precio_venta_producto3'];
$precio_venta_producto4                        = $datos_transferencia_bodega_producto['precio_venta_producto4'];
$precio_venta_producto5                        = $datos_transferencia_bodega_producto['precio_venta_producto5'];
$iva_ptj                                       = $datos_transferencia_bodega_producto['iva_ptj'];
$dto1                                          = $datos_transferencia_bodega_producto['dto1'];
$dto2                                          = $datos_transferencia_bodega_producto['dto2'];
$precio_ipc                                    = $datos_transferencia_bodega_producto['precio_ipc'];
$total_venta_producto                          = $datos_transferencia_bodega_producto['total_venta_producto'];
$nombre_tipo_producto                          = $datos_transferencia_bodega_producto['nombre_tipo_producto'];
$nombre_tipo_unidad_medida                     = $datos_transferencia_bodega_producto['nombre_tipo_unidad_medida'];
$posologia_cantidad                            = $datos_transferencia_bodega_producto['posologia_cantidad'];
$posologia_peso                                = $datos_transferencia_bodega_producto['posologia_peso'];
$nombre_tipo_presentacion                      = $datos_transferencia_bodega_producto['nombre_tipo_presentacion'];
$nombre_via_administracion                     = $datos_transferencia_bodega_producto['nombre_via_administracion'];
$nombre_frec_duracion                          = $datos_transferencia_bodega_producto['nombre_frec_duracion'];
$cod_tipo_cobrar                               = $datos_transferencia_bodega_producto['cod_tipo_cobrar'];
$nombre_tipo_precio_venta                      = $datos_transferencia_bodega_producto['nombre_tipo_precio_venta'];
$cod_estado_permitir_venta                     = $datos_transferencia_bodega_producto['cod_estado_permitir_venta'];
...
$incre++;
?>
<tr style="text-align:center;" id="tr<?php echo $cod_transferencia_bodega_producto;?>">
<th style="text-align:center;"></th>
...
<th style="text-align:center;"></th>
</tr style="text-align:right;" id="tr<?php echo $cod_transferencia_bodega_producto;?>">
<?php } ?>
</tbody>
</table>
