        ...
        <div class="flex" id="flex">
            <div class="modal_contenido">
                ...
                <form method="post" enctype="multipart/form-data" id="formulario_nuevo_registro_modal" name="formulario_nuevo_registro_modal" class="form-horizontal form-label-left input_mask">
                    <input type="hidden" name="cod_info_impuesto_facturas_hidden" id="cod_info_cotizacion_factura_venta" value="<?php echo $cod_info_cotizacion_factura_venta ?>" placeholder="">
...
$(document).ready(function() {
    ...
    $("#btn_guardar_formulario_nuevo_registro_modal").click(function(){
        ...
        var cod_info_cotizacion_factura_venta = document.getElementById('cod_info_cotizacion_factura_venta').value;
