...
<?php
if (isset($_GET['cod_cotizar_producto'])) { 
    $cod_cotizar_producto             = intval($_GET['cod_cotizar_producto']);

    $sql_producto_ind = "SELECT * FROM tbl15_cotizar_producto WHERE cod_cotizar_producto = '$cod_cotizar_producto'";
    ...
    $correo                          = $datos_producto_ind['correo'];
    $telefono                        = $datos_producto_ind['telefono'];
    $telefono_whatsapp               = $datos_producto_ind['telefono_whatsapp'];
?>
    <!-- Start Shop Page  -->
    <!-- Start Shop Detail  -->
            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        <p>Numero de Telefono: <?php echo ($telefono) ?></p>
                        <p>Numero de Whatsapp: <?php echo ($telefono_whatsapp) ?></p>
                    </div>
                </div>
