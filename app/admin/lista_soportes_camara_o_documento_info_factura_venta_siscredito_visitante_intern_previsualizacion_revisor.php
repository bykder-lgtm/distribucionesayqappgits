...
if ($nombre_estado_factura == 'ABIERTA') {
    ...
    $pagina_redirect_edit_factura = '../admin/edit_checkout_info_factura_venta_abierta_siscredito_visitante_intern_revisor.php?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&modo_venta_por_defecto='.$modo_venta_por_defecto.'&pagina='.$pagina;
    ...
    $pagina_redirect_generar_factura_venta = '#';
} else {
    ...
    $pagina_redirect_edit_factura = '../admin/edit_checkout_info_factura_venta_cerrada_siscredito_visitante_intern_revisor.php?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&modo_venta_por_defecto='.$modo_venta_por_defecto.'&pagina='.$pagina;
    ...
    $pagina_redirect_generar_factura_venta = '../admin/generar_factura_venta_siscredito_venta_producto_reg.php?cod_info_factura_venta='.$cod_info_factura_venta.'&cuenta='.$cuenta.'&cod_caja_virtual='.$cod_caja_virtual.'&modo_venta_por_defecto='.$modo_venta_por_defecto.'&pagina='.$pagina;
}
?>
    ...
    <input type='hidden' value='<?php echo $nombre_nota_observacion;?>' id='nombre_nota_observacion<?php echo $cod_nota_observacion;?>'>
                            ...
                            -->
                                ...
                                <?php if ($codigo_estado_revision == '0') { // 0 POR CARGAR ?>
                                    ...
                                    <?php } else { ?>
                                    <div class="col-md-12">
                                        <div style="text-align:center; <?php echo $color_fondo_celda_estado ?>; <?php echo $color_letra_celda_estado ?>" id="estado_revision_por_cargar<?php echo $cod_nota_observacion ?>" class=""><?php echo $nombre_nota_observacion ?> <br> ESTADO: 
                                            ...
                                            <br>
                                            <a href="#" id="focotext<?php echo $cod_nota_observacion ?>"></a>
                                            <span id="cargador_check<?php echo $cod_nota_observacion ?>"><img style="width:300px" class="w-1000 mb-4" src="<?php echo $url_img_orig_producto ?>"></span>
                                        </div>
                                    </div>
                                <?php } ?>
