...
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='BAJO PESO') AND ((nombre_empresa)='$nombre_empresa'))
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='PESO NORMAL') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY exa_fis_interpreimc, nombre_empresa";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='SOBREPESO') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY exa_fis_interpreimc, nombre_empresa";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD I') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY exa_fis_interpreimc, nombre_empresa";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD II') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY exa_fis_interpreimc, nombre_empresa";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD III') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY exa_fis_interpreimc, nombre_empresa";
...
FROM tbl15_historia_clinica 
WHERE ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (cod_estado_facturacion=1) AND (exa_fis_interpreimc='OBESIDAD EXTREMA') AND ((nombre_empresa)='$nombre_empresa'))
GROUP BY exa_fis_interpreimc, nombre_empresa";
