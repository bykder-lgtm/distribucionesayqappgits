...
<tbody>
    <tr>
        <td style="text-align:left;">
            <select name="cod_movimiento_contable_cuenta_personal" id="cod_movimiento_contable_cuenta_personal" class="chosen" data-show-subtext="true" data-live-search="true" style="font-size: 25px; height: 50px; width: 400px;" required>
