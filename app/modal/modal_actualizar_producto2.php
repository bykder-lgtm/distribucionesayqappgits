            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="actualizar_registro_modal" name="actualizar_registro_modal">
                        ...
                        <input type="hidden" name="cod_producto" id="mod_cod_producto">

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Codigo<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="cod_producto_barra" id="mod_cod_producto_barra" value="" class="form-control" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" name="nombre_producto" id="mod_nombre_producto" value="" class="form-control" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="und_producto" id="mod_und_producto" value="" class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="precio_costo_producto" id="mod_precio_costo_producto" value="" class="form-control" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="precio_venta_producto" id="mod_precio_venta_producto" value="" class="form-control" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="nombre_tipo_producto" id="mod_nombre_tipo_producto" class="selectpicker" data-show-subtext="true" data-live-search="true" required>
