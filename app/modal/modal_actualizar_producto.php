<!-- Modal -->
<?php $mod = 'mod_'; ?>
    <div class="modal fade abrir_modal_actualizar" tabindex="10" role="dialog" aria-hidden="true">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" id="actualizar_registro_modal" name="actualizar_registro_modal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" name="cod_producto_barra" id="<?php echo $mod;?>cod_producto_barra" value="" class="form-control" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="tope_min" id="<?php echo $mod;?>tope_min" value="" class="form-control" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Iva<span class="required">:</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="iva_ptj" id="<?php echo $mod;?>iva_ptj" value="" class="form-control" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            $consulta2_sql = ("SELECT cod_tipo_producto, nombre_tipo_producto FROM tbl15_tipo_producto ORDER BY cod_tipo_producto ASC");
                        ...
                        <div class="form-group">
                            ...
                            $consulta2_sql = ("SELECT cod_tipo_unidad_medida, nombre_tipo_unidad_medida FROM tbl15_tipo_unidad_medida ORDER BY cod_tipo_unidad_medida ASC");
                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                        ...
                        <div class="form-group">
                            ...
                            $consulta2_sql = ("SELECT cod_tipo_presentacion, nombre_tipo_presentacion FROM tbl15_tipo_presentacion ORDER BY cod_tipo_presentacion ASC");
                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                        ...
                        <div class="form-group">
                            ...
                            $consulta2_sql = ("SELECT cod_via_administracion, nombre_via_administracion FROM tbl15_via_administracion ORDER BY cod_via_administracion ASC");
                            $consulta2 = mysqli_query($conectar, $consulta2_sql);
                            while ($datos2 = mysqli_fetch_assoc($consulta2)) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" name="nombre_frec_duracion" id="<?php echo $mod;?>nombre_frec_duracion" value="" class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Fecha Vencimiento 1<span class="required">:</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="date" name="fecha_vencimiento1" id="<?php echo $mod;?>fecha_vencimiento1" value="" class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Lote 1<span class="required">:</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="vencimiento_lote1" id="<?php echo $mod;?>vencimiento_lote1" value="" class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Fecha Vencimiento 2<span class="required">:</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="date" name="fecha_vencimiento2" id="<?php echo $mod;?>fecha_vencimiento2" value="" class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Lote 2<span class="required">:</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="number" name="vencimiento_lote2" id="<?php echo $mod;?>vencimiento_lote2" value="" class="form-control" placeholder="">
                            </div>
                        </div>
